...
[← CZMQRingItemThreadedWorker](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51459.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSourceElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51461.md)

---

---

# <a name="AEN51460"></a>CZMQRingItemThreadedWorker

<a name="AEN51464"></a>## Name

CZMQRingItemThreadedWorker -- ZeroMQ Threaded worker for ZeroMQ

<a name="AEN51467"></a>## Synopsis
