...
[← 3provider](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63498.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [multilogger →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63501.md)
...
<a name="AEN63514"></a>## Name

Introduction -- Data source providers

<a name="AEN63517"></a>## Synopsis
...
Data source providers are Tcl loadable packages that provide
            ...
            [*SSHPipe*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63987.md)
            which understands how to run command line readout programs on the end
            of a SSH pipeline to a (possibily) remote system, and
            [*s800*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64099.md) which
...
<a name="AEN63570"></a>## CREATING A DATA SOURCE PROVIDER
...
<a name="AEN63587"></a>## API FUNCTIONS
...
- **check** *sourceId*
  Whatever code is managing a set of data providers
                              ...
                              has exited.
                              [*check*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63716.md)
                              returns a true value if a source is still running and
                              false if not.
- **stop** *sourceId*
  [*stop*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63748.md)
                              Stops the specified data source.
- **begin** *sourceId runNumber title*
  Starts data taking for a new run.
                              See [*begin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63779.md)
                              for reference information.
- **pause** *sourceId*
  If your data source implements pause/resume functionality
                              you must define this command to pause the run.
                              See the 
                              [*pause*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63810.md)
                              reference material for more information.
- **resume** *sourceId*
  If your data source implements pause/resume functionality
                              you must implement
                              [*resume*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63847.md)
                              to resume paused runs.
- **end** *sourceId*
  The
                              [*end*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63880.md)
                              ends a run in a data source.
- **init** *sourceId*
  The
                              [*init*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63909.md)
                              causes an initialize procedure in the data source.
- **capbilities**
  Describes the data
                              [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63938.md)
                              source capabilities.
