...
[← Configuration](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61609.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::configParams →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61623.md)
...
<a name="AEN61624"></a>## Name

Configuration -- Configuration variable management

<a name="AEN61627"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63275.md) package for that
            instead.

<a name="AEN61650"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63275.md) is a better
                          choice).
