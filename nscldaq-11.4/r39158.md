...
[← CCondition](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39137.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSynchronizedThread →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39169.md)
...
<a name="AEN39172"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN39175"></a>## Synopsis
...
<a name="AEN39217"></a>## Public member functions
...
<a name="AEN39255"></a>`void sync_self(void);`
...
<a name="AEN39262"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN39270"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39282"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN39288"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN39298"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39328"></a>`void sync_global_end(void);`
