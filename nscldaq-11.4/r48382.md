...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48377.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48445.md)
...
<a name="AEN48396"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN48399"></a>## Synopsis

```
CException
```

<a name="AEN48433"></a>## Description
...
<a name="AEN48438"></a>## Public member functions
