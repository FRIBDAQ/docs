...
[← CZMQRingItemThreadedWorker](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50782.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSourceElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50791.md)

---

---

# <a name="AEN50783"></a>CZMQRingItemThreadedWorker

<a name="AEN50787"></a>## Name

CZMQRingItemThreadedWorker -- ZeroMQ Threaded worker for ZeroMQ

<a name="AEN50790"></a>## Synopsis
