...
[← CDataSourceFactory"](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25662.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSink →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25671.md)
...
<a name="AEN25684"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN25687"></a>## Synopsis

```
CDataSink
```

<a name="AEN25712"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26004.md)
