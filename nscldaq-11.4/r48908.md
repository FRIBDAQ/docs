...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48893.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStateException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48939.md)
...
<a name="AEN48922"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN48925"></a>## Synopsis

```
CException
```

<a name="AEN48959"></a>## Description
...
<a name="AEN48964"></a>## Public member functions
