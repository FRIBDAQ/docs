...
[← CCAMACTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33011.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamac →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33075.md)
...
<a name="AEN33126"></a>## Public member functions



- <a name="AEN33131"></a>`CCAMACScalerLRS4434(unsigned int b, unsigned int c, unsigned int n);`
  Constructs a new `CCAMACScalerLRS4434` object.
                              ...
                              parameters.
- <a name="AEN33149"></a>` virtual   void  Initialize(void);`
  Sets up the module for use in data taking.  The module will be software latched
                              ...
                              Off position.
- <a name="AEN33160"></a>`virtual   void  Read(std::vector<unsigned long>&
                                      Scalers);`
  Reads the 32 scaler channels of the module and appends their values
                              ...
                              to be incremental.
- <a name="AEN33173"></a>`virtual   void  Clear(void);`
  Clears the scaler counters.  The counters are all simulataneousl cleared
                              ...
                              again.
- <a name="AEN33183"></a>`virtual unsigned int  size(void);`
