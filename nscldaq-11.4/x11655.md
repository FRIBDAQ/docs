...
[← ringFragmentSource - a prepackaged client for ringbuffer data sources](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11610.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC state manager callback bundle. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11662.md)

---

---

# <a name="AEN11655"></a>65.2. API layer
