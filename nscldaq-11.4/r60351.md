...
[← ccusbcamac](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60340.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onEnd →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60353.md)
...
<a name="AEN60365"></a>## Name

EVBC::startRingSource -- Start a ring fragment source for the event builder.

<a name="AEN60368"></a>## Synopsis

**
EVBC::startRingSource *source-uri extractor-lib source-id info*
**

<a name="AEN60372"></a>## DESCRIPTION

Please use the [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60263.md) instead of this proc.
