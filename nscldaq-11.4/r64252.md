...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64251.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [PortManager →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64253.md)
...
<a name="AEN64266"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN64269"></a>## Synopsis
...
<a name="AEN64283"></a>## METHODS



- <a name="AEN64288"></a>`PortManager(string host, int    port);`
