...
[← TransientLabel](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r83596.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCompoundEventSegment →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r83610.md)
...
<a name="AEN83648"></a>## OPTIONS



- `-menulist` *list of items*
...
- `-zoomrange` *low high*
  Specifies the subset of menu items the +
...
- `-min`
  Contains/sets the minimum value.  Changes to the value,
                          ...
                          script.
- `-enablemin` *on|off*
  Boolean value.  When true displays
