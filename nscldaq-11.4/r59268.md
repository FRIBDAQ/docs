...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59216.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59269.md)
...
<a name="AEN59282"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN59285"></a>## Synopsis

```
CControlHardware
```

<a name="AEN59352"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59108.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59215.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN59359"></a>## METHODS
