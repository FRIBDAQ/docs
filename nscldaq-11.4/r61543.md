...
[← Eventbuilder callback bundle](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61503.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onBegin →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61570.md)
...
<a name="AEN61557"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN61560"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN61564"></a>## DESCRIPTION
