...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28947.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29032.md)
...
<a name="AEN29480"></a>## Public member functions
...
- <a name="AEN29487"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN29508"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN29521"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN29546"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN29557"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN29890"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN29903"></a>` ECLOutputSelect
...
- <a name="AEN29971"></a>` unsigned short
...
- <a name="AEN30135"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30147"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30157"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30167"></a>` TriggerConfiguration
...
- <a name="AEN30264"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN30288"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN30305"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN30331"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN30345"></a>` PWResolution
...
- <a name="AEN30505"></a>` unsigned short
...
- <a name="AEN30553"></a>` void
  ...
  Disables the specified channel.  Note that channel numbering
                              ...
                              about this.
- <a name="AEN30565"></a>` void EnableAllChannels(void);`
...
- <a name="AEN30599"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN30611"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN30628"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN30641"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN30653"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN30674"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN30686"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30701"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30716"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30731"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN30743"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN30758"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN30768"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN30780"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN30792"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN30804"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN30816"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN30826"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN30836"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN30846"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN30856"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN30868"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN30878"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN30888"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN30898"></a>` void EnableBypassOnError(void);`
- <a name="AEN30908"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN30918"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN30930"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN30940"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN30952"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN30962"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN30974"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN30986"></a>` void EnableAllChannels(void);`
- <a name="AEN30996"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN31006"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN31018"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN31030"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN31045"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN31057"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31069"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31090"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31103"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31120"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31138"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31153"></a>## Types and public data
