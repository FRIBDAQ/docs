...
[← CRangeError](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48566.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRangeError →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48629.md)
...
<a name="AEN48621"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN48624"></a>## Synopsis

```
CException
```

<a name="AEN48658"></a>## Description
...
<a name="AEN48663"></a>## Public member functions
