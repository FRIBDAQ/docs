...
<a name="AEN28456"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN28459"></a>## Synopsis
...
<a name="AEN28685"></a>## Public member functions





<a name="AEN28691"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28753"></a>`unsigned long getBase(void);`
...
<a name="AEN28764"></a>`int getSerial(void);`
...
<a name="AEN28795"></a>`int  getFirmware(void);`
...
<a name="AEN28805"></a>`int  getCrate(void);`
...
<a name="AEN28816"></a>`void setCrate(int crateNum);`
...
<a name="AEN28829"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN28850"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN28860"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN28870"></a>`void keepOverflowData(void);`
...
<a name="AEN28880"></a>`void discardOverflowData(void);`
...
<a name="AEN28890"></a>`void keepInvalidData(void);`
...
<a name="AEN28901"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN28912"></a>`void commonStart(void);`
...
<a name="AEN28923"></a>`void commonStop(void);`
...
<a name="AEN28934"></a>`void setRange(int range);`
...
<a name="AEN28947"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN29019"></a>`void clearData
                                (void);`
...
<a name="AEN29062"></a>`bool Busy(void);`
...
<a name="AEN29073"></a>` bool gBusy(void);`
...
<a name="AEN29084"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN29095"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN29106"></a>`int readEvent(void* buf);`
...
<a name="AEN29119"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN29160"></a>`void enableSmallThresholds(void);`
...
<a name="AEN29223"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN29227"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN29231"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN29235"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN29239"></a>**Example 3. Reading out a CAEN 785 e.g.**
