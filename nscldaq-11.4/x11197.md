...
[← Building the use shared library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11155.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the standard event orderer startup script →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11198.md)

---

---

# <a name="AEN11197"></a>64.2. Using the standard event orderer startup script
