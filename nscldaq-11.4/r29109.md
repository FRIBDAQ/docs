...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29032.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29246.md)
...
<a name="AEN29641"></a>## Public member functions
...
- <a name="AEN29648"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN29669"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN29682"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN29707"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN29718"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN30026"></a>` void
  ...
  Defines the FIFO almost full level.  If there are more than
                                  ...
                                  true
- <a name="AEN30041"></a>` unsigned short
...
- <a name="AEN30051"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN30064"></a>` ECLOutputSelect
...
- <a name="AEN30132"></a>` unsigned short
...
- <a name="AEN30296"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30308"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30318"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30328"></a>` TriggerConfiguration
...
- <a name="AEN30425"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN30449"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN30466"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN30492"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN30506"></a>` PWResolution
...
- <a name="AEN30666"></a>` unsigned short
...
- <a name="AEN30760"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN30772"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN30789"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN30802"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN30814"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN30835"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN30847"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30862"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30877"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30892"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN30904"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN30919"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN30929"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN30941"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN30953"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN30965"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN30977"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN30987"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN30997"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN31007"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN31017"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN31029"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN31039"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN31049"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN31059"></a>` void EnableBypassOnError(void);`
- <a name="AEN31069"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN31079"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN31091"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN31101"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN31113"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN31123"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN31135"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN31147"></a>` void EnableAllChannels(void);`
- <a name="AEN31157"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN31167"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN31179"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN31191"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN31206"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN31218"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31230"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31251"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31264"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31281"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31299"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31314"></a>## Types and public data
