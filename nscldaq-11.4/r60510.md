...
[← RingSourceMgr](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60501.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client framework →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60511.md)
...
<a name="AEN60524"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN60527"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN60531"></a>## DESCRIPTION
