...
[← CCrateController](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33951.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacNimout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34066.md)
...
<a name="AEN34162"></a>## Public member functions
...
- <a name="AEN34185"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN34195"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN34206"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN34217"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN34229"></a>` void SetLatchMode(void);const`
...
- <a name="AEN34241"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN34276"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN34345"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN34356"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN34367"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN34378"></a>` void Clock(void);const`
...
- <a name="AEN34389"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN34400"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN34411"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN34423"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN34434"></a>` unsigned long Read(void);const`
...
- <a name="AEN34446"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
