...
[← EVB::CallbackManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15405.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::inputStatistics::statusDisplay →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15440.md)
...
<a name="AEN15431"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN15434"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN15439"></a>## DESCRIPTION
...
<a name="AEN15461"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN15464"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN15467"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN15470"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN15473"></a>## DEPENDENCIES
