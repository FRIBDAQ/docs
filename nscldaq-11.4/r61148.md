...
[← Eventbuilder callback bundle](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61147.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3rdogui →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61158.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60955.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60779.md) to create the ring
             sources.
