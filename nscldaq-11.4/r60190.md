...
[← EVBC::startRingSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60189.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::stop →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60193.md)
...
<a name="AEN60204"></a>## Name

EVBC::startRingSource -- Start a ring fragment source for the event builder.

<a name="AEN60207"></a>## Synopsis

**
EVBC::startRingSource *source-uri extractor-lib source-id info*
**

<a name="AEN60211"></a>## DESCRIPTION

Please use the [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60102.md) instead of this proc.

Starts a fragment source that gets its data from a ring buffer.  For
            more on ring fragment sources see:
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11610.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11610.md#sec_tsextractors)
