...
[← Eventbuilder callback bundle](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60470.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::stop →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60494.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60278.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60102.md) to create the ring
             sources.
