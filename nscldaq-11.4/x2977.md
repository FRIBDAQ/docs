...
It is also possible to write slow controls drivers in Tcl and
            [[*Writing Tcl slow controls device drivers*|x3404]]
...
[[![(1)](../images/callouts/1.gif)|x2977#ccusb-slowdriver-includes-tcl.h]]                            Since our driver will get loaded via the Tcl
                        ...
                        [[![(2)](../images/callouts/2.gif)|x2977#ccusb-slowdriver-includes-CModuleFactory.h]]                            The `CModuleFactory` class is
...
[[![(3)](../images/callouts/3.gif)|x2977#ccusb-slowdriver-includes-CModuleCreator.h]]                            This header defines the base class for all module
                            ...
                            our own creator. (see
                            [[*CModuleCreator*|r60402]]
                            )
                        [[![(4)](../images/callouts/4.gif)|x2977#ccusb-slowdriver-includes-CControlHardware.h]]                            Drivers are classes that are derived from
                            ...
                            (see
                            [[*CControlHardware*|r60455]]
[[![(5)](../images/callouts/5.gif)|x2977#ccusb-slowdriver-includes-CControlModule.h]]                            The makeup of a `CControlHardware`
...
[[![(1)](../images/callouts/1.gif)|x2977#ccusb-slowdriver-def-subclass]]                                As we mentioned earlier, all slow controls device
                            ...
                            [[![(2)](../images/callouts/2.gif)|x2977#ccusb-slowdriver-def-m_pConfig]]                                Each driver class has associated with it a
...
[[![(3)](../images/callouts/3.gif)|x2977#ccusb-slowdriver-def-noimplementation]]                                If not defined, the methods in this section will
...
[[![(4)](../images/callouts/4.gif)|x2977#ccusb-slowdriver-def-onattach]]                                The `OnAttach` method is
...
[[![(5)](../images/callouts/5.gif)|x2977#ccusb-slowdriver-def-initialize]]                                Some devices require a one-time initialization
                            ...
                            [[![(7)](../images/callouts/7.gif)|x2977#ccusb-slowdriver-def-set]]                                This method is called when a client wants to set
                            ...
                            [[![(8)](../images/callouts/8.gif)|x2977#ccusb-slowdriver-def-get]]                                This method is called when a client wants to read
                                a parameter controlled by this driver instance.
                                Normally this means reading a register or set of
                                registers from the hardware.
                            [[![(9)](../images/callouts/9.gif)|x2977#ccusb-slowdriver-def-clone]] `clone` is intended to
...
**Construction and destruction. **
                            See
                            [[*The constructor and destructor*|x2977#ccusb-slowdriver-impl-condestruct]]
...
[[![(1)](../images/callouts/1.gif)|x2977#ccusb-slowdriver-impl-constr-baseinit]]                                The constructor must initialize the base
                            ...
                            [[![(2)](../images/callouts/2.gif)|x2977#ccusb-slowdriver-impl-constr-configinit]]                                The `m_pConfig` member variable
                            ...
                            [[![(3)](../images/callouts/3.gif)|x2977#ccusb-slowdriver-impl-destruct]]                                If the driver needs to create any dynamic data
...
[[![(1)](../images/callouts/1.gif)|x2977#cccusb-slowdriver-impl-set-configure]]                                Our driver uses the configuration database
...
[[![(2)](../images/callouts/2.gif)|x2977#cccusb-slowdriver-impl-set-error]]                                The string result of the method is used to report
...
[[![(3)](../images/callouts/3.gif)|x2977#cccusb-slowdriver-impl-set-ok]]                                On success, the `Set`
...
[[![(1)](../images/callouts/1.gif)|x2977#ccusb-slowdriver-impl-get-cget]]                                Since our device uses its configuration parameters
...
[[![(2)](../images/callouts/2.gif)|x2977#ccusb-slowdriver-impl-get-error]]                                The `cget` method throws
...
[[![(1)](../images/callouts/1.gif)|x2977#ccusb-slowdriver-init-externc]]                                This line and the closing brace at the end of
...
[[![(2)](../images/callouts/2.gif)|x2977#ccusb-slowdriver-init-name]]                                Since the driver will be encapsulated in a package
                            ...
                            [[![(5)](../images/callouts/5.gif)|x2977#ccusb-slowdriver-init-factadd]]                                This line instantiates a creator for the sample
...
[[![(1)](../images/callouts/1.gif)|x2977#ccusb-slowdriver-makefile-instdir]]                            This line defines the top level directory of the NSCLDAQ
...
[[![(2)](../images/callouts/2.gif)|x2977#ccusb-slowdriver-makefile-sources]]                            This line should contain a space separated list
                        ...
                        [[![(3)](../images/callouts/3.gif)|x2977#ccusb-slowdriver-makefile-pkginfo]]                            The part of the Makefile that generates the
