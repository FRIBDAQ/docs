...
[← The SBS Readout framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11927.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The SBS Readout framework →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11944.md)
...
# <a name="AEN11954"></a>69.1. SBS Readout concepts
...
- size_t `read`(
  ...
  The base class, `CEventSegment`
                              ...
                              the manpage 
                              [*CEventSegment*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r84291.md)
...
For reference information on this class see:
            ...
            via the [CDocumentedPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r83890.md).
            The [CEventPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r84163.md)
...
For reference information about the `CCompoundEventSegment`
            class see
            [CCompoundEventSegment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r83610.md).

The readout software has a single object from the
            [CExperiment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r84612.md)
...
See the section:
            [Modifying the skeleton application to meet your needs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x12364.md)
...
For reference information see
            [CScalerBank](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85079.md)
...
The readout framework provides
            [`CCAENV262Busy`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r83361.md),
            and
            [`CV977Busy`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85467.md) as
...
<a name="AEN12276"></a>**Example 69-1. Passing the ring buffer to the construction of an Event segment.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring-normal-stuff)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring-getring)
...
<a name="AEN12312"></a>**Example 69-2. Creating Events**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring_getevtcount)
  To set up for the loop that emits ring items we first
                          fetch the number of events that have been read.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring_geteventinfo)
  This section of code gets the informatino about the event
                          ...
                          variable.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring_makeitem)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring_fillitem)
  The `getBodyCursor` method
                          ...
                          event data.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring_updatecursor)
  This line computes a pointer to the first unused byte
                          ...
                          to put its data.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring_commit)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11943.md#specialring_bookkeeping)
