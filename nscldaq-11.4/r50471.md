...
[← CZMQRouterTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50463.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CParallelWorker →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50474.md)

---

---

# <a name="AEN50471"></a>CZMQDealerTransport

<a name="AEN50475"></a>## Name

CZMQDealerTransport -- Peer, receiver for CZMQRouterTransport(3daq)

<a name="AEN50478"></a>## Synopsis
