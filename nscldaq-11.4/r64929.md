...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64928.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [PortManager →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64930.md)
...
<a name="AEN64943"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN64946"></a>## Synopsis
...
<a name="AEN64960"></a>## METHODS



- <a name="AEN64965"></a>`PortManager(string host, int    port);`
