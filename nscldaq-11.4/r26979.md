...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r27136]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r27136]].
...
[[portAllocator(3tcl)|r79064]],
            [[CPortManagerException(3daq)|r27136]],
            [[DaqPortManager(1tcl)|r17368]]
