...
[← CZMQCommunicatorFactory](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50923.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CZMQRouterTransport →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50925.md)

---

---

# <a name="AEN50924"></a>CThreadedProcessingElement

<a name="AEN50928"></a>## Name

CThreadedProcessingElement -- Run a processing element ina thread.

<a name="AEN50931"></a>## Synopsis
