...
[← init](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64650.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [capabilities →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64679.md)
...
<a name="AEN64702"></a>## CAPABILITIES
...
- runsHaveTitles
  If true the provider will honor the
                              ...
                              [*begin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64519.md)
                              command.
- runsHaveNumbers
