...
<a name="AEN27715"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN27718"></a>## Synopsis
...
<a name="AEN27944"></a>## Public member functions





<a name="AEN27950"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28012"></a>`unsigned long getBase(void);`
...
<a name="AEN28023"></a>`int getSerial(void);`
...
<a name="AEN28054"></a>`int  getFirmware(void);`
...
<a name="AEN28064"></a>`int  getCrate(void);`
...
<a name="AEN28075"></a>`void setCrate(int crateNum);`
...
<a name="AEN28088"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN28109"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN28119"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN28129"></a>`void keepOverflowData(void);`
...
<a name="AEN28139"></a>`void discardOverflowData(void);`
...
<a name="AEN28149"></a>`void keepInvalidData(void);`
...
<a name="AEN28160"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN28171"></a>`void commonStart(void);`
...
<a name="AEN28182"></a>`void commonStop(void);`
...
<a name="AEN28193"></a>`void setRange(int range);`
...
<a name="AEN28206"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN28278"></a>`void clearData
                                (void);`
...
<a name="AEN28321"></a>`bool Busy(void);`
...
<a name="AEN28332"></a>` bool gBusy(void);`
...
<a name="AEN28343"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN28354"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN28365"></a>`int readEvent(void* buf);`
...
<a name="AEN28378"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN28419"></a>`void enableSmallThresholds(void);`
...
<a name="AEN28482"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN28486"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN28490"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN28494"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN28498"></a>**Example 3. Reading out a CAEN 785 e.g.**
