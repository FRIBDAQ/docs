...
[← CScaler](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85793.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CV977Busy →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85823.md)
...
<a name="AEN85808"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN85811"></a>## Synopsis
...
<a name="AEN85859"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85080.md)).
