...
[← DataSourceUI](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61462.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::configParams →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61473.md)
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61143.md).

<a name="AEN61493"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61143.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61574.md)).
