...
[← EVBC::initialize](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60277.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ph7106Widget →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60283.md)
...
<a name="AEN60292"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN60295"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN60299"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59957.md).

<a name="AEN60307"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59957.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60388.md)).
