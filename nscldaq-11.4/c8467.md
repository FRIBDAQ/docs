...
[← Networked ring buffer access](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8410.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring Buffer Primitives →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8471.md)
...
Reference material can be found in the
        [CRingBuffer reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19850.md)

# <a name="AEN8481"></a>40.1. Incorporating ring buffer software
...
<a name="AEN8488"></a>**Example 40-1. Compilation line for ring buffer primitives**
...
<a name="AEN8494"></a>**Example 40-2. Including the ring buffer primitives header**
...
<a name="AEN8500"></a>**Example 40-3. Linking to the ring buffer primitives**
