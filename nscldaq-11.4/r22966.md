...
[← CDataFormatItem](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r22908.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAbnormaEndItem →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r22967.md)
...
<a name="AEN22980"></a>## Name

CAbnormalEndItem -- Abnormal end of run.

<a name="AEN22983"></a>## Synopsis

```
CAbnormalEnditem
```

<a name="AEN23057"></a>## DESCRIPTION

Provides a class for objects that represent abnormal end of run
            ring items.

<a name="AEN23060"></a>## METHODS
