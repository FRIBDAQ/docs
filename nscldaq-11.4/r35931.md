...
[← CVME](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35930.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMETrigger →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35960.md)
...
<a name="AEN35945"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN35948"></a>## Synopsis
...
<a name="AEN36055"></a>## Public member functions



- <a name="AEN36060"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN36098"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN36113"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN36126"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN36139"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN36184"></a>`T*  T* operator-> (void);`
...
- <a name="AEN36194"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN36209"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36221"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN36233"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36245"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN36255"></a>## Types and public data
