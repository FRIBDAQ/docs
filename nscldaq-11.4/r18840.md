...
[← vmusbcaenupgrader](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18834.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SBS Vme Tcl package →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18844.md)
...
<a name="AEN18912"></a>### Map access command
...
<a name="AEN18922"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN18930"></a>***mapname* put *width offset value***
