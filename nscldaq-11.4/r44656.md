...
[← CTCLException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44647.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPNoSuchService →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44660.md)
...
<a name="AEN44670"></a>## Name

CTCPNoSuchService -- Exception thrown if a nonexistent service is referenced

<a name="AEN44673"></a>## Synopsis

```
CTCPNoSuchService
```

<a name="AEN44698"></a>## DESCRIPTION
