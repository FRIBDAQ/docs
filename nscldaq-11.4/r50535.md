...
[← CZMQDealerTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50534.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CReceiver →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50550.md)

---

---

# <a name="AEN50535"></a>CZMQDealerTransport

<a name="AEN50539"></a>## Name

CZMQDealerTransport -- Peer, receiver for CZMQRouterTransport(3daq)

<a name="AEN50542"></a>## Synopsis
