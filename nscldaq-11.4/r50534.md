...
[← CClientRegistry](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50491.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CZMQDealerTransport →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50535.md)

---

---

# <a name="AEN50534"></a>CZMQDealerTransport

<a name="AEN50538"></a>## Name

CZMQDealerTransport -- Peer, receiver for CZMQRouterTransport(3daq)

<a name="AEN50541"></a>## Synopsis
