...
<a name="AEN39541"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN39544"></a>## Synopsis
...
<a name="AEN39586"></a>## Public member functions
...
<a name="AEN39624"></a>`void sync_self(void);`
...
<a name="AEN39631"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN39639"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39651"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN39657"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN39667"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39697"></a>`void sync_global_end(void);`
