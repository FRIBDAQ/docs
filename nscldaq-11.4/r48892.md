...
[← CStreamIOError](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48887.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48893.md)
...
<a name="AEN49002"></a>## Public member functions
...
<a name="AEN49113"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN49118"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48159.md)
