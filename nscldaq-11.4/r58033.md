...
<a name="AEN58047"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN58050"></a>## Synopsis
...
<a name="AEN58219"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r52997]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r58768]])
...
<a name="AEN58227"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r58768]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r58768]] for
...
<a name="AEN58679"></a>## DEVICE ENUMERATION
...
<a name="AEN58703"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN58713"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN58719"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r56246]] for reference
...
<a name="AEN58762"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r52997]]
[[cccusbreadoutlist(3ccusb)|r58768]]
[[CCCUSBReadoutList(3ccusb)|r56246]]
