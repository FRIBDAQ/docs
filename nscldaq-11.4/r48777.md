...
[← CStateException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48714.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStateException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48778.md)
...
<a name="AEN48791"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN48794"></a>## Synopsis

```
CStateException
```

<a name="AEN48824"></a>## Description
...
<a name="AEN48834"></a>## Public member functions
