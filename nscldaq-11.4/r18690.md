...
[← SBS Vme Tcl package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18689.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingAccess →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18704.md)
...
<a name="AEN18704"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN18707"></a>## Synopsis
...
<a name="AEN18762"></a>### Map access command
...
<a name="AEN18772"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN18780"></a>***mapname* put *width offset value***
