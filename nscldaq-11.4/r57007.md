...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r56996.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r57011.md)
...
<a name="AEN57021"></a>## Name

CCCUSBusb -- Provide access to a connected CC-USB device.

<a name="AEN57024"></a>## Synopsis

```
CCCUSBusb
```

<a name="AEN57088"></a>## DESCRIPTION
