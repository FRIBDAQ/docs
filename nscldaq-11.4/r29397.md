...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29247.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29401.md)
...
<a name="AEN29536"></a>## Public member functions





- <a name="AEN29542"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN29554"></a>`bool Xtest(void);const`
...
- <a name="AEN29566"></a>`bool Qtest(void);const`
...
- <a name="AEN29583"></a>`bool TimedOut(void);const`
...
- <a name="AEN29595"></a>`bool BranchDemand(void);const`
...
- <a name="AEN29607"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN29621"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN29634"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN29648"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN29663"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN29678"></a>`bool IT4(void);const`
...
- <a name="AEN29692"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN29703"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN29716"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN29732"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN29743"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN29754"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN29764"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN29768"></a>**Example 1. Initializing branch 0**
