...
[← CCAMACScalerLRS4434](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33072.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACScalerLRS2551 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33166.md)
...
<a name="AEN33089"></a>## Name

CCamac -- Manages CAMAC memory maps.

<a name="AEN33092"></a>## Synopsis
...
<a name="AEN33123"></a>## Public member functions



- <a name="AEN33128"></a>`static void  BranchInit(int nBranch);`
...
- <a name="AEN33140"></a>`static void  BranchRelease(int nBranch);`
...
- <a name="AEN33152"></a>`static long*  Base(int nBranch);`
