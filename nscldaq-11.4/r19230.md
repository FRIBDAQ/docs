...
[← vmusbcaenupgrader](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19203.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3daq →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19351.md)
...
<a name="AEN19244"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN19247"></a>## Synopsis
...
<a name="AEN19323"></a>## Public member functions
...
<a name="AEN19414"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN19418"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN19422"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
