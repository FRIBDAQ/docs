...
[← EVBC::initialize](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60954.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQParameters →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60968.md)
...
<a name="AEN60969"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN60972"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN60976"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60634.md).

<a name="AEN60984"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60634.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61065.md)).
