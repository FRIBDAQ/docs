...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29401.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29624.md)
...
<a name="AEN29942"></a>## Public member functions
...
- <a name="AEN29949"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN29970"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN29983"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN30008"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN30019"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN30352"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN30365"></a>` ECLOutputSelect
...
- <a name="AEN30433"></a>` unsigned short
...
- <a name="AEN30597"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30609"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30619"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30629"></a>` TriggerConfiguration
...
- <a name="AEN30726"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN30750"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN30767"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN30793"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN30807"></a>` PWResolution
...
- <a name="AEN30923"></a>` void EnableBypassOnError(void);`
...
- <a name="AEN30967"></a>` unsigned short
...
- <a name="AEN31061"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN31073"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN31090"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN31103"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN31115"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN31136"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN31148"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31163"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31178"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31193"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN31205"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN31220"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN31230"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN31242"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN31254"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN31266"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN31278"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN31288"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN31298"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN31308"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN31318"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN31330"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN31340"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN31350"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN31360"></a>` void EnableBypassOnError(void);`
- <a name="AEN31370"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN31380"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN31392"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN31402"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN31414"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN31424"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN31436"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN31448"></a>` void EnableAllChannels(void);`
- <a name="AEN31458"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN31468"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN31480"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN31492"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN31507"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN31519"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31531"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31552"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31565"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31582"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31600"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31615"></a>## Types and public data
