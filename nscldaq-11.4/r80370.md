...
[← TclServer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80353.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [iSegVhs →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80382.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80656.md)
        for one such panel.
...
<a name="AEN80417"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN80421"></a>### VhsWidgets::channel
...
<a name="AEN80441"></a>### VhsWidgets::channelStatus options
...
<a name="AEN80447"></a>## OBJECT METHODS
...
<a name="AEN80451"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN80454"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r79856.md)
