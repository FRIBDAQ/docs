...
[← EVBC::startS800Source](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60184.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startRingSource →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60190.md)
...
<a name="AEN60203"></a>## Name

EVBC::startRingSource -- Start a ring fragment source for the event builder.

<a name="AEN60206"></a>## Synopsis

**
EVBC::startRingSource *source-uri extractor-lib source-id info*
**

<a name="AEN60210"></a>## DESCRIPTION

Please use the [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60101.md) instead of this proc.

Starts a fragment source that gets its data from a ring buffer.  For
            more on ring fragment sources see:
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11609.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11609.md#sec_tsextractors)
