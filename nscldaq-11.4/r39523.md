...
[← CBufferQueue](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39514.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39527.md)
...
<a name="AEN39537"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN39540"></a>## Synopsis
...
<a name="AEN39582"></a>## Public member functions
...
<a name="AEN39620"></a>`void sync_self(void);`
...
<a name="AEN39627"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN39635"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39647"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN39653"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN39663"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39693"></a>`void sync_global_end(void);`
