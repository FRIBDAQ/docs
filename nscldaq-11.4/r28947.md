...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28884.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28948.md)
...
<a name="AEN29479"></a>## Public member functions
...
- <a name="AEN29486"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN29507"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN29520"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN29545"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN29556"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN29889"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN29902"></a>` ECLOutputSelect
...
- <a name="AEN29970"></a>` unsigned short
...
- <a name="AEN30134"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30146"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30156"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30166"></a>` TriggerConfiguration
...
- <a name="AEN30263"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN30287"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN30304"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN30330"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN30344"></a>` PWResolution
...
- <a name="AEN30504"></a>` unsigned short
...
- <a name="AEN30598"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN30610"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN30627"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN30640"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN30652"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN30673"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN30685"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30700"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30715"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30730"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN30742"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN30757"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN30767"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN30779"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN30791"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN30803"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN30815"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN30825"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN30835"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN30845"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN30855"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN30867"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN30877"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN30887"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN30897"></a>` void EnableBypassOnError(void);`
- <a name="AEN30907"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN30917"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN30929"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN30939"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN30951"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN30961"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN30973"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN30985"></a>` void EnableAllChannels(void);`
- <a name="AEN30995"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN31005"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN31017"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN31029"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN31044"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN31056"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31068"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31089"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31102"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31119"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31137"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31152"></a>## Types and public data
