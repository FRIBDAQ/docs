...
[← EVBC::startRingSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60867.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onEnd →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60879.md)
...
<a name="AEN60883"></a>## Name

Configuration -- Configuration variable management

<a name="AEN60886"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62534.md) package for that
            instead.

<a name="AEN60909"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62534.md) is a better
                          choice).
