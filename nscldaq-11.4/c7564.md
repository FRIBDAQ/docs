...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c7538.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c7628.md)

---

---

# <a name="ch.dumper"></a>Chapter 20. The dumper program
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14117.md).
...
<a name="AEN7578"></a>**Example 20-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN7582"></a>**Example 20-2. Dumping data from the event file segment
...
# <a name="AEN7592"></a>20.1. Item dump formats and examples
...
<a name="AEN7595"></a>**Example 20-3. State Transition items**
...
<a name="AEN7600"></a>**Example 20-4. Text List items**
...
<a name="AEN7605"></a>**Example 20-5. Incremental Scalers dump**
...
<a name="AEN7611"></a>**Example 20-6. Event count items**
...
<a name="AEN7617"></a>**Example 20-7. Physics Event items**
...
<a name="AEN7622"></a>**Example 20-8. Unknown item types**
