...
[← 3rdogui](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60857.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startRingSource →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60866.md)
...
<a name="AEN60873"></a>## Name

Introduction -- ReadoutGUI API introduction

<a name="AEN60876"></a>## DESCRIPTION
...
- bells
  This package provides the `bells`
                              ...
                              some pattern.
  See
                              [*bells*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60973.md)
...
- Configuration
  ...
  See
                              [*Configuration*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61094.md)
                              for reference information.
- DAQParameters
  Provides access to parameters that affect data taking.
                              ...
                              above.
  See
                              [*DAQParameters*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61193.md)
                              for reference information.
- DataSourceManager
  ...
  See
                              [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61371.md)
- DataSourceUI
  ...
  See
                              [*DataSourceUI*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61623.md)
- Diagnostics
  Provides simple error/warning/info dialogs.
                              See:
                              [*Diagnostics*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61952.md)
- ExpFileSystemConfig
  Provides read/write access to configuration parameters
                              that determine where event data and related meta-data
                              are stored.
                              See:
                              [*ExpFileSystemConfig*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62027.md)
- ReadoutGUI
  Provides the readout GUI application class which
                              strings everything together. See
                              [*ReadoutGui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62116.md)
- ReadoutGUIPanel
  Provides a group of API elements that allow you
                              ...
                              object.
                              See:
                              [*ReadoutGUIPanel*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62267.md)
- RunstateMachine
...
- StateManager
  ...
  See
                              [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62759.md)
- ui
  ...
  See
                              [*ui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62920.md)
