...
[← Setting up an XLM72 as a gate delay generator for remote control](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x7416.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Overview of Functionality →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x7450.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/figures/gd16_startup.png)
...
To write the state of the GUI to a configuration file, you should simply
      ...
      displayed in the GUI. See the section [*The Saved File*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x7455.md)
