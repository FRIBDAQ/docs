...
<a name="AEN59293"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN59296"></a>## Synopsis
...
<a name="AEN59465"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r54243]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r60014]])
...
<a name="AEN59473"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r60014]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r60014]] for
...
<a name="AEN59925"></a>## DEVICE ENUMERATION
...
<a name="AEN59949"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN59959"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN59965"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r57492]] for reference
...
<a name="AEN60008"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r54243]]
[[cccusbreadoutlist(3ccusb)|r60014]]
[[CCCUSBReadoutList(3ccusb)|r57492]]
