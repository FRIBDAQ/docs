...
[← format  Functions](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r24382.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDesiredTypesPredicate →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r24385.md)
...
<a name="AEN24397"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN24400"></a>## Synopsis
...
<a name="AEN24402"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN24413"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN24447"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN24467"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN24513"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN24519"></a>`pGlomParameters
...
<a name="AEN24533"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN24553"></a>`pEventBuilderFragment
...
<a name="AEN24573"></a>` pPhysicsEventItem
...
<a name="AEN24593"></a>` pPhysicsEventCountItem
...
<a name="AEN24686"></a>` pStateChangeItem
...
<a name="AEN24718"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN24726"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN24732"></a>## DESCRIPTION
...
- <a name="AEN24740"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN24761"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN24816"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN24852"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN24892"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN24945"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN24961"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN24988"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN25020"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN25046"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN25075"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN25223"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN25275"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN25286"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
