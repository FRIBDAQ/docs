...
[← CZMQRouterTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51290.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CZMQRouterTransport →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51294.md)

---

---

# <a name="AEN51293"></a>CDataSinkElement

<a name="AEN51297"></a>## Name

CDataSinkElement -- Forward data to some sink.

<a name="AEN51300"></a>## Synopsis
