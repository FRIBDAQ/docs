...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28506.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28570.md)
...
<a name="AEN28708"></a>## Public member functions





- <a name="AEN28714"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN28726"></a>`bool Xtest(void);const`
...
- <a name="AEN28738"></a>`bool Qtest(void);const`
...
- <a name="AEN28755"></a>`bool TimedOut(void);const`
...
- <a name="AEN28767"></a>`bool BranchDemand(void);const`
...
- <a name="AEN28779"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN28793"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN28806"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN28820"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN28835"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN28850"></a>`bool IT4(void);const`
...
- <a name="AEN28864"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN28875"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN28888"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN28904"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN28915"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN28926"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN28936"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN28940"></a>**Example 1. Initializing branch 0**
