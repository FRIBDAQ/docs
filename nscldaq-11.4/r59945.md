...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59893.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59946.md)
...
<a name="AEN59959"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN59962"></a>## Synopsis

```
CControlHardware
```

<a name="AEN60029"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59785.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59892.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN60036"></a>## METHODS
