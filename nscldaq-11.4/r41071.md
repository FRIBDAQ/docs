...
[← CFdInteractor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41044.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTclAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41075.md)
...
<a name="AEN41123"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44950.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10835.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r45730.md).
...
<a name="AEN41173"></a>## Types and public data
