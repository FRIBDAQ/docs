...
<a name="AEN32527"></a>## Public member functions



<a name="AEN32532"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN32560"></a>`void  Enable(int nChannel);`
...
<a name="AEN32575"></a>`void  Disable(int nChannel);`
...
<a name="AEN32590"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN32603"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN32615"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN32627"></a>`void   SetWide (void);`
...
<a name="AEN32639"></a>`void   SetNarrow (void);`
...
<a name="AEN32650"></a>`void  EnableHeader (void);`
...
<a name="AEN32728"></a>`bool  isFull (void);`
...
<a name="AEN32740"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN32752"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN32845"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN32859"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
