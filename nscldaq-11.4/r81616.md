...
[← caennet](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81600.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VhsWidgets →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81620.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81902.md)
        for one such panel.
...
<a name="AEN81663"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN81667"></a>### VhsWidgets::channel
...
<a name="AEN81687"></a>### VhsWidgets::channelStatus options
...
<a name="AEN81693"></a>## OBJECT METHODS
...
<a name="AEN81697"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN81700"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81102.md)
