...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r27813]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r27813]].
...
[[portAllocator(3tcl)|r79741]],
            [[CPortManagerException(3daq)|r27813]],
            [[DaqPortManager(1tcl)|r18045]]
