...
[← ccusb (command)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51616.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CZMQRingItemSourceThread →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51633.md)

---

---

# <a name="AEN51629"></a>CZMQRingItemSourceThread

<a name="AEN51633"></a>## Name

CZMQRingItemSourceThread -- Provide a thread that routes ring items from a source

<a name="AEN51636"></a>## Synopsis
