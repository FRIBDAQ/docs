...
<a name="AEN21791"></a>## Public member functions
...
<a name="AEN22009"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN22012"></a>**Example 1. Creating a begin run state transition item**
