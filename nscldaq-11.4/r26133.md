...
[← CDataSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26130.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSource →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26134.md)
...
<a name="AEN26147"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN26150"></a>## Synopsis

```
CDataSink
```

<a name="AEN26175"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26467.md)
