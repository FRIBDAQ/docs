...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r27964]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r27964]].
...
[[portAllocator(3tcl)|r80247]],
            [[CPortManagerException(3daq)|r27964]],
            [[DaqPortManager(1tcl)|r18196]]
