...
[← CScalerBank](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85080.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CScaler →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85117.md)
...
<a name="AEN85130"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN85133"></a>## Synopsis
...
<a name="AEN85181"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r84402.md)).
