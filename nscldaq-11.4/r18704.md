...
[← SBS Vme Tcl package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18690.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [n568Control →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18707.md)
...
<a name="AEN18718"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN18721"></a>## Synopsis
...
The chapter:
            [Networed Ring Buffer Access](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8406.md)
            includes sample code for detecting and mapping the use of a system's
            hostname into localhost.

<a name="AEN18797"></a>## Public member functions
...
<a name="AEN18888"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN18892"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN18896"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
