...
[← CRingScalerItem](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21009.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingTextItem →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21120.md)
...
<a name="AEN21195"></a>## Public member functions
...
<a name="AEN21405"></a>## Types and public data

See the ScalerItem type in
            <DataFormat.h>.

<a name="AEN21410"></a>## Exceptions
...
<a name="AEN21431"></a>**Example 1. Constructing a scaler item from an item gotten from a ring**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21010.md#scaler.allpred)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21010.md#scaler.get)
  Gets the next item from the ring, regardless of type.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21010.md#scaler.isscaler)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21010.md#scaler.construct)
  If the item is a scaler item, it is converted into a
                      `CScalerItem`
                      and processed.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21010.md#scaler.delete)
