...
[← SoftwareTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14881.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EventFilter →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14939.md)
...
<a name="AEN14905"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN14908"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN14913"></a>## DESCRIPTION
...
<a name="AEN14935"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN14938"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN14941"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN14944"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN14947"></a>## DEPENDENCIES
