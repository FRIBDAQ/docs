...
### <a name="AEN1655"></a>4.9.1.1. Driver requirements

A Slow controls device driver is a class that is derived from
          the 
          [[r74999]] abstract base class.
...
The [[r74999]] class is an abstract
...
#### <a name="AEN1783"></a>4.9.1.1.1. The driver
...
<a name="AEN1786"></a>**Example 4-14. Control driver headers**
...
<a name="AEN1805"></a>**Example 4-15. Control driver class definition**
...
<a name="AEN1812"></a>**Example 4-16. Control driver constructor**
...
<a name="AEN1816"></a>**Example 4-17. Control driver `onAttach` method**
...
[[x1616#ctldriver-onattach-saveconfig]]		  The base class (`CControlHardware`) 
...
<a name="AEN1839"></a>**Example 4-18. Control driver `Update`**
...
<a name="AEN1851"></a>**Example 4-19. Control driver `Set` method.**
...
<a name="AEN1901"></a>**Example 4-20. Control driver `Get` method**
...
<a name="AEN1935"></a>**Example 4-21. Control driver `clone` method**
...
#### <a name="AEN1946"></a>4.9.1.1.2. The creator
...
<a name="AEN1949"></a>**Example 4-22. Control driver creator**
...
<a name="AEN1984"></a>**Example 4-23. Control driver initialization**
...
[[x1616#ctldriver-init-cbinding]]		    The Tcl interpreter needs to be able to compute
		  ...
		  [[x1616#ctldriver-init-factget]]		    The main work of the intitialization function is to register
		    ...
		    of the factory.
		  [[x1616#ctldriver-init-creator]]		    Registers the new creator object associating it with the
		    module type mydriver
[[x1616#ctldriver-init-status]]		    Returns a normal status value.

#### <a name="AEN2028"></a>4.9.1.1.4. Building the driver and using it.
...
<a name="AEN2096"></a>**Example 4-24. Control drivers - structure of a Tcl driver**
...
### <a name="AEN2143"></a>4.9.2.1. Initialize

The full implementation of the `Initialize` is shown
	  below:

<a name="AEN2147"></a>**Example 4-25. Tcl control driver `Initialize` method**
...
### <a name="AEN2176"></a>4.9.2.3. The Set method
...
<a name="AEN2180"></a>**Example 4-27. Tcl control driver `Set` method**
...
### <a name="AEN2200"></a>4.9.2.4. The Get method
...
<a name="AEN2203"></a>**Example 4-28. Tcl control driver `Get` method**
...
### <a name="AEN2218"></a>4.9.2.5. The addMonitorList method

Since we are not using monitor lists, this method is trivial:

<a name="AEN2221"></a>**Example 4-29. Tcl control drer `addMonitorList` method**
...
### <a name="AEN2228"></a>4.9.2.6. The processMonitorList method
...
<a name="AEN2232"></a>**Example 4-30. Tcl control driver `processMonitorList` method**
...
### <a name="AEN2236"></a>4.9.2.7. The getMonitoredData method
...
<a name="AEN2244"></a>**Example 4-31. Tcl control driver `getMonitoredData` method**
...
### <a name="AEN2248"></a>4.9.2.8. Validating the command options
...
<a name="AEN2257"></a>**Example 4-32. Tcl control driver validation**
