...
[← ReadoutGUIPanel](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62106.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutGui →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62116.md)
...
<a name="AEN62129"></a>## Name

Configuration -- Configuration variable management

<a name="AEN62132"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63780.md) package for that
            instead.

<a name="AEN62155"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63780.md) is a better
                          choice).
