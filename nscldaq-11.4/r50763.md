...
[← CNullTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50762.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CNullTransport →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50766.md)

---

---

# <a name="AEN50763"></a>CThreadedProcessingElement

<a name="AEN50767"></a>## Name

CThreadedProcessingElement -- Run a processing element ina thread.

<a name="AEN50770"></a>## Synopsis
