...
[← CDataSink](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26347.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingDataSink →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26366.md)
...
<a name="AEN26362"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN26365"></a>## Synopsis

```
CDataSink
```

<a name="AEN26390"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26682.md)
