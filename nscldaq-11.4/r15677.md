...
<a name="AEN15691"></a>## Name

controlpush -- 
            Push epics data into a Tcl Server (e.g. production readout).

<a name="AEN15694"></a>## Synopsis

**controlpush *[options...] files...*
**

<a name="AEN15698"></a>## OPTIONS

Options that govern the actions of the program are:



`-h --help`Writes brief program help to stdout.

`-V --version`Writes the program version number to stdout.

`-pportnum --port=portnum`*portnum* is the number of the port to which
...
`-a` (`--authorize`)Specifies that controlpush is connecting to a Tcl
...
<a name="AEN15769"></a>## CONFIGURATION FILES
...
<a name="AEN15777"></a>## DEPENDENCIES
