...
[← EVBC::onEnd](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61603.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61610.md)
...
<a name="AEN61623"></a>## Name

Configuration -- Configuration variable management

<a name="AEN61626"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63274.md) package for that
            instead.

<a name="AEN61649"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63274.md) is a better
                          choice).
