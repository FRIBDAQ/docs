...
[← CSynchronizedThread](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38492.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Thread →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38511.md)
...
<a name="AEN38507"></a>## Name

CSynchronizedThread -- Thread with synchronized initialization

<a name="AEN38510"></a>## Synopsis

```

```

<a name="AEN38537"></a>## DESCRIPTION

Provides a Thread class (see
            [*Thread*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38350.md)).
