...
<a name="AEN59143"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN59146"></a>## Synopsis
...
<a name="AEN59315"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r54093]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r59864]])
...
<a name="AEN59323"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r59864]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r59864]] for
...
<a name="AEN59775"></a>## DEVICE ENUMERATION
...
<a name="AEN59799"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN59809"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN59815"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r57342]] for reference
...
<a name="AEN59858"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r54093]]
[[cccusbreadoutlist(3ccusb)|r59864]]
[[CCCUSBReadoutList(3ccusb)|r57342]]
