...
[← iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80382.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VhsWidgets →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80434.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80719.md)
        for one such panel.
...
<a name="AEN80480"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN80484"></a>### VhsWidgets::channel
...
<a name="AEN80504"></a>### VhsWidgets::channelStatus options
...
<a name="AEN80510"></a>## OBJECT METHODS
...
<a name="AEN80514"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN80517"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r79919.md)
