...
[← ReadoutGui](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61955.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [bells →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61994.md)
...
<a name="AEN61979"></a>## Name

Configuration -- Configuration variable management

<a name="AEN61982"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63630.md) package for that
            instead.

<a name="AEN62005"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63630.md) is a better
                          choice).
