...
[← CRingAccess](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19444.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingBuffer →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19485.md)
...
<a name="AEN19538"></a>## Public member functions
...
<a name="AEN19629"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN19633"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN19637"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
