...
[← 3provider](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63562.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Introduction →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63564.md)
...
<a name="AEN63577"></a>## Name

Introduction -- Data source providers

<a name="AEN63580"></a>## Synopsis
...
Data source providers are Tcl loadable packages that provide
            ...
            [*SSHPipe*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64050.md)
            which understands how to run command line readout programs on the end
            of a SSH pipeline to a (possibily) remote system, and
            [*s800*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64162.md) which
...
<a name="AEN63633"></a>## CREATING A DATA SOURCE PROVIDER
...
<a name="AEN63650"></a>## API FUNCTIONS
...
- **parameters**
  Each data source a data source provider starts may
                              ...
                              command connections.
                              [*parameters*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63723.md)
...
- **check** *sourceId*
  Whatever code is managing a set of data providers
                              ...
                              has exited.
                              [*check*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63779.md)
                              returns a true value if a source is still running and
                              false if not.
- **stop** *sourceId*
  [*stop*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63811.md)
                              Stops the specified data source.
- **begin** *sourceId runNumber title*
  Starts data taking for a new run.
                              See [*begin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63842.md)
                              for reference information.
- **pause** *sourceId*
  If your data source implements pause/resume functionality
                              you must define this command to pause the run.
                              See the 
                              [*pause*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63873.md)
...
- **end** *sourceId*
  The
                              [*end*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63943.md)
                              ends a run in a data source.
- **init** *sourceId*
  The
                              [*init*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63972.md)
                              causes an initialize procedure in the data source.
- **capbilities**
  Describes the data
                              [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64001.md)
                              source capabilities.
