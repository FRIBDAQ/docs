...
[← EVBC::flush](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60079.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::registerRingSource →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60102.md)
...
The registerRingSource proc registers information to the
             [*RingSourceMgr*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60564.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11609.md#sec_tsextractors) describes how
