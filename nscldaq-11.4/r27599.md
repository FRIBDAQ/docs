...
[← FragmentIndex](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27596.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [FragmentIndex →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27600.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27442.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN27669"></a>## Public member functions
...
<a name="AEN27725"></a>## Types and public data
...
<a name="AEN27745"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN27748"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r79527.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27442.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r17831.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48908.md)
