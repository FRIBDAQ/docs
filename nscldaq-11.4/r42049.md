...
[← io](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42041.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [URL →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42142.md)
...
<a name="AEN42063"></a>## Name

CDAQShm -- class description

<a name="AEN42066"></a>## Synopsis
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42049.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42049.md#daqshm-varsrefsect).
