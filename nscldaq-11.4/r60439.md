...
[← EVBC::start](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60419.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::configParams →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60440.md)
...
<a name="AEN60453"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN60456"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN60460"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60118.md).

<a name="AEN60468"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60118.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60549.md)).
