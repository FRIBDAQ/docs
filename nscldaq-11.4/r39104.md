...
[← CriticalSection](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39103.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCondition →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39136.md)
...
<a name="AEN39118"></a>## Name

CriticalSection -- Simple, safe critical section

<a name="AEN39121"></a>## Synopsis

```
CriticalSection
```

<a name="AEN39130"></a>## DESCRIPTION
