...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md#statemgr_vars)
  Creates a namespace for the state variables
                          and declares `var1` and
                          `var2` which will be saved and restored.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md#statemgr_getter)
  The getter uses the name passed to it, and the fact
                          ...
                          **return $::State::$name**
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md#statemgr_setter)
  The setter similarly uses the name and value to update
                          the named variable in the ::State
                          namespace.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md#statemgr_register)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md#statemgr_configfile)
  Before doing saves and restores, the `-file`
                          ...
                          can be written/read.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md#statemgr_save)
...
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md#statemgr_restore)
