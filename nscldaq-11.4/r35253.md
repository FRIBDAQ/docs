...
[← CTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35216.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35254.md)
...
<a name="AEN35267"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN35270"></a>## Synopsis
...
<a name="AEN35377"></a>## Public member functions



- <a name="AEN35382"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN35420"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN35435"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN35448"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN35461"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN35506"></a>`T*  T* operator-> (void);`
...
- <a name="AEN35516"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN35531"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN35543"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN35555"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN35567"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN35577"></a>## Types and public data
