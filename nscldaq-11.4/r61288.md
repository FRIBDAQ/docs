...
[← EVBC::registerRingSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61284.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::initialize →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61310.md)
...
The registerRingSource proc registers information to the
             [*RingSourceMgr*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61751.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11792.md#sec_tsextractors) describes how
