...
[← CRingAccess](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18767.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vhqControl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18778.md)
...
<a name="AEN18782"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN18785"></a>## Synopsis
...
<a name="AEN18861"></a>## Public member functions
...
<a name="AEN18956"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN18960"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
