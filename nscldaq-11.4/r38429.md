...
[← CFilter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38427.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSynchronizedThread →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38492.md)
...
<a name="AEN38443"></a>## Name

CSynchronizedThread -- Thread with synchronized initialization

<a name="AEN38446"></a>## Synopsis

```

```

<a name="AEN38473"></a>## DESCRIPTION

Provides a Thread class (see
            [*Thread*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38286.md)).
