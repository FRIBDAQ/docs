...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r27137]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r27137]].
...
[[portAllocator(3tcl)|r79065]],
            [[CPortManagerException(3daq)|r27137]],
            [[DaqPortManager(1tcl)|r17369]]
