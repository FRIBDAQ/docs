...
[← CVMEScalerLRS1151](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36284.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMmapError →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36306.md)
...
<a name="AEN36338"></a>## Public member functions
...
<a name="AEN36376"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN36379"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
