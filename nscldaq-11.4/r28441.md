...
<a name="AEN28455"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN28458"></a>## Synopsis
...
<a name="AEN28684"></a>## Public member functions





<a name="AEN28690"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28752"></a>`unsigned long getBase(void);`
...
<a name="AEN28763"></a>`int getSerial(void);`
...
<a name="AEN28794"></a>`int  getFirmware(void);`
...
<a name="AEN28804"></a>`int  getCrate(void);`
...
<a name="AEN28815"></a>`void setCrate(int crateNum);`
...
<a name="AEN28828"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN28849"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN28859"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN28869"></a>`void keepOverflowData(void);`
...
<a name="AEN28879"></a>`void discardOverflowData(void);`
...
<a name="AEN28889"></a>`void keepInvalidData(void);`
...
<a name="AEN28900"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN28911"></a>`void commonStart(void);`
...
<a name="AEN28922"></a>`void commonStop(void);`
...
<a name="AEN28933"></a>`void setRange(int range);`
...
<a name="AEN28946"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN29018"></a>`void clearData
                                (void);`
...
<a name="AEN29061"></a>`bool Busy(void);`
...
<a name="AEN29072"></a>` bool gBusy(void);`
...
<a name="AEN29083"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN29094"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN29105"></a>`int readEvent(void* buf);`
...
<a name="AEN29118"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN29159"></a>`void enableSmallThresholds(void);`
...
<a name="AEN29222"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN29226"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN29230"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN29234"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN29238"></a>**Example 3. Reading out a CAEN 785 e.g.**
