...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29624.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29775.md)
...
<a name="AEN30157"></a>## Public member functions
...
- <a name="AEN30164"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN30185"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN30198"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN30223"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN30234"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN30567"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN30580"></a>` ECLOutputSelect
...
- <a name="AEN30648"></a>` unsigned short
...
- <a name="AEN30812"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30824"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30834"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30844"></a>` TriggerConfiguration
...
- <a name="AEN30941"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN30965"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN30982"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN31008"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN31022"></a>` PWResolution
...
- <a name="AEN31182"></a>` unsigned short
...
- <a name="AEN31276"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN31288"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN31305"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN31318"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN31330"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN31351"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN31363"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31378"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31393"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31408"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN31420"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN31435"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN31445"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN31457"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN31469"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN31481"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN31493"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN31503"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN31513"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN31523"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN31533"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN31545"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN31555"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN31565"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN31575"></a>` void EnableBypassOnError(void);`
- <a name="AEN31585"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN31595"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN31607"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN31617"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN31629"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN31639"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN31651"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN31663"></a>` void EnableAllChannels(void);`
- <a name="AEN31673"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN31683"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN31695"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN31707"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN31722"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN31734"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31746"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31767"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31780"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31797"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31815"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31830"></a>## Types and public data
