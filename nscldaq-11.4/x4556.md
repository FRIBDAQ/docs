...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [[developer documentation|c11885]] as well
      in the [[man pages|r61141]].
...
The next thing that you need to do is register clients
      ...
      of how to create one at the [[ringFragmentSource documentation|x11792]].
