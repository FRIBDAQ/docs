...
[← CRangeError](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48630.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48704.md)
...
<a name="AEN48788"></a>## Public member functions
...
<a name="AEN48899"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN48904"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r47945.md)
