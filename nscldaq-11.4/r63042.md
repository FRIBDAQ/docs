...
<a name="AEN63056"></a>## Name

RunStateMachine -- Run control state machine

<a name="AEN63059"></a>## Synopsis
...
<a name="AEN63076"></a>## METHODS and TYPEMETHODS
...
The `RunstateMachine` has a well defined
                ...
                [[*ReadoutShell's state diagram*|c3683#rdogui_statediagram]]
...
<a name="AEN63198"></a>## CALLOUT BUNDLES
...
<a name="AEN63235"></a>**Example 1. A do nothing `RunstateMachine` callout bundle**
...
[[![(1)](../images/callouts/1.gif)|r63042#callout_bundle_require]]                        Requires the run state machine package.  This is needed
                    ...
                    [[![(3)](../images/callouts/3.gif)|r63042#callout_bundle_attach]]                        Defines the **attach** proc of the
                    ...
                    [[![(4)](../images/callouts/4.gif)|r63042#callout_bundle_leave]]                        Defines the **leave** proc of the bundle.
                    ...
                    [[![(7)](../images/callouts/7.gif)|r63042#callout_bundle_register]]                        Registers the bundle with the state machine.  Prior to
