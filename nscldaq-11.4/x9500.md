...
[← Sending data to the event builder.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9414.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event orderer/event builder API →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9504.md)

---

---

# <a name="AEN9500"></a>43.6. The Event orderer/event builder API
...
## <a name="AEN9508"></a>43.6.1. Starting the event builder/orderer
...
<a name="AEN9511"></a>**Example 43-3. Starting the event builder**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9500.md#evb_start_ap)
  Adds the Tcl Library directory of the NSCLDAQ to the
                          ...
                          tclsh or
                          wish starts.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9500.md#evb_start_require)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9500.md#evb_start_start)
