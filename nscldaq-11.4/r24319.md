...
[← CAllButPredicate](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r24200.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DataFormat.h →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r24346.md)
...
<a name="AEN24338"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN24349"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN24383"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN24403"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN24449"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN24455"></a>`pGlomParameters
...
<a name="AEN24469"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN24489"></a>`pEventBuilderFragment
...
<a name="AEN24509"></a>` pPhysicsEventItem
...
<a name="AEN24529"></a>` pPhysicsEventCountItem
...
<a name="AEN24622"></a>` pStateChangeItem
...
<a name="AEN24654"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN24662"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN24668"></a>## DESCRIPTION
...
- <a name="AEN24676"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN24697"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN24752"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN24788"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN24828"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN24881"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN24897"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN24924"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN24956"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN24982"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN25011"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN25159"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN25211"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN25222"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
