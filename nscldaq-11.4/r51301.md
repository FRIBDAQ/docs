...
[← CZMQRouterTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51294.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSourceElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51306.md)
...
<a name="AEN51315"></a>## Name

c257 -- Manages the C257 scaler module

<a name="AEN51318"></a>## Synopsis
...
- `-slot` *slotnumber*
  Specifies `slotnumber` as the CAMAC
...
- `-id` *module-id*
  ...
  Defaults to 0.
- `-insertid` *true|false*
  If this parameter is true the value specified
...
- `-readinhibit` *true | false*
  If this parameter is true (the default), the
