...
[← CNullTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50612.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSinkElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50617.md)

---

---

# <a name="AEN50616"></a>CDataSinkElement

<a name="AEN50620"></a>## Name

CDataSinkElement -- Forward data to some sink.

<a name="AEN50623"></a>## Synopsis
