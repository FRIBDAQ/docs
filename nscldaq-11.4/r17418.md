...
[← VMUSB vmetcl](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r17412.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::outputStats →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r17456.md)
...
<a name="AEN17432"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN17435"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN17442"></a>## DESCRIPTION
