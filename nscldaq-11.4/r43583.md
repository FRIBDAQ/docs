...
[← CTCPConnectionLost](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43520.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPConnectionLost →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43584.md)
...
<a name="AEN43597"></a>## Name

CTCPConnectionLost -- Exception thrown when connection to peer is lost

<a name="AEN43600"></a>## Synopsis

```
CTCPConnectionLost
```

<a name="AEN43632"></a>## DESCRIPTION
...
<a name="AEN43689"></a>## SEE ALSO

[*CSocket*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42488.md)
