...
[← CRingItemSorter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51419.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CThreadedProcessingElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51440.md)

---

---

# <a name="AEN51439"></a>CThreadedProcessingElement

<a name="AEN51443"></a>## Name

CThreadedProcessingElement -- Run a processing element ina thread.

<a name="AEN51446"></a>## Synopsis
