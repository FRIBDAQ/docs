...
[← The Ring Item Types](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x314.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing Tcl slow controls device drivers →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x3404.md)
...
There are a number of frameworks for building C++ applications. First
      there is the [SBS Readout Framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11948.md),
      ...
      data format. To facilitate the design of filter programs, the [Filter framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12472.md) exists. It handles the
