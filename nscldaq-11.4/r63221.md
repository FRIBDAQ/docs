...
[← OutputWindowSettings](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63209.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [OutputWindowSettings →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63272.md)
...
<a name="AEN63235"></a>## Name

ui -- ReadoutGUI graphical user interface elements.

<a name="AEN63238"></a>## Synopsis

**
package require ui
          **

<a name="AEN63241"></a>## DESCRIPTION
...
- [*readoutMenuBar*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_readoutMenubar)
  Provides the menu bar for the application.  This can
                          ...
                          as well.
- [*RunIdentification*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_RunIdentification)
...
- [*RunControl*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_RunControl)
  Provides a megawidget that contains the controls for a run.
                          These are buttons intended to drive the
                          [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62827.md).
...
- [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_StopWatch)
...
- [*ElapsedTimeDisplay*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_ElapsedTimeDisplay)
...
- [*TimedRunControls*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_TimedRunControls)
  ...
  An associated callout bundle hooks the singleton
                          ...
                          timed runs.
- [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_OutputWindow)
  ...
  An associated
                          [*OutputWindowSettings*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63735.md)
...
- [*StatusArea*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63806.md)
...
<a name="AEN63435"></a>### SINGLETON IMPLEMENTATION
...
Makes use of a
                [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md#rdogui3_ui_StopWatch) to provide
...
<a name="AEN63570"></a>### SINGLETON IMPLEMENTATION
...
<a name="AEN63726"></a>### SINGLETON IMPLEMENTATION
