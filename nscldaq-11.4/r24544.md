...
[← CDesiredTypesPredicate](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r24540.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DataFormat.h →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r24560.md)
...
<a name="AEN24558"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN24561"></a>## Synopsis
...
<a name="AEN24563"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN24574"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN24608"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN24628"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN24674"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN24680"></a>`pGlomParameters
...
<a name="AEN24694"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN24714"></a>`pEventBuilderFragment
...
<a name="AEN24734"></a>` pPhysicsEventItem
...
<a name="AEN24754"></a>` pPhysicsEventCountItem
...
<a name="AEN24847"></a>` pStateChangeItem
...
<a name="AEN24879"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN24887"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN24893"></a>## DESCRIPTION
...
- <a name="AEN24901"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN24922"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN24977"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN25013"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN25053"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN25106"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN25122"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN25149"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN25181"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN25207"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN25236"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN25384"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN25436"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN25447"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
