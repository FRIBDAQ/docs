...
[← EVB::lateFragments](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15781.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::inputStatistics::summaryDisplay →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15783.md)
...
<a name="AEN15796"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN15799"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN15804"></a>## DESCRIPTION
...
<a name="AEN15826"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN15829"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN15832"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN15835"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN15838"></a>## DEPENDENCIES
