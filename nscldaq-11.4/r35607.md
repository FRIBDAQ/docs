...
[← CStatusModule](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35603.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEScalerLRS1151 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35608.md)
...
<a name="AEN35660"></a>## Public member functions
...
<a name="AEN35698"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN35701"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
