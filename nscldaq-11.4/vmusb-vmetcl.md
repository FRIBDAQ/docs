...
<a name="AEN18125"></a>## SUBCOMMANDS



**vme create** *name options... base-address size*Creates a new named window in the vme crate address space.
...
<a name="AEN18175"></a>## WINDOW SUB-COMMANDS
...
**get *size offset***Fetches data from the VME bus.  The *size*
...
**put *size offset value***Writes data to the VME bus.  The *size*
