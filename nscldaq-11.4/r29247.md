...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29246.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29397.md)
...
<a name="AEN29386"></a>## Public member functions





- <a name="AEN29392"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN29404"></a>`bool Xtest(void);const`
...
- <a name="AEN29416"></a>`bool Qtest(void);const`
...
- <a name="AEN29433"></a>`bool TimedOut(void);const`
...
- <a name="AEN29445"></a>`bool BranchDemand(void);const`
...
- <a name="AEN29457"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN29471"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN29484"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN29498"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN29513"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN29528"></a>`bool IT4(void);const`
...
- <a name="AEN29542"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN29553"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN29566"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN29582"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN29593"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN29604"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN29614"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN29618"></a>**Example 1. Initializing branch 0**
