...
[← Starting the GUI for USB communication](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x7221.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration menu →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x7263.md)
...
5. The user will then be presented with the following display and should
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/figures/MCFD16Control-MXDCRCBusHowTo-0.png)
