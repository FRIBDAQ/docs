...
# <a name="AEN7238"></a>13.3. Starting the GUI for the RC-bus through an MxDC device
...
5. The user will then be presented with the following display and should
   ...
   <a name="mcfd16control_fig1"></a>**Figure 13-2. MCFD16Control Graphical User Interface for MxDC-RCbus**
