...
<a name="AEN36099"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN36102"></a>## Synopsis
...
<a name="AEN36209"></a>## Public member functions



<a name="AEN36214"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
<a name="AEN36252"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
<a name="AEN36267"></a>`CVME<T>(const CVME& aCVME);`
...
<a name="AEN36280"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
<a name="AEN36293"></a>`int  operator==(const CVME<T>& aCVME);`
...
<a name="AEN36338"></a>`T*  T* operator-> (void);`
...
<a name="AEN36348"></a>`T&  operator[](UInt_t nOffset);`
...
<a name="AEN36363"></a>`CVME<T>& operator+(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN36375"></a>`CVME<T>&  operator-(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN36387"></a>`CVME<T>&  operator+=(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN36399"></a>`CVME<T>&  operator-=(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN36409"></a>## Types and public data
