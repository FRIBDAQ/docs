...
[← CCAMACStatusModule](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32668.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACStatusModule →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32732.md)
...
<a name="AEN32782"></a>## Public member functions



- <a name="AEN32787"></a>`CCAMACStatusModule(unsigned int b, unsigned int c, unsigned int n);`
...
- <a name="AEN32820"></a>`virtual void  GoBusy(void);`
  Pulses the computer going busy output.  This is usually used to indicate
                              ...
                              latch to be busy.
- <a name="AEN32830"></a>`virtual void  GoClear(void);`
...
- <a name="AEN32840"></a>`virtual void  ModuleClear(void);`
