...
[[![(1)](../images/callouts/1.gif)|r63630#statemgr_vars]] Creates a namespace for the state variables
                        and declares `var1` and
                        `var2` which will be saved and restored.
                    [[![(2)](../images/callouts/2.gif)|r63630#statemgr_getter]]                        The getter uses the name passed to it, and the fact
...
[[![(5)](../images/callouts/5.gif)|r63630#statemgr_configfile]]                        Before doing saves and restores, the `-file`
                        ...
                        can be written/read.
                    [[![(6)](../images/callouts/6.gif)|r63630#statemgr_save]]                        Saves the values of `::State::var1`
                    ...
                    [[![(7)](../images/callouts/7.gif)|r63630#statemgr_restore]] **source**s the last configured `-file`
