...
[← CProcessingElement](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49586.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStateException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49609.md)
...
<a name="AEN49619"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN49622"></a>## Synopsis

```
CStateException
```

<a name="AEN49652"></a>## Description
...
<a name="AEN49662"></a>## Public member functions
