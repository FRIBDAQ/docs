...
[← CUnixUserCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40700.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStringInteractor →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40809.md)
...
<a name="AEN40758"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44585.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10835.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r45365.md).
...
<a name="AEN40808"></a>## Types and public data
