...
[← Event orderer packages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11275.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing an event orderer startup script →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11370.md)

---

---

# <a name="AEN11359"></a>64.2. Using the standard event orderer startup script
