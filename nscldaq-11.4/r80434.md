...
[← VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80433.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [n568Panel →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80449.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80720.md)
        for one such panel.
...
<a name="AEN80481"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN80485"></a>### VhsWidgets::channel
...
<a name="AEN80505"></a>### VhsWidgets::channelStatus options
...
<a name="AEN80511"></a>## OBJECT METHODS
...
<a name="AEN80515"></a>**Example 1. Hooking update methods to recurring timer**
