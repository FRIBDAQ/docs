...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64713.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SSHPipe →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64727.md)
...
<a name="AEN64729"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN64732"></a>## Synopsis
...
<a name="AEN64746"></a>## METHODS



- <a name="AEN64751"></a>`PortManager(string host, int    port);`
