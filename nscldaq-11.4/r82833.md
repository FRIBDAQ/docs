...
[← Orphan](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r82832.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV262Busy →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r82846.md)

---

---

# <a name="AEN82833"></a>Orphan

<a name="AEN82837"></a>## Name

Orphan -- Run script when the process is orphaned

<a name="AEN82840"></a>## Synopsis
