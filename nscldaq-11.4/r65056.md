...
[← adc](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65042.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [pause →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65060.md)
...
<a name="AEN65070"></a>## Name

pause -- Pause a data taking run (optional)

<a name="AEN65073"></a>## Synopsis
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65184.md) specifies  the
