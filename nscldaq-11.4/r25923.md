...
[← CRingDataSink](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25904.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSinkFactory →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25941.md)
...
<a name="AEN25937"></a>## Name

CFileDataSink -- Data sink to a disk file.

<a name="AEN25940"></a>## Synopsis

```
CFileDataSink : public CDataSink
```

<a name="AEN25980"></a>## DESCRIPTION
