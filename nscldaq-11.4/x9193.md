...
[← Incorporating the headers and libraries into your applications.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9088.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Generic ring data sinks →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9197.md)
...
For reference information on the data sink classes see:
            [*CDataSink*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26498.md),
            [*CRingDataSink*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26731.md),
            [*CFileDataSink*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26589.md).
            For reference information on the factory class see:
            [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26832.md)
