...
[← CCCUSB](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r53060.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ph7xxx →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r53086.md)
...
<a name="AEN53075"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN53078"></a>## Synopsis

```
CCCUSB
```

<a name="AEN54060"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r56310.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r56310.md) for
...
<a name="AEN54631"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN54635"></a>### Action Register
...
<a name="AEN54678"></a>### Firmware Register
...
<a name="AEN54730"></a>### Global Mode Register
...
<a name="AEN54863"></a>### Delay Register
...
<a name="AEN54896"></a>### Scaler Control register
...
<a name="AEN54929"></a>### LED Source Register
...
<a name="AEN55181"></a>### Output source selection register.
...
<a name="AEN55350"></a>### Device source register
...
<a name="AEN55703"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN55764"></a>### Transfer setup register
