...
[← CNimout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36415.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEScalerLRS1151 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36439.md)
...
<a name="AEN36488"></a>## Public member functions
...
<a name="AEN36526"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN36529"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
