...
| Prev | Chapter 54. Shared memory | Next |


---

# <a name="shm_compile"></a>54.2. Compiling/Linking your software with the shared memory API
...
<a name="AEN10681"></a>**Example 54-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN10685"></a>**Example 54-3. Linking C++ object files that use the
            daqshm library**
