...
[← CTCPBadSocketState](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44020.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLInterpreter →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44059.md)
...
<a name="AEN44060"></a>## Name

CTCPConnectionLost -- Exception thrown when connection to peer is lost

<a name="AEN44063"></a>## Synopsis

```
CTCPConnectionLost
```

<a name="AEN44095"></a>## DESCRIPTION
...
<a name="AEN44152"></a>## SEE ALSO

[*CSocket*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42951.md)
