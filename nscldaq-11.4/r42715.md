...
[← CSocket](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42650.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDAQShm →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42719.md)
...
<a name="AEN42729"></a>## Name

CDAQShm -- class description

<a name="AEN42732"></a>## Synopsis

```
CDAQShm
```

<a name="AEN42847"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42715.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42715.md#daqshm-varsrefsect).
