...
[← EVB::handleFragment](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r16906.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [::EVB::utility::sortedWidget →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r16915.md)
...
<a name="AEN16921"></a>## Name

EVB::handleFragment -- Submit event fragments.

<a name="AEN16924"></a>## Synopsis

**
EVB::handleFragments *file-descriptor*
**

<a name="AEN16928"></a>## DESCRIPTION
...
The format of the data expected on that file descriptor is described
            in [*eventorderer*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85254.md).
