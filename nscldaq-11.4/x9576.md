...
[← Callbacks](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9538.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [How do I use it? →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9580.md)

---

---

# <a name="AEN9576"></a>44.2. How do I use it?
...
<a name="AEN9591"></a>**Example 44-1. Processing ring items in Tcl.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9576.md#tclring_attach)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9576.md#tclring_get)
  ...
  The next matching ring items is translated to a dict (see
  	  ...
  	  command.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9576.md#tclring_detach)
  Once processing is done, the ring is detached.  Once detached,
  	  it is no longer available for use in a **ring get**
  	  command.

For reference information see:
      [*TclRingBuffer*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r79982.md)
