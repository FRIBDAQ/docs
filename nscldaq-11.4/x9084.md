...
[← Selecting Data From a Ring Buffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9060.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the headers and libraries into your applications. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9088.md)

---

---

# <a name="AEN9084"></a>42.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN9090"></a>**Example 42-1. Including a ring item class **
...
<a name="AEN9097"></a>**Example 42-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN9102"></a>**Example 42-3. Linking the ring item format libraries**
...
- [`CRingItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r20670.md)
...
- [`CRingStateChangeItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21606.md)
...
- [`CRingScalerItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r21160.md)
...
- [`CRingTextItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r22011.md)
...
- [`CGlomParameters`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23526.md)
...
- [`CPhysicsEventItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r22337.md)
  Encapsulates the data taken in response to a physics
                          trigger.
- [`CRingFragmentItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r22860.md)
...
- [`CRingPhysicsEventCountItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r22533.md)
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [`CUnknownFragment`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23175.md)
...
## <a name="AEN9174"></a>42.3.1. Generic ring data sources
...
Reference information on these classes is availabe at:
                [*CDataSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26130.md),
                [*CRingDataSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26182.md),
                [*CFileDataSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26261.md),
                [*CDataSourceFactory"*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26328.md),
                and
                [*CRingItemFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26395.md).
