...
[← CSIS3820](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34469.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3600 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34516.md)
...
<a name="AEN34677"></a>## Public member functions
...
- <a name="AEN34700"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN34710"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN34721"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN34732"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN34744"></a>` void SetLatchMode(void);const`
...
- <a name="AEN34756"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN34791"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN34860"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN34871"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN34882"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN34893"></a>` void Clock(void);const`
...
- <a name="AEN34904"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN34915"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN34926"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN34938"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN34949"></a>` unsigned long Read(void);const`
...
- <a name="AEN34961"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
