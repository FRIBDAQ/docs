...
[← ReadoutGui](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63141.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ui →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md)
...
<a name="AEN63267"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61398.md#rdogui3_dialogwrapper).
