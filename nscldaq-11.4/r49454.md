...
[← CMonitorException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49416.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStateException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49455.md)
...
<a name="AEN49468"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN49471"></a>## Synopsis

```
CStateException
```

<a name="AEN49501"></a>## Description
...
<a name="AEN49511"></a>## Public member functions
