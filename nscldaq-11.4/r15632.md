...
[← chanlog](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15631.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [::EVB::inputStatistics::queueDisplay →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15657.md)
...
<a name="AEN15646"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN15649"></a>## Synopsis
...
<a name="AEN15676"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN15679"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN15682"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN15685"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN15688"></a>## DEPENDENCIES
