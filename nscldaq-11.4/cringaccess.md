...
<a name="AEN19613"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN19616"></a>## Synopsis
...
<a name="AEN19692"></a>## Public member functions
...
<a name="AEN19783"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN19787"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN19791"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
