...
[← CDataSinkElement](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50616.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CZMQRouterTransport →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50624.md)

---

---

# <a name="AEN50617"></a>CDataSinkElement

<a name="AEN50621"></a>## Name

CDataSinkElement -- Forward data to some sink.

<a name="AEN50624"></a>## Synopsis
