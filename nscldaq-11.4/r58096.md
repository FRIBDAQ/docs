...
<a name="AEN58110"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN58113"></a>## Synopsis
...
<a name="AEN58282"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r53060]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r58831]])
...
<a name="AEN58290"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r58831]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r58831]] for
...
<a name="AEN58742"></a>## DEVICE ENUMERATION
...
<a name="AEN58766"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN58776"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN58782"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r56309]] for reference
...
<a name="AEN58825"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r53060]]
[[cccusbreadoutlist(3ccusb)|r58831]]
[[CCCUSBReadoutList(3ccusb)|r56309]]
