...
[← ReadoutShell](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13403.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [evbwizard →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13448.md)
...
<a name="AEN13496"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN13499"></a>**Example 1. making hex dumps of data from a ring buffer.**
