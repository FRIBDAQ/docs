...
<a name="AEN30311"></a>## Public member functions
...
<a name="AEN30318"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN30339"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN30352"></a>` unsigned char getVersion(void);const`
...
<a name="AEN30377"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN30388"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN30734"></a>` ECLOutputSelect
...
<a name="AEN30802"></a>` unsigned short
...
<a name="AEN30966"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN30978"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN30988"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN30998"></a>` TriggerConfiguration
...
<a name="AEN31095"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN31136"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN31162"></a>` LEResolution
...
<a name="AEN31176"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN31336"></a>` unsigned short
...
<a name="AEN31430"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN31442"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN31459"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN31472"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN31484"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN31505"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN31517"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN31532"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN31547"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN31562"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN31574"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN31589"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN31599"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN31611"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN31623"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN31635"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN31647"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN31657"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN31667"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN31677"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN31687"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN31699"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN31709"></a>` void
                    EnableErrorMark(void);`



<a name="AEN31719"></a>` void
                    DisableErrorMark(void);`



<a name="AEN31729"></a>` void EnableBypassOnError(void);`



<a name="AEN31739"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN31749"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN31761"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN31771"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN31783"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN31793"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN31805"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN31817"></a>` void EnableAllChannels(void);`



<a name="AEN31827"></a>` void
                    DisableAllChannels(void);`



<a name="AEN31837"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN31849"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN31861"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN31876"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN31888"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN31900"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN31921"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN31934"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31951"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31969"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31984"></a>## Types and public data
