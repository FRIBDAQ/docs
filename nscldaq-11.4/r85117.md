...
[← CScaler](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85116.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CExperiment →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85118.md)
...
<a name="AEN85131"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN85134"></a>## Synopsis
...
<a name="AEN85182"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r84403.md)).
