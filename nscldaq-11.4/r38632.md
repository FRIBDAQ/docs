...
[← cvt](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38616.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSynchronizedThread →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38654.md)
...
<a name="AEN38646"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN38649"></a>## Synopsis
...
<a name="AEN38691"></a>## Public member functions
...
<a name="AEN38729"></a>`void sync_self(void);`
...
<a name="AEN38736"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN38744"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN38756"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN38762"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN38772"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN38802"></a>`void sync_global_end(void);`
