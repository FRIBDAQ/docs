...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28596.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28884.md)
...
<a name="AEN28870"></a>## Public member functions





- <a name="AEN28876"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN28888"></a>`bool Xtest(void);const`
...
- <a name="AEN28900"></a>`bool Qtest(void);const`
...
- <a name="AEN28917"></a>`bool TimedOut(void);const`
...
- <a name="AEN28929"></a>`bool BranchDemand(void);const`
...
- <a name="AEN28941"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN28955"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN28968"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN28982"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN28997"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN29012"></a>`bool IT4(void);const`
...
- <a name="AEN29026"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN29037"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN29050"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN29066"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN29077"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN29088"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN29098"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN29102"></a>**Example 1. Initializing branch 0**
