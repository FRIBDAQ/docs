...
<a name="AEN18427"></a>### Configuration Options
...
<a name="AEN18451"></a>### Device Options
...
<a name="AEN18481"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN18497"></a>```
...
Retrieve the ID code for the board above<a name="AEN18502"></a>```
...
Load firmware and license it.<a name="AEN18509"></a>```
...
Retrieve license information from a digitizer.<a name="AEN18517"></a>```
...
Un-license a digitizer's firmware:<a name="AEN18522"></a>```
