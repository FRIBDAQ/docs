...
# <a name="AEN10067"></a>Chapter 50. Integer byte order conversion library
...
# <a name="AEN10074"></a>50.1. Using the conversion library in your code

The conversion library is a set of C functions.  To use it,
            you will need to include the library header in your source code
            with a line like:

<a name="AEN10077"></a>**Example 50-1. Including the cvt header**
...
<a name="AEN10083"></a>**Example 50-2. Compiling a C or C++ source file that includes cvt.h**
...
<a name="AEN10087"></a>**Example 50-3. A makefile rule that builds a C++ program using the
                cvt package**
