...
[← chanlog](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14954.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1evb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14957.md)
...
<a name="AEN14969"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN14972"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN14977"></a>## DESCRIPTION
...
<a name="AEN14999"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN15002"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN15005"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN15008"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN15011"></a>## DEPENDENCIES
