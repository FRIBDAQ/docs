...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28569.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAENcard →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28592.md)
...
<a name="AEN28709"></a>## Public member functions





- <a name="AEN28715"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN28727"></a>`bool Xtest(void);const`
...
- <a name="AEN28739"></a>`bool Qtest(void);const`
...
- <a name="AEN28756"></a>`bool TimedOut(void);const`
...
- <a name="AEN28768"></a>`bool BranchDemand(void);const`
...
- <a name="AEN28780"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN28794"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN28807"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN28821"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN28836"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN28851"></a>`bool IT4(void);const`
...
- <a name="AEN28865"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN28876"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN28889"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN28905"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN28916"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN28927"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN28937"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN28941"></a>**Example 1. Initializing branch 0**
