...
[← compatibilitylogger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r12770.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [eventlog-compat →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r12819.md)
...
<a name="AEN12827"></a>## Name

spectcldaq -- Pipe data source for SpecTcl in spectrodaq buffer mode.

<a name="AEN12830"></a>## Synopsis

**
spectcldaq *ring-url*
**

<a name="AEN12834"></a>## DESCRIPTION
...
<a name="AEN12855"></a>**Example 1. Attaching SpecTcl to a ring buffer in compatibility mode**
