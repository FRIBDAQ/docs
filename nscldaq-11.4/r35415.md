...
[← CTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35377.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CScaler →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35486.md)
...
<a name="AEN35429"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN35432"></a>## Synopsis
...
<a name="AEN35539"></a>## Public member functions



- <a name="AEN35544"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN35582"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN35597"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN35610"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN35623"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN35668"></a>`T*  T* operator-> (void);`
...
- <a name="AEN35678"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN35693"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN35705"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN35717"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN35729"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN35739"></a>## Types and public data
