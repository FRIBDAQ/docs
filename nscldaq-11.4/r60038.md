...
[← EVBC::stop](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60032.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBControl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60040.md)
...
The registerRingSource proc registers information to the
             [*RingSourceMgr*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60501.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11546.md#sec_tsextractors) describes how
