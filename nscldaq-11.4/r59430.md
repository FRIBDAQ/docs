...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59377.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlModule →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59435.md)
...
<a name="AEN59444"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN59447"></a>## Synopsis

```
CControlHardware
```

<a name="AEN59514"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59270.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59377.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN59521"></a>## METHODS
