...
[← CStateException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48777.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRangeError →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48791.md)
...
<a name="AEN48792"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN48795"></a>## Synopsis

```
CStateException
```

<a name="AEN48825"></a>## Description
...
<a name="AEN48835"></a>## Public member functions
