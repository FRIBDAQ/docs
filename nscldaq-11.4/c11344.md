...
- [[![(1)](../images/callouts/1.gif)|c11344#evbfw-base-initialize]]
...
- [[![(2)](../images/callouts/2.gif)|c11344#evbfw-base-dataready]]
  This method is called from time to time to determine if
                      ...
                      return true.
- [[![(3)](../images/callouts/3.gif)|c11344#evbfw-base-getevents]]
...
- [[![(4)](../images/callouts/4.gif)|c11344#evbfw-base-shutdown]]
...
- [[![(1)](../images/callouts/1.gif)|c11344#evb-clientfw-get-list]]
...
- [[![(2)](../images/callouts/2.gif)|c11344#evb-clientfw-get-while]]
  The main loop condition for our code is to run
                          until we've pulled all the items from the ring.
                          See [[below however.|c11344#evb-clientfw-get-limit]]
- [[![(3)](../images/callouts/3.gif)|c11344#evb-clientfw-get-itemprep]]
  This is the heart of the loop. Each pass through the loop,
                          ...
                          hard coded to 1.
- [[![(4)](../images/callouts/4.gif)|c11344#evb-clientfw-get-limit]]
...
- [[![(5)](../images/callouts/5.gif)|c11344#evb-clientfw-get-submit]]
  This condition avoids doing anything if for some reason
                          ...
                          to the eventbuilder.
- [[![(6)](../images/callouts/6.gif)|c11344#evb-clientfw-get-cleanup]]
