...
[← vhqPanel](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80881.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [caennet →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80922.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81182.md)
        for one such panel.
...
<a name="AEN80943"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN80947"></a>### VhsWidgets::channel
...
<a name="AEN80967"></a>### VhsWidgets::channelStatus options
...
<a name="AEN80973"></a>## OBJECT METHODS
...
<a name="AEN80977"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN80980"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80382.md)
