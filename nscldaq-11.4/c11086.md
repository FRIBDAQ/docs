...
[← Parallel programming framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10958.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Transformer →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11087.md)

---

---

# <a name="AEN11086"></a>Chapter 62. Injecting variables into the USB data taking frameworks
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14782.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14782.md)),
...
<a name="AEN11105"></a>**Example 62-1. The **watch** command.**
