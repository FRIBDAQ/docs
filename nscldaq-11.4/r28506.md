...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28442.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28569.md)
...
<a name="AEN28645"></a>## Public member functions





- <a name="AEN28651"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN28663"></a>`bool Xtest(void);const`
...
- <a name="AEN28675"></a>`bool Qtest(void);const`
...
- <a name="AEN28692"></a>`bool TimedOut(void);const`
...
- <a name="AEN28704"></a>`bool BranchDemand(void);const`
...
- <a name="AEN28716"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN28730"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN28743"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN28757"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN28772"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN28787"></a>`bool IT4(void);const`
...
- <a name="AEN28801"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN28812"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN28825"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN28841"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN28852"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN28863"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN28873"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN28877"></a>**Example 1. Initializing branch 0**
