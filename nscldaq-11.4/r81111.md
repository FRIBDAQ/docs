...
[← VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81110.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [camac →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81159.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81397.md)
        for one such panel.
...
<a name="AEN81158"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN81162"></a>### VhsWidgets::channel
...
<a name="AEN81182"></a>### VhsWidgets::channelStatus options
...
<a name="AEN81188"></a>## OBJECT METHODS
...
<a name="AEN81192"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN81195"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80597.md)
