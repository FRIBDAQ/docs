...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r53972.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Slow controls protocol →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r54122.md)
...
<a name="AEN54107"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN54110"></a>## Synopsis

```
CCCUSB
```

<a name="AEN55092"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r57342.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r57342.md) for
...
<a name="AEN55663"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN55667"></a>### Action Register
...
<a name="AEN55710"></a>### Firmware Register
...
<a name="AEN55762"></a>### Global Mode Register
...
<a name="AEN55895"></a>### Delay Register
...
<a name="AEN55928"></a>### Scaler Control register
...
<a name="AEN55961"></a>### LED Source Register
...
<a name="AEN56213"></a>### Output source selection register.
...
<a name="AEN56382"></a>### Device source register
...
<a name="AEN56735"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN56796"></a>### Transfer setup register
