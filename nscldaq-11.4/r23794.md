...
[← CDesiredTypesPredicate](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23709.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAbnormaEndItem →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23798.md)
...
<a name="AEN23808"></a>## Name

CAbnormalEndItem -- Abnormal end of run.

<a name="AEN23811"></a>## Synopsis

```
CAbnormalEnditem
```

<a name="AEN23885"></a>## DESCRIPTION

Provides a class for objects that represent abnormal end of run
            ring items.

<a name="AEN23888"></a>## METHODS
