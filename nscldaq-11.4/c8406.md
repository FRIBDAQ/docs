...
[← Ring master class library.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8390.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Networked ring buffer access →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8410.md)
...
<a name="AEN8414"></a>**Example 39-1. A sample ring specification in URI form**
...
<a name="AEN8422"></a>**Example 39-2. Substituting local host for the hostname in URI's**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8406.md#chapter.ringaccess.hostname)
  This section of code determines the name of the host.
                  For spdaq20.nscl.msu.edu e.g., this will
                  fill `localhost` with
                  localhost
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8406.md#chapter.ringaccess.domain)
  This section of code determines DNS domain name of the system.
                  For spdaq20.nscl.msu.edu
  `domain` gets filled with the string
                  nscl.msu.edu.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8406.md#chapter.ringaccess.islocal)
  This section of code considers the case that
                  ...
                  *fully qualified host name*
                  ...
                  the `ring`
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8406.md#chapter.ringaccess.builduri)
...
<a name="AEN8454"></a>**Example 39-3. Including the header**
...
<a name="AEN8457"></a>**Example 39-4. Compiling code that uses `CRingAccess`**
...
<a name="AEN8461"></a>**Example 39-5. Linking code that uses `CRingAccess`**
...
[Remote Ring Access](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19595.md) provides
