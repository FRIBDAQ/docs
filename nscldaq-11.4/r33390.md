...
[← CCamacNimout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33389.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACStatusModule →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33408.md)
...
<a name="AEN33438"></a>## Public member functions
...
- <a name="AEN33463"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN33476"></a>` void WriteBit(unsigned int nBitno);`
