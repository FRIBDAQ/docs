...
[[![(1)](../images/callouts/1.gif)|c12466#sillyc.includes]]                        As usual at the top of the file we include the
...
[[![(2)](../images/callouts/2.gif)|c12466#sillyc.class]]                        Defines our class.   Notice that our class has
                        `CRingMarkingWorker::Classifier`
                        as its base class. 
                    [[![(3)](../images/callouts/3.gif)|c12466#sillyc.functor]]                        Defines out `operator()`
...
[[![(1)](../images/callouts/1.gif)|c12466#sillyc.definelarge]]                        The constant `LARGE` defines what
