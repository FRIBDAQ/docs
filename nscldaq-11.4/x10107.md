...
[← Byte order signatures and conversion blocks](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x10091.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Data conversion →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x10111.md)

---

---

# <a name="AEN10107"></a>50.3. Data conversion
...
Functions are provided that allow you to convert shorts and longs
            ...
            in the
            [cvt reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38981.md).
            Briefly however:
