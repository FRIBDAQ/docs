...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59268.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CModuleFactory →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59270.md)
...
<a name="AEN59283"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN59286"></a>## Synopsis

```
CControlHardware
```

<a name="AEN59353"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59109.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59216.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN59360"></a>## METHODS
