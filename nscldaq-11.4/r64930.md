...
[← PortManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64929.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [start →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64933.md)
...
<a name="AEN64944"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN64947"></a>## Synopsis
...
<a name="AEN64961"></a>## METHODS



- <a name="AEN64966"></a>`PortManager(string host, int    port);`
