...
[← CCrateController](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34165.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacNimout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34217.md)
...
<a name="AEN34292"></a>## Public member functions
...
- <a name="AEN34334"></a>` long Lams(void);`
...
- <a name="AEN34344"></a>` void UnInhibit(void);`
...
- <a name="AEN34355"></a>` void DisableDemand(void);`
...
- <a name="AEN34365"></a>` void Inhibit(void);`
...
- <a name="AEN34376"></a>` void EnableDemand(void);`
  Enable the module to assert the branch demand (BD) line
                              if LAMs are present.
- <a name="AEN34386"></a>` bool isInhibited(void);`
...
- <a name="AEN34397"></a>` bool isDemanding(void);`
  Returns true if the controller is asserting
                              a branch demand.
- <a name="AEN34408"></a>` bool isDemandEnabled(void);`
  Returns true if the branch demand is enabled.
- <a name="AEN34419"></a>` void BroadcastControl(unsigned int f, unsigned int a);`
  Performs a control (non data transfer) broadcast operation to the
                              ...
                              24-31.
- <a name="AEN34439"></a>` void BroadcastWrite(unsigned int f, unsigned int a, unsigned long d);`
...
- <a name="AEN34461"></a>` void MulticastControl(unsigned int f, unsigned int a, unsigned long nMask);`
...
- <a name="AEN34484"></a>` void MulticastWrite(unsigned int f, unsigned int a, unsigned long nMask, unsigned long nData);`
...
- <a name="AEN34508"></a>` void InitializeCrate(void);`
