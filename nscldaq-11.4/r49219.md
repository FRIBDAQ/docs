...
[← CMonitorException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49191.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49220.md)
...
<a name="AEN49233"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN49237"></a>## Synopsis

```
CErrnoException
```

<a name="AEN49264"></a>## Description
...
<a name="AEN49273"></a>## Public member functions
