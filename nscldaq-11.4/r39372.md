...
[← CMutex](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39335.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r39373.md)
...
<a name="AEN39386"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN39389"></a>## Synopsis
...
<a name="AEN39431"></a>## Public member functions
...
<a name="AEN39469"></a>`void sync_self(void);`
...
<a name="AEN39476"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN39484"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39496"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN39502"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN39512"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39542"></a>`void sync_global_end(void);`
