...
[← CCrateController](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33425.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACScalerLRS4434 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33441.md)
...
<a name="AEN33491"></a>## Public member functions



- <a name="AEN33496"></a>`CCAMACScalerLRS4434(unsigned int b, unsigned int c, unsigned int n);`
  Constructs a new `CCAMACScalerLRS4434` object.
                              ...
                              parameters.
- <a name="AEN33514"></a>` virtual   void  Initialize(void);`
  Sets up the module for use in data taking.  The module will be software latched
                              ...
                              Off position.
- <a name="AEN33525"></a>`virtual   void  Read(std::vector<unsigned long>&
                                      Scalers);`
  Reads the 32 scaler channels of the module and appends their values
                              ...
                              to be incremental.
- <a name="AEN33538"></a>`virtual   void  Clear(void);`
  Clears the scaler counters.  The counters are all simulataneousl cleared
                              ...
                              again.
- <a name="AEN33548"></a>`virtual unsigned int  size(void);`
