...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48382.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48446.md)
...
<a name="AEN48459"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN48462"></a>## Synopsis

```
CException
```

<a name="AEN48496"></a>## Description
...
<a name="AEN48501"></a>## Public member functions
