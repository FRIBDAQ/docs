...
[← CRingBlockReader](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43184.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingFileBlockReader →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43283.md)

---

---

# <a name="AEN43279"></a>CRingFileBlockReader

<a name="AEN43283"></a>## Name

CRingFileBlockReader -- CRingBlockreader that reads from file.

<a name="AEN43286"></a>## Synopsis
