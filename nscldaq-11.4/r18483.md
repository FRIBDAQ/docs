...
[← bcnaf](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18482.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [canev812control →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18504.md)
...
<a name="AEN18497"></a>## Name

bcnaf -- bcnaf via SBS VME CAMAC interfaces

<a name="AEN18500"></a>## Synopsis

**
bcnaf `-ces | -wiener` *b c n a f* [d]
    **

<a name="AEN18506"></a>## DESCRIPTION
