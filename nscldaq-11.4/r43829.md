...
[← CTCPNoSuchService](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43828.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLApplication 3 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43853.md)
...
<a name="AEN43843"></a>## Name

CTCPNoSuchService -- Exception thrown if a nonexistent service is referenced

<a name="AEN43846"></a>## Synopsis

```
CTCPNoSuchService
```

<a name="AEN43871"></a>## DESCRIPTION
