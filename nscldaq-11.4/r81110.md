...
[← iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81106.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VhsWidgets →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81111.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r81396.md)
        for one such panel.
...
<a name="AEN81157"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN81161"></a>### VhsWidgets::channel
...
<a name="AEN81181"></a>### VhsWidgets::channelStatus options
...
<a name="AEN81187"></a>## OBJECT METHODS
...
<a name="AEN81191"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN81194"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80596.md)
