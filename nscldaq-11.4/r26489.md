...
[← CEventOrderClient](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26484.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSink →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26498.md)
...
<a name="AEN26503"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN26506"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN26536"></a>## DESCRIPTION
...
See METHODS below for a description of the base class methods
            ...
            [*CEVBClientFramework*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26643.md)
...
<a name="AEN26598"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
