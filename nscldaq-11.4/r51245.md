...
[← CThreadedProcessingElement](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51225.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CZMQClientTransport →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51258.md)

---

---

# <a name="AEN51245"></a>CZMQRingItemThreadedWorker

<a name="AEN51249"></a>## Name

CZMQRingItemThreadedWorker -- ZeroMQ Threaded worker for ZeroMQ

<a name="AEN51252"></a>## Synopsis
