...
<a name="AEN58272"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN58275"></a>## Synopsis
...
<a name="AEN58444"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r53222]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r58993]])
...
<a name="AEN58452"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r58993]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r58993]] for
...
<a name="AEN58904"></a>## DEVICE ENUMERATION
...
<a name="AEN58928"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN58938"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN58944"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r56471]] for reference
...
<a name="AEN58987"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r53222]]
[[cccusbreadoutlist(3ccusb)|r58993]]
[[CCCUSBReadoutList(3ccusb)|r56471]]
