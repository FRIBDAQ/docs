...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r27073]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r27073]].
...
[[portAllocator(3tcl)|r79001]],
            [[CPortManagerException(3daq)|r27073]],
            [[DaqPortManager(1tcl)|r17305]]
