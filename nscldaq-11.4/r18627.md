...
[← wienerbcnaf](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18602.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vhqControl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18628.md)
...
This  command  runs the vhq control program.   config are configuration files described by
        [vhqconfig(5)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r86299.md)
