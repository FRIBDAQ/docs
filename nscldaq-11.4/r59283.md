...
This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r54247]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r60018]])
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r60018]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r60018]] for
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r57496]] for reference
...
[[CCCUSB(3ccusb)|r54247]]
[[cccusbreadoutlist(3ccusb)|r60018]]
[[CCCUSBReadoutList(3ccusb)|r57496]]
