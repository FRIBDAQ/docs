...
[← Interactors](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x10473.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compiling/Linking your software with the shared memory API →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x10670.md)
...
<a name="AEN10677"></a>**Example 54-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN10681"></a>**Example 54-3. Linking C++ object files that use the
            daqshm library**
