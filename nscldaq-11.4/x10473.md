...
In addition to
            [[CInteractor|r41525]], the following
            concrete interactors have been supplied.



[[`CStringInteractor`|r41704]]This interactor supplies a string that you have gotten by
                        whatever means you got it.  It can be used when interactors
                        are not suitable for acquiring the stringified credentials.

[[`CFdInteractor`|r41875]]This interactor accepts the credentials via an open file
                        descriptor.

[[`CIOInteractor`|r42011]]This interator uses a pair of other interactors, an output and
