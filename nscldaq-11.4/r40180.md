...
[← CAuthenticator](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40173.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CUnixUserCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40184.md)
...
<a name="AEN40232"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44059.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10835.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44839.md).
...
<a name="AEN40282"></a>## Types and public data
