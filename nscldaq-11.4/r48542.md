...
[← CErrnoException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48479.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48543.md)
...
<a name="AEN48556"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN48560"></a>## Synopsis

```
CErrnoException
```

<a name="AEN48587"></a>## Description
...
<a name="AEN48596"></a>## Public member functions
