...
[← CDataSourceFactory"](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26332.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSink →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26348.md)
...
<a name="AEN26361"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN26364"></a>## Synopsis

```
CDataSink
```

<a name="AEN26389"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26681.md)
