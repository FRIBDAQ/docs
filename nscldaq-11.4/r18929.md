...
[← CZCopyRingBuffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18900.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [epicsdisplay →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18957.md)
...
<a name="AEN18943"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN18946"></a>## Synopsis
...
<a name="AEN19022"></a>## Public member functions
...
<a name="AEN19113"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN19117"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN19121"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
