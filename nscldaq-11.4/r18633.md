...
[← vhqControl](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18628.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [bcnaf →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18637.md)
...
<a name="AEN18647"></a>## Name

bcnaf -- bcnaf via SBS VME CAMAC interfaces

<a name="AEN18650"></a>## Synopsis

**
bcnaf `-ces | -wiener` *b c n a f* [d]
    **

<a name="AEN18656"></a>## DESCRIPTION
