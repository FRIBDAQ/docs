...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [[r61288]] to create the ring
             sources.
