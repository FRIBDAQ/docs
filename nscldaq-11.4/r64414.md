...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64412.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [start →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64427.md)
...
<a name="AEN64445"></a>## METHODS



- <a name="AEN64450"></a>`PortManager(string host, int    port);`
