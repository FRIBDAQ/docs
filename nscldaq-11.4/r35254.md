...
[← CVME](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35253.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStatusModule →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35302.md)
...
<a name="AEN35268"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN35271"></a>## Synopsis
...
<a name="AEN35378"></a>## Public member functions



- <a name="AEN35383"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN35421"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN35436"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN35449"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN35462"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN35507"></a>`T*  T* operator-> (void);`
...
- <a name="AEN35517"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN35532"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN35544"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN35556"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN35568"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN35578"></a>## Types and public data
