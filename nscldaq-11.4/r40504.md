...
[← CHostListCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40503.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40513.md)
...
<a name="AEN40588"></a>## Description

`CHostListCheck` is derived from the
            [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40352.md).
...
<a name="AEN40598"></a>## Public member functions
...
<a name="AEN40689"></a>## Types and public data
