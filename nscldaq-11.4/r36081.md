...
[← CVMEScalerLRS1151](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36070.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36085.md)
...
<a name="AEN36095"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN36098"></a>## Synopsis
...
<a name="AEN36205"></a>## Public member functions



- <a name="AEN36210"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN36248"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN36263"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN36276"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN36289"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN36334"></a>`T*  T* operator-> (void);`
...
- <a name="AEN36344"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN36359"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36371"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN36383"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36395"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN36405"></a>## Types and public data
