...
[← 3rdogui](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61373.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Introduction →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61375.md)
...
<a name="AEN61388"></a>## Name

Introduction -- ReadoutGUI API introduction

<a name="AEN61391"></a>## DESCRIPTION
...
- bells
  This package provides the `bells`
                              ...
                              some pattern.
  See
                              [*bells*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61488.md)
...
- DAQParameters
  Provides access to parameters that affect data taking.
                              ...
                              above.
  See
                              [*DAQParameters*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61708.md)
                              for reference information.
- DataSourceManager
  ...
  See
                              [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61886.md)
- DataSourceUI
  ...
  See
                              [*DataSourceUI*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62138.md)
- Diagnostics
  Provides simple error/warning/info dialogs.
                              See:
                              [*Diagnostics*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62467.md)
- ExpFileSystemConfig
  Provides read/write access to configuration parameters
                              that determine where event data and related meta-data
                              are stored.
                              See:
                              [*ExpFileSystemConfig*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62542.md)
- ReadoutGUI
  Provides the readout GUI application class which
                              strings everything together. See
                              [*ReadoutGui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62631.md)
- ReadoutGUIPanel
  Provides a group of API elements that allow you
                              ...
                              object.
                              See:
                              [*ReadoutGUIPanel*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62782.md)
- RunstateMachine
...
- StateManager
  ...
  See
                              [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63274.md)
- ui
  ...
  See
                              [*ui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63435.md)
