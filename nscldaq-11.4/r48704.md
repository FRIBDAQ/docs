...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48678.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStateException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48714.md)
...
<a name="AEN48718"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN48722"></a>## Synopsis

```
CErrnoException
```

<a name="AEN48749"></a>## Description
...
<a name="AEN48758"></a>## Public member functions
