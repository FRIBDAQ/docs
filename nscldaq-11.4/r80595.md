...
[← vhq](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80523.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [iSegVhs →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80596.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80881.md)
        for one such panel.
...
<a name="AEN80642"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN80646"></a>### VhsWidgets::channel
...
<a name="AEN80666"></a>### VhsWidgets::channelStatus options
...
<a name="AEN80672"></a>## OBJECT METHODS
...
<a name="AEN80676"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN80679"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80081.md)
