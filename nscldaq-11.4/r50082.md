...
[← CRingBufferTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50079.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMonitorException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50086.md)
...
`CMonitorException`
            is derived from the
            [CException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49273.md)
            class, and therefore supports and implements all of its
            virtual members.

<a name="AEN50170"></a>## Public member functions
