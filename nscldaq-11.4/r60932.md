...
[← EVBC::startS800Source](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60925.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Eventbuilder callback bundle →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60933.md)
...
<a name="AEN60946"></a>## Name

Configuration -- Configuration variable management

<a name="AEN60949"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md) package for that
            instead.

<a name="AEN60972"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62597.md) is a better
                          choice).
