...
- ringbuffer
  This utility allows you to create, re-initialize, delete  and
              ...
              don't already exist. See the [[man page|r13335]] for more information.
- dumper
  Provides a simple textual formatted dump of the buffers.  If you
              ...
              each event and the packets within the event. See [[user documentation|c7564]] and [[man page|r14117]] for more information.
- eventlog
  Performs native mode event loggging.  In this mode, event file
              segments consists of streams of ring buffer items. See [[user documentation|c7628]] and [[man page|r14211]] for more information.
- ringselector
  Provides a flexible ringbuffer consumer that pipes the ring items
              ...
              applications like SpecTcl. See [[user documentation|c7959]] and [[man page|r14465]] for more information.
- ringtostdout
  Accepts data from a ring and pipes it to stdout.  This is the server
              ...
              process data from  a ring. See the [[man page|r13459]] for more information.
- ScalerDisplay
  Provides a display of scaler event data.  This application is highly
              ...
              selected scalers are also supported. See [[user documentation|c4676]] and [[man page|r13805#manpage.scalerdisplay]] for more information.
- stdintoring
  Accepts data on stdin and puts it in a ring buffer.  This is the
              client side of the data pipeline that sets up a proxy ring. See the [[man page|r13523]] for more information.
