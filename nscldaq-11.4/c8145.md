...
[← Compatibility utilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8040.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The epics display utility →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8183.md)
...
controlpush
      ...
      [the controlpush manpage](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15677.md).

The intent is that 
      controlpush be pointed at a 
      TclServer.
[The TclServer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c7658.md)
...
You can use 
      ...
      system parameters. 
      [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8183.md) is an example
