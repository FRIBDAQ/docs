...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48908.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CURIFormatException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48996.md)
...
<a name="AEN48953"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN48956"></a>## Synopsis

```
CStateException
```

<a name="AEN48986"></a>## Description
...
<a name="AEN48996"></a>## Public member functions
