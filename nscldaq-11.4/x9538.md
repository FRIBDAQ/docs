...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9538.md#evb_connection_cb)
  This is a sample connection callback proc.  All it
                              does is output information about the connection
                              that was just processed.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9538.md#evb_connection_cb_establish)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9538.md#evb_disconnect_cb)
  This is a simple sample disconnecdt callback.
                              It just prints information about the disconnect
                              on stdout.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9538.md#evb_disconnect_cb_establish)
