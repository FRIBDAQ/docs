...
[← CStateException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49454.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRangeError →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49457.md)
...
<a name="AEN49469"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN49472"></a>## Synopsis

```
CStateException
```

<a name="AEN49502"></a>## Description
...
<a name="AEN49512"></a>## Public member functions
