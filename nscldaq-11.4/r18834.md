...
<a name="AEN18889"></a>### Configuration Options
...
<a name="AEN18913"></a>### Device Options
...
<a name="AEN18943"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN18959"></a>```
...
Retrieve the ID code for the board above<a name="AEN18964"></a>```
...
Load firmware and license it.<a name="AEN18971"></a>```
...
Retrieve license information from a digitizer.<a name="AEN18979"></a>```
...
Un-license a digitizer's firmware:<a name="AEN18984"></a>```
