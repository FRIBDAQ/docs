...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40405.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CUnixUserCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40485.md)
...
<a name="AEN40524"></a>## Description

`CHostListCheck` is derived from the
            [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40288.md).
...
<a name="AEN40534"></a>## Public member functions
...
<a name="AEN40625"></a>## Types and public data
