...
<a name="AEN27779"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN27782"></a>## Synopsis
...
<a name="AEN28008"></a>## Public member functions





<a name="AEN28014"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28076"></a>`unsigned long getBase(void);`
...
<a name="AEN28087"></a>`int getSerial(void);`
...
<a name="AEN28118"></a>`int  getFirmware(void);`
...
<a name="AEN28128"></a>`int  getCrate(void);`
...
<a name="AEN28139"></a>`void setCrate(int crateNum);`
...
<a name="AEN28152"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN28173"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN28183"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN28193"></a>`void keepOverflowData(void);`
...
<a name="AEN28203"></a>`void discardOverflowData(void);`
...
<a name="AEN28213"></a>`void keepInvalidData(void);`
...
<a name="AEN28224"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN28235"></a>`void commonStart(void);`
...
<a name="AEN28246"></a>`void commonStop(void);`
...
<a name="AEN28257"></a>`void setRange(int range);`
...
<a name="AEN28270"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN28342"></a>`void clearData
                                (void);`
...
<a name="AEN28385"></a>`bool Busy(void);`
...
<a name="AEN28396"></a>` bool gBusy(void);`
...
<a name="AEN28407"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN28418"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN28429"></a>`int readEvent(void* buf);`
...
<a name="AEN28442"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN28483"></a>`void enableSmallThresholds(void);`
...
<a name="AEN28546"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN28550"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN28554"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN28558"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN28562"></a>**Example 3. Reading out a CAEN 785 e.g.**
