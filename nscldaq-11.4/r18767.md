...
[← vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18744.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingAccess →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18768.md)
...
<a name="AEN18781"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN18784"></a>## Synopsis
...
<a name="AEN18860"></a>## Public member functions
...
<a name="AEN18951"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN18955"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN18959"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
