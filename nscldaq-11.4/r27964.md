...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27926.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27968.md)
...
<a name="AEN28027"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27807.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN28034"></a>## Public member functions
...
<a name="AEN28090"></a>## Types and public data
...
<a name="AEN28110"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN28113"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80247.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27807.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18196.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49273.md)
