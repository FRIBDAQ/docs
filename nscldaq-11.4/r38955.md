...
[← CMutex](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38873.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cvt →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38981.md)
...
<a name="AEN38969"></a>## Name

CSynchronizedThread -- Thread with synchronized initialization

<a name="AEN38972"></a>## Synopsis

```

```

<a name="AEN38999"></a>## DESCRIPTION

Provides a Thread class (see
            [*Thread*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38812.md)).
