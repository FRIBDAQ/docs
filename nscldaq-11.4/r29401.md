...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29397.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29410.md)
...
<a name="AEN29540"></a>## Public member functions





- <a name="AEN29546"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN29558"></a>`bool Xtest(void);const`
...
- <a name="AEN29570"></a>`bool Qtest(void);const`
...
- <a name="AEN29587"></a>`bool TimedOut(void);const`
...
- <a name="AEN29599"></a>`bool BranchDemand(void);const`
...
- <a name="AEN29611"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN29625"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN29638"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN29652"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN29667"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN29682"></a>`bool IT4(void);const`
...
- <a name="AEN29696"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN29707"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN29720"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN29736"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN29747"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN29758"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN29768"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN29772"></a>**Example 1. Initializing branch 0**
