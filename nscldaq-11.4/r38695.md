...
[← CSynchronizedThread](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38654.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38696.md)
...
<a name="AEN38709"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN38712"></a>## Synopsis
...
<a name="AEN38754"></a>## Public member functions
...
<a name="AEN38792"></a>`void sync_self(void);`
...
<a name="AEN38799"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN38807"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN38819"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN38825"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN38835"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN38865"></a>`void sync_global_end(void);`
