...
[← CEvbClientApp](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27004.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEventOrderClient →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27010.md)
...
See METHODS below for a description of the base class methods
            ...
            [*CEVBClientFramework*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27159.md)
...
<a name="AEN27114"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
