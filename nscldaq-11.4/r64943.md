...
[← start](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64937.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [check →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64962.md)
...
<a name="AEN64957"></a>## Name

resume -- Resume a Paused Run

<a name="AEN64960"></a>## Synopsis
...
Resumes a run that is paused in the data source identified by
          ...
          [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65034.md) specifies  the
