...
<a name="AEN68285"></a>**Example 1. Sample use of mqdc command for timestamping with external oscillator**
...
[[![(1)](../images/callouts/1.gif)|r67846#mqdccreate]]                This command creates an object to manage an MQDC-32
              ...
              [[![(3)](../images/callouts/3.gif)|r67846#mqdcmakethresh]]                This highlights the fact that the configuration file is
                ...
                some external file.
              [[![(4)](../images/callouts/4.gif)|r67846#mqdcthresholds]]                This command uses the `thresholds` variable
                and programs the channel thresholds of the QDC.

<a name="AEN68307"></a>**Example 2. Sample configuration of mqdc for event counting and interrupt readout**
