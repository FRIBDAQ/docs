...
[← Running event builder clients](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11576.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ringFragmentSource - a prepackaged client for ringbuffer data sources →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11609.md)

---

---

# <a name="evb-using-client"></a>65.3. Running event builder clients
