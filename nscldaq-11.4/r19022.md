...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.filter]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.filter.savetype]]
  The constructor of
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.filter.function]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.filter.peek]]
  The predicate function operator will peek at message
                      headers.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.filter.noheader]]
  If there are no messages in the ring buffer when the
                      ...
                      blocking.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.filter.skip]]
  This code assumes that messages are atomically put in the
                      ...
                      continue to block.
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.filter.found]]
  If, on the other hand, the message matches the desired message
                      ...
                      blocking.
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.predicate]]
  The first step to actually filtering out unwanted message
                      ...
                      we want to see.
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.skipsome]]
  This call to
...
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19022.md#ringman.peekheader]]
