...
[← SyncGuard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38632.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38695.md)
...
<a name="AEN38668"></a>## Name

CSynchronizedThread -- Thread with synchronized initialization

<a name="AEN38671"></a>## Synopsis

```

```

<a name="AEN38698"></a>## DESCRIPTION

Provides a Thread class (see
            [*Thread*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38511.md)).
