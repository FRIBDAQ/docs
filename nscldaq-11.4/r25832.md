...
[← CRingDataSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25817.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingDataSink →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25840.md)
...
<a name="AEN25846"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN25849"></a>## Synopsis

```
CDataSink
```

<a name="AEN25874"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26166.md)
