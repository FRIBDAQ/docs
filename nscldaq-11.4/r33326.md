...
[← CCAMACScalerLRS2551](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33321.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamac →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33376.md)
...
<a name="AEN33374"></a>## Public member functions
...
- <a name="AEN33399"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN33412"></a>` void WriteBit(unsigned int nBitno);`
