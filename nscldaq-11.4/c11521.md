...
[← Event builder client framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11505.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client framework →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11522.md)
...
- [*CEvbClientApp*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27004.md) provides
              reference material that describes the base class on which
              the application code for the event builder is based.
- [*Event builder client framework*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61187.md)
              provides reference material that desribes the event builder command
              options and parameters.

# <a name="AEN11541"></a>67.1. Application specific code for the event builder
...
<a name="AEN11567"></a>**Example 67-1. `CEVBClientApp` definition**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evbfw-base-initialize)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evbfw-base-dataready)
  This method is called from time to time to determine if
                      ...
                      return true.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evbfw-base-getevents)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evbfw-base-shutdown)
...
## <a name="AEN11592"></a>67.1.1. Sample ring `EVBClientApp` class.
...
<a name="AEN11599"></a>**Example 67-2. The `CEVBRingClientApp` class
                definition.
                **
...
<a name="AEN11613"></a>**Example 67-3. The `CEVBRingClientApp` `initialize`
...
<a name="AEN11626"></a>**Example 67-4. The `CEVBRingClientApp`
`dataReady` method.**
...
See
                [*CEVBClientFramework*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27158.md)
...
<a name="AEN11670"></a>**Example 67-5. The `EVBRingClientApp` `getEvents`
                implementation.
                **
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evb-clientfw-get-list)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evb-clientfw-get-while)
  The main loop condition for our code is to run
                          until we've pulled all the items from the ring.
                          See [below however.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evb-clientfw-get-limit)
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evb-clientfw-get-itemprep)
  This is the heart of the loop. Each pass through the loop,
                          ...
                          hard coded to 1.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evb-clientfw-get-limit)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evb-clientfw-get-submit)
  This condition avoids doing anything if for some reason
                          ...
                          to the eventbuilder.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11521.md#evb-clientfw-get-cleanup)
