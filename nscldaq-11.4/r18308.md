...
<a name="AEN18363"></a>### Configuration Options
...
<a name="AEN18387"></a>### Device Options
...
<a name="AEN18417"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN18433"></a>```
...
Retrieve the ID code for the board above<a name="AEN18438"></a>```
...
Load firmware and license it.<a name="AEN18445"></a>```
...
Retrieve license information from a digitizer.<a name="AEN18453"></a>```
...
Un-license a digitizer's firmware:<a name="AEN18458"></a>```
