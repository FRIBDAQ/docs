...
[← CDAQShm](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42564.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingFileBlockReader →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42613.md)
...
<a name="AEN42579"></a>## Name

CDAQShm -- class description

<a name="AEN42582"></a>## Synopsis

```
CDAQShm
```

<a name="AEN42697"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42565.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42565.md#daqshm-varsrefsect).
