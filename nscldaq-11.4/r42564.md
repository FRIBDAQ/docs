...
[← Os](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42534.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDAQShm →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42565.md)
...
<a name="AEN42578"></a>## Name

CDAQShm -- class description

<a name="AEN42581"></a>## Synopsis

```
CDAQShm
```

<a name="AEN42696"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42564.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42564.md#daqshm-varsrefsect).
