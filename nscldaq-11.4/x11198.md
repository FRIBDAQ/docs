...
[← Using the standard event orderer startup script](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11197.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing an event orderer startup script →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11208.md)

---

---

# <a name="AEN11198"></a>64.2. Using the standard event orderer startup script
