...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r56835.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBReadoutList →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r56986.md)
...
<a name="AEN56871"></a>## Name

CCCUSBusb -- Provide access to a connected CC-USB device.

<a name="AEN56874"></a>## Synopsis

```
CCCUSBusb
```

<a name="AEN56938"></a>## DESCRIPTION
