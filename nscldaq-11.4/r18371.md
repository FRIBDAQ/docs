...
<a name="AEN18426"></a>### Configuration Options
...
<a name="AEN18450"></a>### Device Options
...
<a name="AEN18480"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN18496"></a>```
...
Retrieve the ID code for the board above<a name="AEN18501"></a>```
...
Load firmware and license it.<a name="AEN18508"></a>```
...
Retrieve license information from a digitizer.<a name="AEN18516"></a>```
...
Un-license a digitizer's firmware:<a name="AEN18521"></a>```
