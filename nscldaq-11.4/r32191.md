...
[← CCAENV830](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32190.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV977 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32242.md)
...
<a name="AEN32373"></a>## Public member functions



- <a name="AEN32378"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN32406"></a>`void  Enable(int nChannel);`
...
- <a name="AEN32421"></a>`void  Disable(int nChannel);`
...
- <a name="AEN32436"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN32449"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN32461"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN32473"></a>`void   SetWide (void);`
...
- <a name="AEN32485"></a>`void   SetNarrow (void);`
...
- <a name="AEN32496"></a>`void  EnableHeader (void);`
...
- <a name="AEN32574"></a>`bool  isFull (void);`
...
- <a name="AEN32586"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN32598"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN32691"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN32705"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
