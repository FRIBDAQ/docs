...
[← CThreadedProcessingElement](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51440.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSinkElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51448.md)

---

---

# <a name="AEN51444"></a>CDataSinkElement

<a name="AEN51448"></a>## Name

CDataSinkElement -- Forward data to some sink.

<a name="AEN51451"></a>## Synopsis
