...
[← EVBC::registerRingSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60263.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::initialize →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60278.md)
...
<a name="AEN60291"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN60294"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN60298"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59956.md).

<a name="AEN60306"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59956.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60387.md)).
