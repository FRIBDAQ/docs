...
[← CFileDataSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26261.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CFileDataSource →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26265.md)
...
<a name="AEN26278"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN26281"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN26311"></a>## DESCRIPTION
...
<a name="AEN26373"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
