...
[← cvt](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38831.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMutex →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38872.md)
...
<a name="AEN38871"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN38874"></a>## Synopsis
...
<a name="AEN38916"></a>## Public member functions
...
<a name="AEN38954"></a>`void sync_self(void);`
...
<a name="AEN38961"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN38969"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN38981"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN38987"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN38997"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN39027"></a>`void sync_global_end(void);`
