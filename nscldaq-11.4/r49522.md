...
[← CProcessor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49480.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CProcessor →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49543.md)
...
<a name="AEN49536"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN49539"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN49623"></a>## Description
...
<a name="AEN49630"></a>## Public member functions
