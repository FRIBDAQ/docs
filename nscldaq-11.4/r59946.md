...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59945.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3evb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59954.md)
...
<a name="AEN59960"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN59963"></a>## Synopsis

```
CControlHardware
```

<a name="AEN60030"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59786.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59893.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN60037"></a>## METHODS
