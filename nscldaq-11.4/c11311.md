...
[← Event builder client framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11280.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SoftwareTrigger →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c11317.md)

---

---

# <a name="AEN11311"></a>Chapter 63. Injecting variables into the USB data taking frameworks
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15308.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15308.md)),
...
<a name="AEN11330"></a>**Example 63-1. The **watch** command.**
