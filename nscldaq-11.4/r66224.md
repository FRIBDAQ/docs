...
[← tcl driver support](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r66184.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [hytec →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r66229.md)
...
- `-inputmask` *mask*
  ...
  This defaults to 0
- `-readmode` *mode*
  Together with the `-readandclear`, determines
...
- `-vector` *status-id*
  ...
  Defaults to 0
- `-pattern` *true|false*
  If this is true, the pattern bit is set
