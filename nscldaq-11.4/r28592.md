...
<a name="AEN28606"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN28609"></a>## Synopsis
...
<a name="AEN28835"></a>## Public member functions





<a name="AEN28841"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28903"></a>`unsigned long getBase(void);`
...
<a name="AEN28914"></a>`int getSerial(void);`
...
<a name="AEN28945"></a>`int  getFirmware(void);`
...
<a name="AEN28955"></a>`int  getCrate(void);`
...
<a name="AEN28966"></a>`void setCrate(int crateNum);`
...
<a name="AEN28979"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN29000"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN29010"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN29020"></a>`void keepOverflowData(void);`
...
<a name="AEN29030"></a>`void discardOverflowData(void);`
...
<a name="AEN29040"></a>`void keepInvalidData(void);`
...
<a name="AEN29051"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN29062"></a>`void commonStart(void);`
...
<a name="AEN29073"></a>`void commonStop(void);`
...
<a name="AEN29084"></a>`void setRange(int range);`
...
<a name="AEN29097"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN29169"></a>`void clearData
                                (void);`
...
<a name="AEN29212"></a>`bool Busy(void);`
...
<a name="AEN29223"></a>` bool gBusy(void);`
...
<a name="AEN29234"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN29245"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN29256"></a>`int readEvent(void* buf);`
...
<a name="AEN29269"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN29310"></a>`void enableSmallThresholds(void);`
...
<a name="AEN29377"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN29381"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN29385"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN29389"></a>**Example 3. Reading out a CAEN 785 e.g.**
