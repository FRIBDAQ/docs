...
<a name="AEN27778"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN27781"></a>## Synopsis
...
<a name="AEN28007"></a>## Public member functions





<a name="AEN28013"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28075"></a>`unsigned long getBase(void);`
...
<a name="AEN28086"></a>`int getSerial(void);`
...
<a name="AEN28117"></a>`int  getFirmware(void);`
...
<a name="AEN28127"></a>`int  getCrate(void);`
...
<a name="AEN28138"></a>`void setCrate(int crateNum);`
...
<a name="AEN28151"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN28172"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN28182"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN28192"></a>`void keepOverflowData(void);`
...
<a name="AEN28202"></a>`void discardOverflowData(void);`
...
<a name="AEN28212"></a>`void keepInvalidData(void);`
...
<a name="AEN28223"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN28234"></a>`void commonStart(void);`
...
<a name="AEN28245"></a>`void commonStop(void);`
...
<a name="AEN28256"></a>`void setRange(int range);`
...
<a name="AEN28269"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN28341"></a>`void clearData
                                (void);`
...
<a name="AEN28384"></a>`bool Busy(void);`
...
<a name="AEN28395"></a>` bool gBusy(void);`
...
<a name="AEN28406"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN28417"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN28428"></a>`int readEvent(void* buf);`
...
<a name="AEN28441"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN28482"></a>`void enableSmallThresholds(void);`
...
<a name="AEN28545"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN28549"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN28553"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN28557"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN28561"></a>**Example 3. Reading out a CAEN 785 e.g.**
