...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r27599]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r27599]].
...
[[portAllocator(3tcl)|r79527]],
            [[CPortManagerException(3daq)|r27599]],
            [[DaqPortManager(1tcl)|r17831]]
