...
[← CCAMACTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32850.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV977 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32908.md)
...
<a name="AEN32944"></a>## Public member functions



- <a name="AEN32949"></a>`CCAMACStatusModule(unsigned int b, unsigned int c, unsigned int n);`
...
- <a name="AEN32982"></a>`virtual void  GoBusy(void);`
  Pulses the computer going busy output.  This is usually used to indicate
                              ...
                              latch to be busy.
- <a name="AEN32992"></a>`virtual void  GoClear(void);`
...
- <a name="AEN33002"></a>`virtual void  ModuleClear(void);`
