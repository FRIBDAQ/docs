...
[← Event builder client framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60510.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::reset →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60517.md)
...
<a name="AEN60525"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN60528"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN60532"></a>## DESCRIPTION
