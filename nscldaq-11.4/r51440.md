...
[← CThreadedProcessingElement](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51439.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSinkElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51444.md)

---

---

# <a name="AEN51440"></a>CThreadedProcessingElement

<a name="AEN51444"></a>## Name

CThreadedProcessingElement -- Run a processing element ina thread.

<a name="AEN51447"></a>## Synopsis
