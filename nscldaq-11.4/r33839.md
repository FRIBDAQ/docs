...
[← CSIS3600](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33838.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacNimout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33852.md)
...
<a name="AEN34001"></a>## Public member functions
...
- <a name="AEN34024"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN34034"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN34045"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN34056"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN34068"></a>` void SetLatchMode(void);const`
...
- <a name="AEN34080"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN34115"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN34184"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN34195"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN34206"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN34217"></a>` void Clock(void);const`
...
- <a name="AEN34228"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN34239"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN34250"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN34262"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN34273"></a>` unsigned long Read(void);const`
...
- <a name="AEN34285"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
