...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60455.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Eventbuilder callback bundle →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60471.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60277.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60101.md) to create the ring
             sources.
