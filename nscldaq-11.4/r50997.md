...
[← CZMQTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50992.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCommunicatorFactoryMaker →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50998.md)

---

---

# <a name="AEN50997"></a>CZMQDealerTransport

<a name="AEN51001"></a>## Name

CZMQDealerTransport -- Peer, receiver for CZMQRouterTransport(3daq)

<a name="AEN51004"></a>## Synopsis
