...
[← pause](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63873.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [end →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63880.md)
...
<a name="AEN63888"></a>## Name

pause -- Pause a data taking run (optional)

<a name="AEN63891"></a>## Synopsis
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64002.md) specifies  the
