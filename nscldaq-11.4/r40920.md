...
[← CStringInteractor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40873.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTclAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40921.md)
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44799.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10835.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r45579.md).
...
<a name="AEN41022"></a>## Types and public data
