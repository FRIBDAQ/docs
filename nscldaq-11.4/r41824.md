...
[← URL](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41777.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CIOInteractor →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41856.md)
...
<a name="AEN41838"></a>## Name

CDAQShm -- class description

<a name="AEN41841"></a>## Synopsis

```
CDAQShm
```

<a name="AEN41956"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41824.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41824.md#daqshm-varsrefsect).
