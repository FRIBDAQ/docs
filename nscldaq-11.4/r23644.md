...
[← CAbnormaEndItem](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23643.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDesiredTypesPredicate →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23645.md)
...
<a name="AEN23658"></a>## Name

CAbnormalEndItem -- Abnormal end of run.

<a name="AEN23661"></a>## Synopsis

```
CAbnormalEnditem
```

<a name="AEN23735"></a>## DESCRIPTION

Provides a class for objects that represent abnormal end of run
            ring items.

<a name="AEN23738"></a>## METHODS
