...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r54126.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSB →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r54247.md)
...
<a name="AEN54257"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN54260"></a>## Synopsis

```
CCCUSB
```

<a name="AEN55242"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r57492.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r57492.md) for
...
<a name="AEN55813"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN55817"></a>### Action Register
...
<a name="AEN55860"></a>### Firmware Register
...
<a name="AEN55912"></a>### Global Mode Register
...
<a name="AEN56045"></a>### Delay Register
...
<a name="AEN56078"></a>### Scaler Control register
...
<a name="AEN56111"></a>### LED Source Register
...
<a name="AEN56363"></a>### Output source selection register.
...
<a name="AEN56532"></a>### Device source register
...
<a name="AEN56885"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN56946"></a>### Transfer setup register
