...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65433.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3python →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65437.md)
...
<a name="AEN65449"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN65452"></a>## Synopsis
...
<a name="AEN65466"></a>## METHODS



- <a name="AEN65471"></a>`PortManager(string host, int    port);`
