...
[← EVB::reviveSocket](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18009.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [loadshaper →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18013.md)
...
<a name="AEN18026"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN18029"></a>## Synopsis
...
<a name="AEN18084"></a>### Map access command
...
<a name="AEN18094"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN18102"></a>***mapname* put *width offset value***
