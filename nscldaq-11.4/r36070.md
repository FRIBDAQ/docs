...
[← CTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36047.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r36081.md)
...
<a name="AEN36123"></a>## Public member functions
...
<a name="AEN36161"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN36164"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
