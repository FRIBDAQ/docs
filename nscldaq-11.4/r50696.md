...
[← CRingItemMarkingWorker](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50695.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CThreadedProcessingElement →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r50699.md)

---

---

# <a name="AEN50696"></a>CZMQDealerTransport

<a name="AEN50700"></a>## Name

CZMQDealerTransport -- Peer, receiver for CZMQRouterTransport(3daq)

<a name="AEN50703"></a>## Synopsis
