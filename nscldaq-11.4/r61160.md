...
[← 3rdogui](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61158.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client framework →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61187.md)
...
- bells
  This package provides the `bells`
                              ...
                              some pattern.
  See
                              [*bells*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61274.md)
...
- Configuration
  ...
  See
                              [*Configuration*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61395.md)
                              for reference information.
- DAQParameters
  Provides access to parameters that affect data taking.
                              ...
                              above.
  See
                              [*DAQParameters*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61494.md)
                              for reference information.
- DataSourceManager
  ...
  See
                              [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61672.md)
- DataSourceUI
  ...
  See
                              [*DataSourceUI*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61924.md)
- Diagnostics
  Provides simple error/warning/info dialogs.
                              See:
                              [*Diagnostics*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62253.md)
- ExpFileSystemConfig
  Provides read/write access to configuration parameters
                              that determine where event data and related meta-data
                              are stored.
                              See:
                              [*ExpFileSystemConfig*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62328.md)
- ReadoutGUI
  Provides the readout GUI application class which
                              strings everything together. See
                              [*ReadoutGui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62417.md)
- ReadoutGUIPanel
  Provides a group of API elements that allow you
                              ...
                              object.
                              See:
                              [*ReadoutGUIPanel*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62568.md)
- RunstateMachine
...
- StateManager
  ...
  See
                              [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63060.md)
- ui
  ...
  See
                              [*ui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63221.md)
