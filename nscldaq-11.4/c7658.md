...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c7628.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAEN V812 Constant Fraction Discriminator →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c7681.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18313.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18366.md).
            section.
...
TclServer is also available as a package that can be incorporated
                ...
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r80353.md)
