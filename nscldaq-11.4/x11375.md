...
[← Writing an event orderer startup script](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11370.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the standard event orderer startup script →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11376.md)

---

---

# <a name="AEN11375"></a>66.2. Using the standard event orderer startup script
