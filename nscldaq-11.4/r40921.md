...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40920.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CHostListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40966.md)
...
<a name="AEN40973"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44800.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10835.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r45580.md).
...
<a name="AEN41023"></a>## Types and public data
