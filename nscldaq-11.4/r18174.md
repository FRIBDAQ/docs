...
[← loadcfd](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18169.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DaqPortManager →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18196.md)
...
<a name="AEN18188"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN18191"></a>## Synopsis
...
<a name="AEN18246"></a>### Map access command
...
<a name="AEN18256"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN18264"></a>***mapname* put *width offset value***
