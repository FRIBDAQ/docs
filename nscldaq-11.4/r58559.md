...
<a name="AEN58573"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN58576"></a>## Synopsis
...
<a name="AEN58745"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r53523]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r59294]])
...
<a name="AEN58753"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r59294]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r59294]] for
...
<a name="AEN59205"></a>## DEVICE ENUMERATION
...
<a name="AEN59229"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN59239"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN59245"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r56772]] for reference
...
<a name="AEN59288"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r53523]]
[[cccusbreadoutlist(3ccusb)|r59294]]
[[CCCUSBReadoutList(3ccusb)|r56772]]
