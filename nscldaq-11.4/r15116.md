...
[← EVB::BarrierStats::queueBarriers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15059.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::BarrierStats::queueBarriers →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15122.md)
...
<a name="AEN15160"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN15163"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN15166"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN15169"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN15172"></a>## DEPENDENCIES
