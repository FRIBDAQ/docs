...
[← stack](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r52948.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lrs2551 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r52952.md)
...
<a name="AEN52963"></a>## Name

stack -- Create and configure CC-USB stacks.

<a name="AEN52966"></a>## Synopsis
...
<a name="AEN53071"></a>## EXAMPLES

The example below extends the example in the
                  [ph7xxx(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r52731.md) command reference
                  reading the defined modules in an event stack:

<a name="AEN53075"></a>**Example 1. Example of the **stack** command.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r52949.md#defmodules)
  These two lines define the modules that we will be using
                          for the experimental setup.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r52949.md#stackdef)
  Creates a new stack called events
                          In subsequent lines I'm going to configure this stack
                          to handle the event trigger.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r52949.md#typemods)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r52949.md#timing)
