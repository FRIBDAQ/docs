...
[← CDAQShm](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41887.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CopyrightNotice →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41935.md)
...
<a name="AEN41902"></a>## Name

CDAQShm -- class description

<a name="AEN41905"></a>## Synopsis

```
CDAQShm
```

<a name="AEN42020"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41888.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41888.md#daqshm-varsrefsect).
