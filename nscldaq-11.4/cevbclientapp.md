...
<a name="AEN27173"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN27176"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN27206"></a>## DESCRIPTION
...
<a name="AEN27268"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
| --- | --- | --- |
| Prev | Home | Next |
| CRingBufferChunkAccess | Up | CEVBClientFramework |
