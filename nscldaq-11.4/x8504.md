...
[[![(1)](../images/callouts/1.gif)|x8504#ringcons.include]]                        The
                        CRingBuffer.h
                        header is included.
                    ...
                    [[![(2)](../images/callouts/2.gif)|x8504#ringcons.std]]                        Incorporating the
                        ...
                        `std::string`
[[![(3)](../images/callouts/3.gif)|x8504#ringcons.create]]                        Ring buffers are created via a the
                        `create` static
                    ...
                    [[![(5)](../images/callouts/5.gif)|x8504#ringcons.latency]]                        When a ring buffer consumer must block because
...
[[![(6)](../images/callouts/6.gif)|x8504#ringcons.get]]                        The
                        `get`
...
[[![(1)](../images/callouts/1.gif)|x8504#ringprod.include]]                        Includes the
                        CRingBuffer.h
