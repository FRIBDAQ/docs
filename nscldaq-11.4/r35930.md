...
[← CTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35893.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35931.md)
...
<a name="AEN35944"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN35947"></a>## Synopsis
...
<a name="AEN36054"></a>## Public member functions



- <a name="AEN36059"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN36097"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN36112"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN36125"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN36138"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN36183"></a>`T*  T* operator-> (void);`
...
- <a name="AEN36193"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN36208"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36220"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN36232"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36244"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN36254"></a>## Types and public data
