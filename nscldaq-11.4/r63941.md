...
[← capabilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63938.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [end →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63943.md)
...
<a name="AEN63955"></a>## Name

ui -- ReadoutGUI graphical user interface elements.

<a name="AEN63958"></a>## Synopsis

**
package require ui
          **

<a name="AEN63961"></a>## DESCRIPTION
...
- [*readoutMenuBar*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_readoutMenubar)
  Provides the menu bar for the application.  This can
                          ...
                          as well.
- [*RunIdentification*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_RunIdentification)
...
- [*RunControl*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_RunControl)
  Provides a megawidget that contains the controls for a run.
                          These are buttons intended to drive the
                          [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63547.md).
...
- [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_StopWatch)
...
- [*ElapsedTimeDisplay*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_ElapsedTimeDisplay)
...
- [*TimedRunControls*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_TimedRunControls)
  ...
  An associated callout bundle hooks the singleton
                          ...
                          timed runs.
- [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_OutputWindow)
  ...
  An associated
                          [*OutputWindowSettings*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64455.md)
...
- [*StatusArea*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64526.md)
...
<a name="AEN64155"></a>### SINGLETON IMPLEMENTATION
...
Makes use of a
                [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63941.md#rdogui3_ui_StopWatch) to provide
...
<a name="AEN64290"></a>### SINGLETON IMPLEMENTATION
...
<a name="AEN64446"></a>### SINGLETON IMPLEMENTATION
