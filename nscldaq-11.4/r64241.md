...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64240.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [check →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64242.md)
...
<a name="AEN64255"></a>## Name

Introduction -- Data source providers

<a name="AEN64258"></a>## Synopsis
...
Data source providers are Tcl loadable packages that provide
            ...
            [*SSHPipe*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64728.md)
            which understands how to run command line readout programs on the end
            of a SSH pipeline to a (possibily) remote system, and
            [*s800*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64840.md) which
...
<a name="AEN64311"></a>## CREATING A DATA SOURCE PROVIDER
...
<a name="AEN64328"></a>## API FUNCTIONS
...
- **check** *sourceId*
  Whatever code is managing a set of data providers
                              ...
                              has exited.
                              [*check*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64457.md)
                              returns a true value if a source is still running and
                              false if not.
- **stop** *sourceId*
  [*stop*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64489.md)
                              Stops the specified data source.
- **begin** *sourceId runNumber title*
  Starts data taking for a new run.
                              See [*begin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64520.md)
                              for reference information.
- **pause** *sourceId*
  If your data source implements pause/resume functionality
                              you must define this command to pause the run.
                              See the 
                              [*pause*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64551.md)
...
- **end** *sourceId*
  The
                              [*end*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64621.md)
                              ends a run in a data source.
- **init** *sourceId*
  The
                              [*init*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64650.md)
                              causes an initialize procedure in the data source.
- **capbilities**
  Describes the data
                              [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64679.md)
                              source capabilities.
