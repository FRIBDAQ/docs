...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r73974.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cvmusb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r74117.md)
...
<a name="AEN74276"></a>## DESCRIPTION

This package provides a tcl interface to the
                `CVMUSB` class described in
                [CVMUSB(3)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r68367.md).
                See COMMANDS below for more information.

<a name="AEN74281"></a>## COMMANDS
