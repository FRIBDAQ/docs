...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48445.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48479.md)
...
<a name="AEN48460"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN48463"></a>## Synopsis

```
CException
```

<a name="AEN48497"></a>## Description
...
<a name="AEN48502"></a>## Public member functions
