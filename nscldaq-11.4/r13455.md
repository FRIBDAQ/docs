...
[← ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13454.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ringtostdout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13459.md)
...
<a name="AEN13513"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN13516"></a>**Example 1. making hex dumps of data from a ring buffer.**
