...
[← CCAENV560](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r31802.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV560 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32016.md)
...
<a name="AEN32158"></a>## Public member functions



- <a name="AEN32163"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN32191"></a>`void  Enable(int nChannel);`
...
- <a name="AEN32206"></a>`void  Disable(int nChannel);`
...
- <a name="AEN32221"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN32234"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN32246"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN32258"></a>`void   SetWide (void);`
...
- <a name="AEN32270"></a>`void   SetNarrow (void);`
...
- <a name="AEN32281"></a>`void  EnableHeader (void);`
...
- <a name="AEN32359"></a>`bool  isFull (void);`
...
- <a name="AEN32371"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN32383"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN32476"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN32490"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
