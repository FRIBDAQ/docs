...
[← CSIS3600](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34515.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3600 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34666.md)
...
<a name="AEN34678"></a>## Public member functions
...
- <a name="AEN34701"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN34711"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN34722"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN34733"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN34745"></a>` void SetLatchMode(void);const`
...
- <a name="AEN34757"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN34792"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN34861"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN34872"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN34883"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN34894"></a>` void Clock(void);const`
...
- <a name="AEN34905"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN34916"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN34927"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN34939"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN34950"></a>` unsigned long Read(void);const`
...
- <a name="AEN34962"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
