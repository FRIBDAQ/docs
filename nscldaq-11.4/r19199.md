...
<a name="AEN19254"></a>### Configuration Options
...
<a name="AEN19278"></a>### Device Options
...
<a name="AEN19308"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN19324"></a>```
...
Retrieve the ID code for the board above<a name="AEN19329"></a>```
...
Load firmware and license it.<a name="AEN19336"></a>```
...
Retrieve license information from a digitizer.<a name="AEN19344"></a>```
...
Un-license a digitizer's firmware:<a name="AEN19349"></a>```
