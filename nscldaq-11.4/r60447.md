...
[← EVBC::configParams](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60441.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60451.md)
...
<a name="AEN60461"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN60464"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN60468"></a>## DESCRIPTION
