...
[← CVMUSBReadoutList](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r71619.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMUSBRemote →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r72014.md)
...
<a name="AEN71814"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN71817"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN73003"></a>## DESCRIPTION
...
<a name="AEN73006"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r68893.md)
