...
[← CTCPBadSocketState](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44174.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPConnectionLost →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44261.md)
...
<a name="AEN44274"></a>## Name

CTCPConnectionLost -- Exception thrown when connection to peer is lost

<a name="AEN44277"></a>## Synopsis

```
CTCPConnectionLost
```

<a name="AEN44309"></a>## DESCRIPTION
