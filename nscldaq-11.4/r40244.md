...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40243.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CGaurdedObject →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r40275.md)
...
<a name="AEN40296"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44123.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10835.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r44903.md).
...
<a name="AEN40346"></a>## Types and public data
