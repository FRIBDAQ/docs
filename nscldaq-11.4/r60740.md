...
[← EVBC::reset](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60732.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [bells →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60748.md)
...
<a name="AEN60754"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN60757"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN60761"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60419.md).

<a name="AEN60769"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60419.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60850.md)).
