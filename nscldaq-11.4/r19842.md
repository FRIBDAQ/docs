...
[← CZCopyRingBuffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19795.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingItem →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19843.md)
...
<a name="AEN19856"></a>## Name

CRingItem -- Encapsulates an item in a ring buffer.

<a name="AEN19859"></a>## Synopsis
...
<a name="AEN20040"></a>## Public member functions
...
Predicates provide a powerful mechanism for selecting and sampling
            ...
            [`CRingSelectionPredicate`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23180.md),
            [`CAllButPredicate`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23522.md),
            and
            [`CDesiredTypesPredicate`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r23708.md).
            Note that you may also construct your own predicate classes should
            these not be sufficient to meet your needs.

The caller is responsible for deleting the object.

<a name="AEN20294"></a>## Types and public data
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19842.md#cringitem.include)
  This #include obtains the data type and
                      ...
                      constant.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19842.md#cringitem.predicate)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19842.md#cringitem.addtype)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19842.md#cringitem.get)
  This gets a pointer to the ring item that satisfies our
                      ...
                      PHYSICS_EVENT.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19842.md#cringitem.process)
  I'm omitting what you do to process the item as that's application
                      dependent.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19842.md#cringitem.delete)
