...
[← CCamac](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33745.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacModule →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r33833.md)
...
<a name="AEN33937"></a>## Public member functions
...
- <a name="AEN33960"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN33970"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN33981"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN33992"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN34004"></a>` void SetLatchMode(void);const`
...
- <a name="AEN34016"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN34051"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN34120"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN34131"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN34142"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN34153"></a>` void Clock(void);const`
...
- <a name="AEN34164"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN34175"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN34186"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN34198"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN34209"></a>` unsigned long Read(void);const`
...
- <a name="AEN34221"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
