...
[← Exemplified Usage of the Actions package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x12636.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The SoftwareTrigger and EventFilter programs →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x12769.md)
