...
[← Pipeline Building, Run Control, and DAQ Modularization](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x19.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Pushing external data into the event stream →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x2311.md)
