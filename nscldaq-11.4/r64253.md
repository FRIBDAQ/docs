...
[← PortManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64252.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [stop →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64274.md)
...
<a name="AEN64267"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN64270"></a>## Synopsis
...
<a name="AEN64284"></a>## METHODS



- <a name="AEN64289"></a>`PortManager(string host, int    port);`
