...
<a name="AEN28241"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN28244"></a>## Synopsis
...
<a name="AEN28470"></a>## Public member functions





<a name="AEN28476"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28538"></a>`unsigned long getBase(void);`
...
<a name="AEN28549"></a>`int getSerial(void);`
...
<a name="AEN28580"></a>`int  getFirmware(void);`
...
<a name="AEN28590"></a>`int  getCrate(void);`
...
<a name="AEN28601"></a>`void setCrate(int crateNum);`
...
<a name="AEN28614"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN28635"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN28645"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN28655"></a>`void keepOverflowData(void);`
...
<a name="AEN28665"></a>`void discardOverflowData(void);`
...
<a name="AEN28675"></a>`void keepInvalidData(void);`
...
<a name="AEN28686"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN28697"></a>`void commonStart(void);`
...
<a name="AEN28708"></a>`void commonStop(void);`
...
<a name="AEN28719"></a>`void setRange(int range);`
...
<a name="AEN28732"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN28804"></a>`void clearData
                                (void);`
...
<a name="AEN28847"></a>`bool Busy(void);`
...
<a name="AEN28858"></a>` bool gBusy(void);`
...
<a name="AEN28869"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN28880"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN28891"></a>`int readEvent(void* buf);`
...
<a name="AEN28904"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN28945"></a>`void enableSmallThresholds(void);`
...
<a name="AEN29008"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN29012"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN29016"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN29020"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN29024"></a>**Example 3. Reading out a CAEN 785 e.g.**
