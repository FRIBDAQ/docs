...
# <a name="AEN11084"></a>61.3. Compiling and linking parallel programs
...
<a name="AEN11094"></a>... -L$DAQLIB -lSwTrigger -ldataformat -ldaqthreads \  
...
<a name="AEN11097"></a>... -L$(DAQLIB) lSwTrigger -ldataformat -ldaqthreads \  
