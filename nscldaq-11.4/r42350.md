...
[← CopyrightNotice](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42304.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingBlockReader →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42352.md)
...
<a name="AEN42364"></a>## Name

CDAQShm -- class description

<a name="AEN42367"></a>## Synopsis

```
CDAQShm
```

<a name="AEN42482"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42350.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42350.md#daqshm-varsrefsect).
