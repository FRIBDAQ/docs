...
[← CFileDataSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26265.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSourceFactory" →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26328.md)
...
<a name="AEN26341"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN26344"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN26374"></a>## DESCRIPTION
...
<a name="AEN26436"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
