...
[← CTCPConnectionLost](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43745.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPBadSocketState →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43805.md)
...
<a name="AEN43779"></a>## Name

CTCPNoSuchService -- Exception thrown if a nonexistent service is referenced

<a name="AEN43782"></a>## Synopsis

```
CTCPNoSuchService
```

<a name="AEN43807"></a>## DESCRIPTION
