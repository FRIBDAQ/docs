...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29410.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29625.md)
...
<a name="AEN30156"></a>## Public member functions
...
- <a name="AEN30163"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN30184"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN30197"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN30222"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN30233"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN30566"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN30579"></a>` ECLOutputSelect
...
- <a name="AEN30647"></a>` unsigned short
...
- <a name="AEN30811"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30823"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30833"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30843"></a>` TriggerConfiguration
...
- <a name="AEN30940"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN30964"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN30981"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN31007"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN31021"></a>` PWResolution
...
- <a name="AEN31181"></a>` unsigned short
...
- <a name="AEN31275"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN31287"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN31304"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN31317"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN31329"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN31350"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN31362"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31377"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31392"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31407"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN31419"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN31434"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN31444"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN31456"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN31468"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN31480"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN31492"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN31502"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN31512"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN31522"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN31532"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN31544"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN31554"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN31564"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN31574"></a>` void EnableBypassOnError(void);`
- <a name="AEN31584"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN31594"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN31606"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN31616"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN31628"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN31638"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN31650"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN31662"></a>` void EnableAllChannels(void);`
- <a name="AEN31672"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN31682"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN31694"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN31706"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN31721"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN31733"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31745"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31766"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31779"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31796"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31814"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31829"></a>## Types and public data
