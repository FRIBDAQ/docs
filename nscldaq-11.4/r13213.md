...
[← BufferToRing](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13181.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [bufdump →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13235.md)
...
<a name="AEN13271"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN13274"></a>**Example 1. making hex dumps of data from a ring buffer.**
