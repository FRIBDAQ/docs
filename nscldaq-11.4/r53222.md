...
[← ULMTrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r53214.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ph7xxx →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r53236.md)
...
<a name="AEN53236"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN53239"></a>## Synopsis

```
CCCUSB
```

<a name="AEN54221"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r56471.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r56471.md) for
...
<a name="AEN54792"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN54796"></a>### Action Register
...
<a name="AEN54839"></a>### Firmware Register
...
<a name="AEN54891"></a>### Global Mode Register
...
<a name="AEN55024"></a>### Delay Register
...
<a name="AEN55057"></a>### Scaler Control register
...
<a name="AEN55090"></a>### LED Source Register
...
<a name="AEN55342"></a>### Output source selection register.
...
<a name="AEN55511"></a>### Device source register
...
<a name="AEN55864"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN55925"></a>### Transfer setup register
