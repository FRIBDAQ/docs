...
[← tclserver](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r17944.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vhqControl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r17950.md)
...
<a name="AEN17963"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN17966"></a>## Synopsis
...
<a name="AEN18021"></a>### Map access command
...
<a name="AEN18031"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN18039"></a>***mapname* put *width offset value***
