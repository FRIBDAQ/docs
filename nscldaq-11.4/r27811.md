...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r27968]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r27968]].
...
[[portAllocator(3tcl)|r80251]],
            [[CPortManagerException(3daq)|r27968]],
            [[DaqPortManager(1tcl)|r18200]]
