...
<a name="AEN58787"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN58790"></a>## Synopsis
...
<a name="AEN58959"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r53737]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r59508]])
...
<a name="AEN58967"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r59508]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r59508]] for
...
<a name="AEN59419"></a>## DEVICE ENUMERATION
...
<a name="AEN59443"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN59453"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN59459"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r56986]] for reference
...
<a name="AEN59502"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r53737]]
[[cccusbreadoutlist(3ccusb)|r59508]]
[[CCCUSBReadoutList(3ccusb)|r56986]]
