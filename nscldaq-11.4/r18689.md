...
[← CRingMaster](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18687.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SBS Vme Tcl package →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18690.md)
...
<a name="AEN18761"></a>### Map access command
...
<a name="AEN18771"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN18779"></a>***mapname* put *width offset value***
