...
[← CHostListCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41180.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41183.md)
...
<a name="AEN41265"></a>## Description

`CHostListCheck` is derived from the
            [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41029.md).
...
<a name="AEN41275"></a>## Public member functions
...
<a name="AEN41366"></a>## Types and public data
