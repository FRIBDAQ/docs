...
[← n568configfile](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85959.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CV977Busy →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85977.md)
...
<a name="AEN86023"></a>| Plug | Direction | Meaning |
| --- | --- | --- |
...
<a name="AEN86044"></a>## Public member functions
...
[CBusy(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r83802.md),
     [CV977Trigger(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r86085.md)
