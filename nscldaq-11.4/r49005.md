...
[← CURIFormatException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48996.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49043.md)
...
<a name="AEN49019"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN49023"></a>## Synopsis

```
CErrnoException
```

<a name="AEN49050"></a>## Description
...
<a name="AEN49059"></a>## Public member functions
