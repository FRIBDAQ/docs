...
[← adc](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64301.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [s800 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64324.md)
...
<a name="AEN64363"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62494.md#rdogui3_dialogwrapper).
