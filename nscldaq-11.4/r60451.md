...
[← Event builder client framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60447.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60455.md)
...
<a name="AEN60465"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN60468"></a>## Synopsis

```
CControlHardware
```

<a name="AEN60535"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60291.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60398.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN60542"></a>## METHODS
