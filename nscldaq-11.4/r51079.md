...
[← addtcldriver](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51052.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CZMQCommunicatorFactory →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r51084.md)

---

---

# <a name="AEN51079"></a>CDataSinkElement

<a name="AEN51083"></a>## Name

CDataSinkElement -- Forward data to some sink.

<a name="AEN51086"></a>## Synopsis
