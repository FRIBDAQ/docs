...
<a name="AEN58111"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN58114"></a>## Synopsis
...
<a name="AEN58283"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r53061]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r58832]])
...
<a name="AEN58291"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r58832]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r58832]] for
...
<a name="AEN58743"></a>## DEVICE ENUMERATION
...
<a name="AEN58767"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN58777"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN58783"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r56310]] for reference
...
<a name="AEN58826"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r53061]]
[[cccusbreadoutlist(3ccusb)|r58832]]
[[CCCUSBReadoutList(3ccusb)|r56310]]
