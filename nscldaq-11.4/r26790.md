...
[← FragmentIndex](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26769.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSinkFactory →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r26832.md)
...
<a name="AEN26804"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN26807"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN26837"></a>## DESCRIPTION
...
<a name="AEN26899"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
