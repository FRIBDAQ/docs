...
<a name="AEN18588"></a>### Configuration Options
...
<a name="AEN18612"></a>### Device Options
...
<a name="AEN18642"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN18658"></a>```
...
Retrieve the ID code for the board above<a name="AEN18663"></a>```
...
Load firmware and license it.<a name="AEN18670"></a>```
...
Retrieve license information from a digitizer.<a name="AEN18678"></a>```
...
Un-license a digitizer's firmware:<a name="AEN18683"></a>```
