...
[← StateManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63784.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [StatusArea →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63806.md)
...
<a name="AEN63805"></a>## Name

ui -- ReadoutGUI graphical user interface elements.

<a name="AEN63808"></a>## Synopsis
...
- [*readoutMenuBar*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_readoutMenubar)
  Provides the menu bar for the application.  This can
                          ...
                          as well.
- [*RunIdentification*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_RunIdentification)
...
- [*RunControl*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_RunControl)
  Provides a megawidget that contains the controls for a run.
                          These are buttons intended to drive the
                          [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63397.md).
...
- [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_StopWatch)
...
- [*ElapsedTimeDisplay*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_ElapsedTimeDisplay)
...
- [*TimedRunControls*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_TimedRunControls)
  ...
  An associated callout bundle hooks the singleton
                          ...
                          timed runs.
- [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_OutputWindow)
  ...
  An associated
                          [*OutputWindowSettings*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64305.md)
...
- [*StatusArea*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64376.md)
...
<a name="AEN64005"></a>### SINGLETON IMPLEMENTATION
...
Makes use of a
                [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63791.md#rdogui3_ui_StopWatch) to provide
...
<a name="AEN64140"></a>### SINGLETON IMPLEMENTATION
...
<a name="AEN64296"></a>### SINGLETON IMPLEMENTATION
