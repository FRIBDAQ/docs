...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28948.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29109.md)
...
<a name="AEN29171"></a>## Public member functions





- <a name="AEN29177"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN29189"></a>`bool Xtest(void);const`
...
- <a name="AEN29201"></a>`bool Qtest(void);const`
...
- <a name="AEN29218"></a>`bool TimedOut(void);const`
...
- <a name="AEN29230"></a>`bool BranchDemand(void);const`
...
- <a name="AEN29242"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN29256"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN29269"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN29283"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN29298"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN29313"></a>`bool IT4(void);const`
...
- <a name="AEN29327"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN29338"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN29351"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN29367"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN29378"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN29389"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN29399"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN29403"></a>**Example 1. Initializing branch 0**
