...
[← CCAENV830](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r31513.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV830 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r31675.md)
...
<a name="AEN31696"></a>## Public member functions



- <a name="AEN31701"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN31729"></a>`void  Enable(int nChannel);`
...
- <a name="AEN31744"></a>`void  Disable(int nChannel);`
...
- <a name="AEN31759"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN31772"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN31784"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN31796"></a>`void   SetWide (void);`
...
- <a name="AEN31808"></a>`void   SetNarrow (void);`
...
- <a name="AEN31819"></a>`void  EnableHeader (void);`
...
- <a name="AEN31897"></a>`bool  isFull (void);`
...
- <a name="AEN31909"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN31921"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN32014"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN32028"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
