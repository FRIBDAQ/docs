...
[← CCAENV830](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r31514.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV560 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r31802.md)
...
<a name="AEN31857"></a>## Public member functions



- <a name="AEN31862"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN31890"></a>`void  Enable(int nChannel);`
...
- <a name="AEN31905"></a>`void  Disable(int nChannel);`
...
- <a name="AEN31920"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN31933"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN31945"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN31957"></a>`void   SetWide (void);`
...
- <a name="AEN31969"></a>`void   SetNarrow (void);`
...
- <a name="AEN31980"></a>`void  EnableHeader (void);`
...
- <a name="AEN32058"></a>`bool  isFull (void);`
...
- <a name="AEN32070"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN32082"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN32175"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN32189"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
