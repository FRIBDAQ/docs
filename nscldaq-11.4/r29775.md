...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29625.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29779.md)
...
<a name="AEN30307"></a>## Public member functions
...
- <a name="AEN30314"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN30335"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN30348"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN30373"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN30384"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN30692"></a>` void
  ...
  Defines the FIFO almost full level.  If there are more than
                                  ...
                                  true
- <a name="AEN30707"></a>` unsigned short
...
- <a name="AEN30717"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN30730"></a>` ECLOutputSelect
...
- <a name="AEN30798"></a>` unsigned short
...
- <a name="AEN30962"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30974"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30984"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30994"></a>` TriggerConfiguration
...
- <a name="AEN31091"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN31115"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN31132"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN31158"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN31172"></a>` PWResolution
...
- <a name="AEN31332"></a>` unsigned short
...
- <a name="AEN31380"></a>` void
  ...
  Disables the specified channel.  Note that channel numbering
                              ...
                              about this.
- <a name="AEN31392"></a>` void EnableAllChannels(void);`
  Enables all of the channels on the module.
- <a name="AEN31402"></a>` void
...
- <a name="AEN31426"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN31438"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN31455"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN31468"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN31480"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN31501"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN31513"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31528"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31543"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN31558"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN31570"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN31585"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN31595"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN31607"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN31619"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN31631"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN31643"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN31653"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN31663"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN31673"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN31683"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN31695"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN31705"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN31715"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN31725"></a>` void EnableBypassOnError(void);`
- <a name="AEN31735"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN31745"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN31757"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN31767"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN31779"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN31789"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN31801"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN31813"></a>` void EnableAllChannels(void);`
- <a name="AEN31823"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN31833"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN31845"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN31857"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN31872"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN31884"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31896"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31917"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31930"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31947"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31965"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31980"></a>## Types and public data
