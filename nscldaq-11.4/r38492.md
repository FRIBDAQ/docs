...
[← CSynchronizedThread](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38429.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSynchronizedThread →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38493.md)
...
<a name="AEN38506"></a>## Name

CSynchronizedThread -- Thread with synchronized initialization

<a name="AEN38509"></a>## Synopsis

```

```

<a name="AEN38536"></a>## DESCRIPTION

Provides a Thread class (see
            [*Thread*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38349.md)).
