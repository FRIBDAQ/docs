...
[← CTCLPackagedObjectProcessor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48204.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48216.md)
...
<a name="AEN48325"></a>## Public member functions
...
<a name="AEN48436"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN48441"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r47482.md)
