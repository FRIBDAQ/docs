...
[← eventorderer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r86286.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vhqconfig →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r86300.md)
...
<a name="AEN86313"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN86316"></a>## Synopsis
...
<a name="AEN86364"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85585.md)).
