...
[← The ccusbcamac Tcl package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x3602.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The event logger and ReadoutShell →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x4096.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/readoutshell.jpg)
...
The menu bar provides access to ReadoutShell commands
                ...
                [*Customizing the ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x4130.md) describes
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/eventlogsettings.jpg)
...
- Event Log Program
  ...
  The
                              ...
                              [*The event logger and ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x4096.md) for
...
- Use `--number-of-sources`
  ...
  This option should be used if you are combining
                              ...
                              See
                              [*eventlog*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r14211.md) for more
...
- debug
  The debug log level is intended
                              ...
                              See, however
                              [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63945.md#rdogui3_ui_OutputWindow)  for
...
The log types and their visual representations can be controlled
                ...
                [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63945.md#rdogui3_ui_OutputWindow) for information
