...
[← Interactors](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9939.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Integer byte order conversion library →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c10067.md)

---

---

# <a name="AEN10063"></a>Chapter 50. Integer byte order conversion library
...
Reference material for this library is available in the
        [reference manual page for cvt](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r38981.md).

This chapter gives an high level view of how the
        library should be used.

# <a name="AEN10070"></a>50.1. Using the conversion library in your code

The conversion library is a set of C functions.  To use it,
            you will need to include the library header in your source code
            with a line like:

<a name="AEN10073"></a>**Example 50-1. Including the cvt header**
...
<a name="AEN10079"></a>**Example 50-2. Compiling a C or C++ source file that includes cvt.h**
...
<a name="AEN10083"></a>**Example 50-3. A makefile rule that builds a C++ program using the
                cvt package**
