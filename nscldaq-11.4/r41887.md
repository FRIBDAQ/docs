...
[← CFdInteractor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41875.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDAQShm →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41888.md)
...
<a name="AEN41901"></a>## Name

CDAQShm -- class description

<a name="AEN41904"></a>## Synopsis

```
CDAQShm
```

<a name="AEN42019"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41887.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r41887.md#daqshm-varsrefsect).
