...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27811.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27814.md)
...
<a name="AEN27876"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27656.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN27883"></a>## Public member functions
...
<a name="AEN27939"></a>## Types and public data
...
<a name="AEN27959"></a>**Example 1. Catching a CPortManagerException**
...
[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r79741.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r27656.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18045.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49122.md)
