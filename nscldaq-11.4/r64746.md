...
[← 3provider](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64744.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3provider →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64748.md)
...
<a name="AEN64760"></a>## Name

Introduction -- Data source providers

<a name="AEN64763"></a>## Synopsis
...
Data source providers are Tcl loadable packages that provide
            ...
            [*SSHPipe*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65233.md)
            which understands how to run command line readout programs on the end
            of a SSH pipeline to a (possibily) remote system, and
            [*s800*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65345.md) which
...
<a name="AEN64816"></a>## CREATING A DATA SOURCE PROVIDER
...
<a name="AEN64833"></a>## API FUNCTIONS
...
- **parameters**
  Each data source a data source provider starts may
                              ...
                              command connections.
                              [*parameters*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64906.md)
...
- **check** *sourceId*
  Whatever code is managing a set of data providers
                              ...
                              has exited.
                              [*check*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64962.md)
                              returns a true value if a source is still running and
                              false if not.
- **stop** *sourceId*
  [*stop*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64994.md)
                              Stops the specified data source.
- **begin** *sourceId runNumber title*
  Starts data taking for a new run.
                              See [*begin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65025.md)
                              for reference information.
- **pause** *sourceId*
  If your data source implements pause/resume functionality
                              you must define this command to pause the run.
                              See the 
                              [*pause*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65056.md)
                              reference material for more information.
- **resume** *sourceId*
  If your data source implements pause/resume functionality
                              you must implement
                              [*resume*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65093.md)
                              to resume paused runs.
- **end** *sourceId*
  The
                              [*end*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65126.md)
                              ends a run in a data source.
- **init** *sourceId*
  The
                              [*init*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65155.md)
                              causes an initialize procedure in the data source.
- **capbilities**
  Describes the data
                              [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r65184.md)
                              source capabilities.
