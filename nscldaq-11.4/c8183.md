...
[← Providing EPICS channel information to Tcl Servers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8145.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Epics Channel logging →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8202.md)
...
The epicsdisplay utility provides a tabular
    ...
    available at the [epicsdisplay
      reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r18961.md)

epicsdisplay reads in a configuration file.
    The configuration file is compatible with [the controlpush](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r15677.md) application,
