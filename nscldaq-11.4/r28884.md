...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28731.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r28947.md)
...
<a name="AEN29416"></a>## Public member functions
...
- <a name="AEN29423"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN29444"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN29457"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN29482"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN29493"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN29826"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN29839"></a>` ECLOutputSelect
...
- <a name="AEN29907"></a>` unsigned short
...
- <a name="AEN30071"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN30083"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN30093"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN30103"></a>` TriggerConfiguration
...
- <a name="AEN30200"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN30224"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN30241"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN30267"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN30281"></a>` PWResolution
...
- <a name="AEN30441"></a>` unsigned short
...
- <a name="AEN30489"></a>` void
  ...
  Disables the specified channel.  Note that channel numbering
                              ...
                              about this.
- <a name="AEN30501"></a>` void EnableAllChannels(void);`
...
- <a name="AEN30535"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN30547"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN30564"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN30577"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN30589"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN30610"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN30622"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30637"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30652"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN30667"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN30679"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN30694"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN30704"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN30716"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN30728"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN30740"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN30752"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN30762"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN30772"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN30782"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN30792"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN30804"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN30814"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN30824"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN30834"></a>` void EnableBypassOnError(void);`
- <a name="AEN30844"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN30854"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN30866"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN30876"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN30888"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN30898"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN30910"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN30922"></a>` void EnableAllChannels(void);`
- <a name="AEN30932"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN30942"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN30954"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN30966"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN30981"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN30993"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN31005"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN31026"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN31039"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN31056"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN31074"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN31089"></a>## Types and public data
