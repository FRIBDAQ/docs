...
# <a name="AEN12648"></a>Chapter 72. Software Triggering NEW IN 11.4
...
# <a name="AEN12672"></a>72.1. Creating classification libraries.
...
## <a name="AEN12681"></a>72.1.1. Writing the classification class and factory function
...
DataFormat.hDefines the format of raw ring items.
...
| --- | --- | --- |
| Prev | Home | Next |
| Exemplified Usage of the Actions package | Up | The SoftwareTrigger and EventFilter programs |
