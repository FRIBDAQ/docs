...
[← CSIS3820](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34244.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3820 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r34307.md)
...
<a name="AEN34463"></a>## Public member functions
...
- <a name="AEN34486"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN34496"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN34507"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN34518"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN34530"></a>` void SetLatchMode(void);const`
...
- <a name="AEN34542"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN34577"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN34646"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN34657"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN34668"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN34679"></a>` void Clock(void);const`
...
- <a name="AEN34690"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN34701"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN34712"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN34724"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN34735"></a>` unsigned long Read(void);const`
...
- <a name="AEN34747"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
