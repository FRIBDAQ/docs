...
[← DataSourceUI](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62648.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutGUIAppLauncher →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62719.md)
...
<a name="AEN62709"></a>## Name

ui -- ReadoutGUI graphical user interface elements.

<a name="AEN62712"></a>## Synopsis

**
package require ui
          **

<a name="AEN62715"></a>## DESCRIPTION
...
- [*readoutMenuBar*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_readoutMenubar)
  Provides the menu bar for the application.  This can
                          ...
                          as well.
- [*RunIdentification*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_RunIdentification)
...
- [*RunControl*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_RunControl)
  Provides a megawidget that contains the controls for a run.
                          These are buttons intended to drive the
                          [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62301.md).
...
- [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_StopWatch)
...
- [*ElapsedTimeDisplay*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_ElapsedTimeDisplay)
...
- [*TimedRunControls*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_TimedRunControls)
  ...
  An associated callout bundle hooks the singleton
                          ...
                          timed runs.
- [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_OutputWindow)
  ...
  An associated
                          [*OutputWindowSettings*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63209.md)
...
- [*StatusArea*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63280.md)
...
<a name="AEN62909"></a>### SINGLETON IMPLEMENTATION
...
Makes use of a
                [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62695.md#rdogui3_ui_StopWatch) to provide
...
<a name="AEN63044"></a>### SINGLETON IMPLEMENTATION
...
<a name="AEN63200"></a>### SINGLETON IMPLEMENTATION
