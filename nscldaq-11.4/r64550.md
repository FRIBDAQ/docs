...
[← caenchain](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64549.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [pause →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64551.md)
...
<a name="AEN64564"></a>## Name

pause -- Pause a data taking run (optional)

<a name="AEN64567"></a>## Synopsis
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64678.md) specifies  the
