...
Predicates provide a powerful mechanism for selecting and sampling
            ...
            [[`CRingSelectionPredicate`|r24008]],
            [[`CAllButPredicate`|r24350]],
            and
            [[`CDesiredTypesPredicate`|r24536]].
...
- [[![(1)](../images/callouts/1.gif)|r20670#cringitem.include]]
  This #include obtains the data type and
                      ...
                      constant.
- [[![(2)](../images/callouts/2.gif)|r20670#cringitem.predicate]]
...
- [[![(3)](../images/callouts/3.gif)|r20670#cringitem.addtype]]
...
- [[![(4)](../images/callouts/4.gif)|r20670#cringitem.get]]
  This gets a pointer to the ring item that satisfies our
                      ...
                      PHYSICS_EVENT.
- [[![(5)](../images/callouts/5.gif)|r20670#cringitem.process]]
  I'm omitting what you do to process the item as that's application
                      dependent.
- [[![(6)](../images/callouts/6.gif)|r20670#cringitem.delete]]
