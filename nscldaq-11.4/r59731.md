...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59678.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBControl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59739.md)
...
<a name="AEN59745"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN59748"></a>## Synopsis

```
CControlHardware
```

<a name="AEN59815"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59571.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r59678.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN59822"></a>## METHODS
