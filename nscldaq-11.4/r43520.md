...
[← CTCPBadSocketState](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43504.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPConnectionLost →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r43583.md)
...
<a name="AEN43534"></a>## Name

CTCPConnectionLost -- Exception thrown when connection to peer is lost

<a name="AEN43537"></a>## Synopsis

```
CTCPConnectionLost
```

<a name="AEN43569"></a>## DESCRIPTION
...
<a name="AEN43626"></a>## SEE ALSO

[*CSocket*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42425.md)
