...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49043.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStreamIOError →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49048.md)
...
<a name="AEN49157"></a>## Public member functions
...
<a name="AEN49268"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN49273"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48314.md)
