...
[← Compiling and linking parallel programs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11084.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Building the use shared library →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11143.md)

---

---

# <a name="AEN11134"></a>63.2. Using the standard event orderer startup script
