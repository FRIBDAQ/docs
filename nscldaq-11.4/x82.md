...
[← BufferToRing](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x8140.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Overview and Examples of ring buffers in action. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x8504.md)
...
Finally, the data transferred through the ring buffer is just
      ...
      have a structure defined later in [Chapter 3](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c185.md).
