...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60859.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startRingSource →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60867.md)
...
Starts a fragment source that gets its data from a ring buffer.  For
            ...
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11787.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11787.md#sec_tsextractors)
