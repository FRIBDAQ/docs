...
[← CVMEStatusModule](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35705.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMETrigger →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35735.md)
...
<a name="AEN35730"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN35733"></a>## Synopsis
...
<a name="AEN35840"></a>## Public member functions



- <a name="AEN35845"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN35883"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN35898"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN35911"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN35924"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN35969"></a>`T*  T* operator-> (void);`
...
- <a name="AEN35979"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN35994"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36006"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN36018"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN36030"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN36040"></a>## Types and public data
