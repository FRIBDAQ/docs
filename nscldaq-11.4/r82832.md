...
[← RingStatus](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r82826.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Orphan →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r82833.md)

---

---

# <a name="AEN82832"></a>Orphan

<a name="AEN82836"></a>## Name

Orphan -- Run script when the process is orphaned

<a name="AEN82839"></a>## Synopsis
