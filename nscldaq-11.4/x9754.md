...
[← Using TclRingBuffer in event driven software](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9622.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [A simple example →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9758.md)

---

---

# <a name="AEN9754"></a>45.2. A simple example
...
## <a name="AEN9758"></a>45.2.1. Configuring the ctlconfig.tcl
...
## <a name="AEN9767"></a>45.2.2. The script that runs ccusbcamac commands
