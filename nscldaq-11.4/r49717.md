...
[← CStreamIOError](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49714.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStreamIOError →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49718.md)
...
`CMonitorException`
            is derived from the
            [CException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r48908.md)
            class, and therefore supports and implements all of its
            virtual members.

<a name="AEN49805"></a>## Public member functions
