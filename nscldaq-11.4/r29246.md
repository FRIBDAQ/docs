...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29109.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r29247.md)
...
- <a name="AEN29415"></a>`bool Qtest(void);const`
...
- <a name="AEN29432"></a>`bool TimedOut(void);const`
...
- <a name="AEN29444"></a>`bool BranchDemand(void);const`
...
- <a name="AEN29456"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN29470"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN29483"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN29497"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN29512"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN29527"></a>`bool IT4(void);const`
...
- <a name="AEN29541"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN29552"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN29565"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN29581"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN29592"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN29603"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN29613"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN29617"></a>**Example 1. Initializing branch 0**
