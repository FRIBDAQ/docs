...
[← OutputWindowSettings](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63272.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [StateManager →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63274.md)
...
<a name="AEN63295"></a>## DESCRIPTION

This megawidget provides a prompter for options that can be applied to
            a
            [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r62759.md#rdogui3_ui_OutputWindow)
...
<a name="AEN63331"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61462.md#rdogui3_dialogwrapper).
