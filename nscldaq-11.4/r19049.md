...
<a name="AEN19104"></a>### Configuration Options
...
<a name="AEN19128"></a>### Device Options
...
<a name="AEN19158"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN19174"></a>```
...
Retrieve the ID code for the board above<a name="AEN19179"></a>```
...
Load firmware and license it.<a name="AEN19186"></a>```
...
Retrieve license information from a digitizer.<a name="AEN19194"></a>```
...
Un-license a digitizer's firmware:<a name="AEN19199"></a>```
