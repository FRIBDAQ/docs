...
<a name="AEN19103"></a>### Configuration Options
...
<a name="AEN19127"></a>### Device Options
...
<a name="AEN19157"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN19173"></a>```
...
Retrieve the ID code for the board above<a name="AEN19178"></a>```
...
Load firmware and license it.<a name="AEN19185"></a>```
...
Retrieve license information from a digitizer.<a name="AEN19193"></a>```
...
Un-license a digitizer's firmware:<a name="AEN19198"></a>```
