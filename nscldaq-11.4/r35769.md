...
[← CVMETrigger](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35735.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEptr →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r35796.md)
...
<a name="AEN35822"></a>## Public member functions
...
<a name="AEN35860"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN35863"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
