...
[← EVBC::startRingSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60866.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60869.md)
...
<a name="AEN60881"></a>## Name

EVBC::startRingSource -- Start a ring fragment source for the event builder.

<a name="AEN60884"></a>## Synopsis

**
EVBC::startRingSource *source-uri extractor-lib source-id info*
**

<a name="AEN60888"></a>## DESCRIPTION

Please use the [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r60779.md) instead of this proc.

Starts a fragment source that gets its data from a ring buffer.  For
            more on ring fragment sources see:
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11788.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x11788.md#sec_tsextractors)
