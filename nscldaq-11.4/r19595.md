...
[← CRingBuffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19485.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingAccess →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19599.md)
...
<a name="AEN19609"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN19612"></a>## Synopsis
...
<a name="AEN19688"></a>## Public member functions
...
<a name="AEN19779"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN19783"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN19787"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
