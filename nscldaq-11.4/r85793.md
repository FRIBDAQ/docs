...
[← vhqconfig](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85784.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CScaler →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85794.md)
...
<a name="AEN85807"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN85810"></a>## Synopsis
...
<a name="AEN85858"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r85079.md)).
