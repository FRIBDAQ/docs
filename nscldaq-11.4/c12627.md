...
[← The actions library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12556.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Software Triggering NEW IN 11.4 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12643.md)

---

---

# <a name="AEN12627"></a>Chapter 70. Software Triggering NEW IN 11.4
...
# <a name="AEN12651"></a>70.1. Creating classification libraries.
...
## <a name="AEN12660"></a>70.1.1. Writing the classification class and factory function
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.includes)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.class)
  Defines our class.   Notice that our class has
                          `CRingMarkingWorker::Classifier`
                          as its base class.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.functor)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.externc)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.factory)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.factory-op)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.definelarge)
  The constant `LARGE` defines what
                          ...
                          of this number.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.getbodysize)
  The `CRingItem` provides a method
                          that computes the body size.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c12627.md#sillyc.classify)
  This code returns 1 if the body size is greater than
                          LARGE (500) and 0 otherwise.

## <a name="AEN12754"></a>70.1.2. Building the classification shared library.
