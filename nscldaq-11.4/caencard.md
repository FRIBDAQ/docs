...
<a name="AEN28610"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN28613"></a>## Synopsis
...
<a name="AEN28839"></a>## Public member functions





<a name="AEN28845"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN28907"></a>`unsigned long getBase(void);`
...
<a name="AEN28918"></a>`int getSerial(void);`
...
<a name="AEN28949"></a>`int  getFirmware(void);`
...
<a name="AEN28959"></a>`int  getCrate(void);`
...
<a name="AEN28970"></a>`void setCrate(int crateNum);`
...
<a name="AEN28983"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN29004"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN29014"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN29024"></a>`void keepOverflowData(void);`
...
<a name="AEN29034"></a>`void discardOverflowData(void);`
...
<a name="AEN29044"></a>`void keepInvalidData(void);`
...
<a name="AEN29055"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN29066"></a>`void commonStart(void);`
...
<a name="AEN29077"></a>`void commonStop(void);`
...
<a name="AEN29088"></a>`void setRange(int range);`
...
<a name="AEN29101"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN29173"></a>`void clearData
                                (void);`
...
<a name="AEN29216"></a>`bool Busy(void);`
...
<a name="AEN29227"></a>` bool gBusy(void);`
...
<a name="AEN29238"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN29249"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN29260"></a>`int readEvent(void* buf);`
...
<a name="AEN29273"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN29314"></a>`void enableSmallThresholds(void);`
...
<a name="AEN29377"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN29381"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN29385"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN29389"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN29393"></a>**Example 3. Reading out a CAEN 785 e.g.**
