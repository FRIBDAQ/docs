...
[← CTestTransport](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49886.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CURIFormatException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r49891.md)
...
<a name="AEN49901"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN49904"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN49988"></a>## Description
...
<a name="AEN49995"></a>## Public member functions
