...
[← CFileDataSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25595.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSourceFactory" →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25662.md)
...
<a name="AEN25621"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN25624"></a>## Synopsis

```
CDataSink
```

<a name="AEN25649"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r25941.md)
