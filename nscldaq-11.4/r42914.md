...
[← CRingBlockReader](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42815.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [io::CBufferedOutput →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r42933.md)

---

---

# <a name="AEN42914"></a>CRingFileBlockReader

<a name="AEN42918"></a>## Name

CRingFileBlockReader -- CRingBlockreader that reads from file.

<a name="AEN42921"></a>## Synopsis
