...
[← CCAENV977](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32242.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV830 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r32345.md)
...
- <a name="AEN32528"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN32556"></a>`void  Enable(int nChannel);`
...
- <a name="AEN32571"></a>`void  Disable(int nChannel);`
...
- <a name="AEN32586"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN32599"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN32611"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN32623"></a>`void   SetWide (void);`
...
- <a name="AEN32635"></a>`void   SetNarrow (void);`
...
- <a name="AEN32646"></a>`void  EnableHeader (void);`
...
- <a name="AEN32724"></a>`bool  isFull (void);`
...
- <a name="AEN32736"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN32748"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN32841"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN32855"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
