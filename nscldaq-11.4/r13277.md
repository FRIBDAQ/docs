...
[← ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13276.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1daq →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r13312.md)
...
<a name="AEN13335"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN13338"></a>**Example 1. making hex dumps of data from a ring buffer.**
