...
<a name="AEN58788"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN58791"></a>## Synopsis
...
<a name="AEN58960"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r53738]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r59509]])
...
<a name="AEN58968"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r59509]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r59509]] for
...
<a name="AEN59420"></a>## DEVICE ENUMERATION
...
<a name="AEN59444"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN59454"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN59460"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r56987]] for reference
...
<a name="AEN59503"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r53738]]
[[cccusbreadoutlist(3ccusb)|r59509]]
[[CCCUSBReadoutList(3ccusb)|r56987]]
