...
[← CZCopyRingBuffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19641.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingBuffer →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19700.md)
...
The `CRingBuffer` class include static methods
            ...
            [The Ring Buffer Primitives](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/c8467.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.filter)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.filter.savetype)
  The constructor of
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.filter.function)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.filter.peek)
  The predicate function operator will peek at message
                      headers.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.filter.noheader)
  If there are no messages in the ring buffer when the
                      ...
                      blocking.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.filter.skip)
  This code assumes that messages are atomically put in the
                      ...
                      continue to block.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.filter.found)
  If, on the other hand, the message matches the desired message
                      ...
                      blocking.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.predicate)
  The first step to actually filtering out unwanted message
                      ...
                      we want to see.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.skipsome)
  This call to
...
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.peekheader)
  Peeking at the message header allows us to allocate
                      the storage needed for the entire message, and to read the
                      message atomically.
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r19699.md#ringman.readmsg)
  Reads the message.
