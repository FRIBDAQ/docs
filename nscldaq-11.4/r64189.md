...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64187.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SSHPipe →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r64212.md)
...
<a name="AEN64203"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN64206"></a>## Synopsis
...
- <a name="AEN64225"></a>`PortManager(string host, int    port);`
