...
[← EVBC::startRingSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61376.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DataSourceUI →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r61398.md)
...
<a name="AEN61409"></a>## Name

Configuration -- Configuration variable management

<a name="AEN61412"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63060.md) package for that
            instead.

<a name="AEN61435"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/r63060.md) is a better
                          choice).
