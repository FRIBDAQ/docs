...
[← Features](https://github.com/FRIBDAQ/docs/tree/main/qtpy/c28.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CutiePie (QtPy) (version 5.13-000) →](https://github.com/FRIBDAQ/docs/tree/main/qtpy/index.md)

---

---

# <a name="AEN89"></a>Chapter 4. Plotting window
...
<a name="AEN92"></a>**Figure 4-1. Canvas quick actions**

![](https://github.com/FRIBDAQ/docs/tree/main/qtpy/quick.jpg)
...
- Copy Properties: opens a popup window with several options
  <a name="AEN106"></a>**Figure 4-2. Copy Properties**
  ![](https://github.com/FRIBDAQ/docs/tree/main/qtpy/copy.jpg)
