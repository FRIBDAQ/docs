...
[← How to start CutiePie](https://github.com/FRIBDAQ/docs/tree/main/qtpy/c164.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Standalone CutiePie →](https://github.com/FRIBDAQ/docs/tree/main/qtpy/c168.md)

---

---

# <a name="AEN165"></a>Chapter 8. How to customize ML algo and fitting functions
...
<a name="AEN168"></a>**Example 8-1. ML algorithm skeleton.**
...
<a name="AEN171"></a>**Example 8-2. Example of ML algorithm based on the skeleton. The output is shown in Figure 3-5.**
...
<a name="AEN174"></a>**Example 8-3. Fitting function skeleton.**
...
<a name="AEN177"></a>**Example 8-4. Example of fitting function based on the skeleton.**
