...
<a name="AEN299"></a>## Name

fit -- 1-d Spectrum fitting computation

<a name="AEN302"></a>## Synopsis
...
<a name="AEN384"></a>#### Parameters of supported fit types:
...
<a name="AEN416"></a>y = baseline + height * exp(-0.5*((x-centroid)/sigma)**2)
...
<a name="AEN438"></a>y  = offset + slope*x

<a name="AEN440"></a>### proc
...
<a name="AEN449"></a>## EXAMPLES

<a name="AEN451"></a>**Example 11. Using the proc subcommand**
