...
[← specstats](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/cmdref/r729.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [treeparameter →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/cmdref/r774.md)
...
<a name="AEN828"></a>## COMMAND FORMATS
...
<a name="AEN984"></a>**Example 2. Listing all tree parameters with sample output**
...
<a name="AEN989"></a>**Example 3. Listing only some parameters (using a pattern)**
...
<a name="AEN994"></a>**Example 4. The treeparameter -check command**
...
<a name="AEN1005"></a>**Example 5. Unsetting the modified flag:**
