...
[← sread](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/cmdref/r2904.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [fit →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/cmdref/r295.md)
...
<a name="AEN298"></a>## Name

fit -- 1-d Spectrum fitting computation

<a name="AEN301"></a>## Synopsis
...
<a name="AEN383"></a>#### Parameters of supported fit types:
...
<a name="AEN415"></a>y = baseline + height * exp(-0.5*((x-centroid)/sigma)**2)
...
<a name="AEN437"></a>y  = offset + slope*x

<a name="AEN439"></a>### proc
...
<a name="AEN448"></a>## EXAMPLES

<a name="AEN450"></a>**Example 1. Using the proc subcommand**
