...
[← DAQ::DDAS::DDASUnpacker](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/DDAS/r565.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQ::DDAS::CDDASBuiltUnpacker →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/DDAS/r647.md)

---

---

# <a name="AEN616"></a>DAQ::DDAS::CDDASBuiltUnpacker

<a name="AEN620"></a>## Name

DAQ::DDAS::CDDASBuiltUnpacker -- Unpack ddas hits from event built data.

<a name="AEN623"></a>## Synopsis
