...
[← REST interface for the fold command (new in 5.5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/restdocs/x992.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Introduction> →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/DDAS/c13.md)
