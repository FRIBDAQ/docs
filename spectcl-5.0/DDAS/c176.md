...
Line whose first character is #Ignored.  Use this to comment your configuration file.

Channel definitionThese lines contain five fields.  In order there are four
...
| --- | --- | --- |
| Prev | Home | Next |
| DDAS Data unpackers. |  | CCalibratedFileDrivenParameterMapper |
