...
[← CFileDrivenParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/DDAS/r710.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CFileDrivenParameterMapper →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/DDAS/r754.md)

---

---

# <a name="AEN723"></a>CFileDrivenParameterMapper

<a name="AEN727"></a>## Name

CFileDrivenParameterMapper -- Parameter mapper operating from description file.

<a name="AEN730"></a>## Synopsis
