...
[← dbconfig::restoreAllSpectrumContents](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/r288.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [dbconfig::listSavedSpectra →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/r309.md)
...
- int `s_id`
  Spectrum definitions are spread over several
                                      ...
                                      from this table.
  See the [*Database schema.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/x6432.md#AEN6432)
