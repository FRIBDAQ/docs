...
id : IntegerThe primary key in the save_sets table for this
                                save set.  See Appendix A for information
                                about what this means.

name : StringThe name of the save set this dict describes.

time : IntegerThe timestamp of the time at which the save set
