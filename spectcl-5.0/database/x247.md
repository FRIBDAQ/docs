...
[[![(1)](../images/callouts/1.gif)|x247#pardef.paramhdr]]                        Parameters are encapsulated in
                    ...
                    [[![(2)](../images/callouts/2.gif)|x247#pardef.psave]]                        This will be a pointer to the save set
                        ...
                        exception.
                    [[![(3)](../images/callouts/3.gif)|x247#pardef.getsvset]]                        The `getSaveSet`
...
[[![(5)](../images/callouts/5.gif)|x247#pardef.listpars]]                        Produces a container with pointers to all
...
[[![(1)](../images/callouts/1.gif)|x247#specdef.header]]                        We will be calling methods of the
                        `DBSpectrum`
...
[[![(3)](../images/callouts/3.gif)|x247#specdef.axes]]                        Spectra require one or two axes as well.
...
[[![(1)](../images/callouts/1.gif)|x247#gatedef.header]]                        The DBGate.h header defines
                        ...
                        delete them.
                    [[![(2)](../images/callouts/2.gif)|x247#gatedef.1d]]                        This section of code creates a 1-d gate.
...
[[![(4)](../images/callouts/4.gif)|x247#gatedef.compound]]                        The only difference between a 1d and
...
[[![(6)](../images/callouts/6.gif)|x247#gatedef.list]]                        This section of code lists the gates
...
[[![(1)](../images/callouts/1.gif)|x247#applydef.header]]                        The Applictions.h
                        header defines the
...
[[![(1)](../images/callouts/1.gif)|x247#tv.header]]                        The DBTreeVariable.h
                    ...
                    [[![(3)](../images/callouts/3.gif)|x247#tv.list]]                        This section of code lists the tree
...
[[![(1)](../images/callouts/1.gif)|x247#evtstore.crevent]]                        This function creates an event. It
...
[[![(2)](../images/callouts/2.gif)|x247#evtstore.start]]                        The `startRun`
...
[[![(7)](../images/callouts/7.gif)|x247#evtstore.commit2]]                        Performs the commit for any partial
                        block of events.
                    [[![(8)](../images/callouts/8.gif)|x247#evtstore.endrun]]                        Closes off the run by providing the
                        end run time.
...
[[![(1)](../images/callouts/1.gif)|x247#evtget.sink]]                        This function is a stand in for whatever
                    ...
                    [[![(3)](../images/callouts/3.gif)|x247#evtget.evts]]                        Getting events back from the database
                        ...
                        result set.
                    [[![(4)](../images/callouts/4.gif)|x247#evtget.read]] `readEvent`
...
[[![(5)](../images/callouts/5.gif)|x247#evtget.close]] `closeEvents`
...
[[![(1)](../images/callouts/1.gif)|x247#sclstore.produce]]                        We need something to generate our scaler
...
[[![(2)](../images/callouts/2.gif)|x247#sclstore.save]]                        This loop simulates the scaler readouts
...
[[![(1)](../images/callouts/1.gif)|x247#sclget.process]]                        This function is a stand-in for any processing you
                    ...
                    [[![(3)](../images/callouts/3.gif)|x247#sclget.open]]                        As with getting events from the database,
                        ...
                        from that query.
                    [[![(4)](../images/callouts/4.gif)|x247#sclget.read]]                        The `readScaler`
...
[[![(5)](../images/callouts/5.gif)|x247#sclget.close]]                        Once you are done iterating over the
