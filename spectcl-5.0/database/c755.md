...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#makedb.tcl.boilerplate]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#makedb.tcl.autopath]]
  As described previously, this line appends the
                  SpecTcl Tcl library directory tree to the
                  **package require** search path.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#makedb.tcl.require]]
  Brings the SpecTclDB package into the
                  script. This defines the command ensemble that
                  makes up the package.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#makdeb.tcl.args]]
  The `argv` list contains
                  the command parameters that follow the command.
                  Note that the command itself is not included.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#makedb.tcl.create]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#mkset.catch]]
  ...
  The optional second argument to **catch**
                  ...
                  failure.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#mkset.connect]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#mkset.crset]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#mkset.destroy]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#mkset.errors]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#lssavesets.tcl.list]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#pardef.tclgetsaveset]]
  ...
  The command ensemble that
                  ...
                  *save set instance command* and
                  ...
                  variable.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#pardef.tclcreate]]
  ...
  The first command creates a raw parameter named
                  ...
                  (cm).
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#pardef.tcllist]]
  ...
  - units (optional)
    This key is only present for tree parameters.  It is
                                ...
                                values).
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#pardef.tcldestroy]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#specdef.tcl.cr1d]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#specdef.tcl.cr2d]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#specdef.tcl.list]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#gatedef.tcl.1d]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#gatedef.tcl.2d]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#gatedef.tcl.compound]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#gatedef.tcl.mask]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#gatedef.tcl.list]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#applydef.tcl.apply]]
  The **applyGate** subcommand
                  ...
                  spectrum.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#applydef.tcl.list]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#vardef.tcl.make]]
  ...
  This and the next line of code create a pair of variables that might
                  ...
                  will be; KeV.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#vardef.tcl.unitless]]
  If the variable has no units of measure, you can leave the units
                  ...
                  empty string.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#vardef.tcl.list]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#specstore.tcl.store]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#specstore.tcl.get]]
  The **getChannels** subcommand returns a list of
                  ...
                  channel value.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c755.md#specstore.tcl.list]]
...
| --- | --- | --- |
| Prev | Home | Next |
| Upper layer of SpecTcl's event recording/playback code. |  | SpecTcl API to the database. |
