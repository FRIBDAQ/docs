...
DatabaseIn this manual database means a relational database, specifically
...
Save SetA saved set is a named entity that stores objects.  Save sets
...
ConfigurationOne of the things that can be stored in a save set is a configuration.
...
SpectraSpecTcl's purpose in life is to produce histograms, which it
...
Event DataWhen SpecTcl analyzes raw data, either from a data file or
