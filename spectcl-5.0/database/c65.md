...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#makedb.includes)
  Including this header brings the class definition of
                          `SpecTclDB::CDatabase` into our
                          program.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#makedb.create)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#makesvset.savesetheader)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#makesvset.opendb)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#makesvset.makeset)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#makesvset.errors)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#lssvset.getall)
  ...
  A look at the header will tell you that `savesets`
                          ...
                          of explanation.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#lssvset.name)
  Saveset objects have a
                          ...
                          `std::string`).
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/database/c65.md#lssaveset.del)
