...
- [[![(1)](../images/callouts/1.gif)|c65#makedb.includes]]
  Including this header brings the class definition of
                          `SpecTclDB::CDatabase` into our
                          program.
- [[![(2)](../images/callouts/2.gif)|c65#makedb.create]]
...
- [[![(1)](../images/callouts/1.gif)|c65#makesvset.savesetheader]]
...
- [[![(2)](../images/callouts/2.gif)|c65#makesvset.opendb]]
...
- [[![(3)](../images/callouts/3.gif)|c65#makesvset.makeset]]
...
- [[![(4)](../images/callouts/4.gif)|c65#makesvset.errors]]
...
- [[![(1)](../images/callouts/1.gif)|c65#lssvset.getall]]
  ...
  A look at the header will tell you that `savesets`
                          ...
                          of explanation.
- [[![(2)](../images/callouts/2.gif)|c65#lssvset.name]]
  Saveset objects have a
                          ...
                          `std::string`).
- [[![(3)](../images/callouts/3.gif)|c65#lssaveset.del]]
