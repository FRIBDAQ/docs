...
**open** *db-file*Opens the database file named `db-file`
                                any previously  open data base file is closed.
                                Further operations in the ensemble will operate
                                on `db-file`.

**enable**Enables event recording to the database.
...
**disable**Disables event recording immediately.  This should
...
**close**Closes the database.  Once closed, the only
                                valid operations are **open**
                                and **autosave**.

**autosave** *spectrum-list*The command's parameter is a Tcl list of spectrum
...
**listruns**returns a list of  dictionaries that describe
...
**play** *run-number*If `run-number` has event
...
**stop**Aborts any event playback in progress.
