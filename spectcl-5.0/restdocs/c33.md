...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/restdocs/c13.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [REST requests supported. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/restdocs/c84.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/restdocs/c33.md#require)
  The SpecTclHttpdServer package contains
                      ...
                      interface.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/restdocs/c33.md#getport)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/restdocs/c33.md#start)
  Starts the REST server.  Once this has been done
                      REST requests can be made of the server.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/restdocs/c33.md#output)
