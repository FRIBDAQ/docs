...
Note that this class is only provided for compatibility purposes.
            New applications should use the
            `CTCLInterpreter::setResult` methods.

<a name="AEN4985"></a>## METHODS
...
| --- | --- | --- |
| Prev | Home | Next |
| CTCLResult | Up | CTCLInterpreterObject  3 |
