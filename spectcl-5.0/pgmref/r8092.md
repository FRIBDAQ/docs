...
[← CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r7900.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLObjectPackage →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r8312.md)
...
<a name="AEN8192"></a>## Public member functions
...
<a name="AEN8303"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN8308"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r7369.md)
