...
<a name="AEN5649"></a>## Name

CTCLProcessor -- 
            Provide `argc`, `argv`
            extension commands to Tcl.

<a name="AEN5654"></a>## Synopsis
...
<a name="AEN5656"></a>## DESCRIPTION

`Do not use this for new commands`.  Use
            `CTCLObjectProcessor` instead.
...
| --- | --- | --- |
| Prev | Home | Next |
| CTCLObjectProcessor | Up | CTCLCompatibiltyProcessor |
