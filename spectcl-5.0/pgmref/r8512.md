...
[← Extensible Factories](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r8479.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEventProcessor →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r8591.md)
...
<a name="AEN8612"></a>## Public member functions
...
<a name="AEN8723"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN8728"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r7789.md)
