...
[← CEvent](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r12843.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CNamedItem →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r12872.md)

---

---

# <a name="AEN12844"></a>CEvent
...
`   CEventIterator end();
`
  Provides support for iteration over the parameters in a		    `CEvent` in the STL sense of the word.
  `begin`                        returns an iterator to the first element in
                          ...
                          `end`.
  `end`                        Returns an end of iteration iterator.  Note that
