...
[← CTCLInterpreterObject  3](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r5080.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLObject →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r5159.md)
...
<a name="AEN5118"></a>## Name

CTCLProcessor -- 
            Provide `argc`, `argv`
            extension commands to Tcl.

<a name="AEN5123"></a>## Synopsis
