...
[← CPipelineEventProcessor](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r23927.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDisplay →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r23949.md)

---

---

# <a name="AEN23947"></a>CDisplay
...
- ` virtual std::vector<CGateContainer>  getAssociatedGates(const std::string&  spectrumName = , CHistogrammer&  rSorter)  = );
`
