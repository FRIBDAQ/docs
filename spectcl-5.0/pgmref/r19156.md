...
[← CFilterOutputStageFactory](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r19155.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CFilterOutputStage →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r19161.md)

---

---

# <a name="AEN19156"></a>CFilterOutputStageFactory

<a name="AEN19160"></a>## Name

CFilterOutputStageFactory -- Create filter output stage objects.

<a name="AEN19163"></a>## Synopsis
