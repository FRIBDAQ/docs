...
[← CTCLObjectPackage](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r8732.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTclGrammerApp →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmref/r8782.md)

---

---

# <a name="AEN8780"></a>CTclGrammerApp

<a name="AEN8784"></a>## Name

CTclGrammerApp -- Base Application class

<a name="AEN8787"></a>## Synopsis

```
CTclGrammerApp
```

<a name="AEN8790"></a>## DESCRIPTION
