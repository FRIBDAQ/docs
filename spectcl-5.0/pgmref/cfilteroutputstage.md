...
# <a name="AEN19273"></a>CFilterOutputStage

<a name="AEN19277"></a>## Name

CFilterOutputStage -- Abstract base class for filter output streamers.

<a name="AEN19280"></a>## Synopsis
...
| --- | --- | --- |
| Prev | Home | Next |
| CGatedEventFilter | Up | CXdrFilterOutputStage |
