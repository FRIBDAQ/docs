...
`ParamType`This is actually a double precision value.  It decouples
...
CParameterVectorThis is the underlying data structure used by
                        `CEvent` to hold the
...
`CEventIterator`An iterator into a `CParameterVector`.
