...
# <a name="AEN21667"></a>CFit

<a name="AEN21671"></a>## Name

CFit -- Base class for spectrum fitting subsystem.

<a name="AEN21674"></a>## Synopsis
...
<a name="AEN21695"></a>### `Point` a data point.
...
double `x`The X coordinate of the point. Normally this
                            represents a channel number in the spectrum
                            being fitted.

double ` y`The Y coordinate of the point. Normally this is the
...
<a name="AEN21748"></a>### Typedefs related to `Point`



typedef std::vector<Point> PointArrayPointArray objects maintain the set
                            of points gathered for a fit.

typedef PointArray::iterator PointIteratorSupport iteration in the container that
...
<a name="AEN21765"></a>### Fit parameter data types.
...
| --- | --- | --- |
| Prev | Home | Next |
| CGateObserver | Up | Predefined CFit classes |
