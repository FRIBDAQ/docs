...
[← The API and SpecTcl Objects.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1049.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The API and the event processing pipeline →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1105.md)
...
In [*libTcl++ and adding commands to SpecTcl*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md),
...
<a name="AEN1107"></a>**Example 4-10. Class to switch event analysis pipelines**
...
<a name="AEN1118"></a>**Example 4-11. EVPSwitcher constructor and destrutor**
...
<a name="AEN1136"></a>**Example 4-12. `EVPSwitcher::save` implementation**
...
<a name="AEN1151"></a>**Example 4-13. `EVPSwitcher::restore` implementation**
...
<a name="AEN1166"></a>**Example 4-14. `EVPSwitcher::useFilterProcessor` implementation**
