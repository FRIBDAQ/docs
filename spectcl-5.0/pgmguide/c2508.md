...
[← SpecTcl plugins](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2506.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Interfacing SpecTcl with data from other data acquisition systems. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2819.md)
...
<a name="AEN2512"></a>**Figure 10-1. SpecTcl event decode process**
...
# <a name="AEN2529"></a>10.1. The classes involved in getting data from source to analyzer
...
<a name="AEN2576"></a>**Example 10-1. `CFile` class definition**
...
<a name="AEN2778"></a>**Example 10-2. `CAnalyzer` base class definition**
...
<a name="AEN3074"></a>**Example 10-3. The `CBufferDecoder` abstract base class**
...
<a name="AEN3340"></a>**Example 10-4. BufferTranslator.h important bits:**
...
<a name="AEN3528"></a>**Example 10-5. `CCreator` definition**
