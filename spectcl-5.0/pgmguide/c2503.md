...
[← Interfacing SpecTcl with data from other data acquisition systems.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c246.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SpecTcl plugins →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2506.md)
...
<a name="AEN2507"></a>**Figure 10-1. SpecTcl event decode process**
...
# <a name="AEN2524"></a>10.1. The classes involved in getting data from source to analyzer
...
<a name="AEN2571"></a>**Example 10-1. `CFile` class definition**
...
<a name="AEN2773"></a>**Example 10-2. `CAnalyzer` base class definition**
...
<a name="AEN3069"></a>**Example 10-3. The `CBufferDecoder` abstract base class**
...
<a name="AEN3335"></a>**Example 10-4. BufferTranslator.h important bits:**
...
<a name="AEN3523"></a>**Example 10-5. `CCreator` definition**
