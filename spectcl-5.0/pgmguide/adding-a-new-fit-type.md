...
| Prev | Chapter 9. Extending the set of SpecTcl fit types. | Next |


---

# <a name="AEN2796"></a>9.2. Adding a new fit type
...
| --- | --- | --- |
| Prev | Home | Next |
| Extending the set of SpecTcl fit types. | Up | Interfacing SpecTcl with data from other data acquisition systems. |
