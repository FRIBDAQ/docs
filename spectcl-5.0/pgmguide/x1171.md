...
[← The API and the event processing pipeline](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1105.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The API and the event sink pipeline →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1176.md)
...
The event sink pipeline is described more completely in
            [*The SpecTcl event sink pipeline.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1218.md).
...
<a name="AEN1184"></a>**Example 4-15. Listing the event sink pipeline elements**
