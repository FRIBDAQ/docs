...
- [[![(1)](../images/callouts/1.gif)|x591#makefile.include]]
  This include is part of the standard Makefile.  It pulls in
                      ...
                      transformatinos.
- [[![(2)](../images/callouts/2.gif)|x591#makefile.daqversion]]
  I added this line.  It allows me to change which version of
                      NSCLDAQ simply by changing this line.
- [[![(3)](../images/callouts/3.gif)|x591#makefile.cxxflags]]
...
- [[![(4)](../images/callouts/4.gif)|x591#makefile.ldflags]]
...
- [[![(5)](../images/callouts/5.gif)|x591#makefile.objects]]
