...
In this chapter we will revisit our `EVPSwitcher` class  from
        [[*The API and the event processing pipeline*|x1416]].
...
[[![(2)](../images/callouts/2.gif)|c1617#cmd.swcommand.entry]] `CTCLObjectProcessor` objects
