...
- [[*The API and the parameter dictionary*|c752#sec.api.parameters]]
...
- [[*The API and the spectrum dictionary*|x867]]
  The API provides methods that allow you to query and
                      ...
                      type.
- [[*The API and the gates dictionary*|x990]]
...
- [[*The API and the event processing pipeline*|x1105]]
  The API provides methods to query and manipulate the event
                      processing pipeline.
- [[*The API and the event sink pipeline*|x1176]]
...
- [[*The API and SpecTcl Objects.*|x1194]]
