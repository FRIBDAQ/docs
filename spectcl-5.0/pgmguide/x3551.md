...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_data]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_interface]]
  The methods below indicate that we will implement the
                      `CBufferDecoder` interface.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_fcallop]]
  This method will get called by the data source, I/O
                      handler when a data block is available.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_typehandlers]]
  This set of methods provides handlers for each of the
                      item types the data acquisition system can provide us.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_unanticipated]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_savehdr]]
  This chunk of code saves the buffer header in the member
                      ...
                      originating system.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_firstitem]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_translator]]
  ...
  We don't use this much so it's not worth making a
                      ...
                      byte ordering.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_itemloop]]
  This loop loops over all the items in the buffer.  Note the
                      ...
                      host's byte order.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_dispatch]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_nextitem]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_freetranslator]]
