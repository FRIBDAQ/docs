...
[← Worked example for supporting a new data format](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3546.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Distributing the SomeDaqBufferDecoder as a plugin →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md)

---

---

# <a name="AEN3551"></a>10.3. Worked example for supporting a new data format
...
<a name="AEN3582"></a>**Example 10-6. Structure of data from SomeDaqSystem**
...
<a name="AEN3590"></a>**Example 10-7. `SomeDaqBufferDecoder` header.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_data)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_interface)
  The methods below indicate that we will implement the
                      `CBufferDecoder` interface.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_fcallop)
  This method will get called by the data source, I/O
                      handler when a data block is available.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_typehandlers)
  This set of methods provides handlers for each of the
                      item types the data acquisition system can provide us.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_unanticipated)
...
<a name="AEN3641"></a>**Example 10-8. `SomeDaqBufferDecoder::operator()` implementation**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_savehdr)
  This chunk of code saves the buffer header in the member
                      ...
                      originating system.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_firstitem)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_translator)
  ...
  We don't use this much so it's not worth making a
                      ...
                      byte ordering.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_itemloop)
  This loop loops over all the items in the buffer.  Note the
                      ...
                      host's byte order.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_dispatch)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_nextitem)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md#decoder_op_freetranslator)
...
<a name="AEN3685"></a>**Example 10-9. Implementation of `SomeDaqBufferDecoder::stateChange`**
...
<a name="AEN3693"></a>**Example 10-10. Implementation of `SomeDaqBufferDecoder::scaler`**
...
<a name="AEN3701"></a>**Example 10-11. Implementation of `SomeDaqBufferDecoder::event`**
...
<a name="AEN3707"></a>**Example 10-12. Implementation of `SomeDaqBufferDecoder::other`**
...
<a name="AEN3714"></a>**Example 10-13. Implementation of `SomeDaqBufferDecoder::translateItemType`**
...
<a name="AEN3724"></a>**Example 10-14. Trivial getter implementations**
...
<a name="AEN3728"></a>**Example 10-15. Not as trivial getters:**
...
<a name="AEN3737"></a>**Example 10-16. Header for `SomeDaqDecoderCreator`**
...
<a name="AEN3745"></a>**Example 10-17. Implementation of `SomeDaqDecoderCreator`**
