...
[← The API and the event sink pipeline](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1487.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Adding a file format to SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1552.md)
...
- `getInterpreter`
  Returns the `CTCLInterpreter*` pointer
...
- `GetAnalyzer`
  Returns the `CAnalyzer*` pointer to
