...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.mk)
  The **pman** command is a command
                      ...
                      raw
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.add)
  This loop adds the user written event processors we
                      ...
                      are called.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.filter)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.use)
