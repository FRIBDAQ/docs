...
[← Worked example for supporting a new data format](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3862.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Distributing the SomeDaqBufferDecoder as a plugin →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md)

---

---

# <a name="AEN4090"></a>12.2. Using the **pman** command to create and select pipelines
...
<a name="AEN4103"></a>**Example 12-2. Using the **pman** SpecTcl command**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.mk)
  The **pman** command is a command
                      ...
                      raw
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.add)
  This loop adds the user written event processors we
                      ...
                      are called.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.filter)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md#dynpipe.pman.use)
