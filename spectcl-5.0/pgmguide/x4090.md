...
[[![(1)](../images/callouts/1.gif)|x4090#dynpipe.pman.mk]]                    The **pman** command is a command
...
[[![(2)](../images/callouts/2.gif)|x4090#dynpipe.pman.add]]                    This loop adds the user written event processors we
                    ...
                    are called.
                [[![(3)](../images/callouts/3.gif)|x4090#dynpipe.pman.filter]]                    Similarly, this pair of commands creates the
