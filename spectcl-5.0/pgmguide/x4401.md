...
[← Distributing the SomeDaqBufferDecoder as a plugin](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Setting up an event analysis pipeline (the simple version) →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x591.md)
