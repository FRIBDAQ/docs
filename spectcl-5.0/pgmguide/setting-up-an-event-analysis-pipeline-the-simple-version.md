...
# <a name="AEN596"></a>3.2. Setting up an event analysis pipeline (the simple version)
...
<a name="AEN645"></a>**Example 3-10. SpecTcl Makefile modifications**
...
<a name="AEN697"></a>**Example 3-11. Creating a static event processing pipeline**
