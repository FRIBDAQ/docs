...
The `rAnalyzer` and
                        ...
                        [[*Interfacing SpecTcl with data from other data acquisition systems.*|c2819]].
...
[[![(2)](../images/callouts/2.gif)|c89#evp.fcndataptr]]                    The `pEvent` is an
...
[[![(2)](../images/callouts/2.gif)|c89#evp.fcndataptr]] `pSize` now points to the data in the event,
...
[[![(2)](../images/callouts/2.gif)|c89#evp.onother.scalertype]]                    We only want to do something other than to output a
                ...
                [[![(3)](../images/callouts/3.gif)|c89#evp.onother.createitem]]                    The `CRingItemFactory` is a class
...
[[![(4)](../images/callouts/4.gif)|c89#evp.onother.castscaler]]                    This dynamic cast turns the `CRingItem`
