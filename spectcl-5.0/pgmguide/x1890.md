...
[← Adding a file format to SpecTcl](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1868.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Example filter formatter. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1989.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.wscn.indices)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.wscn.indexing)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.wscn.seldelim)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.write.dims)
  Fetches the number of dimensions the spectrum has.  This is
                    ...
                    types.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.write.xdim)
  Retrieves the number of channels on the X axis.  All spectra have
                    at least an X axis.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.write.ydim1d)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.write.ydim2d)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.write.writelines)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.scanlines)
  ...
  This variable consists of a vector whose elements are the
                      ...
                      y coordinate.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.csvline)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.readrow)
  This line decodes a line fromt he CSV file.  This will be
                      ...
                      into a single file.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.notempty)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.convert)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.pushchannel)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.pushscanline)
  Once a scaneline has been decoded it is pushed back into the
                      `scanlines` vector.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.makespectrum)
  ...
  With this simple file format we can't distinguish between
                      ...
                      incremented.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.fillspectrum)
...
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1890.md#spcfmt.read.snapwrap)
