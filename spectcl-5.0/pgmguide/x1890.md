...
# <a name="AEN1890"></a>7.3. Adding a CSV file format to spectrum read/write
...
<a name="AEN1898"></a>**Example 7-1. `CSVSpectrumFormatter` header**
...
<a name="AEN1939"></a>**Example 7-3. `CSVSpectrumFormatter::Write` implementation**
...
<a name="AEN2016"></a>**Example 7-4. `CSVSpectrumFormatter::Read` implementation**
...
[[x1890#spcfmt.read.scanlines]] `scanlines` will hold all of the spectrum
...
[[x1890#spcfmt.read.csvline]] `csvline` will hold the value of one scanline
