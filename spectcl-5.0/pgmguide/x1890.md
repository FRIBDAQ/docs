...
[[![(1)](../images/callouts/1.gif)|x1890#spcfmt.wscn.indices]]                    This array will be an array of indices into the spectrum.
                ...
                [[![(2)](../images/callouts/2.gif)|x1890#spcfmt.wscn.indexing]]                    The indexing operator of `CSpectrum`
                ...
                [[![(3)](../images/callouts/3.gif)|x1890#spcfmt.wscn.seldelim]]                    Each channel output wil be followed by a delimeter.
...
[[![(1)](../images/callouts/1.gif)|x1890#spcfmt.read.scanlines]] `scanlines` will hold all of the spectrum
...
[[![(2)](../images/callouts/2.gif)|x1890#spcfmt.read.csvline]] `csvline` will hold the value of one scanline
                ...
                [[![(5)](../images/callouts/5.gif)|x1890#spcfmt.read.convert]]                    This call to `strtoul` attempts to decode
...
[[![(9)](../images/callouts/9.gif)|x1890#spcfmt.read.fillspectrum]]                    Fills the channels of the spectrrum with the data in
