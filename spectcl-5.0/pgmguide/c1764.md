...
[← Interfacing SpecTcl with data from other data acquisition systems.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1760.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Extending SpecTcl spectrum file formats →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1831.md)
...
The filter formats supported by SpecTcl are extensible.  In fact,
        ...
        [*SpecTcl plugins*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c3753.md)
...
- Look at the classes and objects that make filter formats
                  extensible (
                  [*Filter formatting objects.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1764.md#sec.filterformatobjects)).
- Walk through writing an extension to the set of filter formats
                  supported by SpecTcl.
                  [*Example filter formatter.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1994.md)
...
<a name="AEN1786"></a>**Example 8-1. `CFilterOutputStage` class definition**
...
<a name="AEN1893"></a>**Example 8-2. `CFilterOutputStageCreator` specification**
...
<a name="AEN1940"></a>**Example 8-3. `CFilterOutputStageFactory` definition**
