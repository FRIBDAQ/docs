...
[← The API and the event processing pipeline](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1100.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The API and the event sink pipeline →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1171.md)
...
In [*libTcl++ and adding commands to SpecTcl*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md),
