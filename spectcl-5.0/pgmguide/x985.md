...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.tabledriven)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.gateparam)
  `pGateParam`
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.create)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.adddict)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.getcontainer)
  Gets the gate container that wraps the gate we just made.
                      ...
                      against failure.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.savecontainer)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.op.getcontainer)
  For each pass through the loop, we get a reference to the
                      ...
                      directly.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.op.clearcache)
  For each gate, we must clear its cached value before
                      checking it.  This was explained previously.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.op.check)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md#api.gates.op.setparam)
