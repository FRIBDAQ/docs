...
[← Setting up an event analysis pipeline (the simple version)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x591.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Playing back filter data →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x700.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x596.md#makefile.include)
  This include is part of the standard Makefile.  It pulls in
                      ...
                      transformatinos.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x596.md#makefile.daqversion)
  I added this line.  It allows me to change which version of
                      NSCLDAQ simply by changing this line.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x596.md#makefile.cxxflags)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x596.md#makefile.ldflags)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x596.md#makefile.objects)
