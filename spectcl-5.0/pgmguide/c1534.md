...
[← Extending SpecTcl spectrum file formats](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1520.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [libTcl++ and adding commands to SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1617.md)
...
<a name="AEN1599"></a>**Example 5-1. Event sink processor header**
...
<a name="AEN1608"></a>**Example 5-2. EventCounter constructor implementation**
...
<a name="AEN1613"></a>**Example 5-3. `EventCounter::operator()` implemntation**
