...
[← The API and the event sink pipeline](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1171.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The API and the spectrum dictionary →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1178.md)
...
The event sink pipeline is described more completely in
            [*The SpecTcl event sink pipeline.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1223.md).
...
<a name="AEN1189"></a>**Example 4-15. Listing the event sink pipeline elements**
