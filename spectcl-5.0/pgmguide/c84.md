...
[← Extending SpecTcl spectrum file formats](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c83.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Extending SpecTcl's filter file formats →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c86.md)
...
# <a name="AEN113"></a>3.1. Event Processors
...
<a name="AEN120"></a>**Example 3-1. CEventProcessor definition**
...
`
  ...
  The `rAnalyzer` and
                          `rDecoder` paramters are references
                          to the analyzer and buffer decoder objects respectively.
                          The services these objects offer will be described in
                          [*Interfacing SpecTcl with data from other data acquisition systems.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2503.md).
...
<a name="AEN365"></a>**Example 3-3. Constructor for `MyEventProcessor`**
...
<a name="AEN379"></a>**Example 3-4. `OnAttach`**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#onattach.dyncast)
  ...
  dynamic_cast attempts to perform a type cast
                      ...
                      `std::bad_cast`.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#onattach.badcast)
  ...
  Since this element of the pipeline failed, kfFalse
                      is returned.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#onattach.otherfails)
  If the cast throws any other exceptions, these two are caught
                      and reported.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#onattach.good)
...
<a name="AEN415"></a>**Example 3-5. OnInitialize - Set up the tree parameters.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#oninit.inittp)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#oninit.indivbound)
  This section of code binds the individual parameter to the
                      event array like object if not.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#oninit.araraybound)
...
<a name="AEN440"></a>**Example 3-6. State transition processing**
...
<a name="AEN490"></a>**Example 3-7. Event processor `operator() method.`**
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.fcndataptr)
  The `pEvent` is an
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.fcndataptr)
  `pSize` now points to the data in the event,
                      ...
                      2 means.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.fcnrawparams)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.fcncomputedparam)
...
<a name="AEN535"></a>**Example 3-8. Event processor `OnOther`**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.onother.decoder)
  ...
  If a null pointer is returned, a message indicating the
                      ...
                      regturned.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.onother.scalertype)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.onother.createitem)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.onother.castscaler)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.onother.tostring)
  Once we've gotten this far we can use the
                      ...
                      which we print out.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.onother.delitem)
  Since the factory dynamically allocated the ring item,
                      we need to delete it in all code paths through the
                      method.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c84.md#evp.onother.dontforgetthis)
...
<a name="AEN586"></a>**Example 3-9. `OnEventSourceOpen` and `OnEventSourceEOF`**
