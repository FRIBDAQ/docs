...
[[x1579#spcfmt.read.scanlines]] `scanlines` will hold all of the spectrum
...
[[x1579#spcfmt.read.csvline]] `csvline` will hold the value of one scanline
