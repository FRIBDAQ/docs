...
[← Setting up an event analysis pipeline (the simple version)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x596.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Playing back filter data →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x705.md)

---

---

# <a name="AEN700"></a>3.3. Playing back filter data
