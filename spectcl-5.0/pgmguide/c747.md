...
[[c747#sec.api.parameters]]The API provides methods to inspect and maniuplate the
...
[[x862]]The API provides methods that allow you to query and
                    manipulate the SpecTcl spectrum dictionary.    These
                    methods include methods that can create spectra of any
                    type.

[[x985]]The API provides methods that allow you to query, define
                    and apply gates.

[[x1100]]The API provides methods to query and manipulate the event
                    processing pipeline.

[[x1171]]The API provides methods to query and manipulate the event sink
...
[[x1189]]The API provides methods to gain access to several important
