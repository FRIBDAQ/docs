...
[← The SpecTcl event sink pipeline](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c74.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The SpecTcl API →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c752.md)
...
The `SpecTcl` class provides an application programming
        ...
        (described in [*The SpecTcl event sink pipeline.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1218.md)),
...
- [*The API and the parameter dictionary*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#sec.api.parameters)
...
- [*The API and the spectrum dictionary*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x862.md)
  The API provides methods that allow you to query and
                      ...
                      type.
- [*The API and the gates dictionary*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x985.md)
...
- [*The API and the event processing pipeline*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1100.md)
  The API provides methods to query and manipulate the event
                      processing pipeline.
- [*The API and the event sink pipeline*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1171.md)
...
- [*The API and SpecTcl Objects.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1189.md)
...
<a name="AEN815"></a>**Example 4-1. Using the API to access parameter definitions**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#api.params.inchist)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#api.params.incparams)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#api.params.getapi)
  We've already discussed this bit of code earlier.  This
                      code gets a reference to the singleton API object.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#api.params.iteration)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#api.params.iterefirst)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#api.params.itersecond)
  The second element of the pair in a parameter dictionary
                      ...
                      entry.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c747.md#api.params.getnumber)
