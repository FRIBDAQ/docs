...
- [[*The API and the parameter dictionary*|c747#sec.api.parameters]]
...
- [[*The API and the spectrum dictionary*|x862]]
  The API provides methods that allow you to query and
                      ...
                      type.
- [[*The API and the gates dictionary*|x985]]
...
- [[*The API and the event processing pipeline*|x1100]]
  The API provides methods to query and manipulate the event
                      processing pipeline.
- [[*The API and the event sink pipeline*|x1171]]
...
- [[*The API and SpecTcl Objects.*|x1189]]
