...
[← Worked example for supporting a new data format](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3551.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Distributing the SomeDaqBufferDecoder as a plugin →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3844.md)

---

---

# <a name="AEN3839"></a>11.2. Distributing the `SomeDaqBufferDecoder` as a plugin
...
<a name="AEN3858"></a>**Example 11-1. Plugin initialization for the sample daq decoder plugin**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_usetclstubs)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_headers)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_strings)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_cbinding)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_initentry)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_initstubs)
  ...
  The first parameter is the interpreter.  The second is a Tcl
                  ...
                  our requirements.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_initstubserror)
  ...
  Package initialization returns TCL_ERROR
                  ...
                  is not loaded.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_pkgprovide)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_registercreator)
...
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_normalstatus)
...
<a name="AEN3949"></a>**Example 11-2. Makefile that can produce the plugin**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_PIC)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_newtarget)
  ...
  The **make** command with no target
                      ...
                      all
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_libtarget)
  ...
  `-shared` instructs the linker that the
                      ...
                      an executable.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_libsources)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_clean)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_attnosample)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_autopath)
  We add the current working directory (.)
                      ...
                      we ran SpecTcl.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_require)
  This **package require** command attempts to
                      load the package.
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_loadok)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x3839.md#plugin_attsample)
