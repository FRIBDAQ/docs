...
[[x3839#plugin_initentry]]                This is the initialization function entry.  The name
            ...
            [[x3839#plugin_initstubs]] `Tcl_InitStubs` initializes the Tcl stubs
...
[[x3839#plugin_initstubserror]] `Tcl_InitStubs` returns a pointer to a string
...
[[x3839#plugin_pkgprovide]] `Tcl_PkgProvide` lets Tcl know that initializing
