...
[← Xamine's button box](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c127.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Extending SpecTcl spectrum file formats →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c130.md)
...
- [*The SpecTcl processing model.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c68.md)
...
- [*The SpecTcl event processing pipeline.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c89.md)
...
- [*The SpecTcl event sink pipeline.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1534.md)
  The event sink pipeline takes over where the event
                      ...
                      pipeline.
- [*libTcl++ and adding commands to SpecTcl*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1617.md)
  SpecTcl uses the Tcl scripting language as its base command
                      ...
                      elements.
- [*Extending SpecTcl spectrum file formats*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1831.md)
  The SpecTcl **sread** and **swrite**
                      ...
                      and **sread** commands.
- [*Extending SpecTcl's filter file formats*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2075.md)
  The format of files written by SpecTcl filters is extensible.
                      In this chapter we'll show how to extend the set of formats
                      available.
- [*Extending the set of SpecTcl fit types.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2377.md)
...
- [*Interfacing SpecTcl with data from other data acquisition systems.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2819.md)
  SpecTcl is data acquisition system neutral.  This chapter
                      ...
                      system.
- [*Dynamic processing pipelines*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c4354.md)
