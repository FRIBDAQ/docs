...
- [[*The SpecTcl processing model.*|c68]]
...
- [[*The SpecTcl event processing pipeline.*|c89]]
...
- [[*The SpecTcl event sink pipeline.*|c1534]]
  The event sink pipeline takes over where the event
                      ...
                      pipeline.
- [[*libTcl++ and adding commands to SpecTcl*|c1617]]
  SpecTcl uses the Tcl scripting language as its base command
                      ...
                      elements.
- [[*Extending SpecTcl spectrum file formats*|c1831]]
...
- [[*Interfacing SpecTcl with data from other data acquisition systems.*|c2819]]
  SpecTcl is data acquisition system neutral.  This chapter
                      ...
                      system.
- [[*Dynamic processing pipelines*|c4354]]
