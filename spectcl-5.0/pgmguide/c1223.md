...
[← The SpecTcl event sink pipeline.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1218.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [libTcl++ and adding commands to SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1226.md)
...
<a name="AEN1288"></a>**Example 5-1. Event sink processor header**
...
<a name="AEN1297"></a>**Example 5-2. EventCounter constructor implementation**
...
<a name="AEN1302"></a>**Example 5-3. `EventCounter::operator()` implemntation**
