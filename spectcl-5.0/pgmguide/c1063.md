...
[[c1063#sec.api.parameters]]The API provides methods to inspect and maniuplate the
...
[[x1178]]The API provides methods that allow you to query and
                    manipulate the SpecTcl spectrum dictionary.    These
                    methods include methods that can create spectra of any
                    type.

[[x1301]]The API provides methods that allow you to query, define
                    and apply gates.

[[x1416]]The API provides methods to query and manipulate the event
                    processing pipeline.

[[x1487]]The API provides methods to query and manipulate the event sink
...
[[x1505]]The API provides methods to gain access to several important
