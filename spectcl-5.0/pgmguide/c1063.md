...
- [[*The API and the parameter dictionary*|c1063#sec.api.parameters]]
...
- [[*The API and the spectrum dictionary*|x1178]]
  The API provides methods that allow you to query and
                      ...
                      type.
- [[*The API and the gates dictionary*|x1301]]
...
- [[*The API and the event processing pipeline*|x1416]]
  The API provides methods to query and manipulate the event
                      processing pipeline.
- [[*The API and the event sink pipeline*|x1487]]
...
- [[*The API and SpecTcl Objects.*|x1505]]
