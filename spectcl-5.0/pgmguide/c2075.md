...
[← The SpecTcl event sink pipeline.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c207.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The SpecTcl event sink pipeline. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c208.md)
...
The filter formats supported by SpecTcl are extensible.  In fact,
        ...
        [*SpecTcl plugins*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c4064.md)
...
- Look at the classes and objects that make filter formats
                  extensible (
                  [*Filter formatting objects.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c2075.md#sec.filterformatobjects)).
- Walk through writing an extension to the set of filter formats
                  supported by SpecTcl.
                  [*Example filter formatter.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x2305.md)
...
<a name="AEN2097"></a>**Example 8-1. `CFilterOutputStage` class definition**
...
<a name="AEN2204"></a>**Example 8-2. `CFilterOutputStageCreator` specification**
...
<a name="AEN2251"></a>**Example 8-3. `CFilterOutputStageFactory` definition**
