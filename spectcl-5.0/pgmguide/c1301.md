...
In this chapter we will revisit our `EVPSwitcher` class  from
        [[*The API and the event processing pipeline*|x1100]].
...
[[![(2)](../images/callouts/2.gif)|c1301#cmd.swcommand.entry]] `CTCLObjectProcessor` objects
