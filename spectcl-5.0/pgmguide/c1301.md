...
[← Extending SpecTcl spectrum file formats](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c130.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [libTcl++ and adding commands to SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md)
...
In this chapter we will revisit our `EVPSwitcher` class  from
        [*The API and the event processing pipeline*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1100.md).
...
<a name="AEN1397"></a>**Example 6-1. Definition file for event processor switcher.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.swcommand.object)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.swcommand.entry)
  ...
  The method is passed a reference to the interpreter that is
                  ...
                  the command itself.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.swcommand.handlers)
...
<a name="AEN1419"></a>**Example 6-2. `EVPSwitchCommand` constructor implementation**
...
<a name="AEN1436"></a>**Example 6-3. Implementation of `EVPSwitchCommand::operator()`**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.bindall)
  This operation bind the interpreter (first parameter) to all
                  ...
                  operations.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.try)
  Exception handling is used to simplify error detection and handling.
                  ...
                  interpreter.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.check42)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.subcommand)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.dispatch)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.nomatch)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.errorhandling)
  ...
  In the event the command is executed with the Tcl
                  **catch** command, this will be the message
                  ...
                  nonzero.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.unexpectedcatch)
  This catch will get control if an exception we've not explicitly
                  ...
                  return TCL_ERROR.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1301.md#cmd.op.success)
...
<a name="AEN1493"></a>**Example 6-4. Implementation of subcommand processors**
