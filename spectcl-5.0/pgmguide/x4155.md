...
[[![(5)](../images/callouts/5.gif)|x4155#plugin_initentry]]                This is the initialization function entry.  The name
            ...
            [[![(6)](../images/callouts/6.gif)|x4155#plugin_initstubs]] `Tcl_InitStubs` initializes the Tcl stubs
...
[[![(7)](../images/callouts/7.gif)|x4155#plugin_initstubserror]] `Tcl_InitStubs` returns a pointer to a string
...
[[![(8)](../images/callouts/8.gif)|x4155#plugin_pkgprovide]] `Tcl_PkgProvide` lets Tcl know that initializing
