...
[← Using the pman command to create and select pipelines](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4090.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the pman command to create and select pipelines →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4401.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_usetclstubs)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_headers)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_strings)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_cbinding)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_initentry)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_initstubs)
  ...
  The first parameter is the interpreter.  The second is a Tcl
                  ...
                  our requirements.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_initstubserror)
  ...
  Package initialization returns TCL_ERROR
                  ...
                  is not loaded.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_pkgprovide)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_registercreator)
...
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_normalstatus)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_PIC)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_newtarget)
  ...
  The **make** command with no target
                      ...
                      all
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_libtarget)
  ...
  `-shared` instructs the linker that the
                      ...
                      an executable.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_libsources)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_clean)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_attnosample)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_autopath)
  We add the current working directory (.)
                      ...
                      we ran SpecTcl.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_require)
  This **package require** command attempts to
                      load the package.
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_loadok)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x4155.md#plugin_attsample)
