...
- [[![(1)](../images/callouts/1.gif)|x4155#plugin_usetclstubs]]
...
- [[![(2)](../images/callouts/2.gif)|x4155#plugin_headers]]
...
- [[![(3)](../images/callouts/3.gif)|x4155#plugin_strings]]
...
- [[![(4)](../images/callouts/4.gif)|x4155#plugin_cbinding]]
...
- [[![(5)](../images/callouts/5.gif)|x4155#plugin_initentry]]
...
- [[![(6)](../images/callouts/6.gif)|x4155#plugin_initstubs]]
  ...
  The first parameter is the interpreter.  The second is a Tcl
                  ...
                  our requirements.
- [[![(7)](../images/callouts/7.gif)|x4155#plugin_initstubserror]]
  ...
  Package initialization returns TCL_ERROR
                  ...
                  is not loaded.
- [[![(8)](../images/callouts/8.gif)|x4155#plugin_pkgprovide]]
...
- [[![(9)](../images/callouts/9.gif)|x4155#plugin_registercreator]]
...
- [[![(10)](../images/callouts/10.gif)|x4155#plugin_normalstatus]]
...
- [[![(1)](../images/callouts/1.gif)|x4155#plugin_PIC]]
...
- [[![(2)](../images/callouts/2.gif)|x4155#plugin_newtarget]]
  ...
  The **make** command with no target
                      ...
                      all
- [[![(3)](../images/callouts/3.gif)|x4155#plugin_libtarget]]
  ...
  `-shared` instructs the linker that the
                      ...
                      an executable.
- [[![(4)](../images/callouts/4.gif)|x4155#plugin_libsources]]
...
- [[![(5)](../images/callouts/5.gif)|x4155#plugin_clean]]
...
- [[![(1)](../images/callouts/1.gif)|x4155#plugin_attnosample]]
...
- [[![(1)](../images/callouts/1.gif)|x4155#plugin_autopath]]
  We add the current working directory (.)
                      ...
                      we ran SpecTcl.
- [[![(2)](../images/callouts/2.gif)|x4155#plugin_require]]
  This **package require** command attempts to
                      load the package.
- [[![(1)](../images/callouts/1.gif)|x4155#plugin_loadok]]
...
- [[![(1)](../images/callouts/1.gif)|x4155#plugin_attsample]]
