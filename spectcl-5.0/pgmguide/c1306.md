...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.swcommand.object)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.swcommand.entry)
  ...
  The method is passed a reference to the interpreter that is
                  ...
                  the command itself.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.swcommand.handlers)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.bindall)
  This operation bind the interpreter (first parameter) to all
                  ...
                  operations.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.try)
  Exception handling is used to simplify error detection and handling.
                  ...
                  interpreter.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.check42)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.subcommand)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.dispatch)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.nomatch)
...
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.errorhandling)
  ...
  In the event the command is executed with the Tcl
                  **catch** command, this will be the message
                  ...
                  nonzero.
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.unexpectedcatch)
  This catch will get control if an exception we've not explicitly
                  ...
                  return TCL_ERROR.
- [![(9)](../images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/c1306.md#cmd.op.success)
