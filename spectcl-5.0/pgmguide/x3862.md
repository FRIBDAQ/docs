...
# <a name="AEN3862"></a>10.3. Worked example for supporting a new data format
...
<a name="AEN3893"></a>**Example 10-6. Structure of data from SomeDaqSystem**
...
<a name="AEN3901"></a>**Example 10-7. `SomeDaqBufferDecoder` header.**
...
`m_lastHeader`Each time we get a new block of data from
...
<a name="AEN3952"></a>**Example 10-8. `SomeDaqBufferDecoder::operator()` implementation**
...
<a name="AEN3996"></a>**Example 10-9. Implementation of `SomeDaqBufferDecoder::stateChange`**
...
<a name="AEN4004"></a>**Example 10-10. Implementation of `SomeDaqBufferDecoder::scaler`**
...
<a name="AEN4012"></a>**Example 10-11. Implementation of `SomeDaqBufferDecoder::event`**
...
<a name="AEN4018"></a>**Example 10-12. Implementation of `SomeDaqBufferDecoder::other`**
...
<a name="AEN4025"></a>**Example 10-13. Implementation of `SomeDaqBufferDecoder::translateItemType`**
...
<a name="AEN4035"></a>**Example 10-14. Trivial getter implementations**
...
<a name="AEN4039"></a>**Example 10-15. Not as trivial getters:**
...
<a name="AEN4048"></a>**Example 10-16. Header for `SomeDaqDecoderCreator`**
...
<a name="AEN4056"></a>**Example 10-17. Implementation of `SomeDaqDecoderCreator`**
...
| --- | --- | --- |
| Prev | Home | Next |
| Step by step recipe for adding support for a new data format | Up | SpecTcl plugins |
