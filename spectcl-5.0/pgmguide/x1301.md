...
[← The API and SpecTcl Objects.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1194.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The API and the event processing pipeline →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1416.md)
...
<a name="AEN1336"></a>**Example 4-6. `GateProcessor` header.**
...
<a name="AEN1343"></a>**Example 4-7. `GateProcessor` constructor implementation**
...
<a name="AEN1350"></a>**Example 4-8. `GateProcessor::OnInitialize` implementation**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.tabledriven)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.gateparam)
  `pGateParam`
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.create)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.adddict)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.getcontainer)
  Gets the gate container that wraps the gate we just made.
                      ...
                      against failure.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.savecontainer)
...
<a name="AEN1391"></a>**Example 4-9. `GateProcessor::operator()` implementation**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.op.getcontainer)
  For each pass through the loop, we get a reference to the
                      ...
                      directly.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.op.clearcache)
  For each gate, we must clear its cached value before
                      checking it.  This was explained previously.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.op.check)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/pgmguide/x1301.md#api.gates.op.setparam)
