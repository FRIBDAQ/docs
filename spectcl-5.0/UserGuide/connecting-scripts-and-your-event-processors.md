...
| --- | --- | --- |
| SpecTcl User guide. |
| Prev | Chapter 6. Scripting with SpecTcl | Next |


---

# <a name="AEN1549"></a>6.3. Connecting scripts and your event processors.
...
## <a name="AEN1560"></a>6.3.1. Using Tcl variables to communicate with C/C++ code
...
`SpecTcl`This class provides and application programming
...
`CTCLInterpreter`SpecTcl (and NSCLDAQ) include a C++ wrapping
...
`CTCLVariable`This class encapsulates a Tcl variable, or
...
<a name="AEN1601"></a>**Example 6-4. Calibration event processor**
...
<a name="AEN1620"></a>**Example 6-5. Calibrated parameter constructor**
...
<a name="AEN1626"></a>**Example 6-6. Calibrated parameter computatino:**
...
<a name="AEN1632"></a>**Example 6-7. Getting the slope from a Tcl variable:**
...
[[x1549#calibget.interp]] `getInterpreter()` returns a
                            ...
                            right one.
                        [[x1549#calibget.tclvar]] `CTCLVariable` wraps a variable
...
<a name="AEN1673"></a>**Example 6-8. Getting the offset from a Tcl variable**
...
<a name="AEN1696"></a>**Example 6-9. Calibrator header with linked variables:**
...
<a name="AEN1704"></a>**Example 6-10. Constructor for linked variables**
...
<a name="AEN1726"></a>**Example 6-11. Destructor for linked variable calibrator**
...
<a name="AEN1735"></a>**Example 6-12. Getting slope and offset for linked variables**
...
## <a name="AEN1739"></a>6.3.2. Using the Treevariable subsystem
...
<a name="AEN1752"></a>**Example 6-13. Header for calibrator using treevariables**
...
<a name="AEN1757"></a>**Example 6-14. TreeCalibratorConstructor**
...
<a name="AEN1763"></a>**Example 6-15. TreeCalibrator::operator()**
...
## <a name="AEN1767"></a>6.3.3. Adding new compiled commands to Tcl
...
### <a name="AEN1787"></a>6.3.3.1. The Event processor

The header of the event processor look fairly normal:

<a name="AEN1790"></a>**Example 6-16. Event processor for command steered calibration**
...
<a name="AEN1794"></a>**Example 6-17. Constructor for command steered calibration event proc.**
...
<a name="AEN1798"></a>**Example 6-18. Command drive event processor implementation**
...
### <a name="AEN1801"></a>6.3.3.2. The command processor
...
<a name="AEN1809"></a>**Example 6-19. setcalib command processor header:**
...
<a name="AEN1850"></a>**Example 6-20. setcalib command constructor:**
...
<a name="AEN1893"></a>**Example 6-21. setcalib Command processor implementation**
...
[[x1549#setcalib.bindcmdwords]] `CTCLObject` objects
...
[[x1549#setcalib.requireexactly]] `CTCLObjectProcessor` provides
...
[[x1549#setcalib.extractparams]] `CTCLObject` provides type
                            conversion
...
| --- | --- | --- |
| Prev | Home | Next |
| Some SpecTcl scripting examples. | Up | Using the 'standard' SpecTcl GUI |
