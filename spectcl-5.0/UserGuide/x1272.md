...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.namespace]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.makecombo]]
  ...
  Note that the proc itself is also in the
                          MultiApply namespace.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.returnwidget]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.gatenames]]
  Recall that the
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.setgatelist]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.variable]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.containerframe]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.listbox]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.scrollbar]]
  ...
  If we wanted to provide an X scrollbar we'd need it to
                          ...
                          command.
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.savelistbox]]
...
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.spectrumtraces]]
  ...
  The **after idle** command executes the script
                          ...
                          **after idle** to schedule execution of
                          ...
                          dictionary.
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.loadinitialspectra]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.spectrace]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.clearlbox]]
  Since we're regenerating the entire contents of the listbox,
                          the first step is to delete all items from the listbox.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.addspecname]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorframe]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorcreation]]
...
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorlayout]]
...
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorresize]]
  By now hopefully you have some familiarity with column
                          ...
                          centered.
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.topframe]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.nsvariables]]
  These two lines import the namespace scoped variables.
                          ...
                          listbox.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.specselections]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.errorchecking]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectedspectrumlist]]
  This loop fetches the names of the selected spectra and
                          puts them in the list `spectrumNames`
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.applygate]]
