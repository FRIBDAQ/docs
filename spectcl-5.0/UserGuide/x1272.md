...
[← Some SpecTcl scripting examples.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Some SpecTcl scripting examples. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1273.md)

---

---

# <a name="AEN1272"></a>6.2. Some SpecTcl scripting examples.
...
<a name="AEN1311"></a>**Example 6-1. A gate selection combobox**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.namespace)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.makecombo)
  ...
  Note that the proc itself is also in the
                          MultiApply namespace.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.returnwidget)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.gatenames)
  Recall that the
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.setgatelist)
...
<a name="AEN1354"></a>**Example 6-2. Spectrum selection listbox**
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.variable)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.containerframe)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.listbox)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.scrollbar)
  ...
  If we wanted to provide an X scrollbar we'd need it to
                          ...
                          command.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.savelistbox)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.spectrumtraces)
  ...
  The **after idle** command executes the script
                          ...
                          **after idle** to schedule execution of
                          ...
                          dictionary.
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.loadinitialspectra)
...
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.spechooserlayout)
...
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.spechooserweight)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.spectrace)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.clearlbox)
  Since we're regenerating the entire contents of the listbox,
                          the first step is to delete all items from the listbox.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.addspecname)
...
<a name="AEN1458"></a>**Example 6-3. Multiselect final layout and logic**
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorframe)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorcreation)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorlayout)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectorresize)
  By now hopefully you have some familiarity with column
                          ...
                          centered.
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.topframe)
...
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectors)
  The frame that contains both of the selectors is created.
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.applybutton)
...
- [**(13)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.toplayout)
...
- [**(14)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.topresize)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.nsvariables)
  These two lines import the namespace scoped variables.
                          ...
                          listbox.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.specselections)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.errorchecking)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.selectedspectrumlist)
  This loop fetches the names of the selected spectra and
                          puts them in the list `spectrumNames`
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md#mapply.applygate)
