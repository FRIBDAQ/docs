...
[[![(1)](../images/callouts/1.gif)|x1272#mapply.namespace]]                        This block of code creates a new Tcl
...
[[![(5)](../images/callouts/5.gif)|x1272#mapply.returnwidget]]                        In order to make the **::MultiApply::GateComboBox**
                    ...
                    [[![(3)](../images/callouts/3.gif)|x1272#mapply.setgatelist]]                        Configuring the combobox's `-values`
...
[[![(10)](../images/callouts/10.gif)|x1272#mapply.loadinitialspectra]]                        Since the trace proc ignores the spectrum parameter we
...
[[![(6)](../images/callouts/6.gif)|x1272#mapply.selectorframe]] `::MultiApply::Selectors`  creates a
...
[[![(7)](../images/callouts/7.gif)|x1272#mapply.selectorcreation]]                        The two selectors get created as children of the frame.
                    ...
                    [[![(9)](../images/callouts/9.gif)|x1272#mapply.selectorresize]]                        By now hopefully you have some familiarity with column
                        ...
                        centered.
                    [[![(10)](../images/callouts/10.gif)|x1272#mapply.topframe]] `::MultiApply::MultiApply` creates
