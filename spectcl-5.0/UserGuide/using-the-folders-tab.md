...
## <a name="AEN2598"></a>7.6.1. Spectra folder

Let's look at the folder gui with the top level Spectra
                    folder and all subfolders opened:

<a name="AEN2601"></a>**Figure 7-26. Tree Gui Spectra folder**
...
### <a name="AEN2622"></a>7.6.1.1. Top level spectra folder context menu
...
New...Allows you to create new spectra.

Refresh treeReloads the current definitions into the tree.
                                        This is required if changes are made
                                        either outside of the GUI or in other
                                        tabs of the GUI.

Clear AllClears all of the spectra (contents).

HelpThe folder page has extensive online help.
...
<a name="AEN2650"></a>**Figure 7-27. Top level spectrum editor**
...
<a name="AEN2659"></a>**Figure 7-28. 1-d Spectrum Editor.**
...
<a name="AEN2677"></a>**Figure 7-29. 2-d spectrum editor**
...
<a name="AEN2699"></a>**Figure 7-30. Gamma-1d spectrum editor**
...
<a name="AEN2716"></a>**Figure 7-31. Gamma 2-d x/y spectrum editor**
...
<a name="AEN2726"></a>**Figure 7-32. Gamma summary spectrum editor**
...
<a name="AEN2735"></a>**Figure 7-33. 2-d sum spectrum**
...
<a name="AEN2752"></a>**Figure 7-34. Summary spectrum editor**
...
<a name="AEN2764"></a>**Figure 7-35. Bit mask spectrum editor**
...
<a name="AEN2773"></a>**Figure 7-36. Strip chart Spectrum editor**
...
### <a name="AEN2778"></a>7.6.1.2. Spectrum context menu
...
Edit...Brings up the spectrum editor appropriate to
...
ClearClears only that spectrum.

Gate...Brings up the gate application dialog
...
<a name="AEN2799"></a>**Figure 7-37. Gate Application dialog**

![](gateapplication.png)

UngateRemoves any gate applied to the spectrum.
                                    This is actually done by applying a True
                                    gate to the spectrum named
                                    -Ungated-.

Write...Brings up a file selection dialog box the
                                    contents of the 
                                    Spectrum on which the context menu was
                                    brought up will be written to file.

Delete..After prompting for confirmation (and
                                    getting it) deletes the spectrum on which
                                    the context menu was popped up.

Help...Displays help on the context menu entries.

## <a name="AEN2823"></a>7.6.2. Parameters folder
...
Pseudo...Allows you to define a new parameter that,
...
<a name="AEN2836"></a>**Figure 7-38. Psuedo parameter editor**
...
Refresh TreeUpdates the user interface's knowledge of the
                                objects SpecTcl knows about.

HelpProvides help on the context menu.
...
<a name="AEN2867"></a>**Figure 7-39. Parameter editor**

![](parameditor.png)

This dialog should be pretty self explanatory.

## <a name="AEN2871"></a>7.6.3. Variables folder
...
## <a name="AEN2881"></a>7.6.4. Gates folder
...
Edit...Brings up the gate editor with all values
                                initialized to that of the gate that
                                brought up the context menu.

Apply To...Brings up a dialog that allows you to select
                                one or more spectra to which the gate will be
                                applied.

Delete...Allows you, after confirmation to delete the gate.
...
Let's look at the
                    [[x2593#sec.gatecreator]]
                    and then at the
                    [[x2593#sec.gateappdialog]]
...
<a name="AEN2913"></a>**Figure 7-41. Gate create/edit dialog**
...
<a name="AEN2968"></a>**Figure 7-45. The interior of a pathalogical contoure gate**

![](contourinterior.png)

The contour editor is the same as the
                        [[x2593#fig.bandeditor]].
...
<a name="AEN2981"></a>**Figure 7-46. Gate Application Dialog**
