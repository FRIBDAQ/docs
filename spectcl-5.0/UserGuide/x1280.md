...
[[x1280#mapply.selectorframe]] `::MultiApply::Selectors`  creates a
...
[[x1280#mapply.selectorcreation]]                        The two selectors get created as children of the frame.
                    ...
                    [[x1280#mapply.selectorresize]]                        By now hopefully you have some familiarity with column
                        ...
                        centered.
                    [[x1280#mapply.topframe]] `::MultiApply::MultiApply` creates
...
| --- | --- | --- |
| Prev | Home | Next |
| Scripting with SpecTcl | Up | Connecting scripts and your event processors. |
