...
[← Using the 'standard' SpecTcl GUI](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/c1998.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the 'standard' SpecTcl GUI →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/c2006.md)
...
<a name="AEN2006"></a>**Figure 7-1. SpecTcl default graphical user interface (GUI)**
...
# <a name="AEN2025"></a>7.1. The Menubar and its contents

Let's look at the menu bar one menu at a time:

## <a name="AEN2028"></a>7.1.1. The File menu
...
<a name="AEN2060"></a>**Figure 7-3. Choosing spectra to save to file**
...
<a name="AEN2083"></a>**Figure 7-4. Spectrum file selection dialog**
...
## <a name="AEN2115"></a>7.1.2. The Edit menu
...
<a name="AEN2121"></a>**Figure 7-5. SpecTcl Preferences dialog**
...
## <a name="AEN2131"></a>7.1.3. The Data Source Menu
...
<a name="AEN2144"></a>**Figure 7-6. Prompt to connect SpecTcl online**
...
<a name="AEN2182"></a>**Figure 7-7. File data source choooser**
...
<a name="AEN2192"></a>**Figure 7-8. Pipe data source dialog**
...
<a name="AEN2207"></a>**Figure 7-9. Cluster chooser dialog**
...
## <a name="AEN2224"></a>7.1.4. The Filters menu
...
SpecTcl must be prepared to read back filter files.
                    ...
                    [*Analyzing filter files*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/c2979.md).
...
<a name="AEN2247"></a>**Figure 7-10. Filter wizard - setting the filter name**
...
<a name="AEN2252"></a>**Figure 7-11. Filter wizard - setting the filter gate.**
...
<a name="AEN2260"></a>**Figure 7-12. Filter wizard - choosing parameters**
...
<a name="AEN2266"></a>**Figure 7-13. Filter wizard - choosing the output file.**
...
<a name="AEN2281"></a>**Figure 7-14. FiltersFilter Enables... dialog**
...
## <a name="AEN2296"></a>7.1.5. The Spectra menu
...
**SpectraCreate... **
                        ...
                        completely in the
                        [*Using the folders tab.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2586.md).
...
<a name="AEN2345"></a>**Figure 7-16. Gate application dialog**
...
## <a name="AEN2351"></a>7.1.6. The Gate menu
...
The GUI mechanics for this menu item will be described in
                    ...
                    see
                    [*Using the Gates page*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2553.md).
...
**GateApply... **
                        ...
                        SpectraApply Gate...
                        See
                        [**Spectra**Apply Gate...**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/c1999.md#para.applygate)
...
<a name="AEN2377"></a>**Figure 7-17. Gate selection dialog**
