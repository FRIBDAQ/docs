...
[[x1541#calibget.interp]] `getInterpreter()` returns a
                            ...
                            right one.
                        [[x1541#calibget.tclvar]] `CTCLVariable` wraps a variable
...
[[x1541#setcalib.bindcmdwords]] `CTCLObject` objects
...
[[x1541#setcalib.requireexactly]] `CTCLObjectProcessor` provides
...
[[x1541#setcalib.extractparams]] `CTCLObject` provides type
                            conversion
