...
For more about startup scripts see:
                                [[*SpecTcl's startup process*|c934]]
                                For more about scripting SpecTcl, see:
                                [[*Scripting with SpecTcl*|c1035]]
...
[[![(1)](../images/callouts/1.gif)|x506#evp.h.guard]]                            Best practices call for header files to be guarded
                        ...
                        [[![(2)](../images/callouts/2.gif)|x506#evp.h.config]]                            The config.h contains definitions
                            ...
                            guard.
                        [[![(3)](../images/callouts/3.gif)|x506#evp.h.baseinc]]                            Our class, `SimpleEventProcessotr`
...
[[![(1)](../images/callouts/1.gif)|x506#simple.raw.ptr]] Address_t is a typedef for
                        ...
                        [[![(2)](../images/callouts/2.gif)|x506#simple.raw.tclanalyzer]]                            One of the things we must do is report the event
                        ...
                        [[![(3)](../images/callouts/3.gif)|x506#simple.raw.size]]                            Extracts the event size.
                        [[![(4)](../images/callouts/4.gif)|x506#simple.raw.setsize]]                            Tells the analyzer how big the event is. Note that
...
[[![(4)](../images/callouts/4.gif)|x506#simple.tree.store]]                            Stores the data into the tree parameter array.
