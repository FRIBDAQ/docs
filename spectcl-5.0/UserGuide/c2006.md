...
SnapshotIf this is checked, the spectrum read is a snapshot
...
Replace existing spectraSpectrum files contain the original names of the
...
Bind to displayIf checked, once the spectrum has been read
...
nsclActually represents data older than nscldaq-10.0.
                                It also requires a buffer size that is smaller
                                than 128Kbytes (65536 words).

jumboRepresents nscldaq data older than 10.0.
...
ring10Data from nscldaq 10.x  This is ringbuffer
                                data prior to the addition of body headers.

ring11Data from nscldaq 11.0 and later.  This is ringbuffer
...
| --- | --- | --- |
| Prev | Home | Next |
| Connecting scripts and your event processors. |  | Using the Spectra page |
