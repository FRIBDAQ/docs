...
[← Using the Gates page](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2560.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the folders tab. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2585.md)
...
## <a name="AEN2588"></a>7.6.1. Spectra folder

Let's look at the folder gui with the top level Spectra
                    folder and all subfolders opened:

<a name="AEN2591"></a>**Figure 7-26. Tree Gui Spectra folder**
...
### <a name="AEN2612"></a>7.6.1.1. Top level spectra folder context menu
...
<a name="AEN2640"></a>**Figure 7-27. Top level spectrum editor**
...
<a name="AEN2649"></a>**Figure 7-28. 1-d Spectrum Editor.**
...
<a name="AEN2667"></a>**Figure 7-29. 2-d spectrum editor**
...
<a name="AEN2689"></a>**Figure 7-30. Gamma-1d spectrum editor**
...
<a name="AEN2706"></a>**Figure 7-31. Gamma 2-d x/y spectrum editor**
...
<a name="AEN2716"></a>**Figure 7-32. Gamma summary spectrum editor**
...
<a name="AEN2725"></a>**Figure 7-33. 2-d sum spectrum**
...
<a name="AEN2742"></a>**Figure 7-34. Summary spectrum editor**
...
<a name="AEN2754"></a>**Figure 7-35. Bit mask spectrum editor**
...
<a name="AEN2763"></a>**Figure 7-36. Strip chart Spectrum editor**
...
### <a name="AEN2768"></a>7.6.1.2. Spectrum context menu
...
- Gate...
  ...
  <a name="AEN2789"></a>**Figure 7-37. Gate Application dialog**
...
## <a name="AEN2813"></a>7.6.2. Parameters folder
...
- Pseudo...
  ...
  <a name="AEN2826"></a>**Figure 7-38. Psuedo parameter editor**
...
## <a name="AEN2871"></a>7.6.4. Gates folder
...
Let's look at the
                    [*Gate creation/edit dialog*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2583.md#sec.gatecreator)
                    and then at the
                    [*Gate application dialog*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2583.md#sec.gateappdialog)
...
<a name="AEN2903"></a>**Figure 7-41. Gate create/edit dialog**
...
**Or gate editor. **
                            ...
                            [*And gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2583.md#fig.andeditor)
...
<a name="AEN2958"></a>**Figure 7-45. The interior of a pathalogical contoure gate**

![](https://github.com/FRIBDAQ/docs/tree/main/contourinterior.png)

The contour editor is the same as the
                        [*Band gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2583.md#fig.bandeditor).
...
<a name="AEN2971"></a>**Figure 7-46. Gate Application Dialog**
