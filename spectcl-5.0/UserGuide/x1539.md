...
[[x1539#calibget.interp]] `getInterpreter()` returns a
                            ...
                            right one.
                        [[x1539#calibget.tclvar]] `CTCLVariable` wraps a variable
...
[[x1539#setcalib.bindcmdwords]] `CTCLObject` objects
...
[[x1539#setcalib.requireexactly]] `CTCLObjectProcessor` provides
...
[[x1539#setcalib.extractparams]] `CTCLObject` provides type
                            conversion
