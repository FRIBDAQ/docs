...
[← Some SpecTcl scripting examples.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1280.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Connecting scripts and your event processors. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1541.md)

---

---

# <a name="AEN1539"></a>6.3. Connecting scripts and your event processors.
...
## <a name="AEN1550"></a>6.3.1. Using Tcl variables to communicate with C/C++ code
...
<a name="AEN1591"></a>**Example 6-4. Calibration event processor**
...
<a name="AEN1610"></a>**Example 6-5. Calibrated parameter constructor**
...
<a name="AEN1616"></a>**Example 6-6. Calibrated parameter computatino:**
...
<a name="AEN1622"></a>**Example 6-7. Getting the slope from a Tcl variable:**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calibget.api)
  ...
  Singleton's don't have public constructors.  They
                              ...
                              that class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calibget.interp)
  `getInterpreter()` returns a
                              ...
                              right one.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calibget.tclvar)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calibget.varget)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calibget.setval)
...
<a name="AEN1663"></a>**Example 6-8. Getting the offset from a Tcl variable**
...
The only difference from `getSlop`
...
<a name="AEN1686"></a>**Example 6-9. Calibrator header with linked variables:**
...
<a name="AEN1694"></a>**Example 6-10. Constructor for linked variables**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calib.linkinterp)
  This code should be familiar by now.  We use the
                              SpecTcl API singleton to get a pointer to the SpecTcl
                              command interpreter.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calib.linkslopeset)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calib.linkslopelink)
  This call links the slope variable to `m_slope`
                              forcing it to be a double.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#calib.linkoffsettoo)
...
<a name="AEN1716"></a>**Example 6-11. Destructor for linked variable calibrator**
...
<a name="AEN1725"></a>**Example 6-12. Getting slope and offset for linked variables**
...
## <a name="AEN1729"></a>6.3.2. Using the Treevariable subsystem
...
<a name="AEN1742"></a>**Example 6-13. Header for calibrator using treevariables**
...
<a name="AEN1747"></a>**Example 6-14. TreeCalibratorConstructor**
...
<a name="AEN1753"></a>**Example 6-15. TreeCalibrator::operator()**
...
## <a name="AEN1757"></a>6.3.3. Adding new compiled commands to Tcl
...
### <a name="AEN1777"></a>6.3.3.1. The Event processor

The header of the event processor look fairly normal:

<a name="AEN1780"></a>**Example 6-16. Event processor for command steered calibration**
...
<a name="AEN1784"></a>**Example 6-17. Constructor for command steered calibration event proc.**
...
<a name="AEN1788"></a>**Example 6-18. Command drive event processor implementation**
...
### <a name="AEN1791"></a>6.3.3.2. The command processor
...
<a name="AEN1799"></a>**Example 6-19. setcalib command processor header:**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.procheader)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.forwarddef)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.classdef)
  Our class, `SetCalibCommand`
                                  is derived, as promised from
                                  `CTCObjectProcessor`.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.evpmember)
  This member declaration provides storage
                                  for a refrence to the event processor we're
                                  configuring.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.constructargs)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.cmdentryargs)
...
<a name="AEN1840"></a>**Example 6-20. setcalib command constructor:**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.implincludes)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.bcconstruct)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.refconstruct)
...
<a name="AEN1883"></a>**Example 6-21. setcalib Command processor implementation**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.statoptimism)
  ...
  This initialization of `status`
                              ...
                              success.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.bindcmdwords)
  `CTCLObject` objects
  ...
  The base class,
                              ...
                              of `CTCLObject`s.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.requireexactly)
  `CTCLObjectProcessor` provides
  ...
  Note as well that the command requires three parameters
                              ...
                              command verb.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.extractparams)
  ...
  If the required representation cannot be extracted
                              ...
                              `CException`.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.errortothrow)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.setparams)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.exceptionhandling)
  ...
  Note as well the final catch(...)
                              ...
                              of TCL_ERROR.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1539.md#setcalib.returncode)
  The final return code, TCL_OK if
                              no exception is caught, or TCL_ERROR
                              if one was. is returned to the interpreter.

### <a name="AEN1956"></a>6.3.3.3. Hooking it all together.
