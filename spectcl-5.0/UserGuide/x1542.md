...
[[![(2)](../images/callouts/2.gif)|x1542#calibget.interp]] `getInterpreter()` returns a
                            ...
                            right one.
                        [[![(3)](../images/callouts/3.gif)|x1542#calibget.tclvar]] `CTCLVariable` wraps a variable
...
[[![(4)](../images/callouts/4.gif)|x1542#calibget.varget]]                            The `Get` method returns the
...
[[![(5)](../images/callouts/5.gif)|x1542#calibget.setval]]                            If the return value from `Get`
...
[[![(6)](../images/callouts/6.gif)|x1542#setcalib.cmdentryargs]]                                The base class arranges for the virtual
                                method `operator()`
...
[[![(1)](../images/callouts/1.gif)|x1542#setcalib.implincludes]]                                These headers are included to satisfy opaque
...
[[![(2)](../images/callouts/2.gif)|x1542#setcalib.bcconstruct]]                                The base class constructor takes care of all
...
[[![(3)](../images/callouts/3.gif)|x1542#setcalib.refconstruct]]                                All member data that are references must be
...
[[![(1)](../images/callouts/1.gif)|x1542#setcalib.statoptimism]]                            Our error handling strategy will be to wrap
...
[[![(2)](../images/callouts/2.gif)|x1542#setcalib.bindcmdwords]] `CTCLObject` objects
...
[[![(3)](../images/callouts/3.gif)|x1542#setcalib.requireexactly]] `CTCLObjectProcessor` provides
...
[[![(4)](../images/callouts/4.gif)|x1542#setcalib.extractparams]] `CTCLObject` provides type
                            conversion
...
[[![(5)](../images/callouts/5.gif)|x1542#setcalib.errortothrow]]                            Here we see how error detection and handling can
...
[[![(6)](../images/callouts/6.gif)|x1542#setcalib.setparams]]                            Once the calibration constants have been processed
                        ...
                        [[![(7)](../images/callouts/7.gif)|x1542#setcalib.exceptionhandling]]                            This group of catches extracts an error message
...
[[![(8)](../images/callouts/8.gif)|x1542#setcalib.returncode]]                            The final return code, TCL_OK if
