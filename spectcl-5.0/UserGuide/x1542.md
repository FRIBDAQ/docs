...
[[x1542#calibget.interp]] `getInterpreter()` returns a
                            ...
                            right one.
                        [[x1542#calibget.tclvar]] `CTCLVariable` wraps a variable
...
[[x1542#setcalib.bindcmdwords]] `CTCLObject` objects
...
[[x1542#setcalib.requireexactly]] `CTCLObjectProcessor` provides
...
[[x1542#setcalib.extractparams]] `CTCLObject` provides type
                            conversion
