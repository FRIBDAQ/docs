...
- [[![(1)](../images/callouts/1.gif)|x1542#calibget.api]]
  ...
  Singleton's don't have public constructors.  They
                              ...
                              that class.
- [[![(2)](../images/callouts/2.gif)|x1542#calibget.interp]]
  `getInterpreter()` returns a
                              ...
                              right one.
- [[![(3)](../images/callouts/3.gif)|x1542#calibget.tclvar]]
...
- [[![(1)](../images/callouts/1.gif)|x1542#setcalib.statoptimism]]
  ...
  This initialization of `status`
                              ...
                              success.
- [[![(2)](../images/callouts/2.gif)|x1542#setcalib.bindcmdwords]]
  `CTCLObject` objects
  ...
  The base class,
                              ...
                              of `CTCLObject`s.
- [[![(3)](../images/callouts/3.gif)|x1542#setcalib.requireexactly]]
  `CTCLObjectProcessor` provides
  ...
  Note as well that the command requires three parameters
                              ...
                              command verb.
- [[![(4)](../images/callouts/4.gif)|x1542#setcalib.extractparams]]
