...
[← Connecting scripts and your event processors.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1541.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Connecting scripts and your event processors. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md)

---

---

# <a name="AEN1542"></a>6.3. Connecting scripts and your event processors.
...
## <a name="AEN1553"></a>6.3.1. Using Tcl variables to communicate with C/C++ code
...
<a name="AEN1594"></a>**Example 6-4. Calibration event processor**
...
<a name="AEN1613"></a>**Example 6-5. Calibrated parameter constructor**
...
<a name="AEN1619"></a>**Example 6-6. Calibrated parameter computatino:**
...
<a name="AEN1625"></a>**Example 6-7. Getting the slope from a Tcl variable:**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calibget.api)
  ...
  Singleton's don't have public constructors.  They
                              ...
                              that class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calibget.interp)
  `getInterpreter()` returns a
                              ...
                              right one.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calibget.tclvar)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calibget.varget)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calibget.setval)
...
<a name="AEN1666"></a>**Example 6-8. Getting the offset from a Tcl variable**
...
<a name="AEN1689"></a>**Example 6-9. Calibrator header with linked variables:**
...
<a name="AEN1697"></a>**Example 6-10. Constructor for linked variables**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calib.linkinterp)
  This code should be familiar by now.  We use the
                              SpecTcl API singleton to get a pointer to the SpecTcl
                              command interpreter.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calib.linkslopeset)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calib.linkslopelink)
  This call links the slope variable to `m_slope`
                              forcing it to be a double.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#calib.linkoffsettoo)
...
<a name="AEN1719"></a>**Example 6-11. Destructor for linked variable calibrator**
...
<a name="AEN1728"></a>**Example 6-12. Getting slope and offset for linked variables**
...
## <a name="AEN1732"></a>6.3.2. Using the Treevariable subsystem
...
<a name="AEN1745"></a>**Example 6-13. Header for calibrator using treevariables**
...
<a name="AEN1750"></a>**Example 6-14. TreeCalibratorConstructor**
...
<a name="AEN1756"></a>**Example 6-15. TreeCalibrator::operator()**
...
## <a name="AEN1760"></a>6.3.3. Adding new compiled commands to Tcl
...
### <a name="AEN1780"></a>6.3.3.1. The Event processor

The header of the event processor look fairly normal:

<a name="AEN1783"></a>**Example 6-16. Event processor for command steered calibration**
...
<a name="AEN1787"></a>**Example 6-17. Constructor for command steered calibration event proc.**
...
<a name="AEN1791"></a>**Example 6-18. Command drive event processor implementation**
...
### <a name="AEN1794"></a>6.3.3.2. The command processor
...
<a name="AEN1802"></a>**Example 6-19. setcalib command processor header:**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.procheader)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.forwarddef)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.classdef)
  Our class, `SetCalibCommand`
                                  is derived, as promised from
                                  `CTCObjectProcessor`.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.evpmember)
  This member declaration provides storage
                                  for a refrence to the event processor we're
                                  configuring.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.constructargs)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.cmdentryargs)
...
<a name="AEN1843"></a>**Example 6-20. setcalib command constructor:**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.implincludes)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.bcconstruct)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.refconstruct)
...
<a name="AEN1886"></a>**Example 6-21. setcalib Command processor implementation**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.statoptimism)
  ...
  This initialization of `status`
                              ...
                              success.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.bindcmdwords)
  `CTCLObject` objects
  ...
  The base class,
                              ...
                              of `CTCLObject`s.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.requireexactly)
  `CTCLObjectProcessor` provides
  ...
  Note as well that the command requires three parameters
                              ...
                              command verb.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.extractparams)
  ...
  If the required representation cannot be extracted
                              ...
                              `CException`.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.errortothrow)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.setparams)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.exceptionhandling)
  ...
  Note as well the final catch(...)
                              ...
                              of TCL_ERROR.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1542.md#setcalib.returncode)
  The final return code, TCL_OK if
                              no exception is caught, or TCL_ERROR
                              if one was. is returned to the interpreter.

#### <a name="AEN1959"></a>6.3.3.2.1. Hooking it all together.
