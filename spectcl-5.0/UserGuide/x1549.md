...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calibget.api]]
  ...
  Singleton's don't have public constructors.  They
                              ...
                              that class.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calibget.interp]]
  `getInterpreter()` returns a
                              ...
                              right one.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calibget.tclvar]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calibget.varget]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calibget.setval]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calib.linkinterp]]
  This code should be familiar by now.  We use the
                              SpecTcl API singleton to get a pointer to the SpecTcl
                              command interpreter.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calib.linkslopeset]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calib.linkslopelink]]
  This call links the slope variable to `m_slope`
                              forcing it to be a double.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#calib.linkoffsettoo]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.procheader]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.forwarddef]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.classdef]]
  Our class, `SetCalibCommand`
                                  is derived, as promised from
                                  `CTCObjectProcessor`.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.evpmember]]
  This member declaration provides storage
                                  for a refrence to the event processor we're
                                  configuring.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.constructargs]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.cmdentryargs]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.implincludes]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.bcconstruct]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.refconstruct]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.statoptimism]]
  ...
  This initialization of `status`
                              ...
                              success.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.bindcmdwords]]
  `CTCLObject` objects
  ...
  The base class,
                              ...
                              of `CTCLObject`s.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.requireexactly]]
  `CTCLObjectProcessor` provides
  ...
  Note as well that the command requires three parameters
                              ...
                              command verb.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.extractparams]]
  ...
  If the required representation cannot be extracted
                              ...
                              `CException`.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.errortothrow]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.setparams]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.exceptionhandling]]
  ...
  Note as well the final catch(...)
                              ...
                              of TCL_ERROR.
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1549.md#setcalib.returncode]]
