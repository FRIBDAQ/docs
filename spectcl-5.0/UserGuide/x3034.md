...
[← The format of filtered event files.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x3033.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The format of filtered event files. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x3041.md)

---

---

# <a name="AEN3034"></a>8.2. The format of filtered event files.
...
## <a name="AEN3045"></a>8.2.1. The header record
...
## <a name="AEN3056"></a>8.2.2. The event record
