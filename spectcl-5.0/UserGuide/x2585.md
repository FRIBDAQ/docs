...
[← Using the folders tab.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2583.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the folders tab. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2586.md)
...
Let's look at the
                    [*Gate creation/edit dialog*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2585.md#sec.gatecreator)
                    and then at the
                    [*Gate application dialog*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2585.md#sec.gateappdialog)
...
**Or gate editor. **
                            ...
                            [*And gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2585.md#fig.andeditor)
...
The gamma slice editor is identical to
                        [*Slice gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2585.md#fig.sliceeditor)
...
The contour editor is the same as the
                        [*Band gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2585.md#fig.bandeditor).
