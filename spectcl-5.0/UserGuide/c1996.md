...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/c13.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the 'standard' SpecTcl GUI →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/c1998.md)
...
<a name="AEN2003"></a>**Figure 7-1. SpecTcl default graphical user interface (GUI)**
...
# <a name="AEN2022"></a>7.1. The Menubar and its contents

Let's look at the menu bar one menu at a time:

## <a name="AEN2025"></a>7.1.1. The File menu
...
<a name="AEN2057"></a>**Figure 7-3. Choosing spectra to save to file**
...
<a name="AEN2080"></a>**Figure 7-4. Spectrum file selection dialog**
...
## <a name="AEN2112"></a>7.1.2. The Edit menu
...
<a name="AEN2118"></a>**Figure 7-5. SpecTcl Preferences dialog**
...
## <a name="AEN2128"></a>7.1.3. The Data Source Menu
...
<a name="AEN2141"></a>**Figure 7-6. Prompt to connect SpecTcl online**
...
<a name="AEN2179"></a>**Figure 7-7. File data source choooser**
...
<a name="AEN2189"></a>**Figure 7-8. Pipe data source dialog**
...
<a name="AEN2204"></a>**Figure 7-9. Cluster chooser dialog**
...
## <a name="AEN2221"></a>7.1.4. The Filters menu
...
<a name="AEN2244"></a>**Figure 7-10. Filter wizard - setting the filter name**
...
<a name="AEN2249"></a>**Figure 7-11. Filter wizard - setting the filter gate.**
...
<a name="AEN2257"></a>**Figure 7-12. Filter wizard - choosing parameters**
...
<a name="AEN2263"></a>**Figure 7-13. Filter wizard - choosing the output file.**
...
<a name="AEN2278"></a>**Figure 7-14. FiltersFilter Enables... dialog**
...
## <a name="AEN2293"></a>7.1.5. The Spectra menu
...
**SpectraCreate... **
                        ...
                        completely in the
                        [*Using the folders tab.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2583.md).
...
<a name="AEN2342"></a>**Figure 7-16. Gate application dialog**
...
## <a name="AEN2348"></a>7.1.6. The Gate menu
...
The GUI mechanics for this menu item will be described in
                    ...
                    see
                    [*Using the Gates page*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2550.md).
...
**GateApply... **
                        ...
                        SpectraApply Gate...
                        See
                        [**Spectra**Apply Gate...**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/c1996.md#para.applygate)
                        for information about the UI mechanics required to
                        complete this operation.

**GateDelete... **Allows you to select a set of gates to delete.  Note that
...
<a name="AEN2374"></a>**Figure 7-17. Gate selection dialog**
