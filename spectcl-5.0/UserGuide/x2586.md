...
[← Using the folders tab.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2585.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the folders tab. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2593.md)
...
## <a name="AEN2591"></a>7.6.1. Spectra folder

Let's look at the folder gui with the top level Spectra
                    folder and all subfolders opened:

<a name="AEN2594"></a>**Figure 7-26. Tree Gui Spectra folder**
...
### <a name="AEN2615"></a>7.6.1.1. Top level spectra folder context menu
...
<a name="AEN2643"></a>**Figure 7-27. Top level spectrum editor**
...
<a name="AEN2652"></a>**Figure 7-28. 1-d Spectrum Editor.**
...
<a name="AEN2670"></a>**Figure 7-29. 2-d spectrum editor**
...
<a name="AEN2692"></a>**Figure 7-30. Gamma-1d spectrum editor**
...
<a name="AEN2709"></a>**Figure 7-31. Gamma 2-d x/y spectrum editor**
...
<a name="AEN2719"></a>**Figure 7-32. Gamma summary spectrum editor**
...
<a name="AEN2728"></a>**Figure 7-33. 2-d sum spectrum**
...
<a name="AEN2745"></a>**Figure 7-34. Summary spectrum editor**
...
<a name="AEN2757"></a>**Figure 7-35. Bit mask spectrum editor**
...
<a name="AEN2766"></a>**Figure 7-36. Strip chart Spectrum editor**
...
### <a name="AEN2771"></a>7.6.1.2. Spectrum context menu
...
- Gate...
  ...
  <a name="AEN2792"></a>**Figure 7-37. Gate Application dialog**
...
## <a name="AEN2816"></a>7.6.2. Parameters folder
...
- Pseudo...
  ...
  <a name="AEN2829"></a>**Figure 7-38. Psuedo parameter editor**
...
## <a name="AEN2874"></a>7.6.4. Gates folder
...
Let's look at the
                    [*Gate creation/edit dialog*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2586.md#sec.gatecreator)
                    and then at the
                    [*Gate application dialog*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2586.md#sec.gateappdialog)
...
<a name="AEN2906"></a>**Figure 7-41. Gate create/edit dialog**
...
**Or gate editor. **
                            ...
                            [*And gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2586.md#fig.andeditor)
...
The gamma slice editor is identical to
                        [*Slice gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2586.md#fig.sliceeditor)
...
<a name="AEN2961"></a>**Figure 7-45. The interior of a pathalogical contoure gate**

![](https://github.com/FRIBDAQ/docs/tree/main/contourinterior.png)

The contour editor is the same as the
                        [*Band gate editor*](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x2586.md#fig.bandeditor).
...
<a name="AEN2974"></a>**Figure 7-46. Gate Application Dialog**
