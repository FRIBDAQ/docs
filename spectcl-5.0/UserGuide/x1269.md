...
[[![(1)](../images/callouts/1.gif)|x1269#mapply.namespace]]                        This block of code creates a new Tcl
...
[[![(5)](../images/callouts/5.gif)|x1269#mapply.returnwidget]]                        In order to make the **::MultiApply::GateComboBox**
                    ...
                    [[![(3)](../images/callouts/3.gif)|x1269#mapply.setgatelist]]                        Configuring the combobox's `-values`
...
[[![(10)](../images/callouts/10.gif)|x1269#mapply.loadinitialspectra]]                        Since the trace proc ignores the spectrum parameter we
...
[[![(6)](../images/callouts/6.gif)|x1269#mapply.selectorframe]] `::MultiApply::Selectors`  creates a
...
The two selectors get created as children of the frame.
                ...
                [[![(8)](../images/callouts/8.gif)|x1269#mapply.selectorlayout]]                        The layout  places the gate selector to the right of
                        ...
                        centered.
                    [[![(10)](../images/callouts/10.gif)|x1269#mapply.topframe]] `::MultiApply::MultiApply` creates
