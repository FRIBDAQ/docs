...
[← SpecTcl User guide.](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/index.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Some SpecTcl scripting examples. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1272.md)

---

---

# <a name="AEN1269"></a>6.2. Some SpecTcl scripting examples.
...
<a name="AEN1308"></a>**Example 6-1. A gate selection combobox**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.namespace)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.makecombo)
  ...
  Note that the proc itself is also in the
                          MultiApply namespace.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.returnwidget)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.setgatelist)
...
<a name="AEN1351"></a>**Example 6-2. Spectrum selection listbox**
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.variable)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.containerframe)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.listbox)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.scrollbar)
  ...
  If we wanted to provide an X scrollbar we'd need it to
                          ...
                          command.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.spectrumtraces)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.spectrumtraces)
  ...
  The **after idle** command executes the script
                          ...
                          **after idle** to schedule execution of
                          ...
                          dictionary.
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.loadinitialspectra)
...
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.spechooserlayout)
...
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.spechooserweight)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.spectrace)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.clearlbox)
  Since we're regenerating the entire contents of the listbox,
                          the first step is to delete all items from the listbox.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.addspecname)
...
<a name="AEN1456"></a>**Example 6-3. Multiselect final layout and logic**
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.selectorframe)
...
The two selectors get created as children of the frame.
                ...
                - [![(8)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.selectorlayout)
  The layout  places the gate selector to the right of
                        ...
                        centered.
                    - [![(10)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.topframe)
...
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.selectors)
  The frame that contains both of the selectors is created.
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.applybutton)
...
- [**(13)**](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.toplayout)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.nsvariables)
  These two lines import the namespace scoped variables.
                          ...
                          listbox.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.specselections)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.errorchecking)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.selectedspectrumlist)
  This loop fetches the names of the selected spectra and
                          puts them in the list `spectrumNames`
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl-5.0/UserGuide/x1269.md#mapply.applygate)
