...
[← FragmentIndex](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r40718.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r41090.md)
...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r41090.md) for
...
If a port could not be allocated (e.g. all are in use or the port manager could
                ...
                [CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r41090.md).
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r41090.md).
