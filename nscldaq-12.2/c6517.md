...
[[`FragmentIndex`|r40718]]This class provide support for iterating through
...
[[CRingItem|r30177]]The base class of a hierarchy of classes that
...
The two tools you have for this are the ring item
                            types in the header [[DataFormat.h|r34376]]
...
[[![(3)](../images/callouts/3.gif)|c6517#redeci_dyncast]]                            The `CRingItem`::`createRingItem`
...
[[![(6)](../images/callouts/6.gif)|c6517#rideci_free]]                            Once the ring item created by the
                            `CRingItemFactory` is
                        ...
                        For more on `std::unique_ptr`
                            check out
                            [[the online documentation of that class|std::unique_ptr]].
...
[[![(1)](../images/callouts/1.gif)|c6517#rideci_bodyhdrcheck]]                            This code assumes that the ring items
...
[[![(2)](../images/callouts/2.gif)|c6517#rideci_bodyheaderinfo]]                            Extracts the information from the body header.
...
[[![(3)](../images/callouts/3.gif)|c6517#rideci_fragindex_info]] `FragmentIndex`, when constructed
...
[[![(4)](../images/callouts/4.gif)|c6517#rideci_fraghandler_dispatch]]                            This loop iterates over the fragments that were
...
[[![(1)](../images/callouts/1.gif)|c6517#cfhi_getbody]]                        The `operator()` method is
...
[[![(3)](../images/callouts/3.gif)|c6517#ringdecmain_instantiations]]                        To analyze data gotten from the data source we'll
