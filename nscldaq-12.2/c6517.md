...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ridec_handlerdict)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ridec_endhandler)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ridec_reghandler)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ridec_regend)
  Similarly provides a mechanis to register
                          an end of event handler.
                          `pHandler` is a pointer to the
                          actual handler object.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ridec_functor)
  ...
  This illustrates a software design principle that is very
                          ...
                          environments.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ridec_physics)
  Called by `operator()` to
                          process PHYSICS_EVENT ring items.
                          We'll look into this more when we look at
                          the implementation of the class.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ridec_other)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_fragreg)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_endreg)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_gettype)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_convert)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#redeci_dyncast)
  ...
  Dynamic casts can also cast to references, however
                              ...
                              thrown.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_phys)
  Now that we've produced the actual physics event item,
                              we can invoke
                              `decodePhysicsEvent` to
                              decode the actual event.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_other)
  ...
  Note that the pointer to the actual ring item type is
                              ...
                              of `decodeOtherItems`.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_free)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_bodyhdrcheck)
  ...
  If the ring item does not have a body header,
                              ...
                              at once.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_bodyheaderinfo)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_fragindex_info)
  ...
  Note that
                              ...
                              this.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#rideci_fraghandler_dispatch)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#meh_def)
  ...
  These two conditions are required for
                          ...
                          properly.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#meh_imp)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#cfhd_map)
  This map will contain the packet type/packet name
                          correspondences passed in to
                          `PacketUtils`::packetName.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#chfd_tspacket)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#cfhi_getbody)
  ...
  Other than outputting information in the
                          ...
                          or body header.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#chfi_toppacket)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#chfi_firstsubpkt)
  ...
  The following while loop iterates over
                          the subpackets.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#chfi_idsubpkt)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#chfi_tsdispatch)
  If the packet was a timestamp packet, it is processed by
                          invoking `timestampPacket`
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#chfi_nextsub)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_checkarg)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_makesource)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_instantiations)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_registrations)
  The fragment handlers and end handlers must be made known
                          ...
                          is 2.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_processitems)
  This loop gets successive ring items from the
                          data source, processes them and deletes them.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_endinput)
  When the last ringitem has been received (e.g.
                          ...
                          code is thrown.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_errors)
...
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md#ringdecmain_fallthrough)
