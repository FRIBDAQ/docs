...
- [[![(1)](../images/callouts/1.gif)|c15139#chapter.thread.mythread]]
  By making
...
- [[![(2)](../images/callouts/2.gif)|c15139#chapter.thread.run]]
  The
                      `run`
...
- [[![(3)](../images/callouts/3.gif)|c15139#chapter.thread.creation]]
  Creating a thread is simple.  Just create an object that
                      is of the thread class type.
- [[![(4)](../images/callouts/4.gif)|c15139#chapter.thread.start]]
  Starting a thread is equally simple, Just call the
                      ...
                      `run`
                      method.
- [[![(5)](../images/callouts/5.gif)|c15139#chapter.thread.join]]
...
- [[![(6)](../images/callouts/6.gif)|c15139#chapter.thread.destroy]]
...
- [[![(1)](../images/callouts/1.gif)|c15139#chapter.thread.synchronizable]]
  This member is the synchronization element.  We will see
                      it used in the
                      `increment`
                      member.
- [[![(2)](../images/callouts/2.gif)|c15139#chapter.thread.enter]]
  The
                      `sync_begin()`
                      ...
                      object.
- [[![(3)](../images/callouts/3.gif)|c15139#chapter.thread.leave]]
  This call leaves the monitor.  The effect of the
                      monitor is to make the increment atomic with respect to the
                      scheduler.
- [[![(4)](../images/callouts/4.gif)|c15139#chapter.thread.monitoredincr]]
  By using the
                      `increment`
...
See the [[*CSynchronizedThread*|r52524]]
