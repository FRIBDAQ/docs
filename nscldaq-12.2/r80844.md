...
[← EVBC::configParams](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r80802.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3rdogui →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r80884.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r80639.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r80463.md) to create the ring
             sources.
