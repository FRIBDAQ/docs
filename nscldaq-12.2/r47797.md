...
[← VMUSBnostackReadout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r4770.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3820 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r48266.md)
...
<a name="AEN47959"></a>## Public member functions
...
- <a name="AEN47982"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN47992"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN48003"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN48014"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN48026"></a>` void SetLatchMode(void);const`
...
- <a name="AEN48038"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN48073"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN48142"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN48153"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN48164"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN48175"></a>` void Clock(void);const`
...
- <a name="AEN48186"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN48197"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN48208"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN48220"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN48231"></a>` unsigned long Read(void);const`
...
- <a name="AEN48243"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
