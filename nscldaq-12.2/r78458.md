...
[← mvlc](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r7816.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [mvlclist →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r7895.md)
...
This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [CCCUSB(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r73422.md).  The
...
Command lists (see [cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r79193.md))
...
- ***object* executeList
  ...
  Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                              (see [cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r79193.md)).
...
- ***object* loadList
  ...
  `readout-list` is a
                              ...
                              [cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r79193.md) for
...
This section describes how to use **executeList**
                ...
                [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r76671.md) for reference
...
[CCCUSB(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r73422.md)
[cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r79193.md)
[CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r76671.md)
