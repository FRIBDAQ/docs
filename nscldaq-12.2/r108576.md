...
[← ssh](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r108521.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [logbookinstance →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r108632.md)
...
<a name="AEN108580"></a>## Name

logbook -- Access Logbooks from Tcl

<a name="AEN108583"></a>## Synopsis
...
<a name="AEN108593"></a>## DESCRIPTION
...
A disadvantage of the logbook package is, that while
            ...
            [*logbookadmin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109322.md)
            package instead as that procedural interface does storage management
            for you.

<a name="AEN108601"></a>### SUBCOMMANDS
...
- **open *filename***
  Provides access to the logbook database in the file
                          ...
                          [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r108632.md)
