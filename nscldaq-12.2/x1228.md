...
[← Overview and Examples of ring buffers in action.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x12135.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Selecting Data From a Ring Buffer →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x12691.md)
...
This section will describe how to run an experiment with the manager.
      Subsequent sections:
      [*Running Readout Software With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1411.md) and
      [*Using the NSCLDAQ Event Builder With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1673.md)
...
- [*Starting and Stopping the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1228.md#sec.mgr.startstop)
              will describe how to start and stop the DAQ manager which is at the
              heart of this subsystem.
- [*The Output Monitor*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1228.md#sec.mgr.output)
              describes a control panel that monitors the output of all programs
              run by the manager.
- [*The Run Control Panel*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1228.md#sec.mgr.runcontrol)
              describes the control panel you can use to control runs.
- [*Event Builder Statistics Panel.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1228.md#sec.mgr.eventbuilderstats)
...
Note that these control panels communicate with the manager and make use
        ...
        sections
        [*Running Readout Software With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1411.md)
        and [*Using the NSCLDAQ Event Builder With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1673.md)
...
The program
          [*mg_startManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20962.md)
...
Full reference information for this program is in
          [*rdo_RunControl*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20642.md)
...
When you use the manager with the event builder, it too will have
          a REST interface.  [*Using the NSCLDAQ Event Builder With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1673.md)
...
[*EVBMonitor*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20679.md)
