...
[← Authenticators](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15419.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compiling/Linking your software with the shared memory API →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15661.md)
...
Interactors are classes that are concrete classes derived
            ...
            [`CInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r54719.md).
...
In addition to
            [CInteractor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r54719.md), the following
            concrete interactors have been supplied.



- [`CStringInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r54898.md)
...
- [`CFdInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r55069.md)
  This interactor accepts the credentials via an open file
                          descriptor.
- [`CIOInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r55205.md)
