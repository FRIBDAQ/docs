...
<a name="AEN34916"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN34919"></a>## Synopsis
...
<a name="AEN34921"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN34932"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN34966"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN34986"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN35032"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN35038"></a>`pGlomParameters
...
<a name="AEN35052"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN35072"></a>`pEventBuilderFragment
...
<a name="AEN35092"></a>` pPhysicsEventItem
...
<a name="AEN35112"></a>` pPhysicsEventCountItem
...
<a name="AEN35205"></a>` pStateChangeItem
...
<a name="AEN35237"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN35245"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN35251"></a>` int  
              hasBodyHeader
...
<a name="AEN35275"></a>` uint32_t 
              itemSize
          (
              const RingItem*  pItem
          );`

<a name="AEN35283"></a>` uint16_t 
              itemType
          (
              const RingItem*  pItem
          );`

<a name="AEN35291"></a>` int
              mustSwap
          (
              const RingItem*  pItem
          );`

<a name="AEN35299"></a>` void* 
              fillRingHeader
          (
              pRingItem  pItem
          , 
...
<a name="AEN35445"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN35466"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN35521"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN35557"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN35650"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN35666"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN35693"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN35725"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN35751"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN35780"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN35928"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN35980"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN35991"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
