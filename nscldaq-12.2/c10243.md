...
[← Command line access to CAMAC via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c10217.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCLDAQ Logbook facility →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c10269.md)
...
The **ringtostdout** command can be used to
        ...
        [ringtostdout reference pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20001.md).
...
The **stdintoring** command can be used to allow a
        ...
        [stdintoring reference material](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20065.md).
