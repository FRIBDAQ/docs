...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r73301.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r76186.md)
...
<a name="AEN73436"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN73439"></a>## Synopsis

```
CCCUSB
```

<a name="AEN74421"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r76671.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r76671.md) for
...
<a name="AEN74992"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN74996"></a>### Action Register
...
<a name="AEN75039"></a>### Firmware Register
...
<a name="AEN75091"></a>### Global Mode Register
...
<a name="AEN75224"></a>### Delay Register
...
<a name="AEN75257"></a>### Scaler Control register
...
<a name="AEN75290"></a>### LED Source Register
...
<a name="AEN75542"></a>### Output source selection register.
...
<a name="AEN75711"></a>### Device source register
...
<a name="AEN76064"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN76125"></a>### Transfer setup register
