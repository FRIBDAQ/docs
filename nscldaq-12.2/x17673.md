...
[[*Obtaining and modifying the skeleton*|x17673#sec.rdoprogramming]]
            describe how to tailor an SBS readout skeleton to produce a readout
            program.   [[*Configuring modules*|x17673#sec.rdoconfig]]
...
6. Write a configuration file that appropriately configures
                         ...
                         [[*Configuring modules*|x17673#sec.rdoconfig]]).
...
- [[![(1)](../images/callouts/1.gif)|x17673#rdo.classinc]]
  This #include is needed to define
                              the `TclConfiguredReadout`
                              class.
- [[![(2)](../images/callouts/2.gif)|x17673#rdo.tracinginc]]
  Wrappers for the CAEN libraries support tracing the
                              ...
                              library Makefile.
- [[![(3)](../images/callouts/3.gif)|x17673#rdo.tracing]]
  If the library has been built with tracing enabled,
                              ...
                              impact performance.
- [[![(4)](../images/callouts/4.gif)|x17673#rdo.makesegment]]
...
- [[![(5)](../images/callouts/5.gif)|x17673#rdo.addmodule]]
...
- **vx27xxpha create *module-name***
  Creates a new configuration for a module `module-name`.
                          ...
                          module.
  thus in our example
                          [[*Sample Skeleton.cpp modifications*|x17673#ex.skeleton]]
