...
[← Exemplified Usage of the Actions package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17635.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Composing experiment configurations from existing pieces →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1792.md)
...
[*Obtaining and modifying the skeleton*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#sec.rdoprogramming)
            ...
            program.   [*Configuring modules*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#sec.rdoconfig)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#rdo.classinc)
  This #include is needed to define
                              the `TclConfiguredReadout`
                              class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#rdo.tracinginc)
  Wrappers for the CAEN libraries support tracing the
                              ...
                              library Makefile.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#rdo.tracing)
  If the library has been built with tracing enabled,
                              ...
                              impact performance.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#rdo.makesegment)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#rdo.addmodule)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#rdo.registersegment)
  The `TclConfiguredReadout`
                              event segment is registered with the experiment framework
                              so that its methods will be invoked by that framework
                              when appropriate.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#rdo.registertrigger)
...
- **vx27xxpha create *module-name***
  Creates a new configuration for a module `module-name`.
                          ...
                          module.
  thus in our example
                          [*Sample Skeleton.cpp modifications*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x17673.md#ex.skeleton)
