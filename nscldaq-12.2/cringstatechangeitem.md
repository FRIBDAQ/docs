...
<a name="AEN31358"></a>## Public member functions
...
<a name="AEN31598"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN31601"></a>**Example 1. Creating a begin run state transition item**
