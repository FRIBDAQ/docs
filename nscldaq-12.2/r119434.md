...
**Set *module-name module-parameter value***Attempts to set a parameter
                          `module-parameter`
...
**Get *module-name module-parameter***Retrives a parameter (`module-parameter`)
...
**mon *module-name***Returns data that is monitored by the
