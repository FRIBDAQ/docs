...
[← Extending the generator with loadable C++ generators](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Managed Objects and Configuration →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x799.md)
...
- `Initialize`
  ...
  The Initialize method/subcommand is passed a single parameter.
                      ...
                      [*Support facilities for Tcl drivers.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen.tcl.support).
- `addReadoutList`
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen-tcl-requiresnit)
  Since our driver is in snit, we must pull in the 
                          ...
                          **package provide sampledriver 1.0** and live in a 
                          ...
                          to locate them.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen-tcl-snittype)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen-tcl-optiondefs)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen-tcl-constructor)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen-tcl-init)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen-tcl-addreadout)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md#mvlcgen-tcl-endrun)
...
- **Table of Contents**
- [Address modifier Tcl variables](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r7802.md) -- Provide symbolic values for VME address modifiers.
- [mvlc](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r7816.md) -- Provide substitute for VMUSB controller object
- [mvlclist](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r7895.md) -- List memorizor for vmvlcgenerator
