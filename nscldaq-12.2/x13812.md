...
[[![(5)](../images/callouts/5.gif)|x13812#ex.staterest.current]]                  The `currentState` method of a
                ...
                [[![(7)](../images/callouts/7.gif)|x13812#ex.staterest.transition]]                  Requests the manager to make a state transition to the
                ...
                [[![(8)](../images/callouts/8.gif)|x13812#ex.staterest.destroy]]                  The `StateClient` object has a
...
[[![(3)](../images/callouts/3.gif)|x13812#ex.pgmstat.status]]                  The `status` method/subcommand provides
...
[[![(4)](../images/callouts/4.gif)|x13812#ex.pgmstat.destroy]]                  This line destroys the client object.
...
[[![(1)](../images/callouts/1.gif)|x13812#ex.kvclient.require]]                  In order to make calls to the Key Value REST client API,
                ...
                [[![(4)](../images/callouts/4.gif)|x13812#ex.kvclient.settitle]]                  The `setValue` method accepts two parameters,
                ...
                [[![(5)](../images/callouts/5.gif)|x13812#ex.kvclient.list]]                  The `list` method dumps the entire
                  ...
                  key value store key.
                [[![(6)](../images/callouts/6.gif)|x13812#ex.kvclient.destroy]]                  The `destroy` method destroys the client
