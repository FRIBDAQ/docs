...
[← RunState](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r116949.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [5daq →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r117194.md)
...
<a name="AEN117073"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN117076"></a>## Synopsis
...
<a name="AEN117120"></a>## Description
...
<a name="AEN117124"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r116345.md)).
