...
As was mentioned in [[x1971]], the user can pass a
...
<a name="AEN2158"></a>`uint64_t getEventTimestamp(void *pBuffer);`
...
<a name="AEN2167"></a>**Example 5-3. A sample getEventTimestamp() implementation**
...
From the [[x2141]], we know the first
...
<a name="AEN2213"></a>`uint64_t getScalerTimestamp(void *pBuffer);`

<a name="AEN2219"></a>**Example 5-4. 
...
## <a name="AEN2224"></a>5.7.3. Implementing an onBeginRun() function

The third function that can be defined in the timestamp extractor
        library has the prototype:

<a name="AEN2227"></a>`void onBeginRun(void);`
...
<a name="AEN2233"></a>**Example 5-5. Adding an offset to the timestamp**
...
### <a name="AEN2256"></a>5.7.3.1. Compiling the shared library
