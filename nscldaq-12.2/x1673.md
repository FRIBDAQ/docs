...
[← Building event builder clients.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x16705.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running event builder clients →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x16750.md)
...
This script assumes the appropriate  daqsetup.bash
      ...
      the [*EVBRest*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r22079.md)
      program which runs the orderer stage with a REST interface plugin.
      The second stage of the pipeline run the **glom** program
      described in
      [*glom*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r22096.md).
...
Use [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20226.md)
...
For more information; see
      [*ringFragmentSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r22441.md)
...
**Making a Program to Shutdown The Event Builder. **
        The [*EVBShutdown*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r22055.md)
...
**Adding the Event Builder Shutdown to a SHUTDOWN Sequence . **
        Using [*mg_seqedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20311.md)
