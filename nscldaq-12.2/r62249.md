...
[← CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r61516.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r62479.md)
...
<a name="AEN62359"></a>## Public member functions
...
<a name="AEN62470"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN62475"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r61516.md)
