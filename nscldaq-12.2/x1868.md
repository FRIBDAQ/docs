...
[← Configuring SpecTcl](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x18589.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Pipeline Building, Run Control, and DAQ Modularization →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x19.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1868.md#vmusb.config.create)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1868.md#vmusb.config.config)
...
Configuration files must also specify at least one stack and, if
        ...
        See the [stack(3vmusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r89856.md) command
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1868.md#vmusb.config.sis3820)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1868.md#vmusb.config.sclrStack)
...
If the device support provided by VMUSBReadout
      ...
      be found in [*Extending the Supported Readout Hardware*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x2269.md).
