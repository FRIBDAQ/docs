...
<a name="AEN43438"></a>## Public member functions
...
<a name="AEN43445"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN43466"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN43479"></a>` unsigned char getVersion(void);const`
...
<a name="AEN43504"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN43515"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN43861"></a>` ECLOutputSelect
...
<a name="AEN43929"></a>` unsigned short
...
<a name="AEN44093"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN44105"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN44115"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN44125"></a>` TriggerConfiguration
...
<a name="AEN44222"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN44263"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN44289"></a>` LEResolution
...
<a name="AEN44303"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN44463"></a>` unsigned short
...
<a name="AEN44557"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN44569"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN44586"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN44599"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN44611"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN44632"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN44644"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN44659"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN44674"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN44689"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN44701"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN44716"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN44726"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN44738"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN44750"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN44762"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN44774"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN44784"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN44794"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN44804"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN44814"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN44826"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN44836"></a>` void
                    EnableErrorMark(void);`



<a name="AEN44846"></a>` void
                    DisableErrorMark(void);`



<a name="AEN44856"></a>` void EnableBypassOnError(void);`



<a name="AEN44866"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN44876"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN44888"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN44898"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN44910"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN44920"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN44932"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN44944"></a>` void EnableAllChannels(void);`



<a name="AEN44954"></a>` void
                    DisableAllChannels(void);`



<a name="AEN44964"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN44976"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN44988"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN45003"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN45015"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN45027"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN45048"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN45061"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN45078"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN45096"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN45111"></a>## Types and public data
