...
ringbufferThis utility allows you to create, re-initialize, delete  and
            ...
            don't already exist. See the [[r19874]] for more information.
...
dumperProvides a simple textual formatted dump of the buffers.  If you
            ...
            each event and the packets within the event. See [[c11188]] and [[r22906]] for more information.

eventlogPerforms native mode event loggging.  In this mode, event file
            segments consists of streams of ring buffer items. See [[c11252]] and [[r23019]] for more information.
...
ringselectorProvides a flexible ringbuffer consumer that pipes the ring items
            ...
            applications like SpecTcl. See [[c11583]] and [[r23416]] for more information.
...
ringtostdoutAccepts data from a ring and pipes it to stdout.  This is the server
            ...
            process data from  a ring. See the [[r20001]] for more information.
...
ScalerDisplayProvides a display of scaler event data.  This application is highly
            ...
            selected scalers are also supported. See [[c6367]] and [[r22579#manpage.scalerdisplay]] for more information.

stdintoringAccepts data on stdin and puts it in a ring buffer.  This is the
            client side of the data pipeline that sets up a proxy ring. See the [[r20065]] for more information.
