...
# <a name="evb-connecting"></a>52.3. Connecting to the event builder.

The code below shows how to connect to the event builder as
                a client:

<a name="AEN14357"></a>**Example 52-1. 
