...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14354.md#evbc-connect-include]]
  As previously described, this #include
                          is required to define the client class.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14354.md#evbc-connect-hostname]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14354.md#evbc-connect-getport]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14354.md#evbc-connect-lookuperr]]
  If the port cannot be looked up an exception is thrown.
                          Normally you would fill in some error reporting code here.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14354.md#evbc-connect-create]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14354.md#evbc-connect-connect]]
  The `Connect` method actually attempts
                          to perform the connection to the event builder.
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14354.md#evbc-connect-connecterr]]
