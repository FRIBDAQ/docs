...
[← Pointers to the reference material](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15371.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Interactors →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15464.md)
...
The complete definitinon of
            ...
            [its reference pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r53742.md).
            The library provides the following concrete authentication classes:



- [`CPasswordCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r53854.md)
...
- [`CUnixUserCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r54052.md)
  The entity must provide a valid username and password
                          that is could login to the local unix system.
- [`CTclAccesListCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r54273.md)
...
- [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r54377.md)
  The entity must supply a string that is one of a set of strings
                              given to the authenticator.
- [`CHostListCheck`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r54529.md)
