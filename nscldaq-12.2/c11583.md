...
[← Sequencing runs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c11493.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compatibility utilities →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c11664.md)
...
The ringselector application is very
        ...
        [ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20001.md)
        application.  Both
...
For a complete reference on the command see the
        [ringselector reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r23416.md).
