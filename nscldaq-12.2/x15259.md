...
- [[![(4)](../images/callouts/4.gif)|x15259#gaurded_enter]]
  Invoking the `Enter` method of the base class
  	    ...
  	    will not block.
- [[![(5)](../images/callouts/5.gif)|x15259#gaurded_leave]]
