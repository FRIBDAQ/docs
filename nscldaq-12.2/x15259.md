...
[← Incorporating the library into an application.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15248.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Thread safe queues (CBufferQueue). →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15299.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15259.md#gaurded_include)
  The header CGaurdedObject.h defines the
  	    `CGaurdedObject` class and must be included
  	    by classes that derive from that class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15259.md#gaurded_inherit)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15259.md#gaurded_enter)
  Invoking the `Enter` method of the base class
  	    ...
  	    will not block.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15259.md#gaurded_leave)
