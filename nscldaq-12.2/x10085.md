...
[← How to use the MDGG16Control GUI](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10052.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Setting up an XLM72 as a gate delay generator for remote control →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10110.md)
