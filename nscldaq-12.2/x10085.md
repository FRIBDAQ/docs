...
| Prev | Chapter 19. Wiener MDGG-16 Controls | Next |


---

# <a name="AEN10085"></a>19.3. Saving and Restoring The State of the GUI Between Sessions

## <a name="AEN10087"></a>19.3.1. Saving the state
...
## <a name="AEN10090"></a>19.3.2. Restoring previous state
...
| --- | --- | --- |
| Prev | Home | Next |
| How to use the MDGG16Control GUI | Up | XLM72 Gate Delay Control GUI |
