...
<a name="AEN97056"></a>## Name

CControlHardware -- Base class for slow controls drivers

<a name="AEN97059"></a>## Synopsis

```
CControlHardware
```

<a name="AEN97151"></a>## DESCRIPTION
...
| --- | --- | --- |
| Prev | Home | Next |
| CConfigurableObject | Up | sis_vmusb_interface |
