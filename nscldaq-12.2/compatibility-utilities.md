...
# <a name="compatibilty"></a>Chapter 40. Compatibility utilities
...
<a name="compatibilitybuffer-ex1"></a>**Example 40-1. Converting a ring buffer event file with compatibilitybuffer**
...
# <a name="AEN11677"></a>40.1. Format conversion with compatibilitybuffer
...
The core tool in the compatibility toolbox is compatibilitybuffer
            ...
            [[c11664#compatibilitybuffer-ex1]],
            we wanted to write data with a 16384 byte buffersize we would instead write:

<a name="AEN11685"></a>**Example 40-2. Converting ring buffer data to a 8Kword (16Kbyte) old style event file**
