...
[← Synchronization Paradigm](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10002.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and restoring state →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10023.md)

---

---

# <a name="AEN10006"></a>18.3. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN10016"></a>**Figure 18-1. The MSCF16Control Graphical User Interface for USB**
   ![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/figures/MSCF16Control-USBHowTo-0.png)
