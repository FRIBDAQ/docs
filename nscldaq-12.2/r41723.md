...
<a name="AEN41737"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN41740"></a>## Synopsis
...
<a name="AEN41966"></a>## Public member functions





<a name="AEN41972"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN42034"></a>`unsigned long getBase(void);`
...
<a name="AEN42045"></a>`int getSerial(void);`
...
<a name="AEN42076"></a>`int  getFirmware(void);`
...
<a name="AEN42086"></a>`int  getCrate(void);`
...
<a name="AEN42097"></a>`void setCrate(int crateNum);`
...
<a name="AEN42110"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN42131"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN42141"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN42151"></a>`void keepOverflowData(void);`
...
<a name="AEN42161"></a>`void discardOverflowData(void);`
...
<a name="AEN42171"></a>`void keepInvalidData(void);`
...
<a name="AEN42182"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN42193"></a>`void commonStart(void);`
...
<a name="AEN42204"></a>`void commonStop(void);`
...
<a name="AEN42215"></a>`void setRange(int range);`
...
<a name="AEN42228"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN42300"></a>`void clearData
                                (void);`
...
<a name="AEN42343"></a>`bool Busy(void);`
...
<a name="AEN42354"></a>` bool gBusy(void);`
...
<a name="AEN42365"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN42376"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN42387"></a>`int readEvent(void* buf);`
...
<a name="AEN42400"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN42441"></a>`void enableSmallThresholds(void);`
...
<a name="AEN42504"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN42508"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN42512"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN42516"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN42520"></a>**Example 3. Reading out a CAEN 785 e.g.**
