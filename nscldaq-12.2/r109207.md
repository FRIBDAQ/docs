...
[← runinstance](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109107.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [logbookadmin →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109322.md)
...
A note instance is a Tcl command ensemble that provides access to
            ...
            See
            [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r108632.md) for subcommands that
            can generate notess
...
set run [*$note* run]
  ...
  If the note has an associated run, this subcommand returns
                       ...
                       [*runinstance*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109107.md)
