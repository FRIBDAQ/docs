...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c10243.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [glom →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c11148.md)
...
- [*Components of the NSCL logbook system*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c10269.md#sec.lg_inventory)
...
- [*Setting up a logbook for use.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10440.md)
             describes the tasks you need to perform to use the NSCL Logbook
              subsystem in an experiment.
- [*Using the logbook in an experiment*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10562.md)
              Describes how to use the logbook system in an experiment and beyond.
- [*Making logbooks available to collaborators*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10861.md)
              ...
              remote facility.
- [**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x10955.md)
...
- **lg_create**
  Used to create a new logbook.  When logbooks are created,
                    ...
                    current.
                    See
                    [*lg_create*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21640.md)
...
- **lg_current**
  Selects the current logbook database file.  This is the
                    ...
                    **lg_*** commands and admin level Tcl bindings.
                    See
                    [*lg_current*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21692.md)
                    for more information.
- **lg_ls**
  Outputs the name of the logbook that is current.
                    See
                    [*lg_ls*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21718.md)
                    for more information.
- **lg_addperson**
  Makes a new person known to the logbook. People are stored
                    ...
                    See
                    [*lg_addperson*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21731.md)
                    for more information
- **lg_lspeople**
  Lists the people that have been defined to the database.
                    See
                    [*lg_lspeople*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21954.md)
                    for more information
- **lg_mkshift**
  Creates new shifts.  A shift is a collection of people that
                    ...
                    See
                    [*lg_mkshift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21770.md)
                    for more information
- **lg_mgshift**
  ...
  See
                    [*lg_mgshift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21791.md)
                    for more information
- **lg_selshift**
  ...
  See
                    [*lg_selshift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21835.md)
                    for more information
- **lg_kvstore**
  ...
  See
                    [*lg_kvstore*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21853.md)
                    for more information
- **lg_wrnote**
  Provides a composer for notes.  Notes have an author and optionally
                    ...
                    rendered.
  See
                    [*lg_wrnote*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21899.md)
                    for more information
- **lg_browse**
  Provides a visual logbook browser.
  See
                    [*lg_browse*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21915.md)
                    for more information
- **lg_print**
  Allows all or part of a logbook to be rendered in PDF,
                    presumably for later printing.
  See
                    [*lg_print*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r21928.md)
                    for more information
