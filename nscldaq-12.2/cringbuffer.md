...
<a name="AEN29368"></a>## Name

CRingBuffer -- Low level ring buffer primitives

<a name="AEN29371"></a>## Synopsis
...
The `CRingBuffer` class include static methods
            ...
            and consumers) to transfer data.
...
<a name="AEN29602"></a>## Public member functions
...
`m_defaultDataSize` is set from a compilation constant in NSCLDAQ
        however it can be overidden by defining the environment variable
        NSCLDAQ_DEFAULT_RINGMBYTES to be an integer number of megabytes
        that will replace the compiled value of `m_defaultDataSize` effectively
...
<a name="AEN30004"></a>## Types and public data

The
            `CRingBuffer` class defines several nested
            data types:

<a name="AEN30008"></a>### CRingBuffer::ClientMode
...
<a name="AEN30028"></a>### CRingBuffer::Usage
...
<a name="AEN30075"></a>### CRingBuffer::CRingBufferPredicate
...
<a name="AEN30122"></a>**Example 1. Message filter predicate**
...
[[r29354#ringman.filter]]                    Defines a class `CMessageFilterPredicate`
                ...
                [[r29354#ringman.filter.savetype]]                    The constructor of
