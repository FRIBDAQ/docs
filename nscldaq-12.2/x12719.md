...
[← Selecting Data From a Ring Buffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x12691.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Generic ring data sinks →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x12828.md)
...
- [`CRingStateChangeItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r31162.md)
...
- [`CRingScalerItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r30665.md)
...
- [`CRingTextItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r31604.md)
...
- [`CGlomParameters`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r33191.md)
...
- [`CPhysicsEventItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r31966.md)
  Encapsulates the data taken in response to a physics
                          trigger.
- [`CRingFragmentItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r32524.md)
...
- [`CRingPhysicsEventCountItem`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r32162.md)
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [`CUnknownFragment`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r32839.md)
...
Reference information on these classes is availabe at:
                [*CDataSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r36308.md),
                [*CRingDataSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r36360.md),
                [*CFileDataSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r36439.md),
                [*CDataSourceFactory"*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r36506.md),
                and
