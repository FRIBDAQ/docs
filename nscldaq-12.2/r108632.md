...
[← logbook](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r108576.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [personinstance →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109004.md)
...
It's not possible for you to directly instantiate a logbook instance
            ...
            command.  See
            [*logbook*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r108576.md).
...
- **addPerson *lastname firstname ?salutation?***
  ...
  Person instances are described in
                       [*personinstance*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109004.md).
...
- **createShift *shiftname ?people?***
  Creates a new shift `shiftname`. If
                       ...
                       [*shiftinstance*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109059.md).
- **getShift *id***
...
- begin *number title ?remark?*
  Begins a new run with run number `number`
                       ...
                       See [*runinstance*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109107.md) for information
...
**createNote *author text images imageoffsets ?run?***
  Creates a new note and returns a note instance command.
                       ...
                       [*noteinstance*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r109207.md).
