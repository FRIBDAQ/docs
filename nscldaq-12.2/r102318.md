...
-rdolistscript *path*The `-rdolistscript` option specifies the path to a
...
-onendscript *path*The `-onendscript` option specifies the path to a
...
<a name="AEN102390"></a>## EXAMPLE

<a name="AEN102392"></a>**Example 1. 
