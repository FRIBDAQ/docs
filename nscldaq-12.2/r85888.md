...
[← 3vmusb](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r85886.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [caenchain →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r86119.md)
...
- **-supressrange** *bool*
  ...
  Often when setting up the module it is a good idea to
  		    ...
  		    the thresholds are.
- **-supressunderthreshold** *bool*
  If false when **-supressrange** is
