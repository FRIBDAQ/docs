...
[← Tcl Drivers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [XLM-72 based modlues →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x8038.md)
...
The **$DAQBIN/mg_cfgcontainers** utility allows you to
          ...
          and
          [*mg_config*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20150.md).
...
The **mg_cfgprogram** utility allows you to create new
          ...
          available at
          [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20226.md)
...
Although normally you do not need to modify the states and allowed
          ...
          **mg_stateedit**
          (Reference pages in
          [*mg_stateedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20265.md))
...
The state transitions of the manager trigger the execution of
            ...
            [*mg_seqedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20311.md).
...
The **mg_cfgEvlog** utility allows you to create, edit
          ...
          utility is at
          [*mg_cfgEvlog*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20354.md)
...
The **mg_kvedit** command allows you to create, new keys,
          ...
          **mg_kvedit** is available at
          [*mg_kvedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20480.md)
...
The experiment configuration database does, however, already provide
          ...
          [*mg_authedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20515.md)
