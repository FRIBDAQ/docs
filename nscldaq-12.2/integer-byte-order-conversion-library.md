...
# <a name="AEN15058"></a>Chapter 59. Integer byte order conversion library
...
# <a name="AEN15065"></a>59.1. Using the conversion library in your code

The conversion library is a set of C functions.  To use it,
            you will need to include the library header in your source code
            with a line like:

<a name="AEN15068"></a>**Example 59-1. Including the cvt header**
...
<a name="AEN15074"></a>**Example 59-2. Compiling a C or C++ source file that includes cvt.h**
...
<a name="AEN15078"></a>**Example 59-3. A makefile rule that builds a C++ program using the
                cvt package**
