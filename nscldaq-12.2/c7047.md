...
[← Examples (Beginning 11.2-009).](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6517.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCLDAQ Manager subsystem (new in 12.0) →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c760.md)
...
Use [*mvlcgenerate*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r24101.md) to translate a daqconfig.tcl
...
Run fribdaq-readout specifying the configuration file that mvlcgenerate
            created.     See [*fribdaq-readout*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r7094.md) to see how to use
