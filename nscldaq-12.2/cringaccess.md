...
<a name="AEN29116"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN29119"></a>## Synopsis
...
<a name="AEN29192"></a>## Public member functions
...
<a name="AEN29283"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN29287"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN29291"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
