...
- [[*Manager Configuration Database API*|c12947#sec.manager.dbapi]]
...
- [[*Manager REST client API.*|x13812]]
...
- [[*Manager User Interface API*|x14002]]
...
- The [[*The *containers* package.*|c12947#sec.manager.containers]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.mgr.mkcont.init]]
...
- [[![(2)](../images/callouts/2.gif)|c12947#ex.mgr.mkcont.auto_path]]
...
- [[![(3)](../images/callouts/3.gif)|c12947#ex.mgr.mkcont.requires]]
...
- [[![(5)](../images/callouts/5.gif)|c12947#ex.mgr.mkcont.add]]
  ...
  This matches our FRIB convention of storing built NSCLDAQ
                      ...
                      /usr/opt.
- [[![(6)](../images/callouts/6.gif)|c12947#ex.mgr.mkcont.closedb]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.usecont.activate]]
...
- [[![(2)](../images/callouts/2.gif)|c12947#ex.usecont.run]]
...
- [[![(3)](../images/callouts/3.gif)|c12947#ex.usecont.relay]]
...
- [[![(4)](../images/callouts/4.gif)|c12947#ex.usecont.deactivate]]
  Done with the container, we deactivate it.
- [[![(5)](../images/callouts/5.gif)|c12947#ex.usecont.closecfd]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.addpgm.autopath]]
  Adds the NSCLDAQ Tcl library path to the
                    `auto_path` so that the
                    programs package can be found.
- [[![(2)](../images/callouts/2.gif)|c12947#ex.addpgm.requires]]
...
- [[![(3)](../images/callouts/3.gif)|c12947#ex.addpgm.open]]
  ...
  Note that while this command
                    ...
                    [[*mg_mkconfig*|r20127]]
                    command.
- [[![(4)](../images/callouts/4.gif)|c12947#ex.addpgm.add]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#program.run.handler]]
  ...
  Note that we don't close the file descriptor.  The program
                    ...
                    file descriptor.
- [[![(2)](../images/callouts/2.gif)|c12947#program.run.run]]
...
- [[![(3)](../images/callouts/3.gif)|c12947#program.run.evloop]]
...
- [[![(4)](../images/callouts/4.gif)|c12947#program.run.kill]]
...
- What a state machine is, and the default state machine
                    ...
                    [[*State Machines, and the Default State Machine*|c12947#sec.sequence.statemachine]]
- Parts of the sequence package that
                    ...
                    [[*The State machine API*|c12947#sec.sequence.stateapi]]
- [[*The Sequence API*|c12947#sec.sequence.seqapi]]
                    sequences and the API section of the sequence
                    package that manage sequences.
- [[*The Transition API*|c12947#sec.sequence.transition]]
                    describes transitions and the parts of the API that manage them.
- [[*Miscellaneous API Entries.*|c12947#sec.sequence.misc]]
...
The three procs that support modifying the state machine are
               ...
               **newTransition** which defines a new transition
               ...
               See [[*The Sequence API*|c12947#sec.sequence.seqapi]]
...
- [[![(2)](../images/callouts/2.gif)|c12947#ex.seq.addstate]]
  Adds a new state named `PAUSED`
                       ...
                       successor state.
- [[![(3)](../images/callouts/3.gif)|c12947#ex.seq.addtransitions]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.seq.makeseq]]
  This creates a new sequence named
                    ...
                    HWINIT.
- [[![(2)](../images/callouts/2.gif)|c12947#ex.seq.addsteps]]
  This block of code adds the five steps we need to the
                    ...
                    to edit sequences.
- [[![(3)](../images/callouts/3.gif)|c12947#ex.seq.delay]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.seq.trans.completion]]
...
- [[![(2)](../images/callouts/2.gif)|c12947#ex.seq.trans.check]]
  Gets the system's current state. Note that the state
                       ...
                       exiting.
- [[![(3)](../images/callouts/3.gif)|c12947#ex.seq.trans.boot]]
  Initiates the shutdown. Note that completion
                       is specified as the end script for this transition.
- [[![(4)](../images/callouts/4.gif)|c12947#ex.seq.trans.vwait]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.seq.misc.snit]]
  ...
  The key point, as we'll see is that in order to
                       ...
                       **onOutput** and
                       **onExit**.
- [[![(2)](../images/callouts/2.gif)|c12947#ex.seq.misc.getmgr]]
  **::sequence::getCurrentTransition**
                       ...
                       empty string.
- [[![(3)](../images/callouts/3.gif)|c12947#ex.seq.misc.lseq]]
  **::sequence::listSequences**
                       ...
                       of the sequence.
- [[![(4)](../images/callouts/4.gif)|c12947#ex.seq.misc.lstep]]
...
- [[![(5)](../images/callouts/5.gif)|c12947#ex.seq.misc.monitor]]
...
- [[![(8)](../images/callouts/8.gif)|c12947#ex.seq.misc.onout]]
...
- [[![(9)](../images/callouts/9.gif)|c12947#seq.misc.orelay]]
  The **::sequence::relayOutput** command
                       sends its argument to all processes connected to its output
                       relay server.
- [[![(10)](../images/callouts/10.gif)|c12947#ex.seq.misc.onexit]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.kvstore.require]]
  This and the next line import the packages needed
                    ...
                    a database file.
- [[![(2)](../images/callouts/2.gif)|c12947#ex.kvstore.create]]
...
- [[![(3)](../images/callouts/3.gif)|c12947#ex.kvstore.modify]]
...
- [[![(4)](../images/callouts/4.gif)|c12947#ex.kvstore.listall]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.auth.require]]
...
- [[![(1)](../images/callouts/1.gif)|c12947#ex.evlog.require]]
  Requires the packages needed to make this program
                    ...
                    ::eventlog namespace.
- [[![(2)](../images/callouts/2.gif)|c12947#ex.evlog.dest]]
...
- [[![(3)](../images/callouts/3.gif)|c12947#ex.evlog.add]]
...
- [[![(4)](../images/callouts/4.gif)|c12947#ex.evlog.searchdest]]
  The next section of code will search the existing
                    ...
                    destroy it using
                    **eventlog::rm**
- [[![(5)](../images/callouts/5.gif)|c12947#ex.evlog.list]]
...
- [[![(6)](../images/callouts/6.gif)|c12947#ex.evlog.rm]]
