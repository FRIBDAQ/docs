...
# <a name="AEN10093"></a>Chapter 20. 
    XLM72 Gate Delay Control GUI

# <a name="AEN10095"></a>20.1. Introduction
...
| --- | --- | --- |
| Prev | Home | Next |
| Saving and Restoring The State of the GUI Between Sessions | Up | Setting up an XLM72 as a gate delay generator for remote control |
