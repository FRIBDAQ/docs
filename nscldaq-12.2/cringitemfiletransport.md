...
# <a name="AEN70313"></a>CRingItemFileTransport

<a name="AEN70317"></a>## Name

CRingItem FileTransport -- Transport ring items to and from files.

<a name="AEN70320"></a>## Synopsis
...
| --- | --- | --- |
| Prev | Home | Next |
| CRingBufferTransport | Up | CRingItemTransportFactory |
