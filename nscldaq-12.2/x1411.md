...
[← Manager User Interface API](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14002.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the event builder client library →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14330.md)
...
- [*Starting Readout with REST at BOOT*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1411.md#sec.mgr.bootreadout)
              describes how to setup Readout to run the REST plugin as a manager program and
              add it to
              a sequence attached to the BOOT transition.
- [*Controlling Readout From the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1411.md#sec.mgr.readoutctl)
...
**Specifying a Readout Program to the Manager. **
            The program editor [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20226.md)
...
- [*mg_startloggers*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20774.md)
...
- [*rdo_runFromKv*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20794.md)
  Asks a single readout program to set its run number to the
                    ...
                    Run control panel.
- [*rdo_titleFromKv*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20826.md)
...
- [*rdo_control*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r20858.md)
