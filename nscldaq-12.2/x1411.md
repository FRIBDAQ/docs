...
- [[*Starting Readout with REST at BOOT*|x1411#sec.mgr.bootreadout]]
              describes how to setup Readout to run the REST plugin as a manager program and
              add it to
              a sequence attached to the BOOT transition.
- [[*Controlling Readout From the Manager*|x1411#sec.mgr.readoutctl]]
...
**Specifying a Readout Program to the Manager. **
            The program editor [[*mg_cfgprogram*|r20226]]
...
[[*mg_startloggers*|r20774]]This program starts all event loggers you have defined
...
[[*rdo_runFromKv*|r20794]]Asks a single readout program to set its run number to the
...
[[*rdo_titleFromKv*|r20826]]Asks a single readout program to set it stitle to the value of
...
[[*rdo_control*|r20858]]Performs some operation on a single Readout program.
