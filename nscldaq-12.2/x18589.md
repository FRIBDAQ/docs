...
[[![(1)](../images/callouts/1.gif)|x18589#spectclapp.includes]] MySpecTclApp.cpp
                    ...
                    [[![(2)](../images/callouts/2.gif)|x18589#spectclapp.pipeline]]                        In most cases, `MySpecTclApp.cpp`
...
[[![(3)](../images/callouts/3.gif)|x18589#spectclapp.builtproc]]                        This line creates a
                        `VX2750EventBuiltEventProcessor`.
...
[[![(6)](../images/callouts/6.gif)|x18589#spectclapp.regprocessor]]                        Appends the event built event processor to the event
