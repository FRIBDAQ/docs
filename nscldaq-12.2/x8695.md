...
# <a name="AEN8695"></a>15.3. Creating the Readout program
...
## <a name="AEN8710"></a>15.3.1. Obtaining the Readout Skeleton
...
## <a name="AEN8716"></a>15.3.2. Writing the Event segment
...
<a name="AEN8732"></a>**Example 15-1. V775 Event Segment (V775EventSegment.h).**
...
[[x8695#v775_rdoh_baseinclude]]                        this header is declaring a new class
                    ...
                    [[x8695#v775_rdoh_caencard_forward]]                        The `CAENcard` class provides
...
<a name="AEN8790"></a>**Example 15-2. v775 Event Segment (V775EventSegment.cpp) - file heading**
...
[[x8695#v775_impl_read_signature]]                        The `read` method is called
...
<a name="AEN8873"></a>**Example 15-6. V775 data ready trigger header (MyTrigger.h)**
...
<a name="AEN8880"></a>**Example 15-7. V775 data ready trigger implementation (MyTrigger.cpp)**
...
## <a name="AEN8884"></a>15.3.4. Hooking everything together.
...
### <a name="v775ss_sec_addressing"></a>15.3.4.1. Addressing VME modules
...
## <a name="AEN8961"></a>15.3.5. Building and testing your Readout
