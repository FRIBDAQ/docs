...
- 76. [[Event builder client framework|c16517]]
  - 76.1. [[Application specific code for the event builder|c16517#AEN16537]]
    - 76.1.1. [[Sample ring `EVBClientApp` class.|c16517#AEN16588]]
  ...
  - 76.4. [[ringFragmentSource - a prepackaged client for ringbuffer data sources|x16783]]
    - 76.4.1. [[Writing and building timestamp extractors.|x16783#sec_tsextractors]]
...
- 81. [[Support for CAEN Nextgen DPP-PHA digitizers|c17643]]
  ...
  - 81.2. [[Getting Data|x17673]]
    - 81.2.1. [[Obtaining and modifying the skeleton|x17673#sec.rdoprogramming]]
    - 81.2.2. [[Configuring modules|x17673#sec.rdoconfig]]
  - 81.3. [[Event structure|x18481]]
  - 81.4. [[Configuring SpecTcl|x18589]]
    - 81.4.1. [[Unpacking classes|x18589#AEN18606]]
    - 81.4.2. [[Obtaining and modifying the skeleton|x18589#AEN18968]]
    - 81.4.3. [[Building the tailored SpecTcl|x18589#AEN19038]]
  - 81.5. [[Software structure|x19086]]
    - 81.5.1. [[Readout Software|x19086#AEN19090]]
    - 81.5.2. [[SpecTcl Support|x19086#AEN19144]]
    - 81.5.3. [[To Do:|x19086#AEN19177]]
- 82. [[Software Triggering NEW IN 11.4|c19187]]
  - 82.1. [[Creating classification libraries.|c19187#AEN19211]]
    - 82.1.1. [[Writing the classification class and factory function|c19187#AEN19220]]
    - 82.1.2. [[Building the classification shared library.|c19187#AEN19314]]
  - 82.2. [[The SoftwareTrigger and EventFilter programs|x19329]]
    - 82.2.1. [[SoftwareTrigger - classifying events|x19329#AEN19336]]
    - 82.2.2. [[EventFilter - accepting events based on classification|x19329#AEN19394]]
