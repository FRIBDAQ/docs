...
[← ScalerDisplay](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r22579.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [eventlog →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r23019.md)
...
The
        **dumper**
        ...
        [Dumping events from ringbuffer or from file](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c11188.md).
...
- `--nscldaq-version` *10 | 11 | 12*
  Specifies the version of NSCLDAQ the event file was written in.  
                      Defaults to 12
- `--detail` *headers | bodies | fragments*
  Controls the amount of information dumper displays for each ring item in the
