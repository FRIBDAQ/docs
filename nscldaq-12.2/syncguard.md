...
<a name="AEN52741"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN52744"></a>## Synopsis
...
<a name="AEN52786"></a>## Public member functions
...
<a name="AEN52824"></a>`void sync_self(void);`
...
<a name="AEN52831"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN52839"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN52851"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN52857"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN52867"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN52897"></a>`void sync_global_end(void);`
