...
### <a name="AEN2721"></a>5.9.1.1. Driver requirements

A Slow controls device driver is a class that is derived from
          the 
          [[r97042]] abstract base class.
...
The [[r97042]] class is an abstract
...
#### <a name="AEN2849"></a>5.9.1.1.1. The driver
...
<a name="AEN2852"></a>**Example 5-14. Control driver headers**
...
<a name="AEN2871"></a>**Example 5-15. Control driver class definition**
...
<a name="AEN2878"></a>**Example 5-16. Control driver constructor**
...
<a name="AEN2882"></a>**Example 5-17. Control driver `onAttach` method**
...
[[x2682#ctldriver-onattach-saveconfig]]		  The base class (`CControlHardware`) 
...
<a name="AEN2905"></a>**Example 5-18. Control driver `Update`**
...
<a name="AEN2917"></a>**Example 5-19. Control driver `Set` method.**
...
<a name="AEN2967"></a>**Example 5-20. Control driver `Get` method**
...
<a name="AEN3001"></a>**Example 5-21. Control driver `clone` method**
...
#### <a name="AEN3012"></a>5.9.1.1.2. The creator
...
<a name="AEN3015"></a>**Example 5-22. Control driver creator**
...
<a name="AEN3050"></a>**Example 5-23. Control driver initialization**
...
[[x2682#ctldriver-init-cbinding]]		    The Tcl interpreter needs to be able to compute
		  ...
		  [[x2682#ctldriver-init-factget]]		    The main work of the intitialization function is to register
		    ...
		    of the factory.
		  [[x2682#ctldriver-init-creator]]		    Registers the new creator object associating it with the
		    module type mydriver
[[x2682#ctldriver-init-status]]		    Returns a normal status value.

#### <a name="AEN3094"></a>5.9.1.1.4. Building the driver and using it.
...
<a name="AEN3162"></a>**Example 5-24. Control drivers - structure of a Tcl driver**
...
### <a name="AEN3209"></a>5.9.2.1. Initialize

The full implementation of the `Initialize` is shown
	  below:

<a name="AEN3213"></a>**Example 5-25. Tcl control driver `Initialize` method**
...
### <a name="AEN3242"></a>5.9.2.3. The Set method
...
<a name="AEN3246"></a>**Example 5-27. Tcl control driver `Set` method**
...
### <a name="AEN3266"></a>5.9.2.4. The Get method
...
<a name="AEN3269"></a>**Example 5-28. Tcl control driver `Get` method**
...
### <a name="AEN3284"></a>5.9.2.5. The addMonitorList method

Since we are not using monitor lists, this method is trivial:

<a name="AEN3287"></a>**Example 5-29. Tcl control drer `addMonitorList` method**
...
### <a name="AEN3294"></a>5.9.2.6. The processMonitorList method
...
<a name="AEN3298"></a>**Example 5-30. Tcl control driver `processMonitorList` method**
...
### <a name="AEN3302"></a>5.9.2.7. The getMonitoredData method
...
<a name="AEN3310"></a>**Example 5-31. Tcl control driver `getMonitoredData` method**
...
### <a name="AEN3314"></a>5.9.2.8. Validating the command options
...
<a name="AEN3323"></a>**Example 5-32. Tcl control driver validation**
