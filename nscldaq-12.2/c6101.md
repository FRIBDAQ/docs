...
[← ReadoutGUI & ReadoutShell](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c5223.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBLite -  light event building →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c6249.md)
...
The client programs that submit data to the server are built using the
      [event builder client
        framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c16517.md). In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [ringFragmentSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x16783.md) program. This
