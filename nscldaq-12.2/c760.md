...
[← mvlcgenerate and using the Mesytec MVLC VME controller](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c7047.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [A Simple VMUSBReadout Experiment Tutorial →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c8052.md)
...
- [*Introduction*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/c760.md#sec.mgr.intro)
          Provides introductory information that's useful for understanding the
          remainder of the presentation.
- [*Managed Objects and Configuration*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x799.md)
            Describes the objects the DAQ manager controls and how to configure
            them.
- [*Running an Experiment With The Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x1228.md)
