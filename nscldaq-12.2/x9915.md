...
# <a name="AEN9915"></a>17.2. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN9925"></a>**Figure 17-1. The MCFD16Control Graphical User Interface for USB**
...
| --- | --- | --- |
| Prev | Home | Next |
| Mesytec MCFD-16 Controls | Up | Starting the GUI for the RC-bus through an MxDC device |
