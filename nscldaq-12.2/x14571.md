...
[← Callbacks](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14529.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using TclRingBuffer in event driven software →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14613.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14571.md#tclring_attach)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14571.md#tclring_get)
  ...
  The next matching ring items is translated to a dict (see
  	  ...
  	  command.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x14571.md#tclring_detach)
  Once processing is done, the ring is detached.  Once detached,
  	  it is no longer available for use in a **ring get**
  	  command.

For reference information see:
      [*TclRingBuffer*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r110686.md)
