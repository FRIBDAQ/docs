...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r41723.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r42906.md)
...
<a name="AEN42667"></a>## Public member functions





- <a name="AEN42673"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN42685"></a>`bool Xtest(void);const`
...
- <a name="AEN42697"></a>`bool Qtest(void);const`
...
- <a name="AEN42714"></a>`bool TimedOut(void);const`
...
- <a name="AEN42726"></a>`bool BranchDemand(void);const`
...
- <a name="AEN42738"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN42752"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN42765"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN42779"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN42794"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN42809"></a>`bool IT4(void);const`
...
- <a name="AEN42823"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN42834"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN42847"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN42863"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN42874"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN42885"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN42895"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN42899"></a>**Example 1. Initializing branch 0**
