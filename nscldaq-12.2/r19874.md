...
<a name="AEN19888"></a>## Name

ringbuffer -- Manage ring buffers.

<a name="AEN19891"></a>## Synopsis
...
<a name="AEN19911"></a>## ENSEMBLE COMMANDS
...
If the environment variable NSCLDAQ_DEFAULT_RINGMBYTES is defined and
            can be decoded as an integer, the value sets the default megabytes of ring buffer data size.
            `--datasize` can be used to explicitly set the data size.
...
<a name="AEN19973"></a>**Example 1. Sample output from **ringbuffer status****
