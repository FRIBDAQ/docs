...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r83759.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [start →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r83946.md)
...
Each data source managed by a data source provider is specified
            ...
            returns a Tcl
            [dict](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/dict.md) that describes the set of parameters
            expected.
