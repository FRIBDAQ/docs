...
| Prev | Chapter 63. Shared memory | Next |


---

# <a name="shm_compile"></a>63.2. Compiling/Linking your software with the shared memory API
...
<a name="AEN15672"></a>**Example 63-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN15676"></a>**Example 63-3. Linking C++ object files that use the
            daqshm library**
