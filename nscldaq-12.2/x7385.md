...
[← BUILDING mesytec-mvlc WITH THE OPTIONAL fribdaq-readout PROGRAM](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7340.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Tcl Drivers →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7676.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlc-sample-oa-saveconfig)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlc-sample-oa-marker)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlc-sample-oa-resetloc)
  This line, defines an option `-resetloc` that, once more, is an integer
                  ...
                  address.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#sample-oa-resetval)
  This call to another overload of `addIntegerParameter` creates
                  ...
                  device.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlc-sample-oa-endrun)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcgen-sd-init-cbinding)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcgen-sd-init-parserinstance)
  We will need the configuration parser (the object interpreting the configuration
                          ...
                          it.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcgen-sd-init-interpencap)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcgen-sd-init-addext)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcgen-sd-init-success)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcget-sd-use-load)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcgen-sd-use-createconfig)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x7385.md#mvlcget-sd-use-stack)
