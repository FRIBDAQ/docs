...
# <a name="AEN9005"></a>15.4. Creating the tailored SpecTcl
...
## <a name="AEN9013"></a>15.4.1. Decoding raw TDC data
...
### <a name="AEN9036"></a>15.4.1.2. Creating the raw unpacker class

Here is the header for our raw unpacker
                    (event processor) pipeline stage:

<a name="AEN9039"></a>**Example 15-9. Raw TDC unpacker (RawUnpacker.h)**
...
<a name="AEN9071"></a>**Example 15-10. v775 raw unpacker implementation includes and defs (RawUnpacker.cpp)**
...
<a name="AEN9093"></a>**Example 15-11. V775 raw unpacker - getLong utility (RawUnpacker.cpp)**
...
<a name="AEN9099"></a>**Example 15-12. V775 raw unpacker object constructor/destructor (RawUnpacker.cpp)**
...
[[x9005#v775_rawimpl_constructor]]                            The constructor is required to initialize the reference
                            ...
                            t.00 ... t.31.
                        [[x9005#v775_rawimpl_destructor]]                            If an object is ever destroyed, its tree parameter
                            array musb be destroyed as well to prevent
                            memory leaks.

<a name="AEN9112"></a>**Example 15-13. v75 raw unpacker unpacking events (RawUnpacker.cpp)**
...
[[x9005#v775_rawimpl_funtorsignature]]                            The `operator()` method
...
[[x9005#v775_rawimpl_storeparam]]                            Tree parameter array objects mimic arrays to the
                        ...
                        [[x9005#v775_rawimple_trailer]]                            The data words from the TDC should be followed by
                            a trailer.  This code asserts that this is the
                            case.

### <a name="AEN9200"></a>15.4.1.3. Adding the unpacker to the analysis pipeline
...
### <a name="AEN9222"></a>15.4.1.4. Creating raw time spectra
...
<a name="AEN9231"></a>**Example 15-14. Defining raw Time spectra the hard way.**
...
### <a name="AEN9304"></a>15.4.1.5. Building and testing what we have so far.
...
## <a name="AEN9342"></a>15.4.2. Producing parameters computed from the raw data
...
<a name="AEN9355"></a>**Example 15-15. Header for time difference event processor (Tdiff.h)**
...
<a name="AEN9368"></a>**Example 15-16. CTdiff implementation (Tdiff.cpp)**
