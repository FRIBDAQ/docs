...
# <a name="chapter.sequencer"></a>Chapter 38. Sequencing runs
...
# <a name="AEN11498"></a>38.1. Configuring the sequencer.
...
<a name="AEN11543"></a>**Example 38-1. Loading the sequencer package**
...
| --- | --- | --- |
| Prev | Home | Next |
| xlmload firmware loader for XLM modules via VM-USB controllers. | Up | Using the sequencer. |
