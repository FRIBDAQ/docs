...
[← Byte order signatures and conversion blocks](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15082.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the library into an application. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x15248.md)
...
Functions are provided that allow you to convert shorts and longs
            ...
            in the
            [cvt reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r52185.md).
            Briefly however:
