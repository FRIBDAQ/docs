...
# <a name="chapter.tclserver"></a>Chapter 30. The tcl server application
...
<a name="AEN11297"></a>**Example 30-1. Using **serverauth** to authorize a node**
...
# <a name="AEN11301"></a>30.1. Tcl server package
