...
[← Software structure](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x19086.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The SoftwareTrigger and EventFilter programs →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x19329.md)
...
If a user wants to write their own module for the slow-controls subsystem,
      ...
      [*Extending the slow controls subsystem*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/x2682.md).
...
There are numerous slow-controls modules availabe for use with the
        Module command (see [Module(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r99080.md)). Because of its
...
- `CVMUSBReadoutList`
  Instances of this class represent lists of VME operations you want
                to perform via the server.  See [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r93662.md) for reference
                information.
- `CVMUSBRemote`
  ...
  See [*CVMUSBRemote*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.2/r94567.md)
