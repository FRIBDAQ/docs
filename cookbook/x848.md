...
[← The code](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x78.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Introduction →](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c13.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.monvars)
  This section of code creates **monvar**
                          ...
                          in
                          [*The SBS readout program.*](https://github.com/FRIBDAQ/docs/tree/main/cookbook/c665.md#sec.epicssbs)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.pkgpath)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.tclserverpkg)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.tclserverstart)
  ...
  Now we can skip back in the code to look at the scripts
                          ...
                          `-onerror`
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.errorhandler)
...
- `ch`
  The channel open on the socket through which
...
- `cmd`
  The full text of the command that
                                      caused the error.
- `msg`
  The error message describing the error
                                      the command threw.

- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.connectionhandler)
...
- `sock`
  The socket that is connected with the
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.process)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.readouthost)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.here)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.onstart)
  `OnStart` is invoked when the
                              ...
                              instance.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x848.md#epics.vmusb.kill)
  This line spawns off a process to kill off any instances
                              ...
                              processes.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/c665.md#epics.sbs.start)
...
<a name="AEN1044"></a>![](https://github.com/FRIBDAQ/docs/tree/main/images/controlpush-vmusbreadout.png)
