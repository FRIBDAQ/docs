...
- [[x319#sec.process.main]]
                          describes the main program.
- [[x319#sec.process.class]]
...
[[x319#process.scalertsget]] `getTimestamp`, where
                        ...
                        [[x319#process.scalertformat]] `ctime` is defined in the
                            ctime header and produces a
                            formatted string representation of the
                            pointer to a time_t it is passed.
                        [[x319#process.dumpscalers]] `getScalerCount` returns
