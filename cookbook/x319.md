...
- [[*The *process.cpp* file*|x319#sec.process.main]]
                          describes the main program.
- [[*The *CRingITemProcessor* class*|x319#sec.process.class]]
...
[[![(1)](../images/callouts/1.gif)|x319#process.rifactheader]]                            This header defines the ring item factory class.
                        ...
                        [[![(4)](../images/callouts/4.gif)|x319#process.processorprototype]]                            We now pass a `CRingItemProcessor`
...
[[![(1)](../images/callouts/1.gif)|x319#process.ripinstantiate]]                            This instantiates the
...
[[![(1)](../images/callouts/1.gif)|x319#process.usefactory]]                            This line shows the use of the ring item factory to
                        ...
                        [[![(4)](../images/callouts/4.gif)|x319#process.periodicscaler]]                            This case label indicates we're processing periodic
                             scaler ring items.
                        [[![(5)](../images/callouts/5.gif)|x319#process.scalerdyncast]]                            Now that we know the actual ring item type, we can
...
[[![(3)](../images/callouts/3.gif)|x319#process.header.processors]]                            THese definitions define the methods that
...
[[![(1)](../images/callouts/1.gif)|x319#processor.includehdr]]                            In general, if I implement a class, I include the
                            ...
                            stands by itself.
                        [[![(2)](../images/callouts/2.gif)|x319#processor.concreteheaders]]                            Recall that I did not include the concrete subclass
...
[[![(3)](../images/callouts/3.gif)|x319#processor.glomtspolicymap]]                            This map provides a lookup table between the symbolic
...
[[![(1)](../images/callouts/1.gif)|x319#process.scalertsget]] `getTimestamp`, where
                        ...
                        [[![(2)](../images/callouts/2.gif)|x319#process.scalertformat]] `ctime` is defined in the
                            ctime header and produces a
                            formatted string representation of the
                            pointer to a time_t it is passed.
                        [[![(3)](../images/callouts/3.gif)|x319#process.dumpscalers]] `getScalerCount` returns
...
[[![(1)](../images/callouts/1.gif)|x319#process.rstypename]]                            The `CRingItem` class has
...
[[![(1)](../images/callouts/1.gif)|x319#process.glombuilding]]                            The method `isBuilding`
                        ...
                        [[![(2)](../images/callouts/2.gif)|x319#process.glomticks]]                            In build mode, `coincidenceTicks`
                        ...
                        [[![(3)](../images/callouts/3.gif)|x319#process.glompolicy]]                            In build mode, Glom assigns a timestamp to the
