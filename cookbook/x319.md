...
[← The code](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x240.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Annotated Code. →](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x322.md)
...
- [*The *process.cpp* file*](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#sec.process.main)
                          describes the main program.
- [*The *CRingITemProcessor* class*](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#sec.process.class)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.rifactheader)
  This header defines the ring item factory class.
                              We'll see it in use when we look at the
                              implementation of the
                              `processRingItem`
                              static function.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.ringitemheaders)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.processorprototype)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.ripinstantiate)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.usefactory)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#processfactitemsautofree)
  Once again, we see the use of the
                              ...
                              `processRingItem` function
                              exits.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.typedependent)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.periodicscaler)
  This case label indicates we're processing periodic
                               scaler ring items.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.scalerdyncast)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.processscaler)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.unrecognized)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.header.guard)
  ...
  The include guard name shown is the convention followed
                              ...
                              projects.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.header.forward)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.header.processors)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#processor.includehdr)
  In general, if I implement a class, I include the
                              ...
                              stands by itself.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#processor.concreteheaders)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#processor.glomtspolicymap)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.scalertsget)
  `getTimestamp`, where
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.scalertformat)
  `ctime` is defined in the
                              ctime header and produces a
                              formatted string representation of the
                              pointer to a time_t it is passed.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.dumpscalers)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.rstypename)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.rsrrunnum)
  All state change items have a run number.  The
                              `getRunNumber` method
                              for `CRingStateChangeItem` returns
                              that run number.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.rstitle)
  Similarly, all state change items have a title
                              an `getTitle` returns
                              that as a `std::string`.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.rseltime)
...
<a name="AEN542"></a>**Example 4-7. `CRingItemProcessor`::`processGlomParams`**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.glombuilding)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.glomticks)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md#process.glompolicy)
