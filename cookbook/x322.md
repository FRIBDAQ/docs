...
[[![(1)](../images/callouts/1.gif)|x322#process.scalertsget]] `getTimestamp`, where
                        ...
                        [[![(2)](../images/callouts/2.gif)|x322#process.scalertformat]] `ctime` is defined in the
                            ctime header and produces a
                            formatted string representation of the
                            pointer to a time_t it is passed.
                        [[![(3)](../images/callouts/3.gif)|x322#process.dumpscalers]] `getScalerCount` returns
