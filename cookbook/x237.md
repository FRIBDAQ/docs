...
[← The NSCLDAQ cookbook](https://github.com/FRIBDAQ/docs/tree/main/cookbook/index.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The code →](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x240.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.datasinkheader)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.datasinkfactheader)
  Similarly, CDataSinkFactory.h defines the data sink factory that produces data sinks given a URI.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.processproto)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.need3args)
  This time we need three command line words.  The program name, the data source URI and the data sink URI.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.codemakesink)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.codeprocesscall)
