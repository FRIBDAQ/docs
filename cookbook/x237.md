...
| Prev | Chapter 3. Writing ring items to a data sink | Next |
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.datasinkheader]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.datasinkfactheader]]
  Similarly, CDataSinkFactory.h defines the data sink factory that produces data sinks given a URI.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.processproto]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.need3args]]
  This time we need three command line words.  The program name, the data source URI and the data sink URI.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.codemakesink]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/cookbook/x237.md#write.codeprocesscall]]
...
| --- | --- | --- |
| Prev | Home | Next |
| Writing ring items to a data sink | Up | Peforming type independent processing |
