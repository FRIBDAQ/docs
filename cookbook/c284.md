...
[← Writing ring items to a data sink](https://github.com/FRIBDAQ/docs/tree/main/cookbook/c203.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Peforming type independent processing →](https://github.com/FRIBDAQ/docs/tree/main/cookbook/c287.md)
...
As usual this chapter is divided into two sections:
            [*Background*](https://github.com/FRIBDAQ/docs/tree/main/cookbook/c284.md#sec.process.background) which provides expository background information and
            [*Annotated Code.*](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md) which annotates the actual code.
...
The actual code and Makefile are installed in
            ...
            In [*Annotated Code.*](https://github.com/FRIBDAQ/docs/tree/main/cookbook/x319.md) we'll also describe a few tactics that can be used to adopt this example to your specific needs.
