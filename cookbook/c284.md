...
As usual this chapter is divided into two sections:
            [[c284#sec.process.background]] which provides expository background information and
            [[x319]] which annotates the actual code.
...
The actual code and Makefile are installed in
            ...
            In [[x319]] we'll also describe a few tactics that can be used to adopt this example to your specific needs.
