...
[← XLM72 Gate Delay Control GUI](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c6734.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Command line access to CAMAC via the SBS interface →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c6833.md)
