...
[← begin](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55167.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [resume →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55231.md)
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55316.md) specifies  the
