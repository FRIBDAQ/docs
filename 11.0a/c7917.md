...
[← The Tcl ring package](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7902.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client API →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c8627.md)
...
In the user guide section on [data
      formats](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c183.md), the format of all the ring items were explained in
