...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c6949.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAEN V812 Constant Fraction Discriminator →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7002.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r15227.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r15270.md).
            section.
...
TclServer is also available as a package that can be incorporated
                ...
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r68850.md)
