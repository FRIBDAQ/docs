...
<a name="AEN35050"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35053"></a>## Synopsis
...
<a name="AEN35095"></a>## Public member functions
...
<a name="AEN35133"></a>`void sync_self(void);`
...
<a name="AEN35140"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35148"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35160"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35166"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35176"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35206"></a>`void sync_global_end(void);`
