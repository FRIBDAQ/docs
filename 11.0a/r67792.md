...
[← slowControlsPrompter](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r67690.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [gdgwidget →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r68010.md)
...
Provides a class that can be instantiated to control a Wiener/JTec
        ...
        [*controlClient*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r67547.md)
...
The object is intended to cooperate with a
        [*gdgwidget*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r68010.md)
