...
[← Starting the GUI for USB communication](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x6576.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and restoring state →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x6618.md)
...
5. The user will then be presented with the following display and should
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/11.0a/figures/MCFD16Control-MXDCRCBusHowTo-0.png)
