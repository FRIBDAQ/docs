...
[← EVBC::flush](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r51996.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startS800Source →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r52071.md)
...
Starts a fragment source that gets is data from a ring buffer.  For
            ...
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x10573.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x10573.md#sec_tsextractors)
