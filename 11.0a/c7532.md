...
[← Epics Channel logging](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7517.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Service Port Manager. →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7683.md)
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [Service Port Manager](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7683.md)
            chapter.
...
Each element of the list reports on the usage of a single ring.
            ...
            [Tcl ring package's ringbuffer
                usage](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r16528.md) command.
