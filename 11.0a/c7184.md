...
[← VM/CCUSB Firmware loaders](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7164.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The ringselector application →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7274.md)
...
For a full description of the sequencer, see its
        [reference manual page.](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r70886.md).
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7184.md#chapter.sequencer.env)
  The global `env` array contains a 
  		 ...
  		 variable.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7184.md#chapter.sequencer.join)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7184.md#chapter.sequencer.path)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7184.md#chapter.sequencer.require)
