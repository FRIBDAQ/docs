...
[← Building the filter program](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x11330.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [How does it work? →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x11408.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-saveconfig)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-baseparam)
  Most if not all VME modules must be addressed relative
                          ...
                          imposed.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-idparam)
  ...
  Constraint checking comes from the
                          ...
                          See [CConfigurableObject(3vmusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r62995.md)
...
See [CVMUSB(3vmusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r58881.md) and
                [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r60873.md) for reference
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-getid)
  The `-id` option is an integer
                          in the range [0 .. 0xffff].
                          This line
                          fetches its current value from the configuration
                          database.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-addmarker)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-ccall)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-initname)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-package)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-adddriver)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-initsuccess)
  The **load** or
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-dtemplate-endccall)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-auto-path)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-itclpkg)
  This loads the Incr-Tcl extension.  Incr-Tcl provides
                          object oriented constructs for Tcl.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-cvmusbpkg)
  The cvmusb package is the
                          SWIG wrapping of the `CVMUSB`
                          C++ class.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-cvmusbrlistpkg)
  The cvmusbreadoutlist package
                          is the SWIG wrapping of the
                          `CVMUSBReadoutList` C++ class.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-class)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-option)
...
marker-itcl obj -value 0x1234;  # Set value to 0x1234 at construction time.
  ...
  ```
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-constructor)
  ...
  This constructor does nothing except allow the use
                          ...
                          is constructed.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-initialize)
  `Initialize` implements
                          ...
                          *pointer* that represents the address
                          ...
                          driver methods.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-wrapvmusb)
...
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-vmusbreadled)
  Invokes the `readLEDSource`
                          ...
                          source of the LED.
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-vmusbwriteled)
...
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-addrdolist)
  ...
  The first command in this method wraps the
                          ...
                          the list.
- [**(14)**](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-itcldrv-addmarker)
...
In general you will need to look at the reference information
                ...
                [CVMUSB](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r64518.md)
[CVMUSBReadoutList](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r65263.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-apath)
  In order to load the packages that wrap the
                          ...
                          your installation.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-snitpkg)
  This line loads the
                          snit package.  Snit provides definitions
                          of the commands that make up the Snit is Not
                          Incr Tcl package.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-cvmusbpkg)
  Loads the cvmusb package.  This package
                          provides the Tcl wrapping of the
                          `CVMUSB` class.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-cvmusbreadoutlist)
  Loads the cvmusbreadoutlist package.
                          This package provides the Tcl wrapping of the
                          `CVMUSBReadoutList`.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-type)
  ...
  This line creates a new snit::type named
                          ...
                          included in a stack.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-option)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-constructor)
  **constructor** methods are called
  ...
  The call to **configurelist** processes
                          ...
                          Tk widgets).
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-init)
  ...
  The `driverPtr` is a
                          *SWIG Pointer*.  Swig pointers
                          ...
                          to a C++ object.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-wrapcvmusb)
  This line creates a new SWIG object that wraps the
                          C++ object represented by `driverPtr`.
                          The resulting object is called `v`
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-readleds)
  ...
  The arithmetic that follows sets the field responsible
                          ...
                          yellow LED lit.
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-writelds)
  Once the new value of the LED source register is
                          computed this line writes then ew value back into the
                          LED source register.
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-addreadoutlist)
...
- [**(13)**](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-wrapreadoutlist)
  Wraps the `list` parameter in a
                          SWIG object named `l` in a mannner
                          analagous to what was done in `Initialize`
- [**(14)**](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x1137.md#vmusb-snit-addmarker)
