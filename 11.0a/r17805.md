...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r17805.md#scaler.allpred)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r17805.md#scaler.get)
  Gets the next item from the ring, regardless of type.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r17805.md#scaler.isscaler)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r17805.md#scaler.construct)
  If the item is a scaler item, it is converted into a
                      `CScalerItem`
                      and processed.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r17805.md#scaler.delete)
