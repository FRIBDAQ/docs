...
[← Byte order signatures and conversion blocks](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x9402.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the library into an application. →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x9560.md)
...
Functions are provided that allow you to convert shorts and longs
            ...
            in the
            [cvt reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r34628.md).
            Briefly however:
