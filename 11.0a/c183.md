...
[← The actions library](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c11333.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCUSBReadout →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c2287.md)
...
Reference material is provided in in the 3daq section that describes the
    ...
    the data format can be is provided [here](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7917.md).
