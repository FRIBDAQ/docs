...
[← DataSourceManager](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r52801.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Diagnostics →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53274.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_toplevel)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_ctlarea)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_form1)
  This makes some rather silly labels and inputs that
                          comprise the part of the dialog (control area) that
                          the user interacts with.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_form2)
  The **grid** geometry manager is then
                          used to arrange the labels and input controls into
                          `f`.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_display)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_modal)
  ...
  The action peformed by the user to complete his or her
                          ...
                          `result`
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_ok)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_cancel)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r53051.md#dlgwrapper_destroy)
