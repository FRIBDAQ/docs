...
# <a name="AEN6593"></a>12.3. Starting the GUI for the RC-bus through an MxDC device
...
5. The user will then be presented with the following display and should
   ...
   ![](figures/MCFD16Control-MXDCRCBusHowTo-0.png)
...
| --- | --- | --- |
| Prev | Home | Next |
| Starting the GUI for USB communication | Up | Saving and restoring state |
