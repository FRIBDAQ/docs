...
[← parameters](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55056.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [check →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55108.md)
...
Starts a data source for the provider.   The
            ...
            [dict](https://github.com/FRIBDAQ/docs/tree/main/11.0a/dict.md).  The keys for the dict are the
