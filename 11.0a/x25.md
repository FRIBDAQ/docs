...
[← Writing device support software](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x2376.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Tcl device driver support →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/x2537.md)
...
With any experiment, it is paramount to understand quickly whether the
      ...
      inspection. The most basic and useful is the [dumper](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c6885.md) program, which provides a textual
      ...
      are higher level tools though such as the [ScalerDisplay](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c4573.md) program. The
...
The fact that ring buffers lie on either side of each process allows the
      ...
      information. Other tools like the [ringbuffer](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r11812.md) program provide
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.0a/figures/intro-data-flow-diagram-diagnostics.png)
