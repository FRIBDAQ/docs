...
[← N568B CAENnet shaping amplifier](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7039.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cratelocator →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c7109.md)
...
- [iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r69553.md)
  Provides a tcl package forlow level support fo the
                      modules including
                      the ability to program the base address of the module.
- [VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r70057.md)
  ...
  This separation allows you to build custom applications
                      ...
                      elements.
- [vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r15556.md)
