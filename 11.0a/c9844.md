...
[← Access control and security](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c9711.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Shared memory →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c9902.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c9844.md#chapter.uri.usage)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c9844.md#chapter.uri.try)
  The `URL` constructor parses the
                  ...
                  block.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c9844.md#chapter.uri.pieces)
  This section of code takes the parsed URI and demonstrates
                  how to pull the elements of the URI out and print them.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/c9844.md#chapter.uri.catch)
  This code catches errors that may be thrown by the URI
                  parse.  The reason for the error is printed out.
                  For more information see
                  the
                  [`CURIFormatException` reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r43024.md).
