...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r23754.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CADC2530 →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r24063.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r23754.md)).
        Since it  is  derived
       from
       `CException`,
...
[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r68750.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r23754.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r15116.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r42460.md)
