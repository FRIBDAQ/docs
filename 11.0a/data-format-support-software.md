...
# <a name="chapter.ringformat-dev"></a>Chapter 40. Data Format Support Software

In the user guide section on [[c183]], the format of all the ring items were explained in
...
# <a name="AEN7932"></a>40.1. The basic data formats
...
<a name="AEN8018"></a>`pDataFormatformatDataFormat
          (void);`


<a name="AEN8024"></a>`pGlomParameters
...
<a name="AEN8038"></a>`pEventBuilderFragment
            formatEVBFragment
          (
            uint64_t timestamp
          , 
...
<a name="AEN8058"></a>`pEventBuilderFragment
...
<a name="AEN8078"></a>` pPhysicsEventItem
...
<a name="AEN8098"></a>` pPhysicsEventCountItem
...
<a name="AEN8191"></a>` pStateChangeItem
...
<a name="AEN8223"></a>` void* bodyPointer
          (
            pRingItem pItem
          );`
...
## <a name="AEN8232"></a>40.1.1. State Change Items
...
## <a name="AEN8272"></a>40.1.2. Text List Items
...
## <a name="AEN8321"></a>40.1.3. Scaler Items
...
## <a name="AEN8354"></a>40.1.4. Event Data Items
...
## <a name="AEN8361"></a>40.1.5. Event count items
