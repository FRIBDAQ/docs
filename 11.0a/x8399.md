...
[[`CRingItem`|r17338]]Base class for all the ring data item format classes.
...
[[`CRingStateChangeItem`|r18241]]Represents a state change item.  Given a reference to
...
[[`CRingScalerItem`|r17805]]Represents a state change item.  Given a reference to a
...
[[`CRingTextItem`|r18636]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[`CGlomParameters`|r20091]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[`CPhysicsEventItem`|r18952]]Encapsulates the data taken in response to a physics
                        trigger.

[[`CRingFragmentItem`|r19455]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[`CRingPhysicsEventCountItem`|r19138]]Encapsulates an item that gives information about the
...
[[`CUnknownFragment`|r19760]]Encapsulates an event fragment produced by the event
...
Reference information on these classes is availabe at:
                [[*CDataSource*|r22633]],
                [[*CRingDataSource*|r22675]],
                [[*CFileDataSource*|r22744]],
                [[*CDataSourceFactory"*|r22801]],
                and
                [[*CRingItemFactory*|r22858]].
