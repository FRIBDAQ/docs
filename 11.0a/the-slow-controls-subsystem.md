...
# <a name="AEN858"></a>4.4. The Slow-Controls Subsystem
...
<a name="AEN870"></a>**Example 4-2. A Sample Controls Configuration**
...
## <a name="AEN879"></a>4.4.1. Using Remote Procedure Calls To Execute Stacks

There are numerous slow-controls modules availabe for use with the
        Module command (see [[r65753]]). Because of its
...
`CVMUSBReadoutList`Instances of this class represent lists of VME operations you want
              to perform via the server.  See [[r60873]] for reference
              information.
