...
<a name="AEN21727"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN21730"></a>## Synopsis
...
<a name="AEN21732"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN21743"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN21777"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN21797"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN21843"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN21849"></a>`pGlomParameters
...
<a name="AEN21863"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN21883"></a>`pEventBuilderFragment
...
<a name="AEN21903"></a>` pPhysicsEventItem
...
<a name="AEN21923"></a>` pPhysicsEventCountItem
...
<a name="AEN22016"></a>` pStateChangeItem
...
<a name="AEN22048"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22056"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22062"></a>## DESCRIPTION
...
<a name="AEN22070"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN22091"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN22146"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN22182"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN22275"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN22291"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN22318"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22350"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22376"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22405"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22553"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22605"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN22616"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
