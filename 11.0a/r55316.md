...
[← init](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55289.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SSHPipe →](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55363.md)
...
- runsHaveTitles
  If true the provider will honor the
                              ...
                              [*begin*](https://github.com/FRIBDAQ/docs/tree/main/11.0a/r55167.md)
                              command.
- runsHaveNumbers
