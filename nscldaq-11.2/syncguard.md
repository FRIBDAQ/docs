...
<a name="AEN36556"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN36559"></a>## Synopsis
...
<a name="AEN36601"></a>## Public member functions
...
<a name="AEN36639"></a>`void sync_self(void);`
...
<a name="AEN36646"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN36654"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN36666"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN36672"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN36682"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN36712"></a>`void sync_global_end(void);`
