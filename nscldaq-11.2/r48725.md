...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r48604.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r51489.md)
...
<a name="AEN48739"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN48742"></a>## Synopsis

```
CCCUSB
```

<a name="AEN49724"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r51974.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r51974.md) for
...
<a name="AEN50295"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN50299"></a>### Action Register
...
<a name="AEN50342"></a>### Firmware Register
...
<a name="AEN50394"></a>### Global Mode Register
...
<a name="AEN50527"></a>### Delay Register
...
<a name="AEN50560"></a>### Scaler Control register
...
<a name="AEN50593"></a>### LED Source Register
...
<a name="AEN50845"></a>### Output source selection register.
...
<a name="AEN51014"></a>### Device source register
...
<a name="AEN51367"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN51428"></a>### Transfer setup register
