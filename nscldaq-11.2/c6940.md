...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c6914.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c7004.md)
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r12936.md).
...
<a name="AEN6954"></a>**Example 19-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN6958"></a>**Example 19-2. Dumping data from the event file segment
...
# <a name="AEN6968"></a>19.1. Item dump formats and examples
...
<a name="AEN6971"></a>**Example 19-3. State Transition items**
...
<a name="AEN6976"></a>**Example 19-4. Text List items**
...
<a name="AEN6981"></a>**Example 19-5. Incremental Scalers dump**
...
<a name="AEN6987"></a>**Example 19-6. Event count items**
...
<a name="AEN6993"></a>**Example 19-7. Physics Event items**
...
<a name="AEN6998"></a>**Example 19-8. Unknown item types**
