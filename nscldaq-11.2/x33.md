...
[← The Ring Item Types](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x314.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing Tcl slow controls device drivers →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x3324.md)
...
There are a number of frameworks for building C++ applications. First
      there is the [SBS Readout Framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c10942.md),
      ...
      data format. To facilitate the design of filter programs, the [Filter framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c11466.md) exists. It handles the
