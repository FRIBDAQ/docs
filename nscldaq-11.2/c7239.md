...
- [[![(1)](../images/callouts/1.gif)|c7239#chapter.sequencer.env]]
  The global `env` array contains a 
  		 ...
  		 variable.
- [[![(2)](../images/callouts/2.gif)|c7239#chapter.sequencer.join]]
...
- [[![(3)](../images/callouts/3.gif)|c7239#chapter.sequencer.path]]
...
- [[![(4)](../images/callouts/4.gif)|c7239#chapter.sequencer.require]]
