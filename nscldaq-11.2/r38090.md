...
[← CUnixUserCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r37869.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r38198.md)
...
`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c10205.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r41717.md).
...
`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c10205.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r42447.md).
...
`CTCLInterpreter`
            ...
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c10205.md) of the
