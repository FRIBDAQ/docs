...
<a name="AEN52513"></a>## Name

CConfigurableObject -- base class for devices that have a configuration

<a name="AEN52516"></a>## Synopsis

```
CConfigurableObject
```

<a name="AEN53027"></a>## DESCRIPTION
...
<a name="AEN53133"></a>| String | Bool Value |
| --- | --- |
| true | true |
| yes | true |
| 1 | true |
...
<a name="AEN53606"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
` TypeCheckInfo s_checker;`
                        } isListParameter;This set of types are used to validate lists.
                            The isListParameter
...
<a name="AEN53726"></a>## CONSTRAINT CHECKING
...
`name`Is the name of the parameter being configured.

`newValue`Is the proposed new value for the parameter.

`pClientData`Is the constraint parameter passed to
                            `addParameter`
