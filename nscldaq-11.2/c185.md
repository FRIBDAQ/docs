...
[← The actions library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c11550.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCUSBReadout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c2296.md)
...
Reference material is provided in in the 3daq section that describes the
    ...
    the data format can be is provided [here](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c7972.md).
