...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r24983]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r24983]].
...
[[portAllocator(3tcl)|r74276]],
            [[CPortManagerException(3daq)|r24983]],
            [[DaqPortManager(1tcl)|r15776]]
