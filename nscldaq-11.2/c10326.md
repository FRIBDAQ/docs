...
[← The NSCL Exception class library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c10263.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event orderer and its user interface →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c10354.md)
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r13371.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r13371.md)),
