...
# <a name="vmetclintro"></a>Chapter 26. Tcl access to the VME via the SBS interface
...
# <a name="AEN7192"></a>26.1. Incorporating Vme Tcl in your scripts
...
<a name="AEN7201"></a>**Example 26-1. Appending the NSCLDAQ Tcl Package repository to Tcl's search
            path**
...
<a name="AEN7205"></a>**Example 26-2. Appending NSLCDAQ's TclPackage repository to Tcl's search path**
...
<a name="AEN7209"></a>**Example 26-3. Requesting the VME Tcl package be loaded.**
