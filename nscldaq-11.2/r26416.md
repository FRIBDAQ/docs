...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r25611.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r26794.md)
...
<a name="AEN26555"></a>## Public member functions





- <a name="AEN26561"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN26573"></a>`bool Xtest(void);const`
...
- <a name="AEN26585"></a>`bool Qtest(void);const`
...
- <a name="AEN26602"></a>`bool TimedOut(void);const`
...
- <a name="AEN26614"></a>`bool BranchDemand(void);const`
...
- <a name="AEN26626"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN26640"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN26653"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN26667"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN26682"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN26697"></a>`bool IT4(void);const`
...
- <a name="AEN26711"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN26722"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN26735"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN26751"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN26762"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN26773"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN26783"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN26787"></a>**Example 1. Initializing branch 0**
