...
<a name="AEN19274"></a>## Public member functions
...
<a name="AEN19492"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN19495"></a>**Example 1. Creating a begin run state transition item**
