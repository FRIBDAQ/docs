...
# <a name="AEN8454"></a>40.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8460"></a>**Example 40-1. Including a ring item class **
...
<a name="AEN8467"></a>**Example 40-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8472"></a>**Example 40-3. Linking the ring item format libraries**
...
[[r18170]]Base class for all the ring data item format classes.
...
[[r19093]]Represents a state change item.  Given a reference to
...
[[r18647]]Represents a state change item.  Given a reference to a
...
[[r19498]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[r21013]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[r19824]]Encapsulates the data taken in response to a physics
                        trigger.

[[r20347]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[r20020]]Encapsulates an item that gives information about the
...
[[r20662]]Encapsulates an event fragment produced by the event
                        builder ordering stage for which there's good reason to
                        believe the payload is not a ring item.

## <a name="AEN8544"></a>40.3.1. Generic ring data sources
