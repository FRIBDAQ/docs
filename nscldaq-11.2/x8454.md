...
[[`CRingItem`|r18170]]Base class for all the ring data item format classes.
...
[[`CRingStateChangeItem`|r19093]]Represents a state change item.  Given a reference to
...
[[`CRingScalerItem`|r18647]]Represents a state change item.  Given a reference to a
...
[[`CRingTextItem`|r19498]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[`CGlomParameters`|r21013]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[`CPhysicsEventItem`|r19824]]Encapsulates the data taken in response to a physics
                        trigger.

[[`CRingFragmentItem`|r20347]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[`CRingPhysicsEventCountItem`|r20020]]Encapsulates an item that gives information about the
...
[[`CUnknownFragment`|r20662]]Encapsulates an event fragment produced by the event
...
Reference information on these classes is availabe at:
                [[*CDataSource*|r23617]],
                [[*CRingDataSource*|r23669]],
                [[*CFileDataSource*|r23748]],
                [[*CDataSourceFactory"*|r23815]],
                and
                [[*CRingItemFactory*|r23882]].
