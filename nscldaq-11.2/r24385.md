...
<a name="AEN24399"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN24402"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN24432"></a>## DESCRIPTION
...
<a name="AEN24494"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
