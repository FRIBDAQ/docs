...
[← bells](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r56445.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQParameters →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r56665.md)
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r58231.md) package for that
            instead.
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r58231.md) is a better
                          choice).
