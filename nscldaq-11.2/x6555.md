...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_size)
  The 32-bit inclusive size is just 9 16-bit words.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_id)
  The 16-bit packet type is the number 0xff00 that we defined.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_bufstart)
  This is the 32-bit buffer header produced by the V785. It
                    encodes the following information: slot=10, pieces of data in
                    buffer = 1.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_data)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_end)
