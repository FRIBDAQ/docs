...
[← Running the Readout Program](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6521.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for USB communication →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6597.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_size)
  The 32-bit inclusive size is just 9 16-bit words.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_id)
  The 16-bit packet type is the number 0xff00 that we defined.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_bufstart)
  This is the 32-bit buffer header produced by the V785. It
                    encodes the following information: slot=10, pieces of data in
                    buffer = 1.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_data)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6555.md#docpkt_end)
