...
[← FrameSequencer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r77352.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [RingStatus →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r77437.md)
...
<a name="AEN77419"></a>## Name

RingStatus -- Widget that shows ring status.

<a name="AEN77422"></a>## Synopsis
...
- `update` *ring-info-list*
  Accepts a list of data compatible with the output
                              of the
                              [**ring usage**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r73800.md)
                              command.  This data is used to update the ring size, free space and
                              consumer information table.

<a name="AEN77463"></a>## SEE ALSO

[*TCL Ring package.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r73800.md)
