...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c7004.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAEN V812 Constant Fraction Discriminator →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c7057.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r15889.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r15942.md).
            section.
...
TclServer is also available as a package that can be incorporated
                ...
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r74378.md)
