...
# <a name="AEN9524"></a>49.1. The thread and synchronization model
...
<a name="AEN9537"></a>**Example 49-1. The life of a thread**
...
<a name="AEN9569"></a>**Example 49-2. Why synchonization is needed**
...
<a name="AEN9593"></a>**Example 49-3. Using `SyncGuard` to implement a monitor**
...
[[c9514#chapter.thread.synchronizable]]                    This member is the synchronization element.  We will see
                    it used in the
                    `increment`
                    member.
                [[c9514#chapter.thread.enter]]                    The
                    `sync_begin()`
