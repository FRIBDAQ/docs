...
<a name="AEN17168"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN17171"></a>## Synopsis
...
<a name="AEN17247"></a>## Public member functions
...
<a name="AEN17338"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN17342"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN17346"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
