...
# <a name="evb-connecting"></a>41.3. Connecting to the event builder.

The code below shows how to connect to the event builder as
                a client:

<a name="AEN8732"></a>**Example 41-1. 
