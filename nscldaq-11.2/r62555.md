...
<a name="AEN62569"></a>## Name

mqdc -- Support Mesytec MQDC-32 modules

<a name="AEN62572"></a>## Synopsis
...
<a name="AEN62992"></a>## EXAMPLES

<a name="AEN62994"></a>**Example 1. Sample use of mqdc command for timestamping with external oscillator**
...
[[![(1)](../images/callouts/1.gif)|r62555#mqdccreate]]                This command creates an object to manage an MQDC-32
              ...
              [[![(3)](../images/callouts/3.gif)|r62555#mqdcmakethresh]]                This highlights the fact that the configuration file is
                ...
                some external file.
              [[![(4)](../images/callouts/4.gif)|r62555#mqdcthresholds]]                This command uses the `thresholds` variable
                and programs the channel thresholds of the QDC.

<a name="AEN63016"></a>**Example 2. Sample configuration of mqdc for event counting and interrupt readout**
