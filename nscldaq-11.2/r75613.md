...
[← iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r75131.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VhsWidgets →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r75645.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r75899.md)
        for one such panel.
...
<a name="AEN75660"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN75664"></a>### VhsWidgets::channel
...
<a name="AEN75684"></a>### VhsWidgets::channelStatus options
...
<a name="AEN75690"></a>## OBJECT METHODS
...
<a name="AEN75694"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN75697"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r75099.md)
