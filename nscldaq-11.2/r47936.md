...
[← ph7xxx](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r47718.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Module →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r48083.md)
...
<a name="AEN47950"></a>## Name

stack -- Create and configure CC-USB stacks.

<a name="AEN47953"></a>## Synopsis
...
<a name="AEN48058"></a>## EXAMPLES

The example below extends the example in the
                  [ph7xxx(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r47718.md) command reference
                  reading the defined modules in an event stack:

<a name="AEN48062"></a>**Example 1. Example of the **stack** command.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r47936.md#defmodules)
  These two lines define the modules that we will be using
                          for the experimental setup.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r47936.md#stackdef)
  Creates a new stack called events
                          In subsequent lines I'm going to configure this stack
                          to handle the event trigger.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r47936.md#typemods)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r47936.md#timing)
