...
For reference information on this class see:
            [[CEventSegment(3sbsreadout)|r78688]].
            Closely allied with this is the concept of packets.  Packets are supported
            via the [[CDocumentedPacket(3sbsreadout)|r78287]].
            The [[CEventPacket(3sbsreadout)|r78560]]
...
For reference information about the `CCompoundEventSegment`
            class see
            [[CCompoundEventSegment(3sbsreadout)|r78007]].

The readout software has a single object from the
            [[CExperiment(3sbsreadout)|r79009]]
...
See the section:
            [[Modifying the skeleton application to meet your needs|x11363]]
...
[[![(1)](../images/callouts/1.gif)|c10942#specialring-normal-stuff]]                        This is part of the usual stuff that's needed in
...
[[![(1)](../images/callouts/1.gif)|c10942#specialring_getevtcount]]                        To set up for the loop that emits ring items we first
                    ...
                    [[![(2)](../images/callouts/2.gif)|c10942#specialring_geteventinfo]]                        This section of code gets the informatino about the event
                        ...
                        variable.
                    [[![(3)](../images/callouts/3.gif)|c10942#specialring_makeitem]]                        This line creates a ring item.  The form of this
                    ...
                    [[![(4)](../images/callouts/4.gif)|c10942#specialring_fillitem]]                        The `getBodyCursor` method
                        ...
                        event data.
                    [[![(5)](../images/callouts/5.gif)|c10942#specialring_updatecursor]]                        This line computes a pointer to the first unused byte
