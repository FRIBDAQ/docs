...
# <a name="AEN6734"></a>14.2. How to use the MDGG16Control GUI
...
4. With the slow-controls server up and running, the user can then go to
   ...
   ```
             MDGG16Control --module mymdgg16 --configfile /path/to/mdgg16.settings
   ```
...
5. The user will then be presented with the a graphical user interface 
             ...
             are in sync.
   <a name="mdgg16control_fig1"></a>**Figure 14-1. MDGG16Control Graphical User Interface**
