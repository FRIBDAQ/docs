...
[← Command line access to CAMAC via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c6888.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The dumper program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c6940.md)
...
The **ringtostdout** command can be used to
        ...
        [ringtostdout reference pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r12234.md).
...
The **stdintoring** command can be used to allow a
        ...
        [stdintoring reference material](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r12298.md).
