...
<a name="AEN12292"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN12295"></a>**Example 1. making hex dumps of data from a ring buffer.**
