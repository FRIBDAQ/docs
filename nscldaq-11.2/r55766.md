...
[← EVBC::flush](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r55743.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startRingSource →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r55853.md)
...
The registerRingSource proc registers information to the
             [*RingSourceMgr*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r56198.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x10786.md#sec_tsextractors) describes how
...
- *oneshot*
  This is a boolean value specifying whether the
