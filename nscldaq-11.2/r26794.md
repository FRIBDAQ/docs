...
<a name="AEN27326"></a>## Public member functions
...
<a name="AEN27333"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN27354"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN27367"></a>` unsigned char getVersion(void);const`
...
<a name="AEN27392"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN27403"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN27597"></a>` int  ReadResolution(void);`

Return the resolution code from the module.

<a name="AEN27607"></a>` bool isPairMode(void);`
...
<a name="AEN27749"></a>` ECLOutputSelect
...
<a name="AEN27817"></a>` unsigned short
...
<a name="AEN27981"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN27993"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN28003"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN28013"></a>` TriggerConfiguration
...
<a name="AEN28110"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN28151"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN28177"></a>` LEResolution
...
<a name="AEN28191"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN28351"></a>` unsigned short
...
<a name="AEN28445"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN28457"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN28474"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN28487"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN28499"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN28520"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN28532"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN28547"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN28562"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN28577"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN28589"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN28604"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN28614"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN28626"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN28638"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN28650"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN28662"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN28672"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN28682"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN28692"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN28702"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN28714"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN28724"></a>` void
                    EnableErrorMark(void);`



<a name="AEN28734"></a>` void
                    DisableErrorMark(void);`



<a name="AEN28744"></a>` void EnableBypassOnError(void);`



<a name="AEN28754"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN28764"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN28776"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN28786"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN28798"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN28808"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN28820"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN28832"></a>` void EnableAllChannels(void);`



<a name="AEN28842"></a>` void
                    DisableAllChannels(void);`
...
<a name="AEN28864"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN28876"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN28891"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN28903"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN28915"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN28936"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN28949"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN28966"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN28984"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN28999"></a>## Types and public data
