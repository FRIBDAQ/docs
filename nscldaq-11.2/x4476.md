...
[← Remote control package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x4440.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [More detail on when the fragments are ouptutted →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x4503.md)
...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c10879.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r55619.md).
...
The next thing that you need to do is register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x10786.md).
