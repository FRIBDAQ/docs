...
# <a name="AEN4465"></a>Chapter 7. Event Builder
...
The client programs that submit data to the server are built using the
      [[c10520]]. In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [[x10786]] program. This
