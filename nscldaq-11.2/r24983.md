...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r24826.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CADC2530 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r25139.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r24826.md)).
        Since it  is  derived
       from
       `CException`,
...
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r45760.md)
