...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_inc_protect]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_class_decl]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_docpacket]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_module_ptr]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_ctor]]
  This line declares the constructor for MyEventSegment. A
                ...
                (constructed).
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_init]]
  The Initialize member function is called whenever the run is
                ...
                resumed.
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_clear]]
...
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_read]]
...
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_computeTstamp]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_ifdef_std]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_include_hdr]]
  In order to get access to the class definition, we must
                include the header that we wrote that defines the class
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_pkt_version]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_initlist]]
  This code in the constructor is called an initializer list.
                ...
                of the module.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_mod_ptr_reset]]
  This code initializes the CAEN V785 module by resetting it
                ...
                latched.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_mod_ptr_clearData]]
  This code clears any data that is latched in the module.
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_poll_for_data]]
...
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_reinterpret_cast]]
  The address of the buffer was passed to the method as a
                ...
                allow us to do so.
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_pkt_begin]]
...
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_read_event]]
