...
[← The electronics](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6291.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The dumper program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6477.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_inc_protect)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_class_decl)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_docpacket)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_module_ptr)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_ctor)
  This line declares the constructor for MyEventSegment. A
                ...
                (constructed).
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_init)
  The Initialize member function is called whenever the run is
                ...
                resumed.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_clear)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_read)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex0_computeTstamp)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_ifdef_std)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_include_hdr)
  In order to get access to the class definition, we must
                include the header that we wrote that defines the class
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_pkt_version)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_initlist)
  This code in the constructor is called an initializer list.
                ...
                of the module.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_mod_ptr_reset)
  This code initializes the CAEN V785 module by resetting it
                ...
                latched.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_mod_ptr_clearData)
  This code clears any data that is latched in the module.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_poll_for_data)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_reinterpret_cast)
  The address of the buffer was passed to the method as a
                ...
                allow us to do so.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_pkt_begin)
...
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_read_event)
  Data are read from the ADC into the packet.
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_pkt_end)
...
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_compute_size)
  The number of 16-bit words that have been added to the
                ...
                afterwards.
- [**(13)**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_setTstamp)
...
- [**(14)**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_return)
  Returns the number of 16-bit words added to the data.
- [**(15)**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x6355.md#ex1_extractCount)
