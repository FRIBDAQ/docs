...
[← Providing EPICS channel information to Tcl Servers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c7515.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Epics Channel logging →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c7572.md)
...
The epicsdisplay utility provides a tabular
    ...
    available at the [epicsdisplay
      reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r16537.md)

epicsdisplay reads in a configuration file.
    The configuration file is compatible with [the controlpush](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r13371.md) application,
