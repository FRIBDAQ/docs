...
[← Writing the Configuration Script](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x802.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Selecting Data From a Ring Buffer →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x8426.md)
...
Finally, the data transferred through the ring buffer is just
      ...
      have a structure defined later in [Chapter 3](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/c185.md).
