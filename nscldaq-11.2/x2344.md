...
[← Pushing external data into the event stream](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x2254.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing device support software →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/x2385.md)
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r47936.md) command
