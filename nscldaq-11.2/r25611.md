...
<a name="AEN25625"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN25628"></a>## Synopsis
...
<a name="AEN25854"></a>## Public member functions





<a name="AEN25860"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN25922"></a>`unsigned long getBase(void);`
...
<a name="AEN25933"></a>`int getSerial(void);`
...
<a name="AEN25964"></a>`int  getFirmware(void);`
...
<a name="AEN25974"></a>`int  getCrate(void);`
...
<a name="AEN25985"></a>`void setCrate(int crateNum);`
...
<a name="AEN25998"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN26019"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN26029"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN26039"></a>`void keepOverflowData(void);`
...
<a name="AEN26049"></a>`void discardOverflowData(void);`
...
<a name="AEN26059"></a>`void keepInvalidData(void);`
...
<a name="AEN26070"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN26081"></a>`void commonStart(void);`
...
<a name="AEN26092"></a>`void commonStop(void);`
...
<a name="AEN26103"></a>`void setRange(int range);`
...
<a name="AEN26116"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN26188"></a>`void clearData
                                (void);`
...
<a name="AEN26231"></a>`bool Busy(void);`
...
<a name="AEN26242"></a>` bool gBusy(void);`
...
<a name="AEN26253"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN26264"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN26275"></a>`int readEvent(void* buf);`
...
<a name="AEN26288"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN26329"></a>`void enableSmallThresholds(void);`
...
DAQWordBufferA spectrodaq buffer of word wide items.

DAQWordBufferPtrA pointer like object into a DAQWordBuffer
                                object.
...
`CAEN_DATUM_TYPE`A mask of the bits in data from the digitizer that
                                isolates the data word type field.

`CAEN_HEADER`Data type field value for event headers.
                                If (datum & CAEN_DATUM_TYPE) == CAEN_HEADER
                                then `datum` is a CAEN module event header.

`CAEN_DATA`Data type field value for channel data.

`CAEN_FOOTER`Data type field value for end of event data footer longwords.

`CAEN_INVALID`Data type field value for longwords returned when
                                reading an event buffer that has no data.

<a name="AEN26392"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN26396"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN26400"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN26404"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN26408"></a>**Example 3. Reading out a CAEN 785 e.g.**
