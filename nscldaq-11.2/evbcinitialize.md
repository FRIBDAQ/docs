...
<a name="AEN55955"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN55958"></a>## Synopsis

**EVBC::initialize *options*
**

<a name="AEN55962"></a>## DESCRIPTION
...
`-glomtimestamppolicy` *earliest | latest | average*The timestamp assigned to the built physics event
