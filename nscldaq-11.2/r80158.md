...
[← RunState](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r80080.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CScaler →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r80190.md)
...
<a name="AEN80172"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN80175"></a>## Synopsis
...
<a name="AEN80223"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.2/r79444.md)).
