...
- [[![(2)](../images/callouts/2.gif)|x10902#evbbundle.register]]
  Informs the state manager that you will be using the
                      ...
                      callback bundle.
- [[![(3)](../images/callouts/3.gif)|x10902#evbbundle.onstart]]
  The `OnStart` proc is called from the
                      ReadoutGUI when it makes a transition to the
                      Halted state from
                      NotReady.
- [[![(4)](../images/callouts/4.gif)|x10902#evbbundle.initialize]]
...
- [[![(5)](../images/callouts/5.gif)|x10902#evbbundle.registerringsource1]]
...
- [[![(6)](../images/callouts/6.gif)|x10902#evbbundle.registerringsource2]]
  This line adds an event sources using the convenience
