...
<a name="AEN22711"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN22714"></a>## Synopsis
...
<a name="AEN22716"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN22727"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN22761"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN22781"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN22827"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN22833"></a>`pGlomParameters
...
<a name="AEN22847"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN22867"></a>`pEventBuilderFragment
...
<a name="AEN22887"></a>` pPhysicsEventItem
...
<a name="AEN22907"></a>` pPhysicsEventCountItem
...
<a name="AEN23000"></a>` pStateChangeItem
...
<a name="AEN23032"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN23040"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN23046"></a>## DESCRIPTION
...
<a name="AEN23054"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN23075"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN23130"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN23166"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN23259"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN23275"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN23302"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23334"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23360"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23389"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23537"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23589"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN23600"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
