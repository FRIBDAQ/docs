...
[← Authenticators](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9731.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Authenticators →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9741.md)

---

---

# <a name="AEN9732"></a>50.2. Authenticators
...
<a name="AEN9736"></a>**Example 50-3. Boilerplate DAQ Authorization code **
...
The complete definitinon of
            ...
            [its reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36010.md).
            The library provides the following concrete authentication classes:



- [`CPasswordCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36114.md)
...
- [`CUnixUserCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36302.md)
  The entity must provide a valid username and password
                          that is could login to the local unix system.
- [`CTclAccesListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36513.md)
...
- [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36611.md)
  The entity must supply a string that is one of a set of strings
                              given to the authenticator.
- [`CHostListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36753.md)
