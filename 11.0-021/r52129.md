...
[← Event builder client framework](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r52128.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client framework →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r52138.md)
...
<a name="AEN52141"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN52144"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN52148"></a>## DESCRIPTION
