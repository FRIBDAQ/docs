...
[← CEVBClientFramework](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23487.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEVBClientFramework →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23497.md)
...
<a name="AEN23492"></a>## Name

CEVBClientFramework -- Event builder client framework.

<a name="AEN23495"></a>## Synopsis

```
CEVBClientFramework
```

<a name="AEN23512"></a>## DESCRIPTION
...
`
  Allows you to submit a list of event fragments to the
                          ...
                          see
                          [*CEventOrderClient*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23544.md).
