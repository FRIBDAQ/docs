...
[← RingStatus](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r71309.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3sbsReadout →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r71368.md)
...
- `update` *ring-info-list*
  Accepts a list of data compatible with the output
                              of the
                              [**ring usage**](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r68240.md)
...
[*TCL Ring package.
        **Ron**Fox**
*NSCLDAQ*
***](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r68240.md)
