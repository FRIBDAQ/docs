...
<a name="AEN24538"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24541"></a>## Synopsis
...
<a name="AEN24767"></a>## Public member functions





<a name="AEN24773"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24835"></a>`unsigned long getBase(void);`
...
<a name="AEN24846"></a>`int getSerial(void);`
...
<a name="AEN24877"></a>`int  getFirmware(void);`
...
<a name="AEN24887"></a>`int  getCrate(void);`
...
<a name="AEN24898"></a>`void setCrate(int crateNum);`
...
<a name="AEN24911"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24932"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24942"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24952"></a>`void keepOverflowData(void);`
...
<a name="AEN24962"></a>`void discardOverflowData(void);`
...
<a name="AEN24972"></a>`void keepInvalidData(void);`
...
<a name="AEN24983"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN24994"></a>`void commonStart(void);`
...
<a name="AEN25005"></a>`void commonStop(void);`
...
<a name="AEN25016"></a>`void setRange(int range);`
...
<a name="AEN25029"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25101"></a>`void clearData
                                (void);`
...
<a name="AEN25144"></a>`bool Busy(void);`
...
<a name="AEN25155"></a>` bool gBusy(void);`
...
<a name="AEN25166"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25177"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25188"></a>`int readEvent(void* buf);`
...
<a name="AEN25201"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25242"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25305"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25309"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25313"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25317"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25321"></a>**Example 3. Reading out a CAEN 785 e.g.**
