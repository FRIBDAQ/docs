...
[← The NSCL Exception class library](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c10060.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Injecting variables into the USB data taking frameworks →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c10114.md)
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12943.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12943.md)),
