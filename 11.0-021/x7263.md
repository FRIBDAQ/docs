...
[← Using the sequencer.](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7254.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing event files with compatibilitylogger →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7392.md)
