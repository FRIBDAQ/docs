...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55443.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [PortManager →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55445.md)
...
<a name="AEN55456"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN55459"></a>## Synopsis
...
<a name="AEN55473"></a>## METHODS



- <a name="AEN55478"></a>`PortManager(string host, int    port);`
