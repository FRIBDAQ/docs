...
[← chanlog](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r13042.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [chanlog →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r13052.md)
...
<a name="AEN13047"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN13050"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN13055"></a>## DESCRIPTION
...
<a name="AEN13077"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN13080"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN13083"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN13086"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN13089"></a>## DEPENDENCIES
