...
[← CURIFormatException](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42919.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMonitorException →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r43095.md)
...
The NSCL DAQ base software includes support for an object model
            ...
            chapter;
            [NSCL DAQ Thread Library](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md).
...
`CMonitorException`
            is derived from the
            [CException](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42345.md)
            class, and therefore supports and implements all of its
            virtual members.

<a name="AEN43172"></a>## Public member functions
