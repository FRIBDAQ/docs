...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10700.md#evbbundle.require)
  Incorporates the package code into your script.  This makes
                      all three APIs visible and accessible from your script.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10700.md#evbbundle.onstart)
  The `OnStart` is called from the
                      ...
                      user interface.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10700.md#evbbundle.register)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10700.md#evbbundle.configure)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10700.md#evbbundle.startsources)
  When the event builder is started, if you define a proc named
                      ...
                      event builder.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10700.md#evbbundle.startringsource)
