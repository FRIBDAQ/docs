...
<a name="AEN50001"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN50004"></a>## Synopsis
...
<a name="AEN50173"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r45011]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r50722]])
...
<a name="AEN50181"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r50722]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r50722]] for
...
<a name="AEN50633"></a>## DEVICE ENUMERATION
...
<a name="AEN50657"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN50667"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN50673"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r48230]] for reference
...
<a name="AEN50716"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r45011]]
[[cccusbreadoutlist(3ccusb)|r50722]]
[[CCCUSBReadoutList(3ccusb)|r48230]]
