...
[← tclserver](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15227.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [tclserver →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15237.md)
...
<a name="AEN15232"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN15235"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN15242"></a>## DESCRIPTION
