...
[← CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23909.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23919.md)
...
<a name="AEN23971"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23755.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN23978"></a>## Public member functions
...
<a name="AEN24034"></a>## Types and public data
...
<a name="AEN24054"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN24057"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r68636.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23755.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15117.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42346.md)
