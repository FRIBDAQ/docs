...
[← BufferToRing](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7464.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Overview and Examples of ring buffers in action. →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7828.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringcons.include)
  The
                          CRingBuffer.h
                          header is included.
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringcons.std)
  Incorporating the
                          ...
                          `std::string`
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringcons.create)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringcons.obj)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringcons.latency)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringcons.get)
  The
                          `get`
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringprod.include)
  Includes the
                          CRingBuffer.h
                          ...
                          ring buffers.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringprod.latency)
  See the discussion of the consumer for more
                          ...
                          response latencies.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringprod.pattern)
  This loop creates a buffer that consists of 1MB
                          counting pattern.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x7819.md#ringprod.put)
