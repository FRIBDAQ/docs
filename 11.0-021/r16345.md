...
<a name="AEN16356"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16359"></a>## Synopsis
...
<a name="AEN16435"></a>## Public member functions
...
<a name="AEN16526"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16530"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16534"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
