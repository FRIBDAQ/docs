...
[← The tcl server application](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c6979.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAEN V812 Constant Fraction Discriminator →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7002.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15237.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15280.md).
            section.
...
TclServer is also available as a package that can be incorporated
                ...
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r68778.md)
