...
[← CVMEScalerLRS1151](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r32176.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEScalerLRS1151 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r32186.md)
...
<a name="AEN32220"></a>## Public member functions
...
<a name="AEN32258"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN32261"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
