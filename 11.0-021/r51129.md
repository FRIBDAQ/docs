...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51128.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51138.md)
...
<a name="AEN51133"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN51136"></a>## Synopsis

```
CControlHardware
```

<a name="AEN51203"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r50989.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51086.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN51210"></a>## METHODS
