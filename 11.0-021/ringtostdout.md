...
<a name="AEN11968"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN11971"></a>**Example 1. making hex dumps of data from a ring buffer.**
