...
<a name="AEN21737"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN21740"></a>## Synopsis
...
<a name="AEN21742"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN21753"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN21787"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN21807"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN21853"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN21859"></a>`pGlomParameters
...
<a name="AEN21873"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN21893"></a>`pEventBuilderFragment
...
<a name="AEN21913"></a>` pPhysicsEventItem
...
<a name="AEN21933"></a>` pPhysicsEventCountItem
...
<a name="AEN22026"></a>` pStateChangeItem
...
<a name="AEN22058"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22066"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22072"></a>## DESCRIPTION
...
<a name="AEN22080"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN22101"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN22156"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN22192"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN22285"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN22301"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN22328"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22360"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22386"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22415"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22563"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22615"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN22626"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
