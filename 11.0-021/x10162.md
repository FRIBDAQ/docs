...
[← Using the standard event orderer startup script](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10161.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the standard event orderer startup script →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10171.md)

---

---

# <a name="AEN10162"></a>56.2. Using the standard event orderer startup script
