...
[← The dumper program](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c6885.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c6949.md)
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12578.md).
...
<a name="AEN6908"></a>**Example 19-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN6912"></a>**Example 19-2. Dumping data from the event file segment
...
# <a name="AEN6922"></a>19.1. Item dump formats and examples
...
<a name="AEN6925"></a>**Example 19-3. State Transition items**
...
<a name="AEN6930"></a>**Example 19-4. Text List items**
...
<a name="AEN6935"></a>**Example 19-5. Incremental Scalers dump**
...
<a name="AEN6941"></a>**Example 19-6. Event count items**
...
<a name="AEN6947"></a>**Example 19-7. Physics Event items**
...
<a name="AEN6952"></a>**Example 19-8. Unknown item types**
