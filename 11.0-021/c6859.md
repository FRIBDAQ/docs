...
[← Command line access to CAMAC via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c6842.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring piping utilities →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c6868.md)
...
The **ringtostdout** command can be used to
        ...
        [ringtostdout reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r11911.md).
...
The **stdintoring** command can be used to allow a
        ...
        [stdintoring reference material](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r11965.md).
