...
[← Using CGaurdedObject to implement synchronized methods](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9581.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Thread safe queues (CBufferQueue). →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9612.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9611.md#bufferqueue_databuffer)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9611.md#bufferqueue_queues)
  These are the queues.  By passing pointers around in the queue
              ...
              new data.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9611.md#bufferqueue_get)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9611.md#bufferqueue_put)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9611.md#bufferqueue_outputget)
  The output thread gets a filled buffer from the queue and processes it.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9611.md#bufferqueue_outputput)
