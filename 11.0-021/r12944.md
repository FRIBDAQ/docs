...
[← controlpush](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12943.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1epics →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12951.md)
...
<a name="AEN13026"></a>## CONFIGURATION FILES
...
Channel lines, have as their first non-whitespace word, the name of
	   ...
	   (notably
	   [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7498.md)) may 
	   parse additional characters for their own purposes.

<a name="AEN13034"></a>## DEPENDENCIES
