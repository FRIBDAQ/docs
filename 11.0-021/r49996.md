...
<a name="AEN50000"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN50003"></a>## Synopsis
...
<a name="AEN50172"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r45010]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r50721]])
...
<a name="AEN50180"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r50721]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r50721]] for
...
<a name="AEN50632"></a>## DEVICE ENUMERATION
...
<a name="AEN50656"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN50666"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN50672"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r48229]] for reference
...
<a name="AEN50715"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r45010]]
[[cccusbreadoutlist(3ccusb)|r50721]]
[[CCCUSBReadoutList(3ccusb)|r48229]]
