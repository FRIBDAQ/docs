...
[← CAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36610.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36620.md)
...
The
            ...
            [CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36513.md)
            class, however the list is stored internally in the class rather than
            in a Tcl variable.

<a name="AEN36676"></a>## Public member functions
...
<a name="AEN36747"></a>## Types and public data
