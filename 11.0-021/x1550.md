...
[← Ring buffer utilities](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x130.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Pipeline Building, Run Control, and DAQ Modularization →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x19.md)
...
A Slow controls device driver is a class that is derived from
          the 
          [*CControlHardware*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r64151.md) abstract base class.
...
The [*CControlHardware*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r64151.md) class is an abstract
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-onattach-saveconfig)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-onattach-makeparams)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-set-params)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-set-configure)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-set-error)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-get-params)
  ...
  - `parameter`
    The name of the parameter to modify.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-get-cget)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-get-error)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#cltcreator-headers)
  The creator must have `CModuleCreator` as 
  		  a base class.   This line includes the header for that class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctlcreator-classdef)
  This is the class definition for the creator.  By convention
  		  ...
  		  `CModuleCreator`
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctlcreator-functordef)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctlcreator-new)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-init-headers)
  ...
  - tcl.h
    Contains interface definitions for the API to the
    			  Tcl interpreter.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-init-cbinding)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-init-prototype)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-init-factget)
  The main work of the intitialization function is to register
  		    ...
  		    of the factory.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-init-creator)
  Registers the new creator object associating it with the
  		    module type mydriver
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-init-status)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-tclstruct-packages)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-tclstruct-snittype)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-tclstruct-options)
  The **option**, defined within a **snit::type**
  	    ...
  	    **option** provides the name of a method that
  	    ...
  	    validation.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-tclstruct-constructor)
  The constructor  method must do all internal initializations,
  	    ...
  	    parameter contains.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-tclstruct-methods)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#ctldriver-tclstruct-configmethods)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#tcldriver-validate-isinteger)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#tcldriver-validate-setintopt)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#tcldriver-validate-intinvalid)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#tldriver-validate-islist)
  This trick checks that `value` is a valid list.  This works
  	      because complete commands must be valid Tcl lists as well.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#tcldriver-validate-listcount)
  This ensures the list has exactly 16 elements, else an error is thrown.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#tcldriver-validate-intelements)
  Element by element, the list is checked to ensure that all elements are
  	      valid integers.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1550.md#tcldriver-validate-setlistopt)
