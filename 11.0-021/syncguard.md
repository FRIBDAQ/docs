...
<a name="AEN35060"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35063"></a>## Synopsis
...
<a name="AEN35105"></a>## Public member functions
...
<a name="AEN35143"></a>`void sync_self(void);`
...
<a name="AEN35150"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35158"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35170"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35176"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35186"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35216"></a>`void sync_global_end(void);`
