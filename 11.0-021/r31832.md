...
<a name="AEN31946"></a>## Public member functions



<a name="AEN31951"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
<a name="AEN31989"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
<a name="AEN32004"></a>`CVME<T>(const CVME& aCVME);`
...
<a name="AEN32017"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
<a name="AEN32030"></a>`int  operator==(const CVME<T>& aCVME);`
...
<a name="AEN32075"></a>`T*  T* operator-> (void);`
...
<a name="AEN32085"></a>`T&  operator[](UInt_t nOffset);`
...
<a name="AEN32100"></a>`CVME<T>& operator+(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32112"></a>`CVME<T>&  operator-(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32124"></a>`CVME<T>&  operator+=(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32136"></a>`CVME<T>&  operator-=(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32146"></a>## Types and public data
