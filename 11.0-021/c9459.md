...
[← Integer byte order conversion library](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9388.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DAQ Thread Library →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9460.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.mythread)
  By making
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.run)
  The
                      `run`
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.creation)
  Creating a thread is simple.  Just create an object that
                      is of the thread class type.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.start)
  Starting a thread is equally simple, Just call the
                      ...
                      `run`
                      method.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.join)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.destroy)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.synchronizable)
  This member is the synchronization element.  We will see
                      it used in the
                      `increment`
                      member.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.enter)
  The
                      `sync_begin()`
                      ...
                      object.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.leave)
  This call leaves the monitor.  The effect of the
                      monitor is to make the increment atomic with respect to the
                      scheduler.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9459.md#chapter.thread.monitoredincr)
  By using the
                      `increment`
