...
### <a name="AEN1589"></a>4.9.1.1. Driver requirements

A Slow controls device driver is a class that is derived from
          the 
          [[r64151]] abstract base class.
...
The [[r64151]] class is an abstract
...
#### <a name="AEN1717"></a>4.9.1.1.1. The driver
...
<a name="AEN1720"></a>**Example 4-14. Control driver headers**
...
<a name="AEN1739"></a>**Example 4-15. Control driver class definition**
...
<a name="AEN1746"></a>**Example 4-16. Control driver constructor**
...
<a name="AEN1750"></a>**Example 4-17. Control driver `onAttach` method**
...
[[x1550#ctldriver-onattach-saveconfig]]		  The base class (`CControlHardware`) 
...
<a name="AEN1773"></a>**Example 4-18. Control driver `Update`**
...
<a name="AEN1785"></a>**Example 4-19. Control driver `Set` method.**
...
<a name="AEN1835"></a>**Example 4-20. Control driver `Get` method**
...
<a name="AEN1869"></a>**Example 4-21. Control driver `clone` method**
...
#### <a name="AEN1880"></a>4.9.1.1.2. The creator
...
<a name="AEN1883"></a>**Example 4-22. Control driver creator**
...
<a name="AEN1918"></a>**Example 4-23. Control driver initialization**
...
[[x1550#ctldriver-init-cbinding]]		    The Tcl interpreter needs to be able to compute
		  ...
		  [[x1550#ctldriver-init-factget]]		    The main work of the intitialization function is to register
		    ...
		    of the factory.
		  [[x1550#ctldriver-init-creator]]		    Registers the new creator object associating it with the
		    module type mydriver
[[x1550#ctldriver-init-status]]		    Returns a normal status value.

#### <a name="AEN1962"></a>4.9.1.1.4. Building the driver and using it.
...
<a name="AEN2030"></a>**Example 4-24. Control drivers - structure of a Tcl driver**
...
### <a name="AEN2077"></a>4.9.2.1. Initialize

The full implementation of the `Initialize` is shown
	  below:

<a name="AEN2081"></a>**Example 4-25. Tcl control driver `Initialize` method**
...
### <a name="AEN2110"></a>4.9.2.3. The Set method
...
<a name="AEN2114"></a>**Example 4-27. Tcl control driver `Set` method**
...
### <a name="AEN2134"></a>4.9.2.4. The Get method
...
<a name="AEN2137"></a>**Example 4-28. Tcl control driver `Get` method**
...
### <a name="AEN2152"></a>4.9.2.5. The addMonitorList method

Since we are not using monitor lists, this method is trivial:

<a name="AEN2155"></a>**Example 4-29. Tcl control drer `addMonitorList` method**
...
### <a name="AEN2162"></a>4.9.2.6. The processMonitorList method
...
<a name="AEN2166"></a>**Example 4-30. Tcl control driver `processMonitorList` method**
...
### <a name="AEN2170"></a>4.9.2.7. The getMonitoredData method
...
<a name="AEN2178"></a>**Example 4-31. Tcl control driver `getMonitoredData` method**
...
### <a name="AEN2182"></a>4.9.2.8. Validating the command options
...
<a name="AEN2191"></a>**Example 4-32. Tcl control driver validation**
