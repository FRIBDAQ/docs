...
[← The ccusbcamac Tcl package](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x3513.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The event logger and ReadoutShell →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x4007.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/readoutshell.jpg)
...
The menu bar provides access to ReadoutShell commands
                ...
                [*Customizing the ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x4041.md) describes
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/eventlogsettings.jpg)
...
- Event Log Program
  ...
  The
                              ...
                              [*The event logger and ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x4007.md) for
...
- Use `--number-of-sources`
  ...
  This option should be used if you are combining
                              ...
                              See
                              [*eventlog*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12662.md) for more
...
- debug
  The debug log level is intended
                              ...
                              See, however
                              [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54125.md#rdogui3_ui_OutputWindow)  for
...
The log types and their visual representations can be controlled
                ...
                [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54125.md#rdogui3_ui_OutputWindow) for information
