...
[← CCCUSB](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r45010.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSB →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r45020.md)
...
<a name="AEN45015"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45018"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46000"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r48230.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r48230.md) for
...
<a name="AEN46571"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46575"></a>### Action Register
...
<a name="AEN46618"></a>### Firmware Register
...
<a name="AEN46670"></a>### Global Mode Register
...
<a name="AEN46803"></a>### Delay Register
...
<a name="AEN46836"></a>### Scaler Control register
...
<a name="AEN46869"></a>### LED Source Register
...
<a name="AEN47121"></a>### Output source selection register.
...
<a name="AEN47290"></a>### Device source register
...
<a name="AEN47643"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47704"></a>### Transfer setup register
