...
[← ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r11910.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ringtostdout →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r11920.md)
...
<a name="AEN11959"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN11962"></a>**Example 1. making hex dumps of data from a ring buffer.**
