...
**-base** *value*Specifies the base address of the module. See the manual on how to address the XLM. When the module is using geographic addressing, the slot number is pushed up 27 bits (i.e. slot 10 produces a base address of 0x50000000).

**-firmware** *path*The path to the xferajan.bit firmware file.

**-configurationID** *value*The value to use in the validation test. Default is 0x54000041.

**-forceFirmwareLoad** *bool*Force reload of the firmware every run regardless of whether the XLM passes the validation test.
