...
[← CCAMACTrigger](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r29528.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACTrigger →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r29538.md)
...
<a name="AEN29555"></a>## Public member functions



- <a name="AEN29560"></a>`CCAMACTrigger(unsigned int b);`
...
- <a name="AEN29572"></a>`virtual bool  operator()(void);`
  Tests for the presence of a trigger condition.

<a name="AEN29580"></a>## DEFECTS AND RESTRICTIONS
