...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42355.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42433.md)
...
<a name="AEN42436"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN42440"></a>## Synopsis

```
CErrnoException
```

<a name="AEN42467"></a>## Description
...
<a name="AEN42476"></a>## Public member functions
