...
[← CSIS3600](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r30467.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3600 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r30477.md)
...
<a name="AEN30620"></a>## Public member functions
...
- <a name="AEN30643"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN30653"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN30664"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN30675"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN30687"></a>` void SetLatchMode(void);const`
...
- <a name="AEN30699"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN30734"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN30803"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN30814"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN30825"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN30836"></a>` void Clock(void);const`
...
- <a name="AEN30847"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN30858"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN30869"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN30881"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN30892"></a>` unsigned long Read(void);const`
...
- <a name="AEN30904"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
