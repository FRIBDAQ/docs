...
[← pause](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55091.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [resume →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55117.md)
...
<a name="AEN55128"></a>## Name

resume -- Resume a Paused Run

<a name="AEN55131"></a>## Synopsis
...
Resumes a run that is paused in the data source identified by
          ...
          [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55201.md) specifies  the
