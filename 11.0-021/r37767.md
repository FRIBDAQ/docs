...
[← CDAQShm](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37758.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLApplication 3 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r38116.md)
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37767.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37767.md#daqshm-varsrefsect).
