...
[[![(1)](../images/callouts/1.gif)|c9460#chapter.thread.mythread]]                    By making
                    `MyThread` a subclass of
                    `Thread`,
                    objects from class
                    `MyThread`
                    can be started as independent threads of execution
                [[![(2)](../images/callouts/2.gif)|c9460#chapter.thread.run]]                    The
                    `run`
...
[[![(1)](../images/callouts/1.gif)|c9460#chapter.thread.synchronizable]]                    This member is the synchronization element.  We will see
                    it used in the
                    `increment`
                    member.
                [[![(2)](../images/callouts/2.gif)|c9460#chapter.thread.enter]]                    The
                    `sync_begin()`
                    ...
                    object.
                [[![(3)](../images/callouts/3.gif)|c9460#chapter.thread.leave]]                    This call leaves the monitor.  The effect of the
                    monitor is to make the increment atomic with respect to the
                    scheduler.
                [[![(4)](../images/callouts/4.gif)|c9460#chapter.thread.monitoredincr]]                    By using the
                    `increment`
