...
[← PortManager](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55444.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3python →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55452.md)
...
<a name="AEN55457"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN55460"></a>## Synopsis
...
<a name="AEN55474"></a>## METHODS



- <a name="AEN55479"></a>`PortManager(string host, int    port);`
