...
[← CVMUSBRemote](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r61653.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMUSBRemote →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r61696.md)
...
<a name="AEN61658"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN61661"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN62847"></a>## DESCRIPTION
...
<a name="AEN62850"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r58767.md)
