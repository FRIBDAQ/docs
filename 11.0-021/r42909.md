...
[← CStreamIOError](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42756.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CURIFormatException →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42910.md)
...
<a name="AEN42913"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN42916"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN43000"></a>## Description
...
<a name="AEN43007"></a>## Public member functions
