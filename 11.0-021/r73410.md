...
[← CV977Busy](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r73409.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CV977Busy →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r73452.md)
...
<a name="AEN73450"></a>| Plug | Direction | Meaning |
| --- | --- | --- |
...
<a name="AEN73471"></a>## Public member functions
...
<a name="AEN73507"></a>## SEE ALSO

[CBusy(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r71371.md),
     [CV977Trigger(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r73512.md)
