...
[← Integer byte order conversion library](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9378.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Integer byte order conversion library →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9388.md)

---

---

# <a name="AEN9379"></a>Chapter 48. Integer byte order conversion library
...
Reference material for this library is available in the
        [reference manual page for cvt](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r34629.md).

This chapter gives an high level view of how the
        library should be used.

# <a name="AEN9386"></a>48.1. Using the conversion library in your code

The conversion library is a set of C functions.  To use it,
            you will need to include the library header in your source code
            with a line like:

<a name="AEN9389"></a>**Example 48-1. Including the cvt header**
...
<a name="AEN9395"></a>**Example 48-2. Compiling a C or C++ source file that includes cvt.h**
...
<a name="AEN9399"></a>**Example 48-3. A makefile rule that builds a C++ program using the
                cvt package**
