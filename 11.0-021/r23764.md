...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23919]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23919]].
...
[[portAllocator(3tcl)|r68678]],
            [[CPortManagerException(3daq)|r23919]],
            [[DaqPortManager(1tcl)|r15126]]
