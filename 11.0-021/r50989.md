...
[← CModuleFactory](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r50988.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CModuleFactory →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r50998.md)
...
<a name="AEN50993"></a>## Name

CModuuleFactory -- Creates specific slow control drivers

<a name="AEN50996"></a>## Synopsis

```
CModuleFactory
```

<a name="AEN51026"></a>## DESCRIPTION
...
This class provides a factory that allows the
            **Module create** slow control server command to
            ...
            [creator object](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51086.md).
