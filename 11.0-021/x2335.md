...
[← Pushing external data into the event stream](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x2245.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing device support software →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x2376.md)
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r44315.md) command
