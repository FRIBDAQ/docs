...
[← vmusbloader](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12767.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vmusbloader →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12777.md)
...
<a name="AEN12772"></a>## Name

vmusbloader -- VM-USB Firmware loader

<a name="AEN12775"></a>## Synopsis

**
vmusbloader *firmware-filename [serial-string]*
**

<a name="AEN12780"></a>## DESCRIPTION

Loads the firmware-filename into the currently
            selected firmware location. See
            [*VM/CCUSB Firmware loaders*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7164.md)
...
<a name="AEN12787"></a>## KNOWN ISSUES
