...
[← CDAQShm](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37757.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDAQShm →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37767.md)
...
<a name="AEN37762"></a>## Name

CDAQShm -- class description

<a name="AEN37765"></a>## Synopsis

```
CDAQShm
```

<a name="AEN37880"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37758.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37758.md#daqshm-varsrefsect).
