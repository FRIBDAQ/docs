...
[[x2888#ccusb-slowdriver-includes-tcl.h]]                            Since our driver will get loaded via the Tcl
                        ...
                        [[x2888#ccusb-slowdriver-includes-CModuleFactory.h]]                            The `CModuleFactory` class is
...
[[x2888#ccusb-slowdriver-includes-CModuleCreator.h]]                            This header defines the base class for all module
                        ...
                        [[x2888#ccusb-slowdriver-includes-CControlHardware.h]]                            Drivers are classes that are derived from
                            ...
                            (see
                            [[r51138]]
[[x2888#ccusb-slowdriver-includes-CControlModule.h]]                            The makeup of a `CControlHardware`
...
[[x2888#ccusb-slowdriver-def-onattach]]                                The `OnAttach` method is
...
**Construction and destruction. **
                            See
                            [[x2888#ccusb-slowdriver-impl-condestruct]]
...
[[x2888#ccusb-slowdriver-impl-constr-baseinit]]                                The constructor must initialize the base
                            ...
                            [[x2888#ccusb-slowdriver-impl-constr-configinit]]                                The `m_pConfig` member variable
...
[[x2888#cccusb-slowdriver-impl-set-configure]]                                Our driver uses the configuration database
...
[[x2888#cccusb-slowdriver-impl-set-ok]]                                On success, the `Set`
...
[[x2888#ccusb-slowdriver-impl-get-error]]                                The `cget` method throws
