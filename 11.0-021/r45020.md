...
[← CCCUSB](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r45011.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r47764.md)
...
<a name="AEN45024"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45027"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46009"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r48239.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r48239.md) for
...
<a name="AEN46580"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46584"></a>### Action Register
...
<a name="AEN46627"></a>### Firmware Register
...
<a name="AEN46679"></a>### Global Mode Register
...
<a name="AEN46812"></a>### Delay Register
...
<a name="AEN46845"></a>### Scaler Control register
...
<a name="AEN46878"></a>### LED Source Register
...
<a name="AEN47130"></a>### Output source selection register.
...
<a name="AEN47299"></a>### Device source register
...
<a name="AEN47652"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47713"></a>### Transfer setup register
