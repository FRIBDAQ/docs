...
[← OutputWindowSettings](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54627.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [OutputWindowSettings →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54637.md)
...
<a name="AEN54684"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r52937.md#rdogui3_dialogwrapper).
