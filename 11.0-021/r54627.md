...
[← ui](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54125.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [OutputWindowSettings →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54628.md)
...
<a name="AEN54683"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r52936.md#rdogui3_dialogwrapper).
