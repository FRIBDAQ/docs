...
<a name="AEN24547"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24550"></a>## Synopsis
...
<a name="AEN24776"></a>## Public member functions





<a name="AEN24782"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24844"></a>`unsigned long getBase(void);`
...
<a name="AEN24855"></a>`int getSerial(void);`
...
<a name="AEN24886"></a>`int  getFirmware(void);`
...
<a name="AEN24896"></a>`int  getCrate(void);`
...
<a name="AEN24907"></a>`void setCrate(int crateNum);`
...
<a name="AEN24920"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24941"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24951"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24961"></a>`void keepOverflowData(void);`
...
<a name="AEN24971"></a>`void discardOverflowData(void);`
...
<a name="AEN24981"></a>`void keepInvalidData(void);`
...
<a name="AEN24992"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN25003"></a>`void commonStart(void);`
...
<a name="AEN25014"></a>`void commonStop(void);`
...
<a name="AEN25025"></a>`void setRange(int range);`
...
<a name="AEN25038"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25110"></a>`void clearData
                                (void);`
...
<a name="AEN25153"></a>`bool Busy(void);`
...
<a name="AEN25164"></a>` bool gBusy(void);`
...
<a name="AEN25175"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25186"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25197"></a>`int readEvent(void* buf);`
...
<a name="AEN25210"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25251"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25314"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25318"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25322"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25326"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25330"></a>**Example 3. Reading out a CAEN 785 e.g.**
