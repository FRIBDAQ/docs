...
[← CVME](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r31832.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r31842.md)
...
<a name="AEN31837"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN31840"></a>## Synopsis
...
<a name="AEN31947"></a>## Public member functions



- <a name="AEN31952"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN31990"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN32005"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN32018"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN32031"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN32076"></a>`T*  T* operator-> (void);`
...
- <a name="AEN32086"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN32101"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32113"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN32125"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32137"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN32147"></a>## Types and public data
