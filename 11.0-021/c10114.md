...
[← Injecting variables into the USB data taking frameworks](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c10113.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Injecting variables into the USB data taking frameworks →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c10123.md)

---

---

# <a name="AEN10114"></a>Chapter 55. Injecting variables into the USB data taking frameworks
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12944.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12944.md)),
...
<a name="AEN10133"></a>**Example 55-1. The **watch** command.**
