...
[← pause](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55081.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [pause →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55091.md)
...
<a name="AEN55094"></a>## Name

pause -- Pause a data taking run (optional)

<a name="AEN55097"></a>## Synopsis
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55202.md) specifies  the
