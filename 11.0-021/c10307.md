...
[[*Event builder client API*|c8627]] describes a low
...
[[![(1)](../images/callouts/1.gif)|c10307#evbfw-base-initialize]]                    Called to perform one-time initialization.  This is called
                ...
                [[![(2)](../images/callouts/2.gif)|c10307#evbfw-base-dataready]]                    This method is called from time to time to determine if
                    ...
                    return true.
                [[![(3)](../images/callouts/3.gif)|c10307#evbfw-base-getevents]]                    Called at some point after `dataReady`
...
[[![(4)](../images/callouts/4.gif)|c10307#evbfw-base-shutdown]]                    Called just prior to the framework shutting down.
...
[[![(1)](../images/callouts/1.gif)|c10307#evb-clientfw-get-list]]                        The `CEVBEventList` is a list
                    ...
                    [[![(2)](../images/callouts/2.gif)|c10307#evb-clientfw-get-while]]                        The main loop condition for our code is to run
                        until we've pulled all the items from the ring.
                        See [[below however.|c10307#evb-clientfw-get-limit]]
[[![(3)](../images/callouts/3.gif)|c10307#evb-clientfw-get-itemprep]]                        This is the heart of the loop. Each pass through the loop,
