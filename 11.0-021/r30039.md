...
[← CCamacNimout](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r30038.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacNimout →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r30048.md)
...
<a name="AEN30077"></a>## Public member functions
...
- <a name="AEN30102"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN30115"></a>` void WriteBit(unsigned int nBitno);`
