...
[← pause](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55082.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [resume →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55116.md)
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r55211.md) specifies  the
