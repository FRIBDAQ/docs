...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r25328.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r25338.md)
...
<a name="AEN25458"></a>## Public member functions





- <a name="AEN25464"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25476"></a>`bool Xtest(void);const`
...
- <a name="AEN25488"></a>`bool Qtest(void);const`
...
- <a name="AEN25505"></a>`bool TimedOut(void);const`
...
- <a name="AEN25517"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25529"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25543"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25556"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25570"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25585"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25600"></a>`bool IT4(void);const`
...
- <a name="AEN25614"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25625"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25638"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25654"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25665"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25676"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25686"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25690"></a>**Example 1. Initializing branch 0**
