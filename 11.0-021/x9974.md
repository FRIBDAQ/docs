...
[← Compiling/Linking your software with the shared memory API](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9973.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compiling/Linking your software with the shared memory API →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9983.md)
...
<a name="AEN9985"></a>**Example 52-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN9989"></a>**Example 52-3. Linking C++ object files that use the
            daqshm library**
