...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42125.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42135.md)
...
<a name="AEN42226"></a>## Public member functions
...
<a name="AEN42337"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN42342"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r41403.md)
