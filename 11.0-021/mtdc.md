...
<a name="AEN57307"></a>## Name

mtdc -- Mesytec 32/34 channel TDC

<a name="AEN57310"></a>## Synopsis
...
`-edge` `rising | falling`Determines which signal edge is timed.
...
`-pulseron` `boolean`If true, the test pulser is active
