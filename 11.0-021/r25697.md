...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r25696.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r25706.md)
...
<a name="AEN26219"></a>## Public member functions
...
- <a name="AEN26226"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN26247"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN26260"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN26285"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN26296"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN26629"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN26642"></a>` ECLOutputSelect
...
- <a name="AEN26710"></a>` unsigned short
...
- <a name="AEN26874"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN26886"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN26896"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN26906"></a>` TriggerConfiguration
...
- <a name="AEN27003"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN27027"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN27044"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN27070"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN27084"></a>` PWResolution
...
- <a name="AEN27244"></a>` unsigned short
...
- <a name="AEN27338"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN27350"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN27367"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN27380"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN27392"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN27413"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN27425"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27440"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27455"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27470"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN27482"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN27497"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN27507"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN27519"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN27531"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN27543"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN27555"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN27565"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN27575"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN27585"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN27595"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN27607"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN27617"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN27627"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN27637"></a>` void EnableBypassOnError(void);`
- <a name="AEN27647"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN27657"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN27669"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN27679"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN27691"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN27701"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN27713"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN27725"></a>` void EnableAllChannels(void);`
- <a name="AEN27735"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN27745"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN27757"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN27769"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN27784"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN27796"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN27808"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN27829"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN27842"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN27859"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN27877"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN27892"></a>## Types and public data
