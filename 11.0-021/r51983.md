...
[← EVBC::initialize](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51982.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::initialize →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51992.md)
...
<a name="AEN51995"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN51998"></a>## Synopsis
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51766.md).

<a name="AEN52010"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51766.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r52044.md)).
