...
**-firmware** *path*The path to the stamp64.bit firmware file.

<a name="AEN66588"></a>## EXAMPLES

<a name="AEN66590"></a>**Example 1. Simple setup of a single timestamp module**
