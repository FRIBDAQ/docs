...
[← Launching the XLM72GateDelayControl](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x6761.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Overview of Functionality →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x6782.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/figures/gd16_startup.png)
...
To write the state of the GUI to a configuration file, you should simply
      ...
      displayed in the GUI. See the section [*The Saved File*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x6790.md)
