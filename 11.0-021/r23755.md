...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23910]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23910]].
...
[[portAllocator(3tcl)|r68636]],
            [[CPortManagerException(3daq)|r23910]],
            [[DaqPortManager(1tcl)|r15117]]
