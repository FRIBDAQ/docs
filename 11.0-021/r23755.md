...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23754.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManager →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23764.md)
...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23910.md) for
...
<a name="AEN23812"></a>## Public member functions
...
If a port could not be allocated (e.g. all are in use or the port manager could
                ...
                [CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23910.md).
...
<a name="AEN23856"></a>## Types and public data
...
<a name="AEN23888"></a>## Exceptions

The `CPortManagerException` is thrown to inform the
            program of most errors dected by this API.  For more information about
            this exception, see:  [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23910.md).

<a name="AEN23893"></a>## EXAMPLES

Allocates a port to MyApplication

<a name="AEN23897"></a>**Example 1. Allocating a port with the port manager**
...
<a name="AEN23901"></a>**Example 2. Listing the port allocatiosn on a system.**
...
<a name="AEN23904"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r68636.md),
            [CPortManagerException(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23910.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15117.md)
