...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r25329.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r25696.md)
...
<a name="AEN25467"></a>## Public member functions





- <a name="AEN25473"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25485"></a>`bool Xtest(void);const`
...
- <a name="AEN25497"></a>`bool Qtest(void);const`
...
- <a name="AEN25514"></a>`bool TimedOut(void);const`
...
- <a name="AEN25526"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25538"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25552"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25565"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25579"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25594"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25609"></a>`bool IT4(void);const`
...
- <a name="AEN25623"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25634"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25647"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25663"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25674"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25685"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25695"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25699"></a>**Example 1. Initializing branch 0**
