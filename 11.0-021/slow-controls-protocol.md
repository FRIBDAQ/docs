...
<a name="AEN44931"></a>## SUBCOMMANDS



Update *name*Asks the driver for the instance *name*
...
Set *name parameter-name value*Note the capital S in **Set** to
...
Get *name parameter-name*Returns the value of the parameter
                            *parameter-name* from
...
<a name="AEN44961"></a>## PARAMETERS FOR SUPPORTED DEVICES

<a name="AEN44963"></a>### ph7106
...
thresholdRepresents the single module threshold.

maskRepresents the module mask parameter.

modeRepresents the control mode of the device.
...
threshold*n*Represents the value of the threshold for
                                channel *n* e.g.
...
width*n*Represents the output width of channel
                                *n*.  Legal values
                                are in the range [0-255].

inhibitsRepresents the module inhibits mask.
...
majorityRepresents the majority level.  This value
