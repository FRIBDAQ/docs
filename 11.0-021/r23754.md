...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23909]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23909]].
...
[[portAllocator(3tcl)|r68635]],
            [[CPortManagerException(3daq)|r23909]],
            [[DaqPortManager(1tcl)|r15116]]
