...
[← Epics Channel logging](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7526.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The RingMaster server →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7541.md)
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [Service Port Manager](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7683.md)
            chapter.
...
Each element of the list reports on the usage of a single ring.
            ...
            [Tcl ring package's ringbuffer
                usage](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r16529.md) command.
