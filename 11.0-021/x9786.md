...
In addition to
            [[CInteractor|r36942]], the following
            concrete interactors have been supplied.



[[`CStringInteractor`|r37111]]This interactor supplies a string that you have gotten by
                        whatever means you got it.  It can be used when interactors
                        are not suitable for acquiring the stringified credentials.

[[`CFdInteractor`|r37272]]This interactor accepts the credentials via an open file
                        descriptor.

[[`CIOInteractor`|r37398]]This interator uses a pair of other interactors, an output and
