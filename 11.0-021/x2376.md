...
# <a name="AEN2376"></a>5.3. Writing device support software
...
<a name="AEN2381"></a>**Example 5-4. Obtaining the ccusb driver development kit**
...
<a name="AEN2387"></a>**Example 5-5. Using a user written CCUSB driver**
...
## <a name="AEN2402"></a>5.3.1. The driver onAttach method
...
[[x2376#ccusb-dtemplate-saveconfig]] `onAttach` needs to be able
...
## <a name="AEN2437"></a>5.3.2. The driver Initialize method
...
## <a name="AEN2470"></a>5.3.3. The driver addReadoutList method
...
## <a name="AEN2497"></a>5.3.4. Initializing the driver with the framework.
