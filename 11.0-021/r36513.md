...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36512.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTclAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r36522.md)
...
<a name="AEN36555"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9993.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r38303.md).
...
`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9993.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r39033.md).
...
<a name="AEN36605"></a>## Types and public data

`CTCLInterpreter`
            and
            `CTCLVariable`
            are objects that are part of the Tcl++ library. See the
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c9993.md) of the
