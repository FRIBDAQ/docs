...
[← CRingAccess](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r16335.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingAccess →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r16345.md)
...
<a name="AEN16347"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16350"></a>## Synopsis
...
<a name="AEN16426"></a>## Public member functions
...
<a name="AEN16517"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16521"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16525"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
