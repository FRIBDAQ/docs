...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54793.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [parameters →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r54942.md)
...
Each data source managed by a data source provider is specified
            ...
            returns a Tcl
            [dict](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/dict.md) that describes the set of parameters
            expected.
