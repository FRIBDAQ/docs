...
[← VMUSBReadout](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c744.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Providing EPICS channel information to Tcl Servers →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7469.md)
...
controlpush
      ...
      [the controlpush manpage](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r12944.md).

The intent is that 
      controlpush be pointed at a 
      TclServer.
[The TclServer](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c6979.md)
...
You can use 
      ...
      system parameters. 
      [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c7498.md) is an example
