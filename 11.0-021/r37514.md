...
[← URL](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37513.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [URL →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r37523.md)
...
<a name="AEN37518"></a>## Name

URL -- Parse Uniform Resource Identifiers (URI)

<a name="AEN37521"></a>## Synopsis
...
<a name="AEN37587"></a>## Public member functions
...
[The NSCL Exception class library](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c10051.md)
        chapter describes the exception class hierarchy, how to use it and
        its common set of interfaces.
        [The `CException`](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42346.md) reference
        page describes the `CException` class.
        [The `CURIFormatException`](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r42910.md)
