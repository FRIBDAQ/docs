...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51095.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51129.md)
...
<a name="AEN51132"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN51135"></a>## Synopsis

```
CControlHardware
```

<a name="AEN51202"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r50988.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51085.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN51209"></a>## METHODS
