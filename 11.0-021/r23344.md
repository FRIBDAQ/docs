...
[← CEvbClientApp](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23343.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEvbClientApp →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r23353.md)
...
<a name="AEN23348"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN23351"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN23381"></a>## DESCRIPTION
...
<a name="AEN23443"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
