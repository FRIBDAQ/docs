...
<a name="AEN15998"></a>### Configuration Options
...
<a name="AEN16022"></a>### Device Options
...
<a name="AEN16052"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN16068"></a>```
...
Retrieve the ID code for the board above<a name="AEN16073"></a>```
...
Load firmware and license it.<a name="AEN16080"></a>```
...
Retrieve license information from a digitizer.<a name="AEN16088"></a>```
...
Un-license a digitizer's firmware:<a name="AEN16093"></a>```
