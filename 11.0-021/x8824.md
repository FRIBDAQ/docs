...
[← The Event orderer/event builder API](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x8815.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Callbacks →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x8849.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x8824.md#evb_start_ap)
  Adds the Tcl Library directory of the NSCLDAQ to the
                          ...
                          tclsh or
                          wish starts.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x8824.md#evb_start_require)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x8824.md#evb_start_start)
