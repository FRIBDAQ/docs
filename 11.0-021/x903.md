...
[← Using TclRingBuffer in event driven software](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x8943.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [A simple example →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x9069.md)
...
- `--timestamplib`
  ...
  For more information about how to generate this library, see 
            [*Developing a Timestamp Extractor Library*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x1022.md).
