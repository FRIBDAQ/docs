...
[← Configuration](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r52413.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r52423.md)
...
<a name="AEN52426"></a>## Name

Configuration -- Configuration variable management

<a name="AEN52429"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r53957.md) package for that
            instead.

<a name="AEN52452"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r53957.md) is a better
                          choice).
