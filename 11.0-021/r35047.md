...
[← SyncGuard](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r35046.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r35056.md)
...
<a name="AEN35051"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35054"></a>## Synopsis
...
<a name="AEN35096"></a>## Public member functions
...
<a name="AEN35134"></a>`void sync_self(void);`
...
<a name="AEN35141"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35149"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35161"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35167"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35177"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35207"></a>`void sync_global_end(void);`
