...
<a name="AEN28424"></a>## Public member functions



<a name="AEN28429"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN28457"></a>`void  Enable(int nChannel);`
...
<a name="AEN28472"></a>`void  Disable(int nChannel);`
...
<a name="AEN28487"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN28500"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN28512"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN28524"></a>`void   SetWide (void);`
...
<a name="AEN28536"></a>`void   SetNarrow (void);`
...
<a name="AEN28547"></a>`void  EnableHeader (void);`
...
<a name="AEN28625"></a>`bool  isFull (void);`
...
<a name="AEN28637"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN28649"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN28742"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN28756"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
