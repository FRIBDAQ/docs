...
[← CCAENV830](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r28242.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV830 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r28252.md)
...
<a name="AEN28415"></a>## Public member functions



- <a name="AEN28420"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN28448"></a>`void  Enable(int nChannel);`
...
- <a name="AEN28463"></a>`void  Disable(int nChannel);`
...
- <a name="AEN28478"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN28491"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN28503"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN28515"></a>`void   SetWide (void);`
...
- <a name="AEN28527"></a>`void   SetNarrow (void);`
...
- <a name="AEN28538"></a>`void  EnableHeader (void);`
...
- <a name="AEN28616"></a>`bool  isFull (void);`
...
- <a name="AEN28628"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN28640"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN28733"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN28747"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
