...
<a name="AEN31846"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN31849"></a>## Synopsis
...
<a name="AEN31956"></a>## Public member functions



<a name="AEN31961"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
<a name="AEN31999"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
<a name="AEN32014"></a>`CVME<T>(const CVME& aCVME);`
...
<a name="AEN32027"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
<a name="AEN32040"></a>`int  operator==(const CVME<T>& aCVME);`
...
<a name="AEN32085"></a>`T*  T* operator-> (void);`
...
<a name="AEN32095"></a>`T&  operator[](UInt_t nOffset);`
...
<a name="AEN32110"></a>`CVME<T>& operator+(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32122"></a>`CVME<T>&  operator-(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32134"></a>`CVME<T>&  operator+=(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32146"></a>`CVME<T>&  operator-=(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32156"></a>## Types and public data
