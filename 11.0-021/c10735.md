...
# <a name="chap-sbsrdo"></a>Chapter 59. The SBS Readout framework
...
# <a name="AEN10746"></a>59.1. SBS Readout concepts
...
<a name="AEN11068"></a>**Example 59-1. Passing the ring buffer to the construction of an Event segment.**
...
<a name="AEN11104"></a>**Example 59-2. Creating Events**
...
| --- | --- | --- |
| Prev | Home | Next |
| EVBC state manager callback bundle. | Up | Obtaining and building the skeleton application |
