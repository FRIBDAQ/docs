...
[← EVBC::startRingSource](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51903.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startS800Source →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r51956.md)
...
Starts a fragment source that gets is data from a ring buffer.  For
            ...
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10583.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x10583.md#sec_tsextractors)
