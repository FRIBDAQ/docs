...
[← SBS Vme Tcl package](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15626.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SBS Vme Tcl package →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/r15636.md)
...
<a name="AEN15689"></a>### Map access command
...
<a name="AEN15699"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN15707"></a>***mapname* put *width offset value***
