...
[← Basic Tenets of VM-USB Operation](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x786.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing the Configuration Script →](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/x800.md)
...
Finally, the data transferred through the ring buffer is just
      ...
      have a structure defined later in [Chapter 3](https://github.com/FRIBDAQ/docs/tree/main/11.0-021/c183.md).
