...
# <a name="AEN11261"></a>60.1. Overview
...
ExtractionIn this stage the ring items are read from the data source.

Filtering / HandlingThe filtering or handling stage deals with how the ring items are to
...
InsertionThe final stage inserts the filtered ring items back into the data
