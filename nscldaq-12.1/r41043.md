...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r40238.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r41421.md)
...
<a name="AEN41182"></a>## Public member functions





- <a name="AEN41188"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN41200"></a>`bool Xtest(void);const`
...
- <a name="AEN41212"></a>`bool Qtest(void);const`
...
- <a name="AEN41229"></a>`bool TimedOut(void);const`
...
- <a name="AEN41241"></a>`bool BranchDemand(void);const`
...
- <a name="AEN41253"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN41267"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN41280"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN41294"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN41309"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN41324"></a>`bool IT4(void);const`
...
- <a name="AEN41338"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN41349"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN41362"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN41378"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN41389"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN41400"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN41410"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN41414"></a>**Example 1. Initializing branch 0**
