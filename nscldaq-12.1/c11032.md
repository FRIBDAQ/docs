...
# <a name="chapter.ringaccess"></a>Chapter 46. Networked ring buffer access
...
The size of the local proxy ringbuffer defaults to 8MB.  This can be modified
        by setting the environment variable NSCLDAQ_DEFAULT_PROXYMB
...
<a name="AEN11042"></a>**Example 46-1. A sample ring specification in URI form**
...
<a name="AEN11050"></a>**Example 46-2. Substituting local host for the hostname in URI's**
...
<a name="AEN11082"></a>**Example 46-3. Including the header**
...
<a name="AEN11085"></a>**Example 46-4. Compiling code that uses `CRingAccess`**
...
<a name="AEN11089"></a>**Example 46-5. Linking code that uses `CRingAccess`**
