...
[← mdpp32scp](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r89716.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMUSB →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r90603.md)
...
- `-irqeventthreshold` *0-32767*
  (From MDPP-32 PADC documentation) Every time the number of events in the FIFO
...
- `-irqdatathreshold` *0-32256*
  (From MDPP-32 PADC documentation) Every time the number of 32 bit words in
...
- `-maxtransfer` *0-32256*
  (From MDPP-32 PADC documentation) With
...
+-----------------------------------------+
  ...
  ```
  - Bit[1:0]
    (From MDPP-32 PADC documentation)
...
- `-outputformat` *0 | 1 | 2*
  - 0
    Time and peak amplitude data
  - 1
    Time only data
  - 2
    Peak amplitude only data
  By default, the value is 0.
...
+-----------------------------------------+
  ...
  The default value is 0x400.
- `-signalwidth`
*int[8] 8-2000 (in unit of 12.5 ns)*
  FWHM value of the input pulse in unit of 12.5 ns.
