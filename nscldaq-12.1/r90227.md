...
# <a name="vmusb3-mdpp32padc"></a>mdpp32padc

<a name="AEN90241"></a>## Name

mdpp32padc -- Mesytec MDPP-32 module with PADC firmware

<a name="AEN90244"></a>## Synopsis

**mdpp32padc create *name -base base [option1 value1 option2 value2 ...]*
**

**mdpp32padc config *name option value ...*
**

**mdpp32padc cget *name*
**

<a name="AEN90254"></a>## DESCRIPTION
...
`-irqeventthreshold` *0-32767*(From MDPP-32 PADC documentation) Every time the number of events in the FIFO
...
`-irqdatathreshold` *0-32256*(From MDPP-32 PADC documentation) Every time the number of 32 bit words in
                             the FIFO exceeds this threshold, an IRQ is emitted. Maximum allowed threshold
                             is "FIFO size".

"FIFO size" in the PADC documentation is 32k-512=32256.
...
`-maxtransfer` *0-32256*(From MDPP-32 PADC documentation) With
...
(From MDPP-32 PADC documnetation) The number of 32 bit words is always even.
...
Bit[1:0](From MDPP-32 PADC documentation)
...
0Time and peak amplitude data

1Time only data

2Peak amplitude only data
...
`-signalwidth`
*int[8] 8-2000 (in unit of 12.5 ns)*FWHM value of the input pulse in unit of 12.5 ns.
...
By default, the value is [list 80 80 80 80  80 80 80 80],
                             which is 6.4ns (80/12.5) for all channels.

`-threshold` *int[32] 1-65535*
...
<a name="AEN90593"></a>## EXAMPLES

<a name="AEN90595"></a>**Example 1. Sample MDPP-32 PADC commands**

```
set signalWidth         [list 80 80 80 80  80 80 80 80]
...
mdpp32padc create padc -base 0x00030000
mdpp32padc config padc -signalwidth $signalWidth \
                     -threshold $threshold \
...
Defines a module with base address 0x00030000.
                 ...
                 used to configure the module (padcJumper
                 is not used).
