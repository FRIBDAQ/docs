...
[← More detail on when the fragments are ouptutted](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6146.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the Event Builder With The Manager →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6232.md)
