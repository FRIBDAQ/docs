...
# <a name="AEN3508"></a>6.3. Writing device support software
...
<a name="AEN3513"></a>**Example 6-4. Obtaining the ccusb driver development kit**
...
<a name="AEN3519"></a>**Example 6-5. Using a user written CCUSB driver**
...
## <a name="AEN3534"></a>6.3.1. The driver onAttach method
...
[[x3508#ccusb-dtemplate-saveconfig]] `onAttach` needs to be able
...
## <a name="AEN3569"></a>6.3.2. The driver Initialize method
...
## <a name="AEN3602"></a>6.3.3. The driver addReadoutList method
...
## <a name="AEN3629"></a>6.3.4. Initializing the driver with the framework.
