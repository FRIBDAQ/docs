...
<a name="AEN108021"></a>## DESCRIPTION
...
<a name="AEN108024"></a>## PACKAGE COMMANDS

The commands below share many of the same parameters:



*b*Is a branch number.  For the CES CBD 8210 this is the
                        number set in the front panel branch number switch.

*c*A CAMAC crate number on some branch.  This is set in the
...
*vmecrate*A VME crate number in which at least one
