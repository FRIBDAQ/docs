...
<a name="AEN106285"></a>## DESCRIPTION
...
**::CFD812::Map** *base name crate=0*Creates a connection between a module at the specified
            `base` address
...
**::CFD812::Unmap** *name*Breaks the connection with the module `name`
...
**::CFD812::SetThreshold** *name channel value*Sets the threshold for a
...
**::CFD812::SetWidth** *name bank value*Sets the width of a
...
**::CFD812::SetDeadtime** *name bank value*Sets the `deadtime`
              of a `bank`
...
**::CFD812::SetMask** *name mval*Sets the enable mask of the module
              `name` to
              `mval`.
...
**::CFD812::SetMultiplicityThreshold** *name value*Sets the majority logic threshold of
                `name` to `value`

**::CFD812::GetSerialNumber** *name*Returns the serial number of the module
                `name`.

**::CFD812::GetBase** *name*Returns the base address of the module
                `name`

<a name="AEN106391"></a>## SEE ALSO

[[caenv812control(1tcl)|r26526]],
        [[caenv812gui(3tcl)|r106397]],
        [[loadcfd(1tcl)|r26556]]
