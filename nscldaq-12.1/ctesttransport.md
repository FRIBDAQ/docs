...
# <a name="AEN68562"></a>CTestTransport

<a name="AEN68566"></a>## Name

CTestTransport -- Transport class for test purposes.

<a name="AEN68569"></a>## Synopsis
...
<a name="AEN68595"></a>## TYPES and PUBLIC DATA

The following data types are public:



messageThis represents a message or a message
...
multipartMessageThis type represents a sent message
                        which can have more than one part.
                        It's defined as a
                        `std::vector<message>`.

messageListThis is a list of simple messages.
...
`std::vector<multiPartMessage>`This type is used to represent messages
                        that have been sent.
