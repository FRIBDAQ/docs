...
<a name="AEN51256"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN51259"></a>## Synopsis
...
<a name="AEN51301"></a>## Public member functions
...
<a name="AEN51339"></a>`void sync_self(void);`
...
<a name="AEN51346"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN51354"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN51366"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN51372"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN51382"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN51412"></a>`void sync_global_end(void);`
