...
[← ringFragmentSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21438.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ScalerDisplay →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21576.md)
...
The input event file is assumed to have come from the output
                of
                [*glom*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21333.md) in event
