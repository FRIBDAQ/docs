...
[← containers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r101614.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [sequence →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r102056.md)
...
- **program::replace *db oldname newname path type host ?options?* **
  Replaces the program named `oldname`
