...
## <a name="AEN2274"></a>5.8.1. Writing C++ device support software
...
<a name="AEN2282"></a>**Example 5-6. Obtaning the VM-USB device driver development kit**
...
<a name="AEN2291"></a>**Example 5-7. Using a user written VMUSB driver**
...
### <a name="AEN2305"></a>5.8.1.1. The driver `onAttach` method
...
### <a name="AEN2336"></a>5.8.1.2. The driver `Initialize` method
...
<a name="AEN2353"></a>**Example 5-8. The template driver `Initialize` method**
...
### <a name="AEN2361"></a>5.8.1.3. The driver `addReadoutList` method
...
<a name="AEN2372"></a>**Example 5-9. Template Driver `addReadoutList` method**
...
[[x2269#vmusb-dtemplate-initsuccess]]                        The **load** or
                    ...
                    [[x2269#vmusb-dtemplate-endccall]]                        Ends the extern "C" {  block.

## <a name="AEN2448"></a>5.8.2. Writing device support software in Tcl
...
### <a name="AEN2468"></a>5.8.2.1. An Incr-Tcl (itcl) driver
...
<a name="AEN2471"></a>**Example 5-11. Itcl VM-USB device driver**
...
[[x2269#vmusb-itcldrv-initialize]] `Initialize` implements
                    ...
                    [[x2269#vmusb-itcldrv-vmusbreadled]]                        Invokes the `readLEDSource`
                    ...
                    [[x2269#vmusb-itcldrv-addrdolist]]                        The `addReadoutList` method
...
### <a name="AEN2559"></a>5.8.2.2. A Snit Is Not Incr Tcl (snit) driver
...
<a name="AEN2563"></a>**Example 5-12. A Snit VM-USB driver.**
...
[[x2269#vmusb-snit-constructor]] **constructor** methods are called
...
### <a name="AEN2651"></a>5.8.2.3. Using a Tcl driver in a DAQ configuration script
...
<a name="AEN2668"></a>**Example 5-13. USing a Tcl VM-USB driver.**
