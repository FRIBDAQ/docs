...
[← SBS VME Module level device support software](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c13764.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The CES CBD 8210 Tcl CAMAC Package →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c13817.md)
...
This chapter describes how to incorporate a pure Tcl package
        ...
        of the
        [the TCL Vme package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c10422.md) that provides
        access to the CAEN VME CAENet controller (V288).   For reference
        information see
        [caenet(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r107887.md)
