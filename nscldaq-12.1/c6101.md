...
[← ReadoutGUI & ReadoutShell](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c5223.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBLite -  light event building →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c6249.md)
...
The client programs that submit data to the server are built using the
      [event builder client
        framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c15514.md). In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [ringFragmentSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15780.md) program. This
