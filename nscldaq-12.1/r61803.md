...
[← CURIFormatException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r61608.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CInvalidArgumentException →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r61948.md)
...
The NSCL DAQ base software includes support for an object model
            ...
            chapter;
            [NSCL DAQ Thread Library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c14136.md).
...
`CMonitorException`
            is derived from the
            [CException](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r60994.md)
