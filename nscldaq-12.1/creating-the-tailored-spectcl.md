...
# <a name="AEN8002"></a>14.4. Creating the tailored SpecTcl
...
## <a name="AEN8010"></a>14.4.1. Decoding raw TDC data
...
### <a name="AEN8033"></a>14.4.1.2. Creating the raw unpacker class

Here is the header for our raw unpacker
                    (event processor) pipeline stage:

<a name="AEN8036"></a>**Example 14-9. Raw TDC unpacker (RawUnpacker.h)**
...
<a name="AEN8068"></a>**Example 14-10. v775 raw unpacker implementation includes and defs (RawUnpacker.cpp)**
...
<a name="AEN8090"></a>**Example 14-11. V775 raw unpacker - getLong utility (RawUnpacker.cpp)**
...
<a name="AEN8096"></a>**Example 14-12. V775 raw unpacker object constructor/destructor (RawUnpacker.cpp)**
...
[[x8002#v775_rawimpl_constructor]]                            The constructor is required to initialize the reference
                            ...
                            t.00 ... t.31.
                        [[x8002#v775_rawimpl_destructor]]                            If an object is ever destroyed, its tree parameter
                            array musb be destroyed as well to prevent
                            memory leaks.

<a name="AEN8109"></a>**Example 14-13. v75 raw unpacker unpacking events (RawUnpacker.cpp)**
...
[[x8002#v775_rawimpl_funtorsignature]]                            The `operator()` method
...
[[x8002#v775_rawimpl_storeparam]]                            Tree parameter array objects mimic arrays to the
                        ...
                        [[x8002#v775_rawimple_trailer]]                            The data words from the TDC should be followed by
                            a trailer.  This code asserts that this is the
                            case.

### <a name="AEN8197"></a>14.4.1.3. Adding the unpacker to the analysis pipeline
...
### <a name="AEN8219"></a>14.4.1.4. Creating raw time spectra
...
<a name="AEN8228"></a>**Example 14-14. Defining raw Time spectra the hard way.**
...
### <a name="AEN8301"></a>14.4.1.5. Building and testing what we have so far.
...
## <a name="AEN8339"></a>14.4.2. Producing parameters computed from the raw data
...
<a name="AEN8352"></a>**Example 14-15. Header for time difference event processor (Tdiff.h)**
...
<a name="AEN8365"></a>**Example 14-16. CTdiff implementation (Tdiff.cpp)**
