...
<a name="AEN44169"></a>## Public member functions



<a name="AEN44174"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN44202"></a>`void  Enable(int nChannel);`
...
<a name="AEN44217"></a>`void  Disable(int nChannel);`
...
<a name="AEN44232"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN44245"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN44257"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN44269"></a>`void   SetWide (void);`
...
<a name="AEN44281"></a>`void   SetNarrow (void);`
...
<a name="AEN44292"></a>`void  EnableHeader (void);`
...
<a name="AEN44370"></a>`bool  isFull (void);`
...
<a name="AEN44382"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN44394"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN44487"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN44501"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
