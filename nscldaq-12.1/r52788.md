...
[← CUnixUserCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r52567.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r52892.md)
...
`Constructs a Tcl Access list authenticator.
                ...
                see the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r56671.md).
...
`Returns a pointer to the
                ...
                objects, see
               the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r57451.md).
