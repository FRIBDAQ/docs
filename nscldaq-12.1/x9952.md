...
[[![(1)](../images/callouts/1.gif)|x9952#lgcppapi_header]]                  The LogBook.h file contains a definition
                ...
                [[![(5)](../images/callouts/5.gif)|x9952#lgcppapi_exists]]                  The `LogBook`::`kvExists`
                ...
                [[![(7)](../images/callouts/7.gif)|x9952#lgcppapi_catch]]                  The `LogBook::Exception` is derived from
...
[[![(1)](../images/callouts/1.gif)|x9952#tclapilow_shell]]                  If you just set a Tcl script executable but
...
[[![(1)](../images/callouts/1.gif)|x9952#tclapihi_prev]]                     This code appeared in
                     [[**kvexamplelow.tcl* low level Tcl logbook API example*|x9952#ex.tclapilow]].
                     We won't explain it again here.  Refer to that example
                     if you need to understand it.
                [[![(2)](../images/callouts/2.gif)|x9952#tclapihi_1param]]                     Unlike [[**kvexamplelow.tcl* low level Tcl logbook API example*|x9952#ex.tclapilow]],
                     we refer to the current logbook.  Therefore we only need one
                     parameter, the key to retrieve.
                [[![(3)](../images/callouts/3.gif)|x9952#tclapihi_exists]]                     This checks that the key exists.  It does this by creating
                ...
                [[![(4)](../images/callouts/4.gif)|x9952#tclaphihi_get]]                     The `kvGet` proc returns the value of
                     a key if it exists.
