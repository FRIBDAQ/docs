...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgcppapi_header)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgcppapi_usage)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgcppapi_try)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgcppapi_construct)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgcppapi_exists)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgcppapi_get)
...
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgcppapi_catch)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_shell)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_libpath)
  This line adds the NSCLDAQ Tcl package library path to the
                    set of paths searched by **package require**.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_require)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_usage)
  Our script requires two parameters, the logbook filename
                       and a key in the key value store.  This ensures both are
                       present.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_open)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_exist)
  The subcommands of a logbook instance command ensemble
                       ...
                       **$instance kvExists** command checks to see
                       ...
                       if not.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_get)
  Similarly a logbook instance command ensemble's
                       **kvGet** subcommand returns the value of a
                       key.
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapilow_destroy)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapihi_prev)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapihi_1param)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclapihi_exists)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#tclaphihi_get)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgpyapi_sys)
  This package provides access to the raw command line words
                    via the `sys.argv` array.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgpyapi_import)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgpyapi_args)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgpyapi_filename)
  As described above we fish the logbook filename from the
                    command arguments.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9952.md#lgpyapi_key)
