...
[← EVBC::configParams](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r79317.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3rdogui →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r79399.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r79154.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r78978.md) to create the ring
             sources.
