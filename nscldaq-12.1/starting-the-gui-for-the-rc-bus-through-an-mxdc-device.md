...
# <a name="AEN8929"></a>16.3. Starting the GUI for the RC-bus through an MxDC device
...
5. The user will then be presented with the following display and should
   ...
   <a name="mcfd16control_fig1"></a>**Figure 16-2. MCFD16Control Graphical User Interface for MxDC-RCbus**
