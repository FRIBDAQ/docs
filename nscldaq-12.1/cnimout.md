...
<a name="AEN49007"></a>## Public member functions
...
<a name="AEN49137"></a>## Types and public data
...
CNimout::DATASelects the NIM data register (offset 0 in the module).

CNimout::STROBESelects the NIM Strobe mask register (offset 2 in the module).

CNimout::TIMINGSelects the strobe timing register of the module (offset 4 in the module).

CNimout::CONTROLSelects the control status register (offset 6 in the module).

<a name="AEN49164"></a>## Issues and defects
