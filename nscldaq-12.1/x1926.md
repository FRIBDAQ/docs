...
[← Pipeline Building, Run Control, and DAQ Modularization](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x19.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running the VMUSBReadout program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x1971.md)

---

---

# <a name="AEN1926"></a>5.4. The Slow-Controls Subsystem
...
<a name="AEN1938"></a>**Example 5-2. A Sample Controls Configuration**
...
If a user wants to write their own module for the slow-controls subsystem,
      ...
      [*Extending the slow controls subsystem*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x2682.md).

## <a name="AEN1947"></a>5.4.1. Using Remote Procedure Calls To Execute Stacks

There are numerous slow-controls modules availabe for use with the
        Module command (see [Module(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r98023.md)). Because of its
...
- `CVMUSBReadoutList`
  Instances of this class represent lists of VME operations you want
                to perform via the server.  See [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r92605.md) for reference
                information.
- `CVMUSBRemote`
  ...
  See [*CVMUSBRemote*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r93510.md)
