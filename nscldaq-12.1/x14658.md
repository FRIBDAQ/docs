...
| Prev | Chapter 62. Shared memory | Next |


---

# <a name="shm_compile"></a>62.2. Compiling/Linking your software with the shared memory API
...
<a name="AEN14669"></a>**Example 62-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN14673"></a>**Example 62-3. Linking C++ object files that use the
            daqshm library**
