...
[← mtdc](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r86835.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [madcchain →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r87796.md)
...
- `-ecltiming` *onoff*
  ...
  The default value is false.
- `-eclgate1osc` *0,1*
  0 - Gate 1 input, 1 - Oscillator input.
  Setting this option to 1 automatically sets Bit 1 of ts_sources register
                    (0x6096) to 1.
  Only valid when `-customecl` is `true`.
                    The default value is 0.
- `-eclfcreset` *0,1,2*
  0 - Fast clear input(="not Gate"), 1 - Reset timestamp counter,
                    2 - input for experiment trigger.
  Only valid when `-customecl` is `true`.
                    The default value is 0.
- `-customecl` *onoff*
  When true, ECL_gate1_osc and ECL_FC_Reset registers become customizable.
...
- `-nimfcreset` *0,1,2*
  ...
  Only valid when `-customnim` is true.
                    The default value is 0.
- `-customnim` *onoff*
  When true, NIM_gate1_osc and NIM_FC_Reset registers become customizable.
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r87267.md#mqdccreate)
  This command creates an object to manage an MQDC-32
                  ...
                  qdc.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r87267.md#mqdctiming)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r87267.md#mqdcmakethresh)
  This highlights the fact that the configuration file is
                  ...
                  some external file.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r87267.md#mqdcthresholds)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r87267.md#mqdcirqconfig)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r87267.md#mqdcirqrdo)
