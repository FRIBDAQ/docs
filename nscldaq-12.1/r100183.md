...
[← sis3316](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r100035.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [USB Control operations →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r100285.md)
...
- `-port`
  The number of the port on which the server is listening for
                      ...
                      [*USB Control operations*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r100285.md)
                      and
                      [*slowControlsPrompter*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r100346.md)
...
- ***$object* Get *device channel***
  ...
  The *$object* is the object
                          ...
                          `controlClient`
                          instance.
- ***$object*Set *device channel value***
