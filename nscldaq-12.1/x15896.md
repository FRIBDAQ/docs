...
[← API layer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15889.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EZBuilder →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15932.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15896.md#evbbundle.require)
  Incorporates the package code into your script.  This makes
                      all three APIs visible and accessible from your script.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15896.md#evbbundle.register)
  Informs the state manager that you will be using the
                      ...
                      callback bundle.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15896.md#evbbundle.onstart)
  The `OnStart` proc is called from the
                      ReadoutGUI when it makes a transition to the
                      Halted state from
                      NotReady.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15896.md#evbbundle.initialize)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15896.md#evbbundle.registerringsource1)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15896.md#evbbundle.registerringsource2)
  This line adds an event sources using the convenience
