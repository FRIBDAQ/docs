...
[← LogBookShift](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r37573.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBookNote →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r38237.md)
...
In [*LogBookShift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r37573.md)
...
- int `s_id`
  Primary key of the transition in the transition table.
                    See the [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r113275.md)
                    reference page for the full logbook schema.
- int `s_transition`
  An integer that describes the transition see
                    [*State transition values*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r37746.md#daq3.logbookrun.trantbl)
...
- LogBookShift* `s_onDuty`
  Pointer to a `LogBookShift` object
                    ...
                    [*LogBookShift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r37573.md)
