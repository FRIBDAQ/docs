...
[← Interpreting the dumper output](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x8870.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for the RC-bus through an MxDC device →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x8929.md)

---

---

# <a name="AEN8912"></a>16.2. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN8922"></a>**Figure 16-1. The MCFD16Control Graphical User Interface for USB**
   ![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/figures/MCFD16Control-USBHowTo-0.png)
