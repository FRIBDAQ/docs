...
# <a name="AEN5223"></a>Chapter 8. ReadoutGUI & ReadoutShell
...
Reference material on the API provided by the ReadoutShell can be found in
      the [[r79401]] man page section.

# <a name="AEN5240"></a>8.1. Principles of operation
...
<a name="rdogui_statediagram"></a>**Figure 8-1. ReadoutShell's state diagram**
...
| --- | --- | --- |
| Prev | Home | Next |
| Supported Scaler modules | Up | Operating the user interface |
