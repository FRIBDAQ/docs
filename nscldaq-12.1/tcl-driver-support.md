...
<a name="AEN86354"></a>## Name

tcl driver support -- tcl driver support functions.

<a name="AEN86357"></a>## Synopsis
...
**::VMUSBDriverSupport::convertVmUSBReadoutList *name***Converts a CVMUSBReadoutList swig object identifier into
...
**::VMUSBDriverSupport::validInt *value ?low ?high??***Provides type checking and optional range checking for
...
**::VMUSBDriverSupport::validReal *value ?low ?high??***Provides type and optional range checking for
                        real parameters.
...
**::VMUSBDriverSupport::valideEnum *value set***Throw an error if `value` is not
                        one of the strings  in the Tcl list `set`

**::VMUSBDriverSupport::validBool *value***Throws an error if `value` is not
