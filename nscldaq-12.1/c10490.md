...
[[![(1)](../images/callouts/1.gif)|c10490#chapter.sequencer.env]]	         The global `env` array contains a 
		 ...
		 variable.
	      ...
	      [[![(3)](../images/callouts/3.gif)|c10490#chapter.sequencer.path]]	         This line pre-pends the NSCL DAQ Tcl library
		 ...
		 packages will be found first.
	      [[![(4)](../images/callouts/4.gif)|c10490#chapter.sequencer.require]]	         This line actually loads the sequencer package.
