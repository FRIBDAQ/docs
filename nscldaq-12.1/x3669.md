...
# <a name="AEN3669"></a>6.4. Tcl device driver support
...
## <a name="AEN3673"></a>6.4.1. Conceptual background
...
<a name="AEN3716"></a>**Example 6-6. A snit CCUSB device driver module**
...
## <a name="AEN3802"></a>6.4.3. A sample Incr-Tcl Tcl CCUSB framework driver
...
<a name="AEN3813"></a>**Example 6-7. CCUSB device support example writtin in Incr Tcl**
...
[[x3669#ccusb-itcl-initialize]]                        The `Initialize` method
                    ...
                    [[x3669#ccusb-itcl-addmarker]]                        In Incr Tcl, options are just member variables.
                        Therefore when the marker is added ot the stack,
                        $value substitutes the
                        selected value.

## <a name="ccusb-general-tcldriver-usage"></a>6.4.4. Using Tcl drivers in the DAQ configuration file.
...
<a name="AEN3924"></a>**Example 6-8. DAQ config script fragment with tcl drivers.**
