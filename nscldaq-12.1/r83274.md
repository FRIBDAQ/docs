...
[← Program](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r83178.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBook.Person →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r83692.md)
...
This section allows you to create and retrieve people from the logbook.
         ...
         [*LogBook.Person*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r83692.md).
...
The Shift part of the API manipulates collections of people that
         ...
         [*LogBook.Shift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r83736.md) reference page.
...
Runs are segments of data taking.  They are encapsulated with
         ...
         [*LogBook.Run*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r83812.md).
...
Notes are incapsulated in `LogBook.Note` objects.
         ...
         [*LogBook.Note*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r84011.md).
