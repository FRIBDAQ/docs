...
ringbufferThis utility allows you to create, re-initialize, delete  and
            ...
            don't already exist. See the [[r18871]] for more information.
...
dumperProvides a simple textual formatted dump of the buffers.  If you
            ...
            each event and the packets within the event. See [[c10185]] and [[r21903]] for more information.

eventlogPerforms native mode event loggging.  In this mode, event file
            segments consists of streams of ring buffer items. See [[c10249]] and [[r22016]] for more information.
...
ringselectorProvides a flexible ringbuffer consumer that pipes the ring items
            ...
            applications like SpecTcl. See [[c10580]] and [[r22270]] for more information.
...
ringtostdoutAccepts data from a ring and pipes it to stdout.  This is the server
            ...
            process data from  a ring. See the [[r18998]] for more information.
...
ScalerDisplayProvides a display of scaler event data.  This application is highly
            ...
            selected scalers are also supported. See [[c6367]] and [[r21576#manpage.scalerdisplay]] for more information.

stdintoringAccepts data on stdin and puts it in a ring buffer.  This is the
            client side of the data pipeline that sets up a proxy ring. See the [[r19062]] for more information.
