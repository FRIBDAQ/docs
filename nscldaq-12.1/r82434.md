...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r82274.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [start →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r82461.md)
...
Each data source managed by a data source provider is specified
            ...
            returns a Tcl
            [dict](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/dict.md) that describes the set of parameters
            expected.
