...
[← The Ring Item Types](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x328.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Pushing external data into the event stream →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x3377.md)
...
There are a number of frameworks for building C++ applications. First
      there is the [SBS Readout Framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c15936.md),
      ...
      data format. To facilitate the design of filter programs, the [Filter framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c16460.md) exists. It handles the
