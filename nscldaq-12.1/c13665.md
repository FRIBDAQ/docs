...
hostname of host on which the slow-controls server is running

portport on which the slow-controls server is listening

modnamename of ccusb module loaded into the CCUSBReadout program
