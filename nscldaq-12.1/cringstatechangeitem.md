...
<a name="AEN29873"></a>## Public member functions
...
<a name="AEN30113"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN30116"></a>**Example 1. Creating a begin run state transition item**
