...
[← Writing Tcl slow controls device drivers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x4470.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Supported Event Modules →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x4908.md)
...
<a name="intro.ccusbcamac"></a>Now that you have been introduced to the slow-controls server and how to
        ...
        [Slow controls subsystem section](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x3927.md#ccusb.slowcontrols.intro),
...
Reference material is available at
        [ccusbcamac(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r78539.md).
