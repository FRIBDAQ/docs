...
[← unglom](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21529.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [dumper →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21903.md)
...
- `::scalerconfig::highAlarmColor`
  Background color for channels that are alarming
  			    ...
  			    alarmed channel does not, at this time, affect the
  			    tab color for pages containing the channel.
- `::scalerconfig::lowAlarmTabColor`
  The color for tabs on pages that are displaying
                  channels that are in low rate alarm.  The
                  default color is green.
- `::scalerconfig::highAlarmTabColor`
  Color for tabs on pages that are displaying channels that
                  are in high rate alarm.  THe default color is red.
- `::scalerconfig::bothAlarmTabColor`
  Color for tabs on pages that are displaying channels
