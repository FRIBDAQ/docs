...
<a name="AEN38806"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN38809"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN38839"></a>## DESCRIPTION
...
<a name="AEN38901"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
