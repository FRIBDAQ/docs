...
[← EVBC::registerRingSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r78978.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startS800Source →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r79124.md)
...
Starts a fragment source that gets its data from a ring buffer.  For
            ...
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15780.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15780.md#sec_tsextractors)
