...
Please use the [[*EVBC::registerRingSource*|r78978]] instead of this proc.

Starts a fragment source that gets its data from a ring buffer.  For
            more on ring fragment sources see:
            [[*ringFragmentSource - a prepackaged client for ringbuffer data sources*|x15780]]
...
*extractor-lib*Specifies the file system path to the shared object
                            ...
                            [[*Writing and building timestamp extractors.*|x15780#sec_tsextractors]]
