...
This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r71937]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r77708]])
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r77708]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r77708]] for
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r75186]] for reference
...
[[CCCUSB(3ccusb)|r71937]]
[[cccusbreadoutlist(3ccusb)|r77708]]
[[CCCUSBReadoutList(3ccusb)|r75186]]
