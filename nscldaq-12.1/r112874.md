...
# <a name="AEN112874"></a>Container Description File

<a name="AEN112878"></a>## Name

Container Description File -- Describe containes to Manager configuration container wizard

<a name="AEN112881"></a>## Synopsis
...
<a name="AEN112883"></a>## INTRODUCTION
...
<a name="AEN112890"></a>## Configuration file format
...
native_treeWhere the /usr/opt directories live in the native file system.

container_treewhere the /usr/opt directories get mapped in the containerized
...
path (Mandatory)The value of this key is the path to the container image in
                  the host filesystem.

usropt (Mandatory)The directory that should be bound to /usr/opt in the
...
bindings (Optional)If specified these are additional bindings that will be made
...
<a name="AEN112934"></a>## EXAMPLE

This example shows a configuration file that's part of the FRIB
         configuration file:

<a name="AEN112937"></a>**Example 1. Sample Container Configuration File**
...
| --- | --- | --- |
| Prev | Home | Next |
| DAQ manager database schema | Up | Readouts REST |
