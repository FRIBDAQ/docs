...
[← Remote control package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6064.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [More detail on when the fragments are ouptutted →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6146.md)
...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c15873.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r78831.md).
...
The next thing that you need to do is register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x15780.md).
