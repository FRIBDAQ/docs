...
<a name="AEN106553"></a>## Name

n568b -- Support package for the CAEN N568B shaper.

<a name="AEN106556"></a>## Synopsis
...
**::n568b::Id *controller node***Returns the node id string of a module.  See the N568b manual
...
**::n568b::GetOffset *controller node***Returns the current value of the  module's  common  offset.
...
**::n568b::GetMuxStatus *controller node***Returns the output multiplexor status of the module.
...
**::n568b::SetFineGain *controller node channel value***Sets the fine gain for
                    `channel` to
                    `value`.

**::n568b::SetCoarseGain *controller node channel value***Sets  the coarse gain for channel to value.
...
**::n568b::SetPole0 *controller node channel value***Set the pole 0 correction magnitude for
                    `channel` to
                    `value`.

**::n568b::SetShapingTime *controller node channel value***Set the shaping time for channel to value.
                    Valid value can be:
...
**::n568b::SetPolarity *controller node channel value***Set the the polarity of
                    `channel` to
                    `value`.
                    A value of
                    0 means positive,
...
**::n568b::SetOutputConfiguration *controller node channel value***Sets the output configuration of
                    `channel`.  If
                    `value` is
                    0, the output is direct.  If 1,  inverted.

**::n568b::SetOffset *controller node value***Sets the module common offset.

**::n568b::EnableMuxOut *controller node***Enables  the multiplexed output.  Note that the channel
...
**::n568b::DisableMuxOut *controller node***Disables the multiplexor output

<a name="AEN106730"></a>## SEE ALSO

[[loadshaper(1tcl)|r26701]],
        [[n568control(1tcl)|r26729]],
        [[n568panel(3tcl)|r106737]],
        [[caennet(3tcl)|r107887]]
