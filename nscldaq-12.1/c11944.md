...
# <a name="AEN11944"></a>Chapter 50. DAQ Manager APIs
...
# <a name="sec.manager.dbapi"></a>50.1. Manager Configuration Database API
...
<a name="AEN11966"></a>**Example 50-1. Setting the TCLLIBPATH environment variable for tclsh**
...
<a name="AEN11972"></a>**Example 50-2. Adding DAQTCLLIBS to auto_path**
...
- The [[c11944#sec.manager.containers]]
...
## <a name="sec.manager.containers"></a>50.1.1. The containers package.
...
<a name="ex.sqlite3cmd"></a>**Example 50-3. Creating an SQLite3 database command**
...
<a name="AEN12041"></a>**Example 50-4. Creating a container definition for buster**
...
<a name="AEN12084"></a>**Example 50-5. Using containers To Make a RingBuffer.**
...
## <a name="sec.manager.programs"></a>50.1.2. The programs package
...
<a name="AEN12225"></a>**Example 50-6. Adding a New Program Definition**
...
<a name="AEN12269"></a>**Example 50-7. Initialization Script to start Readout REST servers**
...
<a name="AEN12279"></a>**Example 50-8. Listing Program Definitions**
...
<a name="AEN12293"></a>**Example 50-9. Starting Programs in the programs Package**
...
## <a name="sec.manager.sequence"></a>50.1.3. The **sequence** package
...
- What a state machine is, and the default state machine
                    ...
                    [[c11944#sec.sequence.statemachine]]
...
<a name="AEN12371"></a>**Table 50-1. Default Manager State Machine**
...
### <a name="sec.sequence.stateapi"></a>50.1.3.2. The State machine API
...
The three procs that support modifying the state machine are
               ...
               **newTransition** which defines a new transition
               ...
               See [[c11944#sec.sequence.seqapi]]
...
<a name="AEN12413"></a>**Example 50-10. Adding a PAUSED State**
...
### <a name="sec.sequence.seqapi"></a>50.1.3.3. The Sequence API
...
<a name="AEN12446"></a>**Example 50-11. Defining A Boot Sequence**
...
### <a name="sec.sequence.transition"></a>50.1.3.4. The Transition API
...
<a name="AEN12472"></a>**Example 50-12. Booting the System.**
...
### <a name="sec.sequence.misc"></a>50.1.3.5. Miscellaneous API Entries.
...
<a name="AEN12509"></a>**Example 50-13. Using Miscellaneous Sequence Facilities**
...
[[c11944#ex.seq.misc.getmgr]] **::sequence::getCurrentTransition**
                     ...
                     empty string.
                   [[c11944#ex.seq.misc.lseq]] **::sequence::listSequences**
...
## <a name="sec.manager.kvstore"></a>50.1.4. The kvstore package
...
<a name="AEN12584"></a>**Example 50-14. Using the kvstore package**
...
[[c11944#ex.kvstore.require]]                  This and the next line import the packages needed
                ...
                [[c11944#ex.kvstore.modify]] **kvstore::modify** changes the value
...
## <a name="sec.manager.auth"></a>50.1.5. The auth package.
...
<a name="AEN12636"></a>**Example 50-15. Program Using the auth Package**
...
## <a name="sec.manager.eventloggers"></a>50.1.6. The eventloggers Package.
...
<a name="AEN12744"></a>**Figure 50-1. Full logger directory tree**
...
<a name="AEN12750"></a>**Example 50-16. Sample Eventloggers Program**
...
[[c11944#ex.evlog.require]]                  Requires the packages needed to make this program
                ...
                [[c11944#ex.evlog.add]] **eventlog::add** adds a new event logger
...
[[c11944#ex.evlog.rm]] **eventlog::rm** is used to remove
