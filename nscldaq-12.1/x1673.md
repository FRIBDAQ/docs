...
[← Getting Data](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x16670.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuring SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x17586.md)
...
This script assumes the appropriate  daqsetup.bash
      ...
      the [*EVBRest*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21076.md)
      program which runs the orderer stage with a REST interface plugin.
      The second stage of the pipeline run the **glom** program
      described in
      [*glom*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21093.md).
...
Use [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r19223.md)
...
For more information; see
      [*ringFragmentSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21438.md)
...
**Making a Program to Shutdown The Event Builder. **
        The [*EVBShutdown*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r21052.md)
...
**Adding the Event Builder Shutdown to a SHUTDOWN Sequence . **
        Using [*mg_seqedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r19308.md)
