...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r39444.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CADC2530 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r39766.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r39444.md)).
        Since it  is  derived
       from
       `CException`,
