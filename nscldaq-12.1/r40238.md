...
<a name="AEN40252"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN40255"></a>## Synopsis
...
<a name="AEN40481"></a>## Public member functions





<a name="AEN40487"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN40549"></a>`unsigned long getBase(void);`
...
<a name="AEN40560"></a>`int getSerial(void);`
...
<a name="AEN40591"></a>`int  getFirmware(void);`
...
<a name="AEN40601"></a>`int  getCrate(void);`
...
<a name="AEN40612"></a>`void setCrate(int crateNum);`
...
<a name="AEN40625"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN40646"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN40656"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN40666"></a>`void keepOverflowData(void);`
...
<a name="AEN40676"></a>`void discardOverflowData(void);`
...
<a name="AEN40686"></a>`void keepInvalidData(void);`
...
<a name="AEN40697"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN40708"></a>`void commonStart(void);`
...
<a name="AEN40719"></a>`void commonStop(void);`
...
<a name="AEN40730"></a>`void setRange(int range);`
...
<a name="AEN40743"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN40815"></a>`void clearData
                                (void);`
...
<a name="AEN40858"></a>`bool Busy(void);`
...
<a name="AEN40869"></a>` bool gBusy(void);`
...
<a name="AEN40880"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN40891"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN40902"></a>`int readEvent(void* buf);`
...
<a name="AEN40915"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN40956"></a>`void enableSmallThresholds(void);`
...
<a name="AEN41019"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN41023"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN41027"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN41031"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN41035"></a>**Example 3. Reading out a CAEN 785 e.g.**
