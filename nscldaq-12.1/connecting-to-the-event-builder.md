...
# <a name="evb-connecting"></a>51.3. Connecting to the event builder.

The code below shows how to connect to the event builder as
                a client:

<a name="AEN13354"></a>**Example 51-1. 
