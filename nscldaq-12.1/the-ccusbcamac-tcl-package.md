...
# <a name="AEN4668"></a>6.9. The ccusbcamac Tcl package
...
<a name="intro.ccusbcamac"></a>Now that you have been introduced to the slow-controls server and how to
        ...
        [[x3927#ccusb.slowcontrols.intro]],
...
## <a name="AEN4693"></a>6.9.1. Incorporating ccusbcamac in your scripts.
...
## <a name="AEN4728"></a>6.9.2. Using ccusbcamac
...
<a name="AEN4745"></a>**Example 6-30. Enabling a module Lam with ccusbcamac**
...
| --- | --- | --- |
| Prev | Home | Next |
| Writing Tcl slow controls device drivers | Up | Non stack VMUSB Readout framwork$DAQBIN/VMUSBnostackReadout |
