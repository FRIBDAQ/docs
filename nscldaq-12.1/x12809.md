...
- [[![(7)](../images/callouts/7.gif)|x12809#ex.staterest.transition]]
...
- [[![(8)](../images/callouts/8.gif)|x12809#ex.staterest.destroy]]
...
- [[![(1)](../images/callouts/1.gif)|x12809#ex.pgmstat.require]]
  To use the package it must be pulled into the script via
                    the **package require** command shown.
- [[![(2)](../images/callouts/2.gif)|x12809#ex.pgmstat.construct]]
...
- [[![(3)](../images/callouts/3.gif)|x12809#ex.pgmstat.status]]
...
- [[![(4)](../images/callouts/4.gif)|x12809#ex.pgmstat.destroy]]
...
- [[![(1)](../images/callouts/1.gif)|x12809#ex.kvclient.require]]
  In order to make calls to the Key Value REST client API,
                    the kvclient package must be pulled into the
                    program.
- [[![(2)](../images/callouts/2.gif)|x12809#ex.kvclient.mktitle]]
...
- [[![(3)](../images/callouts/3.gif)|x12809#ex.kvclient.construct]]
...
- [[![(4)](../images/callouts/4.gif)|x12809#ex.kvclient.settitle]]
...
- [[![(5)](../images/callouts/5.gif)|x12809#ex.kvclient.list]]
  The `list` method dumps the entire
                    ...
                    key value store key.
- [[![(6)](../images/callouts/6.gif)|x12809#ex.kvclient.destroy]]
...
- [[![(1)](../images/callouts/1.gif)|x12809#ex.lgclient.require]]
...
- [[![(3)](../images/callouts/3.gif)|x12809#ex.lgclient.list]]
  The `listLoggers` method of a logger
                    ...
                    destination is required, by the API to be unique and is used
                     ...
                     loggers.
- [[![(4)](../images/callouts/4.gif)|x12809#ex.lgclient.enable]]
...
- [[![(5)](../images/callouts/5.gif)|x12809#ex.lgclient.record]]
  The `record` method sets the state of
                    the global recording flag.
- [[![(6)](../images/callouts/6.gif)|x12809#ex.lgclient.start]]
...
- [[![(7)](../images/callouts/7.gif)|x12809#ex.lgclient.destroy]]
