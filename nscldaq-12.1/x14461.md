...
[← Authenticators](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x14416.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compiling/Linking your software with the shared memory API →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x14658.md)
...
Interactors are classes that are concrete classes derived
            ...
            [`CInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r53234.md).
...
In addition to
            [CInteractor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r53234.md), the following
            concrete interactors have been supplied.



- [`CStringInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r53413.md)
...
- [`CFdInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r53584.md)
  This interactor accepts the credentials via an open file
                          descriptor.
- [`CIOInteractor`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r53720.md)
