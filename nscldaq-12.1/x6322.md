...
[← evbtagger - making event builder fragments from ring items.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6300.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Why does it exist? →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6372.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6322.md#evblite.require)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x6322.md#evblite.instance)
...
- -insid 0
  `-insid` specifies the input source id.  If non physics items are found
