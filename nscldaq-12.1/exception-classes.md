...
| Prev | Chapter 68. The NSCL Exception class library | Next |


---

# <a name="AEN14916"></a>68.2. Exception classes
...
<a name="AEN14941"></a>**Example 68-1. Catching `CException` and exiting**
...
| --- | --- | --- |
| Prev | Home | Next |
| The NSCL Exception class library | Up | Parallel programming framework |
