...
<a name="AEN47741"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN47744"></a>## Synopsis
...
<a name="AEN47851"></a>## Public member functions



<a name="AEN47856"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
<a name="AEN47894"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
<a name="AEN47909"></a>`CVME<T>(const CVME& aCVME);`
...
<a name="AEN47922"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
<a name="AEN47935"></a>`int  operator==(const CVME<T>& aCVME);`
...
<a name="AEN47980"></a>`T*  T* operator-> (void);`
...
<a name="AEN47990"></a>`T&  operator[](UInt_t nOffset);`
...
<a name="AEN48005"></a>`CVME<T>& operator+(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN48017"></a>`CVME<T>&  operator-(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN48029"></a>`CVME<T>&  operator+=(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN48041"></a>`CVME<T>&  operator-=(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN48051"></a>## Types and public data
