...
# <a name="AEN4043"></a>6.7. Writing C++ slow controls device drivers
...
## <a name="AEN4059"></a>6.7.1. Obtaining the sample driver and its Makefile
...
<a name="AEN4064"></a>**Example 6-9. Obtaining the sample CCUSB slow controls driver**
...
## <a name="AEN4082"></a>6.7.2. Modifying the sample driver and Makefile.
...
### <a name="AEN4101"></a>6.7.2.1. Driver Code
...
<a name="AEN4104"></a>**Example 6-10. Headers for the CCUSB sample slow controls driver**
...
[[x4043#ccusb-slowdriver-includes-tcl.h]]                            Since our driver will get loaded via the Tcl
                        ...
                        [[x4043#ccusb-slowdriver-includes-CModuleFactory.h]]                            The `CModuleFactory` class is
...
[[x4043#ccusb-slowdriver-includes-CModuleCreator.h]]                            This header defines the base class for all module
                        ...
                        [[x4043#ccusb-slowdriver-includes-CControlHardware.h]]                            Drivers are classes that are derived from
                            ...
                            (see
                            [[r78145]]
[[x4043#ccusb-slowdriver-includes-CControlModule.h]]                            The makeup of a `CControlHardware`
...
#### <a name="AEN4144"></a>6.7.2.1.1. The driver class and its implementation
...
<a name="AEN4147"></a>**Example 6-11. CCUSB Slow control driver class definition **
...
[[x4043#ccusb-slowdriver-def-onattach]]                                The `OnAttach` method is
...
**Construction and destruction. **
                            See
                            [[x4043#ccusb-slowdriver-impl-condestruct]]
                            for the actual implementation of these methods in the
                            sample driver.

<a name="ccusb-slowdriver-impl-condestruct"></a>**Example 6-12. 
...
[[x4043#ccusb-slowdriver-impl-constr-baseinit]]                                The constructor must initialize the base
                            ...
                            [[x4043#ccusb-slowdriver-impl-constr-configinit]]                                The `m_pConfig` member variable
...
<a name="AEN4228"></a>**Example 6-13. CCUSB Slow controls driver `OnAttach`**
...
<a name="AEN4262"></a>**Example 6-14. CCUSB Slow controls driver initialize method**
...
<a name="AEN4274"></a>**Example 6-15. CCUSB Slow controls driver Update**
...
<a name="AEN4302"></a>**Example 6-16. CCUSB Slow controls driver Set method**
...
[[x4043#cccusb-slowdriver-impl-set-configure]]                                Our driver uses the configuration database
...
[[x4043#cccusb-slowdriver-impl-set-ok]]                                On success, the `Set`
...
<a name="AEN4337"></a>**Example 6-17. CCUSB slow controls Get method**
...
[[x4043#ccusb-slowdriver-impl-get-error]]                                The `cget` method throws
...
<a name="AEN4362"></a>**Example 6-18. CCUSB Slow controls clone method**
...
#### <a name="AEN4370"></a>6.7.2.1.2. The creator class and its implementation
...
<a name="AEN4381"></a>**Example 6-19. Module creator for the CCUSB Sample slow controls driver**
...
<a name="AEN4411"></a>**Example 6-20. CCUSB Slow control driver initialization function**
...
### <a name="AEN4441"></a>6.7.2.2. The Makefile and typical modifications.
...
<a name="AEN4447"></a>**Example 6-21. CCUSB Slow controls driver Skeleton Makefile**
