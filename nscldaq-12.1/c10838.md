...
# <a name="chapter.ringmaster"></a>Chapter 43. The RingMaster server
...
# <a name="AEN10851"></a>43.1. The RingMaster Protocol
...
<a name="AEN10873"></a>**Example 43-1. The CONNECT message format**
...
<a name="AEN10888"></a>**Example 43-2. Format of the DISCONNECT message**
...
<a name="AEN10902"></a>**Example 43-3. Format of the LIST command**
...
<a name="AEN10954"></a>**Example 43-4. Format of the REGISTER command**
...
<a name="AEN10964"></a>**Example 43-5. Format of the UNREGISTER message**
...
<a name="AEN10976"></a>**Example 43-6. Format of the REMOTE message**
...
2. The ring master will have treated a request for
                           ...
                           via that socket.
3. The data received on the data transfer socket
...
`CRingAccess` does, however, require that
