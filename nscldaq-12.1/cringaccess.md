...
<a name="AEN27631"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN27634"></a>## Synopsis
...
<a name="AEN27707"></a>## Public member functions
...
<a name="AEN27798"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN27802"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN27806"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
