...
[← waitForRing](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r101592.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [programs →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r101783.md)
...
- **container::add *db name image initfile mountpoints***
  ...
  The `mountpoints` parameter is a
                      ...
                      --bind point:where).
- **container::replace *db oldname newname image initfile mountpoints***
  Replaces the container named `oldname`
