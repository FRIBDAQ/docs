...
[← bells](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r79515.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQParameters →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r79735.md)
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r81308.md) package for that
            instead.
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r81308.md) is a better
                          choice).
