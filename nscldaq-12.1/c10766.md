...
[← Compatibility utilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c10661.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The epics display utility →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c10804.md)
...
controlpush
      ...
      [the controlpush manpage](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r23758.md).

The intent is that 
      controlpush be pointed at a 
      TclServer.
[The TclServer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c10279.md)
...
You can use 
      ...
      system parameters. 
      [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/c10804.md) is an example
