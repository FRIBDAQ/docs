...
# <a name="AEN11716"></a>49.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN11722"></a>**Example 49-1. Including a ring item class **
...
<a name="AEN11729"></a>**Example 49-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN11734"></a>**Example 49-3. Linking the ring item format libraries**
...
[[r28692]]Base class for all the ring data item format classes.
...
[[r29677]]Represents a state change item.  Given a reference to
...
[[r29180]]Represents a state change item.  Given a reference to a
...
[[r30119]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[r31706]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[r30481]]Encapsulates the data taken in response to a physics
                        trigger.

[[r31039]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[r30677]]Encapsulates an item that gives information about the
...
[[r31354]]Encapsulates an event fragment produced by the event
                        builder ordering stage for which there's good reason to
                        believe the payload is not a ring item.

## <a name="AEN11806"></a>49.3.1. Generic ring data sources
