...
[← Data conversion](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x14099.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the library into an application. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x14245.md)
...
- [*Starting Readout with REST at BOOT*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x1411.md#sec.mgr.bootreadout)
              describes how to setup Readout to run the REST plugin as a manager program and
              add it to
              a sequence attached to the BOOT transition.
- [*Controlling Readout From the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x1411.md#sec.mgr.readoutctl)
...
**Specifying a Readout Program to the Manager. **
            The program editor [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r19223.md)
...
- [*mg_startloggers*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r19771.md)
...
- [*rdo_runFromKv*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r19791.md)
  Asks a single readout program to set its run number to the
                    ...
                    Run control panel.
- [*rdo_titleFromKv*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r19823.md)
...
- [*rdo_control*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/r19855.md)
