...
[← Saving and restoring state](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x8974.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for USB communication →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.1/x9003.md)
