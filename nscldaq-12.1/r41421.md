...
<a name="AEN41953"></a>## Public member functions
...
<a name="AEN41960"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN41981"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN41994"></a>` unsigned char getVersion(void);const`
...
<a name="AEN42019"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN42030"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN42376"></a>` ECLOutputSelect
...
<a name="AEN42444"></a>` unsigned short
...
<a name="AEN42608"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN42620"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN42630"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN42640"></a>` TriggerConfiguration
...
<a name="AEN42737"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN42778"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN42804"></a>` LEResolution
...
<a name="AEN42818"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN42978"></a>` unsigned short
...
<a name="AEN43072"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN43084"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN43101"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN43114"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN43126"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN43147"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN43159"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN43174"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN43189"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN43204"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN43216"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN43231"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN43241"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN43253"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN43265"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN43277"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN43289"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN43299"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN43309"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN43319"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN43329"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN43341"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN43351"></a>` void
                    EnableErrorMark(void);`



<a name="AEN43361"></a>` void
                    DisableErrorMark(void);`



<a name="AEN43371"></a>` void EnableBypassOnError(void);`



<a name="AEN43381"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN43391"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN43403"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN43413"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN43425"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN43435"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN43447"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN43459"></a>` void EnableAllChannels(void);`



<a name="AEN43469"></a>` void
                    DisableAllChannels(void);`



<a name="AEN43479"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN43491"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN43503"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN43518"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN43530"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN43542"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN43563"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN43576"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN43593"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN43611"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN43626"></a>## Types and public data
