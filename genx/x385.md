...
[← Code generated for Root](https://github.com/FRIBDAQ/docs/tree/main/genx/x303.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Putting this all together for SpecTcl and Root. →](https://github.com/FRIBDAQ/docs/tree/main/genx/x388.md)

---

---

# <a name="AEN385"></a>4.3. Putting this all together for SpecTcl and Root.
...
## <a name="AEN389"></a>4.3.1. Setting up the project
...
## <a name="AEN412"></a>4.3.2. Code in the TopLevel directory.
...
<a name="AEN416"></a>**Example 4-22. event.decl - event declaration file for the example:**
...
<a name="AEN420"></a>**Example 4-23. Makefile - generating code from event.decl**
...
<a name="AEN426"></a>**Example 4-24. unpacker.cpp - example unpacker**
...
## <a name="AEN429"></a>4.3.3. SpecTcl event processor and unpacker.
...
<a name="AEN449"></a>**Example 4-25. SpecTcl/CUnpackerWrapper.h**
...
<a name="AEN457"></a>**Example 4-26. SpecTcl/CUnpackerWrapper.cpp**
...
<a name="AEN463"></a>**Example 4-27. SpecTcl/MySpecTclApp.cpp - AnalysisPipeline**
...
<a name="AEN469"></a>**Example 4-28. SpecTcl/Makefile**
...
## <a name="AEN481"></a>4.3.4. Ring item reader, and unpacker to make trees.
...
<a name="AEN499"></a>**Example 4-29. Root/process.cpp modifications**
...
<a name="AEN505"></a>**Example 4-30. Root/processor.cpp modifications**
...
<a name="AEN510"></a>**Example 4-31. Root/Makefile**
...
## <a name="AEN522"></a>4.3.5. Full contents of all of the files we wrote/modified
...
<a name="AEN530"></a>**Example 4-32. Full listing of TopLevel/event.decl**
...
<a name="AEN534"></a>**Example 4-33. Full listing of TopLevel/Makefile**
...
<a name="AEN538"></a>**Example 4-34. Full listing of TopLevel/unpacker.cpp**
...
<a name="AEN545"></a>**Example 4-35. TopLevel/SpecTcl/CUnpackerWrapper.h**
...
<a name="AEN549"></a>**Example 4-36. TopLevel/Spectcl/CUnpackerWrapper.cpp**
...
<a name="AEN553"></a>**Example 4-37. TopLevel/SpecTcl/MySpecTclApp.cpp (comments removed)**
...
<a name="AEN557"></a>**Example 4-38. TopLevel/SpecTcl/Makefile**
...
<a name="AEN564"></a>**Example 4-39. TopLevel/Root/process.cpp**
...
<a name="AEN568"></a>**Example 4-40. TopLevel/Root/processor.cpp (comments removed)**
...
<a name="AEN572"></a>**Example 4-41. TopLevel/Root/Makefile**
