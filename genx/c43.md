...
[[![(3)](../images/callouts/3.gif)|c43#decl.simplemember1]][[![(4)](../images/callouts/4.gif)|c43#decl.simplemember2]]									The simplest kind of members are
...
[[![(5)](../images/callouts/5.gif)|c43#decl.arraymember1]][[![(8)](../images/callouts/8.gif)|c43#decl.arraymember2]]									Structure members can also be arrays of simple values
...
[[![(6)](../images/callouts/6.gif)|c43#dec.structmember]]									As with C/C++ structs, a member of a struct can be another struct.
									...
									Tb.
								[[![(7)](../images/callouts/7.gif)|c43#decl.structarraymember]]									Finally the structarray keyword can be used
...
[[![(10)](../images/callouts/10.gif)|c43#decl.simpleinstance]]									As with structure members, simple value instances are defined using the
								...
								[[**(12)**|c43#decl.structinstance]] structinstance is used to declare instances of structs.
...
[[**(13)**|c43#decl.structarrayinstance]] structarrayinstance declares an instance that
