...
# <a name="chapter.sequencer"></a>Chapter 25. Sequencing runs
...
# <a name="AEN1304"></a>25.1. Configuring the sequencer.
...
<a name="AEN1349"></a>**Example 25-1. Loading the sequencer package**
...
| --- | --- | --- |
| Prev | Home | Next |
| The Scaler Display Client | Up | Using the sequencer. |
