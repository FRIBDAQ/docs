...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r12452.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRangeError →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r12616.md)
...
<a name="AEN12543"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN12547"></a>## Synopsis

```
CErrnoException
```

<a name="AEN12574"></a>## Description
...
<a name="AEN12583"></a>## Public member functions
