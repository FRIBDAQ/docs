...
[← CInvalidArgumentException](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r13336.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAuthenticator →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r13796.md)
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r13470.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r13470.md#daqshm-varsrefsect).
