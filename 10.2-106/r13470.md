...
<a name="AEN13474"></a>## Name

CDAQShm -- class description

<a name="AEN13477"></a>## Synopsis

```
CDAQShm
```

<a name="AEN13579"></a>## DESCRIPTION
...
| --- | --- | --- |
| Prev | Home | Next |
| CInvalidArgumentException | Up | CAuthenticator |
