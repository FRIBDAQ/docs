...
<a name="AEN60635"></a>## Name

cvmusb -- SWIG Tcl wrapping of `CVMUSB`

<a name="AEN60639"></a>## Synopsis
...
Creates a new CVMUSB object given a `usbdevice`
                gotten from
                **::cvmusb::CVMUSB_usb_device_vector_get**.
...
Same as
                `::cvmusb::CVMUSB_uint32_vector_get` but
...
Same as `::cvmusb::CVMUSB_uint32_vector_size`
...
| --- | --- | --- |
| Prev | Home | Next |
| CConfigurableObject | Up | cvmusbreadoutlist |
