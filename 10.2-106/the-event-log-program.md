...
# <a name="chap.eventlog"></a>Chapter 21. The Event log program
...
<a name="AEN1189"></a>**Example 21-1. Taking data from a remote ring**
...
| --- | --- | --- |
| Prev | Home | Next |
| Utilities for burning data to DVD | Up | Theringselectorapplication |
