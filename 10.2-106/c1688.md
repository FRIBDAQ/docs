...
[← The Tcl ring package](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c1673.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Shared memory →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c1749.md)

---

---

# <a name="chapter.exception"></a>Chapter 31. The NSCL Exception class library
...
```
        ...
        # <a name="AEN1709"></a>31.1. Incorporating the library in your programs
