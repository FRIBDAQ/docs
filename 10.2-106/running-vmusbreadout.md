...
`-serialno`Specifies the serial number of the VMUSB the program
...
`--host`If specified, the value is the name or IP address on
...
| --- | --- | --- |
| Prev | Home | Next |
| Pushing external data into the event stream | Up | Reference Pages |
