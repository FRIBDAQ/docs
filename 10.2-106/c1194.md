...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c1164.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Scaler Display Software. →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c1269.md)
...
The ringselector application is very
        ...
        [ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r6743.md)
        application.  Both
...
For a complete reference on the command see the
        [ringselector reference page](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r7934.md).
