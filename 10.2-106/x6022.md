...
[[![(1)](../images/callouts/1.gif)|x6022#vmusb-itcldrv-auto-path]]                        In order to locate the SWIG wrappers of the
                        `CVMUSB` and
...
[[![(6)](../images/callouts/6.gif)|x6022#vmusb-itcldrv-option]]                        C++ device support modules provide a set of
...
[[![(7)](../images/callouts/7.gif)|x6022#vmusb-itcldrv-constructor]]                        Constructor methods are analagous to C++ constructors.
...
[[![(8)](../images/callouts/8.gif)|x6022#vmusb-itcldrv-initialize]] `Initialize` implements
                        ...
                        *pointer* that represents the address
                        ...
                        driver methods.
                    [[![(9)](../images/callouts/9.gif)|x6022#vmusb-itcldrv-wrapvmusb]]                        This linexcomp contructs a SWIG wrapping of a
                        `CVMUSB` object.  The
                    ...
                    [[![(10)](../images/callouts/10.gif)|x6022#vmusb-itcldrv-vmusbreadled]]                        Invokes the `readLEDSource`
                    ...
                    [[**(12)**|x6022#vmusb-itcldrv-addrdolist]]                        The `addReadoutList` method
...
[[![(1)](../images/callouts/1.gif)|x6022#vmusb-snit-apath]]                        In order to load the packages that wrap the
                        `CVMUSB` and
...
[[![(6)](../images/callouts/6.gif)|x6022#vmusb-snit-option]]                        Snit objects all have a built in
...
[[![(7)](../images/callouts/7.gif)|x6022#vmusb-snit-constructor]] **constructor** methods are called
...
[[![(8)](../images/callouts/8.gif)|x6022#vmusb-snit-init]]                        The `Initialize` method
