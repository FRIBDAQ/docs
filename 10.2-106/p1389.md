...
- 29. [[Ring Buffer Primitives|c1553]]
  ...
  - 29.2. [[Overview and Examples of ring buffers in action.|x1590]]
    - 29.2.1. [[A Ring Buffer Consumer|x1590#AEN1599]]
    - 29.2.2. [[A Ring Buffer Producer|x1590#AEN1648]]
...
- 37. [[Event builder client API|c2217]]
  ...
  - 37.6. [[The Event orderer/event builder API|x2405]]
    - 37.6.1. [[Starting the event builder/orderer|x2405#AEN2413]]
  - 37.7. [[Callbacks|x2439]]
    - 37.7.1. [[Connection callbacks|x2439#AEN2442]]
    - 37.7.2. [[Establishing the disconnect callback|x2439#AEN2460]]
- 38. [[Format of Event Data In Ring Buffers|c2475]]
  - 38.1. [[The basic data formats|c2475#AEN2489]]
    - 38.1.1. [[State Change Items|c2475#AEN2577]]
    - 38.1.2. [[Text List Items|c2475#AEN2617]]
    - 38.1.3. [[Scaler Items|c2475#AEN2666]]
    - 38.1.4. [[Event Data Items|c2475#AEN2699]]
    - 38.1.5. [[Event count items|c2475#AEN2706]]
  - 38.2. [[Selecting Data From a Ring Buffer|x2716]]
  - 38.3. [[Incorporating the headers and libraries into your applications.|x2744]]
    - 38.3.1. [[Generic ring data sources|x2744#AEN2806]]
