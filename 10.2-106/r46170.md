...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r46317]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r46317]].
...
[[portAllocator(3tcl)|r64221]],
            [[CPortManagerException(3daq)|r46317]],
            [[DaqPortManager(1tcl)|r10485]]
