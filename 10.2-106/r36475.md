...
<a name="AEN36479"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN36482"></a>## Synopsis
...
<a name="AEN36708"></a>## Public member functions





<a name="AEN36714"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN36776"></a>`unsigned long getBase(void);`
...
<a name="AEN36787"></a>`int getSerial(void);`
...
<a name="AEN36818"></a>`int  getFirmware(void);`
...
<a name="AEN36828"></a>`int  getCrate(void);`
...
<a name="AEN36839"></a>`void setCrate(int crateNum);`
...
<a name="AEN36852"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN36873"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN36883"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN36893"></a>`void keepOverflowData(void);`
...
<a name="AEN36903"></a>`void discardOverflowData(void);`
...
<a name="AEN36913"></a>`void keepInvalidData(void);`
...
<a name="AEN36924"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN36935"></a>`void commonStart(void);`
...
<a name="AEN36946"></a>`void commonStop(void);`
...
<a name="AEN36957"></a>`void setRange(int range);`
...
<a name="AEN36970"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN37042"></a>`void clearData
                                (void);`
...
<a name="AEN37085"></a>`bool Busy(void);`
...
<a name="AEN37096"></a>` bool gBusy(void);`
...
<a name="AEN37107"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN37118"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN37129"></a>`int readEvent(void* buf);`
...
<a name="AEN37142"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN37183"></a>`void enableSmallThresholds(void);`
...
<a name="AEN37246"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN37250"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN37254"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN37258"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN37262"></a>**Example 3. Reading out a CAEN 785 e.g.**
