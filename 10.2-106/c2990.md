...
[← The NSCL Exception class library](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c2929.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The NSCL Exception class library →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c3048.md)

---

---

# <a name="chapter.tclplus"></a>Chapter 41. C++ encapsulation of a Tcl API subset
