...
<a name="AEN21265"></a>## Public member functions
...
<a name="AEN21438"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN21441"></a>**Example 1. Creating a begin run state transition item**
