...
# <a name="AEN1904"></a>33.3. Interactors
...
In addition to
            [[r14719]], the following
            concrete interactors have been supplied.



[[r14888]]This interactor supplies a string that you have gotten by
                        whatever means you got it.  It can be used when interactors
                        are not suitable for acquiring the stringified credentials.

[[r15049]]This interactor accepts the credentials via an open file
                        descriptor.

[[r15175]]This interator uses a pair of other interactors, an output and
...
| --- | --- | --- |
| Prev | Home | Next |
| Authenticators | Up | C++ encapsulation of a Tcl API subset |
