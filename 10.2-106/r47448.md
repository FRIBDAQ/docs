...
[← EVB::deadsource](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4736.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Slow controls protocol →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r47490.md)
...
The Module command creates and manipulates instances of slow
            ...
            and `name`.  Currently the following device types
            are supported:
