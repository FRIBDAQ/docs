...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c292.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [C++ encapsulation of a Tcl API subset →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c2990.md)

---

---

# <a name="chapter.exception"></a>Chapter 40. The NSCL Exception class library
...
```
        ...
        # <a name="AEN2950"></a>40.1. Incorporating the library in your programs
