...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r36475.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r37638.md)
...
<a name="AEN37399"></a>## Public member functions





- <a name="AEN37405"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN37417"></a>`bool Xtest(void);const`
...
- <a name="AEN37429"></a>`bool Qtest(void);const`
...
- <a name="AEN37446"></a>`bool TimedOut(void);const`
...
- <a name="AEN37458"></a>`bool BranchDemand(void);const`
...
- <a name="AEN37470"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN37484"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN37497"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN37511"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN37526"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN37541"></a>`bool IT4(void);const`
...
- <a name="AEN37555"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN37566"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN37579"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN37595"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN37606"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN37617"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN37627"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN37631"></a>**Example 1. Initializing branch 0**
