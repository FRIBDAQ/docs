...
- Initialize the package and invoke its commands
                  ...
                  the ReadoutGUI|r7076]] describes ReadoutCallouts.tcl
                  scripts more fully.
...
- [[![(1)](../images/callouts/1.gif)|x2888#s800_autopath]]
...
- [[![(2)](../images/callouts/2.gif)|x2888#s800_init]]
...
- [[![(3)](../images/callouts/3.gif)|x2888#s800_onbegin]]
  The `OnBegin` proc in
...
- [[![(4)](../images/callouts/4.gif)|x2888#s800_onend]]
