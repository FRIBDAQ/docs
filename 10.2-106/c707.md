...
[← Providing EPICS channel information to Tcl Servers](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c669.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cratelocator →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c806.md)
...
The
        ...
        [epicsdisplay reference page](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r726.md)

epicsdisplay reads in a configuration file.
        The configuration file is compatible with
        [the controlpush](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r8257.md) application,
