...
| Prev | Chapter 55. CCUSB Readout framework | Next |


---

# <a name="AEN5455"></a>55.4. Tcl device driver support
...
## <a name="AEN5459"></a>55.4.1. Conceptual background
...
<a name="AEN5502"></a>**Example 55-6. A snit CCUSB device driver module**
...
## <a name="AEN5588"></a>55.4.3. A sample Incr-Tcl Tcl CCUSB framework driver
...
<a name="AEN5599"></a>**Example 55-7. CCUSB device support example writtin in Incr Tcl**
...
[[x5455#ccusb-itcl-initialize]]                        The `Initialize` method
                    ...
                    [[x5455#ccusb-itcl-addmarker]]                        In Incr Tcl, options are just member variables.
                        Therefore when the marker is added ot the stack,
                        $value substitutes the
                        selected value.

## <a name="ccusb-general-tcldriver-usage"></a>55.4.4. Using Tcl drivers in the DAQ configuration file.
...
<a name="AEN5710"></a>**Example 55-8. DAQ config script fragment with tcl drivers.**
