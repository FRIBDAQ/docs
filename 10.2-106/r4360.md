...
[← CScaler](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r43574.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStatusModule →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r43681.md)
...
Starts a fragment source that gets is data from a ring buffer.  For
            ...
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x4145.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x4145.md#sec_tsextractors)
