...
<a name="AEN11462"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN11465"></a>## Synopsis
...
<a name="AEN11541"></a>## Public member functions
...
<a name="AEN11632"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN11636"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN11640"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
