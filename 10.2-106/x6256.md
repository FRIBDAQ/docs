...
[← Writing device support software in Tcl](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x6022.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Pushing external data into the event stream →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x6297.md)
...
- `CVMUSBReadoutList`
  Instances of this class represent lists of VME
                              ...
                              See [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r57342.md)
...
- `CVMUSBRemote`
  ...
  See [*CVMUSBRemote*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r58237.md)
