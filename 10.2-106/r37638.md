...
<a name="AEN38160"></a>## Public member functions
...
<a name="AEN38167"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN38188"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN38201"></a>` unsigned char getVersion(void);const`
...
<a name="AEN38226"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN38237"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN38583"></a>` ECLOutputSelect
...
<a name="AEN38651"></a>` unsigned short
...
<a name="AEN38815"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN38827"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN38837"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN38847"></a>` TriggerConfiguration
...
<a name="AEN38944"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN38985"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN39011"></a>` LEResolution
...
<a name="AEN39025"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN39185"></a>` unsigned short
...
<a name="AEN39279"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN39291"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN39308"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN39321"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN39333"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN39354"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN39366"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN39381"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN39396"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN39411"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN39423"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN39438"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN39448"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN39460"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN39472"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN39484"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN39496"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN39506"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN39516"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN39526"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN39536"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN39548"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN39558"></a>` void
                    EnableErrorMark(void);`



<a name="AEN39568"></a>` void
                    DisableErrorMark(void);`



<a name="AEN39578"></a>` void EnableBypassOnError(void);`



<a name="AEN39588"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN39598"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN39610"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN39620"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN39632"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN39642"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN39654"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN39666"></a>` void EnableAllChannels(void);`



<a name="AEN39676"></a>` void
                    DisableAllChannels(void);`



<a name="AEN39686"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN39698"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN39710"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN39725"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN39737"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN39749"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN39770"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN39783"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN39800"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN39818"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN39833"></a>## Types and public data
