...
[← CCrateController](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r42069.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::start →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4255.md)
...
<a name="AEN42561"></a>## Public member functions
...
- <a name="AEN42584"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN42594"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN42605"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN42616"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN42628"></a>` void SetLatchMode(void);const`
...
- <a name="AEN42640"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN42675"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN42744"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN42755"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN42766"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN42777"></a>` void Clock(void);const`
...
- <a name="AEN42788"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN42799"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN42810"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN42822"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN42833"></a>` unsigned long Read(void);const`
...
- <a name="AEN42845"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
