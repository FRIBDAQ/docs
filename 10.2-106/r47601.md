...
[← EVB::reviveSocket](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4751.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::flush →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4766.md)
...
<a name="AEN47605"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN47608"></a>## Synopsis

```
CCCUSB
```

<a name="AEN48584"></a>## DESCRIPTION
...
`
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r50336.md))
...
`
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r50336.md) for
...
<a name="AEN49142"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN49146"></a>### Action Register
...
<a name="AEN49189"></a>### Firmware Register
...
<a name="AEN49241"></a>### Global Mode Register
...
<a name="AEN49374"></a>### Delay Register
...
<a name="AEN49407"></a>### Scaler Control register
...
<a name="AEN49440"></a>### LED Source Register
...
<a name="AEN49692"></a>### Output source selection register.
...
<a name="AEN49861"></a>### Device source register
...
<a name="AEN50214"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN50275"></a>### Transfer setup register
