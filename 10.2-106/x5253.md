...
[← Running a readout application](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x5208.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing device support software →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x5294.md)

---

---

# <a name="AEN5253"></a>55.2. Writing DAQ configuration files
...
<a name="AEN5257"></a>**Example 55-1. Creating and configuring devices**
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r47320.md) command
            in the reference material for detailed information about how
            to create and configure stacks.

To continue with the previous example:

<a name="AEN5280"></a>**Example 55-2. Configuring an event stack**
...
<a name="AEN5291"></a>**Example 55-3. Setting up a scaler stack**
