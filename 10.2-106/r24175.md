...
[← CRangeError](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r24037.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStreamIOError →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r24274.md)
...
<a name="AEN24179"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN24182"></a>## Synopsis

```
CStateException
```

<a name="AEN24212"></a>## Description
...
<a name="AEN24222"></a>## Public member functions
