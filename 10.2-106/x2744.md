...
[[`CRingItem`|r20487]]Base class for all the ring data item format classes.
...
[[`CRingStateChangeItem`|r21133]]Represents a state change item.  Given a reference to
...
[[`CRingScalerItem`|r20784]]Represents a state change item.  Given a reference to a
...
[[`CRingTextItem`|r21444]]Encapsulates a text list item.  As with all the above
...
Reference information on these classes is availabe at:
                [[*CDataSource*|r23559]],
                [[*CRingDataSource*|r23600]],
                [[*CFileDataSource*|r23668]],
                [[*CDataSourceFactory"*|r23725]],
                and
                [[*CRingItemFactory*|r23781]].
