...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r23873.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRangeError →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r24037.md)
...
<a name="AEN23964"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN23968"></a>## Synopsis

```
CErrnoException
```

<a name="AEN23995"></a>## Description
