...
[← Parsing and URIs](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c2159.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Format of Event Data In Ring Buffers →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c2475.md)
...
This section provides tutorial information that describes the
            ...
            [*CEventOrderClient*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r20276.md)
...
- [Making `CEventOrderClient` available
                  within your program.](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x4112.md)
- [How to form a connection with the event orderer.](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x2264.md)
