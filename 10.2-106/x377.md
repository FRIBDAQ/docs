...
| Prev | Chapter 5. Tcl access to the VME via the SBS interface | Next |


---

# <a name="AEN377"></a>5.2. Sample programs that use the package
...
<a name="AEN381"></a>**Example 5-4. Using VME Tcl to locate all 2530 modules**
...
| --- | --- | --- |
| Prev | Home | Next |
| Tcl access to the VME via the SBS interface | Up | utilities |
