...
[← EVB::reset](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4779.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r50799.md)
...
<a name="AEN50340"></a>## Name

CCCUSBReadoutList -- Create lists of CAMAC commands for CC-USB controllers.

<a name="AEN50343"></a>## Synopsis

```
CCCUSBReadoutList
```

<a name="AEN50523"></a>## DESCRIPTION
