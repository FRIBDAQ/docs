...
For reference information on this class see:
            ...
            via the [[CDocumentedPacket(3sbsreadout)|r64985]].
            The [[CEventPacket(3sbsreadout)|r65248]]
...
For reference information about the `CCompoundEventSegment`
            class see
            [[CCompoundEventSegment(3sbsreadout)|r64763]].

The readout software has a single object from the
            [[CExperiment(3sbsreadout)|r65600]]
...
See the section:
            [[Modifying the skeleton application to meet your needs|x5110]]
