...
[← Event builder Readout Callouts](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c4231.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Introduction →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c5.md)
...
For reference information on this class see:
            ...
            via the [CDocumentedPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r64985.md).
            The [CEventPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r65248.md)
...
For reference information about the `CCompoundEventSegment`
            class see
            [CCompoundEventSegment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r64763.md).

The readout software has a single object from the
            [CExperiment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r65600.md)
...
See the section:
            [Modifying the skeleton application to meet your needs](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/x5110.md)
...
For reference information see
            [CScalerBank](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r66027.md)
...
The readout framework provides
            [`CCAENV262Busy`](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r64534.md),
            and
            [`CV977Busy`](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r66357.md) as
