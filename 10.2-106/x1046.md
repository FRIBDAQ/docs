...
| Prev | Chapter 17. Compatibility utilities | Next |


---

# <a name="AEN1046"></a>17.2. Writing event files with compatibilitylogger
...
<a name="AEN1060"></a>**Example 17-3. Using compatibilitylogger to convert event files**
...
| --- | --- | --- |
| Prev | Home | Next |
| Compatibility utilities | Up | Convenience scripts |
