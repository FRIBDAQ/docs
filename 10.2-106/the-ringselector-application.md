...
# <a name="chapter.ringselector"></a>Chapter 22. The ringselector application
...
<a name="AEN1247"></a>**Example 22-1. Dumping state changes and sampled event data with od**
...
<a name="AEN1255"></a>**Example 22-2. Dumping all but packet types**
...
<a name="AEN1263"></a>**Example 22-3. Attaching SpecTcl**
...
| --- | --- | --- |
| Prev | Home | Next |
| The Event log program | Up | Scaler Display Software. |
