...
[← N568B CAENnet shaping amplifier](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c856.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The tcl server application →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c926.md)
...
- [iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r63638.md)
  Provides a tcl package forlow level support fo the
                      modules including
                      the ability to program the base address of the module.
- [VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r64142.md)
  ...
  This separation allows you to build custom applications
                      ...
                      elements.
- [vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r10350.md)
