...
[← Utilities for burning data to DVD](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c1153.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The ringselector application →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c1194.md)
...
Most experiments will record event data.  Event data files are
        ...
        ring buffers.
        See the chapter:
        [Format of EventData In Ring Buffers](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c2475.md)
...
The full reference documentation for the program is in the
        [event log reference page](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r7873.md).
