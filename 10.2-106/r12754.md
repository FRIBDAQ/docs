...
[← CRangeError](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r12616.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStreamIOError →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r12853.md)
...
<a name="AEN12758"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN12761"></a>## Synopsis

```
CStateException
```

<a name="AEN12791"></a>## Description
...
<a name="AEN12801"></a>## Public member functions
