...
# <a name="chapter.tclserver"></a>Chapter 15. The tcl server application
...
<a name="AEN941"></a>**Example 15-1. Using **serverauth** to authorize a node**
...
| --- | --- | --- |
| Prev | Home | Next |
| VHS-40xxx SBS support. | Up | Dumping events from ringbuffer or from file |
