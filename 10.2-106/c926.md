...
[← VHS-40xxx SBS support.](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c891.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Dumping events from ringbuffer or from file →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/c945.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r10588.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r10631.md).
            section.
