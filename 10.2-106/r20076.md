...
<a name="AEN20080"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN20083"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN20113"></a>## DESCRIPTION
...
<a name="AEN20175"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
