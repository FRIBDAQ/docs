...
**s800::Initialize** *?host? ?port?*Initializes the s800 package.  This involves setting
...
**s800::OnBegin**Should be called from your `OnBegin`
...
**s800:OnEnd**Should be called from your `OnBegin`
...
S800_HOSTIf defined overrides the default host in which the S800
...
S800_PORTOverrides the default port on which the S800 is
...
S800_RINGThe name of the ring into which the s800 data are
