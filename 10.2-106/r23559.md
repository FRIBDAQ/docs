...
[← format  Functions](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r23303.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingDataSource →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r23600.md)
...
Abstract base class for a data source that returns ring items.
            ...
            [***CDataSourceFactory"**3daq****CDataSourceFactory**Create data sources given a URI******CDataSourceFactory**
**static**CDataSource***makeSource***std::string**uri****std::vector<uint16_t>**sample****std::vector<uint16_t>**exclude*******DESCRIPTION**This factory class contains a static method to create a ring item
            data source given a URI.****METHODS******static**CDataSource***makeSource***std::string**uri****std::vector<uint16_t>**sample****std::vector<uint16_t>**exclude******Creates a new data source object and returns a pointer
                        ...
                        *file:///path/to/the/file*.***sample* is a vector of ring item
                        ...
                        data source.******](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r23725.md#daq3_cdatasourcefactory_title).
