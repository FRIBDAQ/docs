...
# <a name="chapter.uri"></a>Chapter 36. Parsing and URIs
...
<a name="AEN2187"></a>**Example 36-1. Sample URI library program**
...
<a name="AEN2213"></a>**Example 36-2. Building urltst.cpp**
...
| --- | --- | --- |
| Prev | Home | Next |
| Pointers to the reference material | Up | Event builder client API |
