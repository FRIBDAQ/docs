...
| Prev | Chapter 32. Shared memory | Next |


---

# <a name="shm_compile"></a>32.2. Compiling/Linking your software with the shared memory API
...
<a name="AEN1831"></a>**Example 32-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN1835"></a>**Example 32-3. Linking C++ object files that use the
            daqshm library**
...
| --- | --- | --- |
| Prev | Home | Next |
| Shared memory | Up | Access control and security |
