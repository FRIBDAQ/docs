...
# <a name="AEN1749"></a>Chapter 32. Shared memory
...
Reference information is available in [[r13470]]

# <a name="AEN1762"></a>32.1. Overview of the API, and using it from within your C++ software
...
<a name="AEN1790"></a>**Example 32-1. Shared memory library example**
...
| --- | --- | --- |
| Prev | Home | Next |
| Exception classes | Up | Compiling/Linking your software with the shared memory API |
