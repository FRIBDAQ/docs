...
<a name="AEN10222"></a>## Name

bcnaf -- bcnaf via SBS VME CAMAC interfaces

<a name="AEN10225"></a>## Synopsis

**bcnaf `-ces | -wiener` *b c n a f* [d]
    **

<a name="AEN10231"></a>## DESCRIPTION
...
| --- | --- | --- |
| Prev | Home | Next |
| wienerbcnaf | Up | canev812control |
