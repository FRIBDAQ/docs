...
[← CVMETrigger](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r44289.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEptr →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r44340.md)
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4255.md).

<a name="AEN4449"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4255.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r4483.md)).
