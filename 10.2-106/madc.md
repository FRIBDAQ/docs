...
<a name="AEN54430"></a>## Name

madc -- Acquire events from Mesytec MADC32 ADC.

<a name="AEN54433"></a>## Synopsis
...
`-ecltiming` *onoff*This parameter, when true enables tge gate1 ECL input to
...
busyThe module busy is output.  This is the
                                 default.

gate0The Gate0 signal is output. If the internal gate
...
gate1The Gate1 signal is output.  If the internal gate
...
cbusThe CBUS output is reflected here.
...
<a name="AEN54654"></a>## EXAMPLES

<a name="AEN54656"></a>**Example 1. Sample use of madc command**
...
| --- | --- | --- |
| Prev | Home | Next |
| tcl driver support | Up | madcchain |
