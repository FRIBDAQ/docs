...
<a name="AEN54681"></a>## Name

madcchain -- Support CBLT chains of MADC32 modules.

<a name="AEN54684"></a>## Synopsis
...
The **create** creates a new MADC32 chain.
...
The **config** configures an MADC32 chain.
...
`-maxwordspermodule` *longword-coun*Defines the maximuim words that can be read from each module.
...
`-modules` *module-name-list*Defines the list of MADC32 modules that make up the chain.
