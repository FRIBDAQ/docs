...
[← CRingItemFactory](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r23781.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r23960.md)
...
<a name="AEN23877"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN23880"></a>## Synopsis

```
CException
```

<a name="AEN23914"></a>## Description
...
<a name="AEN23919"></a>## Public member functions
