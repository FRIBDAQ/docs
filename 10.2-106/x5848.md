...
- [[![(1)](../images/callouts/1.gif)|x5848#vmusb-dtemplate-saveconfig]]
...
- [[![(2)](../images/callouts/2.gif)|x5848#vmusb-dtemplate-baseparam]]
  Most if not all VME modules must be addressed relative
                          ...
                          imposed.
- [[![(3)](../images/callouts/3.gif)|x5848#vmusb-dtemplate-idparam]]
  ...
  Constraint checking comes from the
                          ...
                          See [[CConfigurableObject(3vmusb)|r59464]]
...
See [[CVMUSB(3vmusb)|r55338]] and
                [[*CVMUSBReadoutList*|r57342]] for reference
...
- [[![(1)](../images/callouts/1.gif)|x5848#vmusb-dtemplate-getid]]
  The `-id` option is an integer
                          in the range [0 .. 0xffff].
                          This line
                          fetches its current value from the configuration
                          database.
- [[![(2)](../images/callouts/2.gif)|x5848#vmusb-dtemplate-addmarker]]
...
- [[![(1)](../images/callouts/1.gif)|x5848#vmusb-dtemplate-ccall]]
...
- [[![(2)](../images/callouts/2.gif)|x5848#vmusb-dtemplate-initname]]
...
- [[![(3)](../images/callouts/3.gif)|x5848#vmusb-dtemplate-package]]
...
- [[![(4)](../images/callouts/4.gif)|x5848#vmusb-dtemplate-adddriver]]
...
- [[![(5)](../images/callouts/5.gif)|x5848#vmusb-dtemplate-initsuccess]]
  The **load** or
...
- [[![(6)](../images/callouts/6.gif)|x5848#vmusb-dtemplate-endccall]]
