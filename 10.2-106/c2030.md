...
# <a name="chapter.threads"></a>Chapter 35. NSCL DAQ Thread Library
...
# <a name="AEN2040"></a>35.1. The thread and synchronization model
...
<a name="AEN2053"></a>**Example 35-1. The life of a thread**
...
<a name="AEN2085"></a>**Example 35-2. Why synchonization is needed**
...
<a name="AEN2109"></a>**Example 35-3. Using `SyncGuard` to implement a monitor**
...
[[c2030#chapter.thread.synchronizable]]                    This member is the synchronization element.  We will see
                    it used in the
                    `increment`
                    member.
                [[c2030#chapter.thread.enter]]                    The
                    `sync_begin()`
...
| --- | --- | --- |
| Prev | Home | Next |
| C++ encapsulation of a Tcl API subset | Up | Incorporating the library into an application. |
