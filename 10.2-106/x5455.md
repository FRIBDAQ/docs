...
This section will go through a sample snit driver describing
                ...
                [[Section 55.4.4|x5455#ccusb-general-tcldriver-usage]].
...
- [[![(1)](../images/callouts/1.gif)|x5455#ccusb-snit-auto_path]]
  The SWIG Tcl wrappers for the CCUSB and CCUSBReadoutList
                          ...
                          package.
- [[![(2)](../images/callouts/2.gif)|x5455#ccusb-snit-packages]]
...
- [[![(3)](../images/callouts/3.gif)|x5455#ccusb-snit-type]]
...
- [[![(4)](../images/callouts/4.gif)|x5455#ccusb-snit-option]]
...
- [[![(5)](../images/callouts/5.gif)|x5455#ccusb-snit-Initializemethod]]
...
- [[![(6)](../images/callouts/6.gif)|x5455#ccusb-snit-ccusbswigwrap]]
  ...
  ```
                          ...
                          command.
- [[![(7)](../images/callouts/7.gif)|x5455#ccusb-snit-readleds]]
...
- [[![(8)](../images/callouts/8.gif)|x5455#ccusb-snit-writeleds]]
  Invokes the CCCUSB `writeLedSelector`
                          so that the new value of the LED selector register
                          takes effect.
- [[![(9)](../images/callouts/9.gif)|x5455#ccusb-snit-addReadoutListmethod]]
  The `addReadoutList`
  ...
  The `list` parameter is a pointer
                          ...
                          object.
- [[![(10)](../images/callouts/10.gif)|x5455#ccusb-snit-ccusbreadoutlist-swigwrap]]
  Wraps the pointer in a SWIG object analagous to what
                          was done for the ccusb pointer passed to
                          `Initialize`.
- [[**(11)**|x5455#ccusb-snit-addmarker]]
...
- [[![(1)](../images/callouts/1.gif)|x5455#ccusb-itcl-header]]
...
- [[![(2)](../images/callouts/2.gif)|x5455#ccusb-itcl-class]]
  The **class** command creates an Incr
                          ...
                          (objects).
- [[![(3)](../images/callouts/3.gif)|x5455#ccusb-itcl-options]]
...
- [[![(6)](../images/callouts/6.gif)|x5455#ccusb-itcl-addmarker]]
