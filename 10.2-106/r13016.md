...
[← CStreamIOError](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r12853.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMonitorException →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r13201.md)
...
<a name="AEN13020"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN13023"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN13107"></a>## Description
...
<a name="AEN13114"></a>## Public member functions
