...
# <a name="ch.dumper"></a>Chapter 16. Dumping events from ringbuffer or from file

Sometimes the best way to figure out what's going on, or going wrong,
        is to just look at the data. The
        dumper application can produce formatted
        dumps of ring buffer (online) and file event data.

dumper provides for a certain amount of
...
Data sou4rces, specified by the `--source` option
        are URL's using the file or tcp
        protocols.  tcp URL's specify ring buffers, while
        file protocols specify event files.

<a name="AEN959"></a>**Example 16-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN963"></a>**Example 16-2. Dumping data from the event file segment
            /user/0400x/complete/run-1234-00.evt**
...
<a name="AEN976"></a>**Example 16-3. State Transition items**
...
<a name="AEN981"></a>**Example 16-4. Text List items**
...
<a name="AEN986"></a>**Example 16-5. Incremental Scalers dump**
...
<a name="AEN992"></a>**Example 16-6. Event count items**
...
<a name="AEN998"></a>**Example 16-7. Physics Event items**
...
<a name="AEN1003"></a>**Example 16-8. Unknown item types**
...
User applications can create and insert item types of any sort.
            ...
            item of type 1234.  The body of the dump is
...
| --- | --- | --- |
| Prev | Home | Next |
| The tcl server application | Up | Compatibility utilities |
