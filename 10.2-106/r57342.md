...
[← CVMUSB](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r55338.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMUSBRemote →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r58237.md)
...
<a name="AEN57346"></a>## Name

CVMUSBReadoutList -- Construct VM-USB stacks

<a name="AEN57349"></a>## Synopsis

```
CVMUSBReadoutList
```

<a name="AEN57672"></a>## DESCRIPTION
...
`
  Adds a block write to the list.  `data`
                      ...
                      and as the address crosses 256byte boundaries as provided
                      for in the VME bus block transfer specification.
