...
<a name="AEN10019"></a>## Name

ringbuffer -- Access Rings from tcl.

<a name="AEN10022"></a>## Synopsis
...
**ringbuffer delete *ring***Deletes the shared memory region associated with the ring buffer
