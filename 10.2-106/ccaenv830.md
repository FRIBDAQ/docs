...
<a name="AEN40356"></a>## Public member functions



<a name="AEN40361"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN40389"></a>`void  Enable(int nChannel);`
...
<a name="AEN40404"></a>`void  Disable(int nChannel);`
...
<a name="AEN40419"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN40432"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN40444"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN40456"></a>`void   SetWide (void);`
...
<a name="AEN40468"></a>`void   SetNarrow (void);`
...
<a name="AEN40479"></a>`void  EnableHeader (void);`
...
<a name="AEN40557"></a>`bool  isFull (void);`
...
<a name="AEN40569"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN40581"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN40674"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN40688"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
