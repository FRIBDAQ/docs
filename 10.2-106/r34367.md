...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r34147.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSBSBit3VmeInterface →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r34682.md)
...
This class provides  low level access to VME crates connected to
            ...
            utility [cratelocator](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r34367.md#cratelocator) is able
            to help you determine which crate is which.

A closely related class is
            [`CSBSBit3VmeInterface`](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r34682.md)
...
`Opens a handle to the sbs driver.  The `nMode`
            ...
            [cratelocator](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r34367.md#cratelocator)
...
`Peforms a read from several consecutive locations of VME
            ...
            transfer count,
            (see [CSBSBit3VmeInterface](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r34682.md)),
