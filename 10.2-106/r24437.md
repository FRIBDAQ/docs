...
[← CStreamIOError](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r24274.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMonitorException →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r24622.md)
...
<a name="AEN24441"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN24444"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN24528"></a>## Description
...
<a name="AEN24535"></a>## Public member functions
