...
# <a name="evb-connecting"></a>37.3. Connecting to the event builder.

The code below shows how to connect to the event builder as
                a client:

<a name="AEN2267"></a>**Example 37-1. 
