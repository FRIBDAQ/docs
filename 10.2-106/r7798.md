...
[← dumper](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r7722.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [eventlog →](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r7873.md)
...
- `-eSink --error=Sink`
  Specify  a  logging  sink  for the program's standard error output.  If
                ...
                [SINK SPECIFICATIONS](https://github.com/FRIBDAQ/docs/tree/main/10.2-106/r7798.md#daqstartSINKSPECS)
