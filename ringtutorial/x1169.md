...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_spectrodaqheader)
  This line includes the spectrodaq.h
                          header file. Among other things this defines
                          `DAQWordBufferPtr`
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_daqinterfaceheader)
  The daqinterface.h provides
                          a mini-api to the readout classic library.
                          This also does not exist in RingDaq.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_readevtSignature)
  In __unix__ operating systems,
                          `readevt` is passed a reference
                          to a `DAQWordBufferPtr`.
                          Data then get stored via that object.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_readevtSavePtr)
  In order to be able to compute and return the
                          event size, the 'pointer' object is saved.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_sizeComputation)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_headersRemoved)
  Both the spectrodaq.h
                          and the daqinterface.h headers
                          are no  longer included.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_newSignature)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_newSizeComputation)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localBuffer)
  `readevt` functions that follow
                          this pattern declare a local buffer into which
                          data are first read.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localBufferPtrmaker)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localBufferSize)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localBufferCopyin)
  The data read are then transfered to the spetrodaq
                          buffer using the `DAQWordBufferPtr::CopyIn`
                          method.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localBufferAdvance)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localbufferGone)
  As discussed before the example, we don't need the
                          local buffer any more.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localBufferPtrTrick)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md#classic_localBufferSetbufpt)
