...
[[![(1)](../images/callouts/1.gif)|x1169#classic_headersRemoved]]                        Both the spectrodaq.h
                        and the daqinterface.h headers
                        are no  longer included.
                    [[![(2)](../images/callouts/2.gif)|x1169#classic_newSignature]]                        The parameter signature of `readevt`
                    ...
                    [[![(3)](../images/callouts/3.gif)|x1169#classic_newSizeComputation]]                        Ordinary pointer subtraction can now be used to
...
[[![(1)](../images/callouts/1.gif)|x1169#classic_localbufferGone]]                        As discussed before the example, we don't need the
                        local buffer any more.
                    [[![(2)](../images/callouts/2.gif)|x1169#classic_localBufferPtrTrick]]                        The `localbufpt` is just initialized
                    ...
                    [[![(3)](../images/callouts/3.gif)|x1169#classic_localBufferSetbufpt]]                        Setting `bufpt` to the value of
