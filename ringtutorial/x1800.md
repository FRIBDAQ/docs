...
[← Attaching to a ring buffer data source](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1793.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Creating scaler banks and scaler modules →](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md#version_glob)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md#versions_sort)
  The version directory names are then sorted in high
                          to low order.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md#version_highest)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md#urlgen_tcl_platform)
  The built in global variable `tcl_global`
                          ...
                          to use it.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md#urlgen_gen)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md#attonline_helper)
  The **file join** command creates the
                          ...
                          RingDaq we found.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md#attonline_attach_command)
