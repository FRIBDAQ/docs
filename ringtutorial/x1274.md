...
- [[![(3)](../images/callouts/3.gif)|x1274#rdoclassic_wrapper_trivial]]
  `initialize` and
                              `clear` are trivial delegations
                              to the corresponding skeleton.cpp
                              functions.
- [[![(4)](../images/callouts/4.gif)|x1274#rdoclassic_wrapper_Wordptr]]
  `read` and `readevt`
...
- [[![(2)](../images/callouts/2.gif)|x1274#rdoclassic_sclwrapperPrototypes]]
  This set of statements defines prototypes for the
                              ...
                              skeleton.cpp file.
- [[![(3)](../images/callouts/3.gif)|x1274#rdoclassic_sclwrapperInitialize]]
