...
[← Modifications to skeleton.cpp](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1169.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing the adaptors. →](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1286.md)

---

---

# <a name="AEN1274"></a>4.3. Writing the adaptors.
...
## <a name="AEN1281"></a>4.3.1. Wrapping skeleton.cpp in a `CEventSegment`
...
<a name="AEN1383"></a>**Example 4-7. Header for event segment adapator to readout classic**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#class_wrapheader_eventsegmentincl)
  Includes the `CEventSegment` header
                              which is needed to build a derived class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#class_wrapheader_base)
...
<a name="AEN1397"></a>**Example 4-8. Implementation for the event segment adaptor to readout classic**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapperWordTypedef)
  Without going through the trouble of defining a
                              ...
                              types like uint16_t.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapperexterns)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_trivial)
  `initialize` and
                              `clear` are trivial delegations
                              to the corresponding skeleton.cpp
                              functions.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_Wordptr)
  `read` and `readevt`
                              ...
                              `readevt`.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_delegate)
  This calls `readevt` funtion
                              saving the number of words returned.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_throwtoobig)
  If the number of words returned is larger than
                              ...
                              action.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_returnsize)
  If all goes well the number of words is returned
                              to the caller.

## <a name="AEN1438"></a>4.3.2. Wrapping skeleton.cpp in a `CScaler`
...
<a name="AEN1528"></a>**Example 4-9. Scaler adapter header**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#classic_adaptScalerCScalerHeader)
  In order to derive `CTraditionalScaler`
                              ...
                              this header.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#classic_adaptScalerDerivation)
  Declares our class as derived from
                              ...
                              `CScaler` objects.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#classic_adaptScalerMethodDelcs)
...
<a name="AEN1550"></a>**Example 4-10. Trival methods of the scaler adapter**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperTypedefs)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperPrototypes)
  This set of statements defines prototypes for the
                              functions we are going to be calling in the
                              skeleton.cpp file.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperInitialize)
  `iniscl` is trivially wrapped
                              by this method.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperClear)
...
<a name="AEN1598"></a>**Example 4-11. Adapting the scaler readout**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_numScalers)
  We have assumed the existence of a function in
                              ...
                              write a call to it.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implStorage)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implRead)
  Next the scalers are read into the ordinary buffer.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implToVector)
  This loop transfers the scaler channel data into the
                              vector.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implReturn)
