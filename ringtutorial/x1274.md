...
[[x1274#rdoclassic_sclwrapperTypedefs]]                            The simplest way to get these definitions
                        ...
                        [[x1274#rdoclassic_sclwrapperPrototypes]]                            This set of statements defines prototypes for the
                            functions we are going to be calling in the
                            skeleton.cpp file.
                        [[x1274#rdoclassic_sclwrapperInitialize]] `iniscl` is trivially wrapped
                            by this method.
                        [[x1274#rdoclassic_sclwrapperClear]]                            The `clrscl` function is
