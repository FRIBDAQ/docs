...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#class_wrapheader_eventsegmentincl]]
  Includes the `CEventSegment` header
                              which is needed to build a derived class.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#class_wrapheader_base]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapperWordTypedef]]
  Without going through the trouble of defining a
                              ...
                              types like uint16_t.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapperexterns]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_trivial]]
  `initialize` and
                              `clear` are trivial delegations
                              to the corresponding skeleton.cpp
                              functions.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_Wordptr]]
  `read` and `readevt`
                              ...
                              `readevt`.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_delegate]]
  This calls `readevt` funtion
                              saving the number of words returned.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_throwtoobig]]
  If the number of words returned is larger than
                              ...
                              action.
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_wrapper_returnsize]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#classic_adaptScalerCScalerHeader]]
  In order to derive `CTraditionalScaler`
                              ...
                              this header.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#classic_adaptScalerDerivation]]
  Declares our class as derived from
                              ...
                              `CScaler` objects.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#classic_adaptScalerMethodDelcs]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperTypedefs]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperPrototypes]]
  This set of statements defines prototypes for the
                              functions we are going to be calling in the
                              skeleton.cpp file.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperInitialize]]
  `iniscl` is trivially wrapped
                              by this method.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoclassic_sclwrapperClear]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_numScalers]]
  We have assumed the existence of a function in
                              ...
                              write a call to it.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implStorage]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implRead]]
  Next the scalers are read into the ordinary buffer.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implToVector]]
  This loop transfers the scaler channel data into the
                              vector.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1274.md#rdoClassic_implReturn]]
