...
[[![(1)](../images/callouts/1.gif)|x1153#classic_headersRemoved]]                        Both the spectrodaq.h
                        and the daqinterface.h headers
                        are no  longer included.
                    [[![(2)](../images/callouts/2.gif)|x1153#classic_newSignature]]                        The parameter signature of `readevt`
                    ...
                    [[![(3)](../images/callouts/3.gif)|x1153#classic_newSizeComputation]]                        Ordinary pointer subtraction can now be used to
...
[[![(2)](../images/callouts/2.gif)|x1153#classic_localbufferStdint]]                        This header defines integers of known bit widths such
                    ...
                    [[![(4)](../images/callouts/4.gif)|x1153#classic_localBufferSetbufpt]]                        Setting `bufpt` to the value of
