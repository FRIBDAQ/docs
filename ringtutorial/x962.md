...
[[![(1)](../images/callouts/1.gif)|x962#SDAQToRing_skelincludes]]                        The three headers below are required for our modifications
                    ...
                    [[![(2)](../images/callouts/2.gif)|x962#SDAQToRing_TriggerBusy]]                        These lines are our first additions to the
                        `SetupReadout` method.
                    ...
                    [[![(3)](../images/callouts/3.gif)|x962#SDAQToRing_evsegment]]                        Creates and registers our
