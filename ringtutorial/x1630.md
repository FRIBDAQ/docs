...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#CV262_Includes1]]
  This header and the next define the
                          `CV262Trigger` and
                          `CV262Busy` classes which we will
                          be using as trigger and busy classes respectively.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#CV262_trigger1]]
  This line of code creates a new
                          ...
                          trigger.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#CV262_busy1]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#rdoclassic_EVSegReg_Header]]
  Includes the header for the event segment we wrote to wrap
                          ...
                          later.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#rdoclassic_EVSegReg_Reg]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#rdoclassic_ScalerReg_Header]]
  As before we must include the header for our
                          wrapper so that we can refere to and use the
                          `CTraditionalScaler` class
                          later in the code.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#rdoclassic_ScalerReg_Trigger]]
  ...
  While the `CTimedTrigger` supports
                          ...
                          field set to zero.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md#rdoclassic_ScalerReg_register]]
