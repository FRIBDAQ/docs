...
[← Writing the adaptors.](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1286.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Modifications to Skeleton.cpp →](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1630.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#CV262_Includes1)
  This header and the next define the
                          `CV262Trigger` and
                          `CV262Busy` classes which we will
                          be using as trigger and busy classes respectively.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#CV262_trigger1)
  This line of code creates a new
                          ...
                          trigger.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#CV262_busy1)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#rdoclassic_EVSegReg_Header)
  Includes the header for the event segment we wrote to wrap
                          ...
                          later.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#rdoclassic_EVSegReg_Reg)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#rdoclassic_ScalerReg_Header)
  As before we must include the header for our
                          wrapper so that we can refere to and use the
                          `CTraditionalScaler` class
                          later in the code.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#rdoclassic_ScalerReg_namespacestd)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#rdoclassic_ScalerReg_Trigger)
  ...
  While the `CTimedTrigger` supports
                          ...
                          field set to zero.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1618.md#rdoclassic_ScalerReg_register)
