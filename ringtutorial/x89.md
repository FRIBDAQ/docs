...
[[![(1)](../images/callouts/1.gif)|x89#config.hInclude]]                        All implementation code you write in RingDaq should
                    ...
                    [[![(3)](../images/callouts/3.gif)|x89#CAENCard.hInclude]]                        This satisfies the forward reference to the
                        `CAENcard ` class
                        ...
                        definition.
                    [[![(4)](../images/callouts/4.gif)|x89#EventSegment_otherIncludes]]                        The headers below are standard C/C++ headeres
...
[[![(1)](../images/callouts/1.gif)|x89#newCAENcard]]                        Initializes the `m_pCare` member data
...
[[![(1)](../images/callouts/1.gif)|x89#checkMaxWordsOk]]                        When `read` is called it is
