...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#CV262_Includes)
  This header and the next define the
                              `CV262Trigger` and
                              `CV262Busy` classes which we will
                              be using as trigger and busy classes respectively.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#CV262_trigger)
  This line of code creates a new
                              ...
                              trigger.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#CV262_busy)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#EVSRegsiter_headers)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#EVSRegister_simplesegs)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#EVSRegister_MakeCompound)
  Creates a compound event segment that contains
                              the first 5 TDC events egments (`pTdc0`
                              through `pTdc4`).
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#EVSRegister_Registercompound)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#EVSRegister_RegisterSimple)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#ScalerRegister_headers)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#ScalerRegister_trigger)
  This code sets up a timed trigger for scalers.
                              ...
                              field set to zero.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#SclerRegister_individualModules)
  This code creates 6 `CSIS3820Scaler`
                              objects and assigns their addresses to
                              `pScaler0` ... `pScaler5`.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#ScalerRegister_createbank)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md#ScalerRegister_Register)
