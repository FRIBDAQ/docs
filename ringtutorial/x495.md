...
- [[![(2)](../images/callouts/2.gif)|x495#CV262_trigger]]
  This line of code creates a new
                              ...
                              trigger.
- [[![(3)](../images/callouts/3.gif)|x495#CV262_busy]]
...
- [[![(1)](../images/callouts/1.gif)|x495#EVSRegsiter_headers]]
...
- [[![(2)](../images/callouts/2.gif)|x495#EVSRegister_simplesegs]]
...
- [[![(3)](../images/callouts/3.gif)|x495#EVSRegister_MakeCompound]]
  Creates a compound event segment that contains
                              the first 5 TDC events egments (`pTdc0`
                              through `pTdc4`).
- [[![(4)](../images/callouts/4.gif)|x495#EVSRegister_Registercompound]]
...
- [[![(5)](../images/callouts/5.gif)|x495#EVSRegister_RegisterSimple]]
...
- [[![(1)](../images/callouts/1.gif)|x495#ScalerRegister_headers]]
...
- [[![(2)](../images/callouts/2.gif)|x495#ScalerRegister_trigger]]
  This code sets up a timed trigger for scalers.
                              ...
                              field set to zero.
- [[![(3)](../images/callouts/3.gif)|x495#SclerRegister_individualModules]]
  This code creates 6 `CSIS3820Scaler`
                              objects and assigns their addresses to
                              `pScaler0` ... `pScaler5`.
- [[![(4)](../images/callouts/4.gif)|x495#ScalerRegister_createbank]]
...
- [[![(5)](../images/callouts/5.gif)|x495#ScalerRegister_Register]]
