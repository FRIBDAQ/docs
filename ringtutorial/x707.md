...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SPAQPtoRing_killspectrodaqheader)
  This note is for what is not there.  The
                          #include for
                          spectrodaq.h has been removed
                          as there is no corresponding header in RingDaq.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SPDAQPtoRing_renameinit)
  In RingDaq the name of this method is entirely lower
                          case rather than starting with an upper case letter.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SPDAQPtoRing_resigREadout)
  Note the change not only in name but in parameter
                          types and number.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SPDAQPtoRing_renameclear)
  The clear function has been renamed to be fully lower
                          case.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SPDAQPtoRing_removeMaxWords)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQtoRing_ImplIncludes)
  The <string> header was included so that
                          the `read` method (see below)
                          can throw a `std::string` exception.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_ConstructorNC)
  No changes required to the consturctor.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_DestructorNC)
  No changes were required to the destrutor.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_initializeMods)
  The only change required here was to change the
                          first letter of the function name to lower case.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_clearMods)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_ReadSigMod)
  This line had to be changed.  The first character of the
                          ...
                          a size_t.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_checkMaxSize)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_Waitstillsame)
  This code is unchanged.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_readDaata)
  This code is only slightly changed.  Instead of computing
                          the next buffer location, we just need to know how much
                          data were read.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x707.md#SDAQToRing_returnsize)
