...
[← User written triggers](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/a2057.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compatibility mode utilities →](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/a2109.md)

---

---

# <a name="AEN2102"></a>Appendix C. Compatibility mode utilities
...
<a name="AEN2119"></a>**Example C-1. Writing event data in SPDAQ format**

```

export EVENTLOGGER=/usr/opt/daq/10.0/bin/eventlogger-compat
...
<a name="AEN2128"></a>**Example C-2. Piping SPDAQ formatted event data to SpecTcl**
...
<a name="AEN2142"></a>**Example C-3. Running spectcldaq.server in an Spdaq system.**
...
<a name="AEN2149"></a>**Example C-4. SpecTcl pipe data source using spectcldaq.server**
