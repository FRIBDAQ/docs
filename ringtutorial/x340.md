...
[← Attaching to a ring buffer data source](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1800.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Tying the pieces together →](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x495.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#DerivedFromCScaler)
  Much of this code should look familiar from the'
                          ...
                          readout framework.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820-memberpointer)
  This member will be a pointer to a
                          `CSIS3820` object that will
                          be used to talk to the scaler module we are reading.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CIS3820Scaler-ConstructorDecl)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820Scaler-override-decls)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#newCSIS3820)
  Initializes the `m_pScaler`
                          attribute with a pointer to a dynamically created
                          `CSIS3820` object.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#deleteCSIS3820)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820Scaler-latchmode)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820Scaler-rdclear)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820Scaler-start)
  Enabling and arming the scalers is what starts them
                          counting input pulses.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820Scaler-clear)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820Scaler_readResultVector)
  The `read` method must return an
                          `std::vector`.  This declares
                          storage for that vector.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820Scaler_readResultArray)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820_readout)
  Reads the data in to `channels`
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x340.md#CSIS3820_readToVector)
