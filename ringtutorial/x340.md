...
- [[![(1)](../images/callouts/1.gif)|x340#DerivedFromCScaler]]
...
- [[![(4)](../images/callouts/4.gif)|x340#CSIS3820Scaler-override-decls]]
...
- [[![(1)](../images/callouts/1.gif)|x340#newCSIS3820]]
  Initializes the `m_pScaler`
                          attribute with a pointer to a dynamically created
                          `CSIS3820` object.
- [[![(2)](../images/callouts/2.gif)|x340#deleteCSIS3820]]
...
- [[![(1)](../images/callouts/1.gif)|x340#CSIS3820Scaler-latchmode]]
...
- [[![(2)](../images/callouts/2.gif)|x340#CSIS3820Scaler-rdclear]]
...
- [[![(3)](../images/callouts/3.gif)|x340#CSIS3820Scaler-start]]
  Enabling and arming the scalers is what starts them
                          counting input pulses.
- [[![(4)](../images/callouts/4.gif)|x340#CSIS3820Scaler-clear]]
...
- [[![(1)](../images/callouts/1.gif)|x340#CSIS3820Scaler_readResultVector]]
  The `read` method must return an
                          `std::vector`.  This declares
                          storage for that vector.
- [[![(2)](../images/callouts/2.gif)|x340#CSIS3820Scaler_readResultArray]]
...
- [[![(3)](../images/callouts/3.gif)|x340#CSIS3820_readout]]
  Reads the data in to `channels`
- [[![(4)](../images/callouts/4.gif)|x340#CSIS3820_readToVector]]
