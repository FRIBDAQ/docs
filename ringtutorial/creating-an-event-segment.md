...
`CCompoundEventSegment`The `CCompoundEventSegment`
...
`CEventPacket`NSCL events are often broken into packets.
...
| --- | --- | --- |
| Prev | Home | Next |
| Creating a Readout program from scratch | Up | Creating scaler banks and scaler modules |
