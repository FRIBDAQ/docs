...
[[![(1)](../images/callouts/1.gif)|x1286#class_wrapheader_eventsegmentincl]]                            Includes the `CEventSegment` header
                            which is needed to build a derived class.
                        [[![(2)](../images/callouts/2.gif)|x1286#class_wrapheader_base]]                            Our event segment is derived from the
...
[[![(1)](../images/callouts/1.gif)|x1286#rdoclassic_wrapperWordTypedef]]                            Without going through the trouble of defining a
                        ...
                        [[![(4)](../images/callouts/4.gif)|x1286#rdoclassic_wrapper_Wordptr]] `read` and `readevt`
                            ...
                            `readevt`.
                        [[![(5)](../images/callouts/5.gif)|x1286#rdoclassic_wrapper_delegate]]                            This calls `readevt` funtion
                            saving the number of words returned.
                        [[![(6)](../images/callouts/6.gif)|x1286#rdoclassic_wrapper_throwtoobig]]                            If the number of words returned is larger than
                            ...
                            action.
                        [[![(7)](../images/callouts/7.gif)|x1286#rdoclassic_wrapper_returnsize]]                            If all goes well the number of words is returned
                            to the caller.
...
[[![(1)](../images/callouts/1.gif)|x1286#rdoclassic_sclwrapperTypedefs]]                            The simplest way to get these definitions
                        ...
                        [[![(2)](../images/callouts/2.gif)|x1286#rdoclassic_sclwrapperPrototypes]]                            This set of statements defines prototypes for the
                            functions we are going to be calling in the
                            skeleton.cpp file.
                        [[![(3)](../images/callouts/3.gif)|x1286#rdoclassic_sclwrapperInitialize]] `iniscl` is trivially wrapped
                            by this method.
                        [[![(4)](../images/callouts/4.gif)|x1286#rdoclassic_sclwrapperClear]]                            The `clrscl` function is
