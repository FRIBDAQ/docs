...
[[![(1)](../images/callouts/1.gif)|x1793#version_glob]] `versions` is set to the list of
...
[[![(1)](../images/callouts/1.gif)|x1793#urlgen_tcl_platform]]                        The built in global variable `tcl_global`
...
[[![(1)](../images/callouts/1.gif)|x1793#attonline_helper]]                        The **file join** command creates the
                        ...
                        RingDaq we found.
                    [[![(2)](../images/callouts/2.gif)|x1793#attonline_attach_command]]                        This command does the actual attach.  The
