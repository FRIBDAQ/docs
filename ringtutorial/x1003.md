...
- [[![(1)](../images/callouts/1.gif)|x1003#SPDAQtoRingDaq_scalerReadSignature]]
  The `read` method now returns
                          a vector rather than accepting a reference to one as a
                          parameter.
- [[![(2)](../images/callouts/2.gif)|x1003#SPDAQtoRingDaq_returnVector]]
...
- [[![(3)](../images/callouts/3.gif)|x1003#SPDAQtoRingDaq_returning]]
...
- [[![(1)](../images/callouts/1.gif)|x1003#SDPAQtoRingDaq_skeletonMyScalerHeader]]
  Includes the MyScaler.h header so that
                          the class can be instantiated into an object which
                          will be registered as a scaler.
- [[![(2)](../images/callouts/2.gif)|x1003#SPDAQtoRingDaq_scalerPeriod]]
  This is the number of seconds between scaler readouts.
- [[![(3)](../images/callouts/3.gif)|x1003#SPDAQtoRingDaq_skeletonAddScaler]]
