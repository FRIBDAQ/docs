...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1003.md#SPDAQtoRingDaq_scalerReadSignature]]
  The `read` method now returns
                          a vector rather than accepting a reference to one as a
                          parameter.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1003.md#SPDAQtoRingDaq_returnVector]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1003.md#SPDAQtoRingDaq_returning]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1003.md#SDPAQtoRingDaq_skeletonMyScalerHeader]]
  Includes the MyScaler.h header so that
                          the class can be instantiated into an object which
                          will be registered as a scaler.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1003.md#SPDAQtoRingDaq_scalerPeriod]]
  This is the number of seconds between scaler readouts.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/ringtutorial/x1003.md#SPDAQtoRingDaq_skeletonAddScaler]]
