...
<a name="AEN23350"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN23353"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN23383"></a>## DESCRIPTION
...
<a name="AEN23445"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
