...
<a name="AEN26221"></a>## Public member functions
...
<a name="AEN26228"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN26249"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN26262"></a>` unsigned char getVersion(void);const`
...
<a name="AEN26287"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN26298"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN26644"></a>` ECLOutputSelect
...
<a name="AEN26712"></a>` unsigned short
...
<a name="AEN26876"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN26888"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN26898"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN26908"></a>` TriggerConfiguration
...
<a name="AEN27005"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN27046"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN27072"></a>` LEResolution
...
<a name="AEN27086"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN27246"></a>` unsigned short
...
<a name="AEN27340"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN27352"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN27369"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN27382"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN27394"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN27415"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN27427"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN27442"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN27457"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN27472"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN27484"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN27499"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN27509"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN27521"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN27533"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN27545"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN27557"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN27567"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN27577"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN27587"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN27597"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN27609"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN27619"></a>` void
                    EnableErrorMark(void);`



<a name="AEN27629"></a>` void
                    DisableErrorMark(void);`



<a name="AEN27639"></a>` void EnableBypassOnError(void);`



<a name="AEN27649"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN27659"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN27671"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN27681"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN27693"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN27703"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN27715"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN27727"></a>` void EnableAllChannels(void);`



<a name="AEN27737"></a>` void
                    DisableAllChannels(void);`



<a name="AEN27747"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN27759"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN27771"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN27786"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN27798"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN27810"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN27831"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN27844"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN27861"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN27879"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN27894"></a>## Types and public data
