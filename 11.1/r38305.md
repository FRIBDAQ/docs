...
<a name="AEN38309"></a>## Name

CTCLInterpreter -- 
            Encapsulate a Tcl interpreter.

<a name="AEN38312"></a>## Synopsis
...
`   void setResult(std::string resultString);`
            ...
            Provides a method for setting the result of a command from a text
            string object.  These map to calls to Tcl_SetResult

`   void setResult(Tcl_Obj* resultObj);`
`   void setresult(CTCLObject& resultObj)          throws ;`
            Sets the result via a Tcl_Obj based entity.  These calls map to
            Tcl_SetObjresult.

<a name="AEN38554"></a>## DEFECTS

It is not possible to avoid destroying the interpreter when the
            object is destroyed.

<a name="AEN38557"></a>## SEE ALSO
