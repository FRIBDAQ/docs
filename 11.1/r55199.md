...
[← begin](https://github.com/FRIBDAQ/docs/tree/main/11.1/r55170.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [resume →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r55234.md)
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r55319.md) specifies  the
