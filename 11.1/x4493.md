...
[← More detail on when the fragments are ouptutted](https://github.com/FRIBDAQ/docs/tree/main/11.1/x4487.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Why does it exist? →](https://github.com/FRIBDAQ/docs/tree/main/11.1/x4578.md)
