...
<a name="AEN16349"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16352"></a>## Synopsis
...
<a name="AEN16428"></a>## Public member functions
...
<a name="AEN16519"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16523"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16527"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
