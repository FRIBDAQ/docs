...
[← The ccusbcamac Tcl package](https://github.com/FRIBDAQ/docs/tree/main/11.1/x3513.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The event logger and ReadoutShell →](https://github.com/FRIBDAQ/docs/tree/main/11.1/x4007.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.1/readoutshell.jpg)
...
The menu bar provides access to ReadoutShell commands
                ...
                [*Customizing the ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/11.1/x4041.md) describes
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.1/eventlogsettings.jpg)
...
- Event Log Program
  ...
  The
                              ...
                              [*The event logger and ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/11.1/x4007.md) for
...
- Use `--number-of-sources`
  ...
  This option should be used if you are combining
                              ...
                              See
                              [*eventlog*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r12655.md) for more
...
- debug
  The debug log level is intended
                              ...
                              See, however
                              [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r54233.md#rdogui3_ui_OutputWindow)  for
...
The log types and their visual representations can be controlled
                ...
                [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r54233.md#rdogui3_ui_OutputWindow) for information
