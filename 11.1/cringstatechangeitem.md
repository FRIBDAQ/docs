...
<a name="AEN18415"></a>## Public member functions
...
<a name="AEN18633"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN18636"></a>**Example 1. Creating a begin run state transition item**
