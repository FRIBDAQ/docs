...
[← Interpreting the dumper output](https://github.com/FRIBDAQ/docs/tree/main/11.1/x6535.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for the RC-bus through an MxDC device →](https://github.com/FRIBDAQ/docs/tree/main/11.1/x6594.md)
...
2. At the command line, call
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/11.1/figures/MCFD16Control-USBHowTo-0.png)
