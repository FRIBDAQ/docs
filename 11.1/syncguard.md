...
<a name="AEN35053"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35056"></a>## Synopsis
...
<a name="AEN35098"></a>## Public member functions
...
<a name="AEN35136"></a>`void sync_self(void);`
...
<a name="AEN35143"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35151"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35163"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35169"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35179"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35209"></a>`void sync_global_end(void);`
