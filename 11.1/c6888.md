...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/11.1/c6862.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/11.1/c6952.md)
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1/r12571.md).
...
<a name="AEN6902"></a>**Example 19-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN6906"></a>**Example 19-2. Dumping data from the event file segment
...
# <a name="AEN6916"></a>19.1. Item dump formats and examples
...
<a name="AEN6919"></a>**Example 19-3. State Transition items**
...
<a name="AEN6924"></a>**Example 19-4. Text List items**
...
<a name="AEN6929"></a>**Example 19-5. Incremental Scalers dump**
...
<a name="AEN6935"></a>**Example 19-6. Event count items**
...
<a name="AEN6941"></a>**Example 19-7. Physics Event items**
...
<a name="AEN6946"></a>**Example 19-8. Unknown item types**
