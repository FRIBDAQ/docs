...
<a name="AEN24540"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24543"></a>## Synopsis
...
<a name="AEN24769"></a>## Public member functions





<a name="AEN24775"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24837"></a>`unsigned long getBase(void);`
...
<a name="AEN24848"></a>`int getSerial(void);`
...
<a name="AEN24879"></a>`int  getFirmware(void);`
...
<a name="AEN24889"></a>`int  getCrate(void);`
...
<a name="AEN24900"></a>`void setCrate(int crateNum);`
...
<a name="AEN24913"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24934"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24944"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24954"></a>`void keepOverflowData(void);`
...
<a name="AEN24964"></a>`void discardOverflowData(void);`
...
<a name="AEN24974"></a>`void keepInvalidData(void);`
...
<a name="AEN24985"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN24996"></a>`void commonStart(void);`
...
<a name="AEN25007"></a>`void commonStop(void);`
...
<a name="AEN25018"></a>`void setRange(int range);`
...
<a name="AEN25031"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25103"></a>`void clearData
                                (void);`
...
<a name="AEN25146"></a>`bool Busy(void);`
...
<a name="AEN25157"></a>` bool gBusy(void);`
...
<a name="AEN25168"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25179"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25190"></a>`int readEvent(void* buf);`
...
<a name="AEN25203"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25244"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25307"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25311"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25315"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25319"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25323"></a>**Example 3. Reading out a CAEN 785 e.g.**
