...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/11.1/r24528.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r25699.md)
...
<a name="AEN25460"></a>## Public member functions





- <a name="AEN25466"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25478"></a>`bool Xtest(void);const`
...
- <a name="AEN25490"></a>`bool Qtest(void);const`
...
- <a name="AEN25507"></a>`bool TimedOut(void);const`
...
- <a name="AEN25519"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25531"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25545"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25558"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25572"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25587"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25602"></a>`bool IT4(void);const`
...
- <a name="AEN25616"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25627"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25640"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25656"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25667"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25678"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25688"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25692"></a>**Example 1. Initializing branch 0**
