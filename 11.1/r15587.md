...
[← vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/11.1/r15559.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cratelocator →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r15603.md)
...
This  command  runs the vhq control program.   config are configuration files described by
        [vhqconfig(5)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r74425.md)
