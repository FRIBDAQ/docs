...
[← Epics Channel logging](https://github.com/FRIBDAQ/docs/tree/main/11.1/c7520.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Service Port Manager. →](https://github.com/FRIBDAQ/docs/tree/main/11.1/c7686.md)
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [Service Port Manager](https://github.com/FRIBDAQ/docs/tree/main/11.1/c7686.md)
            chapter.
...
Each element of the list reports on the usage of a single ring.
            ...
            [Tcl ring package's ringbuffer
                usage](https://github.com/FRIBDAQ/docs/tree/main/11.1/r16531.md) command.
