...
[← DaqPortManager](https://github.com/FRIBDAQ/docs/tree/main/11.1/r15119.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [serverauth →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r15273.md)
...
<a name="AEN15234"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN15237"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN15244"></a>## DESCRIPTION
