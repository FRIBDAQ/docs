...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/11.1/r45017.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r47882.md)
...
<a name="AEN45132"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45135"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46117"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r48347.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r48347.md) for
...
<a name="AEN46688"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46692"></a>### Action Register
...
<a name="AEN46735"></a>### Firmware Register
...
<a name="AEN46787"></a>### Global Mode Register
...
<a name="AEN46920"></a>### Delay Register
...
<a name="AEN46953"></a>### Scaler Control register
...
<a name="AEN46986"></a>### LED Source Register
...
<a name="AEN47238"></a>### Output source selection register.
...
<a name="AEN47407"></a>### Device source register
...
<a name="AEN47760"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47821"></a>### Transfer setup register
