...
[[`CRingItem`|r17341]]Base class for all the ring data item format classes.
...
[[`CRingStateChangeItem`|r18244]]Represents a state change item.  Given a reference to
...
[[`CRingScalerItem`|r17808]]Represents a state change item.  Given a reference to a
...
[[`CRingTextItem`|r18639]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[`CGlomParameters`|r20094]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[`CPhysicsEventItem`|r18955]]Encapsulates the data taken in response to a physics
                        trigger.

[[`CRingFragmentItem`|r19458]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[`CRingPhysicsEventCountItem`|r19141]]Encapsulates an item that gives information about the
...
[[`CUnknownFragment`|r19763]]Encapsulates an event fragment produced by the event
...
Reference information on these classes is availabe at:
                [[*CDataSource*|r22636]],
                [[*CRingDataSource*|r22678]],
                [[*CFileDataSource*|r22747]],
                [[*CDataSourceFactory"*|r22804]],
                and
                [[*CRingItemFactory*|r22861]].
