...
[← Writing DAQ configuration files](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2335.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Built-in Diagnostics →](https://github.com/FRIBDAQ/docs/tree/main/11.1/x25.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-saveconfig)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-slotparam)
  ...
  This code is provided by the driver template.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-valueparam)
...
See [CConfigurableObject(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r48862.md) for
...
For detailed information about the methods supported by
                ...
                see [CCCUSB(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r45128.md) and [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r48347.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-init1)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-init2)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-read1)
  This line fetches the `-value`
                          cofiguration parameter.  This is the value
                          that we are going to insert into the event buffer
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-read2)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-dinit1)
  Since C++ *decorates* function  names
                          ...
                          linkage conventions.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-dinit2)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-dinit3)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-dinit4)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x2376.md#ccusb-dtemplate-dinit5)
