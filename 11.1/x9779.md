...
In addition to
            [[CInteractor|r36935]], the following
            concrete interactors have been supplied.



[[`CStringInteractor`|r37104]]This interactor supplies a string that you have gotten by
                        whatever means you got it.  It can be used when interactors
                        are not suitable for acquiring the stringified credentials.

[[`CFdInteractor`|r37265]]This interactor accepts the credentials via an open file
                        descriptor.

[[`CIOInteractor`|r37391]]This interator uses a pair of other interactors, an output and
