...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/11.1/c6952.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAEN V812 Constant Fraction Discriminator →](https://github.com/FRIBDAQ/docs/tree/main/11.1/c7005.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.1/r15230.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/11.1/r15273.md).
            section.
...
TclServer is also available as a package that can be incorporated
                ...
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r68853.md)
