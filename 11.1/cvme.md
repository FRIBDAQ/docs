...
<a name="AEN31839"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN31842"></a>## Synopsis
...
<a name="AEN31949"></a>## Public member functions



<a name="AEN31954"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
<a name="AEN31992"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
<a name="AEN32007"></a>`CVME<T>(const CVME& aCVME);`
...
<a name="AEN32020"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
<a name="AEN32033"></a>`int  operator==(const CVME<T>& aCVME);`
...
<a name="AEN32078"></a>`T*  T* operator-> (void);`
...
<a name="AEN32088"></a>`T&  operator[](UInt_t nOffset);`
...
<a name="AEN32103"></a>`CVME<T>& operator+(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32115"></a>`CVME<T>&  operator-(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32127"></a>`CVME<T>&  operator+=(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32139"></a>`CVME<T>&  operator-=(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32149"></a>## Types and public data
