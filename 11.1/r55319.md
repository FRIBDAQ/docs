...
[← init](https://github.com/FRIBDAQ/docs/tree/main/11.1/r55292.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SSHPipe →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r55366.md)
...
- runsHaveTitles
  If true the provider will honor the
                              ...
                              [*begin*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r55170.md)
                              command.
- runsHaveNumbers
