...
[← The NSCL Exception class library](https://github.com/FRIBDAQ/docs/tree/main/11.1/c10053.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event orderer and its user interface →](https://github.com/FRIBDAQ/docs/tree/main/11.1/c10144.md)
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r12946.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.1/r12946.md)),
