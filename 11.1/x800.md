...
- [[![(1)](../images/callouts/1.gif)|x800#vmusb.config.create]]
...
- [[![(2)](../images/callouts/2.gif)|x800#vmusb.config.config]]
...
Configuration files must also specify at least one stack and, if
        ...
        See the [[stack(3vmusb)|r58756]] command
...
- [[![(1)](../images/callouts/1.gif)|x800#vmusb.config.sis3820]]
...
- [[![(2)](../images/callouts/2.gif)|x800#vmusb.config.sclrStack]]
...
If the device support provided by VMUSBReadout
      ...
      be found in [[*Extending the Supported Readout Hardware*|x1137]].
