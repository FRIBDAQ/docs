...
[← The actions library](https://github.com/FRIBDAQ/docs/tree/main/11.1/c11336.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCUSBReadout →](https://github.com/FRIBDAQ/docs/tree/main/11.1/c2287.md)
...
Reference material is provided in in the 3daq section that describes the
    ...
    the data format can be is provided [here](https://github.com/FRIBDAQ/docs/tree/main/11.1/c7920.md).
