...
## <a name="AEN1142"></a>4.8.1. Writing C++ device support software
...
<a name="AEN1150"></a>**Example 4-6. Obtaning the VM-USB device driver development kit**
...
<a name="AEN1159"></a>**Example 4-7. Using a user written VMUSB driver**
...
### <a name="AEN1173"></a>4.8.1.1. The driver `onAttach` method
...
### <a name="AEN1204"></a>4.8.1.2. The driver `Initialize` method
...
<a name="AEN1221"></a>**Example 4-8. The template driver `Initialize` method**
...
### <a name="AEN1229"></a>4.8.1.3. The driver `addReadoutList` method
...
<a name="AEN1240"></a>**Example 4-9. Template Driver `addReadoutList` method**
...
[[x1137#vmusb-dtemplate-initsuccess]]                        The **load** or
                    ...
                    [[x1137#vmusb-dtemplate-endccall]]                        Ends the extern "C" {  block.

## <a name="AEN1316"></a>4.8.2. Writing device support software in Tcl
...
### <a name="AEN1336"></a>4.8.2.1. An Incr-Tcl (itcl) driver
...
<a name="AEN1339"></a>**Example 4-11. Itcl VM-USB device driver**
...
[[x1137#vmusb-itcldrv-initialize]] `Initialize` implements
                    ...
                    [[x1137#vmusb-itcldrv-vmusbreadled]]                        Invokes the `readLEDSource`
                    ...
                    [[x1137#vmusb-itcldrv-addrdolist]]                        The `addReadoutList` method
...
### <a name="AEN1427"></a>4.8.2.2. A Snit Is Not Incr Tcl (snit) driver
...
<a name="AEN1431"></a>**Example 4-12. A Snit VM-USB driver.**
...
[[x1137#vmusb-snit-constructor]] **constructor** methods are called
...
### <a name="AEN1519"></a>4.8.2.3. Using a Tcl driver in a DAQ configuration script
...
<a name="AEN1536"></a>**Example 4-13. USing a Tcl VM-USB driver.**
