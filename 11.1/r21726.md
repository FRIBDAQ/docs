...
<a name="AEN21730"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN21733"></a>## Synopsis
...
<a name="AEN21735"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN21746"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN21780"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN21800"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN21846"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN21852"></a>`pGlomParameters
...
<a name="AEN21866"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN21886"></a>`pEventBuilderFragment
...
<a name="AEN21906"></a>` pPhysicsEventItem
...
<a name="AEN21926"></a>` pPhysicsEventCountItem
...
<a name="AEN22019"></a>` pStateChangeItem
...
<a name="AEN22051"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22059"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22065"></a>## DESCRIPTION
...
<a name="AEN22073"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN22094"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN22149"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN22185"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN22278"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN22294"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN22321"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22353"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22379"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22408"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22556"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22608"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN22619"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
