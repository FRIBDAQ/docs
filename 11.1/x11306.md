...
[← Building a composite filter](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11302.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Building the filter program →](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11333.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11306.md#filter-main-tempfiltinc)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11306.md#filter-main-maininst)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11306.md#filter-main-userfiltinst)
  Instantiate the user's filter(s). There can be any number of
              ...
              of the main program.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11306.md#filter-main-register)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11306.md#filter-main-mainloop)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11306.md#filter-main-fatalexcept)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1/x11306.md#filter-main-unknownexcept)
