...
[← CCCUSBRemote](https://github.com/FRIBDAQ/docs/tree/main/11.1/r48074.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r48862.md)
...
<a name="AEN48351"></a>## Name

CCCUSBReadoutList -- Create lists of CAMAC commands for CC-USB controllers.

<a name="AEN48354"></a>## Synopsis

```
CCCUSBReadoutList
```

<a name="AEN48556"></a>## DESCRIPTION
