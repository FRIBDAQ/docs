...
# <a name="AEN9472"></a>49.1. The thread and synchronization model
...
<a name="AEN9485"></a>**Example 49-1. The life of a thread**
...
<a name="AEN9517"></a>**Example 49-2. Why synchonization is needed**
...
<a name="AEN9541"></a>**Example 49-3. Using `SyncGuard` to implement a monitor**
...
[[c9462#chapter.thread.synchronizable]]                    This member is the synchronization element.  We will see
                    it used in the
                    `increment`
                    member.
                [[c9462#chapter.thread.enter]]                    The
                    `sync_begin()`
