...
[← Using TclRingBuffer in event driven software](https://github.com/FRIBDAQ/docs/tree/main/11.1/x8936.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [A simple example →](https://github.com/FRIBDAQ/docs/tree/main/11.1/x9072.md)
...
- `--timestamplib`
  ...
  For more information about how to generate this library, see 
            [*Developing a Timestamp Extractor Library*](https://github.com/FRIBDAQ/docs/tree/main/11.1/x1022.md).
