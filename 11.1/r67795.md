...
[← slowControlsPrompter](https://github.com/FRIBDAQ/docs/tree/main/11.1/r67693.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [gdgwidget →](https://github.com/FRIBDAQ/docs/tree/main/11.1/r68013.md)
...
Provides a class that can be instantiated to control a Wiener/JTec
        ...
        [*controlClient*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r67550.md)
...
The object is intended to cooperate with a
        [*gdgwidget*](https://github.com/FRIBDAQ/docs/tree/main/11.1/r68013.md)
