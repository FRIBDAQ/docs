...
<a name="AEN57771"></a>## Name

mqdc -- Support Mesytec MQDC-32 modules

<a name="AEN57774"></a>## Synopsis
...
`-multievent` *boolean*Allows the module to be used in multi-event mode.
...
<a name="AEN58157"></a>## EXAMPLES

<a name="AEN58159"></a>**Example 1. Sample use of mqdc command for timestamping with external oscillator**
...
[[r57766#mqdccreate]]                This command creates an object to manage an MQDC-32
              ...
              [[r57766#mqdcmakethresh]]                This highlights the fact that the configuration file is
                ...
                some external file.
              [[r57766#mqdcthresholds]]                This command uses the `thresholds` variable
                and programs the channel thresholds of the QDC.

<a name="AEN58181"></a>**Example 2. Sample configuration of mqdc for event counting and interrupt readout**
