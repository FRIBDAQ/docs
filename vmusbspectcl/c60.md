...
[← VMUSBSpecTcl  configuration](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c30.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VMUSBSpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/index.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#apilookup-instantiate)
  Creates an instance of the SpecTcl API object.  This object
                  contains data and methods that make up the SpecTcl API.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#apilookup-p1)
  `findParameter` locates the parameter
                  ...
                  NULL is returned.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#apilookup-error)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#apilookup-getid)
  The `getNumber` method of a parameter object
                  ...
                  class.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#apilookup-p2)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#tree_init1)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#tree_bind1)
  Binds the parameter.  This looks up the parameter and
                  ...
                  event.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/vmusbspectcl/c60.md#tree_2)
