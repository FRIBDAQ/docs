...
[[![(1)](../images/callouts/1.gif)|c60#apilookup-instantiate]]                Creates an instance of the SpecTcl API object.  This object
                contains data and methods that make up the SpecTcl API.
            [[![(2)](../images/callouts/2.gif)|c60#apilookup-p1]] `findParameter` locates the parameter
            ...
            [[![(4)](../images/callouts/4.gif)|c60#apilookup-getid]]                The `getNumber` method of a parameter object
...
[[![(1)](../images/callouts/1.gif)|c60#tree_init1]]                A tree parameter declared as
                ```
CTreeParameter
```
