...
<a name="AEN23669"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN23672"></a>## Synopsis
...
<a name="AEN23748"></a>## Public member functions
...
<a name="AEN23839"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN23843"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN23847"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
