...
[← CCAENV830](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39435.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACTrigger →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39530.md)
...
<a name="AEN39666"></a>## Public member functions



- <a name="AEN39671"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN39699"></a>`void  Enable(int nChannel);`
...
- <a name="AEN39714"></a>`void  Disable(int nChannel);`
...
- <a name="AEN39729"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN39742"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN39754"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN39766"></a>`void   SetWide (void);`
...
- <a name="AEN39778"></a>`void   SetNarrow (void);`
...
- <a name="AEN39789"></a>`void  EnableHeader (void);`
...
- <a name="AEN39867"></a>`bool  isFull (void);`
...
- <a name="AEN39879"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN39891"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN39984"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN39998"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
