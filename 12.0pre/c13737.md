...
[← TCPIP classes](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13632.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The NSCL Exception class library →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13795.md)

---

---

# <a name="chapter.tclplus"></a>Chapter 62. C++ encapsulation of a Tcl API subset
