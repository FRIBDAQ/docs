...
[← ReadoutShell](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17378.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [evbwizard →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17438.md)
...
<a name="AEN17423"></a>## Name

EVBShutdown -- Stop Orderer Started with EVBRest

<a name="AEN17426"></a>## Synopsis
...
Requests that an event orderer started via
            [*EVBRest*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17443.md)
            exit.  *host* and
