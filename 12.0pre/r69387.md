...
[← ui](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [RunStateMachine →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69400.md)
...
<a name="AEN69401"></a>## Name

ui -- ReadoutGUI graphical user interface elements.

<a name="AEN69404"></a>## Synopsis

**
package require ui
          **

<a name="AEN69407"></a>## DESCRIPTION
...
- [*readoutMenuBar*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_readoutMenubar)
  Provides the menu bar for the application.  This can
                          ...
                          as well.
- [*RunIdentification*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_RunIdentification)
...
- [*RunControl*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_RunControl)
  Provides a megawidget that contains the controls for a run.
                          These are buttons intended to drive the
                          [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68987.md).
...
- [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_StopWatch)
...
- [*ElapsedTimeDisplay*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_ElapsedTimeDisplay)
...
- [*TimedRunControls*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_TimedRunControls)
  ...
  An associated callout bundle hooks the singleton
                          ...
                          timed runs.
- [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_OutputWindow)
  ...
  An associated
                          [*OutputWindowSettings*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69901.md)
...
- [*StatusArea*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69972.md)
...
<a name="AEN69601"></a>### SINGLETON IMPLEMENTATION
...
Makes use of a
                [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md#rdogui3_ui_StopWatch) to provide
...
<a name="AEN69736"></a>### SINGLETON IMPLEMENTATION
...
<a name="AEN69892"></a>### SINGLETON IMPLEMENTATION
