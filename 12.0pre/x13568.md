...
[← Data conversion](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13539.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the library into an application. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13685.md)

---

---

# <a name="shm_compile"></a>57.2. Compiling/Linking your software with the shared memory API
...
<a name="AEN13579"></a>**Example 57-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN13583"></a>**Example 57-3. Linking C++ object files that use the
            daqshm library**
