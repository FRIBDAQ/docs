...
[← Using NSCLDAQ with a CAEN V785 Peak-Sensing ADC and CAEN V262 IO Register](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8077.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Command line access to CAMAC via the SBS interface →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8167.md)

---

---

# <a name="AEN8116"></a>Chapter 18. 
    ULM Trigger GUI
...
# <a name="AEN8119"></a>18.1. Configuring CCUSBReadout for Remote Communication
