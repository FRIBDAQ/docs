...
[← stateclient](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88378.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ssh →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88422.md)
...
This megawidget glues together the
            [*ReadoutParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88321.md),
            [*ReadoutStatistics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88306.md)
            and
            [*ReadoutState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88365.md)
