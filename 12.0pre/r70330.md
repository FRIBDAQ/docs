...
[← stop](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70317.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [begin →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70348.md)
...
<a name="AEN70344"></a>## Name

pause -- Pause a data taking run (optional)

<a name="AEN70347"></a>## Synopsis
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70458.md) specifies  the
