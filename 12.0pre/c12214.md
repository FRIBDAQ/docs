...
[← DAQ Manager APIs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [TclRingBuffer Tcl package. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12472.md)

---

---

# <a name="evbapi_chap"></a>Chapter 46. 
...
# <a name="AEN12223"></a>46.1. C++ Client API
...
- [Making `CEventOrderClient` available
                  within your program.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14257.md)
- [How to form a connection with the event orderer.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12261.md)
