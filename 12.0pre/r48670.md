...
[← CRingBlockReader](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48629.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CInteractor →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48688.md)
...
<a name="AEN48754"></a>## Description

`CHostListCheck` is derived from the
            [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48518.md).
...
<a name="AEN48764"></a>## Public member functions
...
<a name="AEN48855"></a>## Types and public data
