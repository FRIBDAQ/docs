...
[← LogBookPerson](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r32941.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBookShift →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33030.md)
...
<a name="AEN33025"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN33055"></a>## DESCRIPTION
...
<a name="AEN33117"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
