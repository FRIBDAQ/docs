...
[← cratelocator](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9322.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VM/CCUSB Firmware loaders →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9377.md)

---

---

# <a name="vmetclintro"></a>Chapter 29. Tcl access to the VME via the SBS interface
...
For detailed reference information on the Vme Tcl package start with
        [the vmetcl manpage](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21907.md).

# <a name="AEN9350"></a>29.1. Incorporating Vme Tcl in your scripts
...
<a name="AEN9359"></a>**Example 29-1. Appending the NSCLDAQ Tcl Package repository to Tcl's search
            path**
...
<a name="AEN9363"></a>**Example 29-2. Appending NSLCDAQ's TclPackage repository to Tcl's search path**
...
<a name="AEN9367"></a>**Example 29-3. Requesting the VME Tcl package be loaded.**
