...
[← CCAENV560](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39433.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV830 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39484.md)
...
<a name="AEN39617"></a>## Public member functions



- <a name="AEN39622"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN39650"></a>`void  Enable(int nChannel);`
...
- <a name="AEN39665"></a>`void  Disable(int nChannel);`
...
- <a name="AEN39680"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN39693"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN39705"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN39717"></a>`void   SetWide (void);`
...
- <a name="AEN39729"></a>`void   SetNarrow (void);`
...
- <a name="AEN39740"></a>`void  EnableHeader (void);`
...
- <a name="AEN39818"></a>`bool  isFull (void);`
...
- <a name="AEN39830"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN39842"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN39935"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN39949"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
