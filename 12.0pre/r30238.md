...
[← CRingItemFactory](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30135.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSource →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30278.md)
...
<a name="AEN30252"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN30255"></a>## Synopsis

```
CDataSink
```

<a name="AEN30280"></a>## DESCRIPTION
