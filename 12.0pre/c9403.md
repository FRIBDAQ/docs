...
[← xlmload firmware loader for XLM modules via VM-USB controllers.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9397.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The ringselector application →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9493.md)

---

---

# <a name="chapter.sequencer"></a>Chapter 32. Sequencing runs
...
For a full description of the sequencer, see its
        [reference manual page.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86540.md).
        This chapter gives an overview that describes how to use and configure
        the sequencer.

# <a name="AEN9408"></a>32.1. Configuring the sequencer.
...
<a name="AEN9453"></a>**Example 32-1. Loading the sequencer package**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9403.md#chapter.sequencer.env)
  The global `env` array contains a 
  		 ...
  		 variable.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9403.md#chapter.sequencer.join)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9403.md#chapter.sequencer.path)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9403.md#chapter.sequencer.require)
