...
<a name="AEN29471"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN29474"></a>## Synopsis
...
<a name="AEN29476"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN29487"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN29521"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN29541"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN29587"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN29593"></a>`pGlomParameters
...
<a name="AEN29607"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN29627"></a>`pEventBuilderFragment
...
<a name="AEN29647"></a>` pPhysicsEventItem
...
<a name="AEN29667"></a>` pPhysicsEventCountItem
...
<a name="AEN29760"></a>` pStateChangeItem
...
<a name="AEN29792"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN29800"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN29806"></a>` int  
              hasBodyHeader
...
<a name="AEN29830"></a>` uint32_t 
              itemSize
          (
              const RingItem*  pItem
          );`

<a name="AEN29838"></a>` uint16_t 
              itemType
          (
              const RingItem*  pItem
          );`

<a name="AEN29846"></a>` int
              mustSwap
          (
              const RingItem*  pItem
          );`

<a name="AEN29854"></a>` void* 
              fillRingHeader
          (
              pRingItem  pItem
          , 
...
<a name="AEN30000"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN30021"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN30076"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN30112"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN30205"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN30221"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN30248"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN30280"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN30306"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN30335"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN30483"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN30535"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN30546"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
