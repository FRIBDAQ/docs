...
[← Exemplified Usage of the Actions package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15700.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Basic Tenets of VM-USB Operation →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1822.md)
...
This script assumes the appropriate  daqsetup.bash
      ...
      the [*EVBRest*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17443.md)
      program which runs the orderer stage with a REST interface plugin.
      The second stage of the pipeline run the **glom** program
      described in
      [*glom*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17460.md).
...
Use [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15787.md)
...
For more information; see
      [*ringFragmentSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17746.md)
...
**Making a Program to Shutdown The Event Builder. **
        The [*EVBShutdown*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17419.md)
...
**Adding the Event Builder Shutdown to a SHUTDOWN Sequence . **
        Using [*mg_seqedit*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15872.md)
