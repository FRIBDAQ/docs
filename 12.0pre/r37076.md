...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r37041.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r37454.md)
...
<a name="AEN37215"></a>## Public member functions





- <a name="AEN37221"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN37233"></a>`bool Xtest(void);const`
...
- <a name="AEN37245"></a>`bool Qtest(void);const`
...
- <a name="AEN37262"></a>`bool TimedOut(void);const`
...
- <a name="AEN37274"></a>`bool BranchDemand(void);const`
...
- <a name="AEN37286"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN37300"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN37313"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN37327"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN37342"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN37357"></a>`bool IT4(void);const`
...
- <a name="AEN37371"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN37382"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN37395"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN37411"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN37422"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN37433"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN37443"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN37447"></a>**Example 1. Initializing branch 0**
