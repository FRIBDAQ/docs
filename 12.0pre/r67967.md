...
[← DataSourceUI](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67960.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [hytec →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68015.md)
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69639.md) package for that
            instead.
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69639.md) is a better
                          choice).
