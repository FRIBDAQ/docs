...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35073.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CADC2530 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35214.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34950.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN35177"></a>## Public member functions
...
<a name="AEN35233"></a>## Types and public data
...
<a name="AEN35253"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN35256"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90958.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34950.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21679.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56505.md)
