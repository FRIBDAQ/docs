...
[← CTCLProcessor](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51400.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPConnectionFailed →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51472.md)
...
<a name="AEN51416"></a>## Name

CTCPBadSocketState -- class description

<a name="AEN51419"></a>## Synopsis

```
CTCPBadSocketState
```

<a name="AEN51455"></a>## DESCRIPTION
