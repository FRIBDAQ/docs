...
<a name="AEN22778"></a>### Configuration Options
...
<a name="AEN22802"></a>### Device Options
...
<a name="AEN22832"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN22848"></a>```
...
Retrieve the ID code for the board above<a name="AEN22853"></a>```
...
Load firmware and license it.<a name="AEN22860"></a>```
...
Retrieve license information from a digitizer.<a name="AEN22868"></a>```
...
Un-license a digitizer's firmware:<a name="AEN22873"></a>```
