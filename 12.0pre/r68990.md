...
[← RunStateMachine](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68987.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [StateManager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69054.md)
...
- `-sources` *list-of-source-dicts*
  The data in this option determines what the
                                  ...
                                  the `sources` method
                                  of
                                  [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68244.md)
...
All methods from the `DialogWrapper`
                    ...
                    [*ui*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69800.md)
