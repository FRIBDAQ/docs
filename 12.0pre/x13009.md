...
[← How do I use it?](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13008.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using TclRingBuffer in event driven software →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13050.md)

---

---

# <a name="AEN13009"></a>53.3. Data conversion
...
Functions are provided that allow you to convert shorts and longs
            ...
            in the
            [cvt reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r44430.md).
            Briefly however:
