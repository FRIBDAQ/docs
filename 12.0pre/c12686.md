...
[← SBS VME Module level device support software](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12674.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The CES CBD 8210 Tcl CAMAC Package →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12727.md)

---

---

# <a name="AEN12686"></a>Chapter 50. Tcl CAENet package
...
This chapter describes how to incorporate a pure Tcl package
        ...
        of the
        [the TCL Vme package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9335.md) that provides
        access to the CAEN VME CAENet controller (V288).   For reference
        information see
        [caenet(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86140.md)
