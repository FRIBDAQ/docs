...
[← gdgwidget](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85657.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [controlClient →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85739.md)
...
This is a pre-packaged widget that supplies the needed interfaces
      for use with [*gdgcontrol*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85478.md).
