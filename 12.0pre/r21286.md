...
[← EVB::reset](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21283.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1tcl →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21306.md)
...
<a name="AEN21300"></a>## Name

EVB::handleFragment -- Submit event fragments.

<a name="AEN21303"></a>## Synopsis

**
EVB::handleFragments *file-descriptor*
**

<a name="AEN21307"></a>## DESCRIPTION
...
The format of the data expected on that file descriptor is described
            in [*eventorderer*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98843.md).
