...
[← CControlModule](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66170.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBControl →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66249.md)
...
<a name="AEN66214"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN66217"></a>## Synopsis
...
<a name="AEN66231"></a>## METHODS



- <a name="AEN66236"></a>`PortManager(string host, int    port);`
