...
<a name="AEN34459"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN34462"></a>## Synopsis
...
<a name="AEN34688"></a>## Public member functions





<a name="AEN34694"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN34756"></a>`unsigned long getBase(void);`
...
<a name="AEN34767"></a>`int getSerial(void);`
...
<a name="AEN34798"></a>`int  getFirmware(void);`
...
<a name="AEN34808"></a>`int  getCrate(void);`
...
<a name="AEN34819"></a>`void setCrate(int crateNum);`
...
<a name="AEN34832"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN34853"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN34863"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN34873"></a>`void keepOverflowData(void);`
...
<a name="AEN34883"></a>`void discardOverflowData(void);`
...
<a name="AEN34893"></a>`void keepInvalidData(void);`
...
<a name="AEN34904"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN34915"></a>`void commonStart(void);`
...
<a name="AEN34926"></a>`void commonStop(void);`
...
<a name="AEN34937"></a>`void setRange(int range);`
...
<a name="AEN34950"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN35022"></a>`void clearData
                                (void);`
...
<a name="AEN35065"></a>`bool Busy(void);`
...
<a name="AEN35076"></a>` bool gBusy(void);`
...
<a name="AEN35087"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN35098"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN35109"></a>`int readEvent(void* buf);`
...
<a name="AEN35122"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN35163"></a>`void enableSmallThresholds(void);`
...
<a name="AEN35226"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN35230"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN35234"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN35238"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN35242"></a>**Example 3. Reading out a CAEN 785 e.g.**
