...
[← ccusbloader](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r19314.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vmusbloader →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r19348.md)
...
<a name="AEN19338"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN19341"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN19346"></a>## DESCRIPTION
...
<a name="AEN19368"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN19371"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN19374"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN19377"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN19380"></a>## DEPENDENCIES
