...
[← VMUSBReadout](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c1780.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCUSBReadout →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c3387.md)
...
Reference material is provided in in the 3daq section that describes the
    ...
    the data format can be is provided [here](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10140.md).
