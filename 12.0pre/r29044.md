...
[← DataFormat.h](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28931.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [format  Functions →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r29457.md)
...
<a name="AEN29058"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN29061"></a>## Synopsis
...
<a name="AEN29063"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN29074"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN29108"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN29128"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN29174"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN29180"></a>`pGlomParameters
...
<a name="AEN29194"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN29214"></a>`pEventBuilderFragment
...
<a name="AEN29234"></a>` pPhysicsEventItem
...
<a name="AEN29254"></a>` pPhysicsEventCountItem
...
<a name="AEN29347"></a>` pStateChangeItem
...
<a name="AEN29379"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN29387"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN29393"></a>` int  
              hasBodyHeader
...
<a name="AEN29417"></a>` uint32_t 
              itemSize
          (
              const RingItem*  pItem
          );`

<a name="AEN29425"></a>` uint16_t 
              itemType
          (
              const RingItem*  pItem
          );`

<a name="AEN29433"></a>` int
              mustSwap
          (
              const RingItem*  pItem
          );`

<a name="AEN29441"></a>` void* 
              fillRingHeader
          (
              pRingItem  pItem
          , 
...
- <a name="AEN29587"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN29608"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN29663"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN29699"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN29739"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN29792"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN29808"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN29835"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN29867"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN29893"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN29922"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN30070"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN30122"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN30133"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
