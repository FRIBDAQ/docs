...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64120.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlModule →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64403.md)
...
<a name="AEN64187"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN64190"></a>## Synopsis

```
CControlHardware
```

<a name="AEN64257"></a>## DESCRIPTION
