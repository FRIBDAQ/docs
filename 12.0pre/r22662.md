...
[← wienerbcnaf](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22658.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1utilities →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22672.md)
...
<a name="AEN22676"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN22679"></a>## Synopsis
...
The chapter:
            [Networed Ring Buffer Access](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9944.md)
            includes sample code for detecting and mapping the use of a system's
            hostname into localhost.

<a name="AEN22755"></a>## Public member functions
...
<a name="AEN22846"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN22850"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN22854"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
