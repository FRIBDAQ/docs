...
[[![(2)](../images/callouts/2.gif)|c10854#ex.seq.misc.getmgr]] **::sequence::getCurrentTransition**
                     ...
                     empty string.
                   [[![(3)](../images/callouts/3.gif)|c10854#ex.seq.misc.lseq]] **::sequence::listSequences**
...
[[![(1)](../images/callouts/1.gif)|c10854#ex.kvstore.require]]                  This and the next line import the packages needed
                ...
                [[![(3)](../images/callouts/3.gif)|c10854#ex.kvstore.modify]] **kvstore::modify** changes the value
...
[[![(1)](../images/callouts/1.gif)|c10854#ex.auth.require]]                  The auth package must be pulled into the
                ...
                [[![(2)](../images/callouts/2.gif)|c10854#ex.auth.adduser]] **auth::adduser** makes a new user known to the
...
[[![(1)](../images/callouts/1.gif)|c10854#ex.evlog.require]]                  Requires the packages needed to make this program
                ...
                [[![(3)](../images/callouts/3.gif)|c10854#ex.evlog.add]] **eventlog::add** adds a new event logger
...
[[![(6)](../images/callouts/6.gif)|c10854#ex.evlog.rm]] **eventlog::rm** is used to remove
