...
- The [[c10854#sec.manager.containers]]
...
- What a state machine is, and the default state machine
                    ...
                    [[c10854#sec.sequence.statemachine]]
...
The three procs that support modifying the state machine are
               ...
               **newTransition** which defines a new transition
               ...
               See [[c10854#sec.sequence.seqapi]]
...
[[c10854#ex.seq.misc.getmgr]] **::sequence::getCurrentTransition**
                     ...
                     empty string.
                   [[c10854#ex.seq.misc.lseq]] **::sequence::listSequences**
...
[[c10854#ex.kvstore.require]]                  This and the next line import the packages needed
                ...
                [[c10854#ex.kvstore.modify]] **kvstore::modify** changes the value
...
[[c10854#ex.evlog.require]]                  Requires the packages needed to make this program
                ...
                [[c10854#ex.evlog.add]] **eventlog::add** adds a new event logger
...
[[c10854#ex.evlog.rm]] **eventlog::rm** is used to remove
