...
[← CDesiredTypesPredicate](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28756.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [format  Functions →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28921.md)
...
<a name="AEN28886"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN28889"></a>## Synopsis
...
<a name="AEN28891"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN28902"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN28936"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN28956"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN29002"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN29008"></a>`pGlomParameters
...
<a name="AEN29022"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN29042"></a>`pEventBuilderFragment
...
<a name="AEN29062"></a>` pPhysicsEventItem
...
<a name="AEN29082"></a>` pPhysicsEventCountItem
...
<a name="AEN29175"></a>` pStateChangeItem
...
<a name="AEN29207"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN29215"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN29221"></a>` int  
              hasBodyHeader
...
<a name="AEN29245"></a>` uint32_t 
              itemSize
          (
              const RingItem*  pItem
          );`

<a name="AEN29253"></a>` uint16_t 
              itemType
          (
              const RingItem*  pItem
          );`

<a name="AEN29261"></a>` int
              mustSwap
          (
              const RingItem*  pItem
          );`

<a name="AEN29269"></a>` void* 
              fillRingHeader
          (
              pRingItem  pItem
          , 
...
- <a name="AEN29415"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN29436"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN29491"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN29527"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN29567"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN29620"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN29636"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN29663"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN29695"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN29721"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN29750"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN29898"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN29950"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN29961"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
