...
[← Data Transfer and Flow Control](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x82.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running the Readout Program →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8330.md)
