...
[← Running an Experiment With The Manager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1216.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Manager REST client API. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12249.md)

---

---

# <a name="AEN12237"></a>46.2. Incorporating the event builder client library
