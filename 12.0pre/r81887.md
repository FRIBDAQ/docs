...
[← logbook](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81850.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [logbookinstance →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81906.md)
...
<a name="AEN81901"></a>## Name

cvmusb -- SWIG Tcl wrapping of `CVMUSB`

<a name="AEN81905"></a>## Synopsis
...
<a name="AEN82109"></a>## DESCRIPTION

This package provides a tcl interface to the
                `CVMUSB` class described in
                [CVMUSB(3)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76200.md).
                See COMMANDS below for more information.

<a name="AEN82114"></a>## COMMANDS
