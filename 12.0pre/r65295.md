...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65293.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cccusb →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65304.md)
...
<a name="AEN65299"></a>## Name

LogBook -- Python bindings to LogBook Api.

<a name="AEN65302"></a>## Synopsis
...
<a name="AEN65319"></a>## PEOPLE API section
...
This section allows you to create and retrieve people from the logbook.
         ...
         [*LogBook.Person*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65715.md).
...
`
  ...
  For more informationa bout the strings that can be used
                    ...
                    table at
                    [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91224.md)
...
<a name="AEN65391"></a>## SHIFT API Section
...
The Shift part of the API manipulates collections of people that
         ...
         [*LogBook.Shift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65759.md) reference page.
...
<a name="AEN65452"></a>## RUN API Section

Runs are segments of data taking.  They are encapsulated with
         `LogBook.Run` objects. For more on those, see
         [*LogBook.Run*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65835.md).
...
<a name="AEN65514"></a>## NOTE API section
...
Notes are incapsulated in `LogBook.Note` objects.
         ...
         [*LogBook.Note*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66034.md).
...
<a name="AEN65641"></a>## KEY VALUE STORE API Section
