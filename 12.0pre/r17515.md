...
[← lg_current](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17513.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lg_ls →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17539.md)
...
<a name="AEN17529"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN17532"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN17536"></a>## DESCRIPTION
