...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-includes-tcl.h)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-includes-CModuleFactory.h)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-includes-CModuleCreator.h)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-includes-CControlHardware.h)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-includes-CControlModule.h)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-subclass)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-m_pConfig)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-noimplementation)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-onattach)
  ...
  If real CAMAC hardware is involved, a slow control
                                  ...
                                  the device.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-initialize)
  Some devices require a one-time initialization
                                  ...
                                  initialization.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-update)
...
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-set)
...
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-get)
...
- [![(9)](../images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-def-clone)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-constr-baseinit)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-constr-configinit)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-destruct)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-attach-params)
  Sincethe point of the call to `                                OnAttach` is to provide the
                                  ...
                                  parameter).
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-attach-save)
  Since drivers, in general, define configuration
                                  ...
                                  accessed.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-attach-anint)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-attach-intlist)
  Similarly this line adds a parameter that
                                  consists of a list of 16 integers named
                                  test to the configuration
                                  parameters.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-attach-abool)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#cccusb-slowdriver-impl-set-configure)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#cccusb-slowdriver-impl-set-error)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#cccusb-slowdriver-impl-set-ok)
  On success, the `Set`
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-get-cget)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-impl-get-error)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-creatordef-derive)
  The `SampleCreator` class is
                                  derived from `CModuleCreator`
                                  and therefore meets the first requirement of
                                  creators.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-creatordef-functor)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-init-externc)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-init-name)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-init-provide)
  This sectrion of code uses the
                                  `Tcl_PkgProvide` function
                                  to provide the package Sampledriver
                                  with a version of 1.0 to the
                                  interpreter.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-init-factinstance)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-init-factadd)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-makefile-instdir)
  ...
  This line is normally generated by the NSCLDAQ installation
                              process.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-makefile-sources)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-makefile-pkginfo)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-makefile-libname)
  Similarly, the Makefile needs to know the name of
                              ...
                              index file.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x4011.md#ccusb-slowdriver-makefile-flags)
