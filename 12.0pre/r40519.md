...
[← CCAMACScalerLRS2551](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r40460.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACScalerLRS4434 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r40531.md)
...
<a name="AEN40681"></a>## Public member functions
...
- <a name="AEN40704"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN40714"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN40725"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN40736"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN40748"></a>` void SetLatchMode(void);const`
...
- <a name="AEN40760"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN40795"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN40864"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN40875"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN40886"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN40897"></a>` void Clock(void);const`
...
- <a name="AEN40908"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN40919"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN40930"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN40942"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN40953"></a>` unsigned long Read(void);const`
...
- <a name="AEN40965"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
