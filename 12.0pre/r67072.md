...
[← EVBC::configParams](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67063.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onEnd →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67088.md)
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66751.md).

<a name="AEN67101"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66751.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67182.md)).
