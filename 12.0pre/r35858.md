...
<a name="AEN35872"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN35875"></a>## Synopsis
...
<a name="AEN36101"></a>## Public member functions





<a name="AEN36107"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN36169"></a>`unsigned long getBase(void);`
...
<a name="AEN36180"></a>`int getSerial(void);`
...
<a name="AEN36211"></a>`int  getFirmware(void);`
...
<a name="AEN36221"></a>`int  getCrate(void);`
...
<a name="AEN36232"></a>`void setCrate(int crateNum);`
...
<a name="AEN36245"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN36266"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN36276"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN36286"></a>`void keepOverflowData(void);`
...
<a name="AEN36296"></a>`void discardOverflowData(void);`
...
<a name="AEN36306"></a>`void keepInvalidData(void);`
...
<a name="AEN36317"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN36328"></a>`void commonStart(void);`
...
<a name="AEN36339"></a>`void commonStop(void);`
...
<a name="AEN36350"></a>`void setRange(int range);`
...
<a name="AEN36363"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN36435"></a>`void clearData
                                (void);`
...
<a name="AEN36478"></a>`bool Busy(void);`
...
<a name="AEN36489"></a>` bool gBusy(void);`
...
<a name="AEN36500"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN36511"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN36522"></a>`int readEvent(void* buf);`
...
<a name="AEN36535"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN36576"></a>`void enableSmallThresholds(void);`
...
<a name="AEN36639"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN36643"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN36647"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN36651"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN36655"></a>**Example 3. Reading out a CAEN 785 e.g.**
