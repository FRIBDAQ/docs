...
[← CUnknownFragment](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26401.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataFormatItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26499.md)
...
Since this class is derived from
            [CRingItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24145.md),
...
For a full description of the methods available, see
            both [CRingItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24145.md)'s manpage, and
            the METHODS section below.

<a name="AEN26627"></a>## METHODS
