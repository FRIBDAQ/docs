...
[← ::EVB::inputStatistics::queueDisplay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r20675.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::inputStatistics::summaryDisplay →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r20737.md)
...
<a name="AEN20702"></a>## Name

EvbOrderer -- Event orderer compiled commands.

<a name="AEN20705"></a>## Synopsis
...
**
  ...
  - XonThreshold
    Sets the flow control low water mark.  When
                                            ...
                                            initiated.
  - perQXoffThreshold
    Sets the number of Fragments of payload data
                                            that can be queued before flow control stop
                                            actions are initiated.
  - perQXonThreshold
    Sets the flow control low water mark.  When
