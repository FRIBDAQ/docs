...
<a name="AEN36285"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN36288"></a>## Synopsis
...
<a name="AEN36514"></a>## Public member functions





<a name="AEN36520"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN36582"></a>`unsigned long getBase(void);`
...
<a name="AEN36593"></a>`int getSerial(void);`
...
<a name="AEN36624"></a>`int  getFirmware(void);`
...
<a name="AEN36634"></a>`int  getCrate(void);`
...
<a name="AEN36645"></a>`void setCrate(int crateNum);`
...
<a name="AEN36658"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN36679"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN36689"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN36699"></a>`void keepOverflowData(void);`
...
<a name="AEN36709"></a>`void discardOverflowData(void);`
...
<a name="AEN36719"></a>`void keepInvalidData(void);`
...
<a name="AEN36730"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN36741"></a>`void commonStart(void);`
...
<a name="AEN36752"></a>`void commonStop(void);`
...
<a name="AEN36763"></a>`void setRange(int range);`
...
<a name="AEN36776"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN36848"></a>`void clearData
                                (void);`
...
<a name="AEN36891"></a>`bool Busy(void);`
...
<a name="AEN36902"></a>` bool gBusy(void);`
...
<a name="AEN36913"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN36924"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN36935"></a>`int readEvent(void* buf);`
...
<a name="AEN36948"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN36989"></a>`void enableSmallThresholds(void);`
...
<a name="AEN37052"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN37056"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN37060"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN37064"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN37068"></a>**Example 3. Reading out a CAEN 785 e.g.**
