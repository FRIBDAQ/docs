...
[← Epics Channel logging](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10266.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Service Port Manager. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10436.md)
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [Service Port Manager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10436.md)
            chapter.
...
Each element of the list reports on the usage of a single ring.
            ...
            [Tcl ring package's ringbuffer
                usage](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23910.md) command.
