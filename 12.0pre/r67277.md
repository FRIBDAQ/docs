...
[← EVBC::reset](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67262.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::flush →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67286.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67072.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66896.md) to create the ring
             sources.
