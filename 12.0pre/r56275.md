...
[← c257](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56269.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ccusb (command) →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56359.md)
...
<a name="AEN56385"></a>## Public member functions
...
<a name="AEN56496"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN56501"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r55542.md)
