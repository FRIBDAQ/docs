...
[← Diagnostics](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68241.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Diagnostics →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68290.md)
...
- `DataSourceManager::enumerateProviders`
  Returns a list of the names of the data source providers
                          ...
                          [*Introduction*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70605.md)
