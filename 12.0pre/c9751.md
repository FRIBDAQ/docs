...
[← CAEN V812 Constant Fraction Discriminator](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9745.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [N568B CAENnet shaping amplifier →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9782.md)
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [Service Port Manager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9906.md)
            chapter.
...
Each element of the list reports on the usage of a single ring.
            ...
            [Tcl ring package's ringbuffer
                usage](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22917.md) command.
