...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r60147.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r60729.md)
...
<a name="AEN60282"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN60285"></a>## Synopsis

```
CCCUSB
```

<a name="AEN61267"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63517.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63517.md) for
...
<a name="AEN61838"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN61842"></a>### Action Register
...
<a name="AEN61885"></a>### Firmware Register
...
<a name="AEN61937"></a>### Global Mode Register
...
<a name="AEN62070"></a>### Delay Register
...
<a name="AEN62103"></a>### Scaler Control register
...
<a name="AEN62136"></a>### LED Source Register
...
<a name="AEN62388"></a>### Output source selection register.
...
<a name="AEN62557"></a>### Device source register
...
<a name="AEN62910"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN62971"></a>### Transfer setup register
