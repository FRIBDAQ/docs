...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r61739.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62496.md)
...
<a name="AEN62461"></a>## Name

CCCUSBusb -- Provide access to a connected CC-USB device.

<a name="AEN62464"></a>## Synopsis

```
CCCUSBusb
```

<a name="AEN62528"></a>## DESCRIPTION
