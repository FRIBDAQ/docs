...
[← glom](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17917.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lg_current →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17926.md)
...
<a name="AEN17929"></a>## Name

EVBShutdown -- Stop Orderer Started with EVBRest

<a name="AEN17932"></a>## Synopsis

**
$DAQBIN/EVBShutdown *host user* [*delay*[*service*]] 
           **

<a name="AEN17940"></a>## DESCRIPTION

Requests that an event orderer started via
            [*EVBRest*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17949.md)
            exit.  *host* and
