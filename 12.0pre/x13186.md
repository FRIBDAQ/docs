...
[← Using CGaurdedObject to implement synchronized methods](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13166.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring buffer utilities →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x132.md)
