...
<a name="AEN40202"></a>## Public member functions



<a name="AEN40207"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN40235"></a>`void  Enable(int nChannel);`
...
<a name="AEN40250"></a>`void  Disable(int nChannel);`
...
<a name="AEN40265"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN40278"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN40290"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN40302"></a>`void   SetWide (void);`
...
<a name="AEN40314"></a>`void   SetNarrow (void);`
...
<a name="AEN40325"></a>`void  EnableHeader (void);`
...
<a name="AEN40403"></a>`bool  isFull (void);`
...
<a name="AEN40415"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN40427"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN40520"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN40534"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
