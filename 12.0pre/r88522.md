...
[← ReadoutState](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88488.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [logbook →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88526.md)
...
This megawidget glues together the
            [*ReadoutParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88444.md),
            [*ReadoutStatistics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88429.md)
            and
            [*ReadoutState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88488.md)
...
- `-statistics`
  Passes Readout statistics to the
                       ...
                       method of
                       [*ReadoutRESTClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88308.md)
