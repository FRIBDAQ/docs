...
[← vhqControl](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22302.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [loadshaper →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22326.md)
...
<a name="AEN22329"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN22332"></a>## Synopsis
...
<a name="AEN22387"></a>### Map access command
...
<a name="AEN22397"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN22405"></a>***mapname* put *width offset value***
