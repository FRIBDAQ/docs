...
[← CCamac](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39594.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacModule →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39686.md)
...
<a name="AEN39789"></a>## Public member functions



- <a name="AEN39794"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN39822"></a>`void  Enable(int nChannel);`
...
- <a name="AEN39837"></a>`void  Disable(int nChannel);`
...
- <a name="AEN39852"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN39865"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN39877"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN39889"></a>`void   SetWide (void);`
...
- <a name="AEN39901"></a>`void   SetNarrow (void);`
...
- <a name="AEN39912"></a>`void  EnableHeader (void);`
...
- <a name="AEN39990"></a>`bool  isFull (void);`
...
- <a name="AEN40002"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN40014"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN40107"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN40121"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
