...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r36918.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r37076.md)
...
<a name="AEN37573"></a>## Public member functions
...
- <a name="AEN37580"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN37601"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN37614"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN37639"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN37650"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN37983"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN37996"></a>` ECLOutputSelect
...
- <a name="AEN38064"></a>` unsigned short
...
- <a name="AEN38228"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN38240"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN38250"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN38260"></a>` TriggerConfiguration
...
- <a name="AEN38357"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN38381"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN38398"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN38424"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN38438"></a>` PWResolution
...
- <a name="AEN38598"></a>` unsigned short
...
- <a name="AEN38692"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN38704"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN38721"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN38734"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN38746"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN38767"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN38779"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN38794"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN38809"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN38824"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN38836"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN38851"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN38861"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN38873"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN38885"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN38897"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN38909"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN38919"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN38929"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN38939"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN38949"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN38961"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN38971"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN38981"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN38991"></a>` void EnableBypassOnError(void);`
- <a name="AEN39001"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN39011"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN39023"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN39033"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN39045"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN39055"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN39067"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN39079"></a>` void EnableAllChannels(void);`
- <a name="AEN39089"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN39099"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN39111"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN39123"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN39138"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN39150"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN39162"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN39183"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN39196"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN39213"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN39231"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN39246"></a>## Types and public data
