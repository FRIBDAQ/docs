...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48238.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAuthenticator →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48290.md)
...
<a name="AEN48339"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52182.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14267.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52962.md).
...
<a name="AEN48389"></a>## Types and public data
