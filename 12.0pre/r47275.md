...
<a name="AEN47289"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN47292"></a>## Synopsis
...
<a name="AEN47334"></a>## Public member functions
...
<a name="AEN47372"></a>`void sync_self(void);`
...
<a name="AEN47379"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN47387"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN47399"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN47405"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN47415"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN47445"></a>`void sync_global_end(void);`
