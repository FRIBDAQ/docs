...
[← Using the event builder](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5606.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Fragments and Data Format →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5646.md)
