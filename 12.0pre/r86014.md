...
[← VMUSB VME access](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85977.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VMUSB VME access →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86026.md)
...
Provides a class that can be instantiated to control a Wiener/JTec
        ...
        [*controlClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85739.md)
...
The object is intended to cooperate with a
        [*gdgwidget*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86242.md)
