...
[← Event builder client API](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12744.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Integer byte order conversion library →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12965.md)

---

---

# <a name="intro.wienercamac"></a>Chapter 52. The Wienercamac Tcl package
...
Reference material is available at
        [wienercamac(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86392.md).

# <a name="AEN12791"></a>52.1. Incorporating wienercamac in your scripts.
