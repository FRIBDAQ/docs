...
[← init](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71014.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SSHPipe →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71092.md)
...
- runsHaveTitles
  If true the provider will honor the
                              ...
                              [*begin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70884.md)
                              command.
- runsHaveNumbers
