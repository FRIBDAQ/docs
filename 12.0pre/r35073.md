...
[← CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35058.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35107.md)
...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35230.md) for
...
<a name="AEN35132"></a>## Public member functions
...
If a port could not be allocated (e.g. all are in use or the port manager could
                ...
                [CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35230.md).
...
<a name="AEN35176"></a>## Types and public data
...
<a name="AEN35208"></a>## Exceptions

The `CPortManagerException` is thrown to inform the
            program of most errors dected by this API.  For more information about
            this exception, see:  [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35230.md).

<a name="AEN35213"></a>## EXAMPLES

Allocates a port to MyApplication

<a name="AEN35217"></a>**Example 1. Allocating a port with the port manager**
...
<a name="AEN35221"></a>**Example 2. Listing the port allocatiosn on a system.**
...
<a name="AEN35224"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91081.md),
            [CPortManagerException(3daq)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35230.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21802.md)
