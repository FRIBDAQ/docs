...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r35230]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r35230]].
...
[[portAllocator(3tcl)|r91081]],
            [[CPortManagerException(3daq)|r35230]],
            [[DaqPortManager(1tcl)|r21802]]
