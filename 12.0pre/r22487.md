...
[← epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22481.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1sbsReadout →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22515.md)
...
<a name="AEN22501"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN22504"></a>## Synopsis
...
<a name="AEN22559"></a>### Map access command
...
<a name="AEN22569"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN22577"></a>***mapname* put *width offset value***
