...
[← Tcl CAENet package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12686.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client API →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12744.md)

---

---

# <a name="AEN12727"></a>Chapter 51. The CES CBD 8210 Tcl CAMAC Package
...
Reference information is available as well. See
        [camac(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86215.md)

# <a name="AEN12739"></a>51.1. Incorporating camac into your scripts
