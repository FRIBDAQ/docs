...
[← Tcl access to the VME via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9865.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VM/CCUSB Firmware loaders →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9907.md)
...
- The
                          [port manager daemon](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21308.md)
...
- A
                          [C++ class library](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33660.md)
                          that allows C++ software to interact with the
                          port manager either as a server or as a client.
- The
                      [portAllocator package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r84282.md),
