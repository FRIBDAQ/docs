...
[← CTCPNoSuchHost](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51876.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLCompatibiltyProcessor →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51894.md)
...
<a name="AEN51902"></a>## Name

CTCPNoSuchService -- Exception thrown if a nonexistent service is referenced

<a name="AEN51905"></a>## Synopsis

```
CTCPNoSuchService
```

<a name="AEN51930"></a>## DESCRIPTION
