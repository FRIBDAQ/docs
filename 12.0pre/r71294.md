...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71292.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBook.Run →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71298.md)
...
<a name="AEN71298"></a>## Name

LogBook -- Python bindings to LogBook Api.

<a name="AEN71301"></a>## Synopsis
...
<a name="AEN71318"></a>## PEOPLE API section
...
This section allows you to create and retrieve people from the logbook.
         ...
         [*LogBook.Person*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71714.md).
...
`
  ...
  For more informationa bout the strings that can be used
                    ...
                    table at
                    [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98761.md)
...
<a name="AEN71390"></a>## SHIFT API Section
...
The Shift part of the API manipulates collections of people that
         ...
         [*LogBook.Shift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71758.md) reference page.
...
<a name="AEN71451"></a>## RUN API Section

Runs are segments of data taking.  They are encapsulated with
         `LogBook.Run` objects. For more on those, see
         [*LogBook.Run*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71834.md).
...
<a name="AEN71513"></a>## NOTE API section
...
Notes are incapsulated in `LogBook.Note` objects.
         ...
         [*LogBook.Note*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r72033.md).
...
<a name="AEN71640"></a>## KEY VALUE STORE API Section
