...
[← logbookinstance](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81906.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cvmusb →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r82059.md)
...
<a name="AEN81950"></a>## Name

cvmusb -- SWIG Tcl wrapping of `CVMUSB`

<a name="AEN81954"></a>## Synopsis
...
<a name="AEN82158"></a>## DESCRIPTION

This package provides a tcl interface to the
                `CVMUSB` class described in
                [CVMUSB(3)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76249.md).
                See COMMANDS below for more information.

<a name="AEN82163"></a>## COMMANDS
