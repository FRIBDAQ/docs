...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-saveconfig]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-baseparam]]
  Most if not all VME modules must be addressed relative
                          ...
                          imposed.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-idparam]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-getid]]
  The `-id` option is an integer
                          in the range [0 .. 0xffff].
                          This line
                          fetches its current value from the configuration
                          database.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-addmarker]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-ccall]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-initname]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-package]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-adddriver]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-initsuccess]]
  The **load** or
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-dtemplate-endccall]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-auto-path]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-itclpkg]]
  This loads the Incr-Tcl extension.  Incr-Tcl provides
                          object oriented constructs for Tcl.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-cvmusbpkg]]
  The cvmusb package is the
                          SWIG wrapping of the `CVMUSB`
                          C++ class.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-cvmusbrlistpkg]]
  The cvmusbreadoutlist package
                          is the SWIG wrapping of the
                          `CVMUSBReadoutList` C++ class.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-class]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-option]]
  ...
  ```
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-constructor]]
  ...
  This constructor does nothing except allow the use
                          ...
                          is constructed.
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-initialize]]
  `Initialize` implements
                          ...
                          *pointer* that represents the address
                          ...
                          driver methods.
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-wrapvmusb]]
...
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-itcldrv-vmusbreadled]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-apath]]
  In order to load the packages that wrap the
                          ...
                          your installation.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-snitpkg]]
  This line loads the
                          snit package.  Snit provides definitions
                          of the commands that make up the Snit is Not
                          Incr Tcl package.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-cvmusbpkg]]
  Loads the cvmusb package.  This package
                          provides the Tcl wrapping of the
                          `CVMUSB` class.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-cvmusbreadoutlist]]
  Loads the cvmusbreadoutlist package.
                          This package provides the Tcl wrapping of the
                          `CVMUSBReadoutList`.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-type]]
  ...
  This line creates a new snit::type named
                          ...
                          included in a stack.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-option]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-constructor]]
  **constructor** methods are called
  ...
  The call to **configurelist** processes
                          ...
                          Tk widgets).
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-init]]
  ...
  The `driverPtr` is a
                          *SWIG Pointer*.  Swig pointers
                          ...
                          to a C++ object.
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-wrapcvmusb]]
  This line creates a new SWIG object that wraps the
                          C++ object represented by `driverPtr`.
                          The resulting object is called `v`
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md#vmusb-snit-readleds]]
