...
[← Manager User Interface API](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12439.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using TclRingBuffer in event driven software →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12520.md)

---

---

# <a name="AEN12478"></a>47.2. How do I use it?
...
<a name="AEN12493"></a>**Example 47-1. Processing ring items in Tcl.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12478.md#tclring_attach)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12478.md#tclring_get)
  ...
  The next matching ring items is translated to a dict (see
  	  ...
  	  command.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12478.md#tclring_detach)
  Once processing is done, the ring is detached.  Once detached,
  	  it is no longer available for use in a **ring get**
  	  command.

For reference information see:
      [*TclRingBuffer*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r83961.md)
