...
[← 1epics](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r19262.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::CallbackManager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r19291.md)
...
<a name="AEN19356"></a>## CONFIGURATION FILES
...
Channel lines, have as their first non-whitespace word, the name of
	   ...
	   (notably
	   [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10247.md)) may 
	   parse additional characters for their own purposes.

<a name="AEN19364"></a>## DEPENDENCIES
