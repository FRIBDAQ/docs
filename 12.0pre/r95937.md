...
[← CEventTrigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95887.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CExperiment →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95952.md)
...
`Creates the object.  `seg` is a reference
                ...
                [CDocumentedPacket(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95664.md)
