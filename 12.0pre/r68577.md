...
[← ReadoutGUIPanel](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68556.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutGUIPanel →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68605.md)
...
- `-sources` *list-of-source-dicts*
  The data in this option determines what the
                                  ...
                                  the `sources` method
                                  of
                                  [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67831.md)
...
All methods from the `DialogWrapper`
                    ...
                    [*ui*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md)
