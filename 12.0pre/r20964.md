...
[← Observer](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r20950.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::inputStats →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r20993.md)
...
The format of the data expected on that file descriptor is described
            in [*eventorderer*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91912.md).
