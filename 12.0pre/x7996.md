...
[← Taking the example further.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7987.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [How to use the MDGG16Control GUI →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8013.md)
