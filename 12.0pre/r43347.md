...
[← CTrigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43309.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVmeModule →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43379.md)
...
<a name="AEN43361"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN43364"></a>## Synopsis
...
<a name="AEN43471"></a>## Public member functions



- <a name="AEN43476"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN43514"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN43529"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN43542"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN43555"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN43600"></a>`T*  T* operator-> (void);`
...
- <a name="AEN43610"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN43625"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN43637"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN43649"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN43661"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN43671"></a>## Types and public data
