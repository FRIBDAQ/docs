...
[← Manager REST](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90333.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lg_utilities →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90391.md)
...
<a name="AEN90401"></a>## DESCRIPTION

This package provides a family of controllers that interface
            between the model provided by
            [*EVBRESTClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90124.md)
            and the presentation views provided by
            [*EVBRestUI*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89878.md).
...
<a name="AEN90427"></a>## CONTROLLER VIEW PAIRS
...
<a name="AEN90431"></a>**Table 1. EVBRestControllers and Corresponding EVBRestUI Views**
