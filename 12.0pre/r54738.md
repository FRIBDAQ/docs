...
[← CTCLLiveEventLoop](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r54729.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLPackagedCommand →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r54766.md)
...
<a name="AEN54752"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN54755"></a>## Synopsis

```
CException
```

<a name="AEN54789"></a>## Description
...
<a name="AEN54794"></a>## Public member functions
