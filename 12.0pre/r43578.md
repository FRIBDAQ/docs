...
[← CScaler](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43530.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEStatusModule →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43626.md)
...
<a name="AEN43631"></a>## Public member functions
...
<a name="AEN43669"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN43672"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
