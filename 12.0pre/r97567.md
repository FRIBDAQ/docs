...
[← DAQ manager database schema](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r97476.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQ manager database schema →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r97599.md)
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96853.md)).
