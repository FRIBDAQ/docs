...
[← CRingStateChangeItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25181.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingStateChangeItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25304.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25220.md#scaler.allpred)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25220.md#scaler.get)
  Gets the next item from the ring, regardless of type.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25220.md#scaler.isscaler)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25220.md#scaler.construct)
  If the item is a scaler item, it is converted into a
                      `CScalerItem`
                      and processed.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25220.md#scaler.delete)
