...
[← controlscript](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86713.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [readoutscript →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86817.md)
...
<a name="AEN86816"></a>## EXPORTED ENTRY POINTS
...
- **program::add** *db name path type host ?options?*
  ...
  - container
    If supplied, this must be the name of a container
                               ...
                               [*containers*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86563.md)
