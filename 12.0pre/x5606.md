...
[← Remote control package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5558.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [More detail on when the fragments are ouptutted →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5640.md)
...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14383.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64725.md).
...
The next thing that you need to do is register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md).
