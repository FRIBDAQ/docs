...
[← DataFormat.h](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28395.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DataFormat.h →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28518.md)
...
<a name="AEN28478"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN28481"></a>## Synopsis
...
<a name="AEN28483"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN28494"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN28528"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN28548"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN28594"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN28600"></a>`pGlomParameters
...
<a name="AEN28614"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN28634"></a>`pEventBuilderFragment
...
<a name="AEN28654"></a>` pPhysicsEventItem
...
<a name="AEN28674"></a>` pPhysicsEventCountItem
...
<a name="AEN28767"></a>` pStateChangeItem
...
<a name="AEN28799"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN28807"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN28813"></a>` int  
              hasBodyHeader
...
<a name="AEN28837"></a>` uint32_t 
              itemSize
          (
              const RingItem*  pItem
          );`

<a name="AEN28845"></a>` uint16_t 
              itemType
          (
              const RingItem*  pItem
          );`

<a name="AEN28853"></a>` int
              mustSwap
          (
              const RingItem*  pItem
          );`
...
- <a name="AEN29007"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN29028"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN29083"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN29119"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN29159"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN29212"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN29228"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN29255"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN29287"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN29313"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN29342"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN29490"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN29542"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN29553"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
