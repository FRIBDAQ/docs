...
[← cvmusb](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76473.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cvmusbreadoutlist →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r77228.md)
...
<a name="AEN76799"></a>## Name

CVMUSB -- Interface with VM-USB controller.

<a name="AEN76802"></a>## Synopsis

```
CVMUSB
```

<a name="AEN78088"></a>## DESCRIPTION
