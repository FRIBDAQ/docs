...
[← SyncGuard](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r47275.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CFdInteractor →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r47320.md)
...
<a name="AEN47317"></a>## Name

CCondition -- Encapsulate POSIX condition variables.

<a name="AEN47320"></a>## Synopsis

```
CConditionAttributes
```

<a name="AEN47424"></a>## DESCRIPTION
...
<a name="AEN47577"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
