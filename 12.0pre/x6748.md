...
[← Running VMUSBReadout](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6710.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Developing a Tailored SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6815.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-evthdr)
  VM-USB event header. This is just 16-bits.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-v775hdr)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-v775data)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-v775eoe)
  As we expect by header word of the V775, this is the end of event word.
            ...
            in decimal.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-v785hdr)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-v785data)
  Here is the data for the V785. It corresponds to channel 1 and has a
            value f 3567.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-v785eoe)
  Here is the end-of-event word for the V785. It corresponds to event
            number 3077.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6748.md#vmusb-ss-rawdata-ffff)
