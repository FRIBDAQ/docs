...
[← CamacCrate](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r59682.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSB →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r59732.md)
...
<a name="AEN59697"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN59700"></a>## Synopsis

```
CCCUSB
```

<a name="AEN60682"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62932.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62932.md) for
...
<a name="AEN61253"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN61257"></a>### Action Register
...
<a name="AEN61300"></a>### Firmware Register
...
<a name="AEN61352"></a>### Global Mode Register
...
<a name="AEN61485"></a>### Delay Register
...
<a name="AEN61518"></a>### Scaler Control register
...
<a name="AEN61551"></a>### LED Source Register
...
<a name="AEN61803"></a>### Output source selection register.
...
<a name="AEN61972"></a>### Device source register
...
<a name="AEN62325"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN62386"></a>### Transfer setup register
