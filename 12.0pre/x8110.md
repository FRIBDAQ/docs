...
[← Overview of Functionality](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8105.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Launching the ULMTriggerGUI →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8124.md)

---

---

# <a name="gd16_saved_file"></a>17.5. The Saved File
