...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8193.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Mesytec MCFD-16 Controls →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8398.md)

---

---

# <a name="AEN8219"></a>Chapter 21. NSCLDAQ Logbook facility
...
- [*Components of the NSCL logbook system*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8219.md#sec.lg_inventory)
...
- [*Setting up a logbook for use.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8390.md)
             describes the tasks you need to perform to use the NSCL Logbook
              subsystem in an experiment.
- [*Using the logbook in an experiment*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8512.md)
              Describes how to use the logbook system in an experiment and beyond.
- [*Making logbooks available to collaborators*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8811.md)
              ...
              remote facility.
- [**](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8905.md)
...
# <a name="sec.lg_inventory"></a>21.1. Components of the NSCL logbook system
...
<a name="AEN8285"></a>**Figure 21-1. Logbook component layering.**
...
- **lg_create**
  Used to create a new logbook.  When logbooks are created,
                    ...
                    current.
                    See
                    [*lg_create*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17004.md)
...
- **lg_current**
  Selects the current logbook database file.  This is the
                    ...
                    **lg_*** commands and admin level Tcl bindings.
                    See
                    [*lg_current*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17056.md)
                    for more information.
- **lg_ls**
  Outputs the name of the logbook that is current.
                    See
                    [*lg_ls*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17082.md)
                    for more information.
- **lg_addperson**
  Makes a new person known to the logbook. People are stored
                    ...
                    See
                    [*lg_addperson*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17095.md)
                    for more information
- **lg_lspeople**
  Lists the people that have been defined to the database.
                    See
                    [*lg_lspeople*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17318.md)
                    for more information
- **lg_mkshift**
  Creates new shifts.  A shift is a collection of people that
                    ...
                    See
                    [*lg_mkshift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17134.md)
                    for more information
- **lg_mgshift**
  ...
  See
                    [*lg_mgshift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17155.md)
                    for more information
- **lg_selshift**
  ...
  See
                    [*lg_selshift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17199.md)
                    for more information
- **lg_kvstore**
  ...
  See
                    [*lg_kvstore*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17217.md)
                    for more information
- **lg_wrnote**
  Provides a composer for notes.  Notes have an author and optionally
                    ...
                    rendered.
  See
                    [*lg_wrnote*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17263.md)
                    for more information
- **lg_browse**
  Provides a visual logbook browser.
  See
                    [*lg_browse*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17279.md)
                    for more information
- **lg_print**
  Allows all or part of a logbook to be rendered in PDF,
                    presumably for later printing.
  See
                    [*lg_print*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17292.md)
                    for more information
