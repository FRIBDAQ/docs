...
[← How to use the MDGG16Control GUI](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8013.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The full SpecTcl program. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8052.md)

---

---

# <a name="AEN8046"></a>16.3. Saving and Restoring The State of the GUI Between Sessions

## <a name="AEN8048"></a>16.3.1. Saving the state
...
## <a name="AEN8051"></a>16.3.2. Restoring previous state
