...
[← cvmusb](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r82472.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [logbookadmin →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r82597.md)
...
A note instance is a Tcl command ensemble that provides access to
            ...
            See
            [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81906.md) for subcommands that
            can generate notess
...
set run [*$note* run]
  ...
  If the note has an associated run, this subcommand returns
                       ...
                       [*runinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r82382.md)
