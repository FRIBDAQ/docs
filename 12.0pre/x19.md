...
[← The Slow-Controls Subsystem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1894.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running the VMUSBReadout program →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1939.md)
