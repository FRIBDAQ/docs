...
[← Manager REST](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r97098.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTimedTrigger →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r97143.md)
...
<a name="AEN97147"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN97150"></a>## Synopsis
...
<a name="AEN97198"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96419.md)).
