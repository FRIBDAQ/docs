...
| Prev | Chapter 13. Simple V775 readout | Next |


---

# <a name="AEN7496"></a>13.4. Creating the tailored SpecTcl
...
## <a name="AEN7504"></a>13.4.1. Decoding raw TDC data
...
### <a name="AEN7527"></a>13.4.1.2. Creating the raw unpacker class

Here is the header for our raw unpacker
                    (event processor) pipeline stage:

<a name="AEN7530"></a>**Example 13-9. Raw TDC unpacker (RawUnpacker.h)**
...
<a name="AEN7562"></a>**Example 13-10. v775 raw unpacker implementation includes and defs (RawUnpacker.cpp)**
...
<a name="AEN7584"></a>**Example 13-11. V775 raw unpacker - getLong utility (RawUnpacker.cpp)**
...
<a name="AEN7590"></a>**Example 13-12. V775 raw unpacker object constructor/destructor (RawUnpacker.cpp)**
...
[[x7496#v775_rawimpl_constructor]]                            The constructor is required to initialize the reference
                            ...
                            t.00 ... t.31.
                        [[x7496#v775_rawimpl_destructor]]                            If an object is ever destroyed, its tree parameter
                            array musb be destroyed as well to prevent
                            memory leaks.

<a name="AEN7603"></a>**Example 13-13. v75 raw unpacker unpacking events (RawUnpacker.cpp)**
...
[[x7496#v775_rawimpl_funtorsignature]]                            The `operator()` method
...
[[x7496#v775_rawimpl_storeparam]]                            Tree parameter array objects mimic arrays to the
                        ...
                        [[x7496#v775_rawimple_trailer]]                            The data words from the TDC should be followed by
                            a trailer.  This code asserts that this is the
                            case.

### <a name="AEN7691"></a>13.4.1.3. Adding the unpacker to the analysis pipeline
...
### <a name="AEN7713"></a>13.4.1.4. Creating raw time spectra
...
<a name="AEN7722"></a>**Example 13-14. Defining raw Time spectra the hard way.**
...
### <a name="AEN7795"></a>13.4.1.5. Building and testing what we have so far.
...
## <a name="AEN7833"></a>13.4.2. Producing parameters computed from the raw data
...
<a name="AEN7846"></a>**Example 13-15. Header for time difference event processor (Tdiff.h)**
...
<a name="AEN7859"></a>**Example 13-16. CTdiff implementation (Tdiff.cpp)**
