...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70707.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Delay →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70725.md)
...
<a name="AEN70713"></a>## Name

LogBook -- Python bindings to LogBook Api.

<a name="AEN70716"></a>## Synopsis
...
<a name="AEN70733"></a>## PEOPLE API section
...
This section allows you to create and retrieve people from the logbook.
         ...
         [*LogBook.Person*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71129.md).
...
`
  ...
  For more informationa bout the strings that can be used
                    ...
                    table at
                    [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98155.md)
...
<a name="AEN70805"></a>## SHIFT API Section
...
The Shift part of the API manipulates collections of people that
         ...
         [*LogBook.Shift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71173.md) reference page.
...
<a name="AEN70866"></a>## RUN API Section

Runs are segments of data taking.  They are encapsulated with
         `LogBook.Run` objects. For more on those, see
         [*LogBook.Run*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71249.md).
...
<a name="AEN70928"></a>## NOTE API section
...
Notes are incapsulated in `LogBook.Note` objects.
         ...
         [*LogBook.Note*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71448.md).
...
<a name="AEN71055"></a>## KEY VALUE STORE API Section
