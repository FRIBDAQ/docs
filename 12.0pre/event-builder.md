...
# <a name="ch_event_builder"></a>Chapter 8. Event Builder

# <a name="AEN5597"></a>8.1. Introduction
...
The client programs that submit data to the server are built using the
      [[c14024]]. In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [[x14290]] program. This
