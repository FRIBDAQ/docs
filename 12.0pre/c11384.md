...
[← DAQ Manager APIs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10854.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client API →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12214.md)
...
- [*Manager Configuration Database API*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.manager.dbapi)
...
- [*Manager REST client API.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12249.md)
...
- [*Manager User Interface API*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12439.md)
...
- The [*The *containers* package.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.manager.containers)
...
- The [*The *programs* package*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.manager.programs)
                 section describes a package that suports the definition of programs
                 in the database and can manipulate them as well.
- The [*The *sequence* package*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.manager.sequence)
                section describes a package that supports manipulation of the
                state machine and sequences attached to state transitions.
- The [*The *kvstore* package*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.manager.kvstore)
                section describes a package that can manipulate the key value store.
- The [*The *auth* package.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.manager.auth)
                section describes support for an authorization database.
- The [*The *eventloggers* Package.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.manager.eventloggers)
...
This code snippet pulls in the sqlite3 Tcl
            ...
            **sqlite3** command, by default will create
            ...
            [*mg_mkconfig*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16426.md)
...
The remainder of this section will briefly describe the capability
            ...
            [*containers*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r87099.md).
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.mgr.mkcont.init)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.mgr.mkcont.auto_path)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.mgr.mkcont.requires)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.mgr.mkcont.opendb)
  Creates a new command **db** which is connected
                      to the SQLite3 database file myconfig.db.
                      This file should have been made with
                      [*mg_mkconfig*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16426.md)
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.mgr.mkcont.add)
  ...
  This matches our FRIB convention of storing built NSCLDAQ
                      ...
                      /usr/opt.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.mgr.mkcont.closedb)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.usecont.activate)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.usecont.run)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.usecont.relay)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.usecont.deactivate)
  Done with the container, we deactivate it.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.usecont.closecfd)
...
Reference material on the programs
            package can be found at:
            [*programs*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r87268.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.addpgm.autopath)
  Adds the NSCLDAQ Tcl library path to the
                    `auto_path` so that the
                    programs package can be found.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.addpgm.requires)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.addpgm.open)
  ...
  Note that while this command
                    ...
                    [*mg_mkconfig*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16426.md)
                    command.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.addpgm.add)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#program.run.handler)
  ...
  Note that we don't close the file descriptor.  The program
                    ...
                    file descriptor.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#program.run.run)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#program.run.evloop)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#program.run.kill)
...
Reference information on the sequence package is at
            [*sequence*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r87541.md)
...
- What a state machine is, and the default state machine
                    ...
                    [*State Machines, and the Default State Machine*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.sequence.statemachine)
- Parts of the sequence package that
                    ...
                    [*The State machine API*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.sequence.stateapi)
- [*The Sequence API*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.sequence.seqapi)
                    sequences and the API section of the sequence
                    package that manage sequences.
- [*The Transition API*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.sequence.transition)
                    describes transitions and the parts of the API that manage them.
- [*Miscellaneous API Entries.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.sequence.misc)
...
The state machine API allows you to configure an arbitrary
               ...
               such as [*rdo_RunControl*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16941.md)
...
The three procs that support modifying the state machine are
               ...
               **newTransition** which defines a new transition
               ...
               See [*The Sequence API*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#sec.sequence.seqapi)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.boilerplate)
  By now this should be familiar.  Extend the library
                       search path and require the packages we need before
                       opening the database.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.addstate)
  Adds a new state named `PAUSED`
                       ...
                       successor state.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.addtransitions)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.makeseq)
  This creates a new sequence named
                    ...
                    HWINIT.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.addsteps)
  This block of code adds the five steps we need to the
                    ...
                    to edit sequences.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.delay)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.trans.completion)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.trans.check)
  Gets the system's current state. Note that the state
                       ...
                       exiting.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.trans.boot)
  Initiates the shutdown. Note that completion
                       is specified as the end script for this transition.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.trans.vwait)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.snit)
  ...
  The key point, as we'll see is that in order to
                       ...
                       **onOutput** and
                       **onExit**.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.getmgr)
  **::sequence::getCurrentTransition**
                       ...
                       empty string.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.lseq)
  **::sequence::listSequences**
                       ...
                       of the sequence.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.lstep)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.monitor)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.addmon)
  This associates the monitor with the step.  Note that the
                       return value from **::sequence::addMonitor**
                       is any prior monitor.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.omonitor)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.onout)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#seq.misc.orelay)
  The **::sequence::relayOutput** command
                       sends its argument to all processes connected to its output
                       relay server.
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.seq.misc.onexit)
...
See
            [*kvstore*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r87952.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.kvstore.require)
  This and the next line import the packages needed
                    ...
                    a database file.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.kvstore.create)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.kvstore.modify)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.kvstore.listall)
...
Full reference material for the authorization package
            (auth)) is provided in
            [*auth*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88285.md).
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.auth.require)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.auth.adduser)
  **auth::adduser** makes a new user known to the
                    configuration.  The name of the user should be the same as
                    their account username.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.auth.addroles)
  This set of lines uses **auth::addrole** to
                    add three roles, manager, analyzer
                    and operator to the authorization database.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.auth.grantrole)
...
The example below illustrates some of the simple capabilities
            ...
            [*eventloggers*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88020.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.evlog.require)
  Requires the packages needed to make this program
                    ...
                    ::eventlog namespace.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.evlog.dest)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.evlog.add)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.evlog.searchdest)
  The next section of code will search the existing
                    ...
                    destroy it using
                    **eventlog::rm**
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.evlog.list)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c11384.md#ex.evlog.rm)
