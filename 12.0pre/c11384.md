...
- The [[c11384#sec.manager.containers]]
...
- What a state machine is, and the default state machine
                    ...
                    [[c11384#sec.sequence.statemachine]]
...
The three procs that support modifying the state machine are
               ...
               **newTransition** which defines a new transition
               ...
               See [[c11384#sec.sequence.seqapi]]
...
[[c11384#ex.seq.misc.getmgr]] **::sequence::getCurrentTransition**
                     ...
                     empty string.
                   [[c11384#ex.seq.misc.lseq]] **::sequence::listSequences**
...
[[c11384#ex.kvstore.require]]                  This and the next line import the packages needed
                ...
                [[c11384#ex.kvstore.modify]] **kvstore::modify** changes the value
...
[[c11384#ex.evlog.require]]                  Requires the packages needed to make this program
                ...
                [[c11384#ex.evlog.add]] **eventlog::add** adds a new event logger
...
[[c11384#ex.evlog.rm]] **eventlog::rm** is used to remove
