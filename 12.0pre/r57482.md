...
<a name="AEN57496"></a>## Name

CStreamIOError -- I/O error on a C++ stream.

<a name="AEN57499"></a>## Synopsis

```
CStreamIOError
```

<a name="AEN57553"></a>## Description
...
<a name="AEN57558"></a>## Public member functions
...
<a name="AEN57628"></a>## Types and public data
...
`CStreamIOError`::EndFileAn end file condition has been detected.

`CStreamIOError`::BadSetThe bad bit in the stream's I/O status mask is set.

`CStreamIOError`::FailSetThe fail bit is set in the stream's I/O status mask.
