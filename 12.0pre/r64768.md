...
<a name="AEN64782"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN64785"></a>## Synopsis
...
<a name="AEN64954"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r59732]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r65503]])
...
<a name="AEN64962"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r65503]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r65503]] for
...
<a name="AEN65414"></a>## DEVICE ENUMERATION
...
<a name="AEN65438"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN65448"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN65454"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r62981]] for reference
...
<a name="AEN65497"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r59732]]
[[cccusbreadoutlist(3ccusb)|r65503]]
[[CCCUSBReadoutList(3ccusb)|r62981]]
