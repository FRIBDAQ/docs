...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63506.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63629.md)
...
<a name="AEN63531"></a>## Name

CCCUSBReadoutList -- Create lists of CAMAC commands for CC-USB controllers.

<a name="AEN63534"></a>## Synopsis

```
CCCUSBReadoutList
```

<a name="AEN63736"></a>## DESCRIPTION
