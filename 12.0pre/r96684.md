...
[← CInvalidPacketStateException](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96669.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTimedTrigger →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96709.md)
...
<a name="AEN96734"></a>| Plug | Direction | Meaning |
| --- | --- | --- |
...
<a name="AEN96755"></a>## Public member functions
...
<a name="AEN96791"></a>## SEE ALSO

[CBusy(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r94513.md),
     [CV977Trigger(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96796.md)
