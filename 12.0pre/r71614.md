...
[← LogBook.Note](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71497.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBook.Note →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71620.md)
...
<a name="AEN71645"></a>## METHODS



- <a name="AEN71650"></a>`PortManager(string host, int    port);`
