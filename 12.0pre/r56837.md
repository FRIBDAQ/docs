...
[← lrs2551](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56824.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStreamIOError →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56897.md)
...
<a name="AEN56851"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN56854"></a>## Synopsis

```
CStateException
```

<a name="AEN56884"></a>## Description
...
<a name="AEN56894"></a>## Public member functions
