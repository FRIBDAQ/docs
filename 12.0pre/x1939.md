...
`--quickstart` *on | off*If the value of this switch is on,
...
**monvar add** *var-name*Adds `var-name` to the set of variables
...
**monvar remove** *var-name*Removes the variable or array element `var-name`
              from the set of variables that are being monitored.

**monvar list** ?*pattern*Lists the set of monitored variables that match the glob
              `pattern`. If `pattern`
