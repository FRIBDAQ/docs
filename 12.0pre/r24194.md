...
[← CRingItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24145.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingScalerItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24227.md)
...
<a name="AEN24208"></a>## Name

CRingItem -- Encapsulates an item in a ring buffer.

<a name="AEN24211"></a>## Synopsis
...
<a name="AEN24392"></a>## Public member functions
...
Predicates provide a powerful mechanism for selecting and sampling
            ...
            [`CRingSelectionPredicate`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r27692.md),
            [`CAllButPredicate`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28034.md),
            and
            [`CDesiredTypesPredicate`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28220.md).
            Note that you may also construct your own predicate classes should
            these not be sufficient to meet your needs.

The caller is responsible for deleting the object.

<a name="AEN24646"></a>## Types and public data
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md#cringitem.include)
  This #include obtains the data type and
                      ...
                      constant.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md#cringitem.predicate)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md#cringitem.addtype)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md#cringitem.get)
  This gets a pointer to the ring item that satisfies our
                      ...
                      PHYSICS_EVENT.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md#cringitem.process)
  I'm omitting what you do to process the item as that's application
                      dependent.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md#cringitem.delete)
