...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48410.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48518.md)
...
<a name="AEN48582"></a>## Description

`CHostListCheck` is derived from the
            [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48346.md).
...
<a name="AEN48592"></a>## Public member functions
...
<a name="AEN48683"></a>## Types and public data
