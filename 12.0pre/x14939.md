...
[← Modifying the skeleton application to meet your needs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14867.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Embedded Tcl server →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14955.md)

---

---

# <a name="sbsrdo.sec.commands"></a>67.4. Readout commands
