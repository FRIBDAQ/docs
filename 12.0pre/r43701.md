...
[← CSIS3300](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43687.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMETrigger →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43720.md)
...
<a name="AEN43754"></a>## Public member functions
...
<a name="AEN43792"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN43795"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
