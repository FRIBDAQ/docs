...
<a name="AEN64905"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN64908"></a>## Synopsis
...
<a name="AEN65077"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r59855]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r65626]])
...
<a name="AEN65085"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r65626]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r65626]] for
...
<a name="AEN65537"></a>## DEVICE ENUMERATION
...
<a name="AEN65561"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN65571"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN65577"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r63104]] for reference
...
<a name="AEN65620"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r59855]]
[[cccusbreadoutlist(3ccusb)|r65626]]
[[CCCUSBReadoutList(3ccusb)|r63104]]
