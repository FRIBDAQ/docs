...
[← Thread safe queues (CBufferQueue).](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13736.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Exception classes →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13826.md)
...
- [`Thread`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46929.md)
                      is the abstract base class from which you can construct
                      application specific threads.
- [`Synchronizable`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r47167.md)
                      is the class used to perform synchronization.
- [`SyncGuard`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r47275.md)
                      is built on top of `Synchronizable` to 
                      provide monitor like synchronization semantics.
- [*CCondition*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r47716.md)
...
- [*CGaurdedObject*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48027.md)
  	      documents the `CGaurdedObject` base class.
- [*CBufferQueue*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48093.md) described
