...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46520.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Synchronizable →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46582.md)
...
<a name="AEN46550"></a>## Name

CSynchronizedThread -- Thread with synchronized initialization

<a name="AEN46553"></a>## Synopsis

```

```

<a name="AEN46580"></a>## DESCRIPTION

Provides a Thread class (see
            [*Thread*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46393.md)).
