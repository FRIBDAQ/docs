...
[← CTCPBadSocketState](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51525.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLChannel →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51599.md)
...
<a name="AEN51608"></a>## Name

CTCPConnectionLost -- Exception thrown when connection to peer is lost

<a name="AEN51611"></a>## Synopsis

```
CTCPConnectionLost
```

<a name="AEN51643"></a>## DESCRIPTION
...
<a name="AEN51700"></a>## SEE ALSO

[*CSocket*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50499.md)
