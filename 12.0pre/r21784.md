...
[← EVB::reset](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21777.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lsservices →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21792.md)
...
<a name="AEN21798"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN21801"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN21808"></a>## DESCRIPTION
