...
[← The Wienercamac Tcl package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13307.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Integer byte order conversion library →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13495.md)

---

---

# <a name="chapter.uri"></a>Chapter 56. Parsing and URIs
...
<a name="AEN13467"></a>**Example 56-1. Sample URI library program**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13439.md#chapter.uri.usage)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13439.md#chapter.uri.try)
  The `URL` constructor parses the
                  ...
                  block.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13439.md#chapter.uri.pieces)
  This section of code takes the parsed URI and demonstrates
                  how to pull the elements of the URI out and print them.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13439.md#chapter.uri.catch)
  This code catches errors that may be thrown by the URI
                  parse.  The reason for the error is printed out.
                  For more information see
                  the
                  [`CURIFormatException` reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r55352.md).
...
<a name="AEN13493"></a>**Example 56-2. Building urltst.cpp**
