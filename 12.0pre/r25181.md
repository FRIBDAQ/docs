...
[← CRingTextItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25166.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingScalerItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25220.md)
...
<a name="AEN25377"></a>## Public member functions
...
<a name="AEN25617"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN25620"></a>**Example 1. Creating a begin run state transition item**
