...
[← ReadoutUI](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81778.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cvmusb →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81887.md)
...
<a name="AEN81854"></a>## Name

logbook -- Access Logbooks from Tcl

<a name="AEN81857"></a>## Synopsis
...
A disadvantage of the logbook package is, that while
            ...
            [*logbookadmin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r82597.md)
            package instead as that procedural interface does storage management
            for you.

<a name="AEN81875"></a>### SUBCOMMANDS
...
- **open *filename***
  Provides access to the logbook database in the file
                          ...
                          [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81906.md)
