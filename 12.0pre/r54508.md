...
[← CTCLResult](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r54424.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLHashTableItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r54511.md)
...
<a name="AEN54618"></a>## Public member functions
...
<a name="AEN54729"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN54734"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r53775.md)
