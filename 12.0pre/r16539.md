...
[← mg_cfgprogram](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16525.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [mg_kvget →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16558.md)
...
<a name="AEN16543"></a>## Name

mg_shutdown -- Shutdown the DAQ manager.

<a name="AEN16546"></a>## Synopsis

**
$DAQBIN/mg_shutdown *host user*
**

<a name="AEN16550"></a>## DESCRIPTION
