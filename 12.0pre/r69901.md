...
[← ReadoutGUIOutputClient](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69887.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutGUIOutputClient →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69936.md)
...
<a name="AEN69959"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68083.md#rdogui3_dialogwrapper).
