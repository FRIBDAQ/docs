...
[← ccusbcamac](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66457.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ph7106Widget →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66492.md)
...
<a name="AEN66490"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN66493"></a>## Synopsis

```
CControlHardware
```

<a name="AEN66560"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66316.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66423.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN66567"></a>## METHODS
