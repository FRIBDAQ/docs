...
[← ReadoutRESTClient](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81564.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81631.md)
...
<a name="AEN81596"></a>## Name

CControlHardware -- Base class for slow controls drivers

<a name="AEN81599"></a>## Synopsis

```
CControlHardware
```

<a name="AEN81691"></a>## DESCRIPTION
