...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r33817]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r33817]].
...
[[portAllocator(3tcl)|r84282]],
            [[CPortManagerException(3daq)|r33817]],
            [[DaqPortManager(1tcl)|r21308]]
