...
[← LogBookShift](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33615.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBookNote →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33694.md)
...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33817.md) for
...
<a name="AEN33719"></a>## Public member functions
...
If a port could not be allocated (e.g. all are in use or the port manager could
                ...
                [CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33817.md).
...
<a name="AEN33763"></a>## Types and public data
...
<a name="AEN33795"></a>## Exceptions

The `CPortManagerException` is thrown to inform the
            program of most errors dected by this API.  For more information about
            this exception, see:  [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33817.md).

<a name="AEN33800"></a>## EXAMPLES

Allocates a port to MyApplication

<a name="AEN33804"></a>**Example 1. Allocating a port with the port manager**
...
<a name="AEN33808"></a>**Example 2. Listing the port allocatiosn on a system.**
...
<a name="AEN33811"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r84282.md),
            [CPortManagerException(3daq)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33817.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21308.md)
