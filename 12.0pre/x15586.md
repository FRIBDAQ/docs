...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15586.md#filter-main-tempfiltinc)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15586.md#filter-main-maininst)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15586.md#filter-main-userfiltinst)
  Instantiate the user's filter(s). There can be any number of
              ...
              of the main program.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15586.md#filter-main-register)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15586.md#filter-main-mainloop)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15586.md#filter-main-fatalexcept)
...
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15586.md#filter-main-unknownexcept)
