...
[← Tcl access to the VME via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9335.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [xlmload firmware loader for XLM modules via VM-USB controllers. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9397.md)

---

---

# <a name="usbloaders_chap"></a>Chapter 30. VM/CCUSB Firmware loaders
...
The VM-USB and CC-USB main Xilinx FPGA chips load their configuration
        ...
        The [*ccusbloader*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18444.md)
        and [*vmusbloader*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18478.md)
