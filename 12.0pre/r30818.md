...
[← CFileDataSink](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30786.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSource →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30863.md)
...
<a name="AEN30832"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN30835"></a>## Synopsis

```
CDataSink
```

<a name="AEN30860"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31152.md)
