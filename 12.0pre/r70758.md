...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70756.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [parameters →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70765.md)
...
<a name="AEN70762"></a>## Name

LogBook -- Python bindings to LogBook Api.

<a name="AEN70765"></a>## Synopsis
...
<a name="AEN70782"></a>## PEOPLE API section
...
This section allows you to create and retrieve people from the logbook.
         ...
         [*LogBook.Person*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71178.md).
...
`
  ...
  For more informationa bout the strings that can be used
                    ...
                    table at
                    [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98204.md)
...
<a name="AEN70854"></a>## SHIFT API Section
...
The Shift part of the API manipulates collections of people that
         ...
         [*LogBook.Shift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71222.md) reference page.
...
<a name="AEN70915"></a>## RUN API Section

Runs are segments of data taking.  They are encapsulated with
         `LogBook.Run` objects. For more on those, see
         [*LogBook.Run*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71298.md).
...
<a name="AEN70977"></a>## NOTE API section
...
Notes are incapsulated in `LogBook.Note` objects.
         ...
         [*LogBook.Note*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71497.md).
...
<a name="AEN71104"></a>## KEY VALUE STORE API Section
