...
[← CCAENV262Triger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95270.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEventPacket →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95380.md)
...
`Creates the object.  `seg` is a reference
                ...
                [CDocumentedPacket(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95058.md)
