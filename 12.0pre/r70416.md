...
[← check](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70408.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [init →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70429.md)
...
<a name="AEN70430"></a>## Name

resume -- Resume a Paused Run

<a name="AEN70433"></a>## Synopsis
...
Resumes a run that is paused in the data source identified by
          ...
          [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70507.md) specifies  the
