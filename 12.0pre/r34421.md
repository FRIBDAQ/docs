...
[← CEVBClientFramework](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34403.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAENcard →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34445.md)
...
<a name="AEN34435"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN34438"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN34468"></a>## DESCRIPTION
...
See METHODS below for a description of the base class methods
            ...
            [*CEVBClientFramework*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34575.md)
...
<a name="AEN34530"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
