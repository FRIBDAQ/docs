...
[← eventlog](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18258.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ScalerDisplay →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18294.md)
...
Requests that an event orderer started via
            [*EVBRest*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18313.md)
            exit.  *host* and
