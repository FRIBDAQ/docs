...
[← CCAENV560](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39310.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV560 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39433.md)
...
<a name="AEN39463"></a>## Public member functions



- <a name="AEN39468"></a>`CCAMACStatusModule(unsigned int b, unsigned int c, unsigned int n);`
...
- <a name="AEN39501"></a>`virtual void  GoBusy(void);`
  Pulses the computer going busy output.  This is usually used to indicate
                              ...
                              latch to be busy.
- <a name="AEN39511"></a>`virtual void  GoClear(void);`
...
- <a name="AEN39521"></a>`virtual void  ModuleClear(void);`
