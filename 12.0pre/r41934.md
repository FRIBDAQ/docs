...
[← CSIS3600](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41932.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCrateController →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41995.md)
...
<a name="AEN41948"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN41951"></a>## Synopsis
...
<a name="AEN42058"></a>## Public member functions



- <a name="AEN42063"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN42101"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN42116"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN42129"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN42142"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN42187"></a>`T*  T* operator-> (void);`
...
- <a name="AEN42197"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN42212"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN42224"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN42236"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN42248"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN42258"></a>## Types and public data
