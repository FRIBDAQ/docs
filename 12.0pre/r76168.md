...
[← v1729a](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76069.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMUSB →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76200.md)
...
<a name="AEN76182"></a>## Name

CControlHardware -- Base class for slow controls drivers

<a name="AEN76185"></a>## Synopsis

```
CControlHardware
```

<a name="AEN76277"></a>## DESCRIPTION
