...
[← Running Readout Software With the Manager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1399.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Building event builder clients. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14212.md)
