...
[← Using the Event Builder With The Manager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5726.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The evblite Tcl package. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5816.md)
