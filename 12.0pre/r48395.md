...
[← CAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48346.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPasswordCheck →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48404.md)
...
The
            ...
            [CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48287.md)
            class, however the list is stored internally in the class rather than
            in a Tcl variable.

<a name="AEN48470"></a>## Public member functions
...
<a name="AEN48541"></a>## Types and public data
