...
[← sis3820](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67359.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::startRingSource →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67397.md)
...
<a name="AEN67396"></a>## Name

Configuration -- Configuration variable management

<a name="AEN67399"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69054.md) package for that
            instead.

<a name="AEN67422"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69054.md) is a better
                          choice).
