...
[← Interactors](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13901.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running Readout Software With the Manager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1399.md)

---

---

# <a name="AEN13955"></a>64.4. Event orderer packages
