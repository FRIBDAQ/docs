...
[← 3rdogui](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67145.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [sis330x →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67152.md)
...
<a name="AEN67161"></a>## Name

Introduction -- ReadoutGUI API introduction

<a name="AEN67164"></a>## DESCRIPTION
...
- bells
  This package provides the `bells`
                              ...
                              some pattern.
  See
                              [*bells*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67261.md)
...
- Configuration
  ...
  See
                              [*Configuration*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67382.md)
                              for reference information.
- DAQParameters
  Provides access to parameters that affect data taking.
                              ...
                              above.
  See
                              [*DAQParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67481.md)
                              for reference information.
- DataSourceManager
...
- DataSourceUI
  ...
  See
                              [*DataSourceUI*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67911.md)
- Diagnostics
  Provides simple error/warning/info dialogs.
                              See:
                              [*Diagnostics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68241.md)
- ExpFileSystemConfig
  Provides read/write access to configuration parameters
                              that determine where event data and related meta-data
                              are stored.
                              See:
                              [*ExpFileSystemConfig*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68316.md)
- ReadoutGUI
  Provides the readout GUI application class which
                              strings everything together. See
                              [*ReadoutGui*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68405.md)
- ReadoutGUIPanel
  Provides a group of API elements that allow you
                              ...
                              object.
                              See:
                              [*ReadoutGUIPanel*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68556.md)
- RunstateMachine
...
- StateManager
  ...
  See
                              [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69054.md)
- ui
