...
[← Saving and restoring state](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7938.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for USB communication →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7967.md)

---

---

# <a name="AEN7963"></a>15.2. Synchronization Paradigm
