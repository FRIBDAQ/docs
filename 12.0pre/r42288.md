...
[← CSIS3820](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r42278.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3600 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r42345.md)
...
<a name="AEN42341"></a>## Public member functions
...
<a name="AEN42379"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN42382"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
