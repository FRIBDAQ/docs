...
[← LogBookNote](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34279.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEVBClientFramework →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34403.md)
...
<a name="AEN34312"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN34315"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN34345"></a>## DESCRIPTION
...
See METHODS below for a description of the base class methods
            ...
            [*CEVBClientFramework*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34452.md)
...
<a name="AEN34407"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
