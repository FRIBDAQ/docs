...
<a name="AEN69155"></a>## Name

ReadoutGUIPanel -- ReadoutGUI Convenience commands

<a name="AEN69158"></a>## Synopsis
...
<a name="AEN69215"></a>## COMMANDS



**::ReadoutGUIPanel::addUserMenu** *ident label*Adds a new menu to the menubar of the ReadoutGUI.
...
**::ReadoutGUIPanel::getRunIdInstance**The Readout GUI is composed of several megawidgets.
...
**::ReadoutGUIPanel::ghostWidgets**Some widgets in the ReadoutGUI must be disabled while
                            the run is not in the halted state.  This
                            command disables those widgets.  See also
                            **::ReadoutGUIPanel::unghostWidgets**

**::ReadoutGUIPanel::unghostWidgets**Enable the widgets that must be disabled when the
                            run is not in the halted state. See also
                            **::ReadoutGUIPanel::ghostWidgets**

**::ReadoutGUIPanel::getTitle**Returns the title from the title section of the
...
**::ReadoutGUIPanel::setTitle** *new-title*Makes `new-title` the new title
...
**::ReadoutGUIPanel::getRun**Returns the value of the run number in the run
...
**::ReadoutGUIPanel::setRun** *new-run*Sets the run number in the run identification
...
**::ReadoutGUIPanel::incrRun**Adds one to the run number in the run identification
                            megawidget. This should only be done when the
                            run is not active (in neither the
                            Active nor Paused
                            states).

**::ReadoutGUIPanel::recordOff**Turns off the record checkbutton in the run control
...
**::ReadoutGUIPanel::recordOn**Turns on the record checkbutton in the run control
                            megawidget.

**::ReadoutGUIPanel::recordData**Returns the state of the record checkbutton in the
                            run control megawidget.

**::ReadoutGUIPanel::getRunTime**Returns the number of seconds the current run has
...
**::ReadoutGUIPanel::isTimed**Returns boolean true if the timed
                            run button is on and false if not.

**::ReadoutGUIPanel::setTimed** *state*Checks or unchecks the timed run checkbutton according
...
**::ReadoutGUIPanel::getRequestedRunTime**Returns the number of seconds in the requested run
...
**::ReadoutGUIPanel::setRequestedRunTime** *time-in-seconds*Sets the number of seconds in the requested run time
...
**::ReadoutGUIPanel::isRecording**Sets the rendition of the text widget to be consistent
                            with the run being recorded.

**::ReadoutGUIPanel::notRecording**Sets the rendition of the text widget to be consistent
                            with the run being not recorded.

**::ReadoutGUIPanel::normalColors**A synonym for **::ReadoutGUIPanel::notRecording**

**::ReadoutGUIPanel::outputText** *message*Outputs `message` to the output
...
**::ReadoutGUIPanel::Log** *source class message*Formats a log message to be output on the text widget.
