...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56456.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56553.md)
...
<a name="AEN56519"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN56522"></a>## Synopsis

```
CException
```

<a name="AEN56556"></a>## Description
...
<a name="AEN56561"></a>## Public member functions
