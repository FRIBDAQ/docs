...
[← EVB::inputStatistics::summaryDisplay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r20737.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [::EVB::utility::sortedWidget →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r20780.md)
...
<a name="AEN20759"></a>## Name

EventBuilder -- Event builder utility **proc**s

<a name="AEN20763"></a>## Synopsis
...
<a name="AEN20790"></a>## DESCRIPTION

Provides a procedural interface to the event builder.

<a name="AEN20793"></a>## PROCs
