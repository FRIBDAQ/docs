...
[← ReadoutParameters](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88321.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutState →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88365.md)
...
This megawidget glues together the
            [*ReadoutParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88272.md),
            [*ReadoutStatistics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88257.md)
            and
            [*ReadoutState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88316.md)
