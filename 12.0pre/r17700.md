...
[← lg_kvstore](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17674.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lg_selshift →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17705.md)

---

---

# <a name="AEN17700"></a>evbtagger

<a name="AEN17704"></a>## Name

evbtagger -- Filter to add fragment headers

<a name="AEN17707"></a>## Synopsis

**
$DAQBIN/evbtagger *options*
**

<a name="AEN17711"></a>## DESCRIPTION
