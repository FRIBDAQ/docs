...
[← 3rdogui](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67730.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DataSourceManager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67831.md)
...
- bells
  This package provides the `bells`
                              ...
                              some pattern.
  See
                              [*bells*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67846.md)
...
- Configuration
  ...
  See
                              [*Configuration*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67967.md)
                              for reference information.
- DAQParameters
  Provides access to parameters that affect data taking.
                              ...
                              above.
  See
                              [*DAQParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68066.md)
                              for reference information.
- DataSourceManager
...
- DataSourceUI
  ...
  See
                              [*DataSourceUI*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68496.md)
- Diagnostics
  Provides simple error/warning/info dialogs.
                              See:
                              [*Diagnostics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68826.md)
- ExpFileSystemConfig
  Provides read/write access to configuration parameters
                              that determine where event data and related meta-data
                              are stored.
                              See:
                              [*ExpFileSystemConfig*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68901.md)
- ReadoutGUI
  Provides the readout GUI application class which
                              strings everything together. See
                              [*ReadoutGui*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68990.md)
- ReadoutGUIPanel
  Provides a group of API elements that allow you
                              ...
                              object.
                              See:
                              [*ReadoutGUIPanel*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69141.md)
- RunstateMachine
...
- StateManager
  ...
  See
                              [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69639.md)
- ui
