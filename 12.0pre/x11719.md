...
[← Creating ring items](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11279.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Manager User Interface API →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11909.md)

---

---

# <a name="sec.manager.clientapi"></a>45.2. Manager REST client API.
...
## <a name="AEN11735"></a>45.2.1. REST Client for State Transitions
...
The REST client is exported in an object oriented manner.
            ...
            [*stateclient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81200.md)
...
<a name="AEN11743"></a>**Example 45-17. Sample State Transition REST Client**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.require)
  In order to use the REST state transition client, it is
                    necessary to pull the stateclient
                    package into your script.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.usage)
  This proc outputs the program usage.  It'll be called if
                    the user does not provide the correct command parameters.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.parameters)
  These two lines of code extract the host and the username
                    from the command line parameters.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.construct)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.current)
  The `currentState` method of a
                    `StateClient` object returns the name
                    of the current state in which the state machine is now in.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.next)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.transition)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.destroy)
  The `StateClient` object has a
                    pre-defined method `destroy` which
                    destroys the object.  We call this before exiting the program.

## <a name="AEN11785"></a>45.2.2. REST Client for Program Status
...
Reference information is available:
            [*programstatusclient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81267.md).
...
<a name="AEN11797"></a>**Example 45-18. Using The programstatusclient Package**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.require)
  To use the package it must be pulled into the script via
                    the **package require** command shown.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.construct)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.status)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.destroy)
  This line destroys the client object.

## <a name="AEN11831"></a>45.2.3. REST Client for Key Value Store
...
Full documentation on this package is available at
            [*kvclient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81372.md).
...
<a name="AEN11839"></a>**Example 45-19. Using the kvclient Package.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.require)
  In order to make calls to the Key Value REST client API,
                    the kvclient package must be pulled into the
                    program.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.mktitle)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.construct)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.settitle)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.list)
  The `list` method dumps the entire
                    ...
                    key value store key.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.destroy)
...
## <a name="AEN11871"></a>45.2.4. REST Clients for Event Log Management
...
The loggerrestclient package provides an
            ...
            [*loggerrestclient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81440.md)

The following example program enables all loggers, sets the recording
            state on and starts the loggers.

<a name="AEN11878"></a>**Example 45-20. Using the loggerrestclient Package**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.require)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.construct)
  Constructs an instance of a client to a manager server that
                    will interact with the logger REST  server domain.k
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.list)
  The `listLoggers` method of a logger
                    ...
                    destination is required, by the API to be unique and is used
                     ...
                     loggers.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.enable)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.record)
  The `record` method sets the state of
                    the global recording flag.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.start)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.destroy)
