...
| Prev | Chapter 45. DAQ Manager APIs | Next |
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.require]]
  In order to use the REST state transition client, it is
                    necessary to pull the stateclient
                    package into your script.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.usage]]
  This proc outputs the program usage.  It'll be called if
                    the user does not provide the correct command parameters.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.parameters]]
  These two lines of code extract the host and the username
                    from the command line parameters.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.construct]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.current]]
  The `currentState` method of a
                    `StateClient` object returns the name
                    of the current state in which the state machine is now in.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.next]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.transition]]
...
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.staterest.destroy]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.require]]
  To use the package it must be pulled into the script via
                    the **package require** command shown.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.construct]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.status]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.pgmstat.destroy]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.require]]
  In order to make calls to the Key Value REST client API,
                    the kvclient package must be pulled into the
                    program.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.mktitle]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.construct]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.settitle]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.list]]
  The `list` method dumps the entire
                    ...
                    key value store key.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.kvclient.destroy]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.require]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.construct]]
  Constructs an instance of a client to a manager server that
                    will interact with the logger REST  server domain.k
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.list]]
  The `listLoggers` method of a logger
                    ...
                    destination is required, by the API to be unique and is used
                     ...
                     loggers.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.enable]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.record]]
  The `record` method sets the state of
                    the global recording flag.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.start]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11719.md#ex.lgclient.destroy]]
