...
[← CV977Trigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96919.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CScaler →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r97010.md)
...
<a name="AEN96975"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN96978"></a>## Synopsis
...
<a name="AEN97026"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96247.md)).
