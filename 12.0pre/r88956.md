...
[← personinstance](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88955.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [shiftinstance →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88961.md)
...
This megawidget glues together the
            [*ReadoutParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88878.md),
            [*ReadoutStatistics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88863.md)
            and
            [*ReadoutState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88922.md)
...
- `-statistics`
  Passes Readout statistics to the
                       ...
                       method of
                       [*ReadoutRESTClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88742.md)
