...
[← ExpFileSystemConfig](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68365.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Diagnostics →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68413.md)
...
- `-sources` *list-of-source-dicts*
  The data in this option determines what the
                                  ...
                                  the `sources` method
                                  of
                                  [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67659.md)
...
All methods from the `DialogWrapper`
                    ...
                    [*ui*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md)
