...
[← CCAENV560](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39261.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV560 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r39310.md)
...
<a name="AEN39344"></a>## Public member functions



- <a name="AEN39349"></a>`CCAMACScalerLRS4434(unsigned int b, unsigned int c, unsigned int n);`
  Constructs a new `CCAMACScalerLRS4434` object.
                              ...
                              parameters.
- <a name="AEN39367"></a>` virtual   void  Initialize(void);`
  Sets up the module for use in data taking.  The module will be software latched
                              ...
                              Off position.
- <a name="AEN39378"></a>`virtual   void  Read(std::vector<unsigned long>&
                                      Scalers);`
  Reads the 32 scaler channels of the module and appends their values
                              ...
                              to be incremental.
- <a name="AEN39391"></a>`virtual   void  Clear(void);`
  Clears the scaler counters.  The counters are all simulataneousl cleared
                              ...
                              again.
- <a name="AEN39401"></a>`virtual unsigned int  size(void);`
