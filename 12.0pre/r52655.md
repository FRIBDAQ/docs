...
[← CTCLList](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52622.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLInterpreter →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52718.md)
...
<a name="AEN52669"></a>## Name

CTCLString -- 
            Provide a wrapper for the Tcl_DString data type
            and its API

<a name="AEN52673"></a>## Synopsis
