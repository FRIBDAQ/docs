...
[← ReadoutUI](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88522.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [logbookinstance →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88533.md)
...
<a name="AEN88530"></a>## Name

logbook -- Access Logbooks from Tcl

<a name="AEN88533"></a>## Synopsis
...
A disadvantage of the logbook package is, that while
            ...
            [*logbookadmin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89273.md)
            package instead as that procedural interface does storage management
            for you.

<a name="AEN88551"></a>### SUBCOMMANDS
