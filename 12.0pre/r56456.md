...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56398.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56505.md)
...
<a name="AEN56470"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN56473"></a>## Synopsis

```
CException
```

<a name="AEN56507"></a>## Description
...
<a name="AEN56512"></a>## Public member functions
