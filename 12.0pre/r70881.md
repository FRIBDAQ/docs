...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70879.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [begin →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70884.md)
...
<a name="AEN70885"></a>## Name

LogBook -- Python bindings to LogBook Api.

<a name="AEN70888"></a>## Synopsis
...
<a name="AEN70905"></a>## PEOPLE API section
...
`
  ...
  For more informationa bout the strings that can be used
                    ...
                    table at
                    [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98327.md)
...
<a name="AEN70977"></a>## SHIFT API Section
...
The Shift part of the API manipulates collections of people that
         ...
         [*LogBook.Shift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71345.md) reference page.
...
<a name="AEN71038"></a>## RUN API Section

Runs are segments of data taking.  They are encapsulated with
         `LogBook.Run` objects. For more on those, see
         [*LogBook.Run*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71421.md).
...
<a name="AEN71100"></a>## NOTE API section
...
Notes are incapsulated in `LogBook.Note` objects.
         ...
         [*LogBook.Note*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71620.md).
...
<a name="AEN71227"></a>## KEY VALUE STORE API Section
