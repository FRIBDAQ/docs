...
[← CTCPConnectionFailed](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51644.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPNoSuchHost →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51753.md)
...
<a name="AEN51718"></a>## Name

CTCPNoSuchHost -- CTCPNoSuchHost

<a name="AEN51721"></a>## Synopsis

```
CTCPNoSuchHost
```

<a name="AEN51765"></a>## DESCRIPTION
