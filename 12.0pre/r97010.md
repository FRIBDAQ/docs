...
[← CScaler](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96961.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [RunState →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r97023.md)
...
<a name="AEN97024"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN97027"></a>## Synopsis
...
<a name="AEN97075"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96296.md)).
