...
[← fragment.h](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34194.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBookNote →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34279.md)
...
<a name="AEN34263"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN34266"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN34296"></a>## DESCRIPTION
...
See METHODS below for a description of the base class methods
            ...
            [*CEVBClientFramework*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34403.md)
...
<a name="AEN34358"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
