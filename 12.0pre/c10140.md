...
[← The Tcl ring package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10125.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Providing EPICS channel information to Tcl Servers →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10209.md)

---

---

# <a name="chapter.ringformat-dev"></a>Chapter 44. Data Format Support Software

In the user guide section on [data
      formats](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c185.md), the format of all the ring items were explained in
...
# <a name="AEN10155"></a>44.1. The basic data formats
...
<a name="AEN10245"></a>`pDataFormatformatDataFormat
          (void);`


<a name="AEN10251"></a>`pGlomParameters
...
<a name="AEN10265"></a>`pEventBuilderFragment
            formatEVBFragment
          (
            uint64_t timestamp
          , 
...
<a name="AEN10285"></a>`pEventBuilderFragment
...
<a name="AEN10305"></a>` pPhysicsEventItem
...
<a name="AEN10325"></a>` pPhysicsEventCountItem
...
<a name="AEN10418"></a>` pStateChangeItem
...
<a name="AEN10450"></a>` void* bodyPointer
          (
            pRingItem pItem
          );`
...
## <a name="AEN10459"></a>44.1.1. State Change Items
...
## <a name="AEN10499"></a>44.1.2. Text List Items
...
## <a name="AEN10548"></a>44.1.3. Scaler Items
...
## <a name="AEN10581"></a>44.1.4. Event Data Items
...
## <a name="AEN10588"></a>44.1.5. Event count items
