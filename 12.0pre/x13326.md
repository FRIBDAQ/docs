...
[← An overview of the use of the camac package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13288.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using wienercamac →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13353.md)

---

---

# <a name="AEN13326"></a>55.2. Authenticators
...
<a name="AEN13330"></a>**Example 55-3. Boilerplate DAQ Authorization code **
...
The complete definitinon of
            ...
            [its reference pages](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r45987.md).
            The library provides the following concrete authentication classes:



- [`CPasswordCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46101.md)
...
- [`CUnixUserCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46299.md)
  The entity must provide a valid username and password
                          that is could login to the local unix system.
- [`CTclAccesListCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46520.md)
...
- [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46628.md)
  The entity must supply a string that is one of a set of strings
                              given to the authenticator.
- [`CHostListCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46780.md)
