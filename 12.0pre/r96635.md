...
[← CTimedTrigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96586.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CInvalidPacketStateException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96669.md)
...
<a name="AEN96685"></a>| Plug | Direction | Meaning |
| --- | --- | --- |
...
<a name="AEN96706"></a>## Public member functions
...
<a name="AEN96742"></a>## SEE ALSO

[CBusy(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r94464.md),
     [CV977Trigger(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96747.md)
