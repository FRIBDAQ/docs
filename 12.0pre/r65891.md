...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65887.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CModuleFactory →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65903.md)
...
<a name="AEN65905"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN65908"></a>## Synopsis

```
CControlHardware
```

<a name="AEN65975"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65731.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65838.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN65982"></a>## METHODS
