...
[← CTrigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43137.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTrigger →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r43186.md)
...
<a name="AEN43189"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN43192"></a>## Synopsis
...
<a name="AEN43299"></a>## Public member functions



- <a name="AEN43304"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN43342"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN43357"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN43370"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN43383"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN43428"></a>`T*  T* operator-> (void);`
...
- <a name="AEN43438"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN43453"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN43465"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN43477"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN43489"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN43499"></a>## Types and public data
