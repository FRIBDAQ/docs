...
[← CTrigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41896.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41934.md)
...
<a name="AEN42094"></a>## Public member functions
...
- <a name="AEN42117"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN42127"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN42138"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN42149"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN42161"></a>` void SetLatchMode(void);const`
...
- <a name="AEN42173"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN42208"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN42277"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN42288"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN42299"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN42310"></a>` void Clock(void);const`
...
- <a name="AEN42321"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN42332"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN42343"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN42355"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN42366"></a>` unsigned long Read(void);const`
...
- <a name="AEN42378"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
