...
<a name="AEN89087"></a>## Name

logbook -- Access Logbooks from Tcl

<a name="AEN89090"></a>## Synopsis
...
**create *filename experiment spokesperson purpose***Creates a new logbook database in
                        `filename`.  `filename`
...
**open *filename***Provides access to the logbook database in the file
...
**tempdir**Returns a path to the directory the logbook system
