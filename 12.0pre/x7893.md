...
[← Running the system.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7881.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration menu →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7918.md)

---

---

# <a name="AEN7893"></a>14.3. Starting the GUI for the RC-bus through an MxDC device
...
5. The user will then be presented with the following display and should
   ...
   <a name="mcfd16control_fig1"></a>**Figure 14-2. MCFD16Control Graphical User Interface for MxDC-RCbus**
