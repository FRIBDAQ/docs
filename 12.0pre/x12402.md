...
[← Sending data to the event builder.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12312.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Callbacks →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12436.md)

---

---

# <a name="AEN12402"></a>46.6. The Event orderer/event builder API
...
## <a name="AEN12410"></a>46.6.1. Starting the event builder/orderer
...
<a name="AEN12413"></a>**Example 46-3. Starting the event builder**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12402.md#evb_start_ap)
  Adds the Tcl Library directory of the NSCLDAQ to the
                          ...
                          tclsh or
                          wish starts.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12402.md#evb_start_require)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12402.md#evb_start_start)
