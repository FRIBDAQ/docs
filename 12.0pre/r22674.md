...
Load firmware file into a V1724 base address 0x32100000<a name="AEN22799"></a>```
...
Retrieve the ID code for the board above<a name="AEN22804"></a>```
...
Load firmware and license it.<a name="AEN22811"></a>```
...
Retrieve license information from a digitizer.<a name="AEN22819"></a>```
...
Un-license a digitizer's firmware:<a name="AEN22824"></a>```
