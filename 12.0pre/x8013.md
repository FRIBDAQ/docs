...
[← The full readout program.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7996.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and Restoring The State of the GUI Between Sessions →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8046.md)

---

---

# <a name="AEN8013"></a>16.2. How to use the MDGG16Control GUI
...
5. The user will then be presented with the a graphical user interface 
             ...
             are in sync.
   <a name="mdgg16control_fig1"></a>**Figure 16-1. MDGG16Control Graphical User Interface**
