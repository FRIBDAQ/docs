...
[← CTCLVariable](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r53085.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLObject →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r53154.md)
...
<a name="AEN53132"></a>## Name

CTCLProcessor -- 
            Provide `argc`, `argv`
            extension commands to Tcl.

<a name="AEN53137"></a>## Synopsis
