...
[← CRangeError](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r57225.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMonitorException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r57265.md)
...
<a name="AEN57256"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN57259"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN57343"></a>## Description
...
<a name="AEN57350"></a>## Public member functions
