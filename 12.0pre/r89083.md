...
[← personinstance](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89078.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [noteinstance →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89109.md)
...
A disadvantage of the logbook package is, that while
            ...
            [*logbookadmin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89830.md)
...
- **open *filename***
  Provides access to the logbook database in the file
                          ...
                          [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89139.md)
