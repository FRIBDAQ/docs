...
<a name="AEN23314"></a>### Configuration Options
...
<a name="AEN23338"></a>### Device Options
...
<a name="AEN23368"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN23384"></a>```
...
Retrieve the ID code for the board above<a name="AEN23389"></a>```
...
Load firmware and license it.<a name="AEN23396"></a>```
...
Retrieve license information from a digitizer.<a name="AEN23404"></a>```
...
Un-license a digitizer's firmware:<a name="AEN23409"></a>```
