...
[← Sequencing runs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9933.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DAQ Software Documentation →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/index.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9944.md#chapter.ringaccess.hostname)
  This section of code determines the name of the host.
                  For spdaq20.nscl.msu.edu e.g., this will
                  fill `localhost` with
                  localhost
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9944.md#chapter.ringaccess.domain)
  This section of code determines DNS domain name of the system.
                  For spdaq20.nscl.msu.edu
  `domain` gets filled with the string
                  nscl.msu.edu.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9944.md#chapter.ringaccess.islocal)
  This section of code considers the case that
                  ...
                  *fully qualified host name*
                  ...
                  the `ring`
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9944.md#chapter.ringaccess.builduri)
...
[Remote Ring Access](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22662.md) provides
