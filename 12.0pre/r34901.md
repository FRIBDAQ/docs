...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r35058]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r35058]].
...
[[portAllocator(3tcl)|r90909]],
            [[CPortManagerException(3daq)|r35058]],
            [[DaqPortManager(1tcl)|r21630]]
