...
[← FrameManager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r94040.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [wait →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r94074.md)

---

---

# <a name="AEN94049"></a>Orphan

<a name="AEN94053"></a>## Name

Orphan -- Run script when the process is orphaned

<a name="AEN94056"></a>## Synopsis
