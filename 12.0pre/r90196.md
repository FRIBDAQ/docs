...
[← EVBRESTClient](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90173.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBRESTClient →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90296.md)
...
<a name="AEN90210"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN90213"></a>## Synopsis
...
<a name="AEN90261"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89482.md)).
