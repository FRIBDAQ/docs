...
| Prev | Chapter 42. Ring Buffer Primitives | Next |
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringcons.include)
  The
                          CRingBuffer.h
                          header is included.
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringcons.std)
  Incorporating the
                          ...
                          `std::string`
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringcons.create)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringcons.obj)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringcons.latency)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringcons.get)
  The
                          `get`
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringprod.include)
  Includes the
                          CRingBuffer.h
                          ...
                          ring buffers.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringprod.latency)
  See the discussion of the consumer for more
                          ...
                          response latencies.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringprod.pattern)
  This loop creates a buffer that consists of 1MB
                          counting pattern.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10042.md#ringprod.put)
