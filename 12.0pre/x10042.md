...
[[![(1)](../images/callouts/1.gif)|x10042#ringcons.include]]                        The
                        CRingBuffer.h
                        header is included.
                    ...
                    [[![(2)](../images/callouts/2.gif)|x10042#ringcons.std]]                        Incorporating the
                        ...
                        `std::string`
[[![(3)](../images/callouts/3.gif)|x10042#ringcons.create]]                        Ring buffers are created via a the
                        `create` static
                    ...
                    [[![(5)](../images/callouts/5.gif)|x10042#ringcons.latency]]                        When a ring buffer consumer must block because
...
[[![(6)](../images/callouts/6.gif)|x10042#ringcons.get]]                        The
                        `get`
...
[[![(1)](../images/callouts/1.gif)|x10042#ringprod.include]]                        Includes the
                        CRingBuffer.h
