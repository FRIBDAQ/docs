...
[← CCAMACTrigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41356.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCrateController →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41410.md)
...
<a name="AEN41408"></a>## Public member functions
...
- <a name="AEN41433"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN41446"></a>` void WriteBit(unsigned int nBitno);`
