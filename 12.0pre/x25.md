...
[← Extending the Supported Readout Hardware](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2237.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Extending the slow controls subsystem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2650.md)
...
With any experiment, it is paramount to understand quickly whether the
      ...
      inspection. The most basic and useful is the [dumper](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9098.md) program, which provides a textual
      ...
      are higher level tools though such as the [ScalerDisplay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c5861.md) program. The
...
The fact that ring buffers lie on either side of each process allows the
      ...
      information. Other tools like the [ringbuffer](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15438.md) program provide
...
![](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/figures/intro-data-flow-diagram-diagnostics.png)
