...
[← EVB::inputStats](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21900.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lsservices →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21915.md)
...
<a name="AEN21921"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN21924"></a>## Synopsis
...
<a name="AEN21979"></a>### Map access command
...
<a name="AEN21989"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN21997"></a>***mapname* put *width offset value***
