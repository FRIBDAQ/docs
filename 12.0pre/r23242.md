...
[← CRingAccess](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23119.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1utilities →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23257.md)
...
<a name="AEN23256"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN23259"></a>## Synopsis
...
<a name="AEN23335"></a>## Public member functions
...
<a name="AEN23426"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN23430"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN23434"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
