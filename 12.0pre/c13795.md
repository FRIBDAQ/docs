...
[← C++ encapsulation of a Tcl API subset](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13737.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Access control and security →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13836.md)

---

---

# <a name="chapter.exception"></a>Chapter 63. The NSCL Exception class library
...
```
        ...
        # <a name="AEN13816"></a>63.1. Incorporating the library in your programs
