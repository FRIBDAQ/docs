...
[← CEventSegment](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95459.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEventSegment →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95508.md)
...
`Creates the object.  `seg` is a reference
                ...
                [CDocumentedPacket(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95230.md)
