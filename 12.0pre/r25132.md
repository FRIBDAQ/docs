...
[← CRingScalerItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24807.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingTextItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25166.md)
...
<a name="AEN25328"></a>## Public member functions
...
<a name="AEN25568"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN25571"></a>**Example 1. Creating a begin run state transition item**
