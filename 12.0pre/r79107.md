...
[← AXLM72](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r79071.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMUSBRemote →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r79156.md)
...
<a name="AEN79121"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN79124"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN80310"></a>## DESCRIPTION
...
<a name="AEN80313"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76200.md)
