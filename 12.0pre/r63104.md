...
[← CCCUSBusb](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63032.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBRemote →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63234.md)
...
<a name="AEN63118"></a>## Name

CCCUSBReadoutList -- Create lists of CAMAC commands for CC-USB controllers.

<a name="AEN63121"></a>## Synopsis

```
CCCUSBReadoutList
```

<a name="AEN63323"></a>## DESCRIPTION
