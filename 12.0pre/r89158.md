...
[← logbookinstance](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89139.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [runinstance →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89181.md)
...
<a name="AEN89162"></a>## Name

noteinstance -- Tcl encapsulation of a note

<a name="AEN89165"></a>## Synopsis
...
A note instance is a Tcl command ensemble that provides access to
            ...
            See
            [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88582.md) for subcommands that
            can generate notess
...
set run [*$note* run]
  ...
  If the note has an associated run, this subcommand returns
                       ...
                       [*runinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89058.md)
