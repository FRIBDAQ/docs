...
[← Wiener MDGG-16 Controls](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8006.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using NSCLDAQ with a CAEN V785 Peak-Sensing ADC and CAEN V262 IO Register →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8077.md)

---

---

# <a name="AEN8054"></a>Chapter 17. 
    XLM72 Gate Delay Control GUI

# <a name="AEN8056"></a>17.1. Introduction
