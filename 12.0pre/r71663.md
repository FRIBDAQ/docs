...
[← LogBook.Note](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71620.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBook.Person →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71714.md)
...
<a name="AEN71677"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN71680"></a>## Synopsis
...
<a name="AEN71694"></a>## METHODS



- <a name="AEN71699"></a>`PortManager(string host, int    port);`
