...
[← EventBuilder](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21330.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::inputStats →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21364.md)
...
<a name="AEN21349"></a>## Name

EVB::handleFragment -- Submit event fragments.

<a name="AEN21352"></a>## Synopsis

**
EVB::handleFragments *file-descriptor*
**

<a name="AEN21356"></a>## DESCRIPTION
...
The format of the data expected on that file descriptor is described
            in [*eventorderer*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98892.md).
