...
[← CRingBufferChunkAccess](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30638.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDataSourceFactory" →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30648.md)
...
<a name="AEN30660"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN30663"></a>## Synopsis

```
CDataSink
```

<a name="AEN30688"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30980.md)
