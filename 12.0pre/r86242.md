...
[← readoutscript](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86232.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [readoutscript →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86281.md)
...
This is a pre-packaged widget that supplies the needed interfaces
      for use with [*gdgcontrol*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86014.md).
