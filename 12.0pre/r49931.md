...
[← URL](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49894.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPNoSuchHost →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49986.md)
...
<a name="AEN49945"></a>## Name

CDAQShm -- class description

<a name="AEN49948"></a>## Synopsis

```
CDAQShm
```

<a name="AEN50063"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49931.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49931.md#daqshm-varsrefsect).
