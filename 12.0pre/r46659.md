...
[← Synchronizable](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46631.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CFilterMain →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46660.md)
...
<a name="AEN46673"></a>## Name

CSynchronizedThread -- Thread with synchronized initialization

<a name="AEN46676"></a>## Synopsis

```

```

<a name="AEN46703"></a>## DESCRIPTION

Provides a Thread class (see
            [*Thread*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46516.md)).
