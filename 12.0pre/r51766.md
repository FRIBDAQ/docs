...
[← CTCPNoSuchHost](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51753.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLCommandPackage →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51779.md)
...
<a name="AEN51780"></a>## Name

CTCPConnectionLost -- Exception thrown when connection to peer is lost

<a name="AEN51783"></a>## Synopsis

```
CTCPConnectionLost
```

<a name="AEN51815"></a>## DESCRIPTION
...
<a name="AEN51872"></a>## SEE ALSO

[*CSocket*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50671.md)
