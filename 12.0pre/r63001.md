...
<a name="AEN63015"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN63018"></a>## Synopsis
...
This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r57965]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r63736]])
...
<a name="AEN63195"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r63736]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r63736]] for
...
<a name="AEN63647"></a>## DEVICE ENUMERATION
...
<a name="AEN63671"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN63681"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN63687"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r61214]] for reference
...
<a name="AEN63730"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r57965]]
[[cccusbreadoutlist(3ccusb)|r63736]]
[[CCCUSBReadoutList(3ccusb)|r61214]]
