...
[← v1495sc](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85621.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [gdgwidget →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85657.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85937.md)
        for one such panel.
...
<a name="AEN85698"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN85702"></a>### VhsWidgets::channel
...
<a name="AEN85722"></a>### VhsWidgets::channelStatus options
...
<a name="AEN85728"></a>## OBJECT METHODS
...
<a name="AEN85732"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN85735"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85137.md)
