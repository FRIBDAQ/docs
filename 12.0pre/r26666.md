...
[← CRingFragmentItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26543.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingPhysicsEventCountItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26717.md)
...
Since this class is derived from
            [CRingItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24317.md),
...
For a full description of the methods available, see
            both [CRingItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24317.md)'s manpage, and
            the METHODS section below.

<a name="AEN26799"></a>## METHODS
