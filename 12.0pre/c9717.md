...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9692.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The tcl server application →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9722.md)
...
The epicsdisplay utility provides a tabular
    ...
    available at the [epicsdisplay
      reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22024.md)

epicsdisplay reads in a configuration file.
    The configuration file is compatible with [the controlpush](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18893.md) application,
