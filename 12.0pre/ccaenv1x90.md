...
<a name="AEN37986"></a>## Public member functions
...
<a name="AEN37993"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN38014"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN38027"></a>` unsigned char getVersion(void);const`
...
<a name="AEN38052"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN38063"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN38409"></a>` ECLOutputSelect
...
<a name="AEN38477"></a>` unsigned short
...
<a name="AEN38641"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN38653"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN38663"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN38673"></a>` TriggerConfiguration
...
<a name="AEN38770"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN38811"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN38837"></a>` LEResolution
...
<a name="AEN38851"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN39011"></a>` unsigned short
...
<a name="AEN39105"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN39117"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN39134"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN39147"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN39159"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN39180"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN39192"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN39207"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN39222"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN39237"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN39249"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN39264"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN39274"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN39286"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN39298"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN39310"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN39322"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN39332"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN39342"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN39352"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN39362"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN39374"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN39384"></a>` void
                    EnableErrorMark(void);`



<a name="AEN39394"></a>` void
                    DisableErrorMark(void);`



<a name="AEN39404"></a>` void EnableBypassOnError(void);`



<a name="AEN39414"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN39424"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN39436"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN39446"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN39458"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN39468"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN39480"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN39492"></a>` void EnableAllChannels(void);`



<a name="AEN39502"></a>` void
                    DisableAllChannels(void);`



<a name="AEN39512"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN39524"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN39536"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN39551"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN39563"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN39575"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN39596"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN39609"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN39626"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN39644"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN39659"></a>## Types and public data
