...
[← loggerrestclient](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88618.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEventSegment →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88694.md)
...
<a name="AEN88653"></a>## Name

logbook -- Access Logbooks from Tcl

<a name="AEN88656"></a>## Synopsis
...
A disadvantage of the logbook package is, that while
            ...
            [*logbookadmin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89396.md)
            package instead as that procedural interface does storage management
            for you.

<a name="AEN88674"></a>### SUBCOMMANDS
