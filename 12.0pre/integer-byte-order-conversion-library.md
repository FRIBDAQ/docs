...
# <a name="AEN13495"></a>Chapter 54. Integer byte order conversion library
...
# <a name="AEN13502"></a>54.1. Using the conversion library in your code

The conversion library is a set of C functions.  To use it,
            you will need to include the library header in your source code
            with a line like:

<a name="AEN13505"></a>**Example 54-1. Including the cvt header**
...
<a name="AEN13511"></a>**Example 54-2. Compiling a C or C++ source file that includes cvt.h**
...
<a name="AEN13515"></a>**Example 54-3. A makefile rule that builds a C++ program using the
                cvt package**
