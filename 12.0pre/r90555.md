...
[← evblite::evblite](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90517.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [TclRingBuffer →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90588.md)
...
This package provides a family of controllers that interface
            ...
            [*EVBRESTClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90296.md)
            and the presentation views provided by
            [*EVBRestUI*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90050.md).
