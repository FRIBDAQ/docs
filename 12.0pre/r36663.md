...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r36540.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r36869.md)
...
<a name="AEN36802"></a>## Public member functions





- <a name="AEN36808"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN36820"></a>`bool Xtest(void);const`
...
- <a name="AEN36832"></a>`bool Qtest(void);const`
...
- <a name="AEN36849"></a>`bool TimedOut(void);const`
...
- <a name="AEN36861"></a>`bool BranchDemand(void);const`
...
- <a name="AEN36873"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN36887"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN36900"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN36914"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN36929"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN36944"></a>`bool IT4(void);const`
...
- <a name="AEN36958"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN36969"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN36982"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN36998"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN37009"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN37020"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN37030"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN37034"></a>**Example 1. Initializing branch 0**
