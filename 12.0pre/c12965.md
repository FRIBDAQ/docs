...
[← The Wienercamac Tcl package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c12777.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [TclRingBuffer Tcl package. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13002.md)

---

---

# <a name="AEN12965"></a>Chapter 53. Integer byte order conversion library
...
Reference material for this library is available in the
        [reference manual page for cvt](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r44430.md).

This chapter gives an high level view of how the
        library should be used.

# <a name="AEN12972"></a>53.1. Using the conversion library in your code

The conversion library is a set of C functions.  To use it,
            you will need to include the library header in your source code
            with a line like:

<a name="AEN12975"></a>**Example 53-1. Including the cvt header**
...
<a name="AEN12981"></a>**Example 53-2. Compiling a C or C++ source file that includes cvt.h**
...
<a name="AEN12985"></a>**Example 53-3. A makefile rule that builds a C++ program using the
                cvt package**
