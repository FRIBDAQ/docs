...
[← StateManager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69226.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ui →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69387.md)
...
<a name="AEN69278"></a>## Name

ui -- ReadoutGUI graphical user interface elements.

<a name="AEN69281"></a>## Synopsis

**
package require ui
          **

<a name="AEN69284"></a>## DESCRIPTION
...
- [*readoutMenuBar*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_readoutMenubar)
  Provides the menu bar for the application.  This can
                          ...
                          as well.
- [*RunIdentification*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_RunIdentification)
...
- [*RunControl*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_RunControl)
  Provides a megawidget that contains the controls for a run.
                          These are buttons intended to drive the
                          [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68864.md).
...
- [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_StopWatch)
...
- [*ElapsedTimeDisplay*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_ElapsedTimeDisplay)
...
- [*TimedRunControls*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_TimedRunControls)
  ...
  An associated callout bundle hooks the singleton
                          ...
                          timed runs.
- [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_OutputWindow)
  ...
  An associated
                          [*OutputWindowSettings*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69778.md)
...
- [*StatusArea*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69849.md)
...
<a name="AEN69478"></a>### SINGLETON IMPLEMENTATION
...
Makes use of a
                [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69264.md#rdogui3_ui_StopWatch) to provide
...
<a name="AEN69613"></a>### SINGLETON IMPLEMENTATION
...
<a name="AEN69769"></a>### SINGLETON IMPLEMENTATION
