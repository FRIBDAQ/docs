...
[[*readoutMenuBar*|r69264#rdogui3_ui_readoutMenubar]]Provides the menu bar for the application.  This can
                        be used as a genric menu bar handling class for
                        your own applications distinct from the ReadoutShell
                        as well.

[[*RunIdentification*|r69264#rdogui3_ui_RunIdentification]]Provides a megawidget that identifies runs.  This contains
...
[[*RunControl*|r69264#rdogui3_ui_RunControl]]Provides a megawidget that contains the controls for a run.
...
[[*StopWatch*|r69264#rdogui3_ui_StopWatch]]This is a non graphical element that implements
...
[[*ElapsedTimeDisplay*|r69264#rdogui3_ui_ElapsedTimeDisplay]]Works with an embedded stopwatch object to provide
...
[[*TimedRunControls*|r69264#rdogui3_ui_TimedRunControls]]Provides a GUI element that prompts for timed
...
[[*OutputWindow*|r69264#rdogui3_ui_OutputWindow]]Provides a scrollable text widget and methods to output
...
[[*StatusArea*|r69849]]Provides a support for a vertically stacked set of
...
Makes use of a
                [[*StopWatch*|r69264#rdogui3_ui_StopWatch]] to provide
