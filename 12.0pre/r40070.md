...
[← CCAENV977](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r40051.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCrateController →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r40169.md)
...
<a name="AEN40118"></a>## Public member functions
...
- <a name="AEN40143"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN40156"></a>` void WriteBit(unsigned int nBitno);`
