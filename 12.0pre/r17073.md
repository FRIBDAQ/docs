...
[← lg_current](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17056.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [lg_ls →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17082.md)
...
Output from loggers is relayed to the output monitor where
            [*mg_monitorOutput*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16891.md)
