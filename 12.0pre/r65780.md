...
[← LogBook.Shift](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65759.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBook.Run →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65835.md)
...
<a name="AEN65794"></a>## Name

CModuuleFactory -- Creates specific slow control drivers

<a name="AEN65797"></a>## Synopsis

```
CModuleFactory
```

<a name="AEN65827"></a>## DESCRIPTION
...
This class provides a factory that allows the
            **Module create** slow control server command to
            ...
            [creator object](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65887.md).
