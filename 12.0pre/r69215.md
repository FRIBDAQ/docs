...
[← ReadoutGUIPanel](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69141.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [StateManager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69226.md)
...
<a name="AEN69229"></a>## Name

ui -- ReadoutGUI graphical user interface elements.

<a name="AEN69232"></a>## Synopsis

**
package require ui
          **

<a name="AEN69235"></a>## DESCRIPTION
...
- [*readoutMenuBar*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_readoutMenubar)
  Provides the menu bar for the application.  This can
                          ...
                          as well.
- [*RunIdentification*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_RunIdentification)
...
- [*RunControl*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_RunControl)
  Provides a megawidget that contains the controls for a run.
                          These are buttons intended to drive the
                          [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68815.md).
...
- [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_StopWatch)
...
- [*ElapsedTimeDisplay*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_ElapsedTimeDisplay)
...
- [*TimedRunControls*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_TimedRunControls)
  ...
  An associated callout bundle hooks the singleton
                          ...
                          timed runs.
- [*OutputWindow*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_OutputWindow)
  ...
  An associated
                          [*OutputWindowSettings*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69729.md)
...
- [*StatusArea*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69800.md)
...
<a name="AEN69429"></a>### SINGLETON IMPLEMENTATION
...
Makes use of a
                [*StopWatch*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69215.md#rdogui3_ui_StopWatch) to provide
...
<a name="AEN69564"></a>### SINGLETON IMPLEMENTATION
...
<a name="AEN69720"></a>### SINGLETON IMPLEMENTATION
