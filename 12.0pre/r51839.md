...
[← CTCLCommandPackage](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51779.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPNoSuchHost →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51876.md)
...
<a name="AEN51853"></a>## Name

CTCPNoSuchService -- Exception thrown if a nonexistent service is referenced

<a name="AEN51856"></a>## Synopsis

```
CTCPNoSuchService
```

<a name="AEN51881"></a>## DESCRIPTION
