...
[← lg_utilities](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90391.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [evblite::evblite →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90468.md)
...
<a name="AEN90450"></a>## DESCRIPTION

This package provides a family of controllers that interface
            between the model provided by
            [*EVBRESTClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r90173.md)
            and the presentation views provided by
            [*EVBRestUI*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89927.md).
...
<a name="AEN90476"></a>## CONTROLLER VIEW PAIRS
...
<a name="AEN90480"></a>**Table 1. EVBRestControllers and Corresponding EVBRestUI Views**
