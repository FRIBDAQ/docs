...
[← Manager User Interface API](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11909.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the event builder client library →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12237.md)
...
This section will describe how to run an experiment with the manager.
      Subsequent sections:
      [*Running Readout Software With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1399.md) and
...
- [*Starting and Stopping the Manager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1216.md#sec.mgr.startstop)
              will describe how to start and stop the DAQ manager which is at the
              heart of this subsystem.
- [*The Output Monitor*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1216.md#sec.mgr.output)
              describes a control panel that monitors the output of all programs
              run by the manager.
- [*The Run Control Panel*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1216.md#sec.mgr.runcontrol)
              describes the control panel you can use to control runs.
- [*Event Builder Statistics Panel.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1216.md#sec.mgr.eventbuilderstats)
...
Note that these control panels communicate with the manager and make use
        ...
        sections
        [*Running Readout Software With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1399.md)
        and [*Using the NSCLDAQ Event Builder With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1661.md)
...
The program
          [*mg_startManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16523.md)
...
Full reference information for this program is in
          [*rdo_RunControl*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16203.md)
...
When you use the manager with the event builder, it too will have
          a REST interface.  [*Using the NSCLDAQ Event Builder With the Manager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1661.md)
...
[*EVBMonitor*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16240.md)
