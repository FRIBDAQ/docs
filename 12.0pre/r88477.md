...
[← ssh](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88471.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutState →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88488.md)
...
<a name="AEN88481"></a>## Name

logbook -- Access Logbooks from Tcl

<a name="AEN88484"></a>## Synopsis
...
- **open *filename***
  Provides access to the logbook database in the file
                          ...
                          [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88533.md)
