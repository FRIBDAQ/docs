...
[← N568B CAENnet shaping amplifier](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9782.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cratelocator →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9852.md)
...
- [iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92370.md)
  Provides a tcl package forlow level support fo the
                      modules including
                      the ability to program the base address of the module.
- [VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92884.md)
  ...
  This separation allows you to build custom applications
                      ...
                      elements.
- [vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22800.md)
