...
[← CSocket](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50548.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLInterpreterObject  3 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50643.md)

---

---

# <a name="AEN50618"></a>CRingFileBlockReader

<a name="AEN50622"></a>## Name

CRingFileBlockReader -- CRingBlockreader that reads from file.

<a name="AEN50625"></a>## Synopsis
