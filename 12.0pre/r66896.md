...
[← EVBC::flush](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66873.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::initialize →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66900.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14848.md#sec_tsextractors) describes how
