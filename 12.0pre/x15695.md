...
[← How does it work?](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15692.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Exemplified Usage of the Actions package →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15700.md)
