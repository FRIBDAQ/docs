...
# <a name="vmetclintro"></a>Chapter 30. Tcl access to the VME via the SBS interface
...
# <a name="AEN9880"></a>30.1. Incorporating Vme Tcl in your scripts
...
<a name="AEN9889"></a>**Example 30-1. Appending the NSCLDAQ Tcl Package repository to Tcl's search
            path**
...
<a name="AEN9893"></a>**Example 30-2. Appending NSLCDAQ's TclPackage repository to Tcl's search path**
...
<a name="AEN9897"></a>**Example 30-3. Requesting the VME Tcl package be loaded.**
