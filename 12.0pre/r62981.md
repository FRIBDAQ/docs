...
[← CCCUSBReadoutList](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62932.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cccusb →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63001.md)
...
<a name="AEN62995"></a>## Name

CCCUSBReadoutList -- Create lists of CAMAC commands for CC-USB controllers.

<a name="AEN62998"></a>## Synopsis

```
CCCUSBReadoutList
```

<a name="AEN63200"></a>## DESCRIPTION
