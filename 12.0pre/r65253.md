...
[← EVBC::configParams](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65211.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3python →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65293.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65048.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64872.md) to create the ring
             sources.
