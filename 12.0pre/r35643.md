...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35628.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAENcard →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35686.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35486.md)).
        Since it  is  derived
       from
       `CException`,
...
[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91515.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35486.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22215.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r57041.md)
