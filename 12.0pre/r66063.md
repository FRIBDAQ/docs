...
[← cccusbreadoutlist](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66039.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlModule →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66121.md)
...
<a name="AEN66077"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN66080"></a>## Synopsis

```
CControlHardware
```

<a name="AEN66147"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65903.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66010.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN66154"></a>## METHODS
