...
[← Command line access to CAMAC via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8167.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCLDAQ Logbook facility →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8219.md)

---

---

# <a name="chapter.ringpipes"></a>Chapter 20. Ring piping utilities
...
The **ringtostdout** command can be used to
        ...
        [ringtostdout reference pages](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15562.md).
...
The **stdintoring** command can be used to allow a
        ...
        [stdintoring reference material](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15626.md).
