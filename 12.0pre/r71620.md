...
[← PortManager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71614.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [PortManager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71663.md)
...
`LogBook.Note` objects encapsulate a single note
         ...
         [*LogBook*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70881.md)
