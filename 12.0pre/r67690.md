...
[← DataSourceManager](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67659.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DataSourceManager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67708.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67485.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67309.md) to create the ring
             sources.
