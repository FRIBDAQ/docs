...
[← cvmusb](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81936.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r82167.md)
...
<a name="AEN82073"></a>## Name

cvmusb -- SWIG Tcl wrapping of `CVMUSB`

<a name="AEN82077"></a>## Synopsis
...
<a name="AEN82281"></a>## DESCRIPTION

This package provides a tcl interface to the
                `CVMUSB` class described in
                [CVMUSB(3)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76372.md).
                See COMMANDS below for more information.

<a name="AEN82286"></a>## COMMANDS
