...
[← CElapsedTime](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50532.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingFileBlockReader →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50618.md)
...
<a name="AEN50562"></a>## Name

CSocket -- Encapsulation of a socket file descriptor.

<a name="AEN50565"></a>## Synopsis

```
CSocket
```

<a name="AEN50836"></a>## DESCRIPTION
...
`CSocket` objects are stateful.  The
            ...
            [*CTCPBadSocketState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51402.md)
            is thrown.

<a name="AEN50846"></a>## METHODS
...
<a name="AEN51394"></a>## SEE ALSO

[*CTCPBadSocketState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51402.md),
            [*CTCPConnectionFailed*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51521.md),
            [*CTCPConnectionLost*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51643.md),
            [*CTCPNoSuchHost*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51753.md),
            [*CTCPNoSuchService*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51888.md)
