...
[← The epics display utility](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9717.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Epics Channel logging →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9736.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22369.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22422.md).
            section.
...
TclServer is also available as a package that can be incorporated
                ...
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91617.md)
