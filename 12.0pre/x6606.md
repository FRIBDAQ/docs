...
[← Using SpecTcl](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6592.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Conclusion →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6619.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-v785-thresh)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-v785-create)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-v785-config)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-v775-create)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-v775-config)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-chain-create)
  This line creates a device instance for the chained block transfer. We
              can refer to it by its name chain later in the
              file.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-chain-config)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-evtstack-config)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x6606.md#vmusb-ss-sclrstack-config)
