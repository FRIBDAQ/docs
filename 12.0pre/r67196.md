...
[← 3rdogui](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67194.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onEnd →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67211.md)
...
<a name="AEN67210"></a>## Name

Introduction -- ReadoutGUI API introduction

<a name="AEN67213"></a>## DESCRIPTION
...
- bells
  This package provides the `bells`
                              ...
                              some pattern.
  See
                              [*bells*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67310.md)
...
- Configuration
  ...
  See
                              [*Configuration*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67431.md)
                              for reference information.
- DAQParameters
  Provides access to parameters that affect data taking.
                              ...
                              above.
  See
                              [*DAQParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67530.md)
                              for reference information.
- DataSourceManager
...
- DataSourceUI
  ...
  See
                              [*DataSourceUI*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67960.md)
- Diagnostics
  Provides simple error/warning/info dialogs.
                              See:
                              [*Diagnostics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68290.md)
- ExpFileSystemConfig
  Provides read/write access to configuration parameters
                              that determine where event data and related meta-data
                              are stored.
                              See:
                              [*ExpFileSystemConfig*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68365.md)
- ReadoutGUI
  Provides the readout GUI application class which
                              strings everything together. See
                              [*ReadoutGui*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68454.md)
- ReadoutGUIPanel
  Provides a group of API elements that allow you
                              ...
                              object.
                              See:
                              [*ReadoutGUIPanel*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r68605.md)
- RunstateMachine
...
- StateManager
  ...
  See
                              [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69103.md)
- ui
