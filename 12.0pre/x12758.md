...
[← A simple example](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12656.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the event builder client library →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12767.md)

---

---

# <a name="AEN12758"></a>51.2. An overview of the use of the camac package
