...
[← EVBC::startRingSource](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67397.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [bells →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67433.md)
...
<a name="AEN67445"></a>## Name

Configuration -- Configuration variable management

<a name="AEN67448"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69103.md) package for that
            instead.

<a name="AEN67471"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69103.md) is a better
                          choice).
