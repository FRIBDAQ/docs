...
[← Starting the GUI for the RC-bus through an MxDC device](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7893.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and restoring state →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7938.md)

---

---

# <a name="AEN7918"></a>14.4. Configuration menu
...
## <a name="AEN7921"></a>14.4.1. Enable/Disable Channel
...
<a name="mcfd16control_enabledisable_config"></a>**Figure 14-3. Channel Enable/Disable Configuration Dialog**

![](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/figures/MCFD16Control-enabledisable-config-0.png)

## <a name="AEN7929"></a>14.4.2. Configurable 16-Channel OR Trigger
...
<a name="mcfd16control_orpattern_config"></a>**Figure 14-4. OR Pattern Configuration Dialog**

![](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/figures/MCFD16Control-triggerOR-config-0.png)
