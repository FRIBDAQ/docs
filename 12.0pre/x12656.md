...
[← Using TclRingBuffer in event driven software](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12520.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [An overview of the use of the camac package →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x12758.md)

---

---

# <a name="AEN12656"></a>48.2. A simple example
...
## <a name="AEN12660"></a>48.2.1. Configuring the ctlconfig.tcl
...
## <a name="AEN12669"></a>48.2.2. The script that runs ccusbcamac commands
