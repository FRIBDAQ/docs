...
[← Setting up a logbook for use.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8390.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for the RC-bus through an MxDC device →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8423.md)
...
2. At the command line, call
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/figures/MCFD16Control-USBHowTo-0.png)
