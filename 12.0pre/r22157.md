...
[← loadshaper](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22154.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::flush →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22167.md)
...
<a name="AEN22171"></a>## Name

bcnaf -- bcnaf via SBS VME CAMAC interfaces

<a name="AEN22174"></a>## Synopsis

**
bcnaf `-ces | -wiener` *b c n a f* [d]
    **

<a name="AEN22180"></a>## DESCRIPTION
