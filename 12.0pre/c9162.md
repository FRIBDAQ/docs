...
[← The dumper program](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9098.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The tcl server application →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9192.md)

---

---

# <a name="chap.eventlog"></a>Chapter 23. The Event log program
...
Most experiments will record event data.  Event data files are
        ...
        ring buffers.
        See the chapter:
        [Format of EventData In Ring Buffers](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c185.md)
...
<a name="AEN9187"></a>**Example 23-1. Taking data from a remote ring**
...
The full reference documentation for the program is in the
        [event log reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18258.md).
