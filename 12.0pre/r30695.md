...
[← CDataSourceFactory"](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30648.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingItemFactory →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30715.md)
...
<a name="AEN30709"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN30712"></a>## Synopsis

```
CDataSink
```

<a name="AEN30737"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31029.md)
