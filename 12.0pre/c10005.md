...
[← Compiling/Linking your software with the shared memory API](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9993.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The ringselector application →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10023.md)

---

---

# <a name="chapter.ringprimitives"></a>Chapter 42. Ring Buffer Primitives
...
Reference material can be found in the
        [CRingBuffer reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22917.md)

# <a name="AEN10019"></a>42.1. Incorporating ring buffer software
...
<a name="AEN10026"></a>**Example 42-1. Compilation line for ring buffer primitives**
...
<a name="AEN10032"></a>**Example 42-2. Including the ring buffer primitives header**
...
<a name="AEN10038"></a>**Example 42-3. Linking to the ring buffer primitives**
