...
[← Pushing external data into the event stream](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x3345.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing device support software →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x3476.md)
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r57176.md) command
