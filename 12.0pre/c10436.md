...
[← The RingMaster server](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10281.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring master class library. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10454.md)
...
- The
                          [port manager daemon](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22215.md)
...
- A
                          [C++ class library](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r35486.md)
                          that allows C++ software to interact with the
                          port manager either as a server or as a client.
- The
                      [portAllocator package](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91515.md),
