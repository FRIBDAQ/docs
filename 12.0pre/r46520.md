...
[← Thread](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46516.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSynchronizedThread →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46536.md)
...
`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13737.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50415.md).
...
`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13737.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51195.md).
...
<a name="AEN46622"></a>## Types and public data

`CTCLInterpreter`
            and
            `CTCLVariable`
            are objects that are part of the Tcl++ library. See the
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13737.md) of the
