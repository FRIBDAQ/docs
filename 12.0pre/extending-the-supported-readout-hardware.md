...
# <a name="vmusb-develop-rdohdwr"></a>5.8. Extending the Supported Readout Hardware
...
## <a name="AEN2242"></a>5.8.1. Writing C++ device support software
...
<a name="AEN2250"></a>**Example 5-6. Obtaning the VM-USB device driver development kit**
...
<a name="AEN2259"></a>**Example 5-7. Using a user written VMUSB driver**
...
### <a name="AEN2273"></a>5.8.1.1. The driver `onAttach` method
...
### <a name="AEN2304"></a>5.8.1.2. The driver `Initialize` method
...
<a name="AEN2321"></a>**Example 5-8. The template driver `Initialize` method**
...
### <a name="AEN2329"></a>5.8.1.3. The driver `addReadoutList` method
...
<a name="AEN2340"></a>**Example 5-9. Template Driver `addReadoutList` method**
...
[[x2237#vmusb-dtemplate-initsuccess]]                        The **load** or
                    ...
                    [[x2237#vmusb-dtemplate-endccall]]                        Ends the extern "C" {  block.

## <a name="AEN2416"></a>5.8.2. Writing device support software in Tcl
...
### <a name="AEN2436"></a>5.8.2.1. An Incr-Tcl (itcl) driver
...
<a name="AEN2439"></a>**Example 5-11. Itcl VM-USB device driver**
...
[[x2237#vmusb-itcldrv-initialize]] `Initialize` implements
                    ...
                    [[x2237#vmusb-itcldrv-vmusbreadled]]                        Invokes the `readLEDSource`
                    ...
                    [[x2237#vmusb-itcldrv-addrdolist]]                        The `addReadoutList` method
...
### <a name="AEN2527"></a>5.8.2.2. A Snit Is Not Incr Tcl (snit) driver
...
<a name="AEN2531"></a>**Example 5-12. A Snit VM-USB driver.**
...
[[x2237#vmusb-snit-constructor]] **constructor** methods are called
...
### <a name="AEN2619"></a>5.8.2.3. Using a Tcl driver in a DAQ configuration script
...
<a name="AEN2636"></a>**Example 5-13. USing a Tcl VM-USB driver.**
