...
[← n568Control](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22354.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [tclserver →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r22369.md)
...
<a name="AEN22378"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN22381"></a>## Synopsis
...
<a name="AEN22436"></a>### Map access command
...
<a name="AEN22446"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN22454"></a>***mapname* put *width offset value***
