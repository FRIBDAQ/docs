...
[← CRingScalerItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25220.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPhysicsEventItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25528.md)
...
<a name="AEN25500"></a>## Public member functions
...
<a name="AEN25740"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN25743"></a>**Example 1. Creating a begin run state transition item**
