...
[← Using TclRingBuffer in event driven software](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13050.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using CGaurdedObject to implement synchronized methods →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13166.md)

---

---

# <a name="AEN13155"></a>54.2. Incorporating the library into an application.
...
<a name="AEN13163"></a>**Example 54-4. Compiling and linking NSCLDAQ threaded software**
