...
[← logbookadmin](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89273.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CInvalidPacketStateException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89298.md)
...
<a name="AEN89285"></a>## Name

noteinstance -- Tcl encapsulation of a note

<a name="AEN89288"></a>## Synopsis
...
A note instance is a Tcl command ensemble that provides access to
            ...
            See
            [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88705.md) for subcommands that
            can generate notess
...
set run [*$note* run]
  ...
  If the note has an associated run, this subcommand returns
                       ...
                       [*runinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89181.md)
