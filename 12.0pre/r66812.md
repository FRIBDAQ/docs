...
[← CCCUSBControl](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66785.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::stop →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66826.md)
...
<a name="AEN66826"></a>## Name

EVBC::startRingSource -- Start a ring fragment source for the event builder.

<a name="AEN66829"></a>## Synopsis

**
EVBC::startRingSource *source-uri extractor-lib source-id info*
**

<a name="AEN66833"></a>## DESCRIPTION

Please use the [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66724.md) instead of this proc.
