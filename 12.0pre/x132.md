...
[← A simple example](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13186.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Thread safe queues (CBufferQueue). →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13206.md)
...
- ringbuffer
  This utility allows you to create, re-initialize, delete  and
              ...
              don't already exist. See the [man page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15438.md) for more information.
- dumper
  Provides a simple textual formatted dump of the buffers.  If you
              ...
              each event and the packets within the event. See [user documentation](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9098.md) and [man page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18164.md) for more information.
- eventlog
  Performs native mode event loggging.  In this mode, event file
              segments consists of streams of ring buffer items. See [user documentation](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9162.md) and [man page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18258.md) for more information.
- ringselector
  Provides a flexible ringbuffer consumer that pipes the ring items
              ...
              applications like SpecTcl. See [user documentation](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9493.md) and [man page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18512.md) for more information.
- ringtostdout
  Accepts data from a ring and pipes it to stdout.  This is the server
              ...
              process data from  a ring. See the [man page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15562.md) for more information.
- ScalerDisplay
  Provides a display of scaler event data.  This application is highly
              ...
              selected scalers are also supported. See [user documentation](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c5861.md) and [man page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r17837.md#manpage.scalerdisplay) for more information.
- stdintoring
  Accepts data on stdin and puts it in a ring buffer.  This is the
              client side of the data pipeline that sets up a proxy ring. See the [man page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15626.md) for more information.
