...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81582.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutStatistics →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81685.md)
...
<a name="AEN81645"></a>## Name

CControlHardware -- Base class for slow controls drivers

<a name="AEN81648"></a>## Synopsis

```
CControlHardware
```

<a name="AEN81740"></a>## DESCRIPTION
