...
[← CTCLChannelCommander](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r54794.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLResult →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r54837.md)
...
<a name="AEN54849"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN54853"></a>## Synopsis

```
CErrnoException
```

<a name="AEN54880"></a>## Description
...
<a name="AEN54889"></a>## Public member functions
