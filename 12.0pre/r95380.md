...
[← CEventPacket](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95331.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCompoundEventSegment →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95384.md)
...
`Creates the object.  `seg` is a reference
                ...
                [CDocumentedPacket(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95107.md)
