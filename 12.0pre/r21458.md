...
[← EVB::dlatestats](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21451.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [tclserver →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21462.md)
...
The format of the data expected on that file descriptor is described
            in [*eventorderer*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r99015.md).
