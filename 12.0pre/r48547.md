...
[← io::CBufferedOutput](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48533.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CUnixUserCheck →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48602.md)
...
`CHostListCheck` is derived from the
            [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48395.md).
...
<a name="AEN48641"></a>## Public member functions
...
<a name="AEN48732"></a>## Types and public data
