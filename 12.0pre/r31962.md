...
[← USB](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31958.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [XXUSBUtil →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31992.md)
...
In [*LogBookShift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31789.md)
...
- int `s_id`
  Primary key of the transition in the transition table.
                    See the [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91224.md)
                    reference page for the full logbook schema.
- int `s_transition`
  An integer that describes the transition see
                    [*State transition values*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31962.md#daq3.logbookrun.trantbl)
...
- LogBookShift* `s_onDuty`
  Pointer to a `LogBookShift` object
                    ...
                    [*LogBookShift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31789.md)
