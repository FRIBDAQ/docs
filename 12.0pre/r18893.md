...
[← 1epics](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18891.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ccusbloader →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18901.md)
...
<a name="AEN18985"></a>## CONFIGURATION FILES
...
Channel lines, have as their first non-whitespace word, the name of
	   ...
	   (notably
	   [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9717.md)) may 
	   parse additional characters for their own purposes.

<a name="AEN18993"></a>## DEPENDENCIES
