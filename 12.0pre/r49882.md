...
[← CTCPConnectionLost](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49876.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [URL →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49894.md)
...
<a name="AEN49896"></a>## Name

CDAQShm -- class description

<a name="AEN49899"></a>## Synopsis

```
CDAQShm
```

<a name="AEN50014"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49882.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r49882.md#daqshm-varsrefsect).
