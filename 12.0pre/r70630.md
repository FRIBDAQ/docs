...
[← s800](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70619.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [s800 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70668.md)
...
- runsHaveTitles
  If true the provider will honor the
                              ...
                              [*begin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70471.md)
                              command.
- runsHaveNumbers
