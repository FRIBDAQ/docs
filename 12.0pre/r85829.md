...
[← V6533Driver](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85809.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [USB Control operations →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85841.md)
...
This is a pre-packaged widget that supplies the needed interfaces
      for use with [*gdgcontrol*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85601.md).
