...
<a name="AEN64733"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN64736"></a>## Synopsis
...
<a name="AEN64905"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r59683]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r65454]])
...
<a name="AEN64913"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r65454]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r65454]] for
...
<a name="AEN65365"></a>## DEVICE ENUMERATION
...
<a name="AEN65389"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN65399"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN65405"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r62932]] for reference
...
<a name="AEN65448"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r59683]]
[[cccusbreadoutlist(3ccusb)|r65454]]
[[CCCUSBReadoutList(3ccusb)|r62932]]
