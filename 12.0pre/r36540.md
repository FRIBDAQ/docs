...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r36491.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r36663.md)
...
<a name="AEN36679"></a>## Public member functions





- <a name="AEN36685"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN36697"></a>`bool Xtest(void);const`
...
- <a name="AEN36709"></a>`bool Qtest(void);const`
...
- <a name="AEN36726"></a>`bool TimedOut(void);const`
...
- <a name="AEN36738"></a>`bool BranchDemand(void);const`
...
- <a name="AEN36750"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN36764"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN36777"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN36791"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN36806"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN36821"></a>`bool IT4(void);const`
...
- <a name="AEN36835"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN36846"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN36859"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN36875"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN36886"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN36897"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN36907"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN36911"></a>**Example 1. Initializing branch 0**
