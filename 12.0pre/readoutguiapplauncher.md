...
Note that beginning with NSCLDAQ-V11.4-010, when the widget that
	     contains the start buttons is destroyed all of the active
	     subprocesses will be sent a SIGTERM signal asking them to exit.
	     If you do not want your application to exit, you'll need to catch
	     and handle the SIGTERM signal in your application. Normally, when
	     used in ReadoutGUI it's perfectly ok for subprocesses started with
	     this application to exit when the GUI exits.

<a name="AEN68771"></a>## COMMANDS
...
<a name="AEN68821"></a>## EXAMPLE

<a name="AEN68823"></a>**Example 1. Simple usage of the ReadoutGUIAppLauncher package**
