...
[← CScaler](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41704.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3600 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41809.md)
...
<a name="AEN41922"></a>## Public member functions
...
- <a name="AEN41945"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN41955"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN41966"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN41977"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN41989"></a>` void SetLatchMode(void);const`
...
- <a name="AEN42001"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN42036"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN42105"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN42116"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN42127"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN42138"></a>` void Clock(void);const`
...
- <a name="AEN42149"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN42160"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN42171"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN42183"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN42194"></a>` unsigned long Read(void);const`
...
- <a name="AEN42206"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
