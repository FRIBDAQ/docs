...
[← Compatibility utilities](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9574.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Providing EPICS channel information to Tcl Servers →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9679.md)

---

---

# <a name="ch.dumper"></a>Chapter 23. The dumper program
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r19034.md).
...
<a name="AEN9642"></a>**Example 23-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN9646"></a>**Example 23-2. Dumping data from the event file segment
...
# <a name="AEN9656"></a>23.1. Item dump formats and examples
...
<a name="AEN9659"></a>**Example 23-3. State Transition items**
...
<a name="AEN9664"></a>**Example 23-4. Text List items**
...
<a name="AEN9669"></a>**Example 23-5. Incremental Scalers dump**
...
<a name="AEN9675"></a>**Example 23-6. Event count items**
...
<a name="AEN9681"></a>**Example 23-7. Physics Event items**
...
<a name="AEN9686"></a>**Example 23-8. Unknown item types**
