...
[← CCCUSBusb](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62496.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBRemote →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62649.md)
...
<a name="AEN62633"></a>## Name

CCCUSBusb -- Provide access to a connected CC-USB device.

<a name="AEN62636"></a>## Synopsis

```
CCCUSBusb
```

<a name="AEN62700"></a>## DESCRIPTION
...
`
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63104.md))
...
`
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63104.md) for
