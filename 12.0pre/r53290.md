...
[← CTCLProcessor](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r53167.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLStdioCommander →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r53298.md)
...
<a name="AEN53304"></a>## Name

CTCLProcessor -- 
            Provide `argc`, `argv`
            extension commands to Tcl.

<a name="AEN53309"></a>## Synopsis
