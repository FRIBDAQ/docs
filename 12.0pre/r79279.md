...
[← CVMUSBRemote](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r79156.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [AXLM72Scaler →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r79382.md)
...
<a name="AEN79293"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN79296"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN80482"></a>## DESCRIPTION
...
<a name="AEN80485"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r76372.md)
