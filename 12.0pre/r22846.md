...
<a name="AEN22901"></a>### Configuration Options
...
<a name="AEN22925"></a>### Device Options
...
<a name="AEN22955"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN22971"></a>```
...
Retrieve the ID code for the board above<a name="AEN22976"></a>```
...
Load firmware and license it.<a name="AEN22983"></a>```
...
Retrieve license information from a digitizer.<a name="AEN22991"></a>```
...
Un-license a digitizer's firmware:<a name="AEN22996"></a>```
