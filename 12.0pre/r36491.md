...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r36271.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r36540.md)
...
<a name="AEN36630"></a>## Public member functions





- <a name="AEN36636"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN36648"></a>`bool Xtest(void);const`
...
- <a name="AEN36660"></a>`bool Qtest(void);const`
...
- <a name="AEN36677"></a>`bool TimedOut(void);const`
...
- <a name="AEN36689"></a>`bool BranchDemand(void);const`
...
- <a name="AEN36701"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN36715"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN36728"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN36742"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN36757"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN36772"></a>`bool IT4(void);const`
...
- <a name="AEN36786"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN36797"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN36810"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN36826"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN36837"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN36848"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN36858"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN36862"></a>**Example 1. Initializing branch 0**
