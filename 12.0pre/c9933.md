...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9933.md#chapter.sequencer.env)
  The global `env` array contains a 
  		 ...
  		 variable.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9933.md#chapter.sequencer.join)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9933.md#chapter.sequencer.path)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9933.md#chapter.sequencer.require)
