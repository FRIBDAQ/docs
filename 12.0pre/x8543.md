...
[← Saving and restoring state](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8514.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and Restoring The State of the GUI Between Sessions →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8576.md)
...
5. The user will then be presented with the a graphical user interface 
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/figures/MDGG16Control-HowTo-0.png)
