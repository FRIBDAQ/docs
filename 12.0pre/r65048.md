...
[← EVBC::startS800Source](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65018.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onBegin →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65158.md)
...
<a name="AEN65062"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN65065"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN65069"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64727.md).

<a name="AEN65077"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64727.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65158.md)).
