...
[← vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21807.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [serverauth →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21837.md)
...
<a name="AEN21847"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN21850"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN21857"></a>## DESCRIPTION
