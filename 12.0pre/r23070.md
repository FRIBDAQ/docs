...
[← epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23017.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1sbsReadout →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23100.md)
...
<a name="AEN23084"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN23087"></a>## Synopsis
...
The chapter:
            [Networed Ring Buffer Access](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c10474.md)
            includes sample code for detecting and mapping the use of a system's
            hostname into localhost.

<a name="AEN23163"></a>## Public member functions
...
<a name="AEN23254"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN23258"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN23262"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
