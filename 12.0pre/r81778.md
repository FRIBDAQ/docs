...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81754.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [logbook →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81850.md)
...
This megawidget glues together the
            [*ReadoutParameters*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81700.md),
            [*ReadoutStatistics*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81685.md)
            and
            [*ReadoutState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81744.md)
...
- `-statistics`
  Passes Readout statistics to the
                       ...
                       method of
                       [*ReadoutRESTClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r81564.md)
