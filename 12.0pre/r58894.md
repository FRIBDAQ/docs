...
[← ph7xxx](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r58848.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [stack →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r58943.md)
...
<a name="AEN58908"></a>## Name

stack -- Create and configure CC-USB stacks.

<a name="AEN58911"></a>## Synopsis
...
<a name="AEN59016"></a>## EXAMPLES

The example below extends the example in the
                  [ph7xxx(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r58676.md) command reference
                  reading the defined modules in an event stack:

<a name="AEN59020"></a>**Example 1. Example of the **stack** command.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r58894.md#defmodules)
  These two lines define the modules that we will be using
                          for the experimental setup.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r58894.md#stackdef)
  Creates a new stack called events
                          In subsequent lines I'm going to configure this stack
                          to handle the event trigger.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r58894.md#typemods)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r58894.md#timing)
