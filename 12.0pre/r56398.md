...
[← ccusb (command)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56359.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56456.md)
...
<a name="AEN56508"></a>## Public member functions
...
<a name="AEN56619"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN56624"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r55665.md)
