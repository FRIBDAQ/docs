...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56505.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56602.md)
...
<a name="AEN56567"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN56571"></a>## Synopsis

```
CErrnoException
```

<a name="AEN56598"></a>## Description
...
<a name="AEN56607"></a>## Public member functions
