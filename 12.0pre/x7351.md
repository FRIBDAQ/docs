...
[← Creating the Readout program](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7186.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Taking the example further. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7457.md)

---

---

# <a name="AEN7351"></a>12.5. Running the system.
...
## <a name="AEN7360"></a>12.5.1. Readout GUI
...
<a name="AEN7365"></a>**Example 12-17. Setting up ssh for password-less login**
...
## <a name="AEN7389"></a>12.5.2. Creating a directory in which to record events
...
<a name="AEN7400"></a>**Example 12-18. Creating an event area for a small amount of data**
...
## <a name="AEN7404"></a>12.5.3. Running and configuring the ReadoutGUI
...
### <a name="AEN7445"></a>12.5.3.1. A brief tour of the event area structure
