...
[← CEVBClientFramework](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34575.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEventOrderClient →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r34641.md)
...
- uint64_t`s_timestamp`
  The 64 bit timestamp of the fragment.  The event builder
  ...
  The first part of this process is called
                          ...
                          *glomming*.
- uint32_t`s_sourceId`
  Is a value that should be unique among data sources and
...
- uint32_t`s_size`
  Number of bytes in the fragment payload.   The actual
...
- pFragmentChain`s_pNext`
  Pointer to the next fragment in the chain.  This pointer
