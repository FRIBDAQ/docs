...
[← 3sbsReadout](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r87697.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [auth →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r87728.md)
...
Concrete busy classes are created by deriving them from
            ...
            [CExperiment](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89015.md)
            in `Skeleton`::`SetupReadout`

<a name="AEN87744"></a>## Public member functions
