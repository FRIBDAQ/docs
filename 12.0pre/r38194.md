...
[← CCAENV560](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r38020.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV977 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r38761.md)
...
<a name="AEN38376"></a>## Public member functions



- <a name="AEN38381"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN38409"></a>`void  Enable(int nChannel);`
...
- <a name="AEN38424"></a>`void  Disable(int nChannel);`
...
- <a name="AEN38439"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN38452"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN38464"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN38476"></a>`void   SetWide (void);`
...
- <a name="AEN38488"></a>`void   SetNarrow (void);`
...
- <a name="AEN38499"></a>`void  EnableHeader (void);`
...
- <a name="AEN38577"></a>`bool  isFull (void);`
...
- <a name="AEN38589"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN38601"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN38694"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN38708"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
