...
[← adc](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71775.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBook.Run →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r71834.md)
...
<a name="AEN71800"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN71803"></a>## Synopsis
...
<a name="AEN71817"></a>## METHODS



- <a name="AEN71822"></a>`PortManager(string host, int    port);`
