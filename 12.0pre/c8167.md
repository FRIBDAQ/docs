...
[← ULM Trigger GUI](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8116.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring piping utilities →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8193.md)

---

---

# <a name="chapter.bcnaf"></a>Chapter 19. Command line access to CAMAC via the SBS interface
