...
<a name="AEN35700"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN35703"></a>## Synopsis
...
<a name="AEN35929"></a>## Public member functions





<a name="AEN35935"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN35997"></a>`unsigned long getBase(void);`
...
<a name="AEN36008"></a>`int getSerial(void);`
...
<a name="AEN36039"></a>`int  getFirmware(void);`
...
<a name="AEN36049"></a>`int  getCrate(void);`
...
<a name="AEN36060"></a>`void setCrate(int crateNum);`
...
<a name="AEN36073"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN36094"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN36104"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN36114"></a>`void keepOverflowData(void);`
...
<a name="AEN36124"></a>`void discardOverflowData(void);`
...
<a name="AEN36134"></a>`void keepInvalidData(void);`
...
<a name="AEN36145"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN36156"></a>`void commonStart(void);`
...
<a name="AEN36167"></a>`void commonStop(void);`
...
<a name="AEN36178"></a>`void setRange(int range);`
...
<a name="AEN36191"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN36263"></a>`void clearData
                                (void);`
...
<a name="AEN36306"></a>`bool Busy(void);`
...
<a name="AEN36317"></a>` bool gBusy(void);`
...
<a name="AEN36328"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN36339"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN36350"></a>`int readEvent(void* buf);`
...
<a name="AEN36363"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN36404"></a>`void enableSmallThresholds(void);`
...
<a name="AEN36467"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN36471"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN36475"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN36479"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN36483"></a>**Example 3. Reading out a CAEN 785 e.g.**
