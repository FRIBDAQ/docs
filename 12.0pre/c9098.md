...
[← NSCLDAQ Logbook facility](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c8749.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9162.md)

---

---

# <a name="ch.dumper"></a>Chapter 22. The dumper program
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18164.md).
...
<a name="AEN9112"></a>**Example 22-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN9116"></a>**Example 22-2. Dumping data from the event file segment
...
# <a name="AEN9126"></a>22.1. Item dump formats and examples
...
<a name="AEN9129"></a>**Example 22-3. State Transition items**
...
<a name="AEN9134"></a>**Example 22-4. Text List items**
...
<a name="AEN9139"></a>**Example 22-5. Incremental Scalers dump**
...
<a name="AEN9145"></a>**Example 22-6. Event count items**
...
<a name="AEN9151"></a>**Example 22-7. Physics Event items**
...
<a name="AEN9156"></a>**Example 22-8. Unknown item types**
