...
[← Readout](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23102.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingAccess →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23242.md)
...
<a name="AEN23133"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN23136"></a>## Synopsis
...
<a name="AEN23212"></a>## Public member functions
...
<a name="AEN23303"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN23307"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN23311"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
