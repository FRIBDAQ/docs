...
[← CElapsedTime](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50655.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLList →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50732.md)
...
<a name="AEN50685"></a>## Name

CSocket -- Encapsulation of a socket file descriptor.

<a name="AEN50688"></a>## Synopsis

```
CSocket
```

<a name="AEN50959"></a>## DESCRIPTION
...
`CSocket` objects are stateful.  The
            ...
            [*CTCPBadSocketState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51525.md)
            is thrown.

<a name="AEN50969"></a>## METHODS
...
<a name="AEN51517"></a>## SEE ALSO

[*CTCPBadSocketState*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51525.md),
            [*CTCPConnectionFailed*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51644.md),
            [*CTCPConnectionLost*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51766.md),
            [*CTCPNoSuchHost*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51876.md),
            [*CTCPNoSuchService*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52011.md)
