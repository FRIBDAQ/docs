...
[← lrs2249](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56759.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56811.md)
...
<a name="AEN56802"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN56805"></a>## Synopsis

```
CStateException
```

<a name="AEN56835"></a>## Description
...
<a name="AEN56845"></a>## Public member functions
