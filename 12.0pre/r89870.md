...
[← lg_utilities](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89834.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBRestUI →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89878.md)
...
<a name="AEN89920"></a>| Plug | Direction | Meaning |
| --- | --- | --- |
...
<a name="AEN89941"></a>## Public member functions
...
<a name="AEN89977"></a>## SEE ALSO

[CBusy(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r87699.md),
     [CV977Trigger(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89982.md)
