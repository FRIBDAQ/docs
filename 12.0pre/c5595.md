...
[← NSCLDAQ In a Nut Shell](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c5.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBLite -  light event building →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c5743.md)
...
The client programs that submit data to the server are built using the
      [event builder client
        framework](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14024.md). In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [ringFragmentSource](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md) program. This
