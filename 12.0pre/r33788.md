...
[← LogBookNote](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33743.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33817.md)
...
In [*LogBookShift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33615.md)
...
- int `s_id`
  Primary key of the transition in the transition table.
                    See the [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98761.md)
                    reference page for the full logbook schema.
- int `s_transition`
  An integer that describes the transition see
                    [*State transition values*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33788.md#daq3.logbookrun.trantbl)
...
- LogBookShift* `s_onDuty`
  Pointer to a `LogBookShift` object
                    ...
                    [*LogBookShift*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33615.md)
