...
[← 3sbsReadout](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r94634.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [FrameManager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r94646.md)
...
Concrete busy classes are created by deriving them from
            ...
            [CExperiment](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r95952.md)
            in `Skeleton`::`SetupReadout`

<a name="AEN94681"></a>## Public member functions
