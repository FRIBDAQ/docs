...
[← cccusbreadoutlist](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r63736.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64042.md)
...
<a name="AEN64027"></a>## Name

CModuuleFactory -- Creates specific slow control drivers

<a name="AEN64030"></a>## Synopsis

```
CModuleFactory
```

<a name="AEN64060"></a>## DESCRIPTION
...
This class provides a factory that allows the
            **Module create** slow control server command to
            ...
            [creator object](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r64120.md).
