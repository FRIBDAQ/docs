...
<a name="AEN35749"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN35752"></a>## Synopsis
...
<a name="AEN35978"></a>## Public member functions





<a name="AEN35984"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN36046"></a>`unsigned long getBase(void);`
...
<a name="AEN36057"></a>`int getSerial(void);`
...
<a name="AEN36088"></a>`int  getFirmware(void);`
...
<a name="AEN36098"></a>`int  getCrate(void);`
...
<a name="AEN36109"></a>`void setCrate(int crateNum);`
...
<a name="AEN36122"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN36143"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN36153"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN36163"></a>`void keepOverflowData(void);`
...
<a name="AEN36173"></a>`void discardOverflowData(void);`
...
<a name="AEN36183"></a>`void keepInvalidData(void);`
...
<a name="AEN36194"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN36205"></a>`void commonStart(void);`
...
<a name="AEN36216"></a>`void commonStop(void);`
...
<a name="AEN36227"></a>`void setRange(int range);`
...
<a name="AEN36240"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN36312"></a>`void clearData
                                (void);`
...
<a name="AEN36355"></a>`bool Busy(void);`
...
<a name="AEN36366"></a>` bool gBusy(void);`
...
<a name="AEN36377"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN36388"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN36399"></a>`int readEvent(void* buf);`
...
<a name="AEN36412"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN36453"></a>`void enableSmallThresholds(void);`
...
<a name="AEN36516"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN36520"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN36524"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN36528"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN36532"></a>**Example 3. Reading out a CAEN 785 e.g.**
