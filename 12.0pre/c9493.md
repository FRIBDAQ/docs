...
[← Sequencing runs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9403.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compatibility utilities →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9574.md)
...
The ringselector application is very
        ...
        [ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15562.md)
        application.  Both
...
For a complete reference on the command see the
        [ringselector reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18512.md).
