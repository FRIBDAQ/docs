...
[← Run Control and Command Execution](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x15695.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the NSCLDAQ Event Builder With the Manager →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x1661.md)
