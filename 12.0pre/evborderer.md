...
<a name="AEN21609"></a>## Name

EvbOrderer -- Event orderer compiled commands.

<a name="AEN21612"></a>## Synopsis
...
windowWhich sets the time window
                                        in which fragments are accumulated
                                        before builds can
                                        occur.

XoffThresholdSets the number of bytes of payload data
                                        that can be queued before flow control stop
                                        actions are initiated.

XonThresholdSets the flow control low water mark.  When
                                        the number of queued payload bytes drops below
                                        this value, flow control resume actions are
                                        initiated.

perQXoffThresholdSets the number of Fragments of payload data
                                        that can be queued before flow control stop
                                        actions are initiated.

perQXonThresholdSets the flow control low water mark.  When
                                        the number of Fragments drops below this value,
                                        flow control resume actions are initiated.
...
| --- | --- | --- |
| Prev | Home | Next |
| Observer | Up | EVB::handleFragment |
