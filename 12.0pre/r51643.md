...
[← CTCLChannel](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51599.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPConnectionFailed →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r51644.md)
...
<a name="AEN51657"></a>## Name

CTCPConnectionLost -- Exception thrown when connection to peer is lost

<a name="AEN51660"></a>## Synopsis

```
CTCPConnectionLost
```

<a name="AEN51692"></a>## DESCRIPTION
...
<a name="AEN51749"></a>## SEE ALSO

[*CSocket*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50548.md)
