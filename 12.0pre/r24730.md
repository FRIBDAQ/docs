...
[← CRingStateChangeItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24724.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingScalerItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24807.md)
...
Predicates provide a powerful mechanism for selecting and sampling
            ...
            see the chapter
            [Ring Format](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c185.md)
            which provides background information about ring buffer predicates.
            For reference information, see the reference pages for:
            [`CRingSelectionPredicate`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28228.md),
            [`CAllButPredicate`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28570.md),
            and
            [`CDesiredTypesPredicate`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r28756.md).
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24730.md#cringitem.include)
  This #include obtains the data type and
                      ...
                      constant.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24730.md#cringitem.predicate)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24730.md#cringitem.addtype)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24730.md#cringitem.get)
  This gets a pointer to the ring item that satisfies our
                      ...
                      PHYSICS_EVENT.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24730.md#cringitem.process)
  I'm omitting what you do to process the item as that's application
                      dependent.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24730.md#cringitem.delete)
