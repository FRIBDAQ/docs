...
[← N568B CAENnet shaping amplifier](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9252.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cratelocator →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c9322.md)

---

---

# <a name="util.vhssbs"></a>Chapter 27. VHS-40xxx SBS support.
...
- [iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85137.md)
  Provides a tcl package forlow level support fo the
                      modules including
                      the ability to program the base address of the module.
- [VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r85651.md)
  ...
  This separation allows you to build custom applications
                      ...
                      elements.
- [vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21807.md)
