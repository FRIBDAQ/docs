...
[← CPhysicsEventItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26521.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingFragmentItem →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26666.md)
...
Since this class is derived from
            [CRingItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md),
...
For a full description of the methods available, see
            both [CRingItem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24194.md)'s manpage, and
            the METHODS section below.

<a name="AEN26676"></a>## METHODS
