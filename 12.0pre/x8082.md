...
[← Setting up an XLM72 as a gate delay generator for remote control](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8071.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The electronics →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8100.md)

---

---

# <a name="AEN8082"></a>17.3. Launching the XLM72GateDelayControl
...
<a name="AEN8095"></a>**Figure 17-1. Screenshot of XLM72GateDelayControl**
...
To write the state of the GUI to a configuration file, you should simply
      ...
      displayed in the GUI. See the section [*The Saved File*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8110.md)
