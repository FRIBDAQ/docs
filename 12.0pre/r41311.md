...
[← CCAMACStatusModule](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41238.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACTrigger →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r41356.md)
...
<a name="AEN41359"></a>## Public member functions
...
- <a name="AEN41384"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN41397"></a>` void WriteBit(unsigned int nBitno);`
