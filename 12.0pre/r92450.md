...
[← vhq](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92416.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vhq →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92539.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92736.md)
        for one such panel.
...
<a name="AEN92497"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN92501"></a>### VhsWidgets::channel
...
<a name="AEN92521"></a>### VhsWidgets::channelStatus options
...
<a name="AEN92527"></a>## OBJECT METHODS
...
<a name="AEN92531"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN92534"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91936.md)
