...
[← CopyrightNotice](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50052.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCPNoSuchService →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50121.md)
...
<a name="AEN50068"></a>## Name

CDAQShm -- class description

<a name="AEN50071"></a>## Synopsis

```
CDAQShm
```

<a name="AEN50186"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50054.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50054.md#daqshm-varsrefsect).
