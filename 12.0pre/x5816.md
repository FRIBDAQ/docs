...
[← evbtagger - making event builder fragments from ring items.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5794.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Why does it exist? →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5866.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5816.md#evblite.require)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x5816.md#evblite.instance)
