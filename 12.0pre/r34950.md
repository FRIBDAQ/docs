...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r35107]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r35107]].
...
[[portAllocator(3tcl)|r90958]],
            [[CPortManagerException(3daq)|r35107]],
            [[DaqPortManager(1tcl)|r21679]]
