...
[← Parsing and URIs](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13439.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Shared memory →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c13497.md)
...
Reference material for this library is available in the
        [reference manual page for cvt](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r46733.md).
