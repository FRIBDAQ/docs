...
[← CBufferQueue](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48093.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CUnixUserCheck →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48189.md)
...
<a name="AEN48178"></a>## Name

CDAQShm -- class description

<a name="AEN48181"></a>## Synopsis

```
CDAQShm
```

<a name="AEN48296"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48164.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48164.md#daqshm-varsrefsect).
