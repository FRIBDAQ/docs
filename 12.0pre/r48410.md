...
[← CPasswordCheck](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48404.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CHostListCheck →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48498.md)
...
<a name="AEN48462"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52305.md).
...
`Returns a pointer to the
               ...
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14267.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r53085.md).
...
<a name="AEN48512"></a>## Types and public data
