...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13696.md#gaurded_include)
  The header CGaurdedObject.h defines the
  	    `CGaurdedObject` class and must be included
  	    by classes that derive from that class.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13696.md#gaurded_inherit)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13696.md#gaurded_enter)
  Invoking the `Enter` method of the base class
  	    ...
  	    will not block.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x13696.md#gaurded_leave)
