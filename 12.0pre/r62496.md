...
[← CCCUSBusb](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62447.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62619.md)
...
<a name="AEN62510"></a>## Name

CCCUSBusb -- Provide access to a connected CC-USB device.

<a name="AEN62513"></a>## Synopsis

```
CCCUSBusb
```

<a name="AEN62577"></a>## DESCRIPTION
