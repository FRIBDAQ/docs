...
[← vmusbloader](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r18984.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ringselector →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r19018.md)
...
<a name="AEN19016"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN19019"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN19024"></a>## DESCRIPTION
...
<a name="AEN19046"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN19049"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN19052"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN19055"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN19058"></a>## DEPENDENCIES
