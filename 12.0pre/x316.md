...
[← Extending the slow controls subsystem](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x2650.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Extensibility and Openness →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x33.md)
