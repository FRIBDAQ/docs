...
[← CErrnoException](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56553.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r56628.md)
...
<a name="AEN56616"></a>## Name

CErrnoException -- Exceptions that wrap the Unix `errno`

<a name="AEN56620"></a>## Synopsis

```
CErrnoException
```

<a name="AEN56647"></a>## Description
...
<a name="AEN56656"></a>## Public member functions
