...
[← CUnixUserCheck](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48189.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTclAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r48287.md)
...
<a name="AEN48290"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14267.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52133.md).
...
`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14267.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r52913.md).
...
<a name="AEN48340"></a>## Types and public data

`CTCLInterpreter`
            and
            `CTCLVariable`
            are objects that are part of the Tcl++ library. See the
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14267.md) of the
