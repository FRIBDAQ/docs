...
[← CCAMACTrigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r40820.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamac →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r40835.md)
...
<a name="AEN40876"></a>## Public member functions



- <a name="AEN40881"></a>`CCAMACStatusModule(unsigned int b, unsigned int c, unsigned int n);`
...
- <a name="AEN40914"></a>`virtual void  GoBusy(void);`
  Pulses the computer going busy output.  This is usually used to indicate
                              ...
                              latch to be busy.
- <a name="AEN40924"></a>`virtual void  GoClear(void);`
...
- <a name="AEN40934"></a>`virtual void  ModuleClear(void);`
