...
[← Interpreting the dumper output](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8364.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for USB communication →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8406.md)

---

---

# <a name="sec.lg_setup"></a>21.2. Setting up a logbook for use.
...
## <a name="AEN8402"></a>21.2.1. Creating a logbook and making it current.
...
<a name="AEN8426"></a>**Example 21-1. Creating a logbook and making it current**
...
## <a name="AEN8429"></a>21.2.2. Organizing the people on an experiment
...
### <a name="AEN8444"></a>21.2.2.1. Adding People.
...
<a name="AEN8448"></a>**Example 21-2. Using **lg_addperson to add people to the logbook****
...
### <a name="AEN8452"></a>21.2.2.2. Using **lg_mkshift** to create and poopulate shifts
...
<a name="AEN8458"></a>**Example 21-3. Using **lg_mkshift****
...
The second form of the **lg_mkshift** command
               ...
               [*The shift editor*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8390.md#fig.lg_shifteditor)
               below.

<a name="fig.lg_shifteditor"></a>**Figure 21-2. The shift editor**

![](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/shifteditor.jpg)
...
### <a name="AEN8473"></a>21.2.2.3. Using **lg_mgshift** and **lg_selshift**
...
<a name="AEN8484"></a>**Example 21-4. Using **lg_mgshift** to manage shifts**
...
<a name="AEN8497"></a>**Example 21-5. Using **lg_selshift** to select the current shift**
...
The shift selector is shown in
               [*The shift selector.*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x8390.md#fig.lg_selshift)
               below.

<a name="fig.lg_selshift"></a>**Figure 21-3. The shift selector.**

![](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/shiftselector.jpg)
