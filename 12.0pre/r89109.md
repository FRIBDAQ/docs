...
[← logbook](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89083.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [shiftinstance →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89133.md)
...
<a name="AEN89113"></a>## Name

noteinstance -- Tcl encapsulation of a note

<a name="AEN89116"></a>## Synopsis
...
A note instance is a Tcl command ensemble that provides access to
            ...
            See
            [*logbookinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r88533.md) for subcommands that
            can generate notess
...
set run [*$note* run]
  ...
  If the note has an associated run, this subcommand returns
                       ...
                       [*runinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89009.md)
