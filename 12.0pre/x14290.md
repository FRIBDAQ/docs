...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_include)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_datafmtinclude)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_timestampentry)
  ...
  ```
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_body_ptr)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_checkversion)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_iterationsetup)
  This section sets up to iterate through the set of packets
                          in the event.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_extract_ts)
  If the next packet is a timestamp packet, the timestamp is
                          extracted from it and returned to the caller.
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_nextpacket)
  If the current packet is not the timestamp packet,
                          the pointer to the next packet is computed and
                          the search continues.
- [![(9)](../images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_failed)
