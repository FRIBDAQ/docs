...
[← Running event builder clients](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14257.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Exception classes →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14356.md)
...
<a name="AEN14336"></a>**Example 65-7. S800 timestamp extractor (s800timestamp.c**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_include)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_datafmtinclude)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_timestampentry)
...
extern "C" {
  ...
  ```
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_body_ptr)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_checkversion)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_iterationsetup)
  This section sets up to iterate through the set of packets
                          in the event.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_extract_ts)
  If the next packet is a timestamp packet, the timestamp is
                          extracted from it and returned to the caller.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_nextpacket)
  If the current packet is not the timestamp packet,
                          the pointer to the next packet is computed and
                          the search continues.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14290.md#s800tstamp_failed)
