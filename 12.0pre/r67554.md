...
[← DAQParameters](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67530.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onBegin →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r67595.md)
...
<a name="AEN67568"></a>## Name

Configuration -- Configuration variable management

<a name="AEN67571"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69226.md) package for that
            instead.

<a name="AEN67594"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r69226.md) is a better
                          choice).
