...
[← delay](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r83742.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBDLeCroy4300B →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r83781.md)
...
<a name="AEN83774"></a>## DESCRIPTION

This package provides a family of controllers that interface
            between the model provided by
            [*EVBRESTClient*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r83497.md)
            and the presentation views provided by
            [*EVBRestUI*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r83251.md).
...
<a name="AEN83800"></a>## CONTROLLER VIEW PAIRS
...
<a name="AEN83804"></a>**Table 1. EVBRestControllers and Corresponding EVBRestUI Views**
