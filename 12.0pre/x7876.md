...
[← Managed Objects and Configuration](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x787.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running the system. →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7881.md)

---

---

# <a name="AEN7876"></a>14.2. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN7886"></a>**Figure 14-1. The MCFD16Control Graphical User Interface for USB**
