...
[← Interpreting the dumper output](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7834.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for USB communication →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x7876.md)
...
Although normally you do not need to modify the states and allowed
          ...
          **mg_stateedit**
          (Reference pages in
          [*mg_stateedit*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15826.md))
...
The **mg_cfgEvlog** utility allows you to create, edit
          ...
          utility is at
          [*mg_cfgEvlog*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r15915.md)
...
The **mg_kvedit** command allows you to create, new keys,
          ...
          **mg_kvedit** is available at
          [*mg_kvedit*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16041.md)
...
The experiment configuration database does, however, already provide
          ...
          [*mg_authedit*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r16076.md)
