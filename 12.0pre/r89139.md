...
[← shiftinstance](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89133.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [noteinstance →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89158.md)
...
It's not possible for you to directly instantiate a logbook instance
            ...
            command.  See
            [*logbook*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89083.md).
...
- **addPerson *lastname firstname ?salutation?***
  ...
  Person instances are described in
                       [*personinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89512.md).
- **findPeople *?where-clause?***
  Returns a list of person instances that match the
                       ...
                       See [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r98761.md)
...
- **createShift *shiftname ?people?***
  Creates a new shift `shiftname`. If
                       ...
                       [*shiftinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89567.md).
- **getShift *id***
...
- begin *number title ?remark?*
  Begins a new run with run number `number`
                       ...
                       See [*runinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89615.md) for information
...
**createNote *author text images imageoffsets ?run?***
  Creates a new note and returns a note instance command.
                       ...
                       [*noteinstance*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r89715.md).
