...
[← Event builder client framework](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14024.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Os class →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14117.md)
...
Reference information is available in [the reference section](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r50467.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14027.md#shm_includes)
  Includes the header for the NSCLDAQ shared memory API.
                      See [*Compiling/Linking your software with the shared memory API*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x14098.md)
                      for information that describes how to ensure this header
                      will be found by the compiler.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14027.md#shm_create)
  Attempts to crate the shared memory. The return value of this
                      ...
                      read/write access.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14027.md#shm_create_fail)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14027.md#shm_attach)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/c14027.md#shm_detach)
