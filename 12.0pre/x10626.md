...
[← Selecting Data From a Ring Buffer](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10598.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Generic ring data sinks →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x10735.md)

---

---

# <a name="AEN10626"></a>44.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN10632"></a>**Example 44-1. Including a ring item class **
...
<a name="AEN10639"></a>**Example 44-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN10644"></a>**Example 44-3. Linking the ring item format libraries**
...
- [`CRingItem`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r23737.md)
...
- [`CRingStateChangeItem`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24724.md)
...
- [`CRingScalerItem`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r24227.md)
...
- [`CRingTextItem`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25166.md)
...
- [`CGlomParameters`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26753.md)
...
- [`CPhysicsEventItem`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25528.md)
  Encapsulates the data taken in response to a physics
                          trigger.
- [`CRingFragmentItem`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26086.md)
...
- [`CRingPhysicsEventCountItem`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r25724.md)
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [`CUnknownFragment`](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r26401.md)
...
## <a name="AEN10716"></a>44.3.1. Generic ring data sources
...
Reference information on these classes is availabe at:
                [*CDataSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r29870.md),
                [*CRingDataSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r29922.md),
                [*CFileDataSource*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30001.md),
                [*CDataSourceFactory"*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30068.md),
                and
                [*CRingItemFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r30135.md).
