...
[← readoutscript](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86817.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3tcl →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86918.md)
...
<a name="AEN86939"></a>## EXPORTED ENTRY POINTS
...
- **program::add** *db name path type host ?options?*
  ...
  - container
    If supplied, this must be the name of a container
                               ...
                               [*containers*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r86686.md)
