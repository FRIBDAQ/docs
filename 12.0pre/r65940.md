...
[← CModuleFactory](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65903.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CModuleCreator →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r66010.md)
...
<a name="AEN65954"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN65957"></a>## Synopsis

```
CControlHardware
```

<a name="AEN66024"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65780.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r65887.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN66031"></a>## METHODS
