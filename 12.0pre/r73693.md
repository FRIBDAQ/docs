...
[← tcl driver support](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r73658.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [v977 →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r73708.md)
...
<a name="AEN73707"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN73710"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN74896"></a>## DESCRIPTION
...
<a name="AEN74899"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r70786.md)
