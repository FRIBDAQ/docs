...
[← CCCUSBRemote](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62821.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBReadoutList →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r62981.md)
...
<a name="AEN62946"></a>## Name

CCCUSBReadoutList -- Create lists of CAMAC commands for CC-USB controllers.

<a name="AEN62949"></a>## Synopsis

```
CCCUSBReadoutList
```

<a name="AEN63151"></a>## DESCRIPTION
