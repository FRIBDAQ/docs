...
<a name="AEN22321"></a>### Configuration Options
...
<a name="AEN22345"></a>### Device Options
...
<a name="AEN22375"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN22391"></a>```
...
Retrieve the ID code for the board above<a name="AEN22396"></a>```
...
Load firmware and license it.<a name="AEN22403"></a>```
...
Retrieve license information from a digitizer.<a name="AEN22411"></a>```
...
Un-license a digitizer's firmware:<a name="AEN22416"></a>```
