...
[← Incorporating the headers and libraries into your applications.](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11156.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Creating ring items →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/x11279.md)
...
For reference information on the data sink classes see:
            [*CDataSink*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31231.md),
            [*CRingDataSink*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31464.md),
            [*CFileDataSink*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31322.md).
            For reference information on the factory class see:
            [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r31565.md)
