...
[← LogBookRun](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33788.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBookNote →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33866.md)
...
<a name="AEN33880"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33660.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN33887"></a>## Public member functions
...
<a name="AEN33943"></a>## Types and public data
...
<a name="AEN33963"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN33966"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r84282.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r33660.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r21308.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r54738.md)
