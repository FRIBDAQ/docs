...
[← n568Panel](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92223.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vhqconfig →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92327.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r92564.md)
        for one such panel.
...
<a name="AEN92325"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN92329"></a>### VhsWidgets::channel
...
<a name="AEN92349"></a>### VhsWidgets::channelStatus options
...
<a name="AEN92355"></a>## OBJECT METHODS
...
<a name="AEN92359"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN92362"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r91764.md)
