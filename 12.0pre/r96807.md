...
[← CV977Trigger](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96796.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CReadoutException →](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96819.md)
...
<a name="AEN96857"></a>| Plug | Direction | Meaning |
| --- | --- | --- |
...
<a name="AEN96878"></a>## Public member functions
...
<a name="AEN96914"></a>## SEE ALSO

[CBusy(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r94636.md),
     [CV977Trigger(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/12.0pre/r96919.md)
