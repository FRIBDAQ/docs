[← NSCL DDAS: nscope/MediaLocator.h Source File](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/MediaLocator_8h_source.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: nscope/ModCsrb.h Source File →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/ModCsrb_8h_source.md)
...
- CBDecayUnpacker::operator()(Address_t, CEvent&, CAnalyzer&, CBufferDecoder&)
- CBDecayUnpacker::OnAttach(CAnalyzer&)
- CBDecayUnpacker::OnBegin(CAnalyzer&, CBufferDecoder&)
- CBDecayUnpacker::OnEnd(CAnalyzer&, CBufferDecoder&)
- CBDecayUnpacker::OnPause(CAnalyzer&, CBufferDecoder&)
- CBDecayUnpacker::OnResume(CAnalyzer&, CBufferDecoder&)
- CBDecayUnpacker::OnOther(UInt_t, CAnalyzer&, CBufferDecoder&)


We then are going to change the CBDecayUnpacker to derive from CEventProcessor to [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CParameterMapper.md). This means that the header file will look something like this:
...
class CBDecayUnpacker : public [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CParameterMapper.md)
...
int computeGlobalSlotId(const [DAQ::DDAS::DDASHit](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md)& hit) const;
...
const [DAQ::DDAS::DDASHit](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md)& hit = channellist[hitIndex];
...
starttime_low = hit.[GetTimeLow](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a63d8283fdf35b61568af8ade64b602dd)();


starttime_high = hit.[GetTimeHigh](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#ab39aa1bc019c6a75568fac5d35f4cded)();


bdecay.clock.fast = hit.[GetTimeLow](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a63d8283fdf35b61568af8ade64b602dd)();


bdecay.clock.slow = hit.[GetTimeHigh](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#ab39aa1bc019c6a75568fac5d35f4cded)();





bdecay.clock.cfd  = hit.[GetTimeCFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a8756c56f094852fdc22aa3e763d741c6)();
...
bdecay.raw.chanid[globalId].adc       = hit.[GetEnergy](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a123d68755f678cd1eec6f5320a39b629)();


bdecay.raw.chanid[globalId].timehigh  = hit.[GetTimeHigh](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#ab39aa1bc019c6a75568fac5d35f4cded)();


bdecay.raw.chanid[globalId].timelow   = hit.[GetTimeLow](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a63d8283fdf35b61568af8ade64b602dd)();


bdecay.raw.chanid[globalId].timecfd   = hit.[GetTimeCFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a8756c56f094852fdc22aa3e763d741c6)();


bdecay.raw.chanid[globalId].time      = hit.[GetTime](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a930e45be2c50eaf4a90988b0bd8c4a74)();





endtime_low = hit.[GetTimeLow](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a63d8283fdf35b61568af8ade64b602dd)();


endtime_high = hit.[GetTimeHigh](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#ab39aa1bc019c6a75568fac5d35f4cded)();
...
int CBDecayUnpacker::computeGlobalSlotId(const [DAQ::DDAS::DDASHit](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md)& hit) const
...
for (int z =0; z < hit.[GetCrateID](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a0c17bf66e65f7314307ad23227fbf93b)(); z++){
...
id += (hit.[GetSlotID](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#aab78355e0d4da8640c3a3886f7701150)() - 2)*bdecayv.ddas.channelpermod;
...
id += hit.[GetChannelID](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#af387c4cad80e87aeac48aff600df53d7)();
...
using namespace [std](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/namespacestd.md);
...
static CBDecayUnpacker Unpacker;
 ...
 fragment This needs to be changed so that the new version of the CBDecayUnpacker is initialized on the heap (i.e. constructed with operator new). We are also intending to replace the CBDecayUnpacker in the event processing pipeline with something else, because the CBDecayUnpacker is no longer an event processor (remember it derives from [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CParameterMapper.md) now). The object we will replace it with is a [DAQ::DDAS::CDDASBuiltUnpacker](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker.md). Built unpackers expect that the data being read is the output of the NSCLDAQ event builder. To construct one of these, you need to pass it a set of source ids that it should pay attention to and then also a concrete instance of a [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CParameterMapper.md). We can accomplish all of this by writing:


static CBDecayUnpacker* UnpackBDecay = new CBDecayUnpacker;


static [DAQ::DDAS::CDDASBuiltUnpacker](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker.md) Unpacker({0, 1}, *UnpackBDecay);
