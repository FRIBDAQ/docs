...
We then are going to change the CBDecayUnpacker to derive from CEventProcessor to [[classDAQ_1_1DDAS_1_1CParameterMapper]]. This means that the header file will look something like this:
...
class CBDecayUnpacker : public [[classDAQ_1_1DDAS_1_1CParameterMapper]]
...
int computeGlobalSlotId(const [[classDAQ_1_1DDAS_1_1DDASHit]]& hit) const;
...
const [[classDAQ_1_1DDAS_1_1DDASHit]]& hit = channellist[hitIndex];
...
starttime_low = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a63d8283fdf35b61568af8ade64b602dd]]();


starttime_high = hit.[[classDAQ_1_1DDAS_1_1DDASHit#ab39aa1bc019c6a75568fac5d35f4cded]]();


bdecay.clock.fast = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a63d8283fdf35b61568af8ade64b602dd]]();


bdecay.clock.slow = hit.[[classDAQ_1_1DDAS_1_1DDASHit#ab39aa1bc019c6a75568fac5d35f4cded]]();





bdecay.clock.cfd  = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a8756c56f094852fdc22aa3e763d741c6]]();
...
bdecay.raw.chanid[globalId].adc       = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a123d68755f678cd1eec6f5320a39b629]]();


bdecay.raw.chanid[globalId].timehigh  = hit.[[classDAQ_1_1DDAS_1_1DDASHit#ab39aa1bc019c6a75568fac5d35f4cded]]();


bdecay.raw.chanid[globalId].timelow   = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a63d8283fdf35b61568af8ade64b602dd]]();


bdecay.raw.chanid[globalId].timecfd   = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a8756c56f094852fdc22aa3e763d741c6]]();


bdecay.raw.chanid[globalId].time      = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a930e45be2c50eaf4a90988b0bd8c4a74]]();





endtime_low = hit.[[classDAQ_1_1DDAS_1_1DDASHit#a63d8283fdf35b61568af8ade64b602dd]]();


endtime_high = hit.[[classDAQ_1_1DDAS_1_1DDASHit#ab39aa1bc019c6a75568fac5d35f4cded]]();
...
int CBDecayUnpacker::computeGlobalSlotId(const [[classDAQ_1_1DDAS_1_1DDASHit]]& hit) const
...
for (int z =0; z < hit.[[classDAQ_1_1DDAS_1_1DDASHit#a0c17bf66e65f7314307ad23227fbf93b]](); z++){
...
id += (hit.[[classDAQ_1_1DDAS_1_1DDASHit#aab78355e0d4da8640c3a3886f7701150]]() - 2)*bdecayv.ddas.channelpermod;
...
id += hit.[[classDAQ_1_1DDAS_1_1DDASHit#af387c4cad80e87aeac48aff600df53d7]]();
...
static CBDecayUnpacker Unpacker;
 ...
 fragment This needs to be changed so that the new version of the CBDecayUnpacker is initialized on the heap (i.e. constructed with operator new). We are also intending to replace the CBDecayUnpacker in the event processing pipeline with something else, because the CBDecayUnpacker is no longer an event processor (remember it derives from [[classDAQ_1_1DDAS_1_1CParameterMapper]] now). The object we will replace it with is a [[classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker]]. Built unpackers expect that the data being read is the output of the NSCLDAQ event builder. To construct one of these, you need to pass it a set of source ids that it should pay attention to and then also a concrete instance of a [[classDAQ_1_1DDAS_1_1CParameterMapper]]. We can accomplish all of this by writing:


static CBDecayUnpacker* UnpackBDecay = new CBDecayUnpacker;


static [[classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker]] Unpacker({0, 1}, *UnpackBDecay);
