[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1PixieCrateReader-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1PixieCrateWriter-members.md)
...
- **DDAS**
- [PixieCrateReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1PixieCrateReader.md)

 top 
[Public Member Functions](#pub-methods) |
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1PixieCrateReader-members.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1PixieCrateReader.png)
...
- The slots parameters must be the same as those passed into the Pixie16InitSystem or the [CrateManager](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateManager.md) constructor if that's being used.
...
The documentation for this class was generated from the following files:- xml/[PixieCrateReader.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/PixieCrateReader_8h_source.md)
- xml/[PixieCrateReader.cpp](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/PixieCrateReader_8cpp.md)
