[← NSCL DDAS: HardwareRegistry Namespace Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/namespaceHardwareRegistry.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Namespace List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/namespaces.md)
...
- [Namespace List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/namespaces.md)
...
The [Test](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/namespaceTest.md) namespace for DDAS provides some tools useful for testing the DDAS system. At the moment, the testing version of the Pixie16 API logs the interactions with the API and also allows the user the ability to set up a fake system using Pixie16SetModuleType().
