...
THis method is very similar to the [[SetTime()|classDAQ_1_1DDAS_1_1DDASHitUnpacker#a0adfc6514f3cfed2cb7bc22de5993f70]] method. It differs in that it doesn not apply a correction for the [[CFD|classCFD]] time. It simply forms the timestamp from the low and high bits and then converts it to a time in nanoseconds.
