[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structTrAnal_1_1CFDResult-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/struct__FitInfo-members.md)
...
- **TrAnal**
- [CFDResult](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structTrAnal_1_1CFDResult.md)

 top 
[Public Attributes](#pub-attribs) |
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structTrAnal_1_1CFDResult-members.md)


TrAnal::CFDResult< T > Struct Template Reference

header
Result for a [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) computation.  
 [More...](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structTrAnal_1_1CFDResult.md#details)
...
Because the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) algorithm does not necessarily start its search at the beginning of the search, it can only identify a location. Typically, the trig and the fraction will be used in a manner similar to as follows.
...
The documentation for this struct was generated from the following file:- traiter/src/[CFD.hpp](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/CFD_8hpp_source.md)
