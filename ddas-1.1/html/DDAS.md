[← NSCL DDAS: nscope/Csra.h Source File](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/Csra_8h_source.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: format/DDASBitMasks.h Source File →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/DDASBitMasks_8h_source.md)
...
![pixie-16-100msps.jpg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/pixie-16-100msps.jpg)
The 100 MSPS Pixie-16
...
The data format is described in detail in the [readout](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/readout.md) section. However, the interpretation of the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) time is unique to each module. The 3rd data word in the event header contains the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) time in its most significant 16 bits. The bits have the following meaning:
...
![pixie-16-250msps.jpg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/pixie-16-250msps.jpg)
The 250 MSPS Pixie-16
...
The table above shows that the timestamp in the module has a factor of two difference between the frequencies it timestamps with and it digitized with. This is really just a difference between the frequencies of the FPGA and ADC. This factor of two causes some interesting features in the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) time that the module outputs. The [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) time provides the correction for the fractional offset from the most recent sample point and also which sample point to adjust from (there are two samples per each tick on the timestamp clock). The meanings of the bits in the third 32-bit header word are as follow:
...
To compute the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) correction to the timestamp from this, one would do the following computation:
...
![pixie-16-500msps.jpg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/pixie-16-500msps.jpg)
The 500 MSPS Pixie-16
...
Like the 250 MSPS modules, there is a discepancy between the timestamp and ADC frequencies. The [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) time therefore also accounts for this detail. The third 32-bit header word emitted by the Pixie-500 module has the following bit meanings:
...
![100msps_LVTTL_breakout.jpg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/100msps_LVTTL_breakout.jpg)
...
The trigger distribution board is used to distribute the clock and triggers between crates in a multicrate system. See the [The Clock/Trigger Distribution Board](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/simple_setup_multicrate.md#ssncrate_hdwrConfigClockDist_sec) for a description of this device and how to use it.
