...
The data format is described in detail in the [[readout|readout]] section. However, the interpretation of the [[CFD|classCFD]] time is unique to each module. The 3rd data word in the event header contains the [[CFD|classCFD]] time in its most significant 16 bits. The bits have the following meaning:
