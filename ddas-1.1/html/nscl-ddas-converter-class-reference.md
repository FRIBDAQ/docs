...
This is an abstract class and cannot be instantiated. It provides the interface that must be implemented by all derived classes. At the moment these are the [[classRootConverter]] and [[classRootConverter2]] classes. The [[classBufdumpMain]] class only deals with the interface defined here such that the use of different conversion objects in the ddasdumper program is transparent to the remainder of the program.


There is one pure virtual member, [[classConverter#a9ff35398f215af687593e4785f3ecf19]], that exists because there is no sensible default implementation.
...
Implemented in [[classRootConverter2#a8b5461e30739b427669f7aa1942614af]], and [[classRootConverter#ae13972969e6fac531cf12da8ac1847be]].
...
Reimplemented in [[classRootConverter2#a82cbffa4f3553d099824c216731d269d]], and [[classRootConverter#a35d0678f9622196fd7caecf43e76bc65]].
...
The documentation for this class was generated from the following files:- ddasdumper/[[Converter_8h_source]]
