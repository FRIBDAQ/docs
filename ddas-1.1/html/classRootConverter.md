...
[[List of all members|classRootConverter-members]]


RootConverter Class Reference

header
[[Converter|classConverter]] for data formats < NSCLDAQ 10.2.  
 [[More...|classRootConverter#details]]
...
A concrete implementation of the [[Converter|classConverter]] base class to support the conversion of data built with NSCLDAQ versions prior to 10.2. This class expects a simple physics data structure defined as follows:
...
The [[RootConverter|classRootConverter]] object creates a branch in the tree referenced by Converter::m_treepointer named dchan. It holds the ddaschannel objects produced by every call to the [[RootConverter::DumpData(const CRingItem&)|classRootConverter#ae13972969e6fac531cf12da8ac1847be]] method.
...
The documentation for this class was generated from the following files:- ddasdumper/[[RootConvert.h|RootConvert_8h_source]]
