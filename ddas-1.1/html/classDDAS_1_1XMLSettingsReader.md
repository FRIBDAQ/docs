[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsReader-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsWriter-members.md)
...
- **DDAS**
- [XMLSettingsReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsReader.md)

 top 
[Public Member Functions](#pub-methods) |
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsReader-members.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsReader.png)
...
For the structure of module files see [XMLSettingsWriter.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/XMLSettingsWriter_8h.md) and its description of the [XMLSettingsWriter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsWriter.md) class. The structure of [Crate](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structDDAS_1_1Crate.md) definition files is pretty simple:
...
The documentation for this class was generated from the following files:- xml/[XMLSettingsReader.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/XMLSettingsReader_8h_source.md)
- xml/[XMLSettingsReader.cpp](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/XMLSettingsReader_8cpp.md)
