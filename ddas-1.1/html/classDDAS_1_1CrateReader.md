[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateReader-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateWriter-members.md)
...
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateReader-members.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateReader.png)
...
- getEvtLen - must return the expected event length for a slot These are called in that order for each slot. - Returns
    [Crate](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structDDAS_1_1Crate.md) - the processed crate description.



---

The documentation for this class was generated from the following files:- xml/[CrateReader.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/CrateReader_8h_source.md)
- xml/[CrateReader.cpp](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/CrateReader_8cpp.md)
