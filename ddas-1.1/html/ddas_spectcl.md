[← NSCL DDAS: ddas_config.h Source File](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/ddas__config_8h_source.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: ddasdumper/ddaschannel.h Source File →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/ddaschannel_8h_source.md)
...
- [Using the Unpacker](#ddas_using_unpacker)
...
The unpacker provided understands how to navigate the fragments of event built data unpacking the hits into "hits". Each hit is represented by a [DAQ::DDAS::DDASHit](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md) object. In addition to time and energy, and potentially traces, this object identifies the channel the it comes from by crate, slot and channel.
...
I will layout the structure of the data in a tree structure where there is a top-level event structure called [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md) that holds the multiplicity information as well as all of the channel data objects as a flat array of energy time pairs.
...
struct [ChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structChannelData.md) {
...
struct [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md) {





[ChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structChannelData.md)          chan[48];
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md)(std::string name);
 ...
 fragment The implementation file is very simple (get the actual code from $DDAS_ROOT/share/src/multicrate_src/MyParameters.cpp):
...
class [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md);
...
class [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classMyParameterMapper.md) : public [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CParameterMapper.md)
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md)& m_params;          // reference to the tree parameter structure
...
[MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classMyParameterMapper.md)([MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md)& params);
...
int computeGlobalIndex(const [DAQ::DDAS::DDASHit](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md)& hit);
 ...
 fragment Note that there is not much to this class. The class maintains a reference to our parameters and an m_chanMap data member, which we will talk about a little later. This class is derived from the [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CParameterMapper.md) base class. Concrete [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CParameterMapper.md) classes are expected to provide a mapToParameters method that takes the hits and spectcl parameter and fills the parameters from the hits.
...
m_params.chan[globalChanIdx].energy    = hit.[GetEnergy](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a123d68755f678cd1eec6f5320a39b629)();


m_params.chan[globalChanIdx].timestamp = hit.[GetTime](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1DDASHit.md#a930e45be2c50eaf4a90988b0bd8c4a74)();
...
MyParameterMapper::MyParameterMapper([MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md)& params)
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md) params("raw");
...
[DAQ::DDAS::CDDASBuiltUnpacker](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker.md) Stage1( {0, 1, 2 }, *(new [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classMyParameterMapper.md)(params)));

 fragment To round out our work on MySpecTclApp.cpp, you simply need to add some include directives to the top of the file. These will bring the [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md), [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classMyParameterMapper.md), [DAQ::DDAS::CDDASBuiltUnpacker](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker.md) classes into scope. Add these lines to the top:
...
Add the [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md) and [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classMyParameterMapper.md) class to the build by adding MyParameters.o and MyParameterMapper.o to the OBJECTS variable. It should look like this when you are done:


OBJECTS=MySpecTclApp.o [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structMyParameters.md).o [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classMyParameterMapper.md).o

 fragment Next the compiler needs to be told where to find the [DDASBuiltUnpacker.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/DDASBuiltUnpacker_8h_source.md) file. Furthermore, the unpacker code uses C++ language and library elements from the 2011 version of the C++ standard so we need to enable the use of those by the compiler. That is done by adding to the USERCXXFLAGS so it looks like this:


USERCXXFLAGS=-[std](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/namespacestd.md)=c++11 -I/usr/opt/ddas/VERSION/include
