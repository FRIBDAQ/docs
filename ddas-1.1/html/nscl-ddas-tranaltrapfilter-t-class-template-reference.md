...
[[classTrAnal_1_1TrapFilter-members]]
...
A simple fast filter (lead sum - trail sum)  
 [[classTrAnal_1_1TrapFilter#details]]
...
Given a starting position, the symmetric filter is built from the rise_range and gap_range provided. These make use of the offset definitions of a [[classTrAnal_1_1TrRange]]. The trailing sum is defined as a region [begin, begin+rise_range) and the leading sum is defined as [begin+rise_range+gap_range, begin+ 2*rise_range+gap_range).
...
Less than comparison to [[classTrAnal_1_1TrIterator]].


Comparison against a simple iterator (useful for checking whether next dereference will be a valid and safe). Literally compares whether the iterator returned by [[classTrAnal_1_1TrapFilter#a0793799d43dcbfe21a018c7907c4d768]] is less than the argument. In normal situations, this is analogous to checking whether the [[classTrAnal_1_1TrapFilter#a0793799d43dcbfe21a018c7907c4d768]] of the leading sum comes before the argument.
...
Returnstrue if it<[[classTrAnal_1_1TrapFilter#a0793799d43dcbfe21a018c7907c4d768]], false otherwise 
...
Greater than comparison to [[classTrAnal_1_1TrIterator]].


Comparison against a simple iterator. Literally compares whether the iterator returned by [[classTrAnal_1_1TrapFilter#a69b62c45160b76b81be8f34df77a419a]] is greater than the argument. In normal situations, this is analogous to checking whether the [[classTrAnal_1_1TrapFilter#a69b62c45160b76b81be8f34df77a419a]] of the trailing sum comes after the argument.
...
Returnstrue if [[classTrAnal_1_1TrapFilter#a69b62c45160b76b81be8f34df77a419a]] > it, false otherwise



---

The documentation for this class was generated from the following file:- traiter/src/[[TrapFilter_8hpp_source]]
