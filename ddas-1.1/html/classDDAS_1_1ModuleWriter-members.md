[← NSCL DDAS: DDAS::CrateWriter Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateWriter.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: DDAS::ModuleWriter Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1ModuleWriter.md)
...
- [ModuleWriter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1ModuleWriter.md)
 ...
 top 
DDAS::ModuleWriter Member List

header
This is the complete list of members for [DDAS::ModuleWriter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1ModuleWriter.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| ModuleWriter(unsigned crate, unsigned slot, unsigned module) | DDAS::ModuleWriter |  |
| write(const ModuleSettings &dspSettings) | DDAS::ModuleWriter | virtual |
| ~ModuleWriter() | DDAS::ModuleWriter | virtual |
