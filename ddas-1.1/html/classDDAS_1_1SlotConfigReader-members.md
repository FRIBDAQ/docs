[← NSCL DDAS: DDAS::SettingsWriter Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1SettingsWriter.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: DDAS::SlotConfigReader Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1SlotConfigReader.md)
...
- [SlotConfigReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1SlotConfigReader.md)
 ...
 top 
DDAS::SlotConfigReader Member List

header
This is the complete list of members for [DDAS::SlotConfigReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1SlotConfigReader.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| operator=(const SlotConfigReader &rhs) | DDAS::SlotConfigReader |  |
| read() | DDAS::SlotConfigReader |  |
| SlotConfigReader(const char *file) | DDAS::SlotConfigReader |  |
| SlotConfigReader(const SlotConfigReader &rhs) | DDAS::SlotConfigReader |  |
