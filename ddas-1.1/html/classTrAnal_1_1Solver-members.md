[← NSCL DDAS: TrAnal::RiseTimeProcResult< T > Class Template Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classTrAnal_1_1RiseTimeProcResult.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: TrAnal::Solver Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classTrAnal_1_1Solver.md)
...
- [Solver](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classTrAnal_1_1Solver.md)
 ...
 top 
TrAnal::Solver Member List

header
This is the complete list of members for [TrAnal::Solver](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classTrAnal_1_1Solver.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| npoints() const =0 | TrAnal::Solver | pure virtual |
| operator()(const std::deque< double > &que) const =0 | TrAnal::Solver | pure virtual |
