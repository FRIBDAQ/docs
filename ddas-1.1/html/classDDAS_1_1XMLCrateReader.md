[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLCrateReader-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLCrateWriter-members.md)
...
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLCrateReader-members.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLCrateReader.png)
...
This class specializes the [CrateReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateReader.md) class to work with a set of XML specifications of the crate, modules and their settings. The top level is a crate xml file which is of the form
...
- Create an [XMLSettingsReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsReader.md) on the filename that's in the [SlotInformation](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structDDAS_1_1XMLCrateReader_1_1SlotInformation.md) struct for that slot. - Parameters
    |  |  |
    | --- | --- |
    | slot | - slot number. |
  - Returns
    SettingsReader* pointer to a dynamically created [XMLSettingsReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1XMLSettingsReader.md)


Implements [DDAS::CrateReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classDDAS_1_1CrateReader.md).
...
The documentation for this class was generated from the following files:- xml/[XMLCrateReader.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/XMLCrateReader_8h_source.md)
- xml/[XMLCrateReader.cpp](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/XMLCrateReader_8cpp.md)
