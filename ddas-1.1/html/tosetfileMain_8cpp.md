[← NSCL DDAS: Todo List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/todo.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: xml/tosetfile.h File Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/tosetfile_8h.md)
...
[Main](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classMain.md) The main logic flow. This is separated so that exceptions can be thrown but handled by the actual main.
