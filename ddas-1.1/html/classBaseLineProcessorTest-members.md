[← NSCL DDAS: AveragingRangeIteratorTest Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classAveragingRangeIteratorTest.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: BaseLineProcessorTest Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classBaseLineProcessorTest.md)
...
[All](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)[Classes](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)[Namespaces](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)[Files](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)[Functions](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)[Variables](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)[Macros](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)[Pages](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/javascript:void(0).md)
 ...
 top 
BaseLineProcessorTest Member List

header
This is the complete list of members for [BaseLineProcessorTest](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classBaseLineProcessorTest.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| CPPUNIT_TEST(testProcessReturnTypeIsBaseLineProcResult) (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| CPPUNIT_TEST(testProcess) (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| CPPUNIT_TEST(testRange) (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| CPPUNIT_TEST(testOffset) (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| CPPUNIT_TEST_SUITE(BaseLineProcessorTest) (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| CPPUNIT_TEST_SUITE_END() (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| setUp() (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| tearDown() (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| testOffset() (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| testProcess() (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| testProcessReturnTypeIsBaseLineProcResult() (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
| testRange() (defined inBaseLineProcessorTest) | BaseLineProcessorTest |  |
