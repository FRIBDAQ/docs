[← NSCL DDAS: dumpsetfile/DSPFileReader.h Source File](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/DSPFileReader_8h_source.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: dumpsetfile/DescriptionParser.cpp File Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/DescriptionParser_8cpp.md)
...
- Remarks
  ...
  - The meaning of the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) bits depend on the type of the Pixie-16 digitizer used. See the page on each module for details about the data it outputs.
