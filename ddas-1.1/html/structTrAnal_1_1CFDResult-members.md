[← NSCL DDAS: Pixie_Configuration Struct Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structPixie__Configuration.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: TrAnal::CFDResult< T > Struct Template Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structTrAnal_1_1CFDResult.md)
...
- [CFDResult](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structTrAnal_1_1CFDResult.md)
 ...
 top 
TrAnal::CFDResult< T > Member List

header
This is the complete list of members for [TrAnal::CFDResult< T >](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structTrAnal_1_1CFDResult.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| fraction | TrAnal::CFDResult< T > |  |
| trig | TrAnal::CFDResult< T > |  |
