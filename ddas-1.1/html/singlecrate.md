[← NSCL DDAS: Multi-crate System Setup Tutorial](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/simple_setup_multicrate.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/structCMyEndCommand_1_1EndEvent-members.md)
...
These files are described in the documentation of [readout](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/readout.md) . This section will summarize the files needed for nscope. By convention a directory subtree is used to hold the configuration files for each crate. The tree looks like this:
...
Note that the nscope program controls many more parameters of the DPP algorithm. See [nscope](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/nscope.md) for more information about what the nscope program can do.
...
- Set the FD Thres. (ADC) to be the LED threshold required to trigger the channel. I'm going to use 1000. In general this signal should be below the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) fraction of the smallest waveform you will take, because the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) zero crossing must occur after the LED is satisfied.


Apply the settings. Finally enable the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) by selecting `UV_Setup->CSRA` and setting the `CF` bit in all of the channels for which you are going to use the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md).
...
For full documentation of the Readout program, see [readout](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/readout.md)
...
For more information about the format of each of these see [Appendix - data format](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/singlecrate.md#dataformat)
...
This section describes the bit fields present in words of a DDAS event. This information is supplemental to the format information at: [Starting the NSCLDAQ dumper program.](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/singlecrate.md#ddas1_ss1_dumper)
...
- Note
  The interpretation of the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/html/classCFD.md) bits above pertain specifically to the 100 MSPS Pixie-16 digitizers at the NSCL. The meanings of the bits changes slightly when working with the 250 MSPS and 500 MSPS digitizers.
