...
These files are described in the documentation of [[readout|readout]] . This section will summarize the files needed for nscope. By convention a directory subtree is used to hold the configuration files for each crate. The tree looks like this:
...
For full documentation of the Readout program, see [[readout|readout]]
