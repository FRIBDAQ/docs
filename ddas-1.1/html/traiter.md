...
// ... more code ..
 ...
 fragment Finally, to clean up the code, some precompiled typedefs are provided if you include [[TraceDefs_8h_source]].


TraceS = [[classTrAnal_1_1TraceT]]
...
Also, all of the algorithms can be included by including the [[TraceAlgorithms_8h_source]] header.
...
using namespace [[namespaceTrAnal]];





[[classddaschannel]]* dch = new [[classddaschannel]];
...
[[classTrAnal_1_1TraceT]] trace(dch->[[classddaschannel#af76f3ae6d3113458bf1d39674dde9690]]());





[[classTrAnal_1_1TrRange]] range(trace.begin(), trace.end());





[[classTrAnal_1_1TrIterator]] it = Threshold(range, 20);
