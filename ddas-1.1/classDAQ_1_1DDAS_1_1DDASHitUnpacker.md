...
[[classDAQ_1_1DDAS_1_1DDASHitUnpacker-members]]
...
Parse the DDAS Readout event data.  
 [[classDAQ_1_1DDAS_1_1DDASHitUnpacker#details]]
...
Compute time in nanoseconds from raw data (no [[classCFD]] correction)


THis method is very similar to the [[classDAQ_1_1DDAS_1_1DDASHitUnpacker#a0adfc6514f3cfed2cb7bc22de5993f70]] method. It differs in that it doesn not apply a correction for the [[classCFD]] time. It simply forms the timestamp from the low and high bits and then converts it to a time in nanoseconds.
...
Like the [[classDAQ_1_1DDAS_1_1DDASHitUnpacker#abdd51a615520b0990923ace877ea467b]] method, this can be called repeatedly to append multiple values to the existing data.
...
The documentation for this class was generated from the following files:- format/[[DDASHitUnpacker_8h_source]]
