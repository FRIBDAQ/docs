...
[Friends](#friends) |
[[List of all members|classtinyxml2_1_1XMLText-members]]
...
A text node can have 2 ways to output the next. "normal" output and CDATA. It will default to the mode it was parsed from the XML file and you generally want to leave it alone, but you can change the output mode with [[SetCData()|classtinyxml2_1_1XMLText#ad080357d76ab7cc59d7651249949329d]] and query it with [[CData()|classtinyxml2_1_1XMLText#a125574fe49da80efbae1349f20d02d41]].
...
An example of using [[Accept()|classtinyxml2_1_1XMLText#ae659d4fc7351a7df11c111cbe1ade46f]]:
