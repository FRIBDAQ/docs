[← NSCL DDAS: DDAS::CrateReader Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1CrateReader.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: DDAS::CrateWriter Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1CrateWriter.md)
...
- **DDAS**
- [CrateWriter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1CrateWriter.md)

 top 
DDAS::CrateWriter Member List

header
This is the complete list of members for [DDAS::CrateWriter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1CrateWriter.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| CrateWriter(const Crate &settings) (defined inDDAS::CrateWriter) | DDAS::CrateWriter |  |
| endCrate(int id, const std::vector< unsigned short > &slots)=0 (defined inDDAS::CrateWriter) | DDAS::CrateWriter | pure virtual |
| getWriter(unsigned short slotNum)=0 (defined inDDAS::CrateWriter) | DDAS::CrateWriter | pure virtual |
| m_settings(defined inDDAS::CrateWriter) | DDAS::CrateWriter | protected |
| startCrate(int id, const std::vector< unsigned short > &slots)=0 (defined inDDAS::CrateWriter) | DDAS::CrateWriter | pure virtual |
