[← NSCL DDAS: DDAS::SetFileReader Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFileReader.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: DDAS::SetFileWriter Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFileWriter.md)
...
- **DDAS**
- [SetFileWriter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFileWriter.md)

 top 
DDAS::SetFileWriter Member List

header
This is the complete list of members for [DDAS::SetFileWriter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFileWriter.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| SetFileWriter(SetFileEditor &editor, unsigned short slot, unsigned short Mhz) | DDAS::SetFileWriter |  |
| write(const ModuleSettings &dspSettings) | DDAS::SetFileWriter | virtual |
| ~SetFileWriter() (defined inDDAS::SetFileWriter) | DDAS::SetFileWriter | inlinevirtual |
