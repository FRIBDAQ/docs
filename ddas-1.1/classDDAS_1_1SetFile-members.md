[← NSCL DDAS: DDAS::PixieSettingsReader Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1PixieSettingsReader.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: DDAS::SetFile Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFile.md)
...
- [SetFile](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFile.md)
 ...
 top 
DDAS::SetFile Member List

header
This is the complete list of members for [DDAS::SetFile](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFile.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| createVarNameMap(const VarOffsetArray &offsets) | DDAS::SetFile | static |
| createVarOffsetMap(const VarOffsetArray &offsets) | DDAS::SetFile | static |
| freeSetFile(uint32_t *pVars) | DDAS::SetFile | static |
| populateSetFileArray(unsigned nLongs, const uint32_t *pVars, const VarOffsetArray &map) | DDAS::SetFile | static |
| populateSetFileMap(unsigned nLong, const uint32_t *pVars, const VarOffsetArray &map) | DDAS::SetFile | static |
| populateSetFileMap(const UnpackedSetFile &vars) | DDAS::SetFile | static |
| readSetFile(const char *filename) | DDAS::SetFile | static |
| readVarFile(const char *filename) | DDAS::SetFile | static |
| writeSetFile(const char *filename, unsigned nLongs, uint32_t *pVars) | DDAS::SetFile | static |
