...
[[classDDAS_1_1XMLCrateReader-members]]
...
This class specializes the [[classDDAS_1_1CrateReader]] class to work with a set of XML specifications of the crate, modules and their settings. The top level is a crate xml file which is of the form
...
- Create an [[classDDAS_1_1XMLSettingsReader]] on the filename that's in the [[structDDAS_1_1XMLCrateReader_1_1SlotInformation]] struct for that slot. Parameters
  |  |  |
  | --- | --- |
  | slot | - slot number. |
  ReturnsSettingsReader* pointer to a dynamically created [[classDDAS_1_1XMLSettingsReader]]
...
The documentation for this class was generated from the following files:- xml/[[XMLCrateReader_8h_source]]
- xml/[[XMLCrateReader_8cpp]]
