...
class [[MyParameterMapper|classMyParameterMapper]] : public DAQ::DDAS::CParameterMapper
...
DAQ::DDAS::CDDASBuiltUnpacker Stage1( {0, 1, 2 }, *(new [[MyParameterMapper|classMyParameterMapper]](params)));

 fragment To round out our work on MySpecTclApp.cpp, you simply need to add some include directives to the top of the file. These will bring the [[MyParameters|structMyParameters]], [[MyParameterMapper|classMyParameterMapper]], DAQ::DDAS::CDDASBuiltUnpacker classes into scope. Add these lines to the top:
