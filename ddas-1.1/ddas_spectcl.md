[← NSCL DDAS: ddas_config.h Source File](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/ddas__config_8h_source.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: ddasdumper/ddaschannel.h Source File →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/ddaschannel_8h_source.md)
...
struct [ChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structChannelData.md) {
...
struct [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md) {





[ChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structChannelData.md)          chan[48];
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md)(std::string name);
...
class [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md);
...
class [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classMyParameterMapper.md) : public DAQ::DDAS::CParameterMapper
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md)& m_params;          // reference to the tree parameter structure
...
[MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classMyParameterMapper.md)([MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md)& params);
...
int computeGlobalIndex(const [DAQ::DDAS::DDASHit](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDAQ_1_1DDAS_1_1DDASHit.md)& hit);
...
m_params.chan[globalChanIdx].energy    = hit.[GetEnergy](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDAQ_1_1DDAS_1_1DDASHit.md#a123d68755f678cd1eec6f5320a39b629)();


m_params.chan[globalChanIdx].timestamp = hit.[GetTime](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDAQ_1_1DDAS_1_1DDASHit.md#a930e45be2c50eaf4a90988b0bd8c4a74)();
...
MyParameterMapper::MyParameterMapper([MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md)& params)
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md) params("raw");
...
DAQ::DDAS::CDDASBuiltUnpacker Stage1( {0, 1, 2 }, *(new [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classMyParameterMapper.md)(params)));

 fragment To round out our work on MySpecTclApp.cpp, you simply need to add some include directives to the top of the file. These will bring the [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md), [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classMyParameterMapper.md), DAQ::DDAS::CDDASBuiltUnpacker classes into scope. Add these lines to the top:
...
Add the [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md) and [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classMyParameterMapper.md) class to the build by adding MyParameters.o and MyParameterMapper.o to the OBJECTS variable. It should look like this when you are done:


OBJECTS=MySpecTclApp.o [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structMyParameters.md).o [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classMyParameterMapper.md).o

 fragment Next the compiler needs to be told where to find the DDASBuiltUnpacker.h file. Furthermore, the unpacker code uses C++ language and library elements from the 2011 version of the C++ standard so we need to enable the use of those by the compiler. That is done by adding to the USERCXXFLAGS so it looks like this:


USERCXXFLAGS=-[std](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/namespacestd.md)=c++11 -I/usr/opt/ddas/VERSION/include
...
![simple_1module_treegui.jpeg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/simple_1module_treegui.jpeg)
...
![simple_1module_spectrum.jpg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/simple_1module_spectrum.jpg)
