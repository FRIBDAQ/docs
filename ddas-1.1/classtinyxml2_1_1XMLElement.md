[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLHandle-members.md)
...
[Friends](#friends) |
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement-members.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.png)
...
An example of using [Accept()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a36d65438991a1e85096caf39ad13a099):
...
Given an attribute name, [Attribute()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a7bdebdf1888074087237f3dd03912740) returns the value for the attribute of that name, or null if none exists. For example:
...
Convenience function for easy access to the text inside an element. Although easy and concise, [GetText()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a56cc727044dad002b978256754d43a4b) is limited compared to getting the [XMLText](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLText.md) child and accessing it directly.


If the first child of 'this' is a [XMLText](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLText.md), the [GetText()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a56cc727044dad002b978256754d43a4b) returns the character string of the Text node, else null is returned.
...
[GetText()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a56cc727044dad002b978256754d43a4b) will return "This is ".
...
Given an attribute name, [IntAttribute()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a1e0b2ebd4ae63ae207f84531c20cfa87) returns the value of the attribute interpreted as an integer. The default value will be returned if the attribute isn't present, or if there is an error. (For a method with error checking, see [QueryIntAttribute()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a8b92c729346aa8ea9acd59ed3e9f2378)).
...
Given an attribute name, [QueryAttribute()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a3c6ca41fb1b6023b58ff4414c8eae2c0) returns XML_SUCCESS, XML_WRONG_ATTRIBUTE_TYPE if the conversion can't be performed, or XML_NO_ATTRIBUTE if the attribute doesn't exist. It is overloaded for the primitive types, and is a generally more convenient replacement of [QueryIntAttribute()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a8b92c729346aa8ea9acd59ed3e9f2378) and related functions.
...
Given an attribute name, [QueryIntAttribute()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a8b92c729346aa8ea9acd59ed3e9f2378) returns XML_SUCCESS, XML_WRONG_ATTRIBUTE_TYPE if the conversion can't be performed, or XML_NO_ATTRIBUTE if the attribute doesn't exist. If successful, the result of the conversion will be written to 'value'. If not successful, nothing will be written to 'value'. This allows you to provide default value:
...
The [QueryIntText()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a71327c9a9d8840562bd204f46d0a7189) and similar functions provide a safe and easier way to get to the "value" of x and y.
...
Convenience function for easy access to the text inside an element. Although easy and concise, [SetText()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a1f9c2cd61b72af5ae708d37b7ad283ce) is limited compared to creating an [XMLText](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLText.md) child and mutating it directly.


If the first child of 'this' is a [XMLText](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLText.md), [SetText()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a1f9c2cd61b72af5ae708d37b7ad283ce) sets its value to the given string, otherwise it will create a first child that is an [XMLText](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLText.md).
...
[SetText()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classtinyxml2_1_1XMLElement.md#a1f9c2cd61b72af5ae708d37b7ad283ce) will generate
