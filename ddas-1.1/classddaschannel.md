[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschanneltest-members.md)
...
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel-members.md)
...
Encapsulation of a generic DDAS event.  
 [More...](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel.md#details)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel.png)
...
- See also
  [UnpackChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel.md#a55ada0749d06cdf03c03caff15604269)) that should be used to fill the item with data. It is encouraged to construct complete events from raw data using it. For example,

[ddaschannel](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel.md) channel;


channel.[UnpackChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel.md#a55ada0749d06cdf03c03caff15604269)( pDataBuffer );
...
- **[Deprecated:](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/deprecated.md#_deprecated000004)**
...
Note that this only really makes sense to be used if the object was filled with data using [UnpackChannelData()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel.md#a55ada0749d06cdf03c03caff15604269).
...
- **[Deprecated:](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/deprecated.md#_deprecated000005)**
...
While it parses, it stores the results into the data members of the object. Prior to parsing, all data members are reset to 0 using the [Reset()](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classddaschannel.md#ac775d0c5571d515b612d4b116c183451) method.
...
- **[Deprecated:](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/deprecated.md#_deprecated000001)**
...
- **[Deprecated:](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/deprecated.md#_deprecated000002)**
...
- **[Deprecated:](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/deprecated.md#_deprecated000003)**



---

The documentation for this class was generated from the following files:- ddasdumper/[ddaschannel.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/ddaschannel_8h_source.md)
