...
The data format is described in detail in the [[dir_936f9f2cb541c58938765a02eba41f87]] section. However, the interpretation of the [[classCFD]] time is unique to each module. The 3rd data word in the event header contains the [[classCFD]] time in its most significant 16 bits. The bits have the following meaning:
