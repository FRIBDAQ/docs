...
Now we need to associate an object with the branch we care about. Because the "ddasevent" branch is filled with [[classDDASEvent]] object, we need to create a [[classDDASEvent]] object and associate it with the branch. In code, that is done by:
