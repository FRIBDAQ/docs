[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classRootConverter2-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classScopedT-members.md)
...
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classRootConverter2-members.md)


RootConverter2 Class Reference

header
[Converter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classConverter.md) for data formats : NSCLDAQ 10.2-00x.  
 [More...](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classRootConverter2.md#details)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classRootConverter2.png)
...
The [RootConverter2](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classRootConverter2.md) object creates a branch in the tree referenced by Converter::m_treepointer named ddasevent. It holds the [DDASEvent](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDASEvent.md) objects produced by every call to the [RootConverter2::DumpData(const CRingItem&)](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classRootConverter2.md#a8b5461e30739b427669f7aa1942614af) method. [DDASEvent](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDASEvent.md) objects are really arrays of individual ddaschannel objects.
...
Default constructor Constructs the [DDASEvent](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDASEvent.md) object.
...
Implements [Converter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classConverter.md#a9ff35398f215af687593e4785f3ecf19).
...
Adds ddasevent branch to tree and associates it with local [DDASEvent](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDASEvent.md) object.


First calls the [Converter::Initialize(std::string,std::string)](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classConverter.md#a7bc5c097d0bc9b7e1afdeffb18644cc1) method to create the output file and the tree, then adds the ddasevent branch to the tree. This branch holds the [DDASEvent](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDASEvent.md) objects produced by the [DumpData(const CRingItem&)](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classRootConverter2.md#a8b5461e30739b427669f7aa1942614af) method.
...
Reimplemented from [Converter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classConverter.md#a7bc5c097d0bc9b7e1afdeffb18644cc1).



---

The documentation for this class was generated from the following files:- ddasdumper/[RootConverter2.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/RootConverter2_8h_source.md)
