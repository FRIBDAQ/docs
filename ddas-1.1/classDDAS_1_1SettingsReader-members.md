[← NSCL DDAS: DDAS::SetFileWriter Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SetFileWriter.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: DDAS::SettingsReader Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SettingsReader.md)
...
- [SettingsReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SettingsReader.md)
 ...
 top 
DDAS::SettingsReader Member List

header
This is the complete list of members for [DDAS::SettingsReader](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDAS_1_1SettingsReader.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| get()=0 (defined inDDAS::SettingsReader) | DDAS::SettingsReader | pure virtual |
