...
- Remarks
  ...
  - The meaning of the [CFD](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classCFD.md) bits depend on the type of the Pixie-16 digitizer used. See the page on each module for details about the data it outputs.
