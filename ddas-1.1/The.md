[← NSCL DDAS: nscope/Tau.h Source File](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/Tau_8h_source.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: $title →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/The_01cfgPixie16_8txt_01file.md)
...
Now we need to associate an object with the branch we care about. Because the "ddasevent" branch is filled with [DDASEvent](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDASEvent.md) object, we need to create a [DDASEvent](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/classDDASEvent.md) object and associate it with the branch. In code, that is done by:
