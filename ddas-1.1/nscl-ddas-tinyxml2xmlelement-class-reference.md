...
[Friends](#friends) |
[[classtinyxml2_1_1XMLElement-members]]
...
Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every node in the XML tree will be conditionally visited and the host will be called back via the [[classtinyxml2_1_1XMLVisitor]] interface.
...
An example of using [[classtinyxml2_1_1XMLElement#a36d65438991a1e85096caf39ad13a099]]:
...
Implements [[classtinyxml2_1_1XMLNode#a81e66df0a44c67a7af17f3b77a152785]].
...
Given an attribute name, [[classtinyxml2_1_1XMLElement#a7bdebdf1888074087237f3dd03912740]] returns the value for the attribute of that name, or null if none exists. For example:
...
Convenience function for easy access to the text inside an element. Although easy and concise, [[classtinyxml2_1_1XMLElement#a56cc727044dad002b978256754d43a4b]] is limited compared to getting the [[classtinyxml2_1_1XMLText]] child and accessing it directly.


If the first child of 'this' is a [[classtinyxml2_1_1XMLText]], the [[classtinyxml2_1_1XMLElement#a56cc727044dad002b978256754d43a4b]] returns the character string of the Text node, else null is returned.
...
[[classtinyxml2_1_1XMLElement#a56cc727044dad002b978256754d43a4b]] will return "This is ".
...
Given an attribute name, [[classtinyxml2_1_1XMLElement#a1e0b2ebd4ae63ae207f84531c20cfa87]] returns the value of the attribute interpreted as an integer. The default value will be returned if the attribute isn't present, or if there is an error. (For a method with error checking, see [[classtinyxml2_1_1XMLElement#a8b92c729346aa8ea9acd59ed3e9f2378]]).
...
Given an attribute name, [[classtinyxml2_1_1XMLElement#a3c6ca41fb1b6023b58ff4414c8eae2c0]] returns XML_SUCCESS, XML_WRONG_ATTRIBUTE_TYPE if the conversion can't be performed, or XML_NO_ATTRIBUTE if the attribute doesn't exist. It is overloaded for the primitive types, and is a generally more convenient replacement of [[classtinyxml2_1_1XMLElement#a8b92c729346aa8ea9acd59ed3e9f2378]] and related functions.
...
The [[classtinyxml2_1_1XMLElement#a71327c9a9d8840562bd204f46d0a7189]] and similar functions provide a safe and easier way to get to the "value" of x and y.
...
Convenience function for easy access to the text inside an element. Although easy and concise, [[classtinyxml2_1_1XMLElement#a1f9c2cd61b72af5ae708d37b7ad283ce]] is limited compared to creating an [[classtinyxml2_1_1XMLText]] child and mutating it directly.


If the first child of 'this' is a [[classtinyxml2_1_1XMLText]], [[classtinyxml2_1_1XMLElement#a1f9c2cd61b72af5ae708d37b7ad283ce]] sets its value to the given string, otherwise it will create a first child that is an [[classtinyxml2_1_1XMLText]].
...
[[classtinyxml2_1_1XMLElement#a1f9c2cd61b72af5ae708d37b7ad283ce]] will generate
...
Make a copy of this node, but not its children. You may pass in a Document pointer that will be the owner of the new Node. If the 'document' is null, then the node returned will be allocated from the current Document. (this->[[classtinyxml2_1_1XMLNode#af343d1ef0b45c0020e62d784d7e67a68]])


Note: if called on a [[classtinyxml2_1_1XMLDocument]], this will return null.


Implements [[classtinyxml2_1_1XMLNode#a8402cbd3129d20e9e6024bbcc0531283]].
...
[[namespaceTest]] if 2 nodes are the same, but don't test children. The 2 nodes do not need to be in the same Document.


Note: if called on a [[classtinyxml2_1_1XMLDocument]], this will return false.


Implements [[classtinyxml2_1_1XMLNode#a7ce18b751c3ea09eac292dca264f9226]].
