...
- [Crate](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structDDAS_1_1Crate.md)
 ...
 top 
DDAS::Crate Member List

header
This is the complete list of members for [DDAS::Crate](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.1/structDDAS_1_1Crate.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| s_crateId(defined inDDAS::Crate) | DDAS::Crate |  |
| s_slots(defined inDDAS::Crate) | DDAS::Crate |  |
