...
[← Providing EPICS channel information to Tcl Servers](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c7460.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Epics Channel logging →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c7517.md)
...
The epicsdisplay utility provides a tabular
    ...
    available at the [epicsdisplay
      reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r15733.md)

epicsdisplay reads in a configuration file.
    The configuration file is compatible with [the controlpush](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r12943.md) application,
