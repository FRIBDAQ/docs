...
<a name="AEN24537"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24540"></a>## Synopsis
...
<a name="AEN24766"></a>## Public member functions





<a name="AEN24772"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24834"></a>`unsigned long getBase(void);`
...
<a name="AEN24845"></a>`int getSerial(void);`
...
<a name="AEN24876"></a>`int  getFirmware(void);`
...
<a name="AEN24886"></a>`int  getCrate(void);`
...
<a name="AEN24897"></a>`void setCrate(int crateNum);`
...
<a name="AEN24910"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24931"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24941"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24951"></a>`void keepOverflowData(void);`
...
<a name="AEN24961"></a>`void discardOverflowData(void);`
...
<a name="AEN24971"></a>`void keepInvalidData(void);`
...
<a name="AEN24982"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN24993"></a>`void commonStart(void);`
...
<a name="AEN25004"></a>`void commonStop(void);`
...
<a name="AEN25015"></a>`void setRange(int range);`
...
<a name="AEN25028"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25100"></a>`void clearData
                                (void);`
...
<a name="AEN25143"></a>`bool Busy(void);`
...
<a name="AEN25154"></a>` bool gBusy(void);`
...
<a name="AEN25165"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25176"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25187"></a>`int readEvent(void* buf);`
...
<a name="AEN25200"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25241"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25304"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25308"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25312"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25316"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25320"></a>**Example 3. Reading out a CAEN 785 e.g.**
