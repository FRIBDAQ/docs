...
[← The Ring Buffer](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c43.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ScalerDisplay →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c4573.md)
...
The client programs that submit data to the server are built using the
      [event builder client
        framework](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c10307.md). In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [ringFragmentSource](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10573.md) program. This
