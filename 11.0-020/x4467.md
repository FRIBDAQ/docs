...
[← Remote control package](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4431.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [More detail on when the fragments are ouptutted →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4487.md)
...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c10666.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r51878.md).
...
The next thing that you need to do register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10573.md).
