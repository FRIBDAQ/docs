...
[← Data Transfer and Flow Control](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x80.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Selecting Data From a Ring Buffer →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x8371.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x800.md#vmusb.config.create)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x800.md#vmusb.config.config)
...
Configuration files must also specify at least one stack and, if
        ...
        See the [stack(3vmusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r58753.md) command
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x800.md#vmusb.config.sis3820)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x800.md#vmusb.config.sclrStack)
...
If the device support provided by VMUSBReadout
      ...
      be found in [*Extending the Supported Readout Hardware*](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x1137.md).
