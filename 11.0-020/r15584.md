...
[← vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r15556.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cratelocator →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r15600.md)
...
This  command  runs the vhq control program.   config are configuration files described by
        [vhqconfig(5)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r74286.md)
