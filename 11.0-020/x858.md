...
[← Creating ring items](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x8522.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the event builder client library →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x8650.md)
...
If a user wants to write their own module for the slow-controls subsystem,
      ...
      [*Extending the slow controls subsystem*](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x1550.md).
...
There are numerous slow-controls modules availabe for use with the
        Module command (see [Module(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r65753.md)). Because of its
...
- `CVMUSBReadoutList`
  Instances of this class represent lists of VME operations you want
                to perform via the server.  See [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r60873.md) for reference
                information.
- `CVMUSBRemote`
  ...
  See [*CVMUSBRemote*](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r61768.md)
