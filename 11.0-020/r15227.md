...
[← DaqPortManager](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r15116.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [serverauth →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r15270.md)
...
<a name="AEN15231"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN15234"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN15241"></a>## DESCRIPTION
