...
[← bells](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r52409.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQParameters →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r52625.md)
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r54071.md) package for that
            instead.
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r54071.md) is a better
                          choice).
