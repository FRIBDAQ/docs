...
[← CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r41517.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r42460.md)
...
<a name="AEN42340"></a>## Public member functions
...
<a name="AEN42451"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN42456"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r41517.md)
