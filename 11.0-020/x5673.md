...
[[![(1)](../images/callouts/1.gif)|x5673#v775_rawheader_config]]                            SpecTcl's config.h header
...
[[![(3)](../images/callouts/3.gif)|x5673#v775_rawheader_tparam]]                            The tree paramter package is a useful package that
                            ...
                            its shape.
                        [[![(2)](../images/callouts/2.gif)|x5673#v775_rawheader_evpbase]]                            The EventProcessor.h header
                        ...
                        [[![(5)](../images/callouts/5.gif)|x5673#v775_rawheader_rawconstruct]]                           Our constructor needs to be declared because it
                           ...
                           parameters.
                        [[![(6)](../images/callouts/6.gif)|x5673#v775_rawheader_rawfunctor]]                            The function call operator is invoked for each event.
                         ...
                         [[![(7)](../images/callouts/7.gif)|x5673#v775_rawheader_times]]                            This reference to a tree parameter array will
...
[[![(1)](../images/callouts/1.gif)|x5673#v775_rawimpl_constructor]]                            The constructor is required to initialize the reference
                            ...
                            t.00 ... t.31.
                        [[![(2)](../images/callouts/2.gif)|x5673#v775_rawimpl_destructor]]                            If an object is ever destroyed, its tree parameter
...
[[![(1)](../images/callouts/1.gif)|x5673#v775_rawimpl_funtorsignature]]                            The `operator()` method
...
[[![(2)](../images/callouts/2.gif)|x5673#v775_rawimpl_tp]]                            SpecTcl and NSCLDAQ can run on systems of any
...
[[![(3)](../images/callouts/3.gif)|x5673#v775_rawimpl_tclanalyzer]]                            SpecTcl's actual defautl analyzer is a
                            `TcAnalyzer` object.
...
[[![(4)](../images/callouts/4.gif)|x5673#v775_rawimpl_setsize]]                            This section of code pulls the first 32 bit item
...
[[![(5)](../images/callouts/5.gif)|x5673#v775_rawimpl_headerprocessing]]                            Immediately following the event we should see the
...
[[![(6)](../images/callouts/6.gif)|x5673#v775_rawimpl_channelloop]]                            This loop unpackes the channel data in the TDC.
                        [[![(7)](../images/callouts/7.gif)|x5673#v775_rawimp_chanproc]]                            The loop first asserts that the items that should
...
[[![(8)](../images/callouts/8.gif)|x5673#v775_rawimpl_storeparam]]                            Tree parameter array objects mimic arrays to the
                        ...
                        [[![(9)](../images/callouts/9.gif)|x5673#v775_rawimple_trailer]]                            The data words from the TDC should be followed by
