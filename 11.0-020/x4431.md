...
[← Customizing the ReadoutShell](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4041.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the event builder →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4467.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4431.md#remote_control_package)
  The remote control software is an optional component.
              This line incorporates that component into the ReadoutGUI
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4431.md#remote_control_initialize)
