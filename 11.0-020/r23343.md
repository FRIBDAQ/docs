...
<a name="AEN23347"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN23350"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN23380"></a>## DESCRIPTION
...
<a name="AEN23442"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
| --- | --- | --- |
| Prev | Home | Next |
| CDataSinkFactory | Up | CEVBClientFramework |
