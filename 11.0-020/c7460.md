...
[← VMUSBReadout](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c744.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The epics display utility →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c7498.md)
...
controlpush
      ...
      [the controlpush manpage](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r12943.md).

The intent is that 
      controlpush be pointed at a 
      TclServer.
[The TclServer](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c6979.md)
...
You can use 
      ...
      system parameters. 
      [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c7498.md) is an example
