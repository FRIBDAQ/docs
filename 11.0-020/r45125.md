...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r45014.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r47879.md)
...
<a name="AEN45129"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45132"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46114"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r48344.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r48344.md) for
...
<a name="AEN46685"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46689"></a>### Action Register
...
<a name="AEN46732"></a>### Firmware Register
...
<a name="AEN46784"></a>### Global Mode Register
...
<a name="AEN46917"></a>### Delay Register
...
<a name="AEN46950"></a>### Scaler Control register
...
<a name="AEN46983"></a>### LED Source Register
...
<a name="AEN47235"></a>### Output source selection register.
...
<a name="AEN47404"></a>### Device source register
...
<a name="AEN47757"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47818"></a>### Transfer setup register
