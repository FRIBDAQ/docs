...
[← EZBuilder](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10686.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Obtaining and building the skeleton application →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x11131.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10690.md#evbbundle.require)
  Incorporates the package code into your script.  This makes
                      all three APIs visible and accessible from your script.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10690.md#evbbundle.onstart)
  The `OnStart` is called from the
                      ...
                      user interface.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10690.md#evbbundle.register)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10690.md#evbbundle.configure)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10690.md#evbbundle.startsources)
  When the event builder is started, if you define a proc named
                      ...
                      event builder.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x10690.md#evbbundle.startringsource)
