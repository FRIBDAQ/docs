...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4041.md#custom_readoutgui_pkgdir)
  This line and the next add the NSCLDAQ Tcl library
                          directory tree to the search path used by
                          **package require**.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4041.md#custom_readoutgui_instance)
  ...
  The line itself creates an instance of the class named
                          ...
                          sourcing it.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x4041.md#custom_readoutgui_extend)
