...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r24525.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r25696.md)
...
<a name="AEN25457"></a>## Public member functions





- <a name="AEN25463"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25475"></a>`bool Xtest(void);const`
...
- <a name="AEN25487"></a>`bool Qtest(void);const`
...
- <a name="AEN25504"></a>`bool TimedOut(void);const`
...
- <a name="AEN25516"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25528"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25542"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25555"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25569"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25584"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25599"></a>`bool IT4(void);const`
...
- <a name="AEN25613"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25624"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25637"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25653"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25664"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25675"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25685"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25689"></a>**Example 1. Initializing branch 0**
