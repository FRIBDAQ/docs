...
[← The VMUSBSpecTcl Alternative](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x5290.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Conclusion →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/x5326.md)
...
1. In the middle of the window on the left, there is a text entry for a
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/figures/treegui_1d_0.png)
...
2. Next we need to give our histogram a name. Lacking any sense of
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/figures/treegui_1d_1.png)
3. To actually create the histogram, you need to press the
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/figures/treegui_1d_2.png)
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/figures/treegui_connect.png)
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/figures/xamine_0.png)
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/figures/xamine_1.png)
