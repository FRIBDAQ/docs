...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c6859.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/c6949.md)
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0-020/r12568.md).
...
<a name="AEN6899"></a>**Example 19-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN6903"></a>**Example 19-2. Dumping data from the event file segment
...
# <a name="AEN6913"></a>19.1. Item dump formats and examples
...
<a name="AEN6916"></a>**Example 19-3. State Transition items**
...
<a name="AEN6921"></a>**Example 19-4. Text List items**
...
<a name="AEN6926"></a>**Example 19-5. Incremental Scalers dump**
...
<a name="AEN6932"></a>**Example 19-6. Event count items**
...
<a name="AEN6938"></a>**Example 19-7. Physics Event items**
...
<a name="AEN6943"></a>**Example 19-8. Unknown item types**
