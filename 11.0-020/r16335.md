...
<a name="AEN16346"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16349"></a>## Synopsis
...
<a name="AEN16425"></a>## Public member functions
...
<a name="AEN16516"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16520"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16524"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
