[← FRIBParallelanalysis: paramfileformat](https://github.com/FRIBDAQ/docs/tree/main/apipeline/md_pages_paramfileformat.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [FRIBParallelanalysis: paramparamcompileandrun →](https://github.com/FRIBDAQ/docs/tree/main/apipeline/md_pages_paramparamcompileandrun.md)
...
In this example we will use the sample worker we showed in [Sample Worker.](https://github.com/FRIBDAQ/docs/tree/main/apipeline/md_pages_paramparamworker.md#paramparamworkerexample) We'll assume the header for this worker is in `MyWorker.h`
