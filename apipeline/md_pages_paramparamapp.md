...
In this example we will use the sample worker we showed in [[md_pages_paramparamworker#paramparamworkerexample]] We'll assume the header for this worker is in `MyWorker.h`
