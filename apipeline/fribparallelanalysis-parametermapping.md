...
If you like, you can makee use of the [[classfrib_1_1analysis_1_1CTCLParameterReader]] which allows you to use Tcl formatted output files that are descrbed in [[md_pages_paramfileformat#paramfileformat]]
