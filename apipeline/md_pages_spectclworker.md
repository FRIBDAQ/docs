[← FRIBParallelanalysis: rawtoparameters](https://github.com/FRIBDAQ/docs/tree/main/apipeline/md_pages_rawtoparameters.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [FRIBParallelanalysis: tcldeffile →](https://github.com/FRIBDAQ/docs/tree/main/apipeline/md_pages_tcldeffile.md)
...
2. Pulls the definitions of the FRIB Analysiys code from the `frib::analysis` namespace into the default name resolution space. Thus e.g. [frib::analysis::CEvent](https://github.com/FRIBDAQ/docs/tree/main/apipeline/classfrib_1_1analysis_1_1CEvent.md) can be referred to as `CEvent`.
...
Much of the work described here is the same as for [Writing the Raw to parameter worker.](https://github.com/FRIBDAQ/docs/tree/main/apipeline/md_pages_rawtoparameters.md#rawtoparamworker) The only difference is that we need to use a SpecTclWorker, instantiate one or more eventprocessors, and add them to that worker to set up the analysis pipeline. That's done as follows:
