...
If you like, you can makee use of the [[frib::analysis::CTCLParameterReader|classfrib_1_1analysis_1_1CTCLParameterReader]] which allows you to use Tcl formatted output files that are descrbed in [[Parameter file format.|md_pages_paramfileformat#paramfileformat]]
