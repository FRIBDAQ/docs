...
<a name="AEN14695"></a>## OPTIONS



`-title`Provides a title for the entire widget.

`-lefttitle`Provides a title for the left column of the widget
                        pair.

`-righttitle`Provides a title for the right column of the widget.

`-create`Provides a callback script that is called when a new
...
`-update`Provides a callback script that is called when a
...
`-destroy`Provides an optional script that is called just
...
| --- | --- | --- |
| Prev | Home | Next |
| ::EVB::utility::sortedPair | Up | EventBuilder |
