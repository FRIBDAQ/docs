...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [[r55809]] to create the ring
             sources.
...
| --- | --- | --- |
| Prev | Home | Next |
| EVBC::configParams | Up | Event builder client framework |
