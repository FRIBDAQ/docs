...
[← EVBC::configParams](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r56148.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client framework →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r56218.md)
...
The `useEventBuilder` command exported by the
            ...
            [*EVBC::initialize*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r55985.md)
...
The `startEVBSources` proc is hook that you can
             ...
             way to start your ring sources. Rather, you should use [*EVBC::registerRingSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r55809.md) to create the ring
             sources.
