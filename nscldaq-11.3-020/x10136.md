...
| Prev | Chapter 53. Shared memory | Next |


---

# <a name="shm_compile"></a>53.2. Compiling/Linking your software with the shared memory API
...
<a name="AEN10147"></a>**Example 53-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN10151"></a>**Example 53-3. Linking C++ object files that use the
            daqshm library**
