...
[← Pushing external data into the event stream](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2311.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing device support software →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2442.md)
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48113.md) command
