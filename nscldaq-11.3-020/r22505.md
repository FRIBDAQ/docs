...
<a name="AEN22519"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN22522"></a>## Synopsis
...
<a name="AEN22524"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN22535"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN22569"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN22589"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN22635"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN22641"></a>`pGlomParameters
...
<a name="AEN22655"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN22675"></a>`pEventBuilderFragment
...
<a name="AEN22695"></a>` pPhysicsEventItem
...
<a name="AEN22715"></a>` pPhysicsEventCountItem
...
<a name="AEN22808"></a>` pStateChangeItem
...
<a name="AEN22840"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22848"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22854"></a>## DESCRIPTION
...
<a name="AEN22862"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN22883"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN22938"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN22974"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN23067"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN23083"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN23110"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23142"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23168"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23197"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23345"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN23397"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN23408"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
