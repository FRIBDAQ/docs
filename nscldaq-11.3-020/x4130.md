...
[← The event logger and ReadoutShell](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4096.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Remote control package →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4520.md)
...
Besides automatically sourcing the ReadoutCallouts.tcl
                ...
                **proc**s from the packages described in
                [*ReadoutGUI API packages*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4130.md#readoutshell_api_packages).
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4130.md#custom_readoutgui_pkgdir)
  This line and the next add the NSCLDAQ Tcl library
                          directory tree to the search path used by
                          **package require**.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4130.md#custom_readoutgui_instance)
  ...
  The line itself creates an instance of the class named
                          ...
                          sourcing it.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4130.md#custom_readoutgui_extend)
  Once the `ReadoutGuiApp` application
                          ...
                          [*ReadoutGUI API packages*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4130.md#readoutshell_api_packages) which
