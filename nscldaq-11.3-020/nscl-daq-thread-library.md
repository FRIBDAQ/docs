...
# <a name="chapter.threads"></a>Chapter 50. NSCL DAQ Thread Library
...
# <a name="AEN9624"></a>50.1. The thread and synchronization model
...
<a name="AEN9637"></a>**Example 50-1. The life of a thread**
...
<a name="AEN9669"></a>**Example 50-2. Why synchonization is needed**
...
<a name="AEN9693"></a>**Example 50-3. Using `SyncGuard` to implement a monitor**
...
[[c9614#chapter.thread.synchronizable]]                    This member is the synchronization element.  We will see
                    it used in the
                    `increment`
                    member.
                [[c9614#chapter.thread.enter]]                    The
                    `sync_begin()`
