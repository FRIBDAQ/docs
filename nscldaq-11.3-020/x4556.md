...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [[developer documentation|c10951]] as well
      in the [[man pages|r55662]].
...
The next thing that you need to do is register clients
      ...
      of how to create one at the [[ringFragmentSource documentation|x10858]].
