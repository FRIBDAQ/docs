...
[← Sequencing runs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c7339.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VMUSBReadout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c746.md)
...
The ringselector application is very
        ...
        [ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r12130.md)
        application.  Both
...
For a complete reference on the command see the
        [ringselector reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r13004.md).
