...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r25002]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r25002]].
...
[[portAllocator(3tcl)|r69983]],
            [[CPortManagerException(3daq)|r25002]],
            [[DaqPortManager(1tcl)|r15655]]
