...
[[![(1)](../images/callouts/1.gif)|x1203#vmusb-dtemplate-saveconfig]]                        The method is passed a reference to its instance
...
[[![(2)](../images/callouts/2.gif)|x1203#vmusb-dtemplate-baseparam]]                        Most if not all VME modules must be addressed relative
                        ...
                        imposed.
                    [[![(3)](../images/callouts/3.gif)|x1203#vmusb-dtemplate-idparam]]                        Since the template driver inserts a marker
...
Constraint checking comes from the
                        ...
                        See [[CConfigurableObject(3vmusb)|r64727]]
...
See [[CVMUSB(3vmusb)|r60583]] and
                [[*CVMUSBReadoutList*|r62585]] for reference
...
[[![(1)](../images/callouts/1.gif)|x1203#vmusb-dtemplate-ccall]]                        The Tcl **load** command will be
...
[[![(2)](../images/callouts/2.gif)|x1203#vmusb-dtemplate-initname]]                        As described above, the initialization function
                    ...
                    [[![(3)](../images/callouts/3.gif)|x1203#vmusb-dtemplate-package]]                        This line also allows you to use the
...
[[![(4)](../images/callouts/4.gif)|x1203#vmusb-dtemplate-adddriver]]                        This line associates the tcl command
                        **changeme** with the
...
[[![(5)](../images/callouts/5.gif)|x1203#vmusb-dtemplate-initsuccess]]                        The **load** or
                    ...
                    [[![(6)](../images/callouts/6.gif)|x1203#vmusb-dtemplate-endccall]]                        Ends the extern "C" {  block.
...
[[![(1)](../images/callouts/1.gif)|x1203#vmusb-itcldrv-auto-path]]                        In order to locate the SWIG wrappers of the
                        `CVMUSB` and
...
[[![(6)](../images/callouts/6.gif)|x1203#vmusb-itcldrv-option]]                        C++ device support modules provide a set of
...
[[![(7)](../images/callouts/7.gif)|x1203#vmusb-itcldrv-constructor]]                        Constructor methods are analagous to C++ constructors.
...
[[![(8)](../images/callouts/8.gif)|x1203#vmusb-itcldrv-initialize]] `Initialize` implements
                        ...
                        *pointer* that represents the address
                        ...
                        driver methods.
                    [[![(9)](../images/callouts/9.gif)|x1203#vmusb-itcldrv-wrapvmusb]]                        This linexcomp contructs a SWIG wrapping of a
                        `CVMUSB` object.  The
                    ...
                    [[![(10)](../images/callouts/10.gif)|x1203#vmusb-itcldrv-vmusbreadled]]                        Invokes the `readLEDSource`
                    ...
                    [[**(12)**|x1203#vmusb-itcldrv-addrdolist]]                        The `addReadoutList` method
...
[[![(1)](../images/callouts/1.gif)|x1203#vmusb-snit-apath]]                        In order to load the packages that wrap the
                        `CVMUSB` and
...
[[![(6)](../images/callouts/6.gif)|x1203#vmusb-snit-option]]                        Snit objects all have a built in
...
[[![(7)](../images/callouts/7.gif)|x1203#vmusb-snit-constructor]] **constructor** methods are called
...
[[![(8)](../images/callouts/8.gif)|x1203#vmusb-snit-init]]                        The `Initialize` method
