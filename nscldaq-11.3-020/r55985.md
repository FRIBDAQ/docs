...
[← EVBC::startS800Source](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r55955.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onBegin →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r56095.md)
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r55664.md).

<a name="AEN56014"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r55664.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r56095.md)).
...
- `-glomtspolicy` *earliest | latest | average*
  The timestamp assigned to the built physics event
                            ...
                            timestamps.
- `-destring` *ring_name*
  The value passed to `-destring` is the
...
- `-setdestringasevtlogsource` *yes | no*
  If the value passed is yes, then the eventlog program
