...
[← Providing EPICS channel information to Tcl Servers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c7615.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Epics Channel logging →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c7672.md)
...
The epicsdisplay utility provides a tabular
    ...
    available at the [epicsdisplay
      reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r16330.md)

epicsdisplay reads in a configuration file.
    The configuration file is compatible with [the controlpush](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r13250.md) application,
