...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48781.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r51666.md)
...
<a name="AEN48916"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN48919"></a>## Synopsis

```
CCCUSB
```

<a name="AEN49901"></a>## DESCRIPTION
...
- ` bool isInhibited();
`
  Reads the state of the dataway I line (inhibit).
  			    This is only
                              meaningful if the firmware version is greater than
  			    0x8e000601. Otherwise,
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r52151.md))
...
`
  THIS IS A PURELY VIRTUAL METHOD. See CCUSBusb and
  			    CCCUSBRemote classes for
                              implementation.
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r52151.md) for
...
<a name="AEN50472"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN50476"></a>### Action Register
...
<a name="AEN50519"></a>### Firmware Register
...
<a name="AEN50571"></a>### Global Mode Register
...
<a name="AEN50704"></a>### Delay Register
...
<a name="AEN50737"></a>### Scaler Control register
...
<a name="AEN50770"></a>### LED Source Register
...
<a name="AEN51022"></a>### Output source selection register.
...
<a name="AEN51191"></a>### Device source register
...
<a name="AEN51544"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN51605"></a>### Transfer setup register
