...
[← CCrateController](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r31354.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3820 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r32173.md)
...
<a name="AEN31866"></a>## Public member functions
...
- <a name="AEN31889"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN31899"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN31910"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN31921"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN31933"></a>` void SetLatchMode(void);const`
...
- <a name="AEN31945"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN31980"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN32049"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN32060"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN32071"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN32082"></a>` void Clock(void);const`
...
- <a name="AEN32093"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN32104"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN32115"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN32127"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN32138"></a>` unsigned long Read(void);const`
...
- <a name="AEN32150"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
