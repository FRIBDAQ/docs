...
<a name="AEN25644"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN25647"></a>## Synopsis
...
<a name="AEN25873"></a>## Public member functions





<a name="AEN25879"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN25941"></a>`unsigned long getBase(void);`
...
<a name="AEN25952"></a>`int getSerial(void);`
...
<a name="AEN25983"></a>`int  getFirmware(void);`
...
<a name="AEN25993"></a>`int  getCrate(void);`
...
<a name="AEN26004"></a>`void setCrate(int crateNum);`
...
<a name="AEN26017"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN26038"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN26048"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN26058"></a>`void keepOverflowData(void);`
...
<a name="AEN26068"></a>`void discardOverflowData(void);`
...
<a name="AEN26078"></a>`void keepInvalidData(void);`
...
<a name="AEN26089"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN26100"></a>`void commonStart(void);`
...
<a name="AEN26111"></a>`void commonStop(void);`
...
<a name="AEN26122"></a>`void setRange(int range);`
...
<a name="AEN26135"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN26207"></a>`void clearData
                                (void);`
...
<a name="AEN26250"></a>`bool Busy(void);`
...
<a name="AEN26261"></a>` bool gBusy(void);`
...
<a name="AEN26272"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN26283"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN26294"></a>`int readEvent(void* buf);`
...
<a name="AEN26307"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN26348"></a>`void enableSmallThresholds(void);`
...
<a name="AEN26411"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN26415"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN26419"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN26423"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN26427"></a>**Example 3. Reading out a CAEN 785 e.g.**
