...
[← Event builder Readout Callouts](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c10951.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCLDAQ Data Format : The Ring Item →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c185.md)
...
- size_t `read`(
  ...
  The base class, `CEventSegment`
                              ...
                              the manpage 
                              [*CEventSegment*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r74395.md)
...
For reference information on this class see:
            [CEventSegment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r74395.md).
            Closely allied with this is the concept of packets.  Packets are supported
            via the [CDocumentedPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r73994.md).
            The [CEventPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r74267.md)
...
For reference information about the `CCompoundEventSegment`
            class see
            [CCompoundEventSegment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r73714.md).

The readout software has a single object from the
            [CExperiment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r74716.md)
...
See the section:
            [Modifying the skeleton application to meet your needs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x11435.md)
...
For reference information see
            [CScalerBank](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r75183.md)
...
The readout framework provides
            [`CCAENV262Busy`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r73465.md),
            and
            [`CV977Busy`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r75571.md) as
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring-normal-stuff)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring-getring)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring_getevtcount)
  To set up for the loop that emits ring items we first
                          fetch the number of events that have been read.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring_geteventinfo)
  This section of code gets the informatino about the event
                          ...
                          variable.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring_makeitem)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring_fillitem)
  The `getBodyCursor` method
                          ...
                          event data.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring_updatecursor)
  This line computes a pointer to the first unused byte
                          ...
                          to put its data.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring_commit)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c11014.md#specialring_bookkeeping)
