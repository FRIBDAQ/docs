...
This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r48902]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r54673]])
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r54673]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r54673]] for
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r52151]] for reference
...
[[cccusbreadoutlist(3ccusb)|r54673]]
