...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r52676.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cccusbreadoutlist →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r54673.md)
...
This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [CCCUSB(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48902.md).  The
...
Command lists (see [cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r54673.md))
...
- ***object* executeList
                    *readout-list maxread***
  Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                              (see [cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r54673.md)).
...
- ***object* loadList
  ...
  `readout-list` is a
                              ...
                              [cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r54673.md) for
...
- ***object* readDGGB**
  Same as **readDGGA** but reads the
...
**
  Writes `value` to the
                              ...
                              constructed by any of the methods described above.
- ***object*
                        writeGlobalMode *value***
  Writes `value` to the global
                              mode register. See section 3.3.2 of the CC-USB
                              manual for a description of this register.
                              `object` is a CCCUSB object
                              constructed by any of the methods described above.
- ***object*
                        writeLamTriggers *value***
  Writes `value` to the LAM
...
This section describes how to use **executeList**
                ...
                [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r52151.md) for reference
...
[CCCUSB(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48902.md)
[cccusbreadoutlist(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r54673.md)
[CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r52151.md)
