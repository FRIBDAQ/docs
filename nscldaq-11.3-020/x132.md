...
ringbufferThis utility allows you to create, re-initialize, delete  and
            ...
            don't already exist. See the [[man page|r12006]] for more information.
...
dumperProvides a simple textual formatted dump of the buffers.  If you
            ...
            each event and the packets within the event. See [[user documentation|c7034]] and [[man page|r12656]] for more information.

eventlogPerforms native mode event loggging.  In this mode, event file
            segments consists of streams of ring buffer items. See [[user documentation|c7098]] and [[man page|r12750]] for more information.
...
ringselectorProvides a flexible ringbuffer consumer that pipes the ring items
            ...
            applications like SpecTcl. See [[user documentation|c7429]] and [[man page|r13004]] for more information.
...
ringtostdoutAccepts data from a ring and pipes it to stdout.  This is the server
            ...
            process data from  a ring. See the [[man page|r12130]] for more information.
...
ScalerDisplayProvides a display of scaler event data.  This application is highly
            ...
            selected scalers are also supported. See [[user documentation|c4676]] and [[man page|r12344#manpage.scalerdisplay]] for more information.

stdintoringAccepts data on stdin and puts it in a ring buffer.  This is the
            client side of the data pipeline that sets up a proxy ring. See the [[man page|r12194]] for more information.
