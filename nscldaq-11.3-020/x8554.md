...
# <a name="AEN8554"></a>41.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8560"></a>**Example 41-1. Including a ring item class **
...
<a name="AEN8567"></a>**Example 41-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8572"></a>**Example 41-3. Linking the ring item format libraries**
...
[[r17978]]Base class for all the ring data item format classes.
...
[[r18901]]Represents a state change item.  Given a reference to
...
[[r18455]]Represents a state change item.  Given a reference to a
...
[[r19306]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[r20821]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[r19632]]Encapsulates the data taken in response to a physics
                        trigger.

[[r20155]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[r19828]]Encapsulates an item that gives information about the
...
[[r20470]]Encapsulates an event fragment produced by the event
                        builder ordering stage for which there's good reason to
                        believe the payload is not a ring item.

## <a name="AEN8644"></a>41.3.1. Generic ring data sources
