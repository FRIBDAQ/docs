...
| Prev | Chapter 51. Access control and security | Next |


---

# <a name="AEN9894"></a>51.2. Authenticators
...
<a name="AEN9898"></a>**Example 51-3. Boilerplate DAQ Authorization code **
...
[[r37286]]The entity must provide a correct password.  Note that the current
                    set of interactors do not support encrypted interactors.  This can be
                    extended if required.

[[r37484]]The entity must provide a valid username and password
                        that is could login to the local unix system.

[[r37705]]Intended for use within a Tcl interpreter.  The entity must
                        supply some string that is an element of a Tcl list
                        held in a Tcl variable.

[[r37813]]The entity must supply a string that is one of a set of strings
                            given to the authenticator.

[[r37965]]Same as `CAccessListCheck` but the
