...
[← DaqPortManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r15655.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [serverauth →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r15821.md)
...
<a name="AEN15782"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN15785"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN15792"></a>## DESCRIPTION
