...
[← Interpreting the dumper output](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x6649.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for the RC-bus through an MxDC device →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x6708.md)

---

---

# <a name="AEN6691"></a>12.2. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN6701"></a>**Figure 12-1. The MCFD16Control Graphical User Interface for USB**
   ![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/figures/MCFD16Control-USBHowTo-0.png)
