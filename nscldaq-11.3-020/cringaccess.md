...
<a name="AEN16976"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16979"></a>## Synopsis
...
<a name="AEN17055"></a>## Public member functions
...
<a name="AEN17146"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN17150"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN17154"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
