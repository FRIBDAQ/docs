...
[← n568Panel](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r70691.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VhsWidgets →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r71352.md)
...
- ***name* haveTempNoGoodEvent**
  Returns true if the module
                          has a pending bad temperature event.
- ***name* haveSupplyNotGoodEventg**
  Returns true if the module has a pending
...
[VhsWidgets(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r71352.md)
[vhsPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r16113.md)
