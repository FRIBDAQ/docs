...
<a name="AEN27345"></a>## Public member functions
...
<a name="AEN27352"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN27373"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN27386"></a>` unsigned char getVersion(void);const`
...
<a name="AEN27411"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN27422"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN27768"></a>` ECLOutputSelect
...
<a name="AEN27836"></a>` unsigned short
...
<a name="AEN28000"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN28012"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN28022"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN28032"></a>` TriggerConfiguration
...
<a name="AEN28129"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN28170"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN28196"></a>` LEResolution
...
<a name="AEN28210"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN28370"></a>` unsigned short
...
<a name="AEN28464"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN28476"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN28493"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN28506"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN28518"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN28539"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN28551"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN28566"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN28581"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN28596"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN28608"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN28623"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN28633"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN28645"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN28657"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN28669"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN28681"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN28691"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN28701"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN28711"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN28721"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN28733"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN28743"></a>` void
                    EnableErrorMark(void);`



<a name="AEN28753"></a>` void
                    DisableErrorMark(void);`



<a name="AEN28763"></a>` void EnableBypassOnError(void);`



<a name="AEN28773"></a>` void
                    DisableBypassOnError(void);`
...
<a name="AEN28795"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN28805"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN28817"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN28827"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN28839"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN28851"></a>` void EnableAllChannels(void);`



<a name="AEN28861"></a>` void
                    DisableAllChannels(void);`



<a name="AEN28871"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN28883"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN28895"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN28910"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN28922"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN28934"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN28955"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN28968"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN28985"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN29003"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN29018"></a>## Types and public data
