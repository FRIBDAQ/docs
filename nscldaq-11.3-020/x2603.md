...
[← Built-in Diagnostics](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x25.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The slow controls subsystem →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2861.md)
...
This section will go through a sample snit driver describing
                ...
                [Section 5.4.4](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-general-tcldriver-usage).
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-auto_path)
  The SWIG Tcl wrappers for the CCUSB and CCUSBReadoutList
                          ...
                          package.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-packages)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-type)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-option)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-Initializemethod)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-ccusbswigwrap)
...
...
  ...
  ```
                          ...
                          command.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-readleds)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-writeleds)
  Invokes the CCCUSB `writeLedSelector`
                          so that the new value of the LED selector register
                          takes effect.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-addReadoutListmethod)
  The `addReadoutList`
  ...
  The `list` parameter is a pointer
                          ...
                          object.
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-ccusbreadoutlist-swigwrap)
  Wraps the pointer in a SWIG object analagous to what
                          was done for the ccusb pointer passed to
                          `Initialize`.
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-snit-addmarker)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-itcl-header)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-itcl-class)
  The **class** command creates an Incr
                          ...
                          (objects).
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-itcl-options)
  ...
  Therefore this line creates the
                          ...
                          variable.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-itcl-initialize)
  The `Initialize` method
                          has been described previously.  The body of this
                          method is identical to the body of the
                          correpondig snit::type.
                          method.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-itcl-addreadoutlist)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x2603.md#ccusb-itcl-addmarker)
