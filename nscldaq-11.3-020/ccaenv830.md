...
<a name="AEN29561"></a>## Public member functions



<a name="AEN29566"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN29594"></a>`void  Enable(int nChannel);`
...
<a name="AEN29609"></a>`void  Disable(int nChannel);`
...
<a name="AEN29624"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN29637"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN29649"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN29661"></a>`void   SetWide (void);`
...
<a name="AEN29673"></a>`void   SetNarrow (void);`
...
<a name="AEN29684"></a>`void  EnableHeader (void);`
...
<a name="AEN29762"></a>`bool  isFull (void);`
...
<a name="AEN29774"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN29786"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN29879"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN29893"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
...
`Disabled`Triggers are disabled.

`Random`Random triggers. Triggers are accepted from the front panel
                                and programmatically.

`Periodic`Periodic triggers.  Triggers happen at a rate determined by the
                                dwell time programmed via `SetDwellTime`

<a name="AEN29942"></a>## Exceptions
