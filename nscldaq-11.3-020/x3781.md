...
[← The ccusbcamac Tcl package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x3602.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The event logger and ReadoutShell →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4096.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/readoutshell.jpg)
...
The menu bar provides access to ReadoutShell commands
                ...
                [*Customizing the ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4130.md) describes
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/eventlogsettings.jpg)
...
- Event Log Program
  ...
  The
                              ...
                              [*The event logger and ReadoutShell*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x4096.md) for
...
- Use `--number-of-sources`
  ...
  This option should be used if you are combining
                              ...
                              See
                              [*eventlog*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r12750.md) for more
