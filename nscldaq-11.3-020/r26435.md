...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r25630.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r26813.md)
...
<a name="AEN26574"></a>## Public member functions





- <a name="AEN26580"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN26592"></a>`bool Xtest(void);const`
...
- <a name="AEN26604"></a>`bool Qtest(void);const`
...
- <a name="AEN26621"></a>`bool TimedOut(void);const`
...
- <a name="AEN26633"></a>`bool BranchDemand(void);const`
...
- <a name="AEN26645"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN26659"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN26672"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN26686"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN26701"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN26716"></a>`bool IT4(void);const`
...
- <a name="AEN26730"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN26741"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN26754"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN26770"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN26781"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN26792"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN26802"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN26806"></a>**Example 1. Initializing branch 0**
