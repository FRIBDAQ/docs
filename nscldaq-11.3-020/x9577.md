...
[← Byte order signatures and conversion blocks](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9557.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the library into an application. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9723.md)
...
Functions are provided that allow you to convert shorts and longs
            ...
            in the
            [cvt reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r35615.md).
            Briefly however:
