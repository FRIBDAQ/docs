...
- [[![(1)](../images/callouts/1.gif)|x8829#evbc-connect-include]]
  As previously described, this #include
                          is required to define the client class.
- [[![(2)](../images/callouts/2.gif)|x8829#evbc-connect-hostname]]
...
- [[![(3)](../images/callouts/3.gif)|x8829#evbc-connect-getport]]
...
- [[![(6)](../images/callouts/6.gif)|x8829#evbc-connect-connect]]
  The `Connect` method actually attempts
                          to perform the connection to the event builder.
- [[![(7)](../images/callouts/7.gif)|x8829#evbc-connect-connecterr]]
