...
# <a name="evb-connecting"></a>42.3. Connecting to the event builder.

The code below shows how to connect to the event builder as
                a client:

<a name="AEN8832"></a>**Example 42-1. 
