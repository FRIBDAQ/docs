...
<a name="AEN19082"></a>## Public member functions
...
<a name="AEN19300"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN19303"></a>**Example 1. Creating a begin run state transition item**
