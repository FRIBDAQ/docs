...
In addition to
            [[CInteractor|r38155]], the following
            concrete interactors have been supplied.



[[`CStringInteractor`|r38334]]This interactor supplies a string that you have gotten by
                        whatever means you got it.  It can be used when interactors
                        are not suitable for acquiring the stringified credentials.

[[`CFdInteractor`|r38505]]This interactor accepts the credentials via an open file
                        descriptor.

[[`CIOInteractor`|r38641]]This interator uses a pair of other interactors, an output and
