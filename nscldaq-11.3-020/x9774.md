...
[← Using CGaurdedObject to implement synchronized methods](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9734.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Pointers to the reference material →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9846.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9774.md#bufferqueue_databuffer)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9774.md#bufferqueue_queues)
  These are the queues.  By passing pointers around in the queue
              ...
              new data.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9774.md#bufferqueue_get)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9774.md#bufferqueue_put)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9774.md#bufferqueue_outputget)
  The output thread gets a filled buffer from the queue and processes it.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x9774.md#bufferqueue_outputput)
