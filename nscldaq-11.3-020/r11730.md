...
<a name="AEN11744"></a>## Name

spectcldaq -- Pipe data source for SpecTcl in spectrodaq buffer mode.

<a name="AEN11747"></a>## Synopsis

**spectcldaq *ring-url*
**

<a name="AEN11751"></a>## DESCRIPTION
...
<a name="AEN11772"></a>**Example 1. Attaching SpecTcl to a ring buffer in compatibility mode**
...
| --- | --- | --- |
| Prev | Home | Next |
| eventlog-compat | Up | spectcldaq.server |
