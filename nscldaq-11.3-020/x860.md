...
[← Incorporating the headers and libraries into your applications.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x8554.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Generic ring data sinks →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x8663.md)
...
If a user wants to write their own module for the slow-controls subsystem,
      ...
      [*Extending the slow controls subsystem*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/x1616.md).
...
There are numerous slow-controls modules availabe for use with the
        Module command (see [Module(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r67525.md)). Because of its
...
- `CVMUSBReadoutList`
  Instances of this class represent lists of VME operations you want
                to perform via the server.  See [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r62585.md) for reference
                information.
- `CVMUSBRemote`
  ...
  See [*CVMUSBRemote*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r63490.md)
