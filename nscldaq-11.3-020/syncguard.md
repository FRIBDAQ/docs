...
<a name="AEN36171"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN36174"></a>## Synopsis
...
<a name="AEN36216"></a>## Public member functions
...
<a name="AEN36254"></a>`void sync_self(void);`
...
<a name="AEN36261"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN36269"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN36281"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN36287"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN36297"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN36327"></a>`void sync_global_end(void);`
