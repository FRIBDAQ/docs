...
<a name="AEN1092"></a>`uint64_t getEventTimestamp(void *pBuffer);`
...
<a name="AEN1101"></a>**Example 4-3. A sample getEventTimestamp() implementation**
...
From the [[x1075]], we know the first
...
<a name="AEN1147"></a>`uint64_t getScalerTimestamp(void *pBuffer);`

<a name="AEN1153"></a>**Example 4-4. 
...
## <a name="AEN1158"></a>4.7.3. Implementing an onBeginRun() function

The third function that can be defined in the timestamp extractor
        library has the prototype:

<a name="AEN1161"></a>`void onBeginRun(void);`
...
<a name="AEN1167"></a>**Example 4-5. Adding an offset to the timestamp**
...
### <a name="AEN1190"></a>4.7.3.1. Compiling the shared library
