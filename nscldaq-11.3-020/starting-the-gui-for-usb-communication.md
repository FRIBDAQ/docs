...
| Prev | Chapter 13. Mesytec MSCF-16 Controls | Next |


---

# <a name="AEN6782"></a>13.3. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN6792"></a>**Figure 13-1. The MSCF16Control Graphical User Interface for USB**
   ![](figures/MSCF16Control-USBHowTo-0.png)
...
| --- | --- | --- |
| Prev | Home | Next |
| Synchronization Paradigm | Up | Saving and restoring state |
