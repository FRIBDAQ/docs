...
- [[![(1)](../images/callouts/1.gif)|x5471#v775_rdoh_protect]]
...
- [[![(2)](../images/callouts/2.gif)|x5471#v775_rdoh_baseinclude]]
...
- [[![(3)](../images/callouts/3.gif)|x5471#v775_rdoh_caencard_forward]]
  ...
  It's worth asking when to do this as opposed to
                          ...
                          at any time.
- [[![(4)](../images/callouts/4.gif)|x5471#v775_rdoh_classdef]]
...
- [[![(5)](../images/callouts/5.gif)|x5471#v775_rdoh_module_member]]
  We will construct our event segment by passing it a
                          ...
                          data by this line.
- [[![(6)](../images/callouts/6.gif)|x5471#v775_rdoh_interfaces]]
...
- [[![(1)](../images/callouts/1.gif)|x5471#v775_impl_heading_declaration]]
  Class implementation files need access to the declaration
                          of the class.  This #include incorporates
                          that declaration.
- [[![(2)](../images/callouts/2.gif)|x5471#v775_impl_heading_card]]
  This module will be invoking methods of the
                          ...
                          `CAENcard` into this
                          compilation unit.
- [[![(3)](../images/callouts/3.gif)|x5471#v775_impl_heading_range]]
...
- [[![(4)](../images/callouts/4.gif)|x5471#v775_impl_heading_maxwords]]
...
- [[![(1)](../images/callouts/1.gif)|x5471#v775_impl_init_try]]
...
- [[![(2)](../images/callouts/2.gif)|x5471#v775_impl_init_startstopmode]]
...
- [[![(1)](../images/callouts/1.gif)|x5471#v775_impl_read_signature]]
...
- [[![(2)](../images/callouts/2.gif)|x5471#v775_impl_read_sizecheck]]
  The device is only read if there is sufficient room in the
                          ...
                          called.
- [[![(3)](../images/callouts/3.gif)|x5471#v775_impl_read_read]]
...
- [[![(4)](../images/callouts/4.gif)|x5471#v775_impl_throw]]
...
- [[![(1)](../images/callouts/1.gif)|x5471#v775_skel_base]]
  Here we define a constant; `V775Base`
                          to be the base address of the TDC module.  See
                          [[*Addressing VME modules*|x5471#v775ss_sec_addressing]]
                          below
                          for more about addessing VME modules.
- [[![(2)](../images/callouts/2.gif)|x5471#v775_skel_card]]
...
- [[![(3)](../images/callouts/3.gif)|x5471#v775_skel_trigger]]
...
- [[![(4)](../images/callouts/4.gif)|x5471#v775_skel_evseg]]
