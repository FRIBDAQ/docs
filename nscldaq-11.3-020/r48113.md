...
[← ph7xxx](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r47895.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Module →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48260.md)
...
<a name="AEN48127"></a>## Name

stack -- Create and configure CC-USB stacks.

<a name="AEN48130"></a>## Synopsis
...
- `-modules` *module-list*
  ...
  The list defaults to empty which is not legal, making
  			    this a mandatory configuration parameter.
...
- `-lams` *mask*
  Specifies the mask of LAMs that can trigger the list.
                             I suggest leaving this value at zero (the default),
  			   and deriving a
...
- `-delay` *microseconds*
  ...
  Note that in general this value is not suitable
  			    as CAMAC digitizers often require a significant
  			    amount of time to convert after their triggers.
...
<a name="AEN48235"></a>## EXAMPLES

The example below extends the example in the
                  [ph7xxx(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r47895.md) command reference
                  reading the defined modules in an event stack:

<a name="AEN48239"></a>**Example 1. Example of the **stack** command.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48113.md#defmodules)
  These two lines define the modules that we will be using
                          for the experimental setup.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48113.md#stackdef)
  Creates a new stack called events
                          In subsequent lines I'm going to configure this stack
                          to handle the event trigger.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48113.md#typemods)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r48113.md#timing)
