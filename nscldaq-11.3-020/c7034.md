...
[← Ring piping utilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c7008.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/c7098.md)

---

---

# <a name="ch.dumper"></a>Chapter 19. The dumper program
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3-020/r12656.md).
...
<a name="AEN7048"></a>**Example 19-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN7052"></a>**Example 19-2. Dumping data from the event file segment
...
# <a name="AEN7062"></a>19.1. Item dump formats and examples
...
<a name="AEN7065"></a>**Example 19-3. State Transition items**
...
<a name="AEN7070"></a>**Example 19-4. Text List items**
...
<a name="AEN7075"></a>**Example 19-5. Incremental Scalers dump**
...
<a name="AEN7081"></a>**Example 19-6. Event count items**
...
<a name="AEN7087"></a>**Example 19-7. Physics Event items**
...
<a name="AEN7092"></a>**Example 19-8. Unknown item types**
