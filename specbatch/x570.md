...
[← Running MPITcl (NSCL/FRIB specific)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x501.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Serial reader parallel worker example. →](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x583.md)
