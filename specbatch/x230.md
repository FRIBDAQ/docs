...
[← How Batch SpeTcl analyzes data](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x192.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [A simple analysis script. →](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x230.md#make.version)
  These two lines of the file specify the SpecTcl version
                          ...
                          version of SpecTcl, simplly change the version numbers
                           ...
                           you are using.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x230.md#make.srcdirs)
  It's tempting to copy event processor source files
                          ...
                          space or : separated.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x230.md#make.sources)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x230.md#make.cxxflags)
  Specify any compilation flags you need to build code here.
                          For example if an event processor and its header live in
                          .., you'll need e.g.
                          MYCXXFLAGS=-I..
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x230.md#cxxldflags)
