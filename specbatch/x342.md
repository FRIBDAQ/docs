...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md#batch.requirebase)
  Requires the SpecTcl batch package.  This script
                          ...
                          5.2-000.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md#batch.requirepipe)
  MyhPipeline is the name of the
                          ...
                          from raw events.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md#batch.defs)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md#batch.getter)
  Specifies data will be gotten from file.
                          ...
                          event file.
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md#batch.distributor)
  The main analysis loop will take data read from the
                          getter and distribute them to the SpecTcl analysis
                          subsystem.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md#batch.analyze)
  Analyzes the entire file.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x342.md#batch.save)
