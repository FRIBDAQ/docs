...
[← mpisink](https://github.com/FRIBDAQ/docs/tree/main/specbatch/r908.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Creating a loadable package for the event analysis pipeline →](https://github.com/FRIBDAQ/docs/tree/main/specbatch/x230.md)
