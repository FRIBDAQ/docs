...
[[![(2)](../images/callouts/2.gif)|c755#mkset.connect]]                The **DBTcl connect** command
...
[[![(3)](../images/callouts/3.gif)|c755#mkset.crset]]                Similarly the **createSaveset**
            ...
            [[![(4)](../images/callouts/4.gif)|c755#mkset.destroy]]                All instance commands have a **destroy**
...
[[![(1)](../images/callouts/1.gif)|c755#lssavesets.tcl.list]]                The **listSavesets** subcommand
...
[[![(1)](../images/callouts/1.gif)|c755#pardef.tclgetsaveset]]                The **getSaveset** subcommand of
...
[[![(2)](../images/callouts/2.gif)|c755#pardef.tclcreate]]                The **createParameter** subcommand
...
[[![(3)](../images/callouts/3.gif)|c755#pardef.tcllist]]                The **listSpectrum** subcommand
...
idContains an integer that is the primary key of the
...
nameText string that is the name of the parameter.

numberTHe number of the parameter.  This differs from the
                            id key. It's a value that
                            the program supplies, rather than a value
                            assigned by the database engine.

low (optional)This key is only present for tree
                            parameters. It's the recommended low limit of spectrum
                            axes defined on this parameter.

high (optional)This key is only present for tree parameters.
                            It is the recommended high limit for axes defined
                            on this parameter.

bins (optional)This key is only present for tree parameters.  It is
                            the recommended number of bins on axes defined on
                            this parameter.

units (optional)This key is only present for tree parameters.  It is
...
[[![(1)](../images/callouts/1.gif)|c755#specdef.tcl.cr1d]]                The **createSpectrum** saveset instance
...
byteChannels will be 8 bit values.

wordChannels will be 16 bit values.

longChannels will be 32 bit values

[[![(2)](../images/callouts/2.gif)|c755#specdef.tcl.cr2d]]                This command creates a 2-d spectrum.  The principles are the
            ...
            [[![(3)](../images/callouts/3.gif)|c755#specdef.tcl.list]]                The **listSpectra** subcommand
...
idThe primary key of the spectrum in the top level
...
typeThe spectrum type code.

parametersThe list of parameters the spectrum depends on.

axesList of axis definitions for each of the
...
datatypeThe data type code as described above.
...
[[![(4)](../images/callouts/4.gif)|c755#gatedef.tcl.mask]]                Creates a mask gate.  Mask gates assume their parameter
            ...
            [[![(5)](../images/callouts/5.gif)|c755#gatedef.tcl.list]]                The **listGates** command returns
...
classification (all)Gives the gate classification. All gates
...
id (all)The primary key in the top level table
...
name (all)The name of the gate.

type (all)The gate type code string.

parameters (point, mask)The parameters that are checked by the gate.
                        Note that mask gates only have one parameter.

gates (compound)The names of the gates this gate depends on

points (point)A list of two element sub lists.  Each element
...
mask (mask)The bitmask for a mask gate.
...
[[![(1)](../images/callouts/1.gif)|c755#vardef.tcl.make]]                The **createVariable** subcommand creates a new
...
valueValue of the tree variable (double).

unitsUnits of measure text string.  If no units were supplied,
...
[[![(1)](../images/callouts/1.gif)|c755#specstore.tcl.store]]                The **storeChannels** command stores
            ...
            [[![(2)](../images/callouts/2.gif)|c755#specstore.tcl.get]]                The **getChannels** subcommand returns a list of
