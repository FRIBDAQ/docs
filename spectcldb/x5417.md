...
- **Table of Contents**
- [[DBTcl|r5453]] -- Provide database access.
- [[Database Instance|r5478]] -- Manipulate a database
- [[Save set Instance|r5522]] -- Manipulate save sets
...
- **Table of Contents**
- [[dbconfig::makeSchema|r6036]] --
- [[dbconfig::connect|r6057]] -- Connect to a database
- [[dbconfig::openSaveSet|r6070]] -- Access a save set.
- [[dbconfig::saveConfig|r6085]] -- Save SpecTcl analysis configuration
- [[dbconfig::listConfigs|r6101]] -- Obtain information about save sets
- [[dbconfig::restoreConfig|r6131]] -- Restore analysis configuration from saveset
- [[dbconfig::saveSpectrum|r6146]] -- Save contents of a spectrum.
- [[dbconfig::restoreSpectrum|r6161]] -- Restore spectrum contents from save set.
- [[dbconfig::saveAllSpectrumContents|r6175]] -- Save the contents of all spectra to a saveset
- [[dbconfig::restoreAllSpectrumContents|r6188]] -- Load channels for all spectra
- [[dbconfig::listRuns|r6201]] -- List information about saved runs.
- [[dbconfig::hasRun|r6242]] -- Determine if a save set has run data.
- [[dbconfig::getRunInfo|r6256]] -- Get information about all runs in a saveset.
- [[dbconfig::getScalers|r6269]] -- Return scaler information from a run.
...
- **Table of Contents**
- [[daqdb|r6323]] -- Record/playback event data from sqlite3 database files
