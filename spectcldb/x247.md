...
[← Pop Up context menus](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x1521.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Object oriented Sqlite3 wrapper →](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x4153.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#pardef.paramhdr)
  Parameters are encapsulated in
                          `SpecTclDB::DBParameter`
                          objects.   This #include
                          bring the definition of that class into
                          the program.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#pardef.psave)
  This will be a pointer to the save set
                          ...
                          exception.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#pardef.getsvset)
  The `getSaveSet`
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#pardef.create)
  ...
  Noe that
                          ...
                          deleted.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#pardef.listpars)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#pardef.find)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#specdef.header)
  We will be calling methods of the
                          ...
                          to our program.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#specdef.pars)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#specdef.axes)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#specdef.def)
  ...
  An optional additional parameter provides
                          ...
                          can also be word or
                          byte.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#specdef.list)
  Asks the saveset for a list of the spectra
                          ...
                          objects.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#specdef.info)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#gatedef.header)
  The DBGate.h header defines
                          ...
                          delete them.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#gatedef.1d)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#gatedef.compound)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#gatedef.mask)
  ...
  This section of code creates an
                          *equal mask gate*.
                          ...
                          gate is satisfied.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#gatedef.list)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#applydef.header)
  The Applictions.h
                          header defines the
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#applydef.apply)
  To save a gate application, we only need
                          ...
                          `applyGate` method
                          of the saveset.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#applydef.list)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#tv.header)
  The DBTreeVariable.h
                          header defines the `SpecTclDB::DBTreeVariable`
                          class which is wraps a database definition
                          for a tree variable.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#tv.create)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#tv.list)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtstore.crevent)
  ...
  There are 100 parameters.  In any given
                          ...
                          [0, 1)
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtstore.start)
  The `startRun`
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtstore.init)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtstore.save)
  This line saves an event. The
                          `data` method of
                          `std::vector` returns
                           a pointer to the contiguous storage used by the
                           event for he current transaction.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtstore.commit)
  ...
  It is also possible to decide not to
                          ...
                          example.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtstore.commit2)
  Performs the commit for any partial
                          block of events.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtstore.endrun)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtget.sink)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtget.open)
  `openRun`
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtget.evts)
  Getting events back from the database
                          ...
                          result set.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtget.read)
  `readEvent`
  ...
  note that this can be trivially turned into
                          ...
                          leaf.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#evtget.close)
  `closeEvents`
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#sclstore.produce)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#sclstore.save)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#sclget.process)
  This function is a stand-in for any processing you
                          ...
                          values to stdout.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#sclget.runinfo)
  The `getRunInfo`
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#sclget.open)
  As with getting events from the database,
                          ...
                          from that query.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#sclget.read)
  The `readScaler`
  ...
  All we do with the data gotten from
                          ...
                          `processScalers`.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcldb/x247.md#sclget.close)
