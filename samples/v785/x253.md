...
[← Compiling the Readout program](https://github.com/FRIBDAQ/docs/tree/main/samples/v785/x228.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Reference (man) pages →](https://github.com/FRIBDAQ/docs/tree/main/specbatch/a236.md)
