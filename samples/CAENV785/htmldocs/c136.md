...
[← Complete program listings.](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c1200.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The electronics →](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c36.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#protect)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#namespace)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#eventsegderived)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#docpacket)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#hardwareobject)
  The support software for the CAEN V685 ADC is itself a class:
                  ...
                  be used to access the object and hence the module.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegconstructor)
  This line declares the *constructor* for
                  ...
                  is being created (constructed).
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegdestructor)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#myseginit)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegclear)
  The `Clear` member function is called when it is
                  ...
                  event is read out.
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegobsoletemaxsize)
...
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegread)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#boilerplate)
  The lines beginning with the include of config.h
          ...
          later.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#myheader)
  In order to get access to the class definition, we must include the header
          that we wrote that defines the class
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#packetversion)
  Recall that we will be putting our event segment into a packet.  The packet
          ...
          will document the revision level of the packet body for our packet.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#packetinit)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#cardcreate)
  The constructor body creates a new `CAENcard` object,
          ...
          of the module.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#destroy)
  The destructor body destroys the `CAENcard` object
          ...
          "lead" some memory.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#moduleInit)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#cleardata)
  This code clears any data that is latched in the module
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#waitready)
  The CAEN V785 requires about 6�s to convert once it is given a gate.
          ...
          At that time, control breaks out of the loop.
- [![(10)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#openpacket)
...
- [**(11)**](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#readdata)
  Data are read from the ADC into the packet.
- [**(12)**](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#closepacket)
  The size of the packet is written to the space reserved for it. The packet
          ...
          buffer.
- [**(13)**](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#returnpointer)
...
- /usr/opt/daq/current/bufdump
  Dumps the front segments of buffers in real-time.
                          This is the program we will use for our initial testing.
- /usr/opt/utilities/current/bin/bufdump
  Provides formatted dumps of complete buffers.  Each buffer
...
- **begin**
  Begins a run.  From the point of view of your code, your
