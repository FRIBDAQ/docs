...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#protect)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#namespace)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#eventsegderived)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#docpacket)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#hardwareobject)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegconstructor)
...
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegdestructor)
...
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#myseginit)
...
- [![(9)](../images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegclear)
  The `Clear` member function is called when it is
                  ...
                  event is read out.
- [![(10)](../images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#mysegobsoletemaxsize)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#boilerplate)
  The lines beginning with the include of config.h
          ...
          later.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#myheader)
  In order to get access to the class definition, we must include the header
          that we wrote that defines the class
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#packetversion)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#packetinit)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#cardcreate)
  The constructor body creates a new `CAENcard` object,
          ...
          of the module.
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#destroy)
  The destructor body destroys the `CAENcard` object
          ...
          "lead" some memory.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#moduleInit)
...
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#cleardata)
  This code clears any data that is latched in the module
- [![(9)](../images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#waitready)
...
- [![(10)](../images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/c136.md#openpacket)
