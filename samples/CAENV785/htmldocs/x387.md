...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epbaseclassinclude)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epxlatorpointerinclude)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#histotypesinclude)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epforwards)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#treearraymember)
  The TreeParameter package provides both individual parameters
                          ...
                          *reference* to that array.  A reference in C++ is
                          ...
                          r.b.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epidmember)
  The `m_nId` member variable will be used to hold the
                      id of the packet our event processor is supposed to decode.
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epslotmember)
...
- [![(9)](../images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epconstructor)
...
- [![(10)](../images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epdestructor)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epinclude)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epforwardincludes)
  The header for `MyEventProcessor` declared several classes
                      ...
                      #include-ed.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#tclanalyzerinclude)
...
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#constants)
  ...
  - `CAEN_DATAMASK`
    ...
    ```
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#getLong)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epinitializers)
...
- [![(8)](../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#epboilerplate)
...
- [![(9)](../images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#packetHeader)
  This code extracts the packet size and id of each packet encountered in the
                      ...
                      event.
- [![(10)](../images/callouts/10.gif)](https://github.com/FRIBDAQ/docs/tree/main/samples/CAENV785/htmldocs/x387.md#packetSearch)
