...
[[![(10)](../images/callouts/10.gif)|x387#epdestructor]]                    A destructor is necessary when classes use dynamcially allocated data, in order
                    ...
                    [[**(11)**|x387#epfunccall]] `operator()` allows objects of a class to be treated as
...
[[![(1)](../images/callouts/1.gif)|x387#epinclude]]                    Since this compilation unit implements the `MyEventProcessor`
                    ...
                    #include-ed.[[![(3)](../images/callouts/3.gif)|x387#tclanalyzerinclude]]                    The `CAnalyzer` reference that will be passed in to the
