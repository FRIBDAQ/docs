...
[[List of all members|classddaschannel-members]]
...
channel.[[UnpackChannelData|classddaschannel#a55ada0749d06cdf03c03caff15604269]]( pDataBuffer );
...
Note that this only really makes sense to be used if the object was filled with data using [[UnpackChannelData()|classddaschannel#a55ada0749d06cdf03c03caff15604269]].
...
While it parses, it stores the results into the data members of the object. Prior to parsing, all data members are reset to 0 using the [[Reset()|classddaschannel#ac775d0c5571d515b612d4b116c183451]] method.
...
The documentation for this class was generated from the following files:- ddasdumper/[[ddaschannel.h|ddaschannel_8h_source]]
