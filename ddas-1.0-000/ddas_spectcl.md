[← NSCL DDAS: ddas_config.h Source File](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/ddas__config_8h_source.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: ddasdumper/ddaschannelDictionary.h Source File →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/ddaschannelDictionary_8h_source.md)
...
struct [ChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structChannelData.md) {
...
struct [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md) {





[ChannelData](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structChannelData.md)          chan[48];
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md)(std::string name);
...
Now that we have laid out the structure of the TreeParameters we will turn our attention to assigning data to them. Normally, users would be required to parse raw data in their SpecTcl and then assign values to the tree parameters. In the DDAS support, we parse the raw data for you. We will name the header file for our mapper [MyParameterMapper.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/MyParameterMapper_8h_source.md). It has the following contents:
...
class [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md);
...
class [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classMyParameterMapper.md) : public [DAQ::DDAS::CParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classDAQ_1_1DDAS_1_1CParameterMapper.md)
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md)& m_params;          // reference to the tree parameter structure
...
[MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classMyParameterMapper.md)([MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md)& params);
...
int computeGlobalIndex(const [DAQ::DDAS::DDASHit](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classDAQ_1_1DDAS_1_1DDASHit.md)& hit);
...
m_params.chan[globalChanIdx].energy    = hit.[GetEnergy](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classDAQ_1_1DDAS_1_1DDASHit.md#a123d68755f678cd1eec6f5320a39b629)();


m_params.chan[globalChanIdx].timestamp = hit.[GetTime](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classDAQ_1_1DDAS_1_1DDASHit.md#a930e45be2c50eaf4a90988b0bd8c4a74)();
...
MyParameterMapper::MyParameterMapper([MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md)& params)
...
[MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md) params("raw");
...
[DAQ::DDAS::CDDASBuiltUnpacker](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker.md) Stage1( {0, 1, 2 }, *(new [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classMyParameterMapper.md)(params)));

 fragment To round out our work on MySpecTclApp.cpp, you simply need to add some include directives to the top of the file. These will bring the [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md), [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classMyParameterMapper.md), [DAQ::DDAS::CDDASBuiltUnpacker](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classDAQ_1_1DDAS_1_1CDDASBuiltUnpacker.md) classes into scope. Add these lines to the top:
...
The final work that needs to be done is to modify the Makefile. Add the [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md) and [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classMyParameterMapper.md) class to the build by adding MyParameters.o and MyParameterMapper.o to the OBJECTS variable. It should look like this when you are done:


OBJECTS=MySpecTclApp.o [MyParameters](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/structMyParameters.md).o [MyParameterMapper](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classMyParameterMapper.md).o

 fragment Next the compiler needs to be told where to find the [DDASBuiltUnpacker.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/DDASBuiltUnpacker_8h_source.md) file and that we need c++11 mode. That is done by adding to the USERCXXFLAGS so it looks like this:
...
![simple_1module_treegui.jpeg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/simple_1module_treegui.jpeg)
...
![simple_1module_spectrum.jpg](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/simple_1module_spectrum.jpg)
...
Generated on Thu Aug 4 2016 08:51:13 for NSCL DDAS by  [![doxygen](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/doxygen.png)](http://www.doxygen.org/index.html) 1.8.1.2
