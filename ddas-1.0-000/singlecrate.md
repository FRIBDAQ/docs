...
Note that the nscope program controls many more parameters of the DPP algorithm. See [[dir_0ed63cb803befae7f7665a2489cc5124]] for more information about what the nscope program can do.
...
The next word is divided into two 16-bit fields, The low order 16 bits (0) are the high order 16 bits of the event timestamp. The high order 16 bits (0x1bdc = 7132) is the [[classCFD]] interpolation value. This is the fraction of a sample time multiplied by 65536. Therefore the [[classCFD]] zero crossing was interpolated at about .11 samples after the trigger time giving the high precision timestamp of 22366491.1 ns.
