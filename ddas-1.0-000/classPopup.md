[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classPopup-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classPulseShape-members.md)
...
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classPopup-members.md)
...
|  | Popup(const TGWindow *p, const TGWindow *main, string message) |
|  | Popup(const TGWindow *p, const TGWindow *main, string message) |
...
The documentation for this class was generated from the following files:- nscope/[Popup.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/Popup_8h_source.md)
- nscope_extcl/[Popup.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/extcl_2Popup_8h_source.md)
- nscope/Popup.cpp
- nscope_extcl/Popup.cpp
