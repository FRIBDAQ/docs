[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classRootConverter-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classRootConverter2-members.md)
...
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classRootConverter-members.md)


RootConverter Class Reference

header
[Converter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classConverter.md) for data formats < NSCLDAQ 10.2.  
 [More...](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classRootConverter.md#details)
...
![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classRootConverter.png)
...
A concrete implementation of the [Converter](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classConverter.md) base class to support the conversion of data built with NSCLDAQ versions prior to 10.2. This class expects a simple physics data structure defined as follows:
...
The documentation for this class was generated from the following files:- ddasdumper/[RootConvert.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/RootConvert_8h_source.md)
