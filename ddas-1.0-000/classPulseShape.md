[← NSCL DDAS: Member List](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classPulseShape-members.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: Member List →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classRiseTimeProcessorTest-members.md)
...
[List of all members](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classPulseShape-members.md)


PulseShape Class Reference

header
Inheritance diagram for PulseShape:


![](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classPulseShape.png)


|  |  |
| --- | --- |
| Public Member Functions |
|  | PulseShape(const TGWindow *p, const TGWindow *main, string name, int columns=3, int rows=16, int NumModules=13) |
...
|  |  |  |  |
| --- | --- | --- | --- |
| Bool_t PulseShape::ProcessMessage | ( | Long_t | msg, |
|  |  | Long_t | parm1, |
|  |  | Long_t | parm2 |
|  | ) |  |  |
...
The documentation for this class was generated from the following files:- nscope/[PulseShape.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/PulseShape_8h_source.md)
- nscope_extcl/[PulseShape.h](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/extcl_2PulseShape_8h_source.md)
- nscope/PulseShape.cpp
- nscope_extcl/PulseShape.cpp
