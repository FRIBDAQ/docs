[← NSCL DDAS: TrAnal::InvalidResultException Class Reference](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classTrAnal_1_1InvalidResultException.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCL DDAS: TrAnal::LinearSolver Class Reference →](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classTrAnal_1_1LinearSolver.md)
...
- [LinearSolver](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classTrAnal_1_1LinearSolver.md)
 ...
 top 
TrAnal::LinearSolver Member List

header
This is the complete list of members for [TrAnal::LinearSolver](https://github.com/FRIBDAQ/docs/tree/main/ddas-1.0-000/classTrAnal_1_1LinearSolver.md), including all inherited members.


|  |  |  |
| --- | --- | --- |
| npoints() const | TrAnal::LinearSolver | inlinevirtual |
| operator()(const std::deque< double > &que) const | TrAnal::LinearSolver | virtual |
