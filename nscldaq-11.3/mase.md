...
<a name="AEN64210"></a>## Name

mase -- Support for XLM with MASE firmware.

<a name="AEN64213"></a>## Synopsis
...
<a name="AEN64236"></a>## OPTIONS



`-base` *base-address*Supplies the base address of the XLM module.  The XLM base
...
`-firmware` *firmware-path**firmware-path* provides the path
...
`-loadfirmware` * true | false*Determines whether or not the firmware file should be
			 loaded as part of the run initialization.  If the
			 module firmware is likely to be fine after a single load,
			 you can initially set this to true
			 and, after the first run starts, set it to
			 false to speed up the start of a run.

This option value defaults to true
