...
<a name="AEN17876"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN17879"></a>## Synopsis
...
<a name="AEN17955"></a>## Public member functions
...
<a name="AEN18046"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN18050"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN18054"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
