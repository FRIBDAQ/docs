...
<a name="AEN37476"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN37479"></a>## Synopsis
...
<a name="AEN37521"></a>## Public member functions
...
<a name="AEN37559"></a>`void sync_self(void);`
...
<a name="AEN37566"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN37574"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN37586"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN37592"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN37602"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN37632"></a>`void sync_global_end(void);`
