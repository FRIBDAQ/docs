...
- [[![(1)](../images/callouts/1.gif)|x9524#sclthread_create]]
...
- [[![(2)](../images/callouts/2.gif)|x9524#sclthread_auto_path]]
...
- [[![(4)](../images/callouts/4.gif)|x9524#sclthread_attachring]]
  With the Tcl Ring buffer package loaded **ringbuffer**
  	  ...
  	  proc parameter.
- [[![(5)](../images/callouts/5.gif)|x9524#sclthread_parentid]]
  As we have seen, in order to send a command to a thread you must know
  	  ...
  	  **thread::send** commands to the parent when a ring
  	  item is received.
- [[![(6)](../images/callouts/6.gif)|x9524#sclthread_procloop]]
...
- [[![(7)](../images/callouts/7.gif)|x9524#sclthread_postevent]]
  This line posts an event to the parent thread.  The event invokes the
  	  **handleData** command in the parent thread, passing
  	  ...
  	  necessary.
- [[![(8)](../images/callouts/8.gif)|x9524#sclthread_startprocessing]]
  The last line of the code sent to the thread actually start
  	  processing ring items by invoking **getItems**.
- [[![(9)](../images/callouts/9.gif)|x9524#sclthread_bgthread]]
