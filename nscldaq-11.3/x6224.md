...
[← Creating the Readout program](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x5914.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running the system. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6609.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawheader_config)
  ...
  This header must be included prior to any other
                              headers.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawheader_tparam)
  The tree paramter package is a useful package that
                              ...
                              its shape.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawheader_evpbase)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawheader_rawclass)
  This defines the new class
                              ...
                              `CEventProcessor` as
                              a base class.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawheader_rawconstruct)
  Our constructor needs to be declared because it
                             ...
                             parameters.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawheader_rawfunctor)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawheader_times)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_classdef)
  This include directive includes the header that defines
                              ...
                              data in the class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_treedef)
  This header defines the tree parameter package
                              classes.  We need it specifically to import the
                              definition of
                              `CTreeParameterArray`.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_transptrdef)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_miscincl)
  These includes are for miscellaneous headers I am not
                              going to describe in detail.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_datadefs)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_constructor)
  The constructor is required to initialize the reference
                              ...
                              t.00 ... t.31.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_destructor)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_funtorsignature)
  The `operator()` method
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_tp)
  ...
  This line of code creates a translating pointer for
                              ...
                              raw event.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_tclanalyzer)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_setsize)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_headerprocessing)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_channelloop)
  This loop unpackes the channel data in the TDC.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimp_chanproc)
  ...
  Note that the data also contains
                              ...
                              are not valid.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimpl_storeparam)
...
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_rawimple_trailer)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_tdiff_impl_valid1)
  ...
  This line ensures that the first time has been assigned
                          a value.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_tdiff_impl_valid2)
  This line ensures that the second parameter in the
                          difference has been assigned a value.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x6224.md#v775_tdiff_compute)
