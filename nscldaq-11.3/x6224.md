...
# <a name="AEN6224"></a>11.4. Creating the tailored SpecTcl
...
## <a name="AEN6232"></a>11.4.1. Decoding raw TDC data
...
### <a name="AEN6255"></a>11.4.1.2. Creating the raw unpacker class

Here is the header for our raw unpacker
                    (event processor) pipeline stage:

<a name="AEN6258"></a>**Example 11-9. Raw TDC unpacker (RawUnpacker.h)**
...
<a name="AEN6290"></a>**Example 11-10. v775 raw unpacker implementation includes and defs (RawUnpacker.cpp)**
...
<a name="AEN6312"></a>**Example 11-11. V775 raw unpacker - getLong utility (RawUnpacker.cpp)**
...
<a name="AEN6318"></a>**Example 11-12. V775 raw unpacker object constructor/destructor (RawUnpacker.cpp)**
...
[[x6224#v775_rawimpl_constructor]]                            The constructor is required to initialize the reference
                            ...
                            t.00 ... t.31.
                        [[x6224#v775_rawimpl_destructor]]                            If an object is ever destroyed, its tree parameter
                            array musb be destroyed as well to prevent
                            memory leaks.

<a name="AEN6331"></a>**Example 11-13. v75 raw unpacker unpacking events (RawUnpacker.cpp)**
...
[[x6224#v775_rawimpl_funtorsignature]]                            The `operator()` method
...
[[x6224#v775_rawimpl_storeparam]]                            Tree parameter array objects mimic arrays to the
                        ...
                        [[x6224#v775_rawimple_trailer]]                            The data words from the TDC should be followed by
                            a trailer.  This code asserts that this is the
                            case.

### <a name="AEN6419"></a>11.4.1.3. Adding the unpacker to the analysis pipeline
...
### <a name="AEN6441"></a>11.4.1.4. Creating raw time spectra
...
<a name="AEN6450"></a>**Example 11-14. Defining raw Time spectra the hard way.**
...
### <a name="AEN6523"></a>11.4.1.5. Building and testing what we have so far.
...
## <a name="AEN6561"></a>11.4.2. Producing parameters computed from the raw data
...
<a name="AEN6574"></a>**Example 11-15. Header for time difference event processor (Tdiff.h)**
...
<a name="AEN6587"></a>**Example 11-16. CTdiff implementation (Tdiff.cpp)**
