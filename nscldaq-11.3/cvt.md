...
<a name="AEN36934"></a>## Name

cvt -- Integer byte order conversions

<a name="AEN36937"></a>## Synopsis
...
<a name="AEN36939"></a>`void makecvtblock(
                uint32_t lsig
            , 
                uint16_t ssig
            , 
...
<a name="AEN36953"></a>`int hostsameasforeign(
                    DaqConversion* conversion
                );`

<a name="AEN36961"></a>`uint32_t ftohl(
                DaqConversion* convertdata
            , 
                uint32_t datum
            );`

<a name="AEN36972"></a>`uint16_t ftohs(
                DaqConversion* convertdata
            , 
                uint1y_t datum
            );`

<a name="AEN36983"></a>`uint32_t> htofl(
                DaqConversion* convertdata
            , 
                uint32_t datum
            );`

<a name="AEN36994"></a>`uint16_t htofs(
                DaqConversion* convertdata
            , 
                uint16_t datum
            );`

<a name="AEN37005"></a>## Description
...
<a name="AEN37017"></a>## Public functions

<a name="AEN37019"></a>`void makecvtblock(
                uint32_t lsig
            , 
                uint16_t ssig
            , 
...
<a name="AEN37041"></a>`int hostsameasforeign(
                    DaqConversion* conversion
                );`
...
<a name="AEN37051"></a>`uint32_t ftohl(
                DaqConversion* convertdata
            , 
                uint32_t datum
            );`
...
<a name="AEN37066"></a>`uint16_t ftohs(
                DaqConversion* convertdata
            , 
                uint1y_t datum
            );`
...
<a name="AEN37081"></a>`uint32_t> htofl(
                DaqConversion* convertdata
            , 
                uint32_t datum
            );`
...
<a name="AEN37096"></a>`uint16_t htofs(
                DaqConversion* convertdata
            , 
                uint16_t datum
            );`
...
<a name="AEN37111"></a>## Types and public data
