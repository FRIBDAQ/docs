...
[← Starting the GUI for the RC-bus through an MxDC device](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x7144.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and restoring state →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x7189.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/figures/MCFD16Control-enabledisable-config-0.png)
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/figures/MCFD16Control-triggerOR-config-0.png)
