...
# <a name="vmetclintro"></a>Chapter 27. Tcl access to the VME via the SBS interface
...
# <a name="AEN7722"></a>27.1. Incorporating Vme Tcl in your scripts
...
<a name="AEN7731"></a>**Example 27-1. Appending the NSCLDAQ Tcl Package repository to Tcl's search
            path**
...
<a name="AEN7735"></a>**Example 27-2. Appending NSLCDAQ's TclPackage repository to Tcl's search path**
...
<a name="AEN7739"></a>**Example 27-3. Requesting the VME Tcl package be loaded.**
