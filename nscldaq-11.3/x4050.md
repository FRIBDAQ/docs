...
[← The event logger and ReadoutShell](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4016.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Remote control package →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4440.md)
...
Besides automatically sourcing the ReadoutCallouts.tcl
                ...
                **proc**s from the packages described in
                [*ReadoutGUI API packages*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4050.md#readoutshell_api_packages).
...
The File->Library...
                ...
                [*Introduction*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r59987.md)
...
**proc**.   The parameters
                ...
                [*parameters*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r60147.md)
...
If this prompter is too simplistic, it is possible for a
                ...
                *providername*_Prompter
                ...
                (see [*start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r60174.md))
...
Not all data sources are created equal.  Thus a data source
                ...
                [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r60425.md)
...
Data sources must also provide a
                ...
                [*check*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r60203.md).
...
Data source providers must know how to end a data source.  This
                ...
                For more information see:
                [*stop*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r60235.md).
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4050.md#custom_readoutgui_pkgdir)
  This line and the next add the NSCLDAQ Tcl library
                          directory tree to the search path used by
                          **package require**.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4050.md#custom_readoutgui_instance)
  ...
  The line itself creates an instance of the class named
                          ...
                          sourcing it.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4050.md#custom_readoutgui_extend)
  Once the `ReadoutGuiApp` application
                          ...
                          [*ReadoutGUI API packages*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4050.md#readoutshell_api_packages) which
...
- bells
  This package provides the `bells`
                              ...
                              some pattern.
  See
                              [*bells*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r57366.md)
...
- Configuration
  ...
  See
                              [*Configuration*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r57487.md)
                              for reference information.
- DAQParameters
  Provides access to parameters that affect data taking.
                              ...
                              above.
  See
                              [*DAQParameters*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r57586.md)
                              for reference information.
- DataSourceManager
  ...
  See
                              [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r57764.md)
- DataSourceUI
  ...
  See
                              [*DataSourceUI*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r58016.md)
- Diagnostics
  Provides simple error/warning/info dialogs.
                              See:
                              [*Diagnostics*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r58345.md)
- ExpFileSystemConfig
  Provides read/write access to configuration parameters
                              that determine where event data and related meta-data
                              are stored.
                              See:
                              [*ExpFileSystemConfig*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r58420.md)
- ReadoutGUI
  Provides the readout GUI application class which
                              strings everything together. See
                              [*ReadoutGui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r58509.md)
- ReadoutGUIPanel
  Provides a group of API elements that allow you
                              ...
                              object.
                              See:
                              [*ReadoutGUIPanel*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r58660.md)
- RunstateMachine
  Implements the run state machine.  This also
                              provides the mechanism to register custom
                              callback bundles.
                              See:
                              [*RunStateMachine*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r58919.md)
- StateManager
  ...
  See
                              [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r59152.md)
- ui
  ...
  See
                              [*ui*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r59313.md)
