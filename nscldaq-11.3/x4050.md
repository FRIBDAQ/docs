...
# <a name="customizing_readoutshell"></a>6.4. Customizing the ReadoutShell
...
<a name="AEN4115"></a>**Table 6-2. Experiment file systems environment variables**
...
|  | In the 10.x and prior versions it was possible to separate
                    ...
                    variable.   This variable is now ignored and that theexperimentdirectory will always live in thestageareadirectory tree. |
...
<a name="AEN4136"></a>**Table 6-3. SSHPipe prompter environment variables**
...
## <a name="AEN4159"></a>6.4.2. ReadoutCallouts.tcl
...
## <a name="AEN4228"></a>6.4.3. Integrating Tcl scripts
...
Besides automatically sourcing the ReadoutCallouts.tcl
                ...
                **proc**s from the packages described in
                [[x4050#readoutshell_api_packages]].

## <a name="AEN4238"></a>6.4.4. Libraries and Data source providers
...
## <a name="AEN4318"></a>6.4.5. Using the ReadoutGUI in your own container script
...
<a name="AEN4327"></a>**Example 6-1. Custom ReadoutGUI startup script**
...
[[x4050#custom_readoutgui_extend]]                        Once the `ReadoutGuiApp` application
                        ...
                        [[x4050#readoutshell_api_packages]] which
...
## <a name="readoutshell_api_packages"></a>6.4.6. ReadoutGUI API packages
