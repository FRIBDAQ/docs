...
Besides automatically sourcing the ReadoutCallouts.tcl
                ...
                **proc**s from the packages described in
                [[*ReadoutGUI API packages*|x4050#readoutshell_api_packages]].
...
[[![(3)](../images/callouts/3.gif)|x4050#custom_readoutgui_extend]]                        Once the `ReadoutGuiApp` application
                        ...
                        [[*ReadoutGUI API packages*|x4050#readoutshell_api_packages]] which
