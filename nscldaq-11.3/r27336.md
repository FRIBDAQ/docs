...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r26531.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r27714.md)
...
<a name="AEN27475"></a>## Public member functions





- <a name="AEN27481"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN27493"></a>`bool Xtest(void);const`
...
- <a name="AEN27505"></a>`bool Qtest(void);const`
...
- <a name="AEN27522"></a>`bool TimedOut(void);const`
...
- <a name="AEN27534"></a>`bool BranchDemand(void);const`
...
- <a name="AEN27546"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN27560"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN27573"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN27587"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN27602"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN27617"></a>`bool IT4(void);const`
...
- <a name="AEN27631"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN27642"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN27655"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN27671"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN27682"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN27693"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN27703"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN27707"></a>**Example 1. Initializing branch 0**
