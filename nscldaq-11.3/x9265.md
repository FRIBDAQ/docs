...
[← Incorporating the event builder client library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9241.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Disconnecting from the event builder. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9298.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9265.md#evbc-connect-include)
  As previously described, this #include
                          is required to define the client class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9265.md#evbc-connect-hostname)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9265.md#evbc-connect-getport)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9265.md#evbc-connect-lookuperr)
  If the port cannot be looked up an exception is thrown.
                          Normally you would fill in some error reporting code here.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9265.md#evbc-connect-create)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9265.md#evbc-connect-connect)
  The `Connect` method actually attempts
                          to perform the connection to the event builder.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x9265.md#evbc-connect-connecterr)
