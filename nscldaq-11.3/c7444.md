...
[← Command line access to CAMAC via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c7418.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VMUSBReadout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c746.md)
...
The **ringtostdout** command can be used to
        ...
        [ringtostdout reference pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r12770.md).
...
The **stdintoring** command can be used to allow a
        ...
        [stdintoring reference material](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r12834.md).
