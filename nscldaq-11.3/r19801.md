...
<a name="AEN19982"></a>## Public member functions
...
<a name="AEN20200"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN20203"></a>**Example 1. Creating a begin run state transition item**
