...
[← BufferToRing](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x8046.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Overview and Examples of ring buffers in action. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x8410.md)
...
Finally, the data transferred through the ring buffer is just
      ...
      have a structure defined later in [Chapter 3](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c185.md).
