...
## <a name="AEN1151"></a>4.8.1. Writing C++ device support software
...
<a name="AEN1159"></a>**Example 4-6. Obtaning the VM-USB device driver development kit**
...
<a name="AEN1168"></a>**Example 4-7. Using a user written VMUSB driver**
...
### <a name="AEN1182"></a>4.8.1.1. The driver `onAttach` method
...
### <a name="AEN1213"></a>4.8.1.2. The driver `Initialize` method
...
<a name="AEN1230"></a>**Example 4-8. The template driver `Initialize` method**
...
### <a name="AEN1238"></a>4.8.1.3. The driver `addReadoutList` method
...
<a name="AEN1249"></a>**Example 4-9. Template Driver `addReadoutList` method**
...
[[x1146#vmusb-dtemplate-initsuccess]]                        The **load** or
                    ...
                    [[x1146#vmusb-dtemplate-endccall]]                        Ends the extern "C" {  block.

## <a name="AEN1325"></a>4.8.2. Writing device support software in Tcl
...
### <a name="AEN1345"></a>4.8.2.1. An Incr-Tcl (itcl) driver
...
<a name="AEN1348"></a>**Example 4-11. Itcl VM-USB device driver**
...
[[x1146#vmusb-itcldrv-initialize]] `Initialize` implements
                    ...
                    [[x1146#vmusb-itcldrv-vmusbreadled]]                        Invokes the `readLEDSource`
                    ...
                    [[x1146#vmusb-itcldrv-addrdolist]]                        The `addReadoutList` method
...
### <a name="AEN1436"></a>4.8.2.2. A Snit Is Not Incr Tcl (snit) driver
...
<a name="AEN1440"></a>**Example 4-12. A Snit VM-USB driver.**
...
[[x1146#vmusb-snit-constructor]] **constructor** methods are called
...
### <a name="AEN1528"></a>4.8.2.3. Using a Tcl driver in a DAQ configuration script
...
<a name="AEN1545"></a>**Example 4-13. USing a Tcl VM-USB driver.**
