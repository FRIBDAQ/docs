...
[← CIOInteractor](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r39946.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CopyrightNotice →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r40239.md)
...
[The NSCL Exception class library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c10799.md)
        chapter describes the exception class hierarchy, how to use it and
        its common set of interfaces.
        [The `CException`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r46680.md) reference
        page describes the `CException` class.
        [The `CURIFormatException`](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r47244.md)
