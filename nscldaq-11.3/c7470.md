...
[← VMUSBReadout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c746.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c7534.md)
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r13495.md).
...
<a name="AEN7484"></a>**Example 20-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN7488"></a>**Example 20-2. Dumping data from the event file segment
...
# <a name="AEN7498"></a>20.1. Item dump formats and examples
...
<a name="AEN7501"></a>**Example 20-3. State Transition items**
...
<a name="AEN7506"></a>**Example 20-4. Text List items**
...
<a name="AEN7511"></a>**Example 20-5. Incremental Scalers dump**
...
<a name="AEN7517"></a>**Example 20-6. Event count items**
...
<a name="AEN7523"></a>**Example 20-7. Physics Event items**
...
<a name="AEN7528"></a>**Example 20-8. Unknown item types**
