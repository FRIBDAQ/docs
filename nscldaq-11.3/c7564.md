...
# <a name="chapter.tclserver"></a>Chapter 22. The tcl server application
...
<a name="AEN7579"></a>**Example 22-1. Using **serverauth** to authorize a node**
...
# <a name="AEN7583"></a>22.1. Tcl server package
