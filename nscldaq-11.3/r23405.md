...
<a name="AEN23419"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN23422"></a>## Synopsis
...
<a name="AEN23424"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN23435"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN23469"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN23489"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN23535"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN23541"></a>`pGlomParameters
...
<a name="AEN23555"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN23575"></a>`pEventBuilderFragment
...
<a name="AEN23595"></a>` pPhysicsEventItem
...
<a name="AEN23615"></a>` pPhysicsEventCountItem
...
<a name="AEN23708"></a>` pStateChangeItem
...
<a name="AEN23740"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN23748"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`
...
<a name="AEN23762"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN23783"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN23838"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN23874"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN23967"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN23983"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN24010"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN24042"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN24068"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN24097"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN24245"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN24297"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN24308"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
