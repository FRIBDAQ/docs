...
<a name="AEN30462"></a>## Public member functions



<a name="AEN30467"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN30495"></a>`void  Enable(int nChannel);`
...
<a name="AEN30510"></a>`void  Disable(int nChannel);`
...
<a name="AEN30525"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN30538"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN30550"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN30562"></a>`void   SetWide (void);`
...
<a name="AEN30574"></a>`void   SetNarrow (void);`
...
<a name="AEN30585"></a>`void  EnableHeader (void);`
...
<a name="AEN30663"></a>`bool  isFull (void);`
...
<a name="AEN30675"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN30687"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN30780"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN30794"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
