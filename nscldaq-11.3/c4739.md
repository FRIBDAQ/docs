...
# <a name="AEN4739"></a>Chapter 9. Examples (Beginning 11.2-009).
...
# <a name="AEN4753"></a>9.1. ReadNSCLDAQFiles - analyze NSCLDAQ data (released 11.2-009)
...
## <a name="AEN4774"></a>9.1.1. A framework for analyzing fragments from and event
...
[[r25534]]This class provide support for iterating through
...
[[r18878]]The base class of a hierarchy of classes that
...
### <a name="AEN4885"></a>9.1.1.1. Handler registration
...
### <a name="AEN4901"></a>9.1.1.2. Ring item processing.
...
[[c4739#rideci_fragindex_info]] `FragmentIndex`, when constructed
...
## <a name="AEN5016"></a>9.1.2. Sample handlers for fragment types.
...
## <a name="AEN5224"></a>9.1.4. Suggestions for embedding the framework in SpecTcl or Root
