...
# <a name="chapter.evbcallouts-dev"></a>Chapter 64. Event builder Readout Callouts

# <a name="AEN11417"></a>64.1. Introduction
...
| --- | --- | --- |
| Prev | Home | Next |
| ringFragmentSource - a prepackaged client for ringbuffer data sources | Up | API layer |
