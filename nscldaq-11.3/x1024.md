...
As was mentioned in [[x905]], the user can pass a
...
<a name="AEN1035"></a>`uint64_t getEventTimestamp(void *pBuffer);`
...
<a name="AEN1044"></a>**Example 4-3. A sample getEventTimestamp() implementation**
...
From the [[x1018]], we know the first
...
<a name="AEN1090"></a>`uint64_t getScalerTimestamp(void *pBuffer);`

<a name="AEN1096"></a>**Example 4-4. 
...
## <a name="AEN1101"></a>4.7.3. Implementing an onBeginRun() function

The third function that can be defined in the timestamp extractor
        library has the prototype:

<a name="AEN1104"></a>`void onBeginRun(void);`
...
<a name="AEN1110"></a>**Example 4-5. Adding an offset to the timestamp**
...
### <a name="AEN1133"></a>4.7.3.1. Compiling the shared library
