...
[← Introduction](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r59987.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [start →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r60174.md)
...
Each data source managed by a data source provider is specified
            ...
            returns a Tcl
            [dict](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/dict.md) that describes the set of parameters
            expected.
