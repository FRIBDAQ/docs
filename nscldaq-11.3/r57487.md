...
[← bells](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r57366.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQParameters →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r57586.md)
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r59152.md) package for that
            instead.
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r59152.md) is a better
                          choice).
