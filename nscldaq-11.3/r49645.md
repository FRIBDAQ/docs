...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r49524.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r52409.md)
...
<a name="AEN49659"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN49662"></a>## Synopsis

```
CCCUSB
```

<a name="AEN50644"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r52894.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r52894.md) for
...
<a name="AEN51215"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN51219"></a>### Action Register
...
<a name="AEN51262"></a>### Firmware Register
...
<a name="AEN51314"></a>### Global Mode Register
...
<a name="AEN51447"></a>### Delay Register
...
<a name="AEN51480"></a>### Scaler Control register
...
<a name="AEN51513"></a>### LED Source Register
...
<a name="AEN51765"></a>### Output source selection register.
...
<a name="AEN51934"></a>### Device source register
...
<a name="AEN52287"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN52348"></a>### Transfer setup register
