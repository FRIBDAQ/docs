...
[← The actions library](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c12086.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCUSBReadout →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c2296.md)
...
Reference material is provided in in the 3daq section that describes the
    ...
    the data format can be is provided [here](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c8508.md).
