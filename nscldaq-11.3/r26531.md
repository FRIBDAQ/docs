...
<a name="AEN26545"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN26548"></a>## Synopsis
...
<a name="AEN26774"></a>## Public member functions





<a name="AEN26780"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN26842"></a>`unsigned long getBase(void);`
...
<a name="AEN26853"></a>`int getSerial(void);`
...
<a name="AEN26884"></a>`int  getFirmware(void);`
...
<a name="AEN26894"></a>`int  getCrate(void);`
...
<a name="AEN26905"></a>`void setCrate(int crateNum);`
...
<a name="AEN26918"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN26939"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN26949"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN26959"></a>`void keepOverflowData(void);`
...
<a name="AEN26969"></a>`void discardOverflowData(void);`
...
<a name="AEN26979"></a>`void keepInvalidData(void);`
...
<a name="AEN26990"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN27001"></a>`void commonStart(void);`
...
<a name="AEN27012"></a>`void commonStop(void);`
...
<a name="AEN27023"></a>`void setRange(int range);`
...
<a name="AEN27036"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN27108"></a>`void clearData
                                (void);`
...
<a name="AEN27151"></a>`bool Busy(void);`
...
<a name="AEN27162"></a>` bool gBusy(void);`
...
<a name="AEN27173"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN27184"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN27195"></a>`int readEvent(void* buf);`
...
<a name="AEN27208"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN27249"></a>`void enableSmallThresholds(void);`
...
<a name="AEN27312"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN27316"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN27320"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN27324"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN27328"></a>**Example 3. Reading out a CAEN 785 e.g.**
