...
# <a name="AEN4467"></a>7.1. Introduction
...
The client programs that submit data to the server are built using the
      [[c11056]]. In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [[x11322]] program. This
