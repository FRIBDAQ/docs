...
For reference information on this class see:
            ...
            via the [[CDocumentedPacket(3sbsreadout)|r79581]].
            The [[CEventPacket(3sbsreadout)|r79854]]
...
For reference information about the `CCompoundEventSegment`
            class see
            [[CCompoundEventSegment(3sbsreadout)|r79301]].

The readout software has a single object from the
            [[CExperiment(3sbsreadout)|r80303]]
...
See the section:
            [[Modifying the skeleton application to meet your needs|x11899]]
...
- [[![(1)](../images/callouts/1.gif)|c11478#specialring-normal-stuff]]
...
- [[![(2)](../images/callouts/2.gif)|c11478#specialring-getring]]
...
- [[![(1)](../images/callouts/1.gif)|c11478#specialring_getevtcount]]
  To set up for the loop that emits ring items we first
                          fetch the number of events that have been read.
- [[![(2)](../images/callouts/2.gif)|c11478#specialring_geteventinfo]]
  This section of code gets the informatino about the event
                          ...
                          variable.
- [[![(3)](../images/callouts/3.gif)|c11478#specialring_makeitem]]
...
- [[![(4)](../images/callouts/4.gif)|c11478#specialring_fillitem]]
  The `getBodyCursor` method
                          ...
                          event data.
- [[![(5)](../images/callouts/5.gif)|c11478#specialring_updatecursor]]
  This line computes a pointer to the first unused byte
                          ...
                          to put its data.
- [[![(6)](../images/callouts/6.gif)|c11478#specialring_commit]]
...
- [[![(7)](../images/callouts/7.gif)|c11478#specialring_bookkeeping]]
