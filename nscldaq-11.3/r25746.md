...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r25903]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r25903]].
...
[[portAllocator(3tcl)|r75432]],
            [[CPortManagerException(3daq)|r25903]],
            [[DaqPortManager(1tcl)|r16484]]
