...
[← Compatibility utilities](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c7946.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The epics display utility →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c8089.md)
...
controlpush
      ...
      [the controlpush manpage](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r14079.md).

The intent is that 
      controlpush be pointed at a 
      TclServer.
[The TclServer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c7564.md)
...
You can use 
      ...
      system parameters. 
      [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c8089.md) is an example
