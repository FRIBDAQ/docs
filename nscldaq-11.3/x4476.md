...
[← Remote control package](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4440.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [More detail on when the fragments are ouptutted →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x4503.md)
...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/c11415.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r56539.md).
...
The next thing that you need to do is register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/x11322.md).
