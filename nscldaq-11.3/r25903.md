...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r25746.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CADC2530 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r26059.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r25746.md)).
        Since it  is  derived
       from
       `CException`,
...
[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r75432.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r25746.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r16484.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.3/r46680.md)
