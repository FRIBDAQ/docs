...
[← EVBC::flush](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53916.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [StateManager →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53976.md)
...
Starts a fragment source that gets is data from a ring buffer.  For
            ...
            [*ringFragmentSource - a prepackaged client for ringbuffer data sources*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10763.md)
...
- *extractor-lib*
  Specifies the file system path to the shared object
                              ...
                              [*Writing and building timestamp extractors.*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10763.md#sec_tsextractors)
