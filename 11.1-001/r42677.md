...
[← CStateException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42675.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLLiveEventLoop →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42694.md)
...
<a name="AEN42681"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN42684"></a>## Synopsis

```
CStateException
```

<a name="AEN42714"></a>## Description
...
<a name="AEN42724"></a>## Public member functions
