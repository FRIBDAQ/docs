...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r24739.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25355.md)
...
<a name="AEN25477"></a>## Public member functions





- <a name="AEN25483"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25495"></a>`bool Xtest(void);const`
...
- <a name="AEN25507"></a>`bool Qtest(void);const`
...
- <a name="AEN25524"></a>`bool TimedOut(void);const`
...
- <a name="AEN25536"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25548"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25562"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25575"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25589"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25604"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25619"></a>`bool IT4(void);const`
...
- <a name="AEN25633"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25644"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25657"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25673"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25684"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25695"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25705"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25709"></a>**Example 1. Initializing branch 0**
