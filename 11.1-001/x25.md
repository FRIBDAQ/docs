...
[← Writing device support software](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x2378.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Tcl device driver support →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x2537.md)
...
With any experiment, it is paramount to understand quickly whether the
      ...
      inspection. The most basic and useful is the [dumper](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6917.md) program, which provides a textual
      ...
      are higher level tools though such as the [ScalerDisplay](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c4575.md) program. The
...
The fact that ring buffers lie on either side of each process allows the
      ...
      information. Other tools like the [ringbuffer](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12002.md) program provide
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/figures/intro-data-flow-diagram-diagnostics.png)
