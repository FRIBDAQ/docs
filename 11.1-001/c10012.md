...
[← Compiling/Linking your software with the shared memory API](https://github.com/FRIBDAQ/docs/tree/main/11.1/x9976.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [C++ encapsulation of a Tcl API subset →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10019.md)
