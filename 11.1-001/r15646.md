...
[← cesbcnaf](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15643.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SBS Vme Tcl package →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15653.md)
...
<a name="AEN15650"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN15653"></a>## Synopsis
...
<a name="AEN15708"></a>### Map access command
...
<a name="AEN15718"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN15726"></a>***mapname* put *width offset value***
