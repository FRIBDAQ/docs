...
<a name="AEN50027"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN50030"></a>## Synopsis
...
<a name="AEN50199"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r45037]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r50748]])
...
<a name="AEN50207"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r50748]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r50748]] for
...
<a name="AEN50659"></a>## DEVICE ENUMERATION
...
<a name="AEN50683"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN50693"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN50699"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r48256]] for reference
...
<a name="AEN50742"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r45037]]
[[cccusbreadoutlist(3ccusb)|r50748]]
[[CCCUSBReadoutList(3ccusb)|r48256]]
