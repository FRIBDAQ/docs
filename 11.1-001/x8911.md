...
[← Callbacks](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8881.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [How do I use it? →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8918.md)

---

---

# <a name="AEN8911"></a>42.2. How do I use it?
...
<a name="AEN8926"></a>**Example 42-1. Processing ring items in Tcl.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8911.md#tclring_attach)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8911.md#tclring_get)
  ...
  The next matching ring items is translated to a dict (see
  	  ...
  	  command.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8911.md#tclring_detach)
  Once processing is done, the ring is detached.  Once detached,
  	  it is no longer available for use in a **ring get**
  	  command.

For reference information see:
      [*TclRingBuffer*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r68392.md)
