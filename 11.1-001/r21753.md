...
[← format  Functions](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r21751.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [format  Functions →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r21937.md)
...
<a name="AEN21757"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN21760"></a>## Synopsis
...
<a name="AEN21762"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN21773"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN21807"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN21827"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN21873"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN21879"></a>`pGlomParameters
...
<a name="AEN21913"></a>`pEventBuilderFragment
...
<a name="AEN21933"></a>` pPhysicsEventItem
...
<a name="AEN21953"></a>` pPhysicsEventCountItem
...
<a name="AEN22046"></a>` pStateChangeItem
...
<a name="AEN22078"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22086"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22092"></a>## DESCRIPTION
...
- <a name="AEN22100"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN22121"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN22176"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN22212"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN22252"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN22305"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN22321"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN22348"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN22380"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN22406"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN22435"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN22583"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN22635"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN22646"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
