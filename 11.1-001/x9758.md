...
[← Authenticators](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9751.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Authenticators →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9759.md)

---

---

# <a name="AEN9758"></a>50.2. Authenticators
...
<a name="AEN9762"></a>**Example 50-3. Boilerplate DAQ Authorization code **
...
The complete definitinon of
            ...
            [its reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36036.md).
            The library provides the following concrete authentication classes:



- [`CPasswordCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36140.md)
...
- [`CUnixUserCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36328.md)
  The entity must provide a valid username and password
                          that is could login to the local unix system.
- [`CTclAccesListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36539.md)
...
- [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36637.md)
  The entity must supply a string that is one of a set of strings
                              given to the authenticator.
- [`CHostListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36779.md)
