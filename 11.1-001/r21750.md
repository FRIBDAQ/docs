...
[← format  Functions](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r21743.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [format  Functions →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r21751.md)
...
<a name="AEN21754"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN21757"></a>## Synopsis
...
<a name="AEN21759"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN21770"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN21804"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN21824"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN21870"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN21876"></a>`pGlomParameters
...
<a name="AEN21890"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN21910"></a>`pEventBuilderFragment
...
<a name="AEN21930"></a>` pPhysicsEventItem
...
<a name="AEN21950"></a>` pPhysicsEventCountItem
...
<a name="AEN22043"></a>` pStateChangeItem
...
<a name="AEN22075"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22083"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22089"></a>## DESCRIPTION
...
- <a name="AEN22097"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN22118"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN22173"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN22209"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN22249"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN22302"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN22318"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN22345"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN22377"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN22403"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN22432"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN22580"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN22632"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN22643"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
