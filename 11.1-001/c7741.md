...
[← Ring master class library.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7733.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Networked ring buffer access →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7748.md)
...
<a name="AEN7749"></a>**Example 37-1. A sample ring specification in URI form**
...
<a name="AEN7757"></a>**Example 37-2. Substituting local host for the hostname in URI's**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7741.md#chapter.ringaccess.hostname)
  This section of code determines the name of the host.
                  For spdaq20.nscl.msu.edu e.g., this will
                  fill `localhost` with
                  localhost
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7741.md#chapter.ringaccess.domain)
  This section of code determines DNS domain name of the system.
                  For spdaq20.nscl.msu.edu
  `domain` gets filled with the string
                  nscl.msu.edu.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7741.md#chapter.ringaccess.islocal)
  This section of code considers the case that
                  ...
                  *fully qualified host name*
                  ...
                  the `ring`
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7741.md#chapter.ringaccess.builduri)
...
<a name="AEN7789"></a>**Example 37-3. Including the header**
...
<a name="AEN7792"></a>**Example 37-4. Compiling code that uses `CRingAccess`**
...
<a name="AEN7796"></a>**Example 37-5. Linking code that uses `CRingAccess`**
...
[Remote Ring Access](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16355.md) provides
