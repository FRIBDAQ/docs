...
[← gdgwidget](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r69963.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VhsWidgets →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70003.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70268.md)
        for one such panel.
...
<a name="AEN70039"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN70043"></a>### VhsWidgets::channel
...
<a name="AEN70063"></a>### VhsWidgets::channelStatus options
...
<a name="AEN70069"></a>## OBJECT METHODS
...
<a name="AEN70073"></a>**Example 1. Hooking update methods to recurring timer**
