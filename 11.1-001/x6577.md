...
[← Starting the GUI for USB communication](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6576.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for USB communication →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6579.md)

---

---

# <a name="AEN6577"></a>12.2. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN6587"></a>**Figure 12-1. The MCFD16Control Graphical User Interface for USB**
