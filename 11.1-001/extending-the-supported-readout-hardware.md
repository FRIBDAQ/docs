...
## <a name="AEN1144"></a>4.8.1. Writing C++ device support software
...
<a name="AEN1152"></a>**Example 4-6. Obtaning the VM-USB device driver development kit**
...
<a name="AEN1161"></a>**Example 4-7. Using a user written VMUSB driver**
...
### <a name="AEN1175"></a>4.8.1.1. The driver `onAttach` method
...
### <a name="AEN1206"></a>4.8.1.2. The driver `Initialize` method
...
<a name="AEN1223"></a>**Example 4-8. The template driver `Initialize` method**
...
### <a name="AEN1231"></a>4.8.1.3. The driver `addReadoutList` method
...
<a name="AEN1242"></a>**Example 4-9. Template Driver `addReadoutList` method**
...
[[x1139#vmusb-dtemplate-initsuccess]]                        The **load** or
                    ...
                    [[x1139#vmusb-dtemplate-endccall]]                        Ends the extern "C" {  block.

## <a name="AEN1318"></a>4.8.2. Writing device support software in Tcl
...
### <a name="AEN1338"></a>4.8.2.1. An Incr-Tcl (itcl) driver
...
<a name="AEN1341"></a>**Example 4-11. Itcl VM-USB device driver**
...
[[x1139#vmusb-itcldrv-initialize]] `Initialize` implements
                    ...
                    [[x1139#vmusb-itcldrv-vmusbreadled]]                        Invokes the `readLEDSource`
                    ...
                    [[x1139#vmusb-itcldrv-addrdolist]]                        The `addReadoutList` method
...
### <a name="AEN1429"></a>4.8.2.2. A Snit Is Not Incr Tcl (snit) driver
...
<a name="AEN1433"></a>**Example 4-12. A Snit VM-USB driver.**
...
[[x1139#vmusb-snit-constructor]] **constructor** methods are called
...
### <a name="AEN1521"></a>4.8.2.3. Using a Tcl driver in a DAQ configuration script
...
<a name="AEN1538"></a>**Example 4-13. USing a Tcl VM-USB driver.**
