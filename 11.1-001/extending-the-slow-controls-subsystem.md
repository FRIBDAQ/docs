...
### <a name="AEN1591"></a>4.9.1.1. Driver requirements

A Slow controls device driver is a class that is derived from
          the 
          [[r66176]] abstract base class.
...
The [[r66176]] class is an abstract
...
#### <a name="AEN1719"></a>4.9.1.1.1. The driver
...
<a name="AEN1722"></a>**Example 4-14. Control driver headers**
...
<a name="AEN1741"></a>**Example 4-15. Control driver class definition**
...
<a name="AEN1748"></a>**Example 4-16. Control driver constructor**
...
<a name="AEN1752"></a>**Example 4-17. Control driver `onAttach` method**
...
[[x1552#ctldriver-onattach-saveconfig]]		  The base class (`CControlHardware`) 
...
<a name="AEN1775"></a>**Example 4-18. Control driver `Update`**
...
<a name="AEN1787"></a>**Example 4-19. Control driver `Set` method.**
...
<a name="AEN1837"></a>**Example 4-20. Control driver `Get` method**
...
<a name="AEN1871"></a>**Example 4-21. Control driver `clone` method**
...
#### <a name="AEN1882"></a>4.9.1.1.2. The creator
...
<a name="AEN1885"></a>**Example 4-22. Control driver creator**
...
<a name="AEN1920"></a>**Example 4-23. Control driver initialization**
...
[[x1552#ctldriver-init-cbinding]]		    The Tcl interpreter needs to be able to compute
		  ...
		  [[x1552#ctldriver-init-factget]]		    The main work of the intitialization function is to register
		    ...
		    of the factory.
		  [[x1552#ctldriver-init-creator]]		    Registers the new creator object associating it with the
		    module type mydriver
[[x1552#ctldriver-init-status]]		    Returns a normal status value.

#### <a name="AEN1964"></a>4.9.1.1.4. Building the driver and using it.
...
<a name="AEN2032"></a>**Example 4-24. Control drivers - structure of a Tcl driver**
...
### <a name="AEN2079"></a>4.9.2.1. Initialize

The full implementation of the `Initialize` is shown
	  below:

<a name="AEN2083"></a>**Example 4-25. Tcl control driver `Initialize` method**
...
### <a name="AEN2112"></a>4.9.2.3. The Set method
...
<a name="AEN2116"></a>**Example 4-27. Tcl control driver `Set` method**
...
### <a name="AEN2136"></a>4.9.2.4. The Get method
...
<a name="AEN2139"></a>**Example 4-28. Tcl control driver `Get` method**
...
### <a name="AEN2154"></a>4.9.2.5. The addMonitorList method

Since we are not using monitor lists, this method is trivial:

<a name="AEN2157"></a>**Example 4-29. Tcl control drer `addMonitorList` method**
...
### <a name="AEN2164"></a>4.9.2.6. The processMonitorList method
...
<a name="AEN2168"></a>**Example 4-30. Tcl control driver `processMonitorList` method**
...
### <a name="AEN2172"></a>4.9.2.7. The getMonitoredData method
...
<a name="AEN2180"></a>**Example 4-31. Tcl control driver `getMonitoredData` method**
...
### <a name="AEN2184"></a>4.9.2.8. Validating the command options
...
<a name="AEN2193"></a>**Example 4-32. Tcl control driver validation**
