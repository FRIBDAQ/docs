...
[← 3provider](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54811.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [parameters →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54961.md)
...
<a name="AEN54825"></a>## Name

Introduction -- Data source providers

<a name="AEN54828"></a>## Synopsis
...
Data source providers are Tcl loadable packages that provide
            ...
            [*SSHPipe*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55278.md)
            which understands how to run command line readout programs on the end
            of a SSH pipeline to a (possibily) remote system, and
            [*s800*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55388.md) which
...
<a name="AEN54881"></a>## CREATING A DATA SOURCE PROVIDER
...
<a name="AEN54898"></a>## API FUNCTIONS
...
- **begin** *sourceId runNumber title*
  Starts data taking for a new run.
                              See [*begin*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55082.md)
                              for reference information.
- **pause** *sourceId*
  If your data source implements pause/resume functionality
                              you must define this command to pause the run.
                              See the 
                              [*pause*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55111.md)
                              reference material for more information.
- **resume** *sourceId*
  If your data source implements pause/resume functionality
                              you must implement
                              [*resume*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55146.md)
                              to resume paused runs.
- **end** *sourceId*
  The
                              [*end*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55177.md)
                              ends a run in a data source.
- **init** *sourceId*
  The
                              [*init*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55204.md)
