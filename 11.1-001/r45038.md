...
[← CCCUSB](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r45037.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSB →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r45040.md)
...
<a name="AEN45042"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45045"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46027"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48257.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48257.md) for
...
<a name="AEN46598"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46602"></a>### Action Register
...
<a name="AEN46645"></a>### Firmware Register
...
<a name="AEN46697"></a>### Global Mode Register
...
<a name="AEN46830"></a>### Delay Register
...
<a name="AEN46863"></a>### Scaler Control register
...
<a name="AEN46896"></a>### LED Source Register
...
<a name="AEN47148"></a>### Output source selection register.
...
<a name="AEN47317"></a>### Device source register
...
<a name="AEN47670"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47731"></a>### Transfer setup register
