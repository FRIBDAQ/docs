...
[← CCCUSB](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r45030.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSB →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r45038.md)
...
<a name="AEN45041"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45044"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46026"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48256.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48256.md) for
...
<a name="AEN46597"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46601"></a>### Action Register
...
<a name="AEN46644"></a>### Firmware Register
...
<a name="AEN46696"></a>### Global Mode Register
...
<a name="AEN46829"></a>### Delay Register
...
<a name="AEN46862"></a>### Scaler Control register
...
<a name="AEN46895"></a>### LED Source Register
...
<a name="AEN47147"></a>### Output source selection register.
...
<a name="AEN47316"></a>### Device source register
...
<a name="AEN47669"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47730"></a>### Transfer setup register
