...
[← ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11937.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ringtostdout →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11940.md)
...
<a name="AEN11986"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN11989"></a>**Example 1. making hex dumps of data from a ring buffer.**
