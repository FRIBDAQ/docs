...
[← CVME](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r31852.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r31860.md)
...
<a name="AEN31863"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN31866"></a>## Synopsis
...
<a name="AEN31973"></a>## Public member functions



- <a name="AEN31978"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN32016"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN32031"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN32044"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN32057"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN32102"></a>`T*  T* operator-> (void);`
...
- <a name="AEN32112"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN32139"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN32151"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32163"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN32173"></a>## Types and public data
