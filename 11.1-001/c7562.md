...
[← The RingMaster server](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7560.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The RingMaster server →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7564.md)
...
# <a name="AEN7575"></a>34.1. The RingMaster Protocol
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [Service Port Manager](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7713.md)
            chapter.
...
<a name="AEN7597"></a>**Example 34-1. The CONNECT message format**
...
<a name="AEN7612"></a>**Example 34-2. Format of the DISCONNECT message**
...
<a name="AEN7626"></a>**Example 34-3. Format of the LIST command**
...
Each element of the list reports on the usage of a single ring.
            ...
            [Tcl ring package's ringbuffer
                usage](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16558.md) command.
...
<a name="AEN7678"></a>**Example 34-4. Format of the REGISTER command**
...
<a name="AEN7688"></a>**Example 34-5. Format of the UNREGISTER message**
...
<a name="AEN7699"></a>**Example 34-6. Format of the REMOTE message**
