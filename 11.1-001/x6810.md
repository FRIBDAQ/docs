...
[← Overview of Functionality](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6808.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Saved File →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6811.md)

---

---

# <a name="AEN6810"></a>15.5. The Saved File
...
As has already been described, the XLM72GateDelayControl GUI can write 
      ...
      a TCL array whose name is "gd16" with a series of array elements. A sample
      output file is included below:
