...
<a name="AEN23561"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN23564"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN23594"></a>## DESCRIPTION
...
<a name="AEN23656"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
