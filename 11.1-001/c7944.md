...
[← Data Format Support Software](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7937.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Data Format Support Software →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7945.md)
...
In the user guide section on [data
      formats](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c183.md), the format of all the ring items were explained in
...
# <a name="AEN7959"></a>40.1. The basic data formats
...
<a name="AEN8045"></a>`pDataFormatformatDataFormat
          (void);`


<a name="AEN8051"></a>`pGlomParameters
...
<a name="AEN8065"></a>`pEventBuilderFragment
            formatEVBFragment
          (
            uint64_t timestamp
          , 
...
<a name="AEN8085"></a>`pEventBuilderFragment
...
<a name="AEN8105"></a>` pPhysicsEventItem
...
<a name="AEN8125"></a>` pPhysicsEventCountItem
...
<a name="AEN8218"></a>` pStateChangeItem
...
<a name="AEN8250"></a>` void* bodyPointer
          (
            pRingItem pItem
          );`
...
## <a name="AEN8259"></a>40.1.1. State Change Items
...
## <a name="AEN8299"></a>40.1.2. Text List Items
...
## <a name="AEN8348"></a>40.1.3. Scaler Items
...
## <a name="AEN8381"></a>40.1.4. Event Data Items
...
## <a name="AEN8388"></a>40.1.5. Event count items
