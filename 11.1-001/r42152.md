...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42145.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42153.md)
...
<a name="AEN42252"></a>## Public member functions
...
<a name="AEN42363"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN42368"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r41429.md)
