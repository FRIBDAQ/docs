...
[← CCAENV1x90](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25716.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25724.md)
...
<a name="AEN26245"></a>## Public member functions
...
- <a name="AEN26252"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN26273"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN26286"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN26311"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN26322"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN26655"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN26668"></a>` ECLOutputSelect
...
- <a name="AEN26736"></a>` unsigned short
...
- <a name="AEN26900"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN26912"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN26922"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN26932"></a>` TriggerConfiguration
...
- <a name="AEN27029"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN27053"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN27070"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN27096"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN27110"></a>` PWResolution
...
- <a name="AEN27270"></a>` unsigned short
...
- <a name="AEN27318"></a>` void
  ...
  Disables the specified channel.  Note that channel numbering
                              ...
                              about this.
- <a name="AEN27330"></a>` void EnableAllChannels(void);`
...
- <a name="AEN27364"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN27376"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN27393"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN27406"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN27418"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN27439"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN27451"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27466"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27481"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27496"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN27508"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN27523"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN27533"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN27545"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN27557"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN27569"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN27581"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN27591"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN27601"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN27611"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN27621"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN27633"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN27643"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN27653"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN27663"></a>` void EnableBypassOnError(void);`
- <a name="AEN27673"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN27683"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN27695"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN27705"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN27717"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN27727"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN27739"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN27751"></a>` void EnableAllChannels(void);`
- <a name="AEN27761"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN27771"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN27783"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN27795"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN27810"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN27822"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN27834"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN27855"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN27868"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN27885"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN27903"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN27918"></a>## Types and public data
