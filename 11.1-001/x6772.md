...
[← Setting up an XLM72 as a gate delay generator for remote control](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6771.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Setting up an XLM72 as a gate delay generator for remote control →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6774.md)

---

---

# <a name="AEN6772"></a>15.2. Setting up an XLM72 as a gate delay generator for remote control
