...
[← pause](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55108.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [pause →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55111.md)
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55229.md) specifies  the
            provider is unable to pause runs, the provider need not implement
            either this proc or the
            [*resume*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55144.md)
