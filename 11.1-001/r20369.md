...
[← CGlomParameters](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r20305.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAbnormaEndItem →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r20376.md)
...
<a name="AEN20381"></a>## Name

CAbnormalEndItem -- Abnormal end of run.

<a name="AEN20384"></a>## Synopsis

```
CAbnormalEnditem
```

<a name="AEN20458"></a>## DESCRIPTION

Provides a class for objects that represent abnormal end of run
            ring items.

<a name="AEN20461"></a>## METHODS
