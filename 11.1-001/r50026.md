...
<a name="AEN50030"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN50033"></a>## Synopsis
...
<a name="AEN50202"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r45040]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r50751]])
...
<a name="AEN50210"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r50751]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r50751]] for
...
<a name="AEN50662"></a>## DEVICE ENUMERATION
...
<a name="AEN50686"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN50696"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN50702"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r48259]] for reference
...
<a name="AEN50745"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r45040]]
[[cccusbreadoutlist(3ccusb)|r50751]]
[[CCCUSBReadoutList(3ccusb)|r48259]]
