...
[← CriticalSection](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35462.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCondition →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35485.md)
...
<a name="AEN35476"></a>## Name

CriticalSection -- Simple, safe critical section

<a name="AEN35479"></a>## Synopsis

```
CriticalSection
```

<a name="AEN35488"></a>## DESCRIPTION
