...
[← 1epics](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12969.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1epics →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12971.md)
...
<a name="AEN13052"></a>## CONFIGURATION FILES
...
Channel lines, have as their first non-whitespace word, the name of
	   ...
	   (notably
	   [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7525.md)) may 
	   parse additional characters for their own purposes.

<a name="AEN13060"></a>## DEPENDENCIES
