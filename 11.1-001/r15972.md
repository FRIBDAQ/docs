...
<a name="AEN16017"></a>### Configuration Options
...
<a name="AEN16041"></a>### Device Options
...
<a name="AEN16071"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN16087"></a>```
...
Retrieve the ID code for the board above<a name="AEN16092"></a>```
...
Load firmware and license it.<a name="AEN16099"></a>```
...
Retrieve license information from a digitizer.<a name="AEN16107"></a>```
...
Un-license a digitizer's firmware:<a name="AEN16112"></a>```
