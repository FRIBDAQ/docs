...
[← CURIFormatException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42929.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CURIFormatException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42937.md)
...
<a name="AEN42940"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN42943"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN43027"></a>## Description
...
<a name="AEN43034"></a>## Public member functions
