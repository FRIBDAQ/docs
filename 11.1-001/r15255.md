...
[← tclserver](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15254.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [tclserver →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15257.md)
...
<a name="AEN15259"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN15262"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN15269"></a>## DESCRIPTION
