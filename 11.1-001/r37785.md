...
[← CDAQShm](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37784.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDAQShm →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37787.md)
...
<a name="AEN37789"></a>## Name

CDAQShm -- class description

<a name="AEN37792"></a>## Synopsis

```
CDAQShm
```

<a name="AEN37907"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37785.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37785.md#daqshm-varsrefsect).
