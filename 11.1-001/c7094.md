...
[← N568B CAENnet shaping amplifier](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7071.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VHS-40xxx SBS support. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7101.md)
...
- [iSegVhs](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r69458.md)
  Provides a tcl package forlow level support fo the
                      modules including
                      the ability to program the base address of the module.
- [VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r69962.md)
  ...
  This separation allows you to build custom applications
                      ...
                      elements.
- [vhsPanel](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15576.md)
