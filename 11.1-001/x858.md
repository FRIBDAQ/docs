...
[← Creating ring items](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8554.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Slow-Controls Subsystem →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x860.md)
...
If a user wants to write their own module for the slow-controls subsystem,
      ...
      [*Extending the slow controls subsystem*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x1550.md).
...
There are numerous slow-controls modules availabe for use with the
        Module command (see [Module(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r65701.md)). Because of its
...
- `CVMUSBReadoutList`
  Instances of this class represent lists of VME operations you want
                to perform via the server.  See [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r60821.md) for reference
                information.
- `CVMUSBRemote`
  ...
  See [*CVMUSBRemote*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r61716.md)
