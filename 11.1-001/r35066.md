...
[← Thread](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35028.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35073.md)
...
<a name="AEN35070"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35073"></a>## Synopsis
...
<a name="AEN35115"></a>## Public member functions
...
<a name="AEN35153"></a>`void sync_self(void);`
...
<a name="AEN35160"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35168"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35180"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35186"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35196"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35226"></a>`void sync_global_end(void);`
