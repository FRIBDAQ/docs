...
<a name="AEN24557"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24560"></a>## Synopsis
...
<a name="AEN24786"></a>## Public member functions





<a name="AEN24792"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24854"></a>`unsigned long getBase(void);`
...
<a name="AEN24865"></a>`int getSerial(void);`
...
<a name="AEN24896"></a>`int  getFirmware(void);`
...
<a name="AEN24906"></a>`int  getCrate(void);`
...
<a name="AEN24917"></a>`void setCrate(int crateNum);`
...
<a name="AEN24930"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24951"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24961"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24971"></a>`void keepOverflowData(void);`
...
<a name="AEN24981"></a>`void discardOverflowData(void);`
...
<a name="AEN24991"></a>`void keepInvalidData(void);`
...
<a name="AEN25002"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN25013"></a>`void commonStart(void);`
...
<a name="AEN25024"></a>`void commonStop(void);`
...
<a name="AEN25035"></a>`void setRange(int range);`
...
<a name="AEN25048"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25120"></a>`void clearData
                                (void);`
...
<a name="AEN25163"></a>`bool Busy(void);`
...
<a name="AEN25174"></a>` bool gBusy(void);`
...
<a name="AEN25185"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25196"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25207"></a>`int readEvent(void* buf);`
...
<a name="AEN25220"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25261"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25324"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25328"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25332"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25336"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25340"></a>**Example 3. Reading out a CAEN 785 e.g.**
