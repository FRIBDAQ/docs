...
[← The dumper program](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6913.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The dumper program →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6917.md)
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12598.md).
...
<a name="AEN6929"></a>**Example 19-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN6933"></a>**Example 19-2. Dumping data from the event file segment
...
# <a name="AEN6943"></a>19.1. Item dump formats and examples
...
<a name="AEN6946"></a>**Example 19-3. State Transition items**
...
<a name="AEN6951"></a>**Example 19-4. Text List items**
...
<a name="AEN6956"></a>**Example 19-5. Incremental Scalers dump**
...
<a name="AEN6962"></a>**Example 19-6. Event count items**
...
<a name="AEN6968"></a>**Example 19-7. Physics Event items**
...
<a name="AEN6973"></a>**Example 19-8. Unknown item types**
