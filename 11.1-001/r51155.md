...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51148.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51156.md)
...
<a name="AEN51159"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN51162"></a>## Synopsis

```
CControlHardware
```

<a name="AEN51229"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51015.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51112.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN51236"></a>## METHODS
