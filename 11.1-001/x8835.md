...
[← Sending data to the event builder.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8757.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event orderer/event builder API →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8842.md)

---

---

# <a name="AEN8835"></a>41.6. The Event orderer/event builder API
...
## <a name="AEN8843"></a>41.6.1. Starting the event builder/orderer
...
<a name="AEN8846"></a>**Example 41-3. Starting the event builder**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8835.md#evb_start_ap)
  Adds the Tcl Library directory of the NSCLDAQ to the
                          ...
                          tclsh or
                          wish starts.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8835.md#evb_start_require)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8835.md#evb_start_start)
