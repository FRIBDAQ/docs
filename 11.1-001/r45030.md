...
[← CURIFormatException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44944.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSB →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r45037.md)
...
<a name="AEN45034"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45037"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46019"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48249.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48249.md) for
...
<a name="AEN46590"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46594"></a>### Action Register
...
<a name="AEN46637"></a>### Firmware Register
...
<a name="AEN46689"></a>### Global Mode Register
...
<a name="AEN46822"></a>### Delay Register
...
<a name="AEN46855"></a>### Scaler Control register
...
<a name="AEN46888"></a>### LED Source Register
...
<a name="AEN47140"></a>### Output source selection register.
...
<a name="AEN47309"></a>### Device source register
...
<a name="AEN47662"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47723"></a>### Transfer setup register
