...
[← CStateException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42674.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStateException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42677.md)
...
<a name="AEN42679"></a>## Name

CStateException -- Exception for invalid state transitions.

<a name="AEN42682"></a>## Synopsis

```
CStateException
```

<a name="AEN42712"></a>## Description
...
<a name="AEN42722"></a>## Public member functions
