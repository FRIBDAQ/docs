...
<a name="AEN24567"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24570"></a>## Synopsis
...
<a name="AEN24796"></a>## Public member functions





<a name="AEN24802"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24864"></a>`unsigned long getBase(void);`
...
<a name="AEN24875"></a>`int getSerial(void);`
...
<a name="AEN24906"></a>`int  getFirmware(void);`
...
<a name="AEN24916"></a>`int  getCrate(void);`
...
<a name="AEN24927"></a>`void setCrate(int crateNum);`
...
<a name="AEN24940"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24961"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24971"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24981"></a>`void keepOverflowData(void);`
...
<a name="AEN24991"></a>`void discardOverflowData(void);`
...
<a name="AEN25001"></a>`void keepInvalidData(void);`
...
<a name="AEN25012"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN25023"></a>`void commonStart(void);`
...
<a name="AEN25034"></a>`void commonStop(void);`
...
<a name="AEN25045"></a>`void setRange(int range);`
...
<a name="AEN25058"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25130"></a>`void clearData
                                (void);`
...
<a name="AEN25173"></a>`bool Busy(void);`
...
<a name="AEN25184"></a>` bool gBusy(void);`
...
<a name="AEN25195"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25206"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25217"></a>`int readEvent(void* buf);`
...
<a name="AEN25230"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25271"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25334"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25338"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25342"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25346"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25350"></a>**Example 3. Reading out a CAEN 785 e.g.**
