...
[← Starting the GUI for USB communication](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6577.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for the RC-bus through an MxDC device →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6593.md)

---

---

# <a name="AEN6579"></a>12.2. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN6589"></a>**Figure 12-1. The MCFD16Control Graphical User Interface for USB**
   ![](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/figures/MCFD16Control-USBHowTo-0.png)
