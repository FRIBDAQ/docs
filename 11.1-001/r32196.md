...
[← CVME](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r32046.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEScalerLRS1151 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r32203.md)
...
<a name="AEN32239"></a>## Public member functions
...
<a name="AEN32277"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN32280"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
