...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36532.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTclAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36540.md)
...
<a name="AEN36581"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10019.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r38329.md).
...
`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10019.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r39059.md).
...
<a name="AEN36631"></a>## Types and public data

`CTCLInterpreter`
            and
            `CTCLVariable`
            are objects that are part of the Tcl++ library. See the
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10019.md) of the
