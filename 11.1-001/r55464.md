...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55462.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3python →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55469.md)
...
<a name="AEN55476"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN55479"></a>## Synopsis
...
<a name="AEN55493"></a>## METHODS



- <a name="AEN55498"></a>`PortManager(string host, int    port);`
