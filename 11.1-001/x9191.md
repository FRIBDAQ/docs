...
[← A simple example](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9101.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [An overview of the use of the camac package →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9198.md)

---

---

# <a name="AEN9191"></a>46.2. An overview of the use of the camac package
