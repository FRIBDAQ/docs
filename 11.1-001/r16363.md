...
[← CRingAccess](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16362.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingAccess →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16365.md)
...
<a name="AEN16374"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16377"></a>## Synopsis
...
The chapter:
            [Networed Ring Buffer Access](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7749.md)
            includes sample code for detecting and mapping the use of a system's
            hostname into localhost.

<a name="AEN16453"></a>## Public member functions
...
<a name="AEN16544"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16548"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16552"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
