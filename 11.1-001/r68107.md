...
<a name="AEN68138"></a>## OPTIONS



**-branch** *value*Specifies the branch index. Default is 0.

**-crates** *list*Specify a proper tcl list of crate modules to be operated on the branch. These crates must be compatible with the driver in use. Care should also be taken to ensure that the crate indices are all different. Default is an empty list.

<a name="AEN68153"></a>## EXAMPLES

<a name="AEN68155"></a>**Example 1. Sample setup of two camac crates on branch 0**
