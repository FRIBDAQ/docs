...
[← Configuration](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52433.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52441.md)
...
<a name="AEN52452"></a>## Name

Configuration -- Configuration variable management

<a name="AEN52455"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53983.md) package for that
            instead.

<a name="AEN52478"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53983.md) is a better
                          choice).
