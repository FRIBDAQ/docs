...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25355.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25358.md)
...
<a name="AEN25485"></a>## Public member functions





- <a name="AEN25491"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25503"></a>`bool Xtest(void);const`
...
- <a name="AEN25515"></a>`bool Qtest(void);const`
...
- <a name="AEN25532"></a>`bool TimedOut(void);const`
...
- <a name="AEN25544"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25556"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25570"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25583"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25597"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25612"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25627"></a>`bool IT4(void);const`
...
- <a name="AEN25641"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25652"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25665"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25681"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25692"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25703"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25713"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25717"></a>**Example 1. Initializing branch 0**
