...
[← CCamacNimout](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30058.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacNimout →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30066.md)
...
<a name="AEN30103"></a>## Public member functions
...
- <a name="AEN30128"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN30141"></a>` void WriteBit(unsigned int nBitno);`
