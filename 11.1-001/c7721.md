...
[← Service Port Manager.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7715.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring master class library. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7728.md)
...
The
        ...
        [The RingMaster Server](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7552.md)
...
<a name="AEN7730"></a>**Example 36-1. Including the header**
...
<a name="AEN7733"></a>**Example 36-2. Compiling code**
...
<a name="AEN7736"></a>**Example 36-3. Linking code to the library**
...
[RingMaster access](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16116.md)
