...
[← SyncGuard](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35073.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35076.md)
...
<a name="AEN35078"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35081"></a>## Synopsis
...
<a name="AEN35123"></a>## Public member functions
...
<a name="AEN35161"></a>`void sync_self(void);`
...
<a name="AEN35168"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35176"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35188"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35194"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35204"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35234"></a>`void sync_global_end(void);`
