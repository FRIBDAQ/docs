...
[← CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23937.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManager →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23968.md)
...
<a name="AEN24000"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23784.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN24007"></a>## Public member functions
...
<a name="AEN24063"></a>## Types and public data
...
<a name="AEN24083"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN24086"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r68698.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23784.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15146.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42375.md)
