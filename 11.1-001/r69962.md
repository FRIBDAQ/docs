...
[← gdgcontrol](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r69745.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [gdgwidget →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r69963.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70228.md)
        for one such panel.
...
<a name="AEN69999"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN70003"></a>### VhsWidgets::channel
...
<a name="AEN70023"></a>### VhsWidgets::channelStatus options
...
<a name="AEN70029"></a>## OBJECT METHODS
...
<a name="AEN70033"></a>**Example 1. Hooking update methods to recurring timer**
