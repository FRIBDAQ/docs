...
[← SBS Vme Tcl package](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15653.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SBS Vme Tcl package →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15656.md)
...
<a name="AEN15658"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN15661"></a>## Synopsis
...
<a name="AEN15716"></a>### Map access command
...
<a name="AEN15726"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN15734"></a>***mapname* put *width offset value***
