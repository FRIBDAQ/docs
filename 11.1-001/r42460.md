...
[← CErrnoException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42459.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42462.md)
...
<a name="AEN42468"></a>## Synopsis

```
CErrnoException
```

<a name="AEN42495"></a>## Description
...
<a name="AEN42504"></a>## Public member functions
