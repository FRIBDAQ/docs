...
[← VM/CCUSB Firmware loaders](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7196.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Sequencing runs →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7211.md)
...
For a full description of the sequencer, see its
        [reference manual page.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70791.md).
        This chapter gives an overview that describes how to use and configure
        the sequencer.

# <a name="AEN7209"></a>28.1. Configuring the sequencer.
...
<a name="AEN7254"></a>**Example 28-1. Loading the sequencer package**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7204.md#chapter.sequencer.env)
  The global `env` array contains a 
  		 ...
  		 variable.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7204.md#chapter.sequencer.join)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7204.md#chapter.sequencer.path)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7204.md#chapter.sequencer.require)
