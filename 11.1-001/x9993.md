...
| Prev | Chapter 52. Shared memory | Next |
...
<a name="AEN10004"></a>**Example 52-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN10008"></a>**Example 52-3. Linking C++ object files that use the
            daqshm library**
...
| --- | --- | --- |
| Prev | Home | Next |
| Shared memory | Up | C++ encapsulation of a Tcl API subset |
