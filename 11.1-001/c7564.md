...
[← The RingMaster server](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7562.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Service Port Manager. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7703.md)
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [Service Port Manager](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7715.md)
            chapter.
...
Each element of the list reports on the usage of a single ring.
            ...
            [Tcl ring package's ringbuffer
                usage](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16742.md) command.
