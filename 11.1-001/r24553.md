...
<a name="AEN24565"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24568"></a>## Synopsis
...
<a name="AEN24794"></a>## Public member functions





<a name="AEN24800"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24862"></a>`unsigned long getBase(void);`
...
<a name="AEN24873"></a>`int getSerial(void);`
...
<a name="AEN24904"></a>`int  getFirmware(void);`
...
<a name="AEN24914"></a>`int  getCrate(void);`
...
<a name="AEN24925"></a>`void setCrate(int crateNum);`
...
<a name="AEN24938"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24959"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24969"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24979"></a>`void keepOverflowData(void);`
...
<a name="AEN24989"></a>`void discardOverflowData(void);`
...
<a name="AEN24999"></a>`void keepInvalidData(void);`
...
<a name="AEN25010"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN25021"></a>`void commonStart(void);`
...
<a name="AEN25032"></a>`void commonStop(void);`
...
<a name="AEN25043"></a>`void setRange(int range);`
...
<a name="AEN25056"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25128"></a>`void clearData
                                (void);`
...
<a name="AEN25171"></a>`bool Busy(void);`
...
<a name="AEN25182"></a>` bool gBusy(void);`
...
<a name="AEN25193"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25204"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25215"></a>`int readEvent(void* buf);`
...
<a name="AEN25228"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25269"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25332"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25336"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25340"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25344"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25348"></a>**Example 3. Reading out a CAEN 785 e.g.**
