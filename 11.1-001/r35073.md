...
[← SyncGuard](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35066.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SyncGuard →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35074.md)
...
<a name="AEN35077"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35080"></a>## Synopsis
...
<a name="AEN35122"></a>## Public member functions
...
<a name="AEN35160"></a>`void sync_self(void);`
...
<a name="AEN35167"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35175"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35187"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35193"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35203"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35233"></a>`void sync_global_end(void);`
