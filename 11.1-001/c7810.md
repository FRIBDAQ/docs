...
[← Ring Buffer Primitives](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7809.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring Buffer Primitives →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7812.md)
...
Reference material can be found in the
        [CRingBuffer reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16556.md)

# <a name="AEN7824"></a>38.1. Incorporating ring buffer software
...
<a name="AEN7831"></a>**Example 38-1. Compilation line for ring buffer primitives**
...
<a name="AEN7837"></a>**Example 38-2. Including the ring buffer primitives header**
...
<a name="AEN7843"></a>**Example 38-3. Linking to the ring buffer primitives**
