...
[← ReadoutGui](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53339.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutGui →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53347.md)
...
- `-sources` *list-of-source-dicts*
  The data in this option determines what the
                                  ...
                                  the `sources` method
                                  of
                                  [*DataSourceManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52713.md)
...
All methods from the `DialogWrapper`
                    ...
                    [*ui*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54142.md)
