...
[← CCAMACTrigger](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r29556.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamac →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r29602.md)
...
<a name="AEN29584"></a>## Public member functions



- <a name="AEN29589"></a>`CCAMACTrigger(unsigned int b);`
...
- <a name="AEN29601"></a>`virtual bool  operator()(void);`
  Tests for the presence of a trigger condition.

<a name="AEN29609"></a>## DEFECTS AND RESTRICTIONS
