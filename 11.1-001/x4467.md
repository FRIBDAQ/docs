...
[← Remote control package](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4433.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the event builder →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4469.md)
...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10696.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51793.md).
...
The next thing that you need to do register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10603.md).
