...
[← Using the sequencer.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7284.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing event files with compatibilitylogger →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7412.md)
