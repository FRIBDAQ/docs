...
[← 3provider](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54801.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3provider →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54808.md)
...
<a name="AEN54815"></a>## Name

Introduction -- Data source providers

<a name="AEN54818"></a>## Synopsis
...
Data source providers are Tcl loadable packages that provide
            ...
            [*SSHPipe*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55268.md)
            which understands how to run command line readout programs on the end
            of a SSH pipeline to a (possibily) remote system, and
            [*s800*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55378.md) which
...
<a name="AEN54871"></a>## CREATING A DATA SOURCE PROVIDER
...
<a name="AEN54888"></a>## API FUNCTIONS
...
- **parameters**
  Each data source a data source provider starts may
                              ...
                              command connections.
                              [*parameters*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54961.md)
...
- **check** *sourceId*
  Whatever code is managing a set of data providers
                              ...
                              has exited.
                              [*check*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55013.md)
                              returns a true value if a source is still running and
                              false if not.
- **stop** *sourceId*
  [*stop*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55043.md)
                              Stops the specified data source.
- **begin** *sourceId runNumber title*
  Starts data taking for a new run.
                              See [*begin*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55072.md)
                              for reference information.
- **pause** *sourceId*
  If your data source implements pause/resume functionality
                              you must define this command to pause the run.
                              See the 
                              [*pause*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55101.md)
...
- **end** *sourceId*
  The
                              [*end*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55167.md)
                              ends a run in a data source.
- **init** *sourceId*
  The
                              [*init*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55194.md)
                              causes an initialize procedure in the data source.
- **capbilities**
  Describes the data
                              [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55221.md)
                              source capabilities.
