...
[← Selecting Data From a Ring Buffer](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8403.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the headers and libraries into your applications. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8426.md)

---

---

# <a name="AEN8419"></a>40.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8425"></a>**Example 40-1. Including a ring item class **
...
<a name="AEN8432"></a>**Example 40-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8437"></a>**Example 40-3. Linking the ring item format libraries**
...
- [`CRingItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17358.md)
...
- [`CRingStateChangeItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18261.md)
...
- [`CRingScalerItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17825.md)
...
- [`CRingTextItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18656.md)
...
- [`CGlomParameters`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r20111.md)
...
- [`CPhysicsEventItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18972.md)
  Encapsulates the data taken in response to a physics
                          trigger.
- [`CRingFragmentItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19475.md)
...
- [`CRingPhysicsEventCountItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19158.md)
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [`CUnknownFragment`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19780.md)
...
## <a name="AEN8509"></a>40.3.1. Generic ring data sources
...
Reference information on these classes is availabe at:
                [*CDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22653.md),
                [*CRingDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22695.md),
                [*CFileDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22764.md),
                [*CDataSourceFactory"*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22821.md),
                and
                [*CRingItemFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22878.md).
