...
[← Authenticators](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9759.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Authenticators →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9771.md)

---

---

# <a name="AEN9761"></a>50.2. Authenticators
...
<a name="AEN9765"></a>**Example 50-3. Boilerplate DAQ Authorization code **
...
The complete definitinon of
            ...
            [its reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36039.md).
            The library provides the following concrete authentication classes:



- [`CPasswordCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36143.md)
...
- [`CUnixUserCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36331.md)
  The entity must provide a valid username and password
                          that is could login to the local unix system.
- [`CTclAccesListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36542.md)
...
- [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36640.md)
  The entity must supply a string that is one of a set of strings
                              given to the authenticator.
- [`CHostListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36782.md)
