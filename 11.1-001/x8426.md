...
[← Incorporating the headers and libraries into your applications.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8419.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the headers and libraries into your applications. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8427.md)

---

---

# <a name="AEN8426"></a>40.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8432"></a>**Example 40-1. Including a ring item class **
...
<a name="AEN8439"></a>**Example 40-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8444"></a>**Example 40-3. Linking the ring item format libraries**
...
- [`CRingItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17365.md)
...
- [`CRingStateChangeItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18268.md)
...
- [`CRingScalerItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17832.md)
...
- [`CRingTextItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18663.md)
...
- [`CGlomParameters`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r20118.md)
...
- [`CPhysicsEventItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18979.md)
  Encapsulates the data taken in response to a physics
                          trigger.
- [`CRingFragmentItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19482.md)
...
- [`CRingPhysicsEventCountItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19165.md)
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [`CUnknownFragment`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19787.md)
...
## <a name="AEN8516"></a>40.3.1. Generic ring data sources
...
Reference information on these classes is availabe at:
                [*CDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22660.md),
                [*CRingDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22702.md),
                [*CFileDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22771.md),
                [*CDataSourceFactory"*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22828.md),
                and
                [*CRingItemFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22885.md).
