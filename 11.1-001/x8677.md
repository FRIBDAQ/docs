...
[← Incorporating the event builder client library](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8670.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the event builder client library →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8678.md)

---

---

# <a name="AEN8677"></a>41.2. Incorporating the event builder client library
