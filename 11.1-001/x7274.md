...
[← Sample programs that use the package](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7189.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the sequencer. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7281.md)

---

---

# <a name="AEN7274"></a>28.2. Using the sequencer.
