...
[← CADC2530](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r24093.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CADC2530 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r24277.md)
...
`CPortManagerException`
       ...
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23968.md)).
        Since it  is  derived
       from
       `CException`,
...
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44380.md)
