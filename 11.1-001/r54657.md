...
[← OutputWindowSettings](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54655.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [StatusArea →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54716.md)
...
<a name="AEN54713"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52966.md#rdogui3_dialogwrapper).
