...
[← Writing event files with compatibilitylogger](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7412.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing event files with compatibilitylogger →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7420.md)

---

---

# <a name="AEN7419"></a>30.2. Writing event files with compatibilitylogger
...
<a name="AEN7433"></a>**Example 30-3. Using compatibilitylogger to convert event files**
