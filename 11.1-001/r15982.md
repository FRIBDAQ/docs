...
<a name="AEN16027"></a>### Configuration Options
...
<a name="AEN16051"></a>### Device Options
...
<a name="AEN16081"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN16097"></a>```
...
Retrieve the ID code for the board above<a name="AEN16102"></a>```
...
Load firmware and license it.<a name="AEN16109"></a>```
...
Retrieve license information from a digitizer.<a name="AEN16117"></a>```
...
Un-license a digitizer's firmware:<a name="AEN16122"></a>```
