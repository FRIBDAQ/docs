...
[← Sample programs that use the package](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7177.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Sample programs that use the package →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7185.md)

---

---

# <a name="AEN7184"></a>26.2. Sample programs that use the package
...
<a name="AEN7188"></a>**Example 26-4. Using VME Tcl to locate all 2530 modules**
