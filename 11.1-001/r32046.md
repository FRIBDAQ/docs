...
<a name="AEN32050"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN32053"></a>## Synopsis
...
<a name="AEN32160"></a>## Public member functions



<a name="AEN32165"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
<a name="AEN32203"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
<a name="AEN32218"></a>`CVME<T>(const CVME& aCVME);`
...
<a name="AEN32231"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
<a name="AEN32244"></a>`int  operator==(const CVME<T>& aCVME);`
...
<a name="AEN32289"></a>`T*  T* operator-> (void);`
...
<a name="AEN32299"></a>`T&  operator[](UInt_t nOffset);`
...
<a name="AEN32314"></a>`CVME<T>& operator+(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32326"></a>`CVME<T>&  operator-(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32338"></a>`CVME<T>&  operator+=(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN32350"></a>`CVME<T>&  operator-=(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN32360"></a>## Types and public data
