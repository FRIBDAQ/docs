...
[← Starting the GUI for the RC-bus through an MxDC device](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6596.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration menu →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6619.md)

---

---

# <a name="AEN6618"></a>12.4. Configuration menu
...
## <a name="AEN6621"></a>12.4.1. Enable/Disable Channel
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/figures/MCFD16Control-enabledisable-config-0.png)

## <a name="AEN6629"></a>12.4.2. Configurable 16-Channel OR Trigger
...
![](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/figures/MCFD16Control-triggerOR-config-0.png)
