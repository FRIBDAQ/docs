...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r24123]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r24123]].
...
[[portAllocator(3tcl)|r70703]],
            [[CPortManagerException(3daq)|r24123]],
            [[DaqPortManager(1tcl)|r15330]]
