...
[← DAQParameters](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54545.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [OutputWindowSettings →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54654.md)
...
<a name="AEN54703"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52956.md#rdogui3_dialogwrapper).
