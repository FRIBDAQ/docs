...
[← Synchronization Paradigm](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6666.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for USB communication →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6668.md)

---

---

# <a name="AEN6667"></a>13.3. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN6677"></a>**Figure 13-1. The MSCF16Control Graphical User Interface for USB**
