...
[← CCAENV560](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r28108.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV830 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r28269.md)
...
<a name="AEN28434"></a>## Public member functions



- <a name="AEN28439"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
- <a name="AEN28467"></a>`void  Enable(int nChannel);`
...
- <a name="AEN28482"></a>`void  Disable(int nChannel);`
...
- <a name="AEN28497"></a>`void   SetEnableMask (int nMask);`
  Sets the mask of channel enables.  Each bit in the 32 bit
                              ...
                              are enabled.
- <a name="AEN28510"></a>`void   SetDwellTime(int   n4ppns);`
  In periodic trigger mode, this sets the number of 400ns clock ticks
                              between periodic triggers.
- <a name="AEN28522"></a>`void   SetTriggerMode (TriggerMode mode);`
  Selct the module trigger mode.  See "Types and public data" for more
                              ...
                              them.
- <a name="AEN28534"></a>`void   SetWide (void);`
...
- <a name="AEN28546"></a>`void   SetNarrow (void);`
...
- <a name="AEN28557"></a>`void  EnableHeader (void);`
...
- <a name="AEN28635"></a>`bool  isFull (void);`
...
- <a name="AEN28647"></a>`bool   isGlobalDReady (void);`
  Returns true if the global data ready line on the control bus is full.
                              ...
                              *this* module.
- <a name="AEN28659"></a>`bool   isGlobalBusy(void);`
...
- <a name="AEN28752"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
- <a name="AEN28766"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
