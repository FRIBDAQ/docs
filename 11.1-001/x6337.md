...
- [[![(1)](../images/callouts/1.gif)|x6337#ex0_inc_protect]]
...
- [[![(2)](../images/callouts/2.gif)|x6337#ex0_class_decl]]
...
- [[![(3)](../images/callouts/3.gif)|x6337#ex0_docpacket]]
...
- [[![(4)](../images/callouts/4.gif)|x6337#ex0_module_ptr]]
...
- [[![(5)](../images/callouts/5.gif)|x6337#ex0_ctor]]
  This line declares the constructor for MyEventSegment. A
                ...
                (constructed).
- [[![(6)](../images/callouts/6.gif)|x6337#ex0_init]]
  The Initialize member function is called whenever the run is
                ...
                resumed.
- [[![(7)](../images/callouts/7.gif)|x6337#ex0_clear]]
...
- [[![(8)](../images/callouts/8.gif)|x6337#ex0_read]]
...
- [[![(9)](../images/callouts/9.gif)|x6337#ex0_computeTstamp]]
...
- [[![(1)](../images/callouts/1.gif)|x6337#ex1_ifdef_std]]
...
- [[![(4)](../images/callouts/4.gif)|x6337#ex1_initlist]]
  This code in the constructor is called an initializer list.
                ...
                of the module.
- [[![(5)](../images/callouts/5.gif)|x6337#ex1_mod_ptr_reset]]
  This code initializes the CAEN V785 module by resetting it
                ...
                latched.
- [[![(6)](../images/callouts/6.gif)|x6337#ex1_mod_ptr_clearData]]
  This code clears any data that is latched in the module.
- [[![(7)](../images/callouts/7.gif)|x6337#ex1_poll_for_data]]
...
- [[![(8)](../images/callouts/8.gif)|x6337#ex1_reinterpret_cast]]
  The address of the buffer was passed to the method as a
                ...
                allow us to do so.
- [[![(9)](../images/callouts/9.gif)|x6337#ex1_pkt_begin]]
...
- [[![(10)](../images/callouts/10.gif)|x6337#ex1_read_event]]
  Data are read from the ADC into the packet.
- [[**(11)**|x6337#ex1_pkt_end]]
