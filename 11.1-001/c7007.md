...
[← The tcl server application](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7006.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The tcl server application →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7009.md)
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15255.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15298.md).
            section.

The following command adds the node spdaq20.nscl.msu.edu
            to the set of hosts that are allowed to connnect to the server.

<a name="AEN7022"></a>**Example 21-1. Using **serverauth** to authorize a node**
...
# <a name="AEN7026"></a>21.1. Tcl server package

TclServer is also available as a package that can be incorporated
                into Tcl scripts.
                For information about that, see:
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r68796.md)
