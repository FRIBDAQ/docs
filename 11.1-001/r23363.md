...
[← CDataSinkFactory](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23309.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CEvbClientApp →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23370.md)
...
<a name="AEN23367"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN23370"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN23400"></a>## DESCRIPTION
...
<a name="AEN23462"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
