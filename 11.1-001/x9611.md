...
- [[![(4)](../images/callouts/4.gif)|x9611#gaurded_enter]]
  Invoking the `Enter` method of the base class
  	    ...
  	    will not block.
- [[![(5)](../images/callouts/5.gif)|x9611#gaurded_leave]]
