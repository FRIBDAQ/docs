...
Besides automatically sourcing the ReadoutCallouts.tcl
                ...
                **proc**s from the packages described in
                [[*ReadoutGUI API packages*|x4041#readoutshell_api_packages]].
...
[[![(3)](../images/callouts/3.gif)|x4041#custom_readoutgui_extend]]                        Once the `ReadoutGuiApp` application
                        ...
                        [[*ReadoutGUI API packages*|x4041#readoutshell_api_packages]] which
