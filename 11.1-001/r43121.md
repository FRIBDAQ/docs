...
[← CMonitorException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r43114.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMonitorException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r43122.md)
...
The NSCL DAQ base software includes support for an object model
            ...
            chapter;
            [NSCL DAQ Thread Library](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9486.md).
...
`CMonitorException`
            is derived from the
            [CException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42372.md)
            class, and therefore supports and implements all of its
            virtual members.

<a name="AEN43199"></a>## Public member functions
