...
[← Sample programs that use the package](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7185.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Sample programs that use the package →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7189.md)

---

---

# <a name="AEN7187"></a>26.2. Sample programs that use the package
...
<a name="AEN7191"></a>**Example 26-4. Using VME Tcl to locate all 2530 modules**
