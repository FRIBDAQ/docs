...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42365.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42373.md)
...
<a name="AEN42376"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN42379"></a>## Synopsis

```
CException
```

<a name="AEN42413"></a>## Description
...
<a name="AEN42418"></a>## Public member functions
