...
[← CVMUSBRemote](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r61714.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMUSBReadoutList →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r62826.md)
...
<a name="AEN61720"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN61723"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN62909"></a>## DESCRIPTION
...
<a name="AEN62912"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r58829.md)
