...
[← Writing event files with compatibilitylogger](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7420.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing event files with compatibilitylogger →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7424.md)

---

---

# <a name="AEN7422"></a>30.2. Writing event files with compatibilitylogger
...
<a name="AEN7436"></a>**Example 30-3. Using compatibilitylogger to convert event files**
