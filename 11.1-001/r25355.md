...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25348.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CBD8210 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25356.md)
...
<a name="AEN25484"></a>## Public member functions





- <a name="AEN25490"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25502"></a>`bool Xtest(void);const`
...
- <a name="AEN25514"></a>`bool Qtest(void);const`
...
- <a name="AEN25531"></a>`bool TimedOut(void);const`
...
- <a name="AEN25543"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25555"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25569"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25582"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25596"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25611"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25626"></a>`bool IT4(void);const`
...
- <a name="AEN25640"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25651"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25664"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25680"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25691"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25702"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25712"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25716"></a>**Example 1. Initializing branch 0**
