...
<a name="AEN28628"></a>## Public member functions



<a name="AEN28633"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN28661"></a>`void  Enable(int nChannel);`
...
<a name="AEN28676"></a>`void  Disable(int nChannel);`
...
<a name="AEN28691"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN28704"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN28716"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN28728"></a>`void   SetWide (void);`
...
<a name="AEN28740"></a>`void   SetNarrow (void);`
...
<a name="AEN28751"></a>`void  EnableHeader (void);`
...
<a name="AEN28829"></a>`bool  isFull (void);`
...
<a name="AEN28841"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN28853"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN28946"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN28960"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
