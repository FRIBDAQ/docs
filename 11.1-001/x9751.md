...
[← Pointers to the reference material](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9723.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Authenticators →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9758.md)

---

---

# <a name="AEN9751"></a>50.2. Authenticators
...
<a name="AEN9755"></a>**Example 50-3. Boilerplate DAQ Authorization code **
...
The complete definitinon of
            ...
            [its reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36029.md).
            The library provides the following concrete authentication classes:



- [`CPasswordCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36133.md)
...
- [`CUnixUserCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36321.md)
  The entity must provide a valid username and password
                          that is could login to the local unix system.
- [`CTclAccesListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36532.md)
...
- [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36630.md)
  The entity must supply a string that is one of a set of strings
                              given to the authenticator.
- [`CHostListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36772.md)
