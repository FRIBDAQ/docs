...
[← resume](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55143.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [resume →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55146.md)
...
<a name="AEN55156"></a>## Name

resume -- Resume a Paused Run

<a name="AEN55159"></a>## Synopsis
...
Resumes a run that is paused in the data source identified by
          ...
          [*pause*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55109.md)
