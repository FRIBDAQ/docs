...
[← Networked ring buffer access](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7753.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring Buffer Primitives →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7809.md)
...
Reference material can be found in the
        [CRingBuffer reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16548.md)

# <a name="AEN7816"></a>38.1. Incorporating ring buffer software
...
<a name="AEN7823"></a>**Example 38-1. Compilation line for ring buffer primitives**
...
<a name="AEN7829"></a>**Example 38-2. Including the ring buffer primitives header**
...
<a name="AEN7835"></a>**Example 38-3. Linking to the ring buffer primitives**
