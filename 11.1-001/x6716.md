...
[← How to use the MDGG16Control GUI](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6714.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and Restoring The State of the GUI Between Sessions →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6746.md)
...
5. The user will then be presented with the a graphical user interface 
   ...
   ![](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/figures/MDGG16Control-HowTo-0.png)
