...
# <a name="AEN2378"></a>5.3. Writing device support software
...
<a name="AEN2383"></a>**Example 5-4. Obtaining the ccusb driver development kit**
...
<a name="AEN2389"></a>**Example 5-5. Using a user written CCUSB driver**
...
## <a name="AEN2404"></a>5.3.1. The driver onAttach method
...
[[x2378#ccusb-dtemplate-saveconfig]] `onAttach` needs to be able
...
## <a name="AEN2439"></a>5.3.2. The driver Initialize method
...
## <a name="AEN2472"></a>5.3.3. The driver addReadoutList method
...
## <a name="AEN2499"></a>5.3.4. Initializing the driver with the framework.
