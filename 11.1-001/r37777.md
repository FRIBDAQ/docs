...
[← CIOInteractor](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37702.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDAQShm →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37784.md)
...
<a name="AEN37781"></a>## Name

CDAQShm -- class description

<a name="AEN37784"></a>## Synopsis

```
CDAQShm
```

<a name="AEN37899"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37777.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37777.md#daqshm-varsrefsect).
