...
[← Ring Buffer Primitives](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7802.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring Buffer Primitives →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7810.md)
...
Reference material can be found in the
        [CRingBuffer reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16555.md)

# <a name="AEN7823"></a>38.1. Incorporating ring buffer software
...
<a name="AEN7830"></a>**Example 38-1. Compilation line for ring buffer primitives**
...
<a name="AEN7836"></a>**Example 38-2. Including the ring buffer primitives header**
...
<a name="AEN7842"></a>**Example 38-3. Linking to the ring buffer primitives**
