...
For reference information on this class see:
            [[CEventSegment(3sbsreadout)|r72501]].
            Closely allied with this is the concept of packets.  Packets are supported
            via the [[CDocumentedPacket(3sbsreadout)|r72120]].
            The [[CEventPacket(3sbsreadout)|r72383]]
...
For reference information about the `CCompoundEventSegment`
            class see
            [[CCompoundEventSegment(3sbsreadout)|r71850]].

The readout software has a single object from the
            [[CExperiment(3sbsreadout)|r72810]]
...
See the section:
            [[Modifying the skeleton application to meet your needs|x11173]]
...
- [[![(1)](../images/callouts/1.gif)|c10752#specialring-normal-stuff]]
...
- [[![(2)](../images/callouts/2.gif)|c10752#specialring-getring]]
...
- [[![(1)](../images/callouts/1.gif)|c10752#specialring_getevtcount]]
  To set up for the loop that emits ring items we first
                          fetch the number of events that have been read.
- [[![(2)](../images/callouts/2.gif)|c10752#specialring_geteventinfo]]
  This section of code gets the informatino about the event
                          ...
                          variable.
- [[![(3)](../images/callouts/3.gif)|c10752#specialring_makeitem]]
...
- [[![(4)](../images/callouts/4.gif)|c10752#specialring_fillitem]]
  The `getBodyCursor` method
                          ...
                          event data.
- [[![(5)](../images/callouts/5.gif)|c10752#specialring_updatecursor]]
  This line computes a pointer to the first unused byte
                          ...
                          to put its data.
- [[![(6)](../images/callouts/6.gif)|c10752#specialring_commit]]
...
- [[![(7)](../images/callouts/7.gif)|c10752#specialring_bookkeeping]]
