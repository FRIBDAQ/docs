...
[← The SBS Readout framework](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10745.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The SBS Readout framework →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10753.md)
...
# <a name="AEN10763"></a>59.1. SBS Readout concepts
...
- size_t `read`(
  ...
  The base class, `CEventSegment`
                              ...
                              the manpage 
                              [*CEventSegment*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r72501.md)
...
For reference information on this class see:
            [CEventSegment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r72501.md).
            Closely allied with this is the concept of packets.  Packets are supported
            via the [CDocumentedPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r72120.md).
            The [CEventPacket(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r72383.md)
...
For reference information about the `CCompoundEventSegment`
            class see
            [CCompoundEventSegment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r71850.md).

The readout software has a single object from the
            [CExperiment(3sbsreadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r72810.md)
...
See the section:
            [Modifying the skeleton application to meet your needs](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x11173.md)
...
For reference information see
            [CScalerBank](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73237.md)
...
The readout framework provides
            [`CCAENV262Busy`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r71621.md),
            and
            [`CV977Busy`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73605.md) as
...
<a name="AEN11085"></a>**Example 59-1. Passing the ring buffer to the construction of an Event segment.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring-normal-stuff)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring-getring)
...
<a name="AEN11121"></a>**Example 59-2. Creating Events**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring_getevtcount)
  To set up for the loop that emits ring items we first
                          fetch the number of events that have been read.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring_geteventinfo)
  This section of code gets the informatino about the event
                          ...
                          variable.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring_makeitem)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring_fillitem)
  The `getBodyCursor` method
                          ...
                          event data.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring_updatecursor)
  This line computes a pointer to the first unused byte
                          ...
                          to put its data.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring_commit)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10752.md#specialring_bookkeeping)
