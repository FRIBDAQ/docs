...
[← CTCLHashTableIterator](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42078.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CConfigurableObject →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42152.md)
...
<a name="AEN42245"></a>## Public member functions
...
<a name="AEN42356"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN42361"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r41422.md)
