...
[← tcl driver support](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r56911.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [start →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r57001.md)
...
Each data source managed by a data source provider is specified
            ...
            returns a Tcl
            [dict](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/dict.md) that describes the set of parameters
            expected.
