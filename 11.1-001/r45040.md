...
[← CCCUSB](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r45038.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMonitorException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r45129.md)
...
<a name="AEN45044"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45047"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46029"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48259.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r48259.md) for
...
<a name="AEN46600"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46604"></a>### Action Register
...
<a name="AEN46647"></a>### Firmware Register
...
<a name="AEN46699"></a>### Global Mode Register
...
<a name="AEN46832"></a>### Delay Register
...
<a name="AEN46865"></a>### Scaler Control register
...
<a name="AEN46898"></a>### LED Source Register
...
<a name="AEN47150"></a>### Output source selection register.
...
<a name="AEN47319"></a>### Device source register
...
<a name="AEN47672"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47733"></a>### Transfer setup register
