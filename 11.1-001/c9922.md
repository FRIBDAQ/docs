...
Reference information is available in [[the reference section|r37777]]
...
- [[![(1)](../images/callouts/1.gif)|c9922#shm_includes]]
  Includes the header for the NSCLDAQ shared memory API.
                      See [[*Compiling/Linking your software with the shared memory API*|x9993]]
                      for information that describes how to ensure this header
                      will be found by the compiler.
- [[![(2)](../images/callouts/2.gif)|c9922#shm_create]]
  Attempts to crate the shared memory. The return value of this
                      ...
                      read/write access.
- [[![(3)](../images/callouts/3.gif)|c9922#shm_create_fail]]
...
- [[![(4)](../images/callouts/4.gif)|c9922#shm_attach]]
...
- [[![(5)](../images/callouts/5.gif)|c9922#shm_detach]]
