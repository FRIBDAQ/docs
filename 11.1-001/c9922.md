...
[← Parsing and URIs](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9884.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Shared memory →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9929.md)

---

---

# <a name="AEN9922"></a>Chapter 52. Shared memory
...
Reference information is available in [the reference section](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37777.md)

# <a name="AEN9935"></a>52.1. Overview of the API, and using it from within your C++ software
...
<a name="AEN9963"></a>**Example 52-1. Shared memory library example**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9922.md#shm_includes)
  Includes the header for the NSCLDAQ shared memory API.
                      See [*Compiling/Linking your software with the shared memory API*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9993.md)
                      for information that describes how to ensure this header
                      will be found by the compiler.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9922.md#shm_create)
  Attempts to crate the shared memory. The return value of this
                      ...
                      read/write access.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9922.md#shm_create_fail)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9922.md#shm_attach)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c9922.md#shm_detach)
