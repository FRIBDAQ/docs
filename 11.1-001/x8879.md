...
[← Callbacks](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8877.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Callbacks →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8881.md)

---

---

# <a name="AEN8879"></a>41.7. Callbacks
...
## <a name="AEN8882"></a>41.7.1. Connection callbacks
...
<a name="AEN8887"></a>**Example 41-4. Establishing the connection callback**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8879.md#evb_connection_cb)
  This is a sample connection callback proc.  All it
                              does is output information about the connection
                              that was just processed.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8879.md#evb_connection_cb_establish)
...
## <a name="AEN8900"></a>41.7.2. Establishing the disconnect callback
...
<a name="AEN8904"></a>**Example 41-5. Setting up the disconnect callback**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8879.md#evb_disconnect_cb)
  This is a simple sample disconnecdt callback.
                              It just prints information about the disconnect
                              on stdout.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8879.md#evb_disconnect_cb_establish)
