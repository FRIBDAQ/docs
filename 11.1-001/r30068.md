...
[← CCamacNimout](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30066.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCrateController →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30147.md)
...
<a name="AEN30106"></a>## Public member functions
...
- <a name="AEN30131"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN30144"></a>` void WriteBit(unsigned int nBitno);`
