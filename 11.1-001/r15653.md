...
[← SBS Vme Tcl package](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15646.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SBS Vme Tcl package →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15654.md)
...
<a name="AEN15657"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN15660"></a>## Synopsis
...
<a name="AEN15715"></a>### Map access command
...
<a name="AEN15725"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN15733"></a>***mapname* put *width offset value***
