...
[← Launching the XLM72GateDelayControl](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6783.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Overview of Functionality →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6802.md)
...
To write the state of the GUI to a configuration file, you should simply
      ...
      displayed in the GUI. See the section [*The Saved File*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6813.md)
