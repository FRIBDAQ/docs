...
[← cratelocator](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7141.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Tcl access to the VME via the SBS interface →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7149.md)
...
For detailed reference information on the Vme Tcl package start with
        [the vmetcl manpage](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15646.md).

# <a name="AEN7157"></a>26.1. Incorporating Vme Tcl in your scripts
...
<a name="AEN7166"></a>**Example 26-1. Appending the NSCLDAQ Tcl Package repository to Tcl's search
            path**
...
<a name="AEN7170"></a>**Example 26-2. Appending NSLCDAQ's TclPackage repository to Tcl's search path**
...
<a name="AEN7174"></a>**Example 26-3. Requesting the VME Tcl package be loaded.**
