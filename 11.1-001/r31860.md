...
[← CVME](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r31859.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVME →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r31862.md)
...
<a name="AEN31864"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN31867"></a>## Synopsis
...
<a name="AEN31974"></a>## Public member functions



- <a name="AEN31979"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN32017"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN32032"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN32045"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN32058"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN32103"></a>`T*  T* operator-> (void);`
...
- <a name="AEN32113"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN32128"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32140"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN32152"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32164"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN32174"></a>## Types and public data
