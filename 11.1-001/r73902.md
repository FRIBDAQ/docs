...
[← CScaler](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73901.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [TransientLabel →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73903.md)
...
<a name="AEN73906"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN73909"></a>## Synopsis
...
<a name="AEN73957"></a>## Public member functions
...
`Should return false if the scaler is not a
                ...
                [CScalerBank(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73238.md)).
