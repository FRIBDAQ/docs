...
[← Launching the XLM72GateDelayControl](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6781.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Launching the XLM72GateDelayControl →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6785.md)

---

---

# <a name="AEN6783"></a>15.3. Launching the XLM72GateDelayControl
...
<a name="AEN6796"></a>**Figure 15-1. Screenshot of XLM72GateDelayControl**

![](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/figures/gd16_startup.png)
...
To write the state of the GUI to a configuration file, you should simply
      ...
      displayed in the GUI. See the section [*The Saved File*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6811.md)
