...
[← Injecting variables into the USB data taking frameworks](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10133.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Injecting variables into the USB data taking frameworks →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10141.md)

---

---

# <a name="AEN10140"></a>Chapter 55. Injecting variables into the USB data taking frameworks
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12970.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12970.md)),
...
<a name="AEN10159"></a>**Example 55-1. The **watch** command.**
