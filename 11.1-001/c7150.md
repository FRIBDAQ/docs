...
[← Tcl access to the VME via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7149.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Tcl access to the VME via the SBS interface →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7152.md)
...
For detailed reference information on the Vme Tcl package start with
        [the vmetcl manpage](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15654.md).

# <a name="AEN7165"></a>26.1. Incorporating Vme Tcl in your scripts
...
<a name="AEN7174"></a>**Example 26-1. Appending the NSCLDAQ Tcl Package repository to Tcl's search
            path**
...
<a name="AEN7178"></a>**Example 26-2. Appending NSLCDAQ's TclPackage repository to Tcl's search path**
...
<a name="AEN7182"></a>**Example 26-3. Requesting the VME Tcl package be loaded.**
