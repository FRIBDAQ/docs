...
# <a name="AEN4458"></a>Chapter 7. Event Builder

# <a name="AEN4460"></a>7.1. Introduction
...
The client programs that submit data to the server are built using the
      [[c10497]]. In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [[x10763]] program. This
