...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23936]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23936]].
...
[[portAllocator(3tcl)|r68695]],
            [[CPortManagerException(3daq)|r23936]],
            [[DaqPortManager(1tcl)|r15143]]
