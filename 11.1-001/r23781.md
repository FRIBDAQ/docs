...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23774.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManager →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23782.md)
...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23936.md) for
...
<a name="AEN23838"></a>## Public member functions
...
If a port could not be allocated (e.g. all are in use or the port manager could
                ...
                [CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23936.md).
...
<a name="AEN23882"></a>## Types and public data
...
<a name="AEN23914"></a>## Exceptions

The `CPortManagerException` is thrown to inform the
            program of most errors dected by this API.  For more information about
            this exception, see:  [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23936.md).

<a name="AEN23919"></a>## EXAMPLES

Allocates a port to MyApplication

<a name="AEN23923"></a>**Example 1. Allocating a port with the port manager**
...
<a name="AEN23927"></a>**Example 2. Listing the port allocatiosn on a system.**
...
<a name="AEN23930"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r68695.md),
            [CPortManagerException(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23936.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15143.md)
