...
[← EVBC::startS800Source](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51986.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::initialize →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52009.md)
...
<a name="AEN52014"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN52017"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN52021"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51785.md).

<a name="AEN52029"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51785.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52063.md)).
