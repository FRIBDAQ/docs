...
# <a name="AEN5674"></a>10.4. Creating the tailored SpecTcl
...
## <a name="AEN5682"></a>10.4.1. Decoding raw TDC data
...
### <a name="AEN5705"></a>10.4.1.2. Creating the raw unpacker class

Here is the header for our raw unpacker
                    (event processor) pipeline stage:

<a name="AEN5708"></a>**Example 10-9. Raw TDC unpacker (RawUnpacker.h)**
...
<a name="AEN5740"></a>**Example 10-10. v775 raw unpacker implementation includes and defs (RawUnpacker.cpp)**
...
<a name="AEN5762"></a>**Example 10-11. V775 raw unpacker - getLong utility (RawUnpacker.cpp)**
...
<a name="AEN5768"></a>**Example 10-12. V775 raw unpacker object constructor/destructor (RawUnpacker.cpp)**
...
[[x5674#v775_rawimpl_constructor]]                            The constructor is required to initialize the reference
                            ...
                            t.00 ... t.31.
                        [[x5674#v775_rawimpl_destructor]]                            If an object is ever destroyed, its tree parameter
                            array musb be destroyed as well to prevent
                            memory leaks.

<a name="AEN5781"></a>**Example 10-13. v75 raw unpacker unpacking events (RawUnpacker.cpp)**
...
[[x5674#v775_rawimpl_funtorsignature]]                            The `operator()` method
...
[[x5674#v775_rawimpl_storeparam]]                            Tree parameter array objects mimic arrays to the
                        ...
                        [[x5674#v775_rawimple_trailer]]                            The data words from the TDC should be followed by
                            a trailer.  This code asserts that this is the
                            case.

### <a name="AEN5869"></a>10.4.1.3. Adding the unpacker to the analysis pipeline
...
### <a name="AEN5891"></a>10.4.1.4. Creating raw time spectra
...
<a name="AEN5900"></a>**Example 10-14. Defining raw Time spectra the hard way.**
...
### <a name="AEN5973"></a>10.4.1.5. Building and testing what we have so far.
...
## <a name="AEN6011"></a>10.4.2. Producing parameters computed from the raw data
...
<a name="AEN6024"></a>**Example 10-15. Header for time difference event processor (Tdiff.h)**
...
<a name="AEN6037"></a>**Example 10-16. CTdiff implementation (Tdiff.cpp)**
