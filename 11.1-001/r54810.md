...
[← 3provider](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54809.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3provider →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54811.md)
...
<a name="AEN54822"></a>## Name

Introduction -- Data source providers

<a name="AEN54825"></a>## Synopsis
...
Data source providers are Tcl loadable packages that provide
            ...
            [*SSHPipe*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55275.md)
            which understands how to run command line readout programs on the end
            of a SSH pipeline to a (possibily) remote system, and
            [*s800*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55385.md) which
...
<a name="AEN54878"></a>## CREATING A DATA SOURCE PROVIDER
...
<a name="AEN54895"></a>## API FUNCTIONS
...
- **parameters**
  Each data source a data source provider starts may
                              ...
                              command connections.
                              [*parameters*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r54968.md)
...
- **check** *sourceId*
  Whatever code is managing a set of data providers
                              ...
                              has exited.
                              [*check*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55020.md)
                              returns a true value if a source is still running and
                              false if not.
- **stop** *sourceId*
  [*stop*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55050.md)
                              Stops the specified data source.
- **begin** *sourceId runNumber title*
  Starts data taking for a new run.
                              See [*begin*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55079.md)
                              for reference information.
- **pause** *sourceId*
  If your data source implements pause/resume functionality
                              you must define this command to pause the run.
                              See the 
                              [*pause*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55108.md)
                              reference material for more information.
- **resume** *sourceId*
  If your data source implements pause/resume functionality
                              you must implement
                              [*resume*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55143.md)
                              to resume paused runs.
- **end** *sourceId*
  The
                              [*end*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55174.md)
                              ends a run in a data source.
- **init** *sourceId*
  The
                              [*init*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55201.md)
                              causes an initialize procedure in the data source.
- **capbilities**
  Describes the data
                              [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55228.md)
                              source capabilities.
