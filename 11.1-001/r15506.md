...
[← bcnaf](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15499.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [bcnaf →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15507.md)
...
<a name="AEN15510"></a>## Name

bcnaf -- bcnaf via SBS VME CAMAC interfaces

<a name="AEN15513"></a>## Synopsis

**
bcnaf `-ces | -wiener` *b c n a f* [d]
    **

<a name="AEN15519"></a>## DESCRIPTION
