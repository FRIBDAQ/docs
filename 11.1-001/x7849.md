...
[← Overview and Examples of ring buffers in action.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7847.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Overview and Examples of ring buffers in action. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7851.md)

---

---

# <a name="AEN7849"></a>38.2. Overview and Examples of ring buffers in action.
...
## <a name="AEN7858"></a>38.2.1. A Ring Buffer Consumer
...
<a name="AEN7863"></a>**Example 38-4. Sample ring buffer consumer**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringcons.include)
  The
                          CRingBuffer.h
                          header is included.
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringcons.std)
  Incorporating the
                          ...
                          `std::string`
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringcons.create)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringcons.obj)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringcons.latency)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringcons.get)
  The
                          `get`
...
## <a name="AEN7907"></a>38.2.2. A Ring Buffer Producer
...
<a name="AEN7912"></a>**Example 38-5. A sample Ring Buffer producer program**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringprod.include)
  Includes the
                          CRingBuffer.h
                          ...
                          ring buffers.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringprod.latency)
  See the discussion of the consumer for more
                          ...
                          response latencies.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringprod.pattern)
  This loop creates a buffer that consists of 1MB
                          counting pattern.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x7849.md#ringprod.put)
