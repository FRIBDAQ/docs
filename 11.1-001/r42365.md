...
[← CTCLResult](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42296.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42372.md)
...
<a name="AEN42369"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN42372"></a>## Synopsis

```
CException
```

<a name="AEN42406"></a>## Description
...
<a name="AEN42411"></a>## Public member functions
