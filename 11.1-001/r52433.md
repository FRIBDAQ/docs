...
[← bells](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52324.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52440.md)
...
<a name="AEN52445"></a>## Name

Configuration -- Configuration variable management

<a name="AEN52448"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53976.md) package for that
            instead.

<a name="AEN52471"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53976.md) is a better
                          choice).
