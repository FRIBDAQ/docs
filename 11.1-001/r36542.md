...
[← CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36540.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CUnixUserCheck →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36615.md)
...
<a name="AEN36584"></a>## Public member functions
...
`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10022.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r38332.md).
...
`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10022.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r39062.md).
...
<a name="AEN36634"></a>## Types and public data

`CTCLInterpreter`
            and
            `CTCLVariable`
            are objects that are part of the Tcl++ library. See the
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10022.md) of the
