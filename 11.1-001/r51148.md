...
[← CModuleCreator](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51115.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51155.md)
...
<a name="AEN51152"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN51155"></a>## Synopsis

```
CControlHardware
```

<a name="AEN51222"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51008.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51105.md)
