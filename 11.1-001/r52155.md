...
[← Event builder client framework](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52148.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client framework →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52156.md)
...
<a name="AEN52167"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN52170"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN52174"></a>## DESCRIPTION
