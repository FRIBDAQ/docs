...
[← CCAMACScalerLRS2551](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r29226.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAMACScalerLRS4434 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r29328.md)
...
- <a name="AEN29277"></a>`  CCAMACScalerLRS2551(unsigned int b, unsigned int c, unsigned int n);`
...
- <a name="AEN29297"></a>`virtual void  Initialize(void);`
  Prepares the module for data taking; the module scaler channels are cleared.
- <a name="AEN29307"></a>`void   Read (std::vector<unsigned long>%amp; Scaleres);`
