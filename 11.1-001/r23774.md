...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23929]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23929]].
...
[[portAllocator(3tcl)|r68655]],
            [[CPortManagerException(3daq)|r23929]],
            [[DaqPortManager(1tcl)|r15136]]
