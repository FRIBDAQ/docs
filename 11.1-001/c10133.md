...
[← The NSCL Exception class library](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10080.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Injecting variables into the USB data taking frameworks →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10140.md)

---

---

# <a name="AEN10133"></a>Chapter 55. Injecting variables into the USB data taking frameworks
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12963.md) a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([controlpush(1epics)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12963.md)),
...
<a name="AEN10152"></a>**Example 55-1. The **watch** command.**
