...
<a name="AEN16560"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16563"></a>## Synopsis
...
<a name="AEN16639"></a>## Public member functions
...
<a name="AEN16730"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16734"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16738"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
