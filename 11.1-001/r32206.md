...
[← CVMEScalerLRS1151](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r32204.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CVMEStatusModule →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r32283.md)
...
<a name="AEN32249"></a>## Public member functions
...
<a name="AEN32287"></a>## Examples

The example below shows how to use one of these modules in the production readout
                framework:

<a name="AEN32290"></a>**Example 1. Using the LRS 1151 in the production readout framework.**
