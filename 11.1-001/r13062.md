...
[← ringselector](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r13005.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [chanlog →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r13069.md)
...
<a name="AEN13066"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN13069"></a>## Synopsis
...
<a name="AEN13096"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN13099"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN13102"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN13105"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN13108"></a>## DEPENDENCIES
