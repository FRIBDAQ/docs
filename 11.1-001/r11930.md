...
[← BufferToRing](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11868.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [bufdump →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11933.md)
...
<a name="AEN11978"></a>## EXAMPLES

This sample creates a hex dump of the data coming from a
        ring buffer:

<a name="AEN11981"></a>**Example 1. making hex dumps of data from a ring buffer.**
