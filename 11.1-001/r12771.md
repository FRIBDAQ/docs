...
[← ccusbloader](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12770.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ccusbloader →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12773.md)
...
<a name="AEN12775"></a>## Name

ccusbloader -- CC-USB Firmware loader

<a name="AEN12778"></a>## Synopsis

**
ccusbloader *firmware-filename [serial-string]*
**

<a name="AEN12783"></a>## DESCRIPTION

Loads the firmware-filename into the currently
            selected firmware location. See
            [*VM/CCUSB Firmware loaders*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7192.md)
...
<a name="AEN12790"></a>## KNOWN ISSUES
