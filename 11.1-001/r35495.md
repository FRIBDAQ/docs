...
[← CCondition](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35493.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CMutex →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35527.md)
...
<a name="AEN35499"></a>## Name

CCondition -- Encapsulate POSIX condition variables.

<a name="AEN35502"></a>## Synopsis

```
CConditionAttributes
```

<a name="AEN35606"></a>## DESCRIPTION
...
<a name="AEN35759"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
