...
[← DataFormat.h](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r21448.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [format  Functions →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r21750.md)
...
<a name="AEN21752"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN21763"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN21797"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN21817"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN21863"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN21869"></a>`pGlomParameters
...
<a name="AEN21903"></a>`pEventBuilderFragment
...
<a name="AEN21923"></a>` pPhysicsEventItem
...
<a name="AEN21943"></a>` pPhysicsEventCountItem
...
<a name="AEN22036"></a>` pStateChangeItem
...
<a name="AEN22068"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22076"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22082"></a>## DESCRIPTION
...
- <a name="AEN22090"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
- <a name="AEN22111"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
- <a name="AEN22166"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
  ...
  `stamp` is the unix
                              ...
                              was created.
- <a name="AEN22202"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
- <a name="AEN22242"></a>`pScalerItem
  ...
  Note that as with all of these functions,
                                  ...
                                  free(3),
- <a name="AEN22295"></a>`pDataFormatformatDataFormat
                            (void);`
...
- <a name="AEN22311"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
- <a name="AEN22338"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
  ...
  The contents of the ring item are as follows:
                                  ...
                                  `pPayload`.
- <a name="AEN22370"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
  ...
  This performs the same operation as
                                  ...
                                  EVB_UNKNOWN_PAYLOAD
- <a name="AEN22396"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
  ...
  Creates an event ring item that has a full body
                                  ...
                                  `pPayload`
- <a name="AEN22425"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN22573"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
- <a name="AEN22625"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
- <a name="AEN22636"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
