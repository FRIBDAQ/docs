...
[← EVBC::initialize](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52010.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [cccusb →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52031.md)
...
<a name="AEN52024"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN52027"></a>## Synopsis

**
EVBC::initialize *options*
**

<a name="AEN52031"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51795.md).

<a name="AEN52039"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51795.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52073.md)).
