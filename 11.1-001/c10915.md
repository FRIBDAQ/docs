...
For reference information on this class see:
            [[CEventSegment(3sbsreadout)|r74892]].
            Closely allied with this is the concept of packets.  Packets are supported
            via the [[CDocumentedPacket(3sbsreadout)|r74511]].
            The [[CEventPacket(3sbsreadout)|r74774]]
...
For reference information about the `CCompoundEventSegment`
            class see
            [[CCompoundEventSegment(3sbsreadout)|r74241]].

The readout software has a single object from the
            [[CExperiment(3sbsreadout)|r75201]]
...
See the section:
            [[Modifying the skeleton application to meet your needs|x11336]]
...
- [[![(1)](../images/callouts/1.gif)|c10915#specialring-normal-stuff]]
...
- [[![(2)](../images/callouts/2.gif)|c10915#specialring-getring]]
...
- [[![(1)](../images/callouts/1.gif)|c10915#specialring_getevtcount]]
  To set up for the loop that emits ring items we first
                          fetch the number of events that have been read.
- [[![(2)](../images/callouts/2.gif)|c10915#specialring_geteventinfo]]
  This section of code gets the informatino about the event
                          ...
                          variable.
- [[![(3)](../images/callouts/3.gif)|c10915#specialring_makeitem]]
...
- [[![(4)](../images/callouts/4.gif)|c10915#specialring_fillitem]]
  The `getBodyCursor` method
                          ...
                          event data.
- [[![(5)](../images/callouts/5.gif)|c10915#specialring_updatecursor]]
  This line computes a pointer to the first unused byte
                          ...
                          to put its data.
- [[![(6)](../images/callouts/6.gif)|c10915#specialring_commit]]
...
- [[![(7)](../images/callouts/7.gif)|c10915#specialring_bookkeeping]]
