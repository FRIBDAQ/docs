...
<a name="AEN50020"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN50023"></a>## Synopsis
...
<a name="AEN50192"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r45030]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r50741]])
...
<a name="AEN50200"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r50741]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r50741]] for
...
<a name="AEN50652"></a>## DEVICE ENUMERATION
...
<a name="AEN50676"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN50686"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN50692"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r48249]] for reference
...
<a name="AEN50735"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r45030]]
[[cccusbreadoutlist(3ccusb)|r50741]]
[[CCCUSBReadoutList(3ccusb)|r48249]]
