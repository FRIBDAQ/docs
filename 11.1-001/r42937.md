...
[← CURIFormatException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42936.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CURIFormatException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42939.md)
...
<a name="AEN42941"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN42944"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN43028"></a>## Description
...
<a name="AEN43035"></a>## Public member functions
