...
[← CCrateController](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30341.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3600 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30494.md)
...
<a name="AEN30639"></a>## Public member functions
...
- <a name="AEN30662"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN30672"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN30683"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN30694"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN30706"></a>` void SetLatchMode(void);const`
...
- <a name="AEN30718"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN30753"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN30822"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN30833"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN30844"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN30855"></a>` void Clock(void);const`
...
- <a name="AEN30866"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN30877"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN30888"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN30900"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN30911"></a>` unsigned long Read(void);const`
...
- <a name="AEN30923"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
