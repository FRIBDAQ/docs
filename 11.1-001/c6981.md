...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6979.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The tcl server application →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6999.md)
...
Most experiments will record event data.  Event data files are
        ...
        ring buffers.
        See the chapter:
        [Format of EventData In Ring Buffers](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c185.md)
...
The full reference documentation for the program is in the
        [event log reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12866.md).
