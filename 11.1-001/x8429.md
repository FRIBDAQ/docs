...
[← Incorporating the headers and libraries into your applications.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8427.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the headers and libraries into your applications. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8431.md)

---

---

# <a name="AEN8429"></a>40.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8435"></a>**Example 40-1. Including a ring item class **
...
<a name="AEN8442"></a>**Example 40-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8447"></a>**Example 40-3. Linking the ring item format libraries**
...
- [`CRingItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17368.md)
...
- [`CRingStateChangeItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18271.md)
...
- [`CRingScalerItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17835.md)
...
- [`CRingTextItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18666.md)
...
- [`CGlomParameters`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r20121.md)
...
- [`CPhysicsEventItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18982.md)
  Encapsulates the data taken in response to a physics
                          trigger.
- [`CRingFragmentItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19485.md)
...
- [`CRingPhysicsEventCountItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19168.md)
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [`CUnknownFragment`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19790.md)
...
## <a name="AEN8519"></a>40.3.1. Generic ring data sources
...
Reference information on these classes is availabe at:
                [*CDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22663.md),
                [*CRingDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22705.md),
                [*CFileDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22774.md),
                [*CDataSourceFactory"*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22831.md),
                and
                [*CRingItemFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22888.md).
