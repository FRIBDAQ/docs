...
[[`CRingItem`|r17368]]Base class for all the ring data item format classes.
...
[[`CRingStateChangeItem`|r18271]]Represents a state change item.  Given a reference to
...
[[`CRingScalerItem`|r17835]]Represents a state change item.  Given a reference to a
...
[[`CRingTextItem`|r18666]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[`CGlomParameters`|r20121]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[`CPhysicsEventItem`|r18982]]Encapsulates the data taken in response to a physics
                        trigger.

[[`CRingFragmentItem`|r19485]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[`CRingPhysicsEventCountItem`|r19168]]Encapsulates an item that gives information about the
...
[[`CUnknownFragment`|r19790]]Encapsulates an event fragment produced by the event
...
Reference information on these classes is availabe at:
                [[*CDataSource*|r22663]],
                [[*CRingDataSource*|r22705]],
                [[*CFileDataSource*|r22774]],
                [[*CDataSourceFactory"*|r22831]],
                and
                [[*CRingItemFactory*|r22888]].
