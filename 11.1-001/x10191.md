...
[← Using the standard event orderer startup script](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10189.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing an event orderer startup script →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10192.md)

---

---

# <a name="AEN10191"></a>56.2. Using the standard event orderer startup script
