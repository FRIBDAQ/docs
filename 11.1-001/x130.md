...
- ringbuffer
  This utility allows you to create, re-initialize, delete  and
              ...
              don't already exist. See the [[man page|r11842]] for more information.
- dumper
  Provides a simple textual formatted dump of the buffers.  If you
              ...
              each event and the packets within the event. See [[user documentation|c6915]] and [[man page|r12598]] for more information.
- eventlog
  Performs native mode event loggging.  In this mode, event file
              segments consists of streams of ring buffer items. See [[user documentation|c6979]] and [[man page|r12682]] for more information.
- ringselector
  Provides a flexible ringbuffer consumer that pipes the ring items
              ...
              applications like SpecTcl. See [[user documentation|c7304]] and [[man page|r12821]] for more information.
- ringtostdout
  Accepts data from a ring and pipes it to stdout.  This is the server
              ...
              process data from  a ring. See the [[man page|r11940]] for more information.
- ScalerDisplay
  Provides a display of scaler event data.  This application is highly
              ...
              selected scalers are also supported. See [[user documentation|c4573]] and [[man page|r12300#manpage.scalerdisplay]] for more information.
- stdintoring
  Accepts data on stdin and puts it in a ring buffer.  This is the
              client side of the data pipeline that sets up a proxy ring. See the [[man page|r11994]] for more information.
