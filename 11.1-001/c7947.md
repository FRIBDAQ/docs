...
[← Data Format Support Software](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7945.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Data Format Support Software →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7949.md)
...
# <a name="AEN7962"></a>40.1. The basic data formats
...
<a name="AEN8048"></a>`pDataFormatformatDataFormat
          (void);`


<a name="AEN8054"></a>`pGlomParameters
...
<a name="AEN8068"></a>`pEventBuilderFragment
            formatEVBFragment
          (
            uint64_t timestamp
          , 
...
<a name="AEN8088"></a>`pEventBuilderFragment
...
<a name="AEN8108"></a>` pPhysicsEventItem
...
<a name="AEN8128"></a>` pPhysicsEventCountItem
...
<a name="AEN8221"></a>` pStateChangeItem
...
<a name="AEN8253"></a>` void* bodyPointer
          (
            pRingItem pItem
          );`
...
## <a name="AEN8262"></a>40.1.1. State Change Items
...
## <a name="AEN8302"></a>40.1.2. Text List Items
...
## <a name="AEN8351"></a>40.1.3. Scaler Items
...
## <a name="AEN8384"></a>40.1.4. Event Data Items
...
## <a name="AEN8391"></a>40.1.5. Event count items
