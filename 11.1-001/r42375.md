...
[← CException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42373.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLString →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42407.md)
...
<a name="AEN42379"></a>## Name

CException -- Abstract base class for the exception class hierarchy.

<a name="AEN42382"></a>## Synopsis

```
CException
```

<a name="AEN42416"></a>## Description
...
<a name="AEN42421"></a>## Public member functions
