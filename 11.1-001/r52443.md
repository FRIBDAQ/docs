...
[← Configuration](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52441.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [DAQParameters →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52530.md)
...
<a name="AEN52455"></a>## Name

Configuration -- Configuration variable management

<a name="AEN52458"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53986.md) package for that
            instead.

<a name="AEN52481"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53986.md) is a better
                          choice).
