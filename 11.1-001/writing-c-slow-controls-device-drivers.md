...
# <a name="AEN2890"></a>5.7. Writing C++ slow controls device drivers
...
## <a name="AEN2906"></a>5.7.1. Obtaining the sample driver and its Makefile
...
<a name="AEN2911"></a>**Example 5-9. Obtaining the sample CCUSB slow controls driver**
...
## <a name="AEN2929"></a>5.7.2. Modifying the sample driver and Makefile.
...
### <a name="AEN2948"></a>5.7.2.1. Driver Code
...
<a name="AEN2951"></a>**Example 5-10. Headers for the CCUSB sample slow controls driver**
...
[[x2890#ccusb-slowdriver-includes-tcl.h]]                            Since our driver will get loaded via the Tcl
                        ...
                        [[x2890#ccusb-slowdriver-includes-CModuleFactory.h]]                            The `CModuleFactory` class is
...
[[x2890#ccusb-slowdriver-includes-CModuleCreator.h]]                            This header defines the base class for all module
                        ...
                        [[x2890#ccusb-slowdriver-includes-CControlHardware.h]]                            Drivers are classes that are derived from
                            ...
                            (see
                            [[r53163]]
[[x2890#ccusb-slowdriver-includes-CControlModule.h]]                            The makeup of a `CControlHardware`
...
#### <a name="AEN2991"></a>5.7.2.1.1. The driver class and its implementation
...
<a name="AEN2994"></a>**Example 5-11. CCUSB Slow control driver class definition **
...
[[x2890#ccusb-slowdriver-def-onattach]]                                The `OnAttach` method is
...
**Construction and destruction. **
                            See
                            [[x2890#ccusb-slowdriver-impl-condestruct]]
...
[[x2890#ccusb-slowdriver-impl-constr-baseinit]]                                The constructor must initialize the base
                            ...
                            [[x2890#ccusb-slowdriver-impl-constr-configinit]]                                The `m_pConfig` member variable
...
<a name="AEN3075"></a>**Example 5-13. CCUSB Slow controls driver `OnAttach`**
...
<a name="AEN3109"></a>**Example 5-14. CCUSB Slow controls driver initialize method**
...
<a name="AEN3121"></a>**Example 5-15. CCUSB Slow controls driver Update**
...
<a name="AEN3149"></a>**Example 5-16. CCUSB Slow controls driver Set method**
...
[[x2890#cccusb-slowdriver-impl-set-configure]]                                Our driver uses the configuration database
...
[[x2890#cccusb-slowdriver-impl-set-ok]]                                On success, the `Set`
...
<a name="AEN3184"></a>**Example 5-17. CCUSB slow controls Get method**
...
[[x2890#ccusb-slowdriver-impl-get-error]]                                The `cget` method throws
...
<a name="AEN3209"></a>**Example 5-18. CCUSB Slow controls clone method**
...
#### <a name="AEN3217"></a>5.7.2.1.2. The creator class and its implementation
...
<a name="AEN3228"></a>**Example 5-19. Module creator for the CCUSB Sample slow controls driver**
...
<a name="AEN3258"></a>**Example 5-20. CCUSB Slow control driver initialization function**
...
### <a name="AEN3288"></a>5.7.2.2. The Makefile and typical modifications.
...
<a name="AEN3294"></a>**Example 5-21. CCUSB Slow controls driver Skeleton Makefile**
