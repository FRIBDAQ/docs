...
[← Event builder client API](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c8654.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client API →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c8657.md)
...
# <a name="AEN8664"></a>41.1. C++ Client API
...
- [Making `CEventOrderClient` available
                  within your program.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10568.md)
- [How to form a connection with the event orderer.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8702.md)
