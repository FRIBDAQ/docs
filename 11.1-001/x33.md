...
[← The Ring Item Types](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x314.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing Tcl slow controls device drivers →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x3315.md)
...
There are a number of frameworks for building C++ applications. First
      there is the [SBS Readout Framework](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10915.md),
      ...
      data format. To facilitate the design of filter programs, the [Filter framework](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c11439.md) exists. It handles the
