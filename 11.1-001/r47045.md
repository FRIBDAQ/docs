...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r46934.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r47784.md)
...
<a name="AEN47049"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN47052"></a>## Synopsis

```
CCCUSB
```

<a name="AEN48034"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r50264.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r50264.md) for
...
<a name="AEN48605"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN48609"></a>### Action Register
...
<a name="AEN48652"></a>### Firmware Register
...
<a name="AEN48704"></a>### Global Mode Register
...
<a name="AEN48837"></a>### Delay Register
...
<a name="AEN48870"></a>### Scaler Control register
...
<a name="AEN48903"></a>### LED Source Register
...
<a name="AEN49155"></a>### Output source selection register.
...
<a name="AEN49324"></a>### Device source register
...
<a name="AEN49677"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN49738"></a>### Transfer setup register
