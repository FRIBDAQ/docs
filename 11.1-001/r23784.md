...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23939]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23939]].
...
[[portAllocator(3tcl)|r68698]],
            [[CPortManagerException(3daq)|r23939]],
            [[DaqPortManager(1tcl)|r15146]]
