...
[← CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23936.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23939.md)
...
<a name="AEN23998"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23782.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN24005"></a>## Public member functions
...
<a name="AEN24061"></a>## Types and public data
...
<a name="AEN24081"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN24084"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r68696.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23782.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15144.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42373.md)
