...
[← The ringselector application](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7301.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The ringselector application →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7304.md)
...
The ringselector application is very
        ...
        [ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11938.md)
        application.  Both
...
<a name="AEN7361"></a>**Example 29-1. Dumping state changes and sampled event data with od**
...
<a name="AEN7369"></a>**Example 29-2. Dumping all but packet types**
...
<a name="AEN7377"></a>**Example 29-3. Attaching SpecTcl**
...
For a complete reference on the command see the
        [ringselector reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12819.md).
