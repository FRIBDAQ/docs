...
In addition to
            [[CInteractor|r36960]], the following
            concrete interactors have been supplied.



[[`CStringInteractor`|r37129]]This interactor supplies a string that you have gotten by
                        whatever means you got it.  It can be used when interactors
                        are not suitable for acquiring the stringified credentials.

[[`CFdInteractor`|r37290]]This interactor accepts the credentials via an open file
                        descriptor.

[[`CIOInteractor`|r37416]]This interator uses a pair of other interactors, an output and
