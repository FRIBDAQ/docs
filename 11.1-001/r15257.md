...
[← tclserver](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15255.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVB::reviveSocket →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15263.md)
...
<a name="AEN15261"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN15264"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN15271"></a>## DESCRIPTION
