...
<a name="AEN26432"></a>## Public member functions
...
<a name="AEN26439"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN26460"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN26473"></a>` unsigned char getVersion(void);const`
...
<a name="AEN26498"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN26509"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN26855"></a>` ECLOutputSelect
...
<a name="AEN26923"></a>` unsigned short
...
<a name="AEN27087"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN27099"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN27109"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN27119"></a>` TriggerConfiguration
...
<a name="AEN27216"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN27257"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN27283"></a>` LEResolution
...
<a name="AEN27297"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN27457"></a>` unsigned short
...
<a name="AEN27551"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN27563"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN27580"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN27593"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN27605"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN27626"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN27638"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN27653"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN27668"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN27683"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN27695"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN27710"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN27720"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN27732"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN27744"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
...
<a name="AEN27768"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN27778"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN27788"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN27798"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN27808"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN27820"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN27830"></a>` void
                    EnableErrorMark(void);`



<a name="AEN27840"></a>` void
                    DisableErrorMark(void);`



<a name="AEN27850"></a>` void EnableBypassOnError(void);`



<a name="AEN27860"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN27870"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN27882"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN27892"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN27904"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN27914"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN27926"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN27938"></a>` void EnableAllChannels(void);`



<a name="AEN27948"></a>` void
                    DisableAllChannels(void);`



<a name="AEN27958"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN27970"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN27982"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN27997"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN28009"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN28021"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN28042"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN28055"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN28072"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN28090"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN28105"></a>## Types and public data
