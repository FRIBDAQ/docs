...
[[![(1)](../images/callouts/1.gif)|c9864#chapter.uri.usage]]                The test program accepts the URL to parse as its command line
            ...
            [[![(2)](../images/callouts/2.gif)|c9864#chapter.uri.try]]                The `URL` constructor parses the
