...
[← FrameManager](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73543.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CV977Busy →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73606.md)
...
<a name="AEN73645"></a>| Plug | Direction | Meaning |
| --- | --- | --- |
...
<a name="AEN73666"></a>## Public member functions
...
<a name="AEN73702"></a>## SEE ALSO

[CBusy(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r71566.md),
     [CV977Trigger(3sbsReadout)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r73707.md)
