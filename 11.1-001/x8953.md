...
[← How do I use it?](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8923.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using TclRingBuffer in event driven software →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8960.md)

---

---

# <a name="AEN8953"></a>42.3. Using TclRingBuffer in event driven software
...
<a name="AEN8959"></a>**Example 42-2. The Scaler Display ring buffer thread**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_create)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_auto_path)
  The environment a thread interpreter starts with is fairly minimal. It
  	  ...
  	  interpreter.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_require)
  Now that the NSCLDAQ Tcl libraries are visible, the thread is asked
  	  to load the TclRingBuffer package.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_attachring)
  With the Tcl Ring buffer package loaded **ringbuffer**
  	  ...
  	  proc parameter.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_parentid)
  As we have seen, in order to send a command to a thread you must know
  	  ...
  	  **thread::send** commands to the parent when a ring
  	  item is received.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_procloop)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_postevent)
  This line posts an event to the parent thread.  The event invokes the
  	  **handleData** command in the parent thread, passing
  	  ...
  	  necessary.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_startprocessing)
  The last line of the code sent to the thread actually start
  	  processing ring items by invoking **getItems**.
- [![(9)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/9.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8953.md#sclthread_bgthread)
