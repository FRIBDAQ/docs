...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8921.md#tclring_attach)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8921.md#tclring_get)
  ...
  The next matching ring items is translated to a dict (see
  	  ...
  	  command.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8921.md#tclring_detach)
