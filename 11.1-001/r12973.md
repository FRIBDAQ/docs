...
[← 1epics](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12971.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vmusbloader →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12981.md)
...
<a name="AEN13055"></a>## CONFIGURATION FILES
...
Channel lines, have as their first non-whitespace word, the name of
	   ...
	   (notably
	   [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7528.md)) may 
	   parse additional characters for their own purposes.

<a name="AEN13063"></a>## DEPENDENCIES
