...
[← Incorporating the library into an application.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9600.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using CGaurdedObject to implement synchronized methods →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9611.md)

---

---

# <a name="AEN9601"></a>49.3. Using CGaurdedObject to implement synchronized methods
...
<a name="AEN9608"></a>**Example 49-5. Using `CGaurdedObject`**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9601.md#gaurded_include)
  The header CGaurdedObject.h defines the
  	    `CGaurdedObject` class and must be included
  	    by classes that derive from that class.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9601.md#gaurded_inherit)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9601.md#gaurded_enter)
  Invoking the `Enter` method of the base class
  	    ...
  	    will not block.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x9601.md#gaurded_leave)
