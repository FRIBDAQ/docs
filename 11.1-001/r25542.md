...
[← CBD8210](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25358.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r25716.md)
...
<a name="AEN25671"></a>## Public member functions





- <a name="AEN25677"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25689"></a>`bool Xtest(void);const`
...
- <a name="AEN25701"></a>`bool Qtest(void);const`
...
- <a name="AEN25718"></a>`bool TimedOut(void);const`
...
- <a name="AEN25730"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25742"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25756"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25769"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25783"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25798"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25813"></a>`bool IT4(void);const`
...
- <a name="AEN25827"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25838"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25851"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25867"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25878"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25889"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25899"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25903"></a>**Example 1. Initializing branch 0**
