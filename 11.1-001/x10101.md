...
[← Compiling/Linking your software with the shared memory API](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10013.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Exception classes →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10108.md)

---

---

# <a name="AEN10101"></a>54.2. Exception classes
...
<a name="AEN10126"></a>**Example 54-1. Catching `CException` and exiting**
