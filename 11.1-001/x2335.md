...
[← Pushing external data into the event stream](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x2247.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing DAQ configuration files →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x2337.md)
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44335.md) command
