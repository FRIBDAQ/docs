...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55470.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [3python →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55472.md)
...
<a name="AEN55483"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN55486"></a>## Synopsis
...
<a name="AEN55500"></a>## METHODS



- <a name="AEN55505"></a>`PortManager(string host, int    port);`
