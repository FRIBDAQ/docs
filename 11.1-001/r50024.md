...
<a name="AEN50028"></a>## Name

cccusb -- Swig wrapping of the CCCUSB C++ class.

<a name="AEN50031"></a>## Synopsis
...
<a name="AEN50200"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r45038]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r50749]])
...
<a name="AEN50208"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r50749]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r50749]] for
...
<a name="AEN50660"></a>## DEVICE ENUMERATION
...
<a name="AEN50684"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN50694"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN50700"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r48257]] for reference
...
<a name="AEN50743"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r45038]]
[[cccusbreadoutlist(3ccusb)|r50749]]
[[CCCUSBReadoutList(3ccusb)|r48257]]
