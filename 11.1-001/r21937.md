...
<a name="AEN21941"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN21944"></a>## Synopsis
...
<a name="AEN21946"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN21957"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN21991"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN22011"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN22057"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN22063"></a>`pGlomParameters
...
<a name="AEN22077"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN22097"></a>`pEventBuilderFragment
...
<a name="AEN22117"></a>` pPhysicsEventItem
...
<a name="AEN22137"></a>` pPhysicsEventCountItem
...
<a name="AEN22230"></a>` pStateChangeItem
...
<a name="AEN22262"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN22270"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN22276"></a>## DESCRIPTION
...
<a name="AEN22284"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN22305"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN22360"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN22396"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN22489"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN22505"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN22532"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22564"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22590"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22619"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22767"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN22819"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN22830"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
