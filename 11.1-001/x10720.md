...
[← EVBC state manager callback bundle.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10718.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running event builder clients →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10730.md)

---

---

# <a name="AEN10720"></a>58.3. EVBC state manager callback bundle.
...
<a name="AEN10726"></a>**Example 58-1. Using the EVBC state manager callback bundle**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10720.md#evbbundle.require)
  Incorporates the package code into your script.  This makes
                      all three APIs visible and accessible from your script.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10720.md#evbbundle.onstart)
  The `OnStart` is called from the
                      ...
                      user interface.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10720.md#evbbundle.register)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10720.md#evbbundle.configure)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10720.md#evbbundle.startsources)
  When the event builder is started, if you define a proc named
                      ...
                      event builder.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10720.md#evbbundle.startringsource)
