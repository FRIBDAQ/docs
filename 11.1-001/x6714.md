...
[← How to use the MDGG16Control GUI](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6713.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [How to use the MDGG16Control GUI →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6716.md)

---

---

# <a name="AEN6714"></a>14.2. How to use the MDGG16Control GUI
