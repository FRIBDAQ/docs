...
[← Using the standard event orderer startup script](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10181.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using the standard event orderer startup script →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10189.md)

---

---

# <a name="AEN10188"></a>56.2. Using the standard event orderer startup script
