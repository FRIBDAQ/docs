...
[← The ringselector application](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7294.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The ringselector application →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7302.md)
...
The ringselector application is very
        ...
        [ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11937.md)
        application.  Both
...
<a name="AEN7360"></a>**Example 29-1. Dumping state changes and sampled event data with od**
...
<a name="AEN7368"></a>**Example 29-2. Dumping all but packet types**
...
<a name="AEN7376"></a>**Example 29-3. Attaching SpecTcl**
...
For a complete reference on the command see the
        [ringselector reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12818.md).
