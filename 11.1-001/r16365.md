...
[← CRingAccess](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16363.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingBuffer →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r16548.md)
...
<a name="AEN16376"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16379"></a>## Synopsis
...
The chapter:
            [Networed Ring Buffer Access](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7751.md)
            includes sample code for detecting and mapping the use of a system's
            hostname into localhost.

<a name="AEN16455"></a>## Public member functions
...
<a name="AEN16546"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16550"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16554"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
