...
[← CUnixUserCheck](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36615.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36637.md)
...
<a name="AEN36690"></a>## Description

The
            `CAccessListCheck`
            class implements authentication against one of a set of legal
            credentials.  This is simlar in nature to the
            [CTclAccessListCheck](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r36532.md)
...
<a name="AEN36766"></a>## Types and public data
