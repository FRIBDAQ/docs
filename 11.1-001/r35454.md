...
[← SyncGuard](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35360.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CriticalSection →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35461.md)
...
<a name="AEN35466"></a>## Name

CriticalSection -- Simple, safe critical section

<a name="AEN35469"></a>## Synopsis

```
CriticalSection
```

<a name="AEN35478"></a>## DESCRIPTION
