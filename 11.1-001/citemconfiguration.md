...
<a name="AEN43441"></a>## Name

CItemConfiguration -- Hold a configuration

<a name="AEN43444"></a>## Synopsis
...
<a name="AEN43670"></a>## Public member functions
...
<a name="AEN43848"></a>## Types and public data
...
<a name="AEN43881"></a>### ConfigurationArray
...
<a name="AEN43887"></a>### Pre-defined type checkers and related data types
...
std::string `name`Name of the configuration parameter being checked.

std::string `value`The proposed new value for the configuration
                                parameter.  This is the value to be checked
                                by the validation function.

void* `arg`This anonymous pointer points to data that
...
| --- | --- | --- |
| Prev | Home | Next |
| CTCLPackagedObjectProcessor | Up | CConfigurableObject |
