...
[← Configuration](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52440.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuration →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52443.md)
...
<a name="AEN52453"></a>## Name

Configuration -- Configuration variable management

<a name="AEN52456"></a>## Synopsis
...
In addition to simple set and get operations environment variables
            ...
            [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53984.md) package for that
            instead.

<a name="AEN52479"></a>## PROCEDURES
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [*StateManager*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53984.md) is a better
                          choice).
