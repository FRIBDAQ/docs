...
[← chanlog](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r13070.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [1evb →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r13118.md)
...
<a name="AEN13076"></a>## Name

chanlog -- Write a set of channels to file

<a name="AEN13079"></a>## Synopsis

**
chanlog *channelfile* *outfile*
**

<a name="AEN13084"></a>## DESCRIPTION
...
<a name="AEN13106"></a>**Example 1. Viewing a set of channel values interactively**
...
<a name="AEN13109"></a>**Example 2. Writing a set of channels to a file**
...
<a name="AEN13112"></a>**Example 3. Appending a set of channels to a file**
...
<a name="AEN13115"></a>**Example 4. Piping a set of channels to a program for processing**
...
<a name="AEN13118"></a>## DEPENDENCIES
