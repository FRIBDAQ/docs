...
- [[![(1)](../images/callouts/1.gif)|x7851#ringcons.include]]
  The
                          CRingBuffer.h
                          header is included.
...
- [[![(2)](../images/callouts/2.gif)|x7851#ringcons.std]]
  Incorporating the
                          ...
                          `std::string`
- [[![(3)](../images/callouts/3.gif)|x7851#ringcons.create]]
...
- [[![(4)](../images/callouts/4.gif)|x7851#ringcons.obj]]
...
- [[![(5)](../images/callouts/5.gif)|x7851#ringcons.latency]]
...
- [[![(6)](../images/callouts/6.gif)|x7851#ringcons.get]]
  The
                          `get`
...
- [[![(1)](../images/callouts/1.gif)|x7851#ringprod.include]]
  Includes the
                          CRingBuffer.h
                          ...
                          ring buffers.
- [[![(3)](../images/callouts/3.gif)|x7851#ringprod.latency]]
  See the discussion of the consumer for more
                          ...
                          response latencies.
- [[![(4)](../images/callouts/4.gif)|x7851#ringprod.pattern]]
  This loop creates a buffer that consists of 1MB
                          counting pattern.
- [[![(5)](../images/callouts/5.gif)|x7851#ringprod.put]]
