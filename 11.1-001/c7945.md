...
[← Data Format Support Software](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7944.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Data Format Support Software →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c7947.md)
...
# <a name="AEN7960"></a>40.1. The basic data formats
...
<a name="AEN8046"></a>`pDataFormatformatDataFormat
          (void);`


<a name="AEN8052"></a>`pGlomParameters
...
<a name="AEN8066"></a>`pEventBuilderFragment
            formatEVBFragment
          (
            uint64_t timestamp
          , 
...
<a name="AEN8086"></a>`pEventBuilderFragment
...
<a name="AEN8106"></a>` pPhysicsEventItem
...
<a name="AEN8126"></a>` pPhysicsEventCountItem
...
<a name="AEN8219"></a>` pStateChangeItem
...
<a name="AEN8251"></a>` void* bodyPointer
          (
            pRingItem pItem
          );`
...
## <a name="AEN8260"></a>40.1.1. State Change Items
...
## <a name="AEN8300"></a>40.1.2. Text List Items
...
## <a name="AEN8349"></a>40.1.3. Scaler Items
...
## <a name="AEN8382"></a>40.1.4. Event Data Items
...
## <a name="AEN8389"></a>40.1.5. Event count items
