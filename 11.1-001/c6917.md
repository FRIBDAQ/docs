...
[← The dumper program](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6915.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6969.md)
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12782.md).
...
<a name="AEN6931"></a>**Example 19-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN6935"></a>**Example 19-2. Dumping data from the event file segment
...
# <a name="AEN6945"></a>19.1. Item dump formats and examples
...
<a name="AEN6948"></a>**Example 19-3. State Transition items**
...
<a name="AEN6953"></a>**Example 19-4. Text List items**
...
<a name="AEN6958"></a>**Example 19-5. Incremental Scalers dump**
...
<a name="AEN6964"></a>**Example 19-6. Event count items**
...
<a name="AEN6970"></a>**Example 19-7. Physics Event items**
...
<a name="AEN6975"></a>**Example 19-8. Unknown item types**
