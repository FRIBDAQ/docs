...
[← Incorporating the headers and libraries into your applications.](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8426.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the headers and libraries into your applications. →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x8429.md)

---

---

# <a name="AEN8427"></a>40.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8433"></a>**Example 40-1. Including a ring item class **
...
<a name="AEN8440"></a>**Example 40-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8445"></a>**Example 40-3. Linking the ring item format libraries**
...
- [`CRingItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17366.md)
...
- [`CRingStateChangeItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18269.md)
...
- [`CRingScalerItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17833.md)
...
- [`CRingTextItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18664.md)
...
- [`CGlomParameters`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r20119.md)
...
- [`CPhysicsEventItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r18980.md)
  Encapsulates the data taken in response to a physics
                          trigger.
- [`CRingFragmentItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19483.md)
...
- [`CRingPhysicsEventCountItem`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19166.md)
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [`CUnknownFragment`](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r19788.md)
...
## <a name="AEN8517"></a>40.3.1. Generic ring data sources
...
Reference information on these classes is availabe at:
                [*CDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22661.md),
                [*CRingDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22703.md),
                [*CFileDataSource*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22772.md),
                [*CDataSourceFactory"*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22829.md),
                and
                [*CRingItemFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r22886.md).
