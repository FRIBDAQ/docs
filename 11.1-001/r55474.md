...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55472.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [ReadoutGUIPanel →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r55503.md)
...
<a name="AEN55486"></a>## Name

PortManager -- Python bindings to port manager

<a name="AEN55489"></a>## Synopsis
...
<a name="AEN55503"></a>## METHODS



- <a name="AEN55508"></a>`PortManager(string host, int    port);`
