...
[← SyncGuard](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35074.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSynchronizedThread →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r35169.md)
...
<a name="AEN35080"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35083"></a>## Synopsis
...
<a name="AEN35125"></a>## Public member functions
...
<a name="AEN35163"></a>`void sync_self(void);`
...
<a name="AEN35170"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35178"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35190"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35196"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35206"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35236"></a>`void sync_global_end(void);`
