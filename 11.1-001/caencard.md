...
<a name="AEN24751"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24754"></a>## Synopsis
...
<a name="AEN24980"></a>## Public member functions





<a name="AEN24986"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN25048"></a>`unsigned long getBase(void);`
...
<a name="AEN25059"></a>`int getSerial(void);`
...
<a name="AEN25090"></a>`int  getFirmware(void);`
...
<a name="AEN25100"></a>`int  getCrate(void);`
...
<a name="AEN25111"></a>`void setCrate(int crateNum);`
...
<a name="AEN25124"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN25145"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN25155"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN25165"></a>`void keepOverflowData(void);`
...
<a name="AEN25175"></a>`void discardOverflowData(void);`
...
<a name="AEN25185"></a>`void keepInvalidData(void);`
...
<a name="AEN25196"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN25207"></a>`void commonStart(void);`
...
<a name="AEN25218"></a>`void commonStop(void);`
...
<a name="AEN25229"></a>`void setRange(int range);`
...
<a name="AEN25242"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25314"></a>`void clearData
                                (void);`
...
<a name="AEN25357"></a>`bool Busy(void);`
...
<a name="AEN25368"></a>` bool gBusy(void);`
...
<a name="AEN25379"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25390"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25401"></a>`int readEvent(void* buf);`
...
<a name="AEN25414"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25455"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25518"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25522"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25526"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25530"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25534"></a>**Example 3. Reading out a CAEN 785 e.g.**
