...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42153.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CTCLIdleProcess →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42174.md)
...
<a name="AEN42255"></a>## Public member functions
...
<a name="AEN42366"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN42371"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r41432.md)
