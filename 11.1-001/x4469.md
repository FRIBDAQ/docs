...
[← Using the event builder](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4467.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [More detail on when the fragments are ouptutted →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4487.md)
...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c10856.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r53798.md).
...
The next thing that you need to do register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10763.md).
