...
[← The Event log program](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6969.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Event log program →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6977.md)
...
<a name="AEN7001"></a>**Example 20-1. Taking data from a remote ring**
...
The full reference documentation for the program is in the
        [event log reference page](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r12679.md).
