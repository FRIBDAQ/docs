...
[← VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70003.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [vhq →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70041.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70271.md)
        for one such panel.
...
<a name="AEN70042"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN70046"></a>### VhsWidgets::channel
...
<a name="AEN70066"></a>### VhsWidgets::channelStatus options
...
<a name="AEN70072"></a>## OBJECT METHODS
...
<a name="AEN70076"></a>**Example 1. Hooking update methods to recurring timer**
...
[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r69501.md)
