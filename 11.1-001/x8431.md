...
# <a name="AEN8431"></a>40.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8437"></a>**Example 40-1. Including a ring item class **
...
<a name="AEN8444"></a>**Example 40-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8449"></a>**Example 40-3. Linking the ring item format libraries**
...
[[r17552]]Base class for all the ring data item format classes.
...
[[r18455]]Represents a state change item.  Given a reference to
...
[[r18019]]Represents a state change item.  Given a reference to a
...
[[r18850]]Encapsulates a text list item.  As with all the above
                        classes, a constructor exists that converts a
                        `CRingItem` to a
                        `CRingTextItem` or throws a
                        `std::bad_cast` if that's not legal.

[[r20305]]Encapsulates the glom parameter ring items.  This ring
                        item describes how the glom component of the event builder
                        pipeline has been started.

[[r19166]]Encapsulates the data taken in response to a physics
                        trigger.

[[r19669]]Encapsulates items produced in the ordering phase of
                        the event builder pipeline.  Items of this type are
                        believed to have other ring items as their payloads.

[[r19352]]Encapsulates an item that gives information about the
...
[[r19974]]Encapsulates an event fragment produced by the event
                        builder ordering stage for which there's good reason to
                        believe the payload is not a ring item.

## <a name="AEN8521"></a>40.3.1. Generic ring data sources
