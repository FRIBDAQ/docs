...
[← CConfigurableObject](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44160.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [stack →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44332.md)
...
<a name="AEN44329"></a>## Name

stack -- Create and configure CC-USB stacks.

<a name="AEN44332"></a>## Synopsis
...
<a name="AEN44435"></a>## EXAMPLES

The example below extends the example in the
                  [ph7xxx(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44131.md) command reference
                  reading the defined modules in an event stack:

<a name="AEN44439"></a>**Example 1. Example of the **stack** command.**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44325.md#defmodules)
  These two lines define the modules that we will be using
                          for the experimental setup.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44325.md#stackdef)
  Creates a new stack called events
                          In subsequent lines I'm going to configure this stack
                          to handle the event trigger.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44325.md#typemods)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r44325.md#timing)
