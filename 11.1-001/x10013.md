...
[← Compiling/Linking your software with the shared memory API](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10003.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Exception classes →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x10101.md)
...
<a name="AEN10024"></a>**Example 52-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN10028"></a>**Example 52-3. Linking C++ object files that use the
            daqshm library**
