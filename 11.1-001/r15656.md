...
[← SBS Vme Tcl package](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15654.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [wienerbcnaf →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15668.md)
...
<a name="AEN15660"></a>## Name

vme -- Provide access to VME crates to Tcl scripts.

<a name="AEN15663"></a>## Synopsis
...
<a name="AEN15718"></a>### Map access command
...
<a name="AEN15728"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN15736"></a>***mapname* put *width offset value***
