...
[← CPortManager](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23784.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CPortManagerException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23936.md)
...
<a name="AEN23990"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [the man page for that class](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23774.md)).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN23997"></a>## Public member functions
...
<a name="AEN24053"></a>## Types and public data
...
<a name="AEN24073"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN24076"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r68655.md),
            [CPortManager(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r23774.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r15136.md)
[CException(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42365.md)
