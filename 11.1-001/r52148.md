...
[← Eventbuilder callback bundle](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52122.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Event builder client framework →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r52155.md)
...
<a name="AEN52160"></a>## Name

Event builder client framework -- Event builder cilent framework

<a name="AEN52163"></a>## Synopsis

** *binary-name options...*
**

<a name="AEN52167"></a>## DESCRIPTION
