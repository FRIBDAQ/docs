...
<a name="AEN35364"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN35367"></a>## Synopsis
...
<a name="AEN35409"></a>## Public member functions
...
<a name="AEN35447"></a>`void sync_self(void);`
...
<a name="AEN35454"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35462"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35474"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35480"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35490"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35520"></a>`void sync_global_end(void);`
