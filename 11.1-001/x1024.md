...
## <a name="AEN1100"></a>4.7.3. Implementing an onBeginRun() function

The third function that can be defined in the timestamp extractor
        library has the prototype:

<a name="AEN1103"></a>`void onBeginRun(void);`
...
<a name="AEN1109"></a>**Example 4-5. Adding an offset to the timestamp**
...
### <a name="AEN1132"></a>4.7.3.1. Compiling the shared library
