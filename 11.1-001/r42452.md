...
[← CTCLString](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42407.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CErrnoException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42459.md)
...
<a name="AEN42460"></a>## Synopsis

```
CErrnoException
```

<a name="AEN42487"></a>## Description
...
<a name="AEN42496"></a>## Public member functions
