...
[← Saving and Restoring The State of the GUI Between Sessions](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6749.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Setting up an XLM72 as a gate delay generator for remote control →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x6772.md)

---

---

# <a name="AEN6771"></a>15.2. Setting up an XLM72 as a gate delay generator for remote control
