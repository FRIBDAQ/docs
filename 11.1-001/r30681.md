...
[← CSIS3600](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30497.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3820 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30946.md)
...
<a name="AEN30833"></a>## Public member functions
...
- <a name="AEN30856"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN30866"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN30877"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN30888"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN30900"></a>` void SetLatchMode(void);const`
...
- <a name="AEN30912"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN30947"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN31016"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN31027"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN31038"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN31049"></a>` void Clock(void);const`
...
- <a name="AEN31060"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN31071"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN31082"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN31094"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN31105"></a>` unsigned long Read(void);const`
...
- <a name="AEN31117"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
