...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-incgrd]]
  To protect against including the header twice, we add these
                ...
                include guard.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-config]]
  The config.h file contains lots of
                preprocessor definitions. You must include it prior to other
                files.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-stdint]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-stddef]]
  To use the std::size_t type, we need to include
                this header.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunp-fwddecl]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-classdecl]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-members]]
  The event processor will maintain an object that handles the
                ...
                of tree parameters.
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-op]]
  The operator() method is called for every ring item of type
                PHYSICS_EVENT that is read from the input stream of data.
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-up]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-usingstd]]
  This brings uint32_t, size_t, and exception into scope. We avoid
                having to prefix these types with std:: every
                time.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-ctor]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-transptr-ctor]]
  The data is not gauranteed to have native byte ordering because it
                ...
                than Address_t.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-dyncast]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-extract]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-setsize]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-nlongwrds]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-auto]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-parseall]]
  Here is where we call our parser. It will return a list of
                parsed events if it succeeds.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-rlevt]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-offset]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-rlch]]
  Here we use another range-based for loop to iterate through the
               channel data of a specific digitizer's data.
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-rawunpack-true]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-sdata]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-tdef]]
  To save from repeatedly writing the type name
                ...
                framework.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-pall-pval]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-defs]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-evtdec]]
  Here we create a brand new, empty ParsedADCEvent that will be
                filled with the parsed data.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-auto]]
  We create a new translator pointer to iterate over the body of
                data.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-chk0]][[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-chk1]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-uphdr]]
  The logic for parsing the header lives in a utility method.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-check]]
...
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-upd]]
...
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-upeoe]]
  A utility method handles the parsing of the end-of-event word.
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ps-mkpr]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ishdr]]
  Here we use bitwise arithmetic to check that bits 24-26 are set to the value 2.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-uph-check]]
  If the word is not a header word, we failed to properly
                understand the data and parsing should stop immediately. An
                exception is thrown.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-uphdr]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-isdata]]
  We check that bits 24-26 store the value 0.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-updm]]
  Using bit-wise arithmetic we extract the channel and value.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-adddatum]]
  The channel and value are paired together and then added to the
                end of the vector.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ud-rsv]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ud-updm]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-ud-ret]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-eoe-is]]
  Check that bits 24-26 contain the number 4 to identify it as an
                end-of-event word.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-eoe-throw]]
  If the word is not identified as an end-of-event word, we do not
                understand the data properly and need to stop parsing.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-eoe-extr]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-pall-init]]
  We initialize an empty vector that will ultimately be filled and returned.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-pall-chberr]]
  Check if the word is a BERR. We expect BERRs at the end of the
                event body, so seeing one or two is not an error.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-pall-single]]
  Parse a single event.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-pall-pback]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-pall-upd8]]
  Use the iterator returned by the parseSingle() method to increment
                our pointer.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x4999.md#vmusb-ss-adcunp-pall-incr]]
