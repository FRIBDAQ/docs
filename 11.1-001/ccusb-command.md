...
`-greeninvert`Inverts the sense of the green front panel LED.

`-greenlatch`Latches the green LED on when the condition to light it
                        is met.
...
`-out1invert`Inverts the sense of the O1 NIM output.

`-out1latch`Latches the state of O1 once the condition needed to
...
`-out2invert`Inverts the sense of the O2 NIM output.

`-out2latch`Latches the NIM O2 state when the condition to assert
...
`-o3invert`Inverts the condition that asserts O3.

`-o3latch`Latches O3 in the asserted state when the condition
                        to assert it is met.
