...
[← CTCLChannelCommander](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42798.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CURIFormatException →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r42936.md)
...
<a name="AEN42933"></a>## Name

CURIFormatException -- Report errors in universal resource identifiers (uri)s.

<a name="AEN42936"></a>## Synopsis

```
CURIFormatException
```

<a name="AEN43020"></a>## Description
...
<a name="AEN43027"></a>## Public member functions
