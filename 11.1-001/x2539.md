...
This section will go through a sample snit driver describing
                ...
                [[Section 5.4.4|x2539#ccusb-general-tcldriver-usage]].
...
[[![(1)](../images/callouts/1.gif)|x2539#ccusb-snit-auto_path]]                        The SWIG Tcl wrappers for the CCUSB and CCUSBReadoutList
                        ...
                        package.
                    [[![(2)](../images/callouts/2.gif)|x2539#ccusb-snit-packages]]                        Incorporates the following packages into the
...
[[![(3)](../images/callouts/3.gif)|x2539#ccusb-snit-type]]                        The **snit::type** command
                    ...
                    [[![(4)](../images/callouts/4.gif)|x2539#ccusb-snit-option]]                        Snit objects all have a set of options that are
...
[[![(5)](../images/callouts/5.gif)|x2539#ccusb-snit-Initializemethod]]                        Instance subcommands are created via the
...
[[![(6)](../images/callouts/6.gif)|x2539#ccusb-snit-ccusbswigwrap]]                        Creates a swig wrapping of the `CCCUSB`
...
```
                        ...
                        command.
                    [[![(7)](../images/callouts/7.gif)|x2539#ccusb-snit-readleds]]                        This is an example of invoking a CCCUSB method.
                    ...
                    [[![(8)](../images/callouts/8.gif)|x2539#ccusb-snit-writeleds]]                        Invokes the CCCUSB `writeLedSelector`
                        so that the new value of the LED selector register
                        takes effect.
                    [[![(9)](../images/callouts/9.gif)|x2539#ccusb-snit-addReadoutListmethod]]                        The `addReadoutList`
...
[[![(4)](../images/callouts/4.gif)|x2539#ccusb-itcl-initialize]]                        The `Initialize` method
                    ...
                    [[![(6)](../images/callouts/6.gif)|x2539#ccusb-itcl-addmarker]]                        In Incr Tcl, options are just member variables.
