...
<a name="AEN24564"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN24567"></a>## Synopsis
...
<a name="AEN24793"></a>## Public member functions





<a name="AEN24799"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24861"></a>`unsigned long getBase(void);`
...
<a name="AEN24872"></a>`int getSerial(void);`
...
<a name="AEN24903"></a>`int  getFirmware(void);`
...
<a name="AEN24913"></a>`int  getCrate(void);`
...
<a name="AEN24924"></a>`void setCrate(int crateNum);`
...
<a name="AEN24937"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24958"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24968"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24978"></a>`void keepOverflowData(void);`
...
<a name="AEN24988"></a>`void discardOverflowData(void);`
...
<a name="AEN24998"></a>`void keepInvalidData(void);`
...
<a name="AEN25009"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN25020"></a>`void commonStart(void);`
...
<a name="AEN25031"></a>`void commonStop(void);`
...
<a name="AEN25042"></a>`void setRange(int range);`
...
<a name="AEN25055"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25127"></a>`void clearData
                                (void);`
...
<a name="AEN25170"></a>`bool Busy(void);`
...
<a name="AEN25181"></a>` bool gBusy(void);`
...
<a name="AEN25192"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25203"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25214"></a>`int readEvent(void* buf);`
...
<a name="AEN25227"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25268"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25331"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25335"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25339"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25343"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25347"></a>**Example 3. Reading out a CAEN 785 e.g.**
