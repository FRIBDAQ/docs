...
[← CControlHardware](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51155.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CControlHardware →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51158.md)
...
<a name="AEN51160"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN51163"></a>## Synopsis

```
CControlHardware
```

<a name="AEN51230"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [*CModuleFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51016.md)
            and
            [*CModuleCreator*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r51113.md)
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN51237"></a>## METHODS
