...
[← CCamacModule](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r29878.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCamacNimout →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30065.md)
...
<a name="AEN30096"></a>## Public member functions
...
- <a name="AEN30121"></a>` void >WriteMask(unsigned short mask);`
...
- <a name="AEN30134"></a>` void WriteBit(unsigned int nBitno);`
