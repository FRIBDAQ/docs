...
[← VhsWidgets](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70002.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [VhsWidgets →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70005.md)
...
This package contains a set of widgets that allow Tcl/Tk programmers
        ...
        See as well, [vhqPanel(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r70269.md)
        for one such panel.
...
<a name="AEN70040"></a>### VhsWidgets::environment options

This widget only supports the `-device` option.
        This option is mandatory.

<a name="AEN70044"></a>### VhsWidgets::channel
...
<a name="AEN70064"></a>### VhsWidgets::channelStatus options
...
<a name="AEN70070"></a>## OBJECT METHODS
...
<a name="AEN70074"></a>**Example 1. Hooking update methods to recurring timer**
...
<a name="AEN70077"></a>## SEE ALSO

[vhs(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r69499.md)
