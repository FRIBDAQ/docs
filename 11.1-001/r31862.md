...
[← CVME](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r31860.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CStatusModule →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r31953.md)
...
<a name="AEN31866"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN31869"></a>## Synopsis
...
<a name="AEN31976"></a>## Public member functions



- <a name="AEN31981"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN32019"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN32034"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN32047"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN32060"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN32105"></a>`T*  T* operator-> (void);`
...
- <a name="AEN32115"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN32130"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32142"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN32154"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32166"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN32176"></a>## Types and public data
