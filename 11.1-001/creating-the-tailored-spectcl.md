...
# <a name="AEN5676"></a>10.4. Creating the tailored SpecTcl
...
## <a name="AEN5684"></a>10.4.1. Decoding raw TDC data
...
### <a name="AEN5707"></a>10.4.1.2. Creating the raw unpacker class

Here is the header for our raw unpacker
                    (event processor) pipeline stage:

<a name="AEN5710"></a>**Example 10-9. Raw TDC unpacker (RawUnpacker.h)**
...
<a name="AEN5742"></a>**Example 10-10. v775 raw unpacker implementation includes and defs (RawUnpacker.cpp)**
...
<a name="AEN5764"></a>**Example 10-11. V775 raw unpacker - getLong utility (RawUnpacker.cpp)**
...
<a name="AEN5770"></a>**Example 10-12. V775 raw unpacker object constructor/destructor (RawUnpacker.cpp)**
...
[[x5676#v775_rawimpl_constructor]]                            The constructor is required to initialize the reference
                            ...
                            t.00 ... t.31.
                        [[x5676#v775_rawimpl_destructor]]                            If an object is ever destroyed, its tree parameter
                            array musb be destroyed as well to prevent
                            memory leaks.

<a name="AEN5783"></a>**Example 10-13. v75 raw unpacker unpacking events (RawUnpacker.cpp)**
...
[[x5676#v775_rawimpl_funtorsignature]]                            The `operator()` method
...
[[x5676#v775_rawimpl_storeparam]]                            Tree parameter array objects mimic arrays to the
                        ...
                        [[x5676#v775_rawimple_trailer]]                            The data words from the TDC should be followed by
                            a trailer.  This code asserts that this is the
                            case.

### <a name="AEN5871"></a>10.4.1.3. Adding the unpacker to the analysis pipeline
...
### <a name="AEN5893"></a>10.4.1.4. Creating raw time spectra
...
<a name="AEN5902"></a>**Example 10-14. Defining raw Time spectra the hard way.**
...
### <a name="AEN5975"></a>10.4.1.5. Building and testing what we have so far.
...
## <a name="AEN6013"></a>10.4.2. Producing parameters computed from the raw data
...
<a name="AEN6026"></a>**Example 10-15. Header for time difference event processor (Tdiff.h)**
...
<a name="AEN6039"></a>**Example 10-16. CTdiff implementation (Tdiff.cpp)**
