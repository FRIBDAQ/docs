...
[← Writing DAQ configuration files](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x2335.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing device support software →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/x2376.md)
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r46340.md) command
