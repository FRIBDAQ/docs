...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23937]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23937]].
...
[[portAllocator(3tcl)|r68696]],
            [[CPortManagerException(3daq)|r23937]],
            [[DaqPortManager(1tcl)|r15144]]
