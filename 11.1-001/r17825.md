...
[← CRingItem](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17552.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingScalerItem →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17832.md)
...
<a name="AEN18000"></a>## Public member functions
...
<a name="AEN18210"></a>## Types and public data

See the ScalerItem type in
            <DataFormat.h>.

<a name="AEN18215"></a>## Exceptions
...
<a name="AEN18236"></a>**Example 1. Constructing a scaler item from an item gotten from a ring**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17825.md#scaler.allpred)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17825.md#scaler.get)
  Gets the next item from the ring, regardless of type.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17825.md#scaler.isscaler)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17825.md#scaler.construct)
  If the item is a scaler item, it is converted into a
                      `CScalerItem`
                      and processed.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r17825.md#scaler.delete)
