...
<a name="AEN18626"></a>## Public member functions
...
<a name="AEN18844"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN18847"></a>**Example 1. Creating a begin run state transition item**
