...
[← Command line access to CAMAC via the SBS interface](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6865.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Ring piping utilities →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/c6886.md)
...
The **ringtostdout** command can be used to
        ...
        [ringtostdout reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11930.md).
...
The **stdintoring** command can be used to allow a
        ...
        [stdintoring reference material](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r11984.md).
