...
[← CSIS3600](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30487.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CSIS3600 →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r30495.md)
...
<a name="AEN30646"></a>## Public member functions
...
- <a name="AEN30669"></a>` void    Reset(void);`
  Performs a module soft reset.
- <a name="AEN30679"></a>` void LightLed(void);const`
  Turns on the U led on the module.  This LED is available for application
                              specific signalling.
- <a name="AEN30690"></a>` void ClearLed(void);const`
  Turns off the U led on the module.
- <a name="AEN30701"></a>` bool isLedLit(void);const`
  Returns true if the U LED is lit.
- <a name="AEN30713"></a>` void SetLatchMode(void);const`
...
- <a name="AEN30725"></a>` void SetCoincidenceMode(void);const`
...
- <a name="AEN30760"></a>` void DisableExternalClear(void);const`
...
- <a name="AEN30829"></a>` int  GetFastClearWindow(void);const`
...
- <a name="AEN30840"></a>` void Enable(void);const`
  Enables the module's ability to clock in new events.
- <a name="AEN30851"></a>` void Disable()(void);const`
  Disables the module's ability to clock in new events.
- <a name="AEN30862"></a>` void Clock(void);const`
...
- <a name="AEN30873"></a>` void StartLatch(void);const`
  Begins a latch operation.  In coincidence mode this allows a (long)
                              ...
                              starts the window.
- <a name="AEN30884"></a>` void EndLatch(void);const`
  Ends a software timed latch (load next event) window.
- <a name="AEN30895"></a>` bool DataReady(void);const`
  Returns true if the module has data in its FIFO.
- <a name="AEN30907"></a>` void ClearData(void);const`
  Clears any data that may be hanging around in the FIFO.
- <a name="AEN30918"></a>` unsigned long Read(void);const`
...
- <a name="AEN30930"></a>` unsigned int  Read(void* pBuffer, int nLongs);const`
