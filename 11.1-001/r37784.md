...
[← CDAQShm](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37777.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CDAQShm →](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37785.md)
...
<a name="AEN37788"></a>## Name

CDAQShm -- class description

<a name="AEN37791"></a>## Synopsis

```
CDAQShm
```

<a name="AEN37906"></a>## DESCRIPTION
...
`
  ...
  See [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37784.md#daqshm-varsrefsect)
...
`
  Returns the status of the most recent call.
                          ...
                          below in
                          [*PUBLIC VARIABLES, TYPES and CONSTANTS*](https://github.com/FRIBDAQ/docs/tree/main/11.1-001/r37784.md#daqshm-varsrefsect).
