...
## <a name="AEN539"></a>3.5.1. Compound gates (+ * -)
...
## <a name="AEN568"></a>3.5.3. Gamma slice (gs)
...
## <a name="AEN576"></a>3.5.4. Simple 2-d gates (b c)
...
## <a name="AEN594"></a>3.5.5. Gamma bands and contours (gb gc
...
## <a name="AEN602"></a>3.5.6. Bit mask gates (em am nm)
