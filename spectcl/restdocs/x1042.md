...
[← SpecTcl REST plugin](https://github.com/FRIBDAQ/docs/tree/main/spectcl/restdocs/index.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Projecting spectra (new in 5.5) →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/restdocs/x1069.md)
