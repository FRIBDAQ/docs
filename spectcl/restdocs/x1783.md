...
[← Accessing the pman comman (new in 5.5)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/restdocs/x1668.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Excuting arbitrary commands in SpecTcl (new in 5.5) →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/restdocs/x1854.md)
