...
| Prev | Chapter 12. Dynamic processing pipelines | Next |


---

# <a name="AEN4406"></a>12.2. Using the **pman** command to create and select pipelines
...
<a name="AEN4419"></a>**Example 12-2. Using the **pman** SpecTcl command**
...
| --- | --- | --- |
| Prev | Home | Next |
| Dynamic processing pipelines | Up | Capturing waveform data for display |
