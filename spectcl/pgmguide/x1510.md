...
[← The API and the event sink pipeline](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1492.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Adding a file format to SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1873.md)
