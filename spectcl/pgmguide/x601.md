...
- [[![(1)](../images/callouts/1.gif)|x601#makefile.include]]
  This include is part of the standard Makefile.  It pulls in
                      ...
                      transformatinos.
- [[![(2)](../images/callouts/2.gif)|x601#makefile.daqversion]]
  I added this line.  It allows me to change which version of
                      NSCLDAQ simply by changing this line.
- [[![(3)](../images/callouts/3.gif)|x601#makefile.cxxflags]]
...
- [[![(4)](../images/callouts/4.gif)|x601#makefile.ldflags]]
...
- [[![(5)](../images/callouts/5.gif)|x601#makefile.objects]]
