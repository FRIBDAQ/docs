...
[← Scripting the creation of waveforms and using them](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x4507.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Playing back filter data →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x710.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x601.md#makefile.include)
  This include is part of the standard Makefile.  It pulls in
                      ...
                      transformatinos.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x601.md#makefile.daqversion)
  I added this line.  It allows me to change which version of
                      NSCLDAQ simply by changing this line.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x601.md#makefile.cxxflags)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x601.md#makefile.ldflags)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x601.md#makefile.objects)
