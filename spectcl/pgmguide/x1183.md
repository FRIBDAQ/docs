...
[← SpecTcl Programming Guide.](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/index.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The API and the gates dictionary →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1306.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.projattr)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.pixel)
  As described in the lead in to this example, we'll assume
                      ...
                      `Pixel`.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.projclear)
  This method is intended to be used by code we're not going
                      ...
                      image.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.projsetdim)
  Once an image is cleared, the code that creates the image
                      is going to call this to define the image size and allocate
                      storage for it.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.setpixel)
  Again intended to be used by the images setting code to
                      set the value of a  pixel in the image.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.projbegin)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.projend)
...
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spectra.projnext)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.flag)
  The if checks for a on zero flag value.  If the flag is
                      non zero, it is set back to zero so that this code
                      only happens once..
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.find)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.is2d)
  The dynamic cast converts the generic spectrum into a
                      ...
                      code is bypassead.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.clear)
  Only once wwe know we have a 2-d long spectrum, one we can
                      work with, do we clear any prior image from the spectrum.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.dims)
  Since we need to ensure we don't write past the ends of the
                      spectrum, we fetch the X and Y dimensions of the spectrum.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.clip)
  Clips the pixel against the limits of the spectrum.  The
                      assumption is that the x and y coordinates are actually
                      unsigned.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.set)
  Copies the pixel value into the spectrum.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1183.md#api.spec.op.dontforget)
