...
<a name="AEN1204"></a>**Example 4-2. The projection class header**
...
<a name="AEN1250"></a>**Example 4-3. Header for an event processor that fills in a spectrum.**
...
<a name="AEN1256"></a>**Example 4-4. FillImage event processor constructor**
...
<a name="AEN1273"></a>**Example 4-5. `FillImage::operator()` implementation**
...
| --- | --- | --- |
| Prev | Home | Next |
| The SpecTcl API | Up | The API and the gates dictionary |
