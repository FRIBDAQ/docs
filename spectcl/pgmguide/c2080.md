...
[← Extending SpecTcl spectrum file formats](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c1836.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Extending the set of SpecTcl fit types. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c2382.md)
...
The filter formats supported by SpecTcl are extensible.  In fact,
        ...
        [*SpecTcl plugins*](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c4069.md)
...
- Look at the classes and objects that make filter formats
                  extensible (
                  [*Filter formatting objects.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c2080.md#sec.filterformatobjects)).
- Walk through writing an extension to the set of filter formats
                  supported by SpecTcl.
                  [*Example filter formatter.*](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x2310.md)
