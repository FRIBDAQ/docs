...
[[x4160#plugin_initentry]]                This is the initialization function entry.  The name
            ...
            [[x4160#plugin_initstubs]] `Tcl_InitStubs` initializes the Tcl stubs
...
[[x4160#plugin_initstubserror]] `Tcl_InitStubs` returns a pointer to a string
...
[[x4160#plugin_pkgprovide]] `Tcl_PkgProvide` lets Tcl know that initializing
