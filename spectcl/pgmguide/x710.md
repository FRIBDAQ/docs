...
[← Setting up an event analysis pipeline (the simple version)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x601.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | ["Using the callout analysis framework →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md)
