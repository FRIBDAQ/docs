...
[← The API and the gates dictionary](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1306.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The API and the event sink pipeline →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x1492.md)
...
In [*libTcl++ and adding commands to SpecTcl*](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c1622.md),
