...
[[c1068#sec.api.parameters]]The API provides methods to inspect and maniuplate the
...
[[x1183]]The API provides methods that allow you to query and
                    manipulate the SpecTcl spectrum dictionary.    These
                    methods include methods that can create spectra of any
                    type.

[[x1306]]The API provides methods that allow you to query, define
                    and apply gates.

[[x1421]]The API provides methods to query and manipulate the event
                    processing pipeline.

[[x1492]]The API provides methods to query and manipulate the event sink
...
[[x1510]]The API provides methods to gain access to several important
...
<a name="AEN1136"></a>**Example 4-1. Using the API to access parameter definitions**
...
| --- | --- | --- |
| Prev | Home | Next |
| "Using the callout analysis framework |  | The API and the spectrum dictionary |
