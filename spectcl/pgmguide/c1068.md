...
- [[*The API and the parameter dictionary*|c1068#sec.api.parameters]]
...
- [[*The API and the spectrum dictionary*|x1183]]
  The API provides methods that allow you to query and
                      ...
                      type.
- [[*The API and the gates dictionary*|x1306]]
...
- [[*The API and the event processing pipeline*|x1421]]
  The API provides methods to query and manipulate the event
                      processing pipeline.
- [[*The API and the event sink pipeline*|x1492]]
...
- [[*The API and SpecTcl Objects.*|x1510]]
