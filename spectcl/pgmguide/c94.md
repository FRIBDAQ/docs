...
[← The SpecTcl processing model.](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c73.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [SpecTcl Programming Guide. →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/index.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#onattach.dyncast)
  ...
  dynamic_cast attempts to perform a type cast
                      ...
                      `std::bad_cast`.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#onattach.badcast)
  ...
  Since this element of the pipeline failed, kfFalse
                      is returned.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#onattach.otherfails)
  If the cast throws any other exceptions, these two are caught
                      and reported.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#onattach.good)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#oninit.inittp)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#oninit.indivbound)
  This section of code binds the individual parameter to the
                      event array like object if not.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#oninit.araraybound)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.fcndataptr)
  The `pEvent` is an
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.fcndataptr)
  `pSize` now points to the data in the event,
                      ...
                      2 means.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.fcnrawparams)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.fcncomputedparam)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.onother.decoder)
  ...
  If a null pointer is returned, a message indicating the
                      ...
                      regturned.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.onother.scalertype)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.onother.createitem)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.onother.castscaler)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.onother.tostring)
  Once we've gotten this far we can use the
                      ...
                      which we print out.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.onother.delitem)
  Since the factory dynamically allocated the ring item,
                      we need to delete it in all code paths through the
                      method.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/c94.md#evp.onother.dontforgetthis)
