...
**save**Saves  the current list of event processors

**restore**Restores the current list of event processors from a
                    previously saved set.

**filter**Sets the event pipeline to be a filter processor.

This quite naturally gives us the following definition for our
        command processor:

<a name="AEN1718"></a>**Example 6-1. Definition file for event processor switcher.**
...
[[c1622#cmd.swcommand.entry]] `CTCLObjectProcessor` objects
...
<a name="AEN1740"></a>**Example 6-2. `EVPSwitchCommand` constructor implementation**
...
<a name="AEN1757"></a>**Example 6-3. Implementation of `EVPSwitchCommand::operator()`**
...
<a name="AEN1814"></a>**Example 6-4. Implementation of subcommand processors**
...
| --- | --- | --- |
| Prev | Home | Next |
| The SpecTcl event sink pipeline. |  | Extending SpecTcl spectrum file formats |
