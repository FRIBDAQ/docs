...
[[c73]]Which covers the processing model used by SpecTcl.  This will
...
[[c94]]The event processing pipeline is the set of objects that
...
[[c1539]]The event sink pipeline takes over where the event
...
[[c1622]]SpecTcl uses the Tcl scripting language as its base command
...
[[c1836]]The SpecTcl **sread** and **swrite**
...
[[c2080]]The format of files written by SpecTcl filters is extensible.
                    In this chapter we'll show how to extend the set of formats
                    available.

[[c2382]]The SpecTcl fitting subsystem allows you to add additional
                    fit types.  In this chapter we'll show how to add a new
                    fit-type to SpecTcl.

[[c2824]]SpecTcl is data acquisition system neutral.  This chapter
...
[[c4359]]Describes new features for SpecTcl 5.1 which allow you to
                    dynamically alter the event processing pipeline.

[[c4450]]Describes new features for SpecTcl 7.0-003 and later to support
