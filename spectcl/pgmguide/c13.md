...
- [[*The SpecTcl processing model.*|c73]]
...
- [[*The SpecTcl event processing pipeline.*|c94]]
...
- [[*The SpecTcl event sink pipeline.*|c1539]]
  The event sink pipeline takes over where the event
                      ...
                      pipeline.
- [[*libTcl++ and adding commands to SpecTcl*|c1622]]
  SpecTcl uses the Tcl scripting language as its base command
                      ...
                      elements.
- [[*Extending SpecTcl spectrum file formats*|c1836]]
