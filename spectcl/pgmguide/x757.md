...
[← Playing back filter data](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x710.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Introduction →](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmref/c13.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#cba.eventprocessorheader)
  This #include pulls in the class definition for
                          ...
                          for each of them.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#cba.analysisbaseheader)
  Instantiates the base class,
                          ...
                          each ring item.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#cba.usercallbackfragment)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#cba.instantiatecb)
  In `CreateAnalysisPipeline`,
                          you'll create a callback object....
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#cba.instantiateevp)
  ...Then you'll create an analysis event processor
                          providing your callback object as a construtor parameter.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#cba.registerevp)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#sccb.scalerprocessorhdr)
  The CScalerProcessor.h
                          header defines `ScalerProcessor`
                          which is the callout
                          processor that we want to use with the callout
                          event processor.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#sccb.apihdr)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#sccb.getinterp)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#sccb.instantiate1)
  As we did in our generic example, we instantiate
                          our callout
                          processor (`ScalerProcessor`
                          is derived from `CAnalysisBase`
                          so it can be used directly).
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#sccb.instantiate2)
  As in our generic example, we instantiate
                          the event processor passing it a pointer to our
                          callout
                          processor.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/spectcl/pgmguide/x757.md#sccb.register)
