...
# <a name="AEN123"></a>3.1. Event Processors
...
<a name="AEN130"></a>**Example 3-1. CEventProcessor definition**
...
<a name="AEN375"></a>**Example 3-3. Constructor for `MyEventProcessor`**
...
<a name="AEN389"></a>**Example 3-4. `OnAttach`**
...
<a name="AEN425"></a>**Example 3-5. OnInitialize - Set up the tree parameters.**
...
<a name="AEN450"></a>**Example 3-6. State transition processing**
...
<a name="AEN500"></a>**Example 3-7. Event processor `operator() method.`**
...
[[c94#evp.fcndataptr]] `pSize` now points to the data in the event,
...
<a name="AEN545"></a>**Example 3-8. Event processor `OnOther`**
...
<a name="AEN596"></a>**Example 3-9. `OnEventSourceOpen` and `OnEventSourceEOF`**
