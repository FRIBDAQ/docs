...
# <a name="AEN9566"></a>CHistogrammer

<a name="AEN9570"></a>## Name

CHistogrammer -- SpecTcl histogramming core

<a name="AEN9573"></a>## Synopsis

```
CHistogrammer
```

<a name="AEN9577"></a>## DESCRIPTION
...
`ParameterDictionary`The objects contained by this dictionary are
                        `CParameter` objects.
                        Note that
...
`SpectrumDictionary`This dictionary contains pointers to
...
`CGateDictionary`Contains pointers to `CGateContainer`
...
| --- | --- | --- |
| Prev | Home | Next |
| CTclGrammerApp | Up | Dictionaries |
