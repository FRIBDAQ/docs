...
# <a name="AEN8835"></a>CEventBuilderEventProcessor

<a name="AEN8839"></a>## Name

CEventBuilderEventProcessor -- Event processor for event built data.

<a name="AEN8842"></a>## Synopsis
