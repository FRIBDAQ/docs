...
# <a name="AEN3125"></a>roottree

<a name="AEN3129"></a>## Name

roottree -- Write CERN ROOT Trees.

<a name="AEN3132"></a>## Synopsis
...
This command allows SpecTcl to write  root trees from the
            ...
            It is only available if the rootinterface
            package is loaded.  This can be loaded from
            your SpecTclRC.tcl script by adding the
            lines:
