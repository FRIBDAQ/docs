...
**parameter `-trace` *script*
**

**parameter `-untrace` *script*
**

<a name="AEN1908"></a>## DESCRIPTION
...
<a name="AEN1920"></a>## OPTIONS

The first option on the **parameter** command is like
...
Establishes `script` as a trace
                    on the parameter dictionary.  The script will be invoked
                    when parameters are added or deleted.  The script will
                    be passed two parameters.  The first is the text
                    add or delete
                    which describes the action that was performed on the
                    parameter dictionary.  The second the name of the
                    parameter for which that action was performed.

**parameter `-untrace` *script*
**

Removes the indicated trace script.

<a name="AEN2059"></a>## EXAMPLES

<a name="AEN2061"></a>**Example 1. Creating a 12 bit 'integer' parameter**
...
<a name="AEN2065"></a>**Example 2. Creating a real valued parameter with units in mm**
