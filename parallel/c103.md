...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/parallel/c103.md#ex.wrapcmd.base)
  As usual, `TclGrammerApp`::`AddCommands` is 
                          called to define the standard SpecTcl commands (like e.g. **spectrum**).
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/parallel/c103.md#ex.wrapcmd.createwrapped)
...
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/parallel/c103.md#ex.wrapcmd.getwrapped)
  Retrieves a pointer to the command processor instance.  The
                          ...
                          processors.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/parallel/c103.md#ex.wrapcmd.wrap)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/parallel/c103.md#ex.autowrap.actualdecl)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/parallel/c103.md#ex.autowrap.wrapperdecl)
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/parallel/c103.md#ex.autowrap.constructorimpl)
