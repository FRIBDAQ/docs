...
**Table of Contents**[[CMPITclCommandAll|r893]] -- Jacket a command that runs in all ranks[[CMPITclCommand|r948]] -- Jacket a command that runs in other ranks[[CMPITclPackagedCommandAll|r998]] -- Wrap a packaged command that will execute in all processes[[CMPITclPackagedCommand|r1052]] -- Jacket packagted commands to run in all but he root.
