...
[← Checking for support of MPI parallelism.](https://github.com/FRIBDAQ/docs/tree/main/parallel/x34.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [MPI Pumps →](https://github.com/FRIBDAQ/docs/tree/main/parallel/x462.md)
...
The actual mechanics of event distribution to the workers is described in 
                    [*The ring item pump*](https://github.com/FRIBDAQ/docs/tree/main/parallel/x462.md#sec.ringpump)
