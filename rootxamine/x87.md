...
[← Rootxamine - Attaching CERN Root to SpecTcl's Spectrum Shared Memory](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/index.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Page not found - Rustogramer User Guide →](https://github.com/FRIBDAQ/docs/tree/main/rustogramer/404.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/x87.md#invoke.bare)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/x87.md#invoke.numericports)
  ...
  Note that this form also *does*
                      ...
                      `--mirror`
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/x87.md#invoke.remote1)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/x87.md#invoke.remote2)
