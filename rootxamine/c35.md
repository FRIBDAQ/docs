...
[← rootxamine's update and consequences for your scripts.](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/c173.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Rootxamine - Attaching CERN Root to SpecTcl's Spectrum Shared Memory →](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/index.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/c35.md#port.libpath)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/c35.md#port.daqlibpath)
  ...
  If you don't add NSCLDAQ Tcl libraries to the search path,
                  ...
                  properly.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/c35.md#port.package)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/rootxamine/c35.md#port.setports)
