...
[← hitmaker](https://github.com/FRIBDAQ/docs/tree/main/get/r689.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r708.md)

---

---

# <a name="AEN707"></a>GET Run control (old way)

<a name="AEN711"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN715"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN721"></a>## DESCRIPTION
