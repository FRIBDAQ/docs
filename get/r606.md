...
[← GET Run control (new way)](https://github.com/FRIBDAQ/docs/tree/main/get/r598.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r632.md)

---

---

# <a name="AEN606"></a>GET Run control (new way)

<a name="AEN610"></a>## Name

daqcontrol -- Start and stop GET data taking with pulser control

<a name="AEN613"></a>## Synopsis

**daqcontrol**  [-c *start | stop*] [-t *TARGETIP:PORT*]  *?-t TARGETIP2:PORT2?*...  [-e *ECCSERVER:PORT*]  *?-p on | off?*

<a name="AEN626"></a>## OPTIONS
...
Description below is copied from the old documentation.
            [*GET Run control (old way)*](https://github.com/FRIBDAQ/docs/tree/main/get/r716.md#ch.components.getruncontrol.old)
