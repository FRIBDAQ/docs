...
[← GET Run control (old way)](https://github.com/FRIBDAQ/docs/tree/main/get/r632.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r635.md)

---

---

# <a name="AEN634"></a>GET Run control (old way)

<a name="AEN638"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN642"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN648"></a>## DESCRIPTION
