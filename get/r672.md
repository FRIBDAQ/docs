...
[← GET Run control (old way)](https://github.com/FRIBDAQ/docs/tree/main/get/r667.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [hitmaker →](https://github.com/FRIBDAQ/docs/tree/main/get/r684.md)

---

---

# <a name="AEN672"></a>GET Run control (old way)

<a name="AEN676"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN680"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN686"></a>## DESCRIPTION
