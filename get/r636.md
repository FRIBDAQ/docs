...
[← GET Run control (old way)](https://github.com/FRIBDAQ/docs/tree/main/get/r635.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r637.md)

---

---

# <a name="AEN636"></a>GET Run control (old way)

<a name="AEN640"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN644"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN650"></a>## DESCRIPTION
