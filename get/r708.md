...
[← GET Run control (old way)](https://github.com/FRIBDAQ/docs/tree/main/get/r707.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r716.md)

---

---

# <a name="AEN708"></a>GET Run control (old way)

<a name="AEN712"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN716"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN722"></a>## DESCRIPTION
