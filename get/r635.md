...
[← GET Run control (old way)](https://github.com/FRIBDAQ/docs/tree/main/get/r634.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r636.md)

---

---

# <a name="AEN635"></a>GET Run control (old way)

<a name="AEN639"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN643"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN649"></a>## DESCRIPTION
