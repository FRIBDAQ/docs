...
[← GET Run control (new way)](https://github.com/FRIBDAQ/docs/tree/main/get/r606.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r634.md)

---

---

# <a name="AEN632"></a>GET Run control (old way)

<a name="AEN636"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN640"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN646"></a>## DESCRIPTION
