...
[← GET Run control (old way)](https://github.com/FRIBDAQ/docs/tree/main/get/r636.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r667.md)

---

---

# <a name="AEN637"></a>GET Run control (old way)

<a name="AEN641"></a>## Name

daqstart, daqstop -- Start and stop GET data taking.

<a name="AEN645"></a>## Synopsis

**daqstart  *hwnode* *eccserver* [1|0]**

<a name="AEN651"></a>## DESCRIPTION
