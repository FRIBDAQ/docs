...
[← GET Run control (old way)](https://github.com/FRIBDAQ/docs/tree/main/get/r637.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [GET Run control (old way) →](https://github.com/FRIBDAQ/docs/tree/main/get/r672.md)

---

---

# <a name="AEN667"></a>GET Run control (old way)

<a name="AEN671"></a>## Name
