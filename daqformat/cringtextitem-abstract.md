...
PACKET_TYPESThe SBS readout framework can use this to provide
                            a dictionary of packet types that can be seen
                            within a PHYSICS_EVENT
                            item body.

MOINTORED_VARIABLESThe readout frameworks based on the Tcl command
...
| --- | --- | --- |
| Prev | Home | Next |
| CRingStateChangeItem (abstract) | Up | CUnknownFragment (abstract) |
