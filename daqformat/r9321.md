...
[← CUnknonwFragment (v12)](https://github.com/FRIBDAQ/docs/tree/main/daqformat/r9301.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CRingItem (abstract) →](https://github.com/FRIBDAQ/docs/tree/main/daqformat/r974.md)
...
- `--help`
  Displays a brief help message that describes the program
...
- `--source`
  The argument to this option is the source of data
...
- `--skip`
  The parameter to this option must be a non-negative integer.
...
- `--count`
  The paramter to this option must be a non-negative integer.
...
- `--exclude`
  The value of this option is a comma separated
  ...
  Note that TIMESTAMPED_NON_INCR_SCALERS
                              ...
                              of later versions.
- `--scaler-width`
  Represents the number of bits of width in the scaler
...
- `--format`
  The parameter of this options is the NSCLDAQ
