...
- [[![(1)](../images/callouts/1.gif)|c171#select.headers]]
...
- [[![(2)](../images/callouts/2.gif)|c171#select.select]]
...
- [[![(3)](../images/callouts/3.gif)|c171#select.makeitem]]
...
- [[![(4)](../images/callouts/4.gif)|c171#select.fillbody]]
...
- [[![(1)](../images/callouts/1.gif)|c171#fmt.formatitem]]
  We'll need to use the definitions of the
              `CRingFormatItem` so we include it's header here.
- [[![(2)](../images/callouts/2.gif)|c171#fmt.dataformat]]
...
- [[![(3)](../images/callouts/3.gif)|c171#fmt.defaultfmt]]
  We store the default format type in a variable.  You might imagine
                  ...
                  for that version.
- [[![(4)](../images/callouts/4.gif)|c171#fmt.getitem]]
...
- [[![(5)](../images/callouts/5.gif)|c171#fmt.isformat]]
...
- [[![(6)](../images/callouts/6.gif)|c171#fmt.cast]]
...
- [[![(7)](../images/callouts/7.gif)|c171#fmt.selectfromitem]]
