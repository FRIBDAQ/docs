...
[← Reference pages](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c263.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCLDAQ Unified Format Library →](https://github.com/FRIBDAQ/docs/tree/main/daqformat/index.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c49.md#v11phys.header)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c49.md#v11phys.create)
  ...
  We'll still need to fill in the header's size field as we'll
                      see later on.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c49.md#v11phys.setbodyheader)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c49.md#v11phys.getcursor)
  ...
  Note that the code in the section marked ...
                      ...
                      body data we put in.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c49.md#v11phys.updatecursor)
  Sets the item's body cursor this does two things:
                      ...
                      object's storage.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/daqformat/c49.md#v11phys.setsize)
