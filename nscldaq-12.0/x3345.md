...
[← Extensibility and Openness](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x33.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing DAQ configuration files →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x3435.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x3345.md#watchexample-createarrays)
  In order to monitor an array, the array must first
                          be created. Note that this is not the case
                          for a scalar variable.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x3345.md#watchexample-monitorarrays)
  These commands specify that the three arrays
                          we created with the **array set**
                          command should be monitored.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x3345.md#watchexample-monitorscalar)
