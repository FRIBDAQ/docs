...
[← Getting Data](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Configuring SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x16654.md)
...
This script assumes the appropriate  daqsetup.bash
      ...
      the [*EVBRest*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r19857.md)
      program which runs the orderer stage with a REST interface plugin.
      The second stage of the pipeline run the **glom** program
      described in
      [*glom*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r19874.md).
...
Use [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18069.md)
...
For more information; see
      [*ringFragmentSource*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r20160.md)
...
**Making a Program to Shutdown The Event Builder. **
        The [*EVBShutdown*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r19833.md)
...
**Adding the Event Builder Shutdown to a SHUTDOWN Sequence . **
        Using [*mg_seqedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18154.md)
