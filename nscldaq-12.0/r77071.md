...
`-file` `file-path`Provides the path to the file that will be used by
                        `save` and
                        `restore` operations.

See METHODS below.

<a name="AEN77126"></a>## METHODS
...
`addStateVariable` `name getter setter`Defines a state variable that will be saved/restored
...
```
                            ...
                            to the file.
                        restoreCreates a secure slave interpreter and sources
...
<a name="AEN77188"></a>**Example 1. Getters and setters for StateManager**
...
[[r77071#statemgr_configfile]]                        Before doing saves and restores, the `-file`
                    ...
                    [[r77071#statemgr_restore]] **source**s the last configured `-file`
