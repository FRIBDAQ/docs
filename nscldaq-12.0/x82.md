...
[← Setting up the software](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x8164.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The dumper program →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x8286.md)
...
Finally, the data transferred through the ring buffer is just
      ...
      have a structure defined later in [Chapter 3](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c185.md).
