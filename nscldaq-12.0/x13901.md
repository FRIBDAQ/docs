...
In addition to
            [[CInteractor|r50817]], the following
            concrete interactors have been supplied.



[[`CStringInteractor`|r50996]]This interactor supplies a string that you have gotten by
                        whatever means you got it.  It can be used when interactors
                        are not suitable for acquiring the stringified credentials.

[[`CFdInteractor`|r51167]]This interactor accepts the credentials via an open file
                        descriptor.

[[`CIOInteractor`|r51303]]This interator uses a pair of other interactors, an output and
