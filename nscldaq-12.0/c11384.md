...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.mgr.mkcont.init]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.mgr.mkcont.auto_path]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.mgr.mkcont.requires]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.mgr.mkcont.opendb]]
  Creates a new command **db** which is connected
                      to the SQLite3 database file myconfig.db.
                      This file should have been made with
                      [[*mg_mkconfig*|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r17970.md]]
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.mgr.mkcont.add]]
  ...
  This matches our FRIB convention of storing built NSCLDAQ
                      ...
                      /usr/opt.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.mgr.mkcont.closedb]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.usecont.activate]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.usecont.run]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.usecont.relay]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.usecont.deactivate]]
  Done with the container, we deactivate it.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.usecont.closecfd]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.addpgm.autopath]]
  Adds the NSCLDAQ Tcl library path to the
                    `auto_path` so that the
                    programs package can be found.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.addpgm.requires]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.addpgm.open]]
  ...
  Note that while this command
                    ...
                    [[*mg_mkconfig*|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r17970.md]]
                    command.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.addpgm.add]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#program.run.handler]]
  ...
  Note that we don't close the file descriptor.  The program
                    ...
                    file descriptor.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#program.run.run]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#program.run.evloop]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#program.run.kill]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.boilerplate]]
  By now this should be familiar.  Extend the library
                       search path and require the packages we need before
                       opening the database.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.addstate]]
  Adds a new state named `PAUSED`
                       ...
                       successor state.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.addtransitions]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.makeseq]]
  This creates a new sequence named
                    ...
                    HWINIT.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.addsteps]]
  This block of code adds the five steps we need to the
                    ...
                    to edit sequences.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.delay]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.trans.completion]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.trans.check]]
  Gets the system's current state. Note that the state
                       ...
                       exiting.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.trans.boot]]
  Initiates the shutdown. Note that completion
                       is specified as the end script for this transition.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.trans.vwait]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.snit]]
  ...
  The key point, as we'll see is that in order to
                       ...
                       **onOutput** and
                       **onExit**.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.getmgr]]
  **::sequence::getCurrentTransition**
                       ...
                       empty string.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.lseq]]
  **::sequence::listSequences**
                       ...
                       of the sequence.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.lstep]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.monitor]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.addmon]]
  This associates the monitor with the step.  Note that the
                       return value from **::sequence::addMonitor**
                       is any prior monitor.
- [[![(7)](../images/callouts/7.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.omonitor]]
...
- [[![(8)](../images/callouts/8.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.onout]]
...
- [[![(9)](../images/callouts/9.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#seq.misc.orelay]]
  The **::sequence::relayOutput** command
                       sends its argument to all processes connected to its output
                       relay server.
- [[![(10)](../images/callouts/10.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.seq.misc.onexit]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.kvstore.require]]
  This and the next line import the packages needed
                    ...
                    a database file.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.kvstore.create]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.kvstore.modify]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.kvstore.listall]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.auth.require]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.auth.adduser]]
  **auth::adduser** makes a new user known to the
                    configuration.  The name of the user should be the same as
                    their account username.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.auth.addroles]]
  This set of lines uses **auth::addrole** to
                    add three roles, manager, analyzer
                    and operator to the authorization database.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.auth.grantrole]]
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.evlog.require]]
  Requires the packages needed to make this program
                    ...
                    ::eventlog namespace.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.evlog.dest]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.evlog.add]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.evlog.searchdest]]
  The next section of code will search the existing
                    ...
                    destroy it using
                    **eventlog::rm**
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.evlog.list]]
...
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md#ex.evlog.rm]]
