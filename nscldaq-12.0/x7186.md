...
[← Setting up the Electronics.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7166.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Creating the tailored SpecTcl →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7496.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_rdoh_protect)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_rdoh_baseinclude)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_rdoh_caencard_forward)
  ...
  It's worth asking when to do this as opposed to
                          ...
                          at any time.
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_rdoh_classdef)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_rdoh_module_member)
  We will construct our event segment by passing it a
                          ...
                          data by this line.
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_rdoh_interfaces)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_heading_declaration)
  Class implementation files need access to the declaration
                          of the class.  This #include incorporates
                          that declaration.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_heading_card)
  This module will be invoking methods of the
                          ...
                          `CAENcard` into this
                          compilation unit.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_heading_range)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_heading_maxwords)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_init_try)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_init_startstopmode)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_init_range)
  Sets the time range of the TDC.  See the manual for
                          the meaning of this value (section 4.34
                          Full Scale Range Register).
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_init_fail)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_read_signature)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_read_sizecheck)
  The device is only read if there is sufficient room in the
                          ...
                          called.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_read_read)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_impl_throw)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_skel_base)
  Here we define a constant; `V775Base`
                          to be the base address of the TDC module.  See
                          [*Addressing VME modules*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775ss_sec_addressing)
                          below
                          for more about addessing VME modules.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_skel_card)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_skel_trigger)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7186.md#v775_skel_evseg)
