...
[← NSCLDAQ In a Nut Shell](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c5.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBLite -  light event building →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c5743.md)
...
The client programs that submit data to the server are built using the
      [event builder client
        framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c14582.md). In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [ringFragmentSource](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x14848.md) program. This
