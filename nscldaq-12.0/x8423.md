...
# <a name="AEN8423"></a>15.3. Starting the GUI for the RC-bus through an MxDC device
...
5. The user will then be presented with the following display and should
   ...
   <a name="mcfd16control_fig1"></a>**Figure 15-2. MCFD16Control Graphical User Interface for MxDC-RCbus**
...
| --- | --- | --- |
| Prev | Home | Next |
| Starting the GUI for USB communication | Up | Configuration menu |
