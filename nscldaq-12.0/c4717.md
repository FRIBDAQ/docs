...
[← The Ring Buffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c43.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [NSCLDAQ In a Nut Shell →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c5.md)
...
Reference material on the API provided by the ReadoutShell can be found in
      the [3rdogui](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r75164.md) man page section.
...
The ReadoutShell and Data source providers communicate via a
            ...
            [3provider](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r78038.md).
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/RunState.jpg)
...
- NotReady
  This state means that none of the data sources are running
                          ...
                          state.
- Starting
  On making a transition to the Starting
                          ...
                          Halted state.
- Halted
  In the Halted state, the system is
