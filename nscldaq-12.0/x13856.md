...
| Prev | Chapter 56. Access control and security | Next |


---

# <a name="AEN13856"></a>56.2. Authenticators
...
<a name="AEN13860"></a>**Example 56-3. Boilerplate DAQ Authorization code **
...
[[r49948]]The entity must provide a correct password.  Note that the current
                    set of interactors do not support encrypted interactors.  This can be
                    extended if required.

[[r50146]]The entity must provide a valid username and password
                        that is could login to the local unix system.

[[r50367]]Intended for use within a Tcl interpreter.  The entity must
                        supply some string that is an element of a Tcl list
                        held in a Tcl variable.

[[r50475]]The entity must supply a string that is one of a set of strings
                            given to the authenticator.

[[r50627]]Same as `CAccessListCheck` but the
