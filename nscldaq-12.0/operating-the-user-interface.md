...
File->Log...Prompts for a file.  Once the file is selelcted,
...
File->Disable LogOnce seleted, if logging has been established,
                                    the log file is closed.

File->Exit...After prompting for confirmation, exits the ReadoutShell.
...
Data Source->Add...Allows you to add a data source to the set of data
...
Data Source->Delete...Presents a list of data sources and their
...
DataSource->ListLists the set of data sources you have currently
...
Event Log ProgramThis item allows you to select the event logging
...
Data Source Ring URIAllows you to override the ring from which data are
...
Use `--number-of-sources`This checkbutton causes the ReadoutGUI to use the
...
Additional SourcesThis option is related to the use --number-of-sources
...
Use GUI Run numberThis checkbox determines if the ReadoutShell uses
...
TitleThis entry control allows you to type in a title.
...
Run NumberAs with the titlwe field, this entry control is only
...
Run Control clusterThe run control cluster is the set of two or
...
RecordThis is located below the Run control cluster.
...
Active Run TimeThis is located to the right of the Start
...
Timed Run ControlsThis set of controls is located to the right
                            of the Begin and
...
debugThe debug log level is intended
...
The log types and their visual representations can be controlled
                ...
                [[r77232#rdogui3_ui_OutputWindow]] for information
...
| --- | --- | --- |
| Prev | Home | Next |
| ReadoutGUI & ReadoutShell | Up | The event logger and ReadoutShell |
