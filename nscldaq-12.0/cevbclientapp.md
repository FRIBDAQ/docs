...
<a name="AEN36392"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN36395"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN36425"></a>## DESCRIPTION
...
<a name="AEN36487"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
