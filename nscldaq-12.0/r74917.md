...
[← EVBC::startS800Source](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r74887.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [EVBC::onBegin →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r75027.md)
...
For information about the specific options, see
            OPTIONS below and
            [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r74596.md).

<a name="AEN74946"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [*EVBC::start*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r74596.md)
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [*EVBC::onBegin*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r75027.md)).
