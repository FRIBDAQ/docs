...
This section will describe how to run an experiment with the manager.
      Subsequent sections:
      [[*Running Readout Software With the Manager*|x1399]] and
...
Note that these control panels communicate with the manager and make use
        ...
        sections
        [[*Running Readout Software With the Manager*|x1399]]
        and [[*Using the NSCLDAQ Event Builder With the Manager*|x1661]]
...
When you use the manager with the event builder, it too will have
          a REST interface.  [[*Using the NSCLDAQ Event Builder With the Manager*|x1661]]
