...
<a name="AEN48833"></a>## Name

SyncGuard -- Provide Critical Regions, Monitors

<a name="AEN48836"></a>## Synopsis
...
<a name="AEN48878"></a>## Public member functions
...
<a name="AEN48916"></a>`void sync_self(void);`
...
<a name="AEN48923"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN48931"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN48943"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN48949"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN48959"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN48989"></a>`void sync_global_end(void);`
