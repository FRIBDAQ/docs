...
[← Building the filter program](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15613.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Run Control and Command Execution →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15695.md)
