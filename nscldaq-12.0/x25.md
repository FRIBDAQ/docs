...
[← Extending the Supported Readout Hardware](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x2237.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Extending the slow controls subsystem →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x2650.md)
...
With any experiment, it is paramount to understand quickly whether the
      ...
      inspection. The most basic and useful is the [dumper](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c9628.md) program, which provides a textual
      ...
      are higher level tools though such as the [ScalerDisplay](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c5861.md) program. The
...
The fact that ring buffers lie on either side of each process allows the
      ...
      information. Other tools like the [ringbuffer](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r17720.md) program provide
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/figures/intro-data-flow-diagram-diagnostics.png)
