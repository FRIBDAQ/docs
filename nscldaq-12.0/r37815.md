...
<a name="AEN37829"></a>## Name

CAENcard -- Support for the CAEN 32 bit digitizers

<a name="AEN37832"></a>## Synopsis
...
<a name="AEN38058"></a>## Public member functions





<a name="AEN38064"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN38126"></a>`unsigned long getBase(void);`
...
<a name="AEN38137"></a>`int getSerial(void);`
...
<a name="AEN38168"></a>`int  getFirmware(void);`
...
<a name="AEN38178"></a>`int  getCrate(void);`
...
<a name="AEN38189"></a>`void setCrate(int crateNum);`
...
<a name="AEN38202"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN38223"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN38233"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN38243"></a>`void keepOverflowData(void);`
...
<a name="AEN38253"></a>`void discardOverflowData(void);`
...
<a name="AEN38263"></a>`void keepInvalidData(void);`
...
<a name="AEN38274"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN38285"></a>`void commonStart(void);`
...
<a name="AEN38296"></a>`void commonStop(void);`
...
<a name="AEN38307"></a>`void setRange(int range);`
...
<a name="AEN38320"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN38392"></a>`void clearData
                                (void);`
...
<a name="AEN38435"></a>`bool Busy(void);`
...
<a name="AEN38446"></a>` bool gBusy(void);`
...
<a name="AEN38457"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN38468"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN38479"></a>`int readEvent(void* buf);`
...
<a name="AEN38492"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN38533"></a>`void enableSmallThresholds(void);`
...
<a name="AEN38596"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN38600"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN38604"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN38608"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN38612"></a>**Example 3. Reading out a CAEN 785 e.g.**
