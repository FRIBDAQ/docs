...
[← Using wienercamac](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-11.4/x9925.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compatibility utilities →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c10104.md)
...
The ringselector application is very
        ...
        [ringtostdout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r17844.md)
        application.  Both
...
For a complete reference on the command see the
        [ringselector reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r20926.md).
