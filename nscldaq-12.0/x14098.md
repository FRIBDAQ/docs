...
[← Running Readout Software With the Manager](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1399.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Incorporating the socket library →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x14248.md)
