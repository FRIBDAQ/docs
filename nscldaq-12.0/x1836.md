...
[← Basic Tenets of VM-USB Operation](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1822.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [The Slow-Controls Subsystem →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1894.md)
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1836.md#vmusb.config.create)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1836.md#vmusb.config.config)
...
Configuration files must also specify at least one stack and, if
        ...
        See the [stack(3vmusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r83659.md) command
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1836.md#vmusb.config.sis3820)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1836.md#vmusb.config.sclrStack)
...
If the device support provided by VMUSBReadout
      ...
      be found in [*Extending the Supported Readout Hardware*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x2237.md).
