...
<a name="AEN31015"></a>## Name

format Functions -- Functions to create ring items.

<a name="AEN31018"></a>## Synopsis
...
<a name="AEN31020"></a>`pPhysicsEventItem formatEventitem(
              size_t nWords, 
                void* pPayload
            );`

<a name="AEN31031"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                  uint32_t runTime
               , 
                time_ttimeStamp
               , 
...
<a name="AEN31065"></a>`pTextItem formatTextItem (
                   unsigned  nStrings 
                , 
                    time_t stamp
                , 
...
<a name="AEN31085"></a>`pStateChangeItem
                formatStateChange (
                   time_t  stamp 
                , 
                    uint32_t offset
...
<a name="AEN31131"></a>`pDataFormatformatDataFormat
                (void);`

<a name="AEN31137"></a>`pGlomParameters
...
<a name="AEN31151"></a>`pEventBuilderFragment
                        formatEVBFragment
                    (
                        uint64_t timestamp
                    , 
...
<a name="AEN31171"></a>`pEventBuilderFragment
...
<a name="AEN31191"></a>` pPhysicsEventItem
...
<a name="AEN31211"></a>` pPhysicsEventCountItem
...
<a name="AEN31304"></a>` pStateChangeItem
...
<a name="AEN31336"></a>` void* bodyPointer
                    (
                        pRingItem pItem
                    );`

<a name="AEN31344"></a>` pAbnormalEndItem formatAbnormalEndItem
                    (void);`

<a name="AEN31350"></a>` int  
              hasBodyHeader
...
<a name="AEN31374"></a>` uint32_t 
              itemSize
          (
              const RingItem*  pItem
          );`

<a name="AEN31382"></a>` uint16_t 
              itemType
          (
              const RingItem*  pItem
          );`

<a name="AEN31390"></a>` int
              mustSwap
          (
              const RingItem*  pItem
          );`

<a name="AEN31398"></a>` void* 
              fillRingHeader
          (
              pRingItem  pItem
          , 
...
<a name="AEN31544"></a>`pPhysicsEventItem formatEventitem(
                          size_t nWords
                        , 
                            void* pPayload
                        );`
...
<a name="AEN31565"></a>`pPhysicsEventCountItem formatTriggerCountItem (
                              uint32_t runTime
                           , 
                            time_ttimeStamp
                           , 
...
<a name="AEN31620"></a>`pTextItem formatTextItem (
                           unsigned  nStrings 
                        , 
                            time_t stamp
                        , 
...
<a name="AEN31656"></a>`pStateChangeItem
                        formatStateChange (
                           time_t  stamp 
                        , 
                            uint32_t offset
...
<a name="AEN31749"></a>`pDataFormatformatDataFormat
                            (void);`
...
<a name="AEN31765"></a>`pGlomParameters
                                    formatGlomParameters
                                (
                                    uint64_t coincidenceWindow
                                , 
...
<a name="AEN31792"></a>`pEventBuilderFragment
                                    formatEVBFragment
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN31824"></a>`pEventBuilderFragment
                                    formatEVBFragmentUnknown
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN31850"></a>` pPhysicsEventItem
                                    formatTimestampedEventItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN31879"></a>` pPhysicsEventCountItem
                                    formatTimestampedTriggerCountItem
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN32027"></a>` pStateChangeItem
                                    formatTimestampedStateChange
                                (
                                    uint64_t timestamp
                                , 
...
<a name="AEN32079"></a>` pAbnormalEndItem formatAbnormalEndItem
                                    (void);`
...
<a name="AEN32090"></a>` void* bodyPointer
                                (
                                    pRingItem pItem
                                );`
