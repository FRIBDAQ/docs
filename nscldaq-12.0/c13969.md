...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c13969.md#chapter.uri.usage]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c13969.md#chapter.uri.try]]
  The `URL` constructor parses the
                  ...
                  block.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c13969.md#chapter.uri.pieces]]
  This section of code takes the parsed URI and demonstrates
                  how to pull the elements of the URI out and print them.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c13969.md#chapter.uri.catch]]
