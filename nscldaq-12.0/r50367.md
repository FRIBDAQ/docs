...
[← CUnixUserCheck](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r50146.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CAccessListCheck →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r50475.md)
...
`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c14267.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r54262.md).
...
`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c14267.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r55042.md).
...
`CTCLInterpreter`
            ...
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c14267.md) of the
