...
[← Providing EPICS channel information to Tcl Servers](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c10209.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Epics Channel logging →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c10266.md)
...
The epicsdisplay utility provides a tabular
    ...
    available at the [epicsdisplay
      reference page](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r24561.md)

epicsdisplay reads in a configuration file.
    The configuration file is compatible with [the controlpush](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r21344.md) application,
