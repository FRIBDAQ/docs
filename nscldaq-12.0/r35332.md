...
[← LogBookShift](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r35159.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBookNote →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r35823.md)
...
In [*LogBookShift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r35159.md)
...
- int `s_id`
  Primary key of the transition in the transition table.
                    See the [*Logbook Schema*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r106711.md)
                    reference page for the full logbook schema.
- int `s_transition`
  An integer that describes the transition see
                    [*State transition values*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r35332.md#daq3.logbookrun.trantbl)
