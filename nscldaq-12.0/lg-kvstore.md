...
<a name="AEN19635"></a>## Name

lg_kvstore -- Manipulate the key value store.

<a name="AEN19638"></a>## Synopsis
...
**exists**Accepts one more parameter, a key.  If the key exists
...
**get**Accepts one more parameter, a key.  The value of the key
                     is output to stdout.

**set**Requires two parmeters, in order a key and value.
                     If the key already exists, its value is modified to value.
                     If the key does not exist, it is created with the
                     specified value.

**create**Requires two parameters, in order a key and value.  The
