...
[← Using the event builder](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x5606.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Fragments and Data Format →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x5646.md)
