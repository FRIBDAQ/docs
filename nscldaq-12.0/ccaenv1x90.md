...
<a name="AEN39530"></a>## Public member functions
...
<a name="AEN39537"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
...
<a name="AEN39558"></a>` unsigned int getModel(void);const`

Returns the model number of the device.  This will be either
                                    1190 or 1290

<a name="AEN39571"></a>` unsigned char getVersion(void);const`
...
<a name="AEN39596"></a>` unsigned int getChipCount(void);const`
...
<a name="AEN39607"></a>` unsigned int getChannelCount(void);const`
...
<a name="AEN39953"></a>` ECLOutputSelect
...
<a name="AEN40021"></a>` unsigned short
...
<a name="AEN40185"></a>` void SetRejectMargin(unsigned int Margin);`
...
<a name="AEN40197"></a>` void EnableTriggerTimeSubtraction(void);`
...
<a name="AEN40207"></a>` void DisableTriggerTimeSubtraction(void);`
...
<a name="AEN40217"></a>` TriggerConfiguration
...
<a name="AEN40314"></a>` EdgeMode GetEdgeDetectMode(void);`
...
<a name="AEN40355"></a>` unsigned short
                    GetResolution(void);`
...
<a name="AEN40381"></a>` LEResolution
...
<a name="AEN40395"></a>` PWResolution
...
| 10 - JTAG instruction parity error. |
                        ...
                        <a name="AEN40555"></a>` unsigned short
...
<a name="AEN40649"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`

Retrieves the channel enable masks.

<a name="AEN40661"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
<a name="AEN40678"></a>` unsigned int GetChipEnables(unsigned short nChip);`

Returns the enable mask for a single chip.  `nChip`
                            selects the chip you are interested in.  The enables are returned as
                            the function value.

<a name="AEN40691"></a>` unsigned int GetChipId(unsigned short nChip);`



<a name="AEN40703"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`



<a name="AEN40724"></a>` unsigned short GetChipErrors(unsigned short nChip);`



<a name="AEN40736"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN40751"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN40766"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`



<a name="AEN40781"></a>` void
                    SetIndividualLSB(Resolution nResolution);`



<a name="AEN40793"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`



<a name="AEN40808"></a>` unsigned short
                    GetResolution(void);`



<a name="AEN40818"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`



<a name="AEN40830"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`



<a name="AEN40842"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`



<a name="AEN40854"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`



<a name="AEN40866"></a>` DeadTime
                    GetDoubleHitResolution(void);`



<a name="AEN40876"></a>` void
                    EnableTDCEncapsulation(void);`



<a name="AEN40886"></a>` void
                    DisableTDCEncapsulation(void);`



<a name="AEN40896"></a>` bool
                    isTDCEncapsulationOn(void);`



<a name="AEN40906"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`



<a name="AEN40918"></a>` HitMax
                    GetMaxHitsPerEvent(void);`



<a name="AEN40928"></a>` void
                    EnableErrorMark(void);`



<a name="AEN40938"></a>` void
                    DisableErrorMark(void);`



<a name="AEN40948"></a>` void EnableBypassOnError(void);`



<a name="AEN40958"></a>` void
                    DisableBypassOnError(void);`



<a name="AEN40968"></a>` void
                    SetErrorEnables(unsigned short nErrors);`



<a name="AEN40980"></a>` unsigned short
                    GetErrorEnables(void);`



<a name="AEN40990"></a>` void
                    SetL1Size(L1Size nL1Size);`



<a name="AEN41002"></a>` L1Size
                    GetL1Size(void);`



<a name="AEN41012"></a>` void
                    EnableChannel(unsigned short nChannel);`



<a name="AEN41024"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`



<a name="AEN41036"></a>` void EnableAllChannels(void);`



<a name="AEN41046"></a>` void
                    DisableAllChannels(void);`



<a name="AEN41056"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`



<a name="AEN41068"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`



<a name="AEN41080"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`



<a name="AEN41095"></a>` unsigned int GetChipEnables(unsigned short nChip);`



<a name="AEN41107"></a>` unsigned int GetChipId(unsigned short nChip);`

Returns the id code fo the TDC.  Note that there is no documentation about
                            possible values that can be returned.

<a name="AEN41119"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
<a name="AEN41140"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
<a name="AEN41153"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN41170"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN41188"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN41203"></a>## Types and public data
