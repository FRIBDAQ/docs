...
[← CAENcard](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r37815.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCAENV1x90 →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r38998.md)
...
<a name="AEN38759"></a>## Public member functions





- <a name="AEN38765"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN38777"></a>`bool Xtest(void);const`
...
- <a name="AEN38789"></a>`bool Qtest(void);const`
...
- <a name="AEN38806"></a>`bool TimedOut(void);const`
...
- <a name="AEN38818"></a>`bool BranchDemand(void);const`
...
- <a name="AEN38830"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN38844"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN38857"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN38871"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN38886"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN38901"></a>`bool IT4(void);const`
...
- <a name="AEN38915"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN38926"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN38939"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN38955"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN38966"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN38977"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN38987"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN38991"></a>**Example 1. Initializing branch 0**
