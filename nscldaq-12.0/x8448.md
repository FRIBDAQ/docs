...
[← Starting the GUI for the RC-bus through an MxDC device](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x8423.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Saving and restoring state →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x8468.md)
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/figures/MCFD16Control-enabledisable-config-0.png)
...
![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/figures/MCFD16Control-triggerOR-config-0.png)
