...
| Prev | Chapter 67. Event builder client framework | Next |


---

# <a name="sec_ringfragsrc"></a>67.4. ringFragmentSource - a prepackaged client for ringbuffer data sources
...
`--ring`=*ring-uri*Defines the ring from which data will be acquired.  This can
...
`--timestampextactor`=*file-path*Specifies the path to the shared library you have built
...
`--expectbodyheaders`This is a boolean flag that indicates whether the ringFragmentSource
...
## <a name="sec_tsextractors"></a>67.4.1. Writing and building timestamp extractors.
...
<a name="AEN14894"></a>**Example 67-7. S800 timestamp extractor (s800timestamp.c**
