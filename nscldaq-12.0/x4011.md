...
# <a name="AEN4011"></a>6.7. Writing C++ slow controls device drivers
...
## <a name="AEN4027"></a>6.7.1. Obtaining the sample driver and its Makefile
...
<a name="AEN4032"></a>**Example 6-9. Obtaining the sample CCUSB slow controls driver**
...
## <a name="AEN4050"></a>6.7.2. Modifying the sample driver and Makefile.
...
### <a name="AEN4069"></a>6.7.2.1. Driver Code
...
<a name="AEN4072"></a>**Example 6-10. Headers for the CCUSB sample slow controls driver**
...
[[x4011#ccusb-slowdriver-includes-tcl.h]]                            Since our driver will get loaded via the Tcl
                        ...
                        [[x4011#ccusb-slowdriver-includes-CModuleFactory.h]]                            The `CModuleFactory` class is
...
[[x4011#ccusb-slowdriver-includes-CModuleCreator.h]]                            This header defines the base class for all module
                        ...
                        [[x4011#ccusb-slowdriver-includes-CControlHardware.h]]                            Drivers are classes that are derived from
                            ...
                            (see
                            [[r73908]]
[[x4011#ccusb-slowdriver-includes-CControlModule.h]]                            The makeup of a `CControlHardware`
...
#### <a name="AEN4112"></a>6.7.2.1.1. The driver class and its implementation
...
<a name="AEN4115"></a>**Example 6-11. CCUSB Slow control driver class definition **
...
[[x4011#ccusb-slowdriver-def-onattach]]                                The `OnAttach` method is
...
**Construction and destruction. **
                            See
                            [[x4011#ccusb-slowdriver-impl-condestruct]]
...
[[x4011#ccusb-slowdriver-impl-constr-baseinit]]                                The constructor must initialize the base
                            ...
                            [[x4011#ccusb-slowdriver-impl-constr-configinit]]                                The `m_pConfig` member variable
...
<a name="AEN4196"></a>**Example 6-13. CCUSB Slow controls driver `OnAttach`**
...
<a name="AEN4230"></a>**Example 6-14. CCUSB Slow controls driver initialize method**
...
<a name="AEN4242"></a>**Example 6-15. CCUSB Slow controls driver Update**
...
<a name="AEN4270"></a>**Example 6-16. CCUSB Slow controls driver Set method**
...
[[x4011#cccusb-slowdriver-impl-set-configure]]                                Our driver uses the configuration database
...
[[x4011#cccusb-slowdriver-impl-set-ok]]                                On success, the `Set`
...
<a name="AEN4305"></a>**Example 6-17. CCUSB slow controls Get method**
...
[[x4011#ccusb-slowdriver-impl-get-error]]                                The `cget` method throws
...
<a name="AEN4330"></a>**Example 6-18. CCUSB Slow controls clone method**
...
#### <a name="AEN4338"></a>6.7.2.1.2. The creator class and its implementation
...
<a name="AEN4349"></a>**Example 6-19. Module creator for the CCUSB Sample slow controls driver**
...
<a name="AEN4379"></a>**Example 6-20. CCUSB Slow control driver initialization function**
...
### <a name="AEN4409"></a>6.7.2.2. The Makefile and typical modifications.
...
<a name="AEN4415"></a>**Example 6-21. CCUSB Slow controls driver Skeleton Makefile**
