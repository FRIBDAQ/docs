...
[← Interactors](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x13901.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Compiling/Linking your software with the shared memory API →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x14098.md)
...
- [*Starting Readout with REST at BOOT*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1399.md#sec.mgr.bootreadout)
              describes how to setup Readout to run the REST plugin as a manager program and
              add it to
              a sequence attached to the BOOT transition.
- [*Controlling Readout From the Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1399.md#sec.mgr.readoutctl)
...
**Specifying a Readout Program to the Manager. **
            The program editor [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18069.md)
            or the experiment configuration editor
            ([*mg_config*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r17993.md))
...
**Starting your Readout From a Boot Sequencde. **
            ...
            system.  Use
            [*mg_seqedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18154.md)
            (or start it from
            [*mg_config*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r17993.md))
...
- [*mg_startloggers*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18617.md)
...
- [*rdo_runFromKv*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18637.md)
  Asks a single readout program to set its run number to the
                    ...
                    Run control panel.
- [*rdo_titleFromKv*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18669.md)
...
- [*rdo_control*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18701.md)
...
1. Use the program editor
                       [*mg_cfgprogram*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18069.md)
