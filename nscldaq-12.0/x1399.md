...
- [[*Starting Readout with REST at BOOT*|x1399#sec.mgr.bootreadout]]
              describes how to setup Readout to run the REST plugin as a manager program and
              add it to
              a sequence attached to the BOOT transition.
- [[*Controlling Readout From the Manager*|x1399#sec.mgr.readoutctl]]
...
If your experiment runs more than one Readout you'll need to repeat the
        ...
        [[*Using the NSCLDAQ Event Builder With the Manager*|x1661]]
...
**Specifying a Readout Program to the Manager. **
            The program editor [[*mg_cfgprogram*|r18069]]
...
[[*mg_startloggers*|r18617]]This program starts all event loggers you have defined
...
[[*rdo_runFromKv*|r18637]]Asks a single readout program to set its run number to the
...
[[*rdo_titleFromKv*|r18669]]Asks a single readout program to set it stitle to the value of
...
[[*rdo_control*|r18701]]Performs some operation on a single Readout program.
