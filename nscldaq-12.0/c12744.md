...
[← DAQ Manager APIs](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c11384.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [TclRingBuffer Tcl package. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c13002.md)
...
This section provides tutorial information that describes the
            ...
            [*CEventOrderClient*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r36598.md)
...
- [Making `CEventOrderClient` available
                  within your program.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x14815.md)
- [How to form a connection with the event orderer.](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x12791.md)
