...
[← The Ring Item Types](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x316.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Pushing external data into the event stream →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x3345.md)
...
There are a number of frameworks for building C++ applications. First
      there is the [SBS Readout Framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c15004.md),
      ...
      data format. To facilitate the design of filter programs, the [Filter framework](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c15528.md) exists. It handles the
