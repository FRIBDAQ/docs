...
[← Pushing external data into the event stream](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x3345.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Writing device support software →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x3476.md)
...
Configuration files must also specify at least one stack and, if
            ...
            See the [stack(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r66911.md) command
