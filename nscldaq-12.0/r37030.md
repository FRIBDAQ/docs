...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r37187]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r37187]].
...
[[portAllocator(3tcl)|r99465]],
            [[CPortManagerException(3daq)|r37187]],
            [[DaqPortManager(1tcl)|r23759]]
