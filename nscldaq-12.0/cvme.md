...
<a name="AEN45318"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN45321"></a>## Synopsis
...
<a name="AEN45428"></a>## Public member functions



<a name="AEN45433"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
<a name="AEN45471"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
<a name="AEN45486"></a>`CVME<T>(const CVME& aCVME);`
...
<a name="AEN45499"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
<a name="AEN45512"></a>`int  operator==(const CVME<T>& aCVME);`
...
<a name="AEN45557"></a>`T*  T* operator-> (void);`
...
<a name="AEN45567"></a>`T&  operator[](UInt_t nOffset);`
...
<a name="AEN45582"></a>`CVME<T>& operator+(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN45594"></a>`CVME<T>&  operator-(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN45606"></a>`CVME<T>&  operator+=(UInt_t nOffset);`

Adds the specified offset to the pointer and returns a reference to the
                            modified pointer.

<a name="AEN45618"></a>`CVME<T>&  operator-=(UInt_t nOffset);`

Subtracts the offset from the pointer and returns a reference to the
                            resulting pointer.

<a name="AEN45628"></a>## Types and public data
