...
[[![(1)](../images/callouts/1.gif)|x16654#spectclapp.includes]] MySpecTclApp.cpp
                    ...
                    [[![(2)](../images/callouts/2.gif)|x16654#spectclapp.pipeline]]                        In most cases, `MySpecTclApp.cpp`
...
[[![(3)](../images/callouts/3.gif)|x16654#spectclapp.builtproc]]                        This line creates a
                        `VX2750EventBuiltEventProcessor`.
...
[[![(6)](../images/callouts/6.gif)|x16654#spectclapp.regprocessor]]                        Appends the event built event processor to the event
