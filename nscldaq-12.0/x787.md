...
[← Creating the tailored SpecTcl](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7496.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Running the system. →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x7881.md)
...
Although normally you do not need to modify the states and allowed
          ...
          **mg_stateedit**
          (Reference pages in
          [*mg_stateedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18108.md))
...
The **mg_cfgEvlog** utility allows you to create, edit
          ...
          utility is at
          [*mg_cfgEvlog*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18197.md)
...
The **mg_kvedit** command allows you to create, new keys,
          ...
          **mg_kvedit** is available at
          [*mg_kvedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18323.md)
...
The experiment configuration database does, however, already provide
          ...
          [*mg_authedit*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r18358.md)
