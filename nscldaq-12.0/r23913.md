...
[← lsservices](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r23872.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [serverauth →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r23966.md)
...
<a name="AEN23927"></a>## Name

tclserver -- Start a Tcl Server.

<a name="AEN23930"></a>## Synopsis

**
tclserver [`-pport` `-userauth`]
	**

<a name="AEN23937"></a>## DESCRIPTION
