...
<a name="AEN25213"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN25216"></a>## Synopsis
...
<a name="AEN25292"></a>## Public member functions
...
<a name="AEN25383"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN25387"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN25391"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
