...
[← Making logbooks available to collaborators](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9341.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Proxy Rings, Ring Masters, and Network Transparency →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x99.md)

---

---

# <a name="sec.lg_programming"></a>22.5.
...
## <a name="AEN9440"></a>22.5.1. Using the logbook API from C++

Here's the C++ implementation of our toy program, kvexample.cpp:

<a name="AEN9443"></a>**Example 22-9. C++ example using logbook API**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgcppapi_header)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgcppapi_usage)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgcppapi_try)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgcppapi_construct)
...
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgcppapi_exists)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgcppapi_get)
...
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgcppapi_catch)
...
<a name="AEN9487"></a>**Example 22-10. Compiling the C++ Logbook API example.**
...
## <a name="AEN9496"></a>22.5.2. Using the logbook API from Tcl
...
### <a name="AEN9499"></a>22.5.2.1. Low Level Tcl bindiings
...
<a name="ex.tclapilow"></a>**Example 22-11. kvexamplelow.tcl low level Tcl logbook API example**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_shell)
...
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_libpath)
  This line adds the NSCLDAQ Tcl package library path to the
                    set of paths searched by **package require**.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_require)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_usage)
  Our script requires two parameters, the logbook filename
                       and a key in the key value store.  This ensures both are
                       present.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_open)
...
- [![(6)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_exist)
  The subcommands of a logbook instance command ensemble
                       ...
                       **$instance kvExists** command checks to see
                       ...
                       if not.
- [![(7)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_get)
  Similarly a logbook instance command ensemble's
                       **kvGet** subcommand returns the value of a
                       key.
- [![(8)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/8.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapilow_destroy)
...
### <a name="AEN9556"></a>22.5.2.2. Using the high-level or administrative Tcl API
...
<a name="AEN9563"></a>**Example 22-12. kvexamplehi.tcl Using the high level Tcl logbook API**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapihi_prev)
  This code appeared in
                       [**kvexamplelow.tcl* low level Tcl logbook API example*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#ex.tclapilow).
                       We won't explain it again here.  Refer to that example
                       if you need to understand it.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapihi_1param)
  Unlike [**kvexamplelow.tcl* low level Tcl logbook API example*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#ex.tclapilow),
                       we refer to the current logbook.  Therefore we only need one
                       parameter, the key to retrieve.
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclapihi_exists)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#tclaphihi_get)
...
## <a name="AEN9584"></a>22.5.3. Using the logbook API from Python
...
<a name="AEN9590"></a>**Example 22-13. kvexample.py programming the Python logbook API**
...
- [![(1)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgpyapi_sys)
  This package provides access to the raw command line words
                    via the `sys.argv` array.
- [![(2)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgpyapi_import)
...
- [![(3)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgpyapi_args)
...
- [![(4)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgpyapi_filename)
  As described above we fish the logbook filename from the
                    command arguments.
- [![(5)](https://github.com/FRIBDAQ/docs/tree/main/images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x9435.md#lgpyapi_key)
...
<a name="AEN9617"></a>**Example 22-14. Running Python scripts that use the logbook API**
