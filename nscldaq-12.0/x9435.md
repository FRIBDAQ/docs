...
- [[![(1)](../images/callouts/1.gif)|x9435#lgcppapi_header]]
...
- [[![(2)](../images/callouts/2.gif)|x9435#lgcppapi_usage]]
...
- [[![(3)](../images/callouts/3.gif)|x9435#lgcppapi_try]]
...
- [[![(4)](../images/callouts/4.gif)|x9435#lgcppapi_construct]]
...
- [[![(5)](../images/callouts/5.gif)|x9435#lgcppapi_exists]]
...
- [[![(6)](../images/callouts/6.gif)|x9435#lgcppapi_get]]
...
- [[![(7)](../images/callouts/7.gif)|x9435#lgcppapi_catch]]
...
- [[![(1)](../images/callouts/1.gif)|x9435#tclapilow_shell]]
...
- [[![(6)](../images/callouts/6.gif)|x9435#tclapilow_exist]]
  The subcommands of a logbook instance command ensemble
                       ...
                       **$instance kvExists** command checks to see
                       ...
                       if not.
- [[![(7)](../images/callouts/7.gif)|x9435#tclapilow_get]]
  Similarly a logbook instance command ensemble's
                       **kvGet** subcommand returns the value of a
                       key.
- [[![(8)](../images/callouts/8.gif)|x9435#tclapilow_destroy]]
...
- [[![(1)](../images/callouts/1.gif)|x9435#tclapihi_prev]]
  This code appeared in
                       [[**kvexamplelow.tcl* low level Tcl logbook API example*|x9435#ex.tclapilow]].
                       We won't explain it again here.  Refer to that example
                       if you need to understand it.
- [[![(2)](../images/callouts/2.gif)|x9435#tclapihi_1param]]
  Unlike [[**kvexamplelow.tcl* low level Tcl logbook API example*|x9435#ex.tclapilow]],
                       we refer to the current logbook.  Therefore we only need one
                       parameter, the key to retrieve.
- [[![(3)](../images/callouts/3.gif)|x9435#tclapihi_exists]]
...
- [[![(4)](../images/callouts/4.gif)|x9435#tclaphihi_get]]
...
- [[![(1)](../images/callouts/1.gif)|x9435#lgpyapi_sys]]
  This package provides access to the raw command line words
                    via the `sys.argv` array.
- [[![(2)](../images/callouts/2.gif)|x9435#lgpyapi_import]]
...
- [[![(3)](../images/callouts/3.gif)|x9435#lgpyapi_args]]
...
- [[![(4)](../images/callouts/4.gif)|x9435#lgpyapi_filename]]
  As described above we fish the logbook filename from the
                    command arguments.
- [[![(5)](../images/callouts/5.gif)|x9435#lgpyapi_key]]
