...
A Slow controls device driver is a class that is derived from
          the 
          [[*CControlHardware*|r90117]] abstract base class.
...
The [[*CControlHardware*|r90117]] class is an abstract
...
- [[![(1)](../images/callouts/1.gif)|x2650#ctldriver-onattach-saveconfig]]
...
- [[![(2)](../images/callouts/2.gif)|x2650#ctldriver-onattach-makeparams]]
...
- [[![(1)](../images/callouts/1.gif)|x2650#ctldriver-set-params]]
...
- [[![(2)](../images/callouts/2.gif)|x2650#ctldriver-set-configure]]
...
- [[![(3)](../images/callouts/3.gif)|x2650#ctldriver-set-error]]
...
- [[![(1)](../images/callouts/1.gif)|x2650#ctldriver-get-params]]
  ...
  - `parameter`
    The name of the parameter to modify.
- [[![(2)](../images/callouts/2.gif)|x2650#ctldriver-get-cget]]
...
- [[![(3)](../images/callouts/3.gif)|x2650#ctldriver-get-error]]
...
- [[![(1)](../images/callouts/1.gif)|x2650#cltcreator-headers]]
  The creator must have `CModuleCreator` as 
  		  a base class.   This line includes the header for that class.
- [[![(2)](../images/callouts/2.gif)|x2650#ctlcreator-classdef]]
  This is the class definition for the creator.  By convention
  		  ...
  		  `CModuleCreator`
- [[![(3)](../images/callouts/3.gif)|x2650#ctlcreator-functordef]]
...
- [[![(4)](../images/callouts/4.gif)|x2650#ctlcreator-new]]
...
- [[![(1)](../images/callouts/1.gif)|x2650#ctldriver-init-headers]]
  ...
  - tcl.h
    Contains interface definitions for the API to the
    			  Tcl interpreter.
- [[![(2)](../images/callouts/2.gif)|x2650#ctldriver-init-cbinding]]
...
- [[![(3)](../images/callouts/3.gif)|x2650#ctldriver-init-prototype]]
...
- [[![(4)](../images/callouts/4.gif)|x2650#ctldriver-init-factget]]
  The main work of the intitialization function is to register
  		    ...
  		    of the factory.
- [[![(5)](../images/callouts/5.gif)|x2650#ctldriver-init-creator]]
  Registers the new creator object associating it with the
  		    module type mydriver
- [[![(6)](../images/callouts/6.gif)|x2650#ctldriver-init-status]]
...
- [[![(1)](../images/callouts/1.gif)|x2650#ctldriver-tclstruct-packages]]
...
- [[![(2)](../images/callouts/2.gif)|x2650#ctldriver-tclstruct-snittype]]
...
- [[![(3)](../images/callouts/3.gif)|x2650#ctldriver-tclstruct-options]]
  The **option**, defined within a **snit::type**
  	    ...
  	    **option** provides the name of a method that
  	    ...
  	    validation.
- [[![(4)](../images/callouts/4.gif)|x2650#ctldriver-tclstruct-constructor]]
  The constructor  method must do all internal initializations,
  	    ...
  	    parameter contains.
- [[![(5)](../images/callouts/5.gif)|x2650#ctldriver-tclstruct-methods]]
...
- [[![(6)](../images/callouts/6.gif)|x2650#ctldriver-tclstruct-configmethods]]
...
- [[![(1)](../images/callouts/1.gif)|x2650#tcldriver-validate-isinteger]]
...
- [[![(2)](../images/callouts/2.gif)|x2650#tcldriver-validate-setintopt]]
...
- [[![(3)](../images/callouts/3.gif)|x2650#tcldriver-validate-intinvalid]]
