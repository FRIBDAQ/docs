...
[← Slow controls protocol](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r67579.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [CCCUSBusb →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r70464.md)
...
<a name="AEN67714"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN67717"></a>## Synopsis

```
CCCUSB
```

<a name="AEN68699"></a>## DESCRIPTION
...
`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r70949.md))
...
`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [CCCUSBReadoutList(3ccusb)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r70949.md) for
...
<a name="AEN69270"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN69274"></a>### Action Register
...
<a name="AEN69317"></a>### Firmware Register
...
<a name="AEN69369"></a>### Global Mode Register
...
<a name="AEN69502"></a>### Delay Register
...
<a name="AEN69535"></a>### Scaler Control register
...
<a name="AEN69568"></a>### LED Source Register
...
<a name="AEN69820"></a>### Output source selection register.
...
<a name="AEN69989"></a>### Device source register
...
<a name="AEN70342"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN70403"></a>### Transfer setup register
