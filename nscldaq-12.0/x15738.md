...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md#rdo.classinc)
  This #include is needed to define
                              the `TclConfiguredReadout`
                              class.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md#rdo.tracinginc)
  Wrappers for the CAEN libraries support tracing the
                              ...
                              library Makefile.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md#rdo.tracing)
  If the library has been built with tracing enabled,
                              ...
                              impact performance.
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md#rdo.makesegment)
...
- [![(5)](../images/callouts/5.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md#rdo.addmodule)
...
- [![(6)](../images/callouts/6.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md#rdo.registersegment)
  The `TclConfiguredReadout`
                              event segment is registered with the experiment framework
                              so that its methods will be invoked by that framework
                              when appropriate.
- [![(7)](../images/callouts/7.gif)](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x15738.md#rdo.registertrigger)
