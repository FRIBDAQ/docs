...
[← Pipeline Building, Run Control, and DAQ Modularization](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x19.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Understanding VMUSBReadout Output →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x2109.md)
...
- `--timestamplib`
  ...
  For more information about how to generate this library, see 
            [*Developing a Timestamp Extractor Library*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x2115.md).
- `--log`
