...
# <a name="customizing_readoutshell"></a>7.4. Customizing the ReadoutShell
...
<a name="AEN5227"></a>**Table 7-2. Experiment file systems environment variables**
...
<a name="AEN5252"></a>**Table 7-3. SSHPipe prompter environment variables**
...
## <a name="AEN5275"></a>7.4.2. ReadoutCallouts.tcl
...
**OnBegin**This command is invoked when the Halted
                            state is left for the Active state.
                            The command is passed the number of the run that is
                            about to be started.

**OnEnd**This command is invoked when the Halted
...
## <a name="AEN5346"></a>7.4.3. Integrating Tcl scripts
...
Besides automatically sourcing the ReadoutCallouts.tcl
                ...
                **proc**s from the packages described in
                [[x5162#readoutshell_api_packages]].

## <a name="AEN5356"></a>7.4.4. Libraries and Data source providers
...
## <a name="AEN5436"></a>7.4.5. Using the ReadoutGUI in your own container script
...
<a name="AEN5445"></a>**Example 7-1. Custom ReadoutGUI startup script**
...
[[x5162#custom_readoutgui_extend]]                        Once the `ReadoutGuiApp` application
                        ...
                        [[x5162#readoutshell_api_packages]] which
...
## <a name="readoutshell_api_packages"></a>7.4.6. ReadoutGUI API packages
...
| --- | --- | --- |
| Prev | Home | Next |
| The event logger and ReadoutShell | Up | Remote control package |
