...
[← Simple V775 readout](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c7152.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Using NSCLDAQ with a CAEN V785 Peak-Sensing ADC and CAEN V262 IO Register →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c8077.md)
...
- [*Introduction*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/c748.md#sec.mgr.intro)
          Provides introductory information that's useful for understanding the
          remainder of the presentation.
- [*Managed Objects and Configuration*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x787.md)
            Describes the objects the DAQ manager controls and how to configure
            them.
- [*Running an Experiment With The Manager*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x1216.md)
