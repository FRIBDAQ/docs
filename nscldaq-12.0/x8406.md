...
[← Interpreting the dumper output](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x8364.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [Starting the GUI for the RC-bus through an MxDC device →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/x8423.md)

---

---

# <a name="AEN8406"></a>15.2. Starting the GUI for USB communication
...
2. At the command line, call
   ...
   <a name="AEN8416"></a>**Figure 15-1. The MCFD16Control Graphical User Interface for USB**
   ![](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/figures/MCFD16Control-USBHowTo-0.png)
