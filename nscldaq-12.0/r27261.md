...
<a name="AEN27457"></a>## Public member functions
...
<a name="AEN27697"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN27700"></a>**Example 1. Creating a begin run state transition item**
