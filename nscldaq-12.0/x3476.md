...
[[![(1)](../images/callouts/1.gif)|x3476#ccusb-dtemplate-saveconfig]] `onAttach` needs to be able
...
[[![(2)](../images/callouts/2.gif)|x3476#ccusb-dtemplate-slotparam]]                        Virtually all of the device support you write will
...
[[![(3)](../images/callouts/3.gif)|x3476#ccusb-dtemplate-valueparam]]                        This sample line shows how to create an unconstrained
...
See [[CConfigurableObject(3ccusb)|r71474]] for
...
For detailed information about the methods supported by
                ...
                see [[CCCUSB(3ccusb)|r67700]] and [[CCCUSBReadoutList(3ccusb)|r70949]]
...
[[![(1)](../images/callouts/1.gif)|x3476#ccusb-dtemplate-init1]]                        In most cases you need the slot number of the module
                    ...
                    [[![(2)](../images/callouts/2.gif)|x3476#ccusb-dtemplate-init2]]                        You would add code here to fetch parameter values
...
[[![(1)](../images/callouts/1.gif)|x3476#ccusb-dtemplate-dinit1]]                        Since C++ *decorates* function  names
                        ...
                        linkage conventions.
                    [[![(2)](../images/callouts/2.gif)|x3476#ccusb-dtemplate-dinit2]]                        In general you will need to modify the name of this
                    ...
                    [[![(3)](../images/callouts/3.gif)|x3476#ccusb-dtemplate-dinit3]]                        In our examples we used the Tcl **load**
                    ...
                    [[![(4)](../images/callouts/4.gif)|x3476#ccusb-dtemplate-dinit4]]                        The `CUserCommand`::`addDriver`
...
[[![(5)](../images/callouts/5.gif)|x3476#ccusb-dtemplate-dinit5]]                        If the library initialization was successful it
