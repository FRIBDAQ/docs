...
[← 3python](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r78725.md) | [Home](https://github.com/FRIBDAQ/docs/tree/main/Home.md) | [LogBook.Person →](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r79147.md)
...
<a name="AEN78731"></a>## Name

LogBook -- Python bindings to LogBook Api.

<a name="AEN78734"></a>## Synopsis
...
<a name="AEN78751"></a>## PEOPLE API section
...
This section allows you to create and retrieve people from the logbook.
         ...
         [*LogBook.Person*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r79147.md).
...
`
  ...
  For more informationa bout the strings that can be used
                    ...
                    ).  And the logbook schema for the person
                    table at
...
<a name="AEN78823"></a>## SHIFT API Section
...
The Shift part of the API manipulates collections of people that
         ...
         [*LogBook.Shift*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r79191.md) reference page.
...
<a name="AEN78884"></a>## RUN API Section

Runs are segments of data taking.  They are encapsulated with
         `LogBook.Run` objects. For more on those, see
         [*LogBook.Run*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r79267.md).
...
<a name="AEN78946"></a>## NOTE API section
...
Notes are incapsulated in `LogBook.Note` objects.
         ...
         [*LogBook.Note*](https://github.com/FRIBDAQ/docs/tree/main/nscldaq-12.0/r79466.md).
...
<a name="AEN79073"></a>## KEY VALUE STORE API Section
