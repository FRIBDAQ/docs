...
$DAQBIN/ddasdumper -s [[file:///scratch/chester/rawdata/run-1234-00.evt|file:///scratch/chester/rawdata/run-1234-00.evt]] -f run-1234-00.root ddasdumper main caught a C++ exception: Unable to dump a data format item... likely you've specified the wrong –nscldaq-format
