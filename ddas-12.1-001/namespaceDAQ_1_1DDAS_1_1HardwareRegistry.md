...
header
The [[namespaceDAQ_1_1DDAS_1_1HardwareRegistry]] namespace is where information about all known [[namespaceDAQ_1_1DDAS]] modules are stored.  
[[namespaceDAQ_1_1DDAS_1_1HardwareRegistry#details]]
...
The [[namespaceDAQ_1_1DDAS_1_1HardwareRegistry]] is fairly simple. It is just a map of HardwareRegistry::HardwareSpecifications that are keyed by [[namespaceDAQ_1_1DDAS_1_1HardwareRegistry#acc5358e9e3cf609ca7ec2d8210b59fb4]] enumerations. The [[namespaceDAQ_1_1DDAS_1_1HardwareRegistry]] provides a default state that provides the normal specifications for each hardware type in use at the NSCL. If for some crazy reason, something changes, the user can change the specifications associated with each device type.


There is also a function to determine the hardware type enumeration value given the hardware revision, ACD frequency, and ADC resolution called [[namespaceDAQ_1_1DDAS_1_1HardwareRegistry#acc667cd1e6674cc33c99eb8103769454]]. The reverse operation is called HardwareRegistry::getSpecification(HardwareType type). Together these two functions are probably the most useful tools.
...
**[[todo#_todo000013]]**(ASC 3/13/24): Create a method that can query a module and compute the HardwareType. 
|  |  |
| --- | --- |
| Enumerator |
| RevB_100MHz_12Bit |  |
