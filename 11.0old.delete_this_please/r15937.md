...
<a name="AEN15982"></a>### Configuration Options
...
<a name="AEN16006"></a>### Device Options
...
<a name="AEN16036"></a>### License Options
...
Load firmware file into a V1724 base address 0x32100000<a name="AEN16052"></a>```
...
Retrieve the ID code for the board above<a name="AEN16057"></a>```
...
Load firmware and license it.<a name="AEN16064"></a>```
...
Retrieve license information from a digitizer.<a name="AEN16072"></a>```
...
Un-license a digitizer's firmware:<a name="AEN16077"></a>```
