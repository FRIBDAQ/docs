...
<a name="AEN36811"></a>## Description

`CHostListCheck` is derived from the
            [`CAccessListCheck`](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r36595.md).
...
<a name="AEN36821"></a>## Public member functions
...
<a name="AEN36912"></a>## Types and public data
