...
# <a name="chapter.ringmaster"></a>Chapter 32. The RingMaster server
...
# <a name="AEN7448"></a>32.1. The RingMaster Protocol
...
This section describes the protocol supported by the
            ...
            PortManager
            is the
            [[Service Port Manager|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7586.md]]
            chapter.
...
<a name="AEN7470"></a>**Example 32-1. The CONNECT message format**
...
<a name="AEN7485"></a>**Example 32-2. Format of the DISCONNECT message**
...
<a name="AEN7499"></a>**Example 32-3. Format of the LIST command**
...
Each element of the list reports on the usage of a single ring.
            ...
            [[Tcl ring package's ringbuffer
                usage|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r16538.md]] command.
...
<a name="AEN7551"></a>**Example 32-4. Format of the REGISTER command**
...
<a name="AEN7561"></a>**Example 32-5. Format of the UNREGISTER message**
...
<a name="AEN7572"></a>**Example 32-6. Format of the REMOTE message**
