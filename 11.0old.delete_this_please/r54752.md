...
<a name="AEN54808"></a>## CONVENIENCE PROC

`::Output::promptSettings` displays a
                `OutputWindowSettings` widget wrapped in a
                [*DialogWrapper*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r53061.md#rdogui3_dialogwrapper).
