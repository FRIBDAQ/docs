...
# <a name="AEN9924"></a>Chapter 50. Shared memory
...
Reference information is available in [[the reference section|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r37767.md]]

# <a name="AEN9937"></a>50.1. Overview of the API, and using it from within your C++ software
...
<a name="AEN9965"></a>**Example 50-1. Shared memory library example**
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c9924.md#shm_includes]]
  Includes the header for the NSCLDAQ shared memory API.
                      See [[*Compiling/Linking your software with the shared memory API*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x9995.md]]
                      for information that describes how to ensure this header
                      will be found by the compiler.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c9924.md#shm_create]]
  Attempts to crate the shared memory. The return value of this
                      ...
                      read/write access.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c9924.md#shm_create_fail]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c9924.md#shm_attach]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c9924.md#shm_detach]]
