...
# <a name="AEN8411"></a>38.4. Generic ring data sinks
...
For reference information on the data sink classes see:
            [*CDataSink*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r22961.md),
            [*CRingDataSink*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23190.md),
            [*CFileDataSink*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23050.md).
            For reference information on the factory class see:
            [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23289.md)
