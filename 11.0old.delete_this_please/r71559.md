...
<a name="AEN71571"></a>## Name

RingStatus -- Widget that shows ring status.

<a name="AEN71574"></a>## Synopsis
...
- `update` *ring-info-list*
  Accepts a list of data compatible with the output
                              of the
                              [[**ring usage**|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68322.md]]
                              command.  This data is used to update the ring size, free space and
                              consumer information table.

<a name="AEN71615"></a>## SEE ALSO

[[*TCL Ring package.
        **Ron**Fox**
*NSCLDAQ*
***|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68322.md]]
