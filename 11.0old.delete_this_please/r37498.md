...
<a name="AEN37502"></a>## Name

URL -- Parse Uniform Resource Identifiers (URI)

<a name="AEN37505"></a>## Synopsis
...
[[The NSCL Exception class library|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10072.md]]
        ...
        [[The `CException`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r42445.md]] reference
        page describes the `CException` class.
        [[The `CURIFormatException`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r43009.md]]
