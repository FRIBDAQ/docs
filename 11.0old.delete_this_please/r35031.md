...
<a name="AEN35080"></a>## Public member functions
...
<a name="AEN35118"></a>`void sync_self(void);`
...
<a name="AEN35125"></a>`void sync_begin(
                    Synchronizable& s
                );`
...
<a name="AEN35133"></a>`voidsync_begin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35145"></a>`void sync_end(void);`

Marks the end of a critical section that was begun with
            one of the sync macros above.

<a name="AEN35151"></a>` void sync_trybegin(Synchronizable& s);`
...
<a name="AEN35161"></a>` void sync_trybegin2(
                t
            , 
                Synchronizable& s
            );`
...
<a name="AEN35191"></a>`void sync_global_end(void);`
