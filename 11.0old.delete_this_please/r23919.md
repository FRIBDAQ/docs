...
`CPortManagerException`
       ...
       class `CPortManager`
        see [[the man page for that class|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23764.md]]).
        Since it  is  derived
       from
       `CException`,
...
[[portAllocator(3tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68886.md]],
            [[CPortManager(3daq)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23764.md]],
            [[DaqPortManager(1tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r15126.md]]
[[CException(3tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r42470.md]]
