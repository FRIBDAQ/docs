...
# <a name="chapter.ringaccess"></a>Chapter 35. Networked ring buffer access
...
<a name="AEN7632"></a>**Example 35-1. A sample ring specification in URI form**
...
<a name="AEN7640"></a>**Example 35-2. Substituting local host for the hostname in URI's**
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7624.md#chapter.ringaccess.hostname)
  This section of code determines the name of the host.
                  For spdaq20.nscl.msu.edu e.g., this will
                  fill `localhost` with
                  localhost
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7624.md#chapter.ringaccess.domain)
  This section of code determines DNS domain name of the system.
                  For spdaq20.nscl.msu.edu
  `domain` gets filled with the string
                  nscl.msu.edu.
- [![(3)](../images/callouts/3.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7624.md#chapter.ringaccess.islocal)
  This section of code considers the case that
                  ...
                  *fully qualified host name*
                  ...
                  the `ring`
- [![(4)](../images/callouts/4.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7624.md#chapter.ringaccess.builduri)
...
<a name="AEN7672"></a>**Example 35-3. Including the header**
...
<a name="AEN7675"></a>**Example 35-4. Compiling code that uses `CRingAccess`**
...
<a name="AEN7679"></a>**Example 35-5. Linking code that uses `CRingAccess`**
...
[Remote Ring Access](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r16345.md) provides
