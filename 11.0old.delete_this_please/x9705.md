...
# <a name="AEN9705"></a>47.5. Pointers to the reference material
...
- [`Thread`](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r34824.md)
                      is the abstract base class from which you can construct
                      application specific threads.
- [`Synchronizable`](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r34958.md)
                      is the class used to perform synchronization.
- [`SyncGuard`](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r35056.md)
                      is built on top of `Synchronizable` to 
                      provide monitor like synchronization semantics.
- [*CCondition*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r35475.md)
...
- [*CGaurdedObject*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r35776.md)
  	      documents the `CGaurdedObject` base class.
- [*CBufferQueue*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r35832.md) described
