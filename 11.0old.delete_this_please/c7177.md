...
# <a name="chapter.ringselector"></a>Chapter 27. The ringselector application

The ringselector application is very
        similar in nature ot
        [[ringtostdout|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r11932.md]]
        application.  Both
...
<a name="AEN7236"></a>**Example 27-1. Dumping state changes and sampled event data with od**
...
<a name="AEN7244"></a>**Example 27-2. Dumping all but packet types**
...
<a name="AEN7252"></a>**Example 27-3. Attaching SpecTcl**
...
For a complete reference on the command see the
        [[ringselector reference page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12813.md]].
