...
# <a name="AEN9121"></a>Chapter 43. Tcl CAENet package
...
This chapter describes how to incorporate a pure Tcl package
        ...
        of the
        [[the TCL Vme package|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7025.md]] that provides
        access to the CAEN VME CAENet controller (V288).   For reference
        information see
        [[caenet(3tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r70652.md]]
