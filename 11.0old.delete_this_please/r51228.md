...
<a name="AEN51232"></a>## Name

CControlHardware -- Base class (ABC) of a slow controls driver

<a name="AEN51235"></a>## Synopsis

```
CControlHardware
```

<a name="AEN51302"></a>## DESCRIPTION
...
`CControlHardware` is the abstract base class
            ...
            [[*CModuleFactory*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r51088.md]]
            and
            [[*CModuleCreator*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r51185.md]]
            for information about how to make the **Module create**
            command aware of your driver so that it instantiate it.

<a name="AEN51309"></a>## METHODS
...
| --- | --- | --- |
| Prev | Home | Next |
| CModuleCreator | Up | CControlModule |
