...
# <a name="chapter.tclserver"></a>Chapter 19. The tcl server application
...
This chapter contains:
    ...
    [the TclServer reference pages](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r15237.md).
...
The TclServer extends the Tcl/Tk command set with the command
	    ...
	    **serverauth** command.](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r15280.md).
            section.

The following command adds the node spdaq20.nscl.msu.edu
            to the set of hosts that are allowed to connnect to the server.

<a name="AEN6897"></a>**Example 19-1. Using **serverauth** to authorize a node**
...
# <a name="AEN6901"></a>19.1. Tcl server package

TclServer is also available as a package that can be incorporated
                into Tcl scripts.
                For information about that, see:
                [*TclServer*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68986.md)
