...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23919.md]] for
...
If a port could not be allocated (e.g. all are in use or the port manager could
                ...
                [[CPortManagerException|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23919.md]].
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23919.md]].
...
[[portAllocator(3tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68886.md]],
            [[CPortManagerException(3daq)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23919.md]],
            [[DaqPortManager(1tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r15126.md]]
