...
# <a name="chap.eventlog"></a>Chapter 18. The Event log program
...
Most experiments will record event data.  Event data files are
        ...
        ring buffers.
        See the chapter:
        [[Format of EventData In Ring Buffers|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c183.md]]
...
<a name="AEN6877"></a>**Example 18-1. Taking data from a remote ring**
...
The full reference documentation for the program is in the
        [[event log reference page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12674.md]].
