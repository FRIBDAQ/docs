...
<a name="AEN17327"></a>## Name

CRingItem -- Encapsulates an item in a ring buffer.

<a name="AEN17330"></a>## Synopsis
...
<a name="AEN17505"></a>## Public member functions
...
Predicates provide a powerful mechanism for selecting and sampling
            ...
            see the chapter
            [[Ring Format|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c183.md]]
            which provides background information about ring buffer predicates.
            For reference information, see the reference pages for:
            [[`CRingSelectionPredicate`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r20546.md]],
            [[`CAllButPredicate`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r20878.md]],
            and
            [[`CDesiredTypesPredicate`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r21054.md]].
            Note that you may also construct your own predicate classes should
            these not be sufficient to meet your needs.

The caller is responsible for deleting the object.

<a name="AEN17752"></a>## Types and public data
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17323.md#cringitem.include]]
  This #include obtains the data type and
                      ...
                      constant.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17323.md#cringitem.predicate]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17323.md#cringitem.addtype]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17323.md#cringitem.get]]
  This gets a pointer to the ring item that satisfies our
                      ...
                      PHYSICS_EVENT.
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17323.md#cringitem.process]]
  I'm omitting what you do to process the item as that's application
                      dependent.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17323.md#cringitem.delete]]
