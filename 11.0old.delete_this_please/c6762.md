...
# <a name="chapter.ringpipes"></a>Chapter 16. Ring piping utilities
...
The **ringtostdout** command can be used to
        ...
        [[ringtostdout reference pages|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r11932.md]].
...
The **stdintoring** command can be used to allow a
        ...
        [[stdintoring reference material|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r11986.md]].
