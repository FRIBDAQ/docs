...
`  CTclAccessListCheck (Tcl_Interp* pInterp, const std::string& rName);`Constructs a Tcl Access list authenticator.
                ...
                and the
                [[CTCLInterpreter reference page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r38312.md]].
...
` const CTCLVariable* getVariable();`Returns a pointer to the
               ...
               [[Tcl++ chapter|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10014.md]] and the
                [[CTCLVariable reference page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r39157.md]].
