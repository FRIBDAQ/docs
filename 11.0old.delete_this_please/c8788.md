...
Detailed information about the **ring** command ensemble
            can found in the
            [[manual page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68497.md]] **ring**.
...
The ring items returned from **ring get** are transformed to
            ...
            [[manual page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68497.md]] .
