...
<a name="AEN23332"></a>## Name

CEvbClientApp -- Framework event builder client application.

<a name="AEN23335"></a>## Synopsis

```
CEVBClientApp
```

<a name="AEN23365"></a>## DESCRIPTION
...
See METHODS below for a description of the base class methods
            ...
            [[*CEVBClientFramework*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23472.md]]
...
<a name="AEN23427"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
