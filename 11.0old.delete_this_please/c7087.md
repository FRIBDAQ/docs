...
# <a name="chapter.sequencer"></a>Chapter 26. Sequencing runs
...
For a full description of the sequencer, see its
        [[reference manual page.|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r71022.md]].
        This chapter gives an overview that describes how to use and configure
        the sequencer.

# <a name="AEN7092"></a>26.1. Configuring the sequencer.
...
<a name="AEN7137"></a>**Example 26-1. Loading the sequencer package**
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7087.md#chapter.sequencer.env]]
  The global `env` array contains a 
  		 ...
  		 variable.
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7087.md#chapter.sequencer.join]]
...
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7087.md#chapter.sequencer.path]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7087.md#chapter.sequencer.require]]
