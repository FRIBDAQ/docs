...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23894.md) for
...
<a name="AEN23796"></a>## Public member functions
...
If a port could not be allocated (e.g. all are in use or the port manager could
                ...
                [CPortManagerException](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23894.md).
...
<a name="AEN23840"></a>## Types and public data
...
<a name="AEN23872"></a>## Exceptions

The `CPortManagerException` is thrown to inform the
            program of most errors dected by this API.  For more information about
            this exception, see:  [CPortManagerException(3)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23894.md).

<a name="AEN23877"></a>## EXAMPLES

Allocates a port to MyApplication

<a name="AEN23881"></a>**Example 1. Allocating a port with the port manager**
...
<a name="AEN23885"></a>**Example 2. Listing the port allocatiosn on a system.**
...
<a name="AEN23888"></a>## SEE ALSO

[portAllocator(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68861.md),
            [CPortManagerException(3daq)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23894.md),
            [DaqPortManager(1tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r15101.md)
