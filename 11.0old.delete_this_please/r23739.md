...
Note  that  members of this class can throw exceptions of type
       `CPortManagerException`.
        See the [[CPortManagerException(3)|r23894]] for
...
The `CPortManagerException` is thrown to inform the
            ...
            this exception, see:  [[CPortManagerException(3)|r23894]].
...
[[portAllocator(3tcl)|r68861]],
            [[CPortManagerException(3daq)|r23894]],
            [[DaqPortManager(1tcl)|r15101]]
