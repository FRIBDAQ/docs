...
<a name="AEN31821"></a>## Name

CVME -- Pointer like object for accessing the VME

<a name="AEN31824"></a>## Synopsis
...
<a name="AEN31931"></a>## Public member functions



- <a name="AEN31936"></a>`CVME<T>(VmeSpace space, UInt_t base, UInt_t length, UInt_t crate);`
...
- <a name="AEN31974"></a>`CVME<T>(CVMEptr<T>* aCVMEptr);`
...
- <a name="AEN31989"></a>`CVME<T>(const CVME& aCVME);`
...
- <a name="AEN32002"></a>`CVME<T>& operator=(const CVME<T>& aCVME);`
...
- <a name="AEN32015"></a>`int  operator==(const CVME<T>& aCVME);`
...
- <a name="AEN32060"></a>`T*  T* operator-> (void);`
...
- <a name="AEN32070"></a>`T&  operator[](UInt_t nOffset);`
...
- <a name="AEN32085"></a>`CVME<T>& operator+(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32097"></a>`CVME<T>&  operator-(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.
- <a name="AEN32109"></a>`CVME<T>&  operator+=(UInt_t nOffset);`
  Adds the specified offset to the pointer and returns a reference to the
                              modified pointer.
- <a name="AEN32121"></a>`CVME<T>&  operator-=(UInt_t nOffset);`
  Subtracts the offset from the pointer and returns a reference to the
                              resulting pointer.

<a name="AEN32131"></a>## Types and public data
