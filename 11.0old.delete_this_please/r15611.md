...
<a name="AEN15673"></a>### Map access command
...
<a name="AEN15683"></a>***mapname* get *width offset*
**

THe format of the *mapname* **put**
            command is:

<a name="AEN15691"></a>***mapname* put *width offset value***
