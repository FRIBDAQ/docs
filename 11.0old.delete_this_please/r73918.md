...
<a name="AEN73961"></a>## Public member functions
...
` virtual const bool isComposite();`Should return false if the scaler is not a
                ...
                [[CScalerBank(3sbsReadout)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r73292.md]]).
                Should return false if the scaler is a container
                and implements the interface defined by
                [[CScalerBank(3sbsReadout)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r73292.md]].

<a name="AEN74000"></a>## SEE ALSO
