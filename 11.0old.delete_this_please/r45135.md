...
<a name="AEN45139"></a>## Name

CCCUSB -- Provide access to a CC-USB device.

<a name="AEN45142"></a>## Synopsis

```
CCCUSB
```

<a name="AEN46124"></a>## DESCRIPTION
...
- ` int executeList(CCCUSBReadoutList& list, void* pReadBuffer, size_t readBufferSize, size_t* bytesRead);`
  ...
  Performs a CAMAC list operation in immediate mode.
                              ...
                              (see [[CCCUSBReadoutList(3ccusb)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r48354.md]])
...
- ` int loadList(uint8_t listNumber, CCCUSBReadoutList& list);`
  ...
  Loads a list into the CC-USB. The `listNumber`
                              ...
                              See [[CCCUSBReadoutList(3ccusb)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r48354.md]] for
...
<a name="AEN46695"></a>## PUBLIC VARIABLES, TYPES and CONSTANTS
...
<a name="AEN46699"></a>### Action Register
...
<a name="AEN46742"></a>### Firmware Register
...
<a name="AEN46794"></a>### Global Mode Register
...
<a name="AEN46927"></a>### Delay Register
...
<a name="AEN46960"></a>### Scaler Control register
...
<a name="AEN46993"></a>### LED Source Register
...
<a name="AEN47245"></a>### Output source selection register.
...
<a name="AEN47414"></a>### Device source register
...
<a name="AEN47767"></a>### Gate and delay generator and pulser set up registers.
...
<a name="AEN47828"></a>### Transfer setup register
