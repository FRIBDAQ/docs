...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x800.md#vmusb.config.create)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x800.md#vmusb.config.config)
...
Configuration files must also specify at least one stack and, if
        ...
        See the [stack(3vmusb)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r58763.md) command
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x800.md#vmusb.config.sis3820)
...
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x800.md#vmusb.config.sclrStack)
...
If the device support provided by VMUSBReadout
      ...
      be found in [*Extending the Supported Readout Hardware*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x1137.md).
