...
# <a name="AEN8752"></a>39.7. Callbacks
...
## <a name="AEN8755"></a>39.7.1. Connection callbacks
...
<a name="AEN8760"></a>**Example 39-4. Establishing the connection callback**
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x8752.md#evb_connection_cb)
  This is a sample connection callback proc.  All it
                              does is output information about the connection
                              that was just processed.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x8752.md#evb_connection_cb_establish)
...
## <a name="AEN8773"></a>39.7.2. Establishing the disconnect callback
...
<a name="AEN8777"></a>**Example 39-5. Setting up the disconnect callback**
...
- [![(1)](../images/callouts/1.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x8752.md#evb_disconnect_cb)
  This is a simple sample disconnecdt callback.
                              It just prints information about the disconnect
                              on stdout.
- [![(2)](../images/callouts/2.gif)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x8752.md#evb_disconnect_cb_establish)
...
| --- | --- | --- |
| Prev | Home | Next |
| The Event orderer/event builder API | Up | Tcl ring access package. |
