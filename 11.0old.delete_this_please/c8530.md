...
# <a name="evbapi_chap"></a>Chapter 39. 
...
# <a name="AEN8539"></a>39.1. C++ Client API

This section provides tutorial information that describes the
            client C++ API to the event orderer/builder.
            [[*CEventOrderClient*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23553.md]]
...
- [[Making `CEventOrderClient` available
                  within your program.|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x10562.md]]
- [[How to form a connection with the event orderer.|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x8577.md]]
