...
There are a number of frameworks for building C++ applications. First
      there is the [[SBS Readout Framework|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10747.md]],
      ...
      data format. To facilitate the design of filter programs, the [[Filter framework|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c11271.md]] exists. It handles the
