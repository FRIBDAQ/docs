...
<a name="AEN55078"></a>## Name

parameters -- Describe data source parameterization

<a name="AEN55081"></a>## Synopsis
...
Each data source managed by a data source provider is specified
            ...
            returns a Tcl
            [dict](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/dict.md) that describes the set of parameters
            expected.
