...
<a name="AEN36539"></a>## Public member functions
...
`  CTclAccessListCheck (Tcl_Interp* pInterp, const std::string& rName);`Constructs a Tcl Access list authenticator.
                ...
                `CTCLInterpreter`,
                See the
                [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10014.md)
                and the
                [CTCLInterpreter reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r38287.md).
...
` const CTCLVariable* getVariable();`Returns a pointer to the
                ...
                `CTCLVariable`
                objects, see
               [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10014.md) and the
                [CTCLVariable reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r39132.md).
...
<a name="AEN36589"></a>## Types and public data

`CTCLInterpreter`
            and
            `CTCLVariable`
            are objects that are part of the Tcl++ library. See the
            [Tcl++ chapter](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10014.md) of the
