...
# <a name="chapter.evb-orderer-dev"></a>Chapter 55. Event builder client framework

[[*Event builder client API*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c8530.md]] describes a low
...
- [[*CEvbClientApp*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23353.md]] provides
              reference material that describes the base class on which
              the application code for the event builder is based.
- [[*Event builder client framework*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r52253.md]]
              provides reference material that desribes the event builder command
              options and parameters.

# <a name="AEN10349"></a>55.1. Application specific code for the event builder
...
<a name="AEN10375"></a>**Example 55-1. `CEVBClientApp` definition**
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evbfw-base-initialize]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evbfw-base-dataready]]
  This method is called from time to time to determine if
                      ...
                      return true.
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evbfw-base-getevents]]
...
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evbfw-base-shutdown]]
...
## <a name="AEN10400"></a>55.1.1. Sample ring `EVBClientApp` class.
...
<a name="AEN10407"></a>**Example 55-2. The `CEVBRingClientApp` class
                definition.
                **
...
<a name="AEN10421"></a>**Example 55-3. The `CEVBRingClientApp` `initialize`
...
<a name="AEN10434"></a>**Example 55-4. The `CEVBRingClientApp`
`dataReady` method.**
...
See
                [[*CEVBClientFramework*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23497.md]]
...
<a name="AEN10478"></a>**Example 55-5. The `EVBRingClientApp` `getEvents`
                implementation.
                **
...
- [[![(1)](../images/callouts/1.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evb-clientfw-get-list]]
...
- [[![(2)](../images/callouts/2.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evb-clientfw-get-while]]
  The main loop condition for our code is to run
                          until we've pulled all the items from the ring.
                          See [[below however.|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evb-clientfw-get-limit]]
- [[![(3)](../images/callouts/3.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evb-clientfw-get-itemprep]]
  This is the heart of the loop. Each pass through the loop,
                          ...
                          hard coded to 1.
- [[![(4)](../images/callouts/4.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evb-clientfw-get-limit]]
...
- [[![(5)](../images/callouts/5.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evb-clientfw-get-submit]]
  This condition avoids doing anything if for some reason
                          ...
                          to the eventbuilder.
- [[![(6)](../images/callouts/6.gif)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md#evb-clientfw-get-cleanup]]
