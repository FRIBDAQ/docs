...
# <a name="compatibilty"></a>Chapter 28. Compatibility utilities
...
<a name="compatibilitybuffer-ex1"></a>**Example 28-1. Converting a ring buffer event file with compatibilitybuffer**
...
# <a name="AEN7271"></a>28.1. Format conversion with compatibilitybuffer
...
The core tool in the compatibility toolbox is compatibilitybuffer
            ...
            [[*Converting Event file*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7258.md#compatibilitybuffer-ex1]],
            we wanted to write data with a 16384 byte buffersize we would instead write:

<a name="AEN7279"></a>**Example 28-2. Converting ring buffer data to a 8Kword (16Kbyte) old style event file**
