...
<a name="AEN52094"></a>## Name

EVBC::initialize -- Initialize the EZBuilder layer.

<a name="AEN52097"></a>## Synopsis

**EVBC::initialize *options*
**

<a name="AEN52101"></a>## DESCRIPTION
...
For information about the specific options, see
            OPTIONS below and
            [[*EVBC::start*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r51865.md]].

<a name="AEN52109"></a>## OPTIONS

The **EVBC::initialize** command accepts all options
            that the [[*EVBC::start*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r51865.md]]
...
- `-restart` *yes | no*
  If `-restart` is yes,
                              ...
                              of each run (See [[*EVBC::onBegin*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r52143.md]]).
