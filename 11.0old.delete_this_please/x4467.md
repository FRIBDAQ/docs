...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [[developer documentation|c10688]] as well
      in the [[man pages|r51888]].
...
The next thing that you need to do register clients
      ...
      of how to create one at the [[ringFragmentSource documentation|x10595]].
