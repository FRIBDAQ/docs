...
When the "Start" button is pushed in the ReadoutGUI, this will add a set
      ...
      details about the callouts in the [developer documentation](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10688.md) as well
      in the [man pages](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r51888.md).
...
The next thing that you need to do register clients
      ...
      of how to create one at the [ringFragmentSource documentation](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x10595.md).
