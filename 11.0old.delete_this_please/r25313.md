...
<a name="AEN25442"></a>## Public member functions





- <a name="AEN25448"></a>` CBD8210(unsigned int b);`
  Constructor, creates a new CBD8210 module for
                                  branch number `b`.  See
                                  DESCRIPTION above for more information about the branch number.
- <a name="AEN25460"></a>`bool Xtest(void);const`
...
- <a name="AEN25472"></a>`bool Qtest(void);const`
...
- <a name="AEN25489"></a>`bool TimedOut(void);const`
...
- <a name="AEN25501"></a>`bool BranchDemand(void);const`
...
- <a name="AEN25513"></a>`void MNoX(bool fSet=true);`
...
- <a name="AEN25527"></a>`void MTo(bool fSet=true);`
  This sets or clears the MTO bit in the
                                  ...
                                  is inhibited.
- <a name="AEN25540"></a>`void MLAM(bool fSet=true);`
...
- <a name="AEN25554"></a>`void MIT2(bool fSet=true);`
  Sets or clears the MIT2 bit in the
                                  ...
                                  via `IT2`.
- <a name="AEN25569"></a>`void MIT4(bool fSet=true);`
...
- <a name="AEN25584"></a>`bool IT4(void);const`
...
- <a name="AEN25598"></a>`unsigned short ReadCsr(void);const`
...
- <a name="AEN25609"></a>`void WriteCsr(unsigned short nMask);`
...
- <a name="AEN25622"></a>`void WriteIFR(unsigned short nMask);`
  Writes the `nMask` parameter to the module's
                                  ...
                                  and IT4 inputs.
- <a name="AEN25638"></a>`unsigned short ReadBTB(void);const`
...
- <a name="AEN25649"></a>`unsigned long ReadGl(void);const`
...
- <a name="AEN25660"></a>`void InitBranch(void);const`
  Performs a Branch Zero (BZ) on the branch.

<a name="AEN25670"></a>## Examples

The example below access branch 0, and does a BZ:

<a name="AEN25674"></a>**Example 1. Initializing branch 0**
