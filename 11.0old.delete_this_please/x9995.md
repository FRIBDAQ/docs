...
| Prev | Chapter 50. Shared memory | Next |


---

# <a name="shm_compile"></a>50.2. Compiling/Linking your software with the shared memory API
...
<a name="AEN10006"></a>**Example 50-2. Compiling a C++ source that includes daqshm.h**
...
<a name="AEN10010"></a>**Example 50-3. Linking C++ object files that use the
            daqshm library**
