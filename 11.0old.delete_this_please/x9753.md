...
| Prev | Chapter 48. Access control and security | Next |


---

# <a name="AEN9753"></a>48.2. Authenticators
...
<a name="AEN9757"></a>**Example 48-3. Boilerplate DAQ Authorization code **
...
The complete definitinon of
            ...
            [[its reference pages|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r36019.md]].
            The library provides the following concrete authentication classes:



- [[`CPasswordCheck`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r36123.md]]
...
- [[`CUnixUserCheck`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r36311.md]]
  The entity must provide a valid username and password
                          that is could login to the local unix system.
- [[`CTclAccesListCheck`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r36522.md]]
...
- [[`CAccessListCheck`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r36620.md]]
  The entity must supply a string that is one of a set of strings
                              given to the authenticator.
- [[`CHostListCheck`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r36762.md]]
