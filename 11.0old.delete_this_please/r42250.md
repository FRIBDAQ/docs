...
<a name="AEN42350"></a>## Public member functions
...
<a name="AEN42461"></a>## Exceptions

std::string exceptions are thrown both from this and
            the calls it makes to `CItemConfiguration`.

<a name="AEN42466"></a>## SEE ALSO

[CItemConfiguration](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r41527.md)
