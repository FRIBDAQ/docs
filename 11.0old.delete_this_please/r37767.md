...
- ` static bool create(std::string name, size_t size, unsigned int flags);`
  ...
  See [[*PUBLIC VARIABLES, TYPES and CONSTANTS*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r37767.md#daqshm-varsrefsect]]
...
- ` static int lastError();`
  Returns the status of the most recent call.
                          ...
                          below in
                          [[*PUBLIC VARIABLES, TYPES and CONSTANTS*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r37767.md#daqshm-varsrefsect]].
