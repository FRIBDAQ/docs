...
| Prev | Chapter 38. Data Format Support Software | Next |


---

# <a name="AEN8302"></a>38.3. Incorporating the headers and libraries into your applications.
...
<a name="AEN8308"></a>**Example 38-1. Including a ring item class **
...
<a name="AEN8315"></a>**Example 38-2. Telling the compiler where to find Ring Item headers**
...
<a name="AEN8320"></a>**Example 38-3. Linking the ring item format libraries**
...
- [[`CRingItem`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17348.md]]
...
- [[`CRingStateChangeItem`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r18251.md]]
...
- [[`CRingScalerItem`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r17815.md]]
...
- [[`CRingTextItem`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r18646.md]]
...
- [[`CGlomParameters`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r20101.md]]
...
- [[`CPhysicsEventItem`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r18962.md]]
  Encapsulates the data taken in response to a physics
                          trigger.
- [[`CRingFragmentItem`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r19465.md]]
...
- [[`CRingPhysicsEventCountItem`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r19148.md]]
  Encapsulates an item that gives information about the
                          ...
                          sampling data.
- [[`CUnknownFragment`|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r19770.md]]
...
## <a name="AEN8392"></a>38.3.1. Generic ring data sources
...
Reference information on these classes is availabe at:
                [[*CDataSource*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r22643.md]],
                [[*CRingDataSource*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r22685.md]],
                [[*CFileDataSource*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r22754.md]],
                [[*CDataSourceFactory"*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r22811.md]],
                and
                [[*CRingItemFactory*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r22868.md]].
