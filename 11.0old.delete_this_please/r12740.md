...
<a name="AEN12744"></a>## Name

ccusbloader -- CC-USB Firmware loader

<a name="AEN12747"></a>## Synopsis

**ccusbloader *firmware-filename [serial-string]*
**

<a name="AEN12752"></a>## DESCRIPTION

Loads the firmware-filename into the currently
            selected firmware location. See
            [*VM/CCUSB Firmware loaders*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7067.md)
...
<a name="AEN12759"></a>## KNOWN ISSUES
