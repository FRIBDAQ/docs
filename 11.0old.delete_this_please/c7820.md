...
# <a name="chapter.ringformat-dev"></a>Chapter 38. Data Format Support Software

In the user guide section on [[data
      formats|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c183.md]], the format of all the ring items were explained in
...
# <a name="AEN7835"></a>38.1. The basic data formats
...
<a name="AEN7921"></a>`pDataFormatformatDataFormat
          (void);`


<a name="AEN7927"></a>`pGlomParameters
...
<a name="AEN7941"></a>`pEventBuilderFragment
            formatEVBFragment
          (
            uint64_t timestamp
          , 
...
<a name="AEN7961"></a>`pEventBuilderFragment
...
<a name="AEN7981"></a>` pPhysicsEventItem
...
<a name="AEN8001"></a>` pPhysicsEventCountItem
...
<a name="AEN8094"></a>` pStateChangeItem
...
<a name="AEN8126"></a>` void* bodyPointer
          (
            pRingItem pItem
          );`
...
## <a name="AEN8135"></a>38.1.1. State Change Items
...
## <a name="AEN8175"></a>38.1.2. Text List Items
...
## <a name="AEN8224"></a>38.1.3. Scaler Items
...
## <a name="AEN8257"></a>38.1.4. Event Data Items
...
## <a name="AEN8264"></a>38.1.5. Event count items
