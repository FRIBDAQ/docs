...
<a name="AEN28399"></a>## Public member functions



<a name="AEN28404"></a>`CCAENV830(int slot, int crate, bool geo, unsigned long base);`
...
<a name="AEN28432"></a>`void  Enable(int nChannel);`
...
<a name="AEN28447"></a>`void  Disable(int nChannel);`
...
<a name="AEN28462"></a>`void   SetEnableMask (int nMask);`
...
<a name="AEN28475"></a>`void   SetDwellTime(int   n4ppns);`

In periodic trigger mode, this sets the number of 400ns clock ticks
                            between periodic triggers.

<a name="AEN28487"></a>`void   SetTriggerMode (TriggerMode mode);`
...
<a name="AEN28499"></a>`void   SetWide (void);`
...
<a name="AEN28511"></a>`void   SetNarrow (void);`
...
<a name="AEN28522"></a>`void  EnableHeader (void);`
...
<a name="AEN28600"></a>`bool  isFull (void);`
...
<a name="AEN28612"></a>`bool   isGlobalDReady (void);`
...
<a name="AEN28624"></a>`bool   isGlobalBusy(void);`
...
<a name="AEN28717"></a>`int   ReadEvent (DAQWordBufferPtr& rBufferPtr);`
...
<a name="AEN28731"></a>`int   ReadEvent (DAQWordBuffer& rBuffer, int  nOffset);`
