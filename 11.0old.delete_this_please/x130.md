...
- ringbuffer
  This utility allows you to create, re-initialize, delete  and
              ...
              don't already exist. See the [[man page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r11834.md]] for more information.
- dumper
  Provides a simple textual formatted dump of the buffers.  If you
              ...
              each event and the packets within the event. See [[user documentation|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c6788.md]] and [[man page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12590.md]] for more information.
- eventlog
  Performs native mode event loggging.  In this mode, event file
              segments consists of streams of ring buffer items. See [[user documentation|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c6852.md]] and [[man page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12674.md]] for more information.
- ringselector
  Provides a flexible ringbuffer consumer that pipes the ring items
              ...
              applications like SpecTcl. See [[user documentation|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7177.md]] and [[man page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12813.md]] for more information.
- ringtostdout
  Accepts data from a ring and pipes it to stdout.  This is the server
              ...
              process data from  a ring. See the [[man page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r11932.md]] for more information.
- ScalerDisplay
  Provides a display of scaler event data.  This application is highly
              ...
              selected scalers are also supported. See [[user documentation|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c4573.md]] and [[man page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12292.md#manpage.scalerdisplay]] for more information.
- stdintoring
  Accepts data on stdin and puts it in a ring buffer.  This is the
              client side of the data pipeline that sets up a proxy ring. See the [[man page|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r11986.md]] for more information.
