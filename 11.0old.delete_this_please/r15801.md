...
<a name="AEN15805"></a>## Name

Readout -- Start an event readout program.

<a name="AEN15808"></a>## Synopsis
...
- **runvar** *varname*
  Designates `varname` as a Tcl variable
                      ...
                      [*controlpush*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12940.md)
