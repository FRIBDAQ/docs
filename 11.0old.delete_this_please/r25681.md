...
<a name="AEN26203"></a>## Public member functions
...
- <a name="AEN26210"></a>`CCAENV1x90(unsigned int nSlot, unsigned int nCrate, unsigned long nBase);`
  Called when a CAENV1x90 object is created to initialize the object
                                  ...
                                  crate.
- <a name="AEN26231"></a>` unsigned int getModel(void);const`
  Returns the model number of the device.  This will be either
                                      1190 or 1290
- <a name="AEN26244"></a>` unsigned char getVersion(void);const`
...
- <a name="AEN26269"></a>` unsigned int getChipCount(void);const`
  Returns the number of TDC chips on the board.  Some of the models,
                                  ...
                                  is allowed to go.
- <a name="AEN26280"></a>` unsigned int getChannelCount(void);const`
...
- <a name="AEN26613"></a>` void
  ...
  Selects the meaning of the ECL user output of the module. See
                                  ...
                                  what they mean.
- <a name="AEN26626"></a>` ECLOutputSelect
...
- <a name="AEN26658"></a>` bool  isEventFIFOReady(void);`
  Returns true if the Event FIFO is not empty.
- <a name="AEN26669"></a>` bool   isEventFIFOFull(void);`
...
- <a name="AEN26694"></a>` unsigned short
...
- <a name="AEN26858"></a>` void SetRejectMargin(unsigned int Margin);`
...
- <a name="AEN26870"></a>` void EnableTriggerTimeSubtraction(void);`
...
- <a name="AEN26880"></a>` void DisableTriggerTimeSubtraction(void);`
...
- <a name="AEN26890"></a>` TriggerConfiguration
...
- <a name="AEN26987"></a>` EdgeMode GetEdgeDetectMode(void);`
...
- <a name="AEN27011"></a>` void
  ...
  Sets the time resolutions of the leading edge and pair timings.
                              ...
                              "Types and Public Data" below.
- <a name="AEN27028"></a>` unsigned short
                    GetResolution(void);`
...
- <a name="AEN27054"></a>` LEResolution
  ...
  Interprets and returns the leading edge resolution from a value
                              ...
                              take.
- <a name="AEN27068"></a>` PWResolution
...
- <a name="AEN27228"></a>` unsigned short
...
- <a name="AEN27276"></a>` void
  ...
  Disables the specified channel.  Note that channel numbering
                              ...
                              about this.
- <a name="AEN27288"></a>` void EnableAllChannels(void);`
...
- <a name="AEN27322"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
  Retrieves the channel enable masks.
- <a name="AEN27334"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
...
- <a name="AEN27351"></a>` unsigned int GetChipEnables(unsigned short nChip);`
  Returns the enable mask for a single chip.  `nChip`
                              selects the chip you are interested in.  The enables are returned as
                              the function value.
- <a name="AEN27364"></a>` unsigned int GetChipId(unsigned short nChip);`
- <a name="AEN27376"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
- <a name="AEN27397"></a>` unsigned short GetChipErrors(unsigned short nChip);`
- <a name="AEN27409"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27424"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27439"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
- <a name="AEN27454"></a>` void
                    SetIndividualLSB(Resolution nResolution);`
- <a name="AEN27466"></a>` void
                    SetPairResolutions(LEResolution nLeadingEdge, PWResolution nPulseWidth);`
- <a name="AEN27481"></a>` unsigned short
                    GetResolution(void);`
- <a name="AEN27491"></a>` Resolution
                    InterpretEdgeResolution(unsigned short nResolution);`
- <a name="AEN27503"></a>` LEResolution
                    InterpretLEResolution(unsigned short nResolution);`
- <a name="AEN27515"></a>` PWResolution
                    InterpretWidthResolution(unsigned short nResolution);`
- <a name="AEN27527"></a>` void
                    SetDoubleHitResolution(DeadTime nDead);`
- <a name="AEN27539"></a>` DeadTime
                    GetDoubleHitResolution(void);`
- <a name="AEN27549"></a>` void
                    EnableTDCEncapsulation(void);`
- <a name="AEN27559"></a>` void
                    DisableTDCEncapsulation(void);`
- <a name="AEN27569"></a>` bool
                    isTDCEncapsulationOn(void);`
- <a name="AEN27579"></a>` void
                    SetMaxHitsPerEvent(HitMax nHits);`
- <a name="AEN27591"></a>` HitMax
                    GetMaxHitsPerEvent(void);`
- <a name="AEN27601"></a>` void
                    EnableErrorMark(void);`
- <a name="AEN27611"></a>` void
                    DisableErrorMark(void);`
- <a name="AEN27621"></a>` void EnableBypassOnError(void);`
- <a name="AEN27631"></a>` void
                    DisableBypassOnError(void);`
- <a name="AEN27641"></a>` void
                    SetErrorEnables(unsigned short nErrors);`
- <a name="AEN27653"></a>` unsigned short
                    GetErrorEnables(void);`
- <a name="AEN27663"></a>` void
                    SetL1Size(L1Size nL1Size);`
- <a name="AEN27675"></a>` L1Size
                    GetL1Size(void);`
- <a name="AEN27685"></a>` void
                    EnableChannel(unsigned short nChannel);`
- <a name="AEN27697"></a>` void
                    DisableChannel(unsigned short
                                 nChannel);`
- <a name="AEN27709"></a>` void EnableAllChannels(void);`
- <a name="AEN27719"></a>` void
                    DisableAllChannels(void);`
- <a name="AEN27729"></a>` void
                    SetChannelEnables(std::vector<unsigned short> masks);`
- <a name="AEN27741"></a>` void
                    GetChannelEnables(std::vector<unsigned short>&
                                 masks);`
- <a name="AEN27753"></a>` void SetChipEnables(unsignedshort nChip, unsigned int nMask);`
- <a name="AEN27768"></a>` unsigned int GetChipEnables(unsigned short nChip);`
- <a name="AEN27780"></a>` unsigned int GetChipId(unsigned short nChip);`
  Returns the id code fo the TDC.  Note that there is no documentation about
                              possible values that can be returned.
- <a name="AEN27792"></a>` void GetuCFirmwareInfo(unsigned short& nRevision, unsigned short& nDay, unsigned short& nMonth, unsigned short& nYear);`
...
- <a name="AEN27813"></a>` unsigned short GetChipErrors(unsigned short nChip);`
...
- <a name="AEN27826"></a>` unsigned int ReadData(void* pBuffer, unsigned int nMaxLongs);`
  Reads data from the TDC.  This actually `ReadPacket`
                              ...
                              are described  below.
- <a name="AEN27843"></a>` unsigned int ReadPacket(void* pBuffer, unsigned int nMaxLongs);`
...
- <a name="AEN27861"></a>`unsigned int ReadValid(void* pBuffer, unsigned int nMaxLongs);`
...
<a name="AEN27876"></a>## Types and public data
