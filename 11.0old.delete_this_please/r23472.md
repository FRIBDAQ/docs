...
<a name="AEN23476"></a>## Name

CEVBClientFramework -- Event builder client framework.

<a name="AEN23479"></a>## Synopsis

```
CEVBClientFramework
```

<a name="AEN23496"></a>## DESCRIPTION
...
- ` void submitFragmentList(static CEVBEventList& fragmentList);`
  Allows you to submit a list of event fragments to the
                          ...
                          see
                          [[*CEventOrderClient*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23528.md]].
