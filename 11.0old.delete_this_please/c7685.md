...
# <a name="chapter.ringprimitives"></a>Chapter 36. Ring Buffer Primitives
...
Reference material can be found in the
        [CRingBuffer reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r16538.md)

# <a name="AEN7699"></a>36.1. Incorporating ring buffer software
...
<a name="AEN7706"></a>**Example 36-1. Compilation line for ring buffer primitives**
...
<a name="AEN7712"></a>**Example 36-2. Including the ring buffer primitives header**
...
<a name="AEN7718"></a>**Example 36-3. Linking to the ring buffer primitives**
