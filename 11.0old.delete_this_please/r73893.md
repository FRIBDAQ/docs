...
<a name="AEN73897"></a>## Name

CScaler -- Base class for scaler readout classes

<a name="AEN73900"></a>## Synopsis
...
<a name="AEN73936"></a>## Public member functions
...
` virtual const bool isComposite();`Should return false if the scaler is not a
                ...
                [[CScalerBank(3sbsReadout)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r73267.md]]).
                Should return false if the scaler is a container
                and implements the interface defined by
                [[CScalerBank(3sbsReadout)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r73267.md]].

<a name="AEN73975"></a>## SEE ALSO
