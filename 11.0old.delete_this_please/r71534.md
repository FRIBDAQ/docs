...
<a name="AEN71546"></a>## Name

RingStatus -- Widget that shows ring status.

<a name="AEN71549"></a>## Synopsis
...
- `update` *ring-info-list*
  Accepts a list of data compatible with the output
                              of the
                              [[**ring usage**|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68297.md]]
                              command.  This data is used to update the ring size, free space and
                              consumer information table.

<a name="AEN71590"></a>## SEE ALSO

[[*TCL Ring package.
        **Ron**Fox**
*NSCLDAQ*
***|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68297.md]]
