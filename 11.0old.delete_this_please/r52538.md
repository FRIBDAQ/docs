...
In addition to simple set and get operations environment variables
            ...
            [[*StateManager*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r54081.md]] package for that
            instead.
...
- `::Configuration::readConfigfile` `path`
  The configuration file at `path` is
                          ...
                          [[*StateManager*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r54081.md]] is a better
                          choice).
