...
The client programs that submit data to the server are built using the
      [[event builder client
        framework|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c10329.md]]. In general, though, it is not necessary to implement a
      client when using the ring buffer system, because the client for ring
      items has already been provided as the [[ringFragmentSource|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x10595.md]] program. This
