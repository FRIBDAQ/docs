...
If a user wants to write their own module for the slow-controls subsystem,
      ...
      [*Extending the slow controls subsystem*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x1550.md).
...
There are numerous slow-controls modules availabe for use with the
        Module command (see [Module(3tcl)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r65763.md)). Because of its
...
- `CVMUSBReadoutList`
  Instances of this class represent lists of VME operations you want
                to perform via the server.  See [*CVMUSBReadoutList*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r60883.md) for reference
                information.
- `CVMUSBRemote`
  ...
  See [*CVMUSBRemote*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r61778.md)
