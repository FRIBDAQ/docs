...
<a name="AEN16331"></a>## Name

CRingAccess -- Remote Ring Access

<a name="AEN16334"></a>## Synopsis
...
The chapter:
            [Networed Ring Buffer Access](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7624.md)
            includes sample code for detecting and mapping the use of a system's
            hostname into localhost.

<a name="AEN16410"></a>## Public member functions
...
<a name="AEN16501"></a>## EXAMPLES

The first example connects to a local ring buffer named
            daq.

<a name="AEN16505"></a>**Example 1. Using `CRingAccess` to connect to
                    a local ring.**
...
<a name="AEN16509"></a>**Example 2. Using `CRingAccess` to connect to a remote
                ring**
