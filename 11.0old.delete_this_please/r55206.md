...
<a name="AEN55218"></a>## Name

pause -- Pause a data taking run (optional)

<a name="AEN55221"></a>## Synopsis
...
This proc is optional.  Specifically, if the data source provider's
            [*capabilities*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r55326.md) specifies  the
