...
<a name="AEN23955"></a>## Description

`CPortManagerException`
       is  an exception that can be thrown by the port manager
       class `CPortManager`
        see [[the man page for that class|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23739.md]]).
        Since it  is  derived
       from
       `CException`,
...
<a name="AEN23962"></a>## Public member functions
...
<a name="AEN24018"></a>## Types and public data
...
<a name="AEN24038"></a>**Example 1. Catching a CPortManagerException**
...
<a name="AEN24041"></a>## SEE ALSO

[[portAllocator(3tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r68861.md]],
            [[CPortManager(3daq)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23739.md]],
            [[DaqPortManager(1tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r15101.md]]
[[CException(3tcl)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r42445.md]]
