...
<a name="AEN22948"></a>## Name

CDataSink -- Abstract base class for data sinks.

<a name="AEN22951"></a>## Synopsis

```
CDataSink
```

<a name="AEN22976"></a>## DESCRIPTION
...
By deriving concrete data types
        ...
        [*CDataSinkFactory*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r23264.md)
