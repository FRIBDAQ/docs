...
# <a name="AEN9400"></a>Chapter 46. Integer byte order conversion library
...
Reference material for this library is available in the
        [[reference manual page for cvt|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r34638.md]].

This chapter gives an high level view of how the
        library should be used.

# <a name="AEN9407"></a>46.1. Using the conversion library in your code

The conversion library is a set of C functions.  To use it,
            you will need to include the library header in your source code
            with a line like:

<a name="AEN9410"></a>**Example 46-1. Including the cvt header**
...
<a name="AEN9416"></a>**Example 46-2. Compiling a C or C++ source file that includes cvt.h**
...
<a name="AEN9420"></a>**Example 46-3. A makefile rule that builds a C++ program using the
                cvt package**
