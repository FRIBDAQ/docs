...
<a name="AEN61782"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN61785"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN62971"></a>## DESCRIPTION
...
<a name="AEN62974"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r58891.md)
