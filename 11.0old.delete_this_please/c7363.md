...
# <a name="chapter.controlpush"></a>Chapter 29. Providing EPICS channel information to Tcl Servers
...
controlpush
      ...
      [the controlpush manpage](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12965.md).

The intent is that 
      controlpush be pointed at a 
      TclServer.
[The TclServer](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c6882.md)
...
You can use 
      ...
      system parameters. 
      [epicsdisplay](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/c7401.md) is an example
