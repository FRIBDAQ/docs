...
<a name="AEN64740"></a>## DESCRIPTION

This package provides a tcl interface to the
                `CVMUSB` class described in
                [CVMUSB(3)](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r58891.md).
                See COMMANDS below for more information.

<a name="AEN64745"></a>## COMMANDS
