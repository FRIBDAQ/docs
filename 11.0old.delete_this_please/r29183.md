...
<a name="AEN29227"></a>## Public member functions



- <a name="AEN29232"></a>`  CCAMACScalerLRS2551(unsigned int b, unsigned int c, unsigned int n);`
