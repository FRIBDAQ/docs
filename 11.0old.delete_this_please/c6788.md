...
# <a name="ch.dumper"></a>Chapter 17. The dumper program
...
dumper provides for a certain amount of
        ...
        [dumper reference page](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12590.md).
...
<a name="AEN6802"></a>**Example 17-1. Dumping data from the ring buffer named 0400x on spdaq22**
...
<a name="AEN6806"></a>**Example 17-2. Dumping data from the event file segment
...
# <a name="AEN6816"></a>17.1. Item dump formats and examples
...
<a name="AEN6819"></a>**Example 17-3. State Transition items**
...
<a name="AEN6824"></a>**Example 17-4. Text List items**
...
<a name="AEN6829"></a>**Example 17-5. Incremental Scalers dump**
...
<a name="AEN6835"></a>**Example 17-6. Event count items**
...
<a name="AEN6841"></a>**Example 17-7. Physics Event items**
...
<a name="AEN6846"></a>**Example 17-8. Unknown item types**
...
| --- | --- | --- |
| Prev | Home | Next |
| Ring piping utilities | Up | The Event log program |
