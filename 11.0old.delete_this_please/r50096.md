...
<a name="AEN50272"></a>## DESCRIPTION

This set of commands is a Tcl wrapper around the
                CCCUSB C++ class (see [[CCCUSB(3ccusb)|r45110]].  The
...
Command lists (see [[cccusbreadoutlist(3ccusb)|r50821]])
...
<a name="AEN50280"></a>## COMMAND DETAILS
...
***object* executeList
                    *readout-list maxread***Executes a `cccusbreadoutlist::CCCUSBReadoutList`
                            (see [[cccusbreadoutlist(3ccusb)|r50821]]).
...
`readout-list` is a
                            ...
                            [[cccusbreadoutlist(3ccusb)|r50821]] for
...
<a name="AEN50732"></a>## DEVICE ENUMERATION
...
<a name="AEN50756"></a>**Example 1. Listing CC-USB Serial numbers (Tcl).**
...
<a name="AEN50766"></a>**Example 2. Creating a CCCUSB object by serial number (Tcl).**
...
<a name="AEN50772"></a>## EXECUTING LISTS
...
This section describes how to use **executeList**
                ...
                [[CCCUSBReadoutList(3ccusb)|r48329]] for reference
...
<a name="AEN50815"></a>## SEE ALSO

[[CCCUSB(3ccusb)|r45110]]
[[cccusbreadoutlist(3ccusb)|r50821]]
[[CCCUSBReadoutList(3ccusb)|r48329]]
