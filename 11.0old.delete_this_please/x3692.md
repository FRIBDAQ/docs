...
The menu bar provides access to ReadoutShell commands
                ...
                [[*Customizing the ReadoutShell*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x4041.md]] describes
...
- Event Log Program
  ...
  The
                              ...
                              [[*The event logger and ReadoutShell*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/x4007.md]] for
...
- Use `--number-of-sources`
  ...
  This option should be used if you are combining
                              ...
                              See
                              [[*eventlog*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12674.md]] for more
...
- debug
  The debug log level is intended
                              ...
                              See, however
                              [[*OutputWindow*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r54240.md#rdogui3_ui_OutputWindow]]  for
...
The log types and their visual representations can be controlled
                ...
                [[*OutputWindow*|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r54240.md#rdogui3_ui_OutputWindow]] for information
