...
# <a name="AEN10135"></a>Chapter 53. Injecting variables into the USB data taking frameworks
...
Both the VMUSBReadout and CCUSBReadout frameworks support recording
        ...
        [[controlpush(1epics)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12965.md]] a client of the
...
How to push variable values into the controls Tcl server is beyond the
        ...
        application ([[controlpush(1epics)|https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r12965.md]]),
...
<a name="AEN10154"></a>**Example 53-1. The **watch** command.**
