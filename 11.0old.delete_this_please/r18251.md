...
<a name="AEN18422"></a>## Public member functions
...
<a name="AEN18640"></a>## EXAMPLES

The example below creates a begin run and informs a ring about this.

<a name="AEN18643"></a>**Example 1. Creating a begin run state transition item**
