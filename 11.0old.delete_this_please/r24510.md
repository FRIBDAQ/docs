...
<a name="AEN24751"></a>## Public member functions





<a name="AEN24757"></a>` CAENcard(int slotNum=-1, int crateNum=0, bool fGeo=true, long nBase=0);`
...
<a name="AEN24819"></a>`unsigned long getBase(void);`
...
<a name="AEN24830"></a>`int getSerial(void);`
...
<a name="AEN24861"></a>`int  getFirmware(void);`
...
<a name="AEN24871"></a>`int  getCrate(void);`
...
<a name="AEN24882"></a>`void setCrate(int crateNum);`
...
<a name="AEN24895"></a>`void setThreshold(int ch, int threshold);`
...
<a name="AEN24916"></a>`void keepUnderThresholdData(void);`

If called, the module will not supress data that is under the
                                threshold.

<a name="AEN24926"></a>`void discardUnderThresholdData(void);`
...
<a name="AEN24936"></a>`void keepOverflowData(void);`
...
<a name="AEN24946"></a>`void discardOverflowData(void);`
...
<a name="AEN24956"></a>`void keepInvalidData(void);`
...
<a name="AEN24967"></a>`void discardInvalidData(void);`

Again see above.  If data are *invalid* they
                                will be discarded from the data stream.

<a name="AEN24978"></a>`void commonStart(void);`
...
<a name="AEN24989"></a>`void commonStop(void);`
...
<a name="AEN25000"></a>`void setRange(int range);`
...
<a name="AEN25013"></a>`void setPedestalCurrent(int ped);`
...
<a name="AEN25085"></a>`void clearData
                                (void);`
...
<a name="AEN25128"></a>`bool Busy(void);`
...
<a name="AEN25139"></a>` bool gBusy(void);`
...
<a name="AEN25150"></a>`bool MEBFull(void);`

Returns true if the multiple event buffer int he module is full.

<a name="AEN25161"></a>`bool MEBEmpty(void);`

Returns true if the module's multi-event
                                buffer is empty.

<a name="AEN25172"></a>`int readEvent(void* buf);`
...
<a name="AEN25185"></a>`int readEvent(DAQWordBuffer& wbuf, int offset);`
...
<a name="AEN25226"></a>`void enableSmallThresholds(void);`
...
<a name="AEN25289"></a>## Exceptions

Many functions throw `std::string` exceptions.

<a name="AEN25293"></a>## Examples

Create a `CAENcard` module in
                geographical mode:

<a name="AEN25297"></a>**Example 1. Creating a CAENcard geographically**
...
<a name="AEN25301"></a>**Example 2. Setting a TDC to common stop mode**
...
<a name="AEN25305"></a>**Example 3. Reading out a CAEN 785 e.g.**
