...
<a name="AEN61757"></a>## Name

CVMUSBRemote -- Execute lists remotely on VMUSBReadout

<a name="AEN61760"></a>## Synopsis

```
CVMUSBRemote
```

<a name="AEN62946"></a>## DESCRIPTION
...
<a name="AEN62949"></a>## METHODS

With the exception of the constructor, please refer to
            [*CVMUSB*](https://github.com/FRIBDAQ/docs/tree/main/11.0old.delete_this_please/r58866.md)
